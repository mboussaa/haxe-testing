...
void TestAll_obj::__construct(){
            	HX_STACK_FRAME("TestAll","new",0xdf2ac441,"TestAll.new","TestAll.hx",26,0x4f103e4f)
            	HX_STACK_THIS(this)
            	}
...
void TestAll_obj::addTests( ::utest::Runner runner){
            	HX_STACK_FRAME("TestAll","addTests",0xcf57027f,"TestAll.addTests","TestAll.hx",7,0x4f103e4f)
            	HX_STACK_ARG(runner,"runner")
HXLINE(   9)		runner->addCase( ::utest::TestAssert_obj::__new(),null(),null(),null(),null());
HXLINE(  10)		runner->addCase( ::utest::TestDispatcher_obj::__new(),null(),null(),null(),null());
            	}
...
void TestAll_obj::main(){
            		...
            		void _hx_run( ::Dynamic o){
            			HX_STACK_FRAME("TestAll","main",0x6594a938,"TestAll.main","TestAll.hx",22,0x4f103e4f)
            			HX_STACK_ARG(o,"o")
HXLINE(  22)			Bool _hx_tmp = (( (Int)(o->__Field(HX_("done",82,f0,6d,42),hx::paccDynamic)) ) == ( (Int)(o->__Field(HX_("totals",2f,f8,d6,97),hx::paccDynamic)) ));
HXDLIN(  22)			if (_hx_tmp) {
HXLINE(  22)				r[(int)0] = ( ( ::utest::TestResult)(o->__Field(HX_("result",dd,68,84,08),hx::paccDynamic)) );
            			}
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_STACK_FRAME("TestAll","main",0x6594a938,"TestAll.main","TestAll.hx",13,0x4f103e4f)
HXLINE(  14)		HX_VARI(  ::utest::Runner,runner) =  ::utest::Runner_obj::__new();
HXLINE(  16)		::TestAll_obj::addTests(runner);
HXLINE(  18)		::utest::ui::Report_obj::create(runner,null(),null());
HXLINE(  21)		HX_VARI( ::Array< ::Dynamic>,r) = ::Array_obj< ::Dynamic>::__new(1)->init(0,null());
HXLINE(  22)		runner->onProgress->add( ::Dynamic(new _hx_Closure_0(r)));
