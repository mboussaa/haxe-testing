...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me66) {
			__temp_me66.assertations = 0;
			__temp_me66.successes = 0;
			__temp_me66.failures = 0;
			__temp_me66.errors = 0;
			__temp_me66.warnings = 0;
			__temp_me66.isOk = true;
			__temp_me66.hasFailures = false;
			__temp_me66.hasErrors = false;
			__temp_me66.hasWarnings = false;
			__temp_me66.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me66.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me66.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me66.onAddWarnings = new global::utest.Dispatcher<int>();
		}
