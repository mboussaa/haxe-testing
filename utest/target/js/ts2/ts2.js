...
TS2.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS2.hx", lineNumber : 17, className : "TS2", methodName : "addTests"});
	runner.addCase(new utest_TestDispatcher(Std.parseInt(w)));
};
TS2.main = function() {
...
var utest_TestDispatcher = function(i) {
	this.x = i;
};
...
utest_TestDispatcher.prototype = {
	...
	,testBase: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.isTrue(dispatcher.has(),null,{ fileName : "TestDispatcher.hx", lineNumber : 18, className : "utest.TestDispatcher", methodName : "testBase"});
			dispatcher.remove(h);
			utest_Assert.isFalse(dispatcher.has(),null,{ fileName : "TestDispatcher.hx", lineNumber : 20, className : "utest.TestDispatcher", methodName : "testBase"});
		}
	}
	,v: null
	,handler1: function(s) {
	...
	,testHandlers: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.equals("",this.v,null,{ fileName : "TestDispatcher.hx", lineNumber : 37, className : "utest.TestDispatcher", methodName : "testHandlers"});
			this.v = "";
			dispatcher.add($bind(this,this.handler1));
			dispatcher.dispatch("d2");
			utest_Assert.equals("d2e1",this.v,null,{ fileName : "TestDispatcher.hx", lineNumber : 42, className : "utest.TestDispatcher", methodName : "testHandlers"});
			this.v = "";
			dispatcher.add($bind(this,this.handler2));
			dispatcher.dispatch("d3");
			utest_Assert.equals("d3e1d3e2",this.v,null,{ fileName : "TestDispatcher.hx", lineNumber : 47, className : "utest.TestDispatcher", methodName : "testHandlers"});
			this.v = "";
			dispatcher.add($bind(this,this.handler1));
			dispatcher.dispatch("d4");
			utest_Assert.equals("d4e1d4e2d4e1",this.v,null,{ fileName : "TestDispatcher.hx", lineNumber : 52, className : "utest.TestDispatcher", methodName : "testHandlers"});
			this.v = "";
			dispatcher.remove($bind(this,this.handler1));
			dispatcher.dispatch("d5");
			utest_Assert.equals("d5e2d5e1",this.v,null,{ fileName : "TestDispatcher.hx", lineNumber : 57, className : "utest.TestDispatcher", methodName : "testHandlers"});
			this.v = "";
			dispatcher.remove($bind(this,this.handler1));
			dispatcher.dispatch("d6");
			utest_Assert.equals("d6e2",this.v,null,{ fileName : "TestDispatcher.hx", lineNumber : 62, className : "utest.TestDispatcher", methodName : "testHandlers"});
			this.v = "";
			dispatcher.remove($bind(this,this.handler2));
			dispatcher.dispatch("d7");
			utest_Assert.equals("",this.v,null,{ fileName : "TestDispatcher.hx", lineNumber : 67, className : "utest.TestDispatcher", methodName : "testHandlers"});
		}
	}
	,stopper: function(s) {
		this.v += s + "s";
	...
	,testStop: function() {
		...
		while(_g1 < _g) {
			...
			dispatcher.add($bind(this,this.handler2));
			dispatcher.dispatch("d1");
			utest_Assert.equals("d1e1d1s",this.v,null,{ fileName : "TestDispatcher.hx", lineNumber : 84, className : "utest.TestDispatcher", methodName : "testStop"});
		}
	}
