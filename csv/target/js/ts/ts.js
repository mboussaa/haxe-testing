...
TestAll.prototype = {
	testEncode: function() {
		utest_Assert.same("1997,Ford,E350",thx_csv_Dsv.encode([["1997","Ford","E350"]],thx_csv_Csv.encodeOptions),null,null,null,{ fileName : "TestAll.hx", lineNumber : 12, className : "TestAll", methodName : "testEncode"});
		utest_Assert.same("1997,Ford,E350,\"Super, luxurious truck\"",thx_csv_Dsv.encode([["1997","Ford","E350","Super, luxurious truck"]],thx_csv_Csv.encodeOptions),null,null,null,{ fileName : "TestAll.hx", lineNumber : 13, className : "TestAll", methodName : "testEncode"});
		utest_Assert.same("1997,Ford,E350,\"Super, \"\"luxurious\"\" truck\"",thx_csv_Dsv.encode([["1997","Ford","E350","Super, \"luxurious\" truck"]],thx_csv_Csv.encodeOptions),null,null,null,{ fileName : "TestAll.hx", lineNumber : 14, className : "TestAll", methodName : "testEncode"});
		utest_Assert.same("1997,Ford,E350,\"Go get one now\nthey are going fast\"",thx_csv_Dsv.encode([["1997","Ford","E350","Go get one now\nthey are going fast"]],thx_csv_Csv.encodeOptions),null,null,null,{ fileName : "TestAll.hx", lineNumber : 15, className : "TestAll", methodName : "testEncode"});
	}
	,testDecode: function() {
		utest_Assert.same([],thx_csv_Dsv.decode("",thx_csv_Csv.decodeOptions),null,null,null,{ fileName : "TestAll.hx", lineNumber : 19, className : "TestAll", methodName : "testDecode"});
		utest_Assert.same([["",""]],thx_csv_Dsv.decode(",",thx_csv_Csv.decodeOptions),null,null,null,{ fileName : "TestAll.hx", lineNumber : 20, className : "TestAll", methodName : "testDecode"});
		utest_Assert.same([["f",""]],thx_csv_Dsv.decode("f,",thx_csv_Csv.decodeOptions),null,null,null,{ fileName : "TestAll.hx", lineNumber : 21, className : "TestAll", methodName : "testDecode"});
		utest_Assert.same([["","f"]],thx_csv_Dsv.decode(",f",thx_csv_Csv.decodeOptions),null,null,null,{ fileName : "TestAll.hx", lineNumber : 22, className : "TestAll", methodName : "testDecode"});
		utest_Assert.same([["x","y"]],thx_csv_Dsv.decode("x,y",thx_csv_Csv.decodeOptions),null,null,null,{ fileName : "TestAll.hx", lineNumber : 23, className : "TestAll", methodName : "testDecode"});
		utest_Assert.same([["",""],["",""]],thx_csv_Dsv.decode(",\n,",thx_csv_Csv.decodeOptions),null,null,null,{ fileName : "TestAll.hx", lineNumber : 24, className : "TestAll", methodName : "testDecode"});
		utest_Assert.same([["",""],[""],["",""]],thx_csv_Dsv.decode(",\n\n,",thx_csv_Csv.decodeOptions),null,null,null,{ fileName : "TestAll.hx", lineNumber : 25, className : "TestAll", methodName : "testDecode"});
		utest_Assert.same([["",""],[""],["",""]],thx_csv_Dsv.decode(",\n\"\"\n,",thx_csv_Csv.decodeOptions),null,null,null,{ fileName : "TestAll.hx", lineNumber : 26, className : "TestAll", methodName : "testDecode"});
		utest_Assert.same([["1997","Ford","E350"]],[["1997","Ford","E350"]],null,null,null,{ fileName : "TestAll.hx", lineNumber : 27, className : "TestAll", methodName : "testDecode"});
		utest_Assert.same([["1997","Ford","E350"]],thx_csv_Dsv.decode("1997,Ford,E350",thx_csv_Csv.decodeOptions),null,null,null,{ fileName : "TestAll.hx", lineNumber : 28, className : "TestAll", methodName : "testDecode"});
		utest_Assert.same([["1997","Ford","E350"]],thx_csv_Dsv.decode("\"1997\",\"Ford\",\"E350\"",thx_csv_Csv.decodeOptions),null,null,null,{ fileName : "TestAll.hx", lineNumber : 29, className : "TestAll", methodName : "testDecode"});
		utest_Assert.same([["1997","Ford","E350","Super, luxurious truck"]],thx_csv_Dsv.decode("1997,Ford,E350,\"Super, luxurious truck\"",thx_csv_Csv.decodeOptions),null,null,null,{ fileName : "TestAll.hx", lineNumber : 30, className : "TestAll", methodName : "testDecode"});
		utest_Assert.same([["1997","Ford","E350","Super, \"luxurious\" truck"]],thx_csv_Dsv.decode("1997,Ford,E350,\"Super, \"\"luxurious\"\" truck\"",thx_csv_Csv.decodeOptions),null,null,null,{ fileName : "TestAll.hx", lineNumber : 31, className : "TestAll", methodName : "testDecode"});
		utest_Assert.same([["1997","Ford","E350","Go get one now\nthey are going fast"]],thx_csv_Dsv.decode("1997,Ford,E350,\"Go get one now\nthey are going fast\"",thx_csv_Csv.decodeOptions),null,null,null,{ fileName : "TestAll.hx", lineNumber : 32, className : "TestAll", methodName : "testDecode"});
	}
	,testIssue20160125: function() {
		...
		utest_Assert.same([["265671209","Dynagreen Environmental Protection Group Co., Ltd.","1330","China","HKD",""]],decoded,null,null,null,{ fileName : "TestAll.hx", lineNumber : 39, className : "TestAll", methodName : "testIssue20160125"});
		utest_Assert.same("265671209,\"Dynagreen Environmental Protection Group Co., Ltd.\",1330,China,HKD,",encoded,null,null,null,{ fileName : "TestAll.hx", lineNumber : 42, className : "TestAll", methodName : "testIssue20160125"});
	}
	,testTerminalComma: function() {
		...
		var encoded = thx_csv_Dsv.encode(decoded,thx_csv_Csv.encodeOptions);
		utest_Assert.same([["Company ID","Name","Ticker","Country","Currency",""],["24085","1-800-Flowers.com Inc.","FLWS","United States","USD",""]],decoded,null,null,null,{ fileName : "TestAll.hx", lineNumber : 50, className : "TestAll", methodName : "testTerminalComma"});
		utest_Assert.same("Company ID,Name,Ticker,Country,Currency,\n24085,1-800-Flowers.com Inc.,FLWS,United States,USD,",encoded,null,null,null,{ fileName : "TestAll.hx", lineNumber : 54, className : "TestAll", methodName : "testTerminalComma"});
	}
	,testRoundtrip: function() {
		...
		var encoded = thx_csv_Dsv.encode(decoded,thx_csv_Csv.encodeOptions);
		utest_Assert.same([["Year","Make","Model","Description","Price"],["1997","Ford","E350","ac, abs, moon","3000.00"],["1999","Chevy","Venture \"Extended Edition\"","","4900.00"],["1999","Chevy","Venture \"Extended Edition, Very Large\"","","5000.00"],["1996","Jeep","Grand Cherokee","MUST SELL!\nair, moon roof, loaded","4799.00"]],decoded,null,null,null,{ fileName : "TestAll.hx", lineNumber : 67, className : "TestAll", methodName : "testRoundtrip"});
		utest_Assert.same("Year,Make,Model,Description,Price\n1997,Ford,E350,\"ac, abs, moon\",3000.00\n1999,Chevy,\"Venture \"\"Extended Edition\"\"\",,4900.00\n1999,Chevy,\"Venture \"\"Extended Edition, Very Large\"\"\",,5000.00\n1996,Jeep,Grand Cherokee,\"MUST SELL!\nair, moon roof, loaded\",4799.00",encoded,null,null,null,{ fileName : "TestAll.hx", lineNumber : 74, className : "TestAll", methodName : "testRoundtrip"});
	}
	,testSemicolon: function() {
		utest_Assert.equals("Year;Make;Model;Length\n1997;Ford;E350;2,34\n2000;Mercury;Cougar;2,38",thx_csv_Dsv.encode(thx_csv_Dsv.decode("Year;Make;Model;Length\n1997;Ford;E350;2,34\n2000;Mercury;Cougar;2,38",{ quote : "\"", escapedQuote : "\"\"", delimiter : ";", trimValues : false}),{ quote : "\"", escapedQuote : "\"\"", delimiter : ";", newline : "\n"}),null,{ fileName : "TestAll.hx", lineNumber : 88, className : "TestAll", methodName : "testSemicolon"});
	}
	,testAutoTrim: function() {
		var encoded = thx_csv_Dsv.decode("1997 , Ford, E350",{ quote : "\"", escapedQuote : "\"\"", delimiter : ",", trimValues : true});
		utest_Assert.same([["1997","Ford","E350"]],encoded,null,null,null,{ fileName : "TestAll.hx", lineNumber : 94, className : "TestAll", methodName : "testAutoTrim"});
		encoded = thx_csv_Dsv.decode("1997 , Ford, E350",{ quote : "\"", escapedQuote : "\"\"", delimiter : ",", trimValues : false});
		utest_Assert.same([["1997 "," Ford"," E350"]],encoded,null,null,null,{ fileName : "TestAll.hx", lineNumber : 96, className : "TestAll", methodName : "testAutoTrim"});
		utest_Assert.same([["1997","Ford","E350"," Super, luxurious truck "]],thx_csv_Dsv.decode("1997,Ford,E350,\" Super, luxurious truck \"",thx_csv_Csv.decodeOptions),null,null,null,{ fileName : "TestAll.hx", lineNumber : 97, className : "TestAll", methodName : "testAutoTrim"});
	}
	,testSurroundingWhitespaces: function() {
		utest_Assert.same([["1997"," \"Ford\" ","E350"]],thx_csv_Dsv.decode("1997, \"Ford\" ,E350",thx_csv_Csv.decodeOptions),null,null,null,{ fileName : "TestAll.hx", lineNumber : 101, className : "TestAll", methodName : "testSurroundingWhitespaces"});
	}
	,testTsv: function() {
		utest_Assert.same([["1997 "," Ford "," E350"]],thx_csv_Dsv.decode("1997 \t Ford \t E350",thx_csv_Tsv.decodeOptions),null,null,null,{ fileName : "TestAll.hx", lineNumber : 105, className : "TestAll", methodName : "testTsv"});
	}
	,__class__: TestAll
};
