...
TS1.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS1.hx", lineNumber : 16, className : "TS1", methodName : "addTests"});
	runner.addCase(new thx_csv_TestCsv(Std.parseInt(w)));
};
TS1.main = function() {
...
thx_csv_Dsv.encode = function(data,options) {
	...
	return data.map(function(row) {
		return row.map(function(cell) {
			if(thx_csv_Dsv.requiresQuotes(cell,options.delimiter,options.quote)) {
...
thx_csv_Dsv.objectsToArray = function(objects,columns) {
	...
	while(_g2 < objects.length) {
		...
		row = [];
		var _g11 = 0;
		var _g21 = Reflect.fields(object);
...
var thx_csv_TestCsv = function(i) {
	this.x = i;
};
thx_csv_TestCsv.__name__ = ["thx","csv","TestCsv"];
thx_csv_TestCsv.prototype = {
	x: null
	,testEncode: function() {
		var _g1 = 0;
		var _g = this.x;
		while(_g1 < _g) {
			++_g1;
			utest_Assert.same("1997,Ford,E350",thx_csv_Dsv.encode([["1997","Ford","E350"]],thx_csv_Csv.encodeOptions),null,null,null,{ fileName : "TestCsv.hx", lineNumber : 13, className : "thx.csv.TestCsv", methodName : "testEncode"});
			utest_Assert.same("1997,Ford,E350,\"Super, luxurious truck\"",thx_csv_Dsv.encode([["1997","Ford","E350","Super, luxurious truck"]],thx_csv_Csv.encodeOptions),null,null,null,{ fileName : "TestCsv.hx", lineNumber : 14, className : "thx.csv.TestCsv", methodName : "testEncode"});
			utest_Assert.same("1997,Ford,E350,\"Super, \"\"luxurious\"\" truck\"",thx_csv_Dsv.encode([["1997","Ford","E350","Super, \"luxurious\" truck"]],thx_csv_Csv.encodeOptions),null,null,null,{ fileName : "TestCsv.hx", lineNumber : 15, className : "thx.csv.TestCsv", methodName : "testEncode"});
			utest_Assert.same("1997,Ford,E350,\"Go get one now\nthey are going fast\"",thx_csv_Dsv.encode([["1997","Ford","E350","Go get one now\nthey are going fast"]],thx_csv_Csv.encodeOptions),null,null,null,{ fileName : "TestCsv.hx", lineNumber : 16, className : "thx.csv.TestCsv", methodName : "testEncode"});
		}
	}
	,testDecode: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.same([],thx_csv_Dsv.decode("",thx_csv_Csv.decodeOptions),null,null,null,{ fileName : "TestCsv.hx", lineNumber : 21, className : "thx.csv.TestCsv", methodName : "testDecode"});
			utest_Assert.same([["",""]],thx_csv_Dsv.decode(",",thx_csv_Csv.decodeOptions),null,null,null,{ fileName : "TestCsv.hx", lineNumber : 22, className : "thx.csv.TestCsv", methodName : "testDecode"});
			utest_Assert.same([["f",""]],thx_csv_Dsv.decode("f,",thx_csv_Csv.decodeOptions),null,null,null,{ fileName : "TestCsv.hx", lineNumber : 23, className : "thx.csv.TestCsv", methodName : "testDecode"});
			utest_Assert.same([["","f"]],thx_csv_Dsv.decode(",f",thx_csv_Csv.decodeOptions),null,null,null,{ fileName : "TestCsv.hx", lineNumber : 24, className : "thx.csv.TestCsv", methodName : "testDecode"});
			utest_Assert.same([["x","y"]],thx_csv_Dsv.decode("x,y",thx_csv_Csv.decodeOptions),null,null,null,{ fileName : "TestCsv.hx", lineNumber : 25, className : "thx.csv.TestCsv", methodName : "testDecode"});
			utest_Assert.same([["",""],["",""]],thx_csv_Dsv.decode(",\n,",thx_csv_Csv.decodeOptions),null,null,null,{ fileName : "TestCsv.hx", lineNumber : 26, className : "thx.csv.TestCsv", methodName : "testDecode"});
			utest_Assert.same([["",""],[""],["",""]],thx_csv_Dsv.decode(",\n\n,",thx_csv_Csv.decodeOptions),null,null,null,{ fileName : "TestCsv.hx", lineNumber : 27, className : "thx.csv.TestCsv", methodName : "testDecode"});
			utest_Assert.same([["",""],[""],["",""]],thx_csv_Dsv.decode(",\n\"\"\n,",thx_csv_Csv.decodeOptions),null,null,null,{ fileName : "TestCsv.hx", lineNumber : 28, className : "thx.csv.TestCsv", methodName : "testDecode"});
			utest_Assert.same([["1997","Ford","E350"]],[["1997","Ford","E350"]],null,null,null,{ fileName : "TestCsv.hx", lineNumber : 29, className : "thx.csv.TestCsv", methodName : "testDecode"});
			utest_Assert.same([["1997","Ford","E350"]],thx_csv_Dsv.decode("1997,Ford,E350",thx_csv_Csv.decodeOptions),null,null,null,{ fileName : "TestCsv.hx", lineNumber : 30, className : "thx.csv.TestCsv", methodName : "testDecode"});
			utest_Assert.same([["1997","Ford","E350"]],thx_csv_Dsv.decode("\"1997\",\"Ford\",\"E350\"",thx_csv_Csv.decodeOptions),null,null,null,{ fileName : "TestCsv.hx", lineNumber : 31, className : "thx.csv.TestCsv", methodName : "testDecode"});
			utest_Assert.same([["1997","Ford","E350","Super, luxurious truck"]],thx_csv_Dsv.decode("1997,Ford,E350,\"Super, luxurious truck\"",thx_csv_Csv.decodeOptions),null,null,null,{ fileName : "TestCsv.hx", lineNumber : 32, className : "thx.csv.TestCsv", methodName : "testDecode"});
			utest_Assert.same([["1997","Ford","E350","Super, \"luxurious\" truck"]],thx_csv_Dsv.decode("1997,Ford,E350,\"Super, \"\"luxurious\"\" truck\"",thx_csv_Csv.decodeOptions),null,null,null,{ fileName : "TestCsv.hx", lineNumber : 33, className : "thx.csv.TestCsv", methodName : "testDecode"});
			utest_Assert.same([["1997","Ford","E350","Go get one now\nthey are going fast"]],thx_csv_Dsv.decode("1997,Ford,E350,\"Go get one now\nthey are going fast\"",thx_csv_Csv.decodeOptions),null,null,null,{ fileName : "TestCsv.hx", lineNumber : 34, className : "thx.csv.TestCsv", methodName : "testDecode"});
		}
	}
	,testIssue20160125: function() {
		var _g1 = 0;
		var _g = this.x;
		while(_g1 < _g) {
			++_g1;
			var decoded = thx_csv_Dsv.decode("265671209,\"Dynagreen Environmental Protection Group Co., Ltd.\",1330,China,HKD,",thx_csv_Csv.decodeOptions);
			var encoded = thx_csv_Dsv.encode(decoded,thx_csv_Csv.encodeOptions);
			utest_Assert.same([["265671209","Dynagreen Environmental Protection Group Co., Ltd.","1330","China","HKD",""]],decoded,null,null,null,{ fileName : "TestCsv.hx", lineNumber : 42, className : "thx.csv.TestCsv", methodName : "testIssue20160125"});
			utest_Assert.same("265671209,\"Dynagreen Environmental Protection Group Co., Ltd.\",1330,China,HKD,",encoded,null,null,null,{ fileName : "TestCsv.hx", lineNumber : 45, className : "thx.csv.TestCsv", methodName : "testIssue20160125"});
		}
	}
	,testTerminalComma: function() {
		var _g1 = 0;
		var _g = this.x;
		while(_g1 < _g) {
			++_g1;
			var decoded = thx_csv_Dsv.decode("Company ID,Name,Ticker,Country,Currency,\n24085,1-800-Flowers.com Inc.,FLWS,United States,USD,",thx_csv_Csv.decodeOptions);
			var encoded = thx_csv_Dsv.encode(decoded,thx_csv_Csv.encodeOptions);
			utest_Assert.same([["Company ID","Name","Ticker","Country","Currency",""],["24085","1-800-Flowers.com Inc.","FLWS","United States","USD",""]],decoded,null,null,null,{ fileName : "TestCsv.hx", lineNumber : 54, className : "thx.csv.TestCsv", methodName : "testTerminalComma"});
			utest_Assert.same("Company ID,Name,Ticker,Country,Currency,\n24085,1-800-Flowers.com Inc.,FLWS,United States,USD,",encoded,null,null,null,{ fileName : "TestCsv.hx", lineNumber : 58, className : "thx.csv.TestCsv", methodName : "testTerminalComma"});
		}
	}
	,testRoundtrip: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var decoded = thx_csv_Dsv.decode("Year,Make,Model,Description,Price\n1997,Ford,E350,\"ac, abs, moon\",3000.00\n1999,Chevy,\"Venture \"\"Extended Edition\"\"\",\"\",4900.00\n1999,Chevy,\"Venture \"\"Extended Edition, Very Large\"\"\",,5000.00\n1996,Jeep,Grand Cherokee,\"MUST SELL!\nair, moon roof, loaded\",4799.00",thx_csv_Csv.decodeOptions);
			var encoded = thx_csv_Dsv.encode(decoded,thx_csv_Csv.encodeOptions);
			utest_Assert.same([["Year","Make","Model","Description","Price"],["1997","Ford","E350","ac, abs, moon","3000.00"],["1999","Chevy","Venture \"Extended Edition\"","","4900.00"],["1999","Chevy","Venture \"Extended Edition, Very Large\"","","5000.00"],["1996","Jeep","Grand Cherokee","MUST SELL!\nair, moon roof, loaded","4799.00"]],decoded,null,null,null,{ fileName : "TestCsv.hx", lineNumber : 72, className : "thx.csv.TestCsv", methodName : "testRoundtrip"});
			utest_Assert.same("Year,Make,Model,Description,Price\n1997,Ford,E350,\"ac, abs, moon\",3000.00\n1999,Chevy,\"Venture \"\"Extended Edition\"\"\",,4900.00\n1999,Chevy,\"Venture \"\"Extended Edition, Very Large\"\"\",,5000.00\n1996,Jeep,Grand Cherokee,\"MUST SELL!\nair, moon roof, loaded\",4799.00",encoded,null,null,null,{ fileName : "TestCsv.hx", lineNumber : 79, className : "thx.csv.TestCsv", methodName : "testRoundtrip"});
		}
	}
	,testSemicolon: function() {
		var _g1 = 0;
		var _g = this.x;
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("Year;Make;Model;Length\n1997;Ford;E350;2,34\n2000;Mercury;Cougar;2,38",thx_csv_Dsv.encode(thx_csv_Dsv.decode("Year;Make;Model;Length\n1997;Ford;E350;2,34\n2000;Mercury;Cougar;2,38",{ quote : "\"", escapedQuote : "\"\"", delimiter : ";", trimValues : false}),{ quote : "\"", escapedQuote : "\"\"", delimiter : ";", newline : "\n"}),null,{ fileName : "TestCsv.hx", lineNumber : 94, className : "thx.csv.TestCsv", methodName : "testSemicolon"});
		}
	}
	,testAutoTrim: function() {
		var _g1 = 0;
		var _g = this.x;
		while(_g1 < _g) {
			++_g1;
			var encoded = thx_csv_Dsv.decode("1997 , Ford, E350",{ quote : "\"", escapedQuote : "\"\"", delimiter : ",", trimValues : true});
			utest_Assert.same([["1997","Ford","E350"]],encoded,null,null,null,{ fileName : "TestCsv.hx", lineNumber : 101, className : "thx.csv.TestCsv", methodName : "testAutoTrim"});
			encoded = thx_csv_Dsv.decode("1997 , Ford, E350",{ quote : "\"", escapedQuote : "\"\"", delimiter : ",", trimValues : false});
			utest_Assert.same([["1997 "," Ford"," E350"]],encoded,null,null,null,{ fileName : "TestCsv.hx", lineNumber : 103, className : "thx.csv.TestCsv", methodName : "testAutoTrim"});
			utest_Assert.same([["1997","Ford","E350"," Super, luxurious truck "]],thx_csv_Dsv.decode("1997,Ford,E350,\" Super, luxurious truck \"",thx_csv_Csv.decodeOptions),null,null,null,{ fileName : "TestCsv.hx", lineNumber : 104, className : "thx.csv.TestCsv", methodName : "testAutoTrim"});
		}
	}
	,testSurroundingWhitespaces: function() {
		var _g1 = 0;
		var _g = this.x;
		while(_g1 < _g) {
			++_g1;
			utest_Assert.same([["1997"," \"Ford\" ","E350"]],thx_csv_Dsv.decode("1997, \"Ford\" ,E350",thx_csv_Csv.decodeOptions),null,null,null,{ fileName : "TestCsv.hx", lineNumber : 109, className : "thx.csv.TestCsv", methodName : "testSurroundingWhitespaces"});
		}
	}
	,testTsv: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.same([["1997 "," Ford "," E350"]],thx_csv_Dsv.decode("1997   Ford    E350",thx_csv_Tsv.decodeOptions),null,null,null,{ fileName : "TestCsv.hx", lineNumber : 114, className : "thx.csv.TestCsv", methodName : "testTsv"});
		}
	}
	,__class__: thx_csv_TestCsv
};
var thx_csv_Tsv = function() { };
thx_csv_Tsv.__name__ = ["thx","csv","Tsv"];
thx_csv_Tsv.decode = function(csv) {
	return thx_csv_Dsv.decode(csv,thx_csv_Tsv.decodeOptions);
};
thx_csv_Tsv.decodeObjects = function(tsv) {
	return thx_csv_Dsv.arrayToObjects(thx_csv_Dsv.decode(tsv,thx_csv_Tsv.decodeOptions));
};
thx_csv_Tsv.encode = function(data) {
	return thx_csv_Dsv.encode(data,thx_csv_Tsv.encodeOptions);
};
thx_csv_Tsv.encodeObjects = function(data) {
...
thx_csv_core_Parser.prototype = {
	...
	,parse: function(s) {
		...
		try {
			...
			haxe_CallStack.lastException = e;
			if (e instanceof js__$Boot_HaxeError) e = e.val;
			haxe_Log.trace(e,{ fileName : "Parser.hx", lineNumber : 39, className : "thx.csv.core.Parser", methodName : "parse"});
			throw new thx_Error("unable to parse at pos " + this.pos + ": " + Std.string(e),null,{ fileName : "Parser.hx", lineNumber : 40, className : "thx.csv.core.Parser", methodName : "parse"});
		}
		this.pushCell();
		this.pushRow();
		return this.result;
...
thx_csv_Tsv.encodeOptions = { delimiter : "\t", quote : "\"", escapedQuote : "\"\"", newline : "\n"};
thx_csv_Tsv.decodeOptions = { delimiter : "\t", quote : "\"", escapedQuote : "\"\"", trimValues : false, trimEmptyLines : true};
