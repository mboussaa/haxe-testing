...
TS7.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS7.hx", lineNumber : 10, className : "TS7", methodName : "addTests"});
	runner.addCase(new thx_TestChar(Std.parseInt(w)));
};
TS7.main = function() {
...
thx_TestChar.prototype = {
	...
	,testChar: function() {
		...
		while(_g1 < _g) {
			...
			var $char = 120;
			utest_Assert.equals(120,$char,null,{ fileName : "TestChar.hx", lineNumber : 17, className : "thx.TestChar", methodName : "testChar"});
			String.fromCharCode($char);
			utest_Assert.equals("x","x",null,{ fileName : "TestChar.hx", lineNumber : 18, className : "thx.TestChar", methodName : "testChar"});
			var i = HxOverrides.cca("y",0);
			thx_Assert.isTrue(i >= 0,"Char value should be greater than zero: " + i,{ fileName : "Char.hx", lineNumber : 19, className : "thx._Char.Char_Impl_", methodName : "fromInt"});
			$char = i;
			utest_Assert.equals(121,$char,null,{ fileName : "TestChar.hx", lineNumber : 22, className : "thx.TestChar", methodName : "testChar"});
			utest_Assert.equals("y",String.fromCharCode($char),null,{ fileName : "TestChar.hx", lineNumber : 23, className : "thx.TestChar", methodName : "testChar"});
			utest_Assert.equals(89,thx__$Char_Char_$Impl_$.toUpperCase($char),null,{ fileName : "TestChar.hx", lineNumber : 25, className : "thx.TestChar", methodName : "testChar"});
			utest_Assert.equals("Y",String.fromCharCode(thx__$Char_Char_$Impl_$.toUpperCase($char)),null,{ fileName : "TestChar.hx", lineNumber : 26, className : "thx.TestChar", methodName : "testChar"});
			$char = thx__$Char_Char_$Impl_$.next($char);
			utest_Assert.equals(122,$char,null,{ fileName : "TestChar.hx", lineNumber : 30, className : "thx.TestChar", methodName : "testChar"});
			utest_Assert.equals("z",String.fromCharCode($char),null,{ fileName : "TestChar.hx", lineNumber : 31, className : "thx.TestChar", methodName : "testChar"});
			utest_Assert.equals(121,thx__$Char_Char_$Impl_$.prev($char),null,{ fileName : "TestChar.hx", lineNumber : 33, className : "thx.TestChar", methodName : "testChar"});
		}
	}
	,testControl: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.isTrue(thx__$Char_Char_$Impl_$.isControl(7),null,{ fileName : "TestChar.hx", lineNumber : 38, className : "thx.TestChar", methodName : "testControl"});
			var i = HxOverrides.cca("x",0);
			thx_Assert.isTrue(i >= 0,"Char value should be greater than zero: " + i,{ fileName : "Char.hx", lineNumber : 19, className : "thx._Char.Char_Impl_", methodName : "fromInt"});
			utest_Assert.isFalse(thx__$Char_Char_$Impl_$.isControl(i),null,{ fileName : "TestChar.hx", lineNumber : 39, className : "thx.TestChar", methodName : "testControl"});
		}
	}
	,testUtf8: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			thx_Assert.isTrue(i >= 0,"Char value should be greater than zero: " + i,{ fileName : "Char.hx", lineNumber : 19, className : "thx._Char.Char_Impl_", methodName : "fromInt"});
			utest_Assert.equals(9786,i,null,{ fileName : "TestChar.hx", lineNumber : 44, className : "thx.TestChar", methodName : "testUtf8"});
			...
			utest_Assert.equals("☺",String.fromCharCode(9786),null,{ fileName : "TestChar.hx", lineNumber : 45, className : "thx.TestChar", methodName : "testUtf8"});
		}
	}
	,testArrayToString: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.equals("xyz",thx__$Char_Char_$Impl_$.arrayToString([tmp,tmp1,122]),null,{ fileName : "TestChar.hx", lineNumber : 51, className : "thx.TestChar", methodName : "testArrayToString"});
		}
	}
