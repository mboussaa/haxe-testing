...
TS39.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS39.hx", lineNumber : 10, className : "TS39", methodName : "addTests"});
	runner.addCase(new thx_TestStaticResource(Std.parseInt(w)));
};
TS39.main = function() {
...
var thx_TestStaticResource = function(i) {
	this.x = i;
};
...
thx_TestStaticResource.prototype = {
	...
	,testBasics: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals(1,thx_ResourceTest.a,null,{ fileName : "TestStaticResource.hx", lineNumber : 13, className : "thx.TestStaticResource", methodName : "testBasics"});
			utest_Assert.notNull(thx_ResourceTest.b,null,{ fileName : "TestStaticResource.hx", lineNumber : 14, className : "thx.TestStaticResource", methodName : "testBasics"});
			utest_Assert.equals("thx",thx_ResourceTest.b.s,null,{ fileName : "TestStaticResource.hx", lineNumber : 15, className : "thx.TestStaticResource", methodName : "testBasics"});
			utest_Assert.isTrue(thx_ResourceTest.c,null,{ fileName : "TestStaticResource.hx", lineNumber : 16, className : "thx.TestStaticResource", methodName : "testBasics"});
			utest_Assert.equals("haxe",thx_ResourceTest.d,null,{ fileName : "TestStaticResource.hx", lineNumber : 17, className : "thx.TestStaticResource", methodName : "testBasics"});
			utest_Assert.equals("value",thx_ResourceTest.fileJson.some,null,{ fileName : "TestStaticResource.hx", lineNumber : 18, className : "thx.TestStaticResource", methodName : "testBasics"});
			utest_Assert.equals("some text\n",thx_ResourceTest.fileText,null,{ fileName : "TestStaticResource.hx", lineNumber : 19, className : "thx.TestStaticResource", methodName : "testBasics"});
		}
	}
	,testDir: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("some text\n",thx_ResourceDir.text,null,{ fileName : "TestStaticResource.hx", lineNumber : 24, className : "thx.TestStaticResource", methodName : "testDir"});
			utest_Assert.equals("value",thx_ResourceDir.object.some,null,{ fileName : "TestStaticResource.hx", lineNumber : 25, className : "thx.TestStaticResource", methodName : "testDir"});
		}
	}
