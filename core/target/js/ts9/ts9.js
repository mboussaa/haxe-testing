...
TS9.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS9.hx", lineNumber : 10, className : "TS9", methodName : "addTests"});
	runner.addCase(new thx_TestConvert(Std.parseInt(w)));
};
TS9.main = function() {
...
var thx_TestConvert = function(i) {
	this.x = i;
};
...
thx_TestConvert.prototype = {
	...
	,testString: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("1",thx_Convert.toString(1),null,{ fileName : "TestConvert.hx", lineNumber : 13, className : "thx.TestConvert", methodName : "testString"});
			utest_Assert.equals("1",thx_Convert.toStringOr(null,"1"),null,{ fileName : "TestConvert.hx", lineNumber : 14, className : "thx.TestConvert", methodName : "testString"});
		}
	}
	,testInt: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals(1,thx_Convert.toInt("1"),null,{ fileName : "TestConvert.hx", lineNumber : 19, className : "thx.TestConvert", methodName : "testInt"});
			utest_Assert.equals(1,thx_Convert.toInt(true),null,{ fileName : "TestConvert.hx", lineNumber : 20, className : "thx.TestConvert", methodName : "testInt"});
			utest_Assert.equals(0,thx_Convert.toInt(false),null,{ fileName : "TestConvert.hx", lineNumber : 21, className : "thx.TestConvert", methodName : "testInt"});
			utest_Assert.equals(1,thx_Convert.toInt(1.1),null,{ fileName : "TestConvert.hx", lineNumber : 22, className : "thx.TestConvert", methodName : "testInt"});
			utest_Assert.equals(1,thx_Convert.toIntOr("z",1),null,{ fileName : "TestConvert.hx", lineNumber : 24, className : "thx.TestConvert", methodName : "testInt"});
		}
	}
	,testFloat: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals(1,thx_Convert.toFloat("1"),null,{ fileName : "TestConvert.hx", lineNumber : 29, className : "thx.TestConvert", methodName : "testFloat"});
			utest_Assert.equals(1,thx_Convert.toFloat(true),null,{ fileName : "TestConvert.hx", lineNumber : 30, className : "thx.TestConvert", methodName : "testFloat"});
			utest_Assert.equals(0,thx_Convert.toFloat(false),null,{ fileName : "TestConvert.hx", lineNumber : 31, className : "thx.TestConvert", methodName : "testFloat"});
			utest_Assert.equals(1.1,thx_Convert.toFloat(1.1),null,{ fileName : "TestConvert.hx", lineNumber : 32, className : "thx.TestConvert", methodName : "testFloat"});
			utest_Assert.equals(1.1,thx_Convert.toFloatOr("z",1.1),null,{ fileName : "TestConvert.hx", lineNumber : 34, className : "thx.TestConvert", methodName : "testFloat"});
		}
	}
	,testBool: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals(true,thx_Convert.toBool("1"),null,{ fileName : "TestConvert.hx", lineNumber : 39, className : "thx.TestConvert", methodName : "testBool"});
			utest_Assert.equals(true,thx_Convert.toBool(true),null,{ fileName : "TestConvert.hx", lineNumber : 40, className : "thx.TestConvert", methodName : "testBool"});
			utest_Assert.equals(false,thx_Convert.toBool(false),null,{ fileName : "TestConvert.hx", lineNumber : 41, className : "thx.TestConvert", methodName : "testBool"});
			utest_Assert.equals(true,thx_Convert.toBool(1.1),null,{ fileName : "TestConvert.hx", lineNumber : 42, className : "thx.TestConvert", methodName : "testBool"});
			utest_Assert.equals(false,thx_Convert.toBool(0),null,{ fileName : "TestConvert.hx", lineNumber : 43, className : "thx.TestConvert", methodName : "testBool"});
			utest_Assert.equals(true,thx_Convert.toBoolOr("z",true),null,{ fileName : "TestConvert.hx", lineNumber : 45, className : "thx.TestConvert", methodName : "testBool"});
		}
	}
	,testMap: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			utest_Assert.equals("bar",thx_Convert.toMap(objOfArrays[0],(function() {
				return function(val) {
					return thx_Convert.toArray(val,thx_Convert.toString);
				};
			})()).get("foo")[0],null,{ fileName : "TestConvert.hx", lineNumber : 53, className : "thx.TestConvert", methodName : "testMap"});
			utest_Assert.equals(2,thx_Convert.toMap(objOfNumbers,thx_Convert.toInt).get("b"),null,{ fileName : "TestConvert.hx", lineNumber : 57, className : "thx.TestConvert", methodName : "testMap"});
			utest_Assert.raises((function() {
				return function() {
					thx_Convert.toMap(3,thx_Convert.toString);
				};
			})(),null,null,null,{ fileName : "TestConvert.hx", lineNumber : 59, className : "thx.TestConvert", methodName : "testMap"});
			utest_Assert.raises((function(objOfArrays1) {
				return function() {
					thx_Convert.toMap(objOfArrays1[0],thx_Convert.toString);
				};
			})(objOfArrays),null,null,null,{ fileName : "TestConvert.hx", lineNumber : 60, className : "thx.TestConvert", methodName : "testMap"});
		}
	}
	,testDateTimeUtc: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.isNull(value,null,{ fileName : "TestConvert.hx", lineNumber : 67, className : "thx.TestConvert", methodName : "testDateTimeUtc"});
		}
	}
