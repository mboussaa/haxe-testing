...
TS22.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS22.hx", lineNumber : 10, className : "TS22", methodName : "addTests"});
	runner.addCase(new thx_TestHashSet(Std.parseInt(w)));
};
TS22.main = function() {
	var runner = new utest_Runner();
	TS22.addTests(runner);
...
var thx_TestHashSet = function(i) {
	this.x = i;
};
...
thx_TestHashSet.prototype = {
	...
	,testCreate: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(3,thx__$HashSet_HashSet_$Impl_$.get_length(s),null,null,null,{ fileName : "TestHashSet.hx", lineNumber : 16, className : "thx.TestHashSet", methodName : "testCreate"});
			var key = new thx_TestItem(1).hashCode();
			utest_Assert.isTrue(s.values.h.hasOwnProperty(key),null,{ fileName : "TestHashSet.hx", lineNumber : 17, className : "thx.TestHashSet", methodName : "testCreate"});
		}
	}
	,testEmpty: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(1,thx__$HashSet_HashSet_$Impl_$.get_length(s1),null,null,null,{ fileName : "TestHashSet.hx", lineNumber : 24, className : "thx.TestHashSet", methodName : "testEmpty"});
			utest_Assert.same(0,thx__$HashSet_HashSet_$Impl_$.get_length(s2),null,null,null,{ fileName : "TestHashSet.hx", lineNumber : 25, className : "thx.TestHashSet", methodName : "testEmpty"});
		}
	}
	,testExists: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(2,thx__$HashSet_HashSet_$Impl_$.get_length(s),null,null,null,{ fileName : "TestHashSet.hx", lineNumber : 34, className : "thx.TestHashSet", methodName : "testExists"});
			var key = i1.hashCode();
			utest_Assert.isTrue(s.values.h.hasOwnProperty(key),null,{ fileName : "TestHashSet.hx", lineNumber : 35, className : "thx.TestHashSet", methodName : "testExists"});
			var key1 = new thx_TestItem(1).hashCode();
			utest_Assert.isTrue(s.values.h.hasOwnProperty(key1),null,{ fileName : "TestHashSet.hx", lineNumber : 36, className : "thx.TestHashSet", methodName : "testExists"});
			var key2 = i2a.hashCode();
			utest_Assert.isTrue(s.values.h.hasOwnProperty(key2),null,{ fileName : "TestHashSet.hx", lineNumber : 37, className : "thx.TestHashSet", methodName : "testExists"});
			var key3 = i2b.hashCode();
			utest_Assert.isTrue(s.values.h.hasOwnProperty(key3),null,{ fileName : "TestHashSet.hx", lineNumber : 38, className : "thx.TestHashSet", methodName : "testExists"});
			var key4 = new thx_TestItem(2).hashCode();
			utest_Assert.isTrue(s.values.h.hasOwnProperty(key4),null,{ fileName : "TestHashSet.hx", lineNumber : 39, className : "thx.TestHashSet", methodName : "testExists"});
		}
	}
	,testAdd: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			utest_Assert.isTrue(thx__$HashSet_HashSet_$Impl_$.add(s,new thx_TestItem(1)),null,{ fileName : "TestHashSet.hx", lineNumber : 45, className : "thx.TestHashSet", methodName : "testAdd"});
			utest_Assert.isTrue(thx__$HashSet_HashSet_$Impl_$.add(s,new thx_TestItem(2)),null,{ fileName : "TestHashSet.hx", lineNumber : 46, className : "thx.TestHashSet", methodName : "testAdd"});
			utest_Assert.isFalse(thx__$HashSet_HashSet_$Impl_$.add(s,new thx_TestItem(2)),null,{ fileName : "TestHashSet.hx", lineNumber : 47, className : "thx.TestHashSet", methodName : "testAdd"});
			utest_Assert.isTrue(thx__$HashSet_HashSet_$Impl_$.add(s,new thx_TestItem(3)),null,{ fileName : "TestHashSet.hx", lineNumber : 48, className : "thx.TestHashSet", methodName : "testAdd"});
			utest_Assert.isFalse(thx__$HashSet_HashSet_$Impl_$.add(s,new thx_TestItem(3)),null,{ fileName : "TestHashSet.hx", lineNumber : 49, className : "thx.TestHashSet", methodName : "testAdd"});
			utest_Assert.same(3,thx__$HashSet_HashSet_$Impl_$.get_length(s),null,null,null,{ fileName : "TestHashSet.hx", lineNumber : 50, className : "thx.TestHashSet", methodName : "testAdd"});
		}
	}
	,testPush: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			thx__$HashSet_HashSet_$Impl_$.add(s,new thx_TestItem(3));
			utest_Assert.same(3,thx__$HashSet_HashSet_$Impl_$.get_length(s),null,null,null,{ fileName : "TestHashSet.hx", lineNumber : 61, className : "thx.TestHashSet", methodName : "testPush"});
		}
	}
	,testRemove: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(1,thx__$HashSet_HashSet_$Impl_$.get_length(s),null,null,null,{ fileName : "TestHashSet.hx", lineNumber : 70, className : "thx.TestHashSet", methodName : "testRemove"});
			var v = new thx_TestItem(2);
			s.values.remove(v.hashCode());
			s.keys.remove(v.hashCode());
			utest_Assert.same(0,thx__$HashSet_HashSet_$Impl_$.get_length(s),null,null,null,{ fileName : "TestHashSet.hx", lineNumber : 72, className : "thx.TestHashSet", methodName : "testRemove"});
		}
	}
	,testCopy: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(2,thx__$HashSet_HashSet_$Impl_$.get_length(s1),null,null,null,{ fileName : "TestHashSet.hx", lineNumber : 81, className : "thx.TestHashSet", methodName : "testCopy"});
			utest_Assert.same(2,thx__$HashSet_HashSet_$Impl_$.get_length(s2),null,null,null,{ fileName : "TestHashSet.hx", lineNumber : 82, className : "thx.TestHashSet", methodName : "testCopy"});
			var key = i1.hashCode();
			utest_Assert.isTrue(s1.values.h.hasOwnProperty(key),null,{ fileName : "TestHashSet.hx", lineNumber : 83, className : "thx.TestHashSet", methodName : "testCopy"});
			var key1 = new thx_TestItem(2).hashCode();
			utest_Assert.isTrue(s1.values.h.hasOwnProperty(key1),null,{ fileName : "TestHashSet.hx", lineNumber : 84, className : "thx.TestHashSet", methodName : "testCopy"});
			var key2 = i1.hashCode();
			utest_Assert.isTrue(s2.values.h.hasOwnProperty(key2),null,{ fileName : "TestHashSet.hx", lineNumber : 85, className : "thx.TestHashSet", methodName : "testCopy"});
			var key3 = new thx_TestItem(2).hashCode();
			utest_Assert.isTrue(s2.values.h.hasOwnProperty(key3),null,{ fileName : "TestHashSet.hx", lineNumber : 86, className : "thx.TestHashSet", methodName : "testCopy"});
			thx__$HashSet_HashSet_$Impl_$.add(s1,new thx_TestItem(3));
			utest_Assert.same(3,thx__$HashSet_HashSet_$Impl_$.get_length(s1),null,null,null,{ fileName : "TestHashSet.hx", lineNumber : 88, className : "thx.TestHashSet", methodName : "testCopy"});
			utest_Assert.same(2,thx__$HashSet_HashSet_$Impl_$.get_length(s2),null,null,null,{ fileName : "TestHashSet.hx", lineNumber : 89, className : "thx.TestHashSet", methodName : "testCopy"});
		}
	}
	,testUnion: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(3,thx__$HashSet_HashSet_$Impl_$.get_length(s1),null,null,null,{ fileName : "TestHashSet.hx", lineNumber : 97, className : "thx.TestHashSet", methodName : "testUnion"});
			utest_Assert.same(4,thx__$HashSet_HashSet_$Impl_$.get_length(s2),null,null,null,{ fileName : "TestHashSet.hx", lineNumber : 98, className : "thx.TestHashSet", methodName : "testUnion"});
			utest_Assert.same(5,thx__$HashSet_HashSet_$Impl_$.get_length(newset),null,null,null,{ fileName : "TestHashSet.hx", lineNumber : 99, className : "thx.TestHashSet", methodName : "testUnion"});
			var key2 = new thx_TestItem(1).hashCode();
			utest_Assert.isTrue(newset.values.h.hasOwnProperty(key2),null,{ fileName : "TestHashSet.hx", lineNumber : 100, className : "thx.TestHashSet", methodName : "testUnion"});
			var key3 = new thx_TestItem(2).hashCode();
			utest_Assert.isTrue(newset.values.h.hasOwnProperty(key3),null,{ fileName : "TestHashSet.hx", lineNumber : 101, className : "thx.TestHashSet", methodName : "testUnion"});
			var key4 = new thx_TestItem(3).hashCode();
			utest_Assert.isTrue(newset.values.h.hasOwnProperty(key4),null,{ fileName : "TestHashSet.hx", lineNumber : 102, className : "thx.TestHashSet", methodName : "testUnion"});
			var key5 = new thx_TestItem(4).hashCode();
			utest_Assert.isTrue(newset.values.h.hasOwnProperty(key5),null,{ fileName : "TestHashSet.hx", lineNumber : 103, className : "thx.TestHashSet", methodName : "testUnion"});
			var key6 = new thx_TestItem(5).hashCode();
			utest_Assert.isTrue(newset.values.h.hasOwnProperty(key6),null,{ fileName : "TestHashSet.hx", lineNumber : 104, className : "thx.TestHashSet", methodName : "testUnion"});
		}
	}
	,testIntersection: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(3,thx__$HashSet_HashSet_$Impl_$.get_length(s1),null,null,null,{ fileName : "TestHashSet.hx", lineNumber : 112, className : "thx.TestHashSet", methodName : "testIntersection"});
			utest_Assert.same(4,thx__$HashSet_HashSet_$Impl_$.get_length(s2),null,null,null,{ fileName : "TestHashSet.hx", lineNumber : 113, className : "thx.TestHashSet", methodName : "testIntersection"});
			utest_Assert.same(2,thx__$HashSet_HashSet_$Impl_$.get_length(result),null,null,null,{ fileName : "TestHashSet.hx", lineNumber : 114, className : "thx.TestHashSet", methodName : "testIntersection"});
			var key3 = new thx_TestItem(2).hashCode();
			utest_Assert.isTrue(result.values.h.hasOwnProperty(key3),null,{ fileName : "TestHashSet.hx", lineNumber : 115, className : "thx.TestHashSet", methodName : "testIntersection"});
			var key4 = new thx_TestItem(3).hashCode();
			utest_Assert.isTrue(result.values.h.hasOwnProperty(key4),null,{ fileName : "TestHashSet.hx", lineNumber : 116, className : "thx.TestHashSet", methodName : "testIntersection"});
		}
	}
	,testDifference: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(3,thx__$HashSet_HashSet_$Impl_$.get_length(s1),null,null,null,{ fileName : "TestHashSet.hx", lineNumber : 125, className : "thx.TestHashSet", methodName : "testDifference"});
			utest_Assert.same(4,thx__$HashSet_HashSet_$Impl_$.get_length(s2),null,null,null,{ fileName : "TestHashSet.hx", lineNumber : 126, className : "thx.TestHashSet", methodName : "testDifference"});
			utest_Assert.same(1,thx__$HashSet_HashSet_$Impl_$.get_length(result),null,null,null,{ fileName : "TestHashSet.hx", lineNumber : 127, className : "thx.TestHashSet", methodName : "testDifference"});
			utest_Assert.same(2,thx__$HashSet_HashSet_$Impl_$.get_length(result1),null,null,null,{ fileName : "TestHashSet.hx", lineNumber : 128, className : "thx.TestHashSet", methodName : "testDifference"});
			var key = new thx_TestItem(1).hashCode();
			utest_Assert.isTrue(result.values.h.hasOwnProperty(key),null,{ fileName : "TestHashSet.hx", lineNumber : 129, className : "thx.TestHashSet", methodName : "testDifference"});
			var key1 = new thx_TestItem(4).hashCode();
			utest_Assert.isTrue(result1.values.h.hasOwnProperty(key1),null,{ fileName : "TestHashSet.hx", lineNumber : 130, className : "thx.TestHashSet", methodName : "testDifference"});
			var key2 = new thx_TestItem(5).hashCode();
			utest_Assert.isTrue(result1.values.h.hasOwnProperty(key2),null,{ fileName : "TestHashSet.hx", lineNumber : 131, className : "thx.TestHashSet", methodName : "testDifference"});
		}
	}
	,testSymmetricDifference: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(3,thx__$HashSet_HashSet_$Impl_$.get_length(s1),null,null,null,{ fileName : "TestHashSet.hx", lineNumber : 140, className : "thx.TestHashSet", methodName : "testSymmetricDifference"});
			utest_Assert.same(4,thx__$HashSet_HashSet_$Impl_$.get_length(s2),null,null,null,{ fileName : "TestHashSet.hx", lineNumber : 141, className : "thx.TestHashSet", methodName : "testSymmetricDifference"});
			utest_Assert.same(3,thx__$HashSet_HashSet_$Impl_$.get_length(result1),null,null,null,{ fileName : "TestHashSet.hx", lineNumber : 142, className : "thx.TestHashSet", methodName : "testSymmetricDifference"});
			utest_Assert.same(3,thx__$HashSet_HashSet_$Impl_$.get_length(result3),null,null,null,{ fileName : "TestHashSet.hx", lineNumber : 143, className : "thx.TestHashSet", methodName : "testSymmetricDifference"});
			var key10 = new thx_TestItem(1).hashCode();
			utest_Assert.isTrue(result1.values.h.hasOwnProperty(key10),null,{ fileName : "TestHashSet.hx", lineNumber : 144, className : "thx.TestHashSet", methodName : "testSymmetricDifference"});
			var key11 = new thx_TestItem(4).hashCode();
			utest_Assert.isTrue(result1.values.h.hasOwnProperty(key11),null,{ fileName : "TestHashSet.hx", lineNumber : 145, className : "thx.TestHashSet", methodName : "testSymmetricDifference"});
			var key12 = new thx_TestItem(5).hashCode();
			utest_Assert.isTrue(result1.values.h.hasOwnProperty(key12),null,{ fileName : "TestHashSet.hx", lineNumber : 146, className : "thx.TestHashSet", methodName : "testSymmetricDifference"});
			var key13 = new thx_TestItem(1).hashCode();
			utest_Assert.isTrue(result3.values.h.hasOwnProperty(key13),null,{ fileName : "TestHashSet.hx", lineNumber : 147, className : "thx.TestHashSet", methodName : "testSymmetricDifference"});
			var key14 = new thx_TestItem(4).hashCode();
			utest_Assert.isTrue(result3.values.h.hasOwnProperty(key14),null,{ fileName : "TestHashSet.hx", lineNumber : 148, className : "thx.TestHashSet", methodName : "testSymmetricDifference"});
			var key15 = new thx_TestItem(5).hashCode();
			utest_Assert.isTrue(result3.values.h.hasOwnProperty(key15),null,{ fileName : "TestHashSet.hx", lineNumber : 149, className : "thx.TestHashSet", methodName : "testSymmetricDifference"});
		}
	}
	,testToArray: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(2,a.length,null,null,null,{ fileName : "TestHashSet.hx", lineNumber : 156, className : "thx.TestHashSet", methodName : "testToArray"});
			utest_Assert.same(1,((function(_e) {
				return function(predicate) {
					return thx_Arrays.find(_e[0],predicate);
				};
			})([a]))((function() {
				return function(_) {
					return _.code == 1;
				};
			})()).code,null,null,null,{ fileName : "TestHashSet.hx", lineNumber : 157, className : "thx.TestHashSet", methodName : "testToArray"});
			utest_Assert.same(2,((function(_e1) {
				return function(predicate1) {
					return thx_Arrays.find(_e1[0],predicate1);
				};
			})([a]))((function() {
				return function(_1) {
					return _1.code == 2;
				};
			})()).code,null,null,null,{ fileName : "TestHashSet.hx", lineNumber : 158, className : "thx.TestHashSet", methodName : "testToArray"});
		}
	}
	,testToString: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.isTrue(new EReg("TestItem \\d, TestItem \\d}","").match(thx__$HashSet_HashSet_$Impl_$.toString(s)),null,{ fileName : "TestHashSet.hx", lineNumber : 164, className : "thx.TestHashSet", methodName : "testToString"});
		}
	}
