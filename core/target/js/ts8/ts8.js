...
TS8.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS8.hx", lineNumber : 10, className : "TS8", methodName : "addTests"});
	runner.addCase(new thx_TestChars(Std.parseInt(w)));
};
TS8.main = function() {
...
thx_TestChars.prototype = {
	...
	,testChars: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.same([97,9786,98,9786,9786,99,9786,9786,9786],t,null,null,null,{ fileName : "TestChars.hx", lineNumber : 18, className : "thx.TestChars", methodName : "testChars"});
			utest_Assert.equals("a☺b☺☺c☺☺☺",thx__$Chars_Chars_$Impl_$.toString(t),null,{ fileName : "TestChars.hx", lineNumber : 19, className : "thx.TestChars", methodName : "testChars"});
		}
	}
	,testArrayAccess: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.equals(9786,chars[1],null,{ fileName : "TestChars.hx", lineNumber : 25, className : "thx.TestChars", methodName : "testArrayAccess"});
			utest_Assert.equals(99,chars[5],null,{ fileName : "TestChars.hx", lineNumber : 26, className : "thx.TestChars", methodName : "testArrayAccess"});
		}
	}
