...
TS41.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS41.hx", lineNumber : 10, className : "TS41", methodName : "addTests"});
	runner.addCase(new thx_TestTime(Std.parseInt(w)));
};
TS41.main = function() {
	var runner = new utest_Runner();
	TS41.addTests(runner);
...
thx_TestTime.prototype = {
	...
	,testBasics: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.equals(10,x.low,null,{ fileName : "TestTime.hx", lineNumber : 16, className : "thx.TestTime", methodName : "testBasics"});
			...
			utest_Assert.equals(9,x1.low,null,{ fileName : "TestTime.hx", lineNumber : 17, className : "thx.TestTime", methodName : "testBasics"});
			...
			utest_Assert.equals(8,x2.low,null,{ fileName : "TestTime.hx", lineNumber : 18, className : "thx.TestTime", methodName : "testBasics"});
			...
			utest_Assert.equals(7,x3.low,null,{ fileName : "TestTime.hx", lineNumber : 19, className : "thx.TestTime", methodName : "testBasics"});
			...
			utest_Assert.equals(6,x4.low,null,{ fileName : "TestTime.hx", lineNumber : 20, className : "thx.TestTime", methodName : "testBasics"});
			...
			utest_Assert.equals(6000,x5.low,null,{ fileName : "TestTime.hx", lineNumber : 21, className : "thx.TestTime", methodName : "testBasics"});
			...
			utest_Assert.equals(60000,x6.low,null,{ fileName : "TestTime.hx", lineNumber : 22, className : "thx.TestTime", methodName : "testBasics"});
			...
			utest_Assert.equals(10,x7.low,null,{ fileName : "TestTime.hx", lineNumber : 24, className : "thx.TestTime", methodName : "testBasics"});
			...
			utest_Assert.equals(249,x8.low,null,{ fileName : "TestTime.hx", lineNumber : 25, className : "thx.TestTime", methodName : "testBasics"});
			...
			utest_Assert.equals(14948,x9.low,null,{ fileName : "TestTime.hx", lineNumber : 26, className : "thx.TestTime", methodName : "testBasics"});
			...
			utest_Assert.equals(896887,x10.low,null,{ fileName : "TestTime.hx", lineNumber : 27, className : "thx.TestTime", methodName : "testBasics"});
			...
			utest_Assert.equals(896887006,x11.low,null,{ fileName : "TestTime.hx", lineNumber : 28, className : "thx.TestTime", methodName : "testBasics"});
			utest_Assert.equals("896887006000",haxe__$Int64_Int64_$Impl_$.toString(haxe__$Int64_Int64_$Impl_$.divMod(time,thx__$DateTimeUtc_DateTimeUtc_$Impl_$.ticksPerMicrosecondI64).quotient),null,{ fileName : "TestTime.hx", lineNumber : 29, className : "thx.TestTime", methodName : "testBasics"});
		}
	}
	,testFromString: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.equals(5,x.low,null,{ fileName : "TestTime.hx", lineNumber : 35, className : "thx.TestTime", methodName : "testFromString"});
			utest_Assert.equals("125",haxe__$Int64_Int64_$Impl_$.toString(haxe__$Int64_Int64_$Impl_$.divMod(time,thx__$DateTimeUtc_DateTimeUtc_$Impl_$.ticksPerHourI64).quotient),null,{ fileName : "TestTime.hx", lineNumber : 36, className : "thx.TestTime", methodName : "testFromString"});
			var x1 = haxe__$Int64_Int64_$Impl_$.divMod(haxe__$Int64_Int64_$Impl_$.divMod(time,thx__$DateTimeUtc_DateTimeUtc_$Impl_$.ticksPerHourI64).quotient,new haxe__$Int64__$_$_$Int64(0,24)).modulus;
			if(x1.high != x1.low >> 31) {
				throw new js__$Boot_HaxeError("Overflow");
			}
			utest_Assert.equals(5,x1.low,null,{ fileName : "TestTime.hx", lineNumber : 37, className : "thx.TestTime", methodName : "testFromString"});
			var x2 = haxe__$Int64_Int64_$Impl_$.divMod(haxe__$Int64_Int64_$Impl_$.divMod(time,thx__$DateTimeUtc_DateTimeUtc_$Impl_$.ticksPerMinuteI64).quotient,new haxe__$Int64__$_$_$Int64(0,60)).modulus;
			if(x2.high != x2.low >> 31) {
				throw new js__$Boot_HaxeError("Overflow");
			}
			utest_Assert.equals(55,x2.low,null,{ fileName : "TestTime.hx", lineNumber : 38, className : "thx.TestTime", methodName : "testFromString"});
			var x3 = haxe__$Int64_Int64_$Impl_$.divMod(haxe__$Int64_Int64_$Impl_$.divMod(time,thx__$DateTimeUtc_DateTimeUtc_$Impl_$.ticksPerSecondI64).quotient,new haxe__$Int64__$_$_$Int64(0,60)).modulus;
			if(x3.high != x3.low >> 31) {
				throw new js__$Boot_HaxeError("Overflow");
			}
			utest_Assert.equals(45,x3.low,null,{ fileName : "TestTime.hx", lineNumber : 39, className : "thx.TestTime", methodName : "testFromString"});
			var x4 = haxe__$Int64_Int64_$Impl_$.divMod(haxe__$Int64_Int64_$Impl_$.divMod(time,thx__$DateTimeUtc_DateTimeUtc_$Impl_$.ticksPerMillisecondI64).quotient,thx__$DateTimeUtc_DateTimeUtc_$Impl_$.thousandI64).modulus;
			if(x4.high != x4.low >> 31) {
				throw new js__$Boot_HaxeError("Overflow");
			}
			utest_Assert.equals(123,x4.low,null,{ fileName : "TestTime.hx", lineNumber : 40, className : "thx.TestTime", methodName : "testFromString"});
			utest_Assert.equals("125:55:45.123",thx__$Time_Time_$Impl_$.toString(time),null,{ fileName : "TestTime.hx", lineNumber : 42, className : "thx.TestTime", methodName : "testFromString"});
			utest_Assert.equals("89:25:30.005",thx__$Time_Time_$Impl_$.toString(thx__$Time_Time_$Impl_$.fromString("3.17:25:30.005")),null,{ fileName : "TestTime.hx", lineNumber : 43, className : "thx.TestTime", methodName : "testFromString"});
			utest_Assert.equals("-89:25:30.05",thx__$Time_Time_$Impl_$.toString(thx__$Time_Time_$Impl_$.fromString("-3.17:25:30.05")),null,{ fileName : "TestTime.hx", lineNumber : 44, className : "thx.TestTime", methodName : "testFromString"});
		}
	}
