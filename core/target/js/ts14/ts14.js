...
TS14.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS14.hx", lineNumber : 10, className : "TS14", methodName : "addTests"});
	runner.addCase(new thx_TestDynamics(Std.parseInt(w)));
};
TS14.main = function() {
...
var thx_TestDynamics = function(i) {
	this.x = i;
};
...
thx_TestDynamics.prototype = {
	...
	,testDynamics: function() {
		...
		while(_g1 < _g) {
			var i = _g1++;
			utest_Assert.equals(null,thx_Dynamics.clone(null),null,{ fileName : "TestDynamics.hx", lineNumber : 15, className : "thx.TestDynamics", methodName : "testDynamics"});
			utest_Assert.equals(true,thx_Dynamics.clone(true),null,{ fileName : "TestDynamics.hx", lineNumber : 16, className : "thx.TestDynamics", methodName : "testDynamics"});
			utest_Assert.equals("hello",thx_Dynamics.clone("hello"),null,{ fileName : "TestDynamics.hx", lineNumber : 17, className : "thx.TestDynamics", methodName : "testDynamics"});
			utest_Assert.equals(3,thx_Dynamics.clone(3),null,{ fileName : "TestDynamics.hx", lineNumber : 18, className : "thx.TestDynamics", methodName : "testDynamics"});
			utest_Assert.equals(3.14,thx_Dynamics.clone(3.14),null,{ fileName : "TestDynamics.hx", lineNumber : 19, className : "thx.TestDynamics", methodName : "testDynamics"});
			utest_Assert.equals(ValueType.TBool,thx_Dynamics.clone(ValueType.TBool),null,{ fileName : "TestDynamics.hx", lineNumber : 20, className : "thx.TestDynamics", methodName : "testDynamics"});
			utest_Assert.isTrue(Type.enumEq(ValueType.TClass(thx_TestDynamics),thx_Dynamics.clone(ValueType.TClass(thx_TestDynamics))),null,{ fileName : "TestDynamics.hx", lineNumber : 21, className : "thx.TestDynamics", methodName : "testDynamics"});
			var date = new Date();
			utest_Assert.equals(date,thx_Dynamics.clone(date),null,{ fileName : "TestDynamics.hx", lineNumber : 23, className : "thx.TestDynamics", methodName : "testDynamics"});
			utest_Assert.same($bind(this,this.testDynamics),thx_Dynamics.clone($bind(this,this.testDynamics)),null,null,null,{ fileName : "TestDynamics.hx", lineNumber : 24, className : "thx.TestDynamics", methodName : "testDynamics"});
			var arr1 = [0,1,2];
			var arr2 = thx_Dynamics.clone(arr1);
			utest_Assert.notEquals(arr1,arr2,null,{ fileName : "TestDynamics.hx", lineNumber : 28, className : "thx.TestDynamics", methodName : "testDynamics"});
			utest_Assert.same(arr1,arr2,null,null,null,{ fileName : "TestDynamics.hx", lineNumber : 29, className : "thx.TestDynamics", methodName : "testDynamics"});
			var obj1 = { name : "Franco", number : 0};
			var obj2 = thx_Dynamics.clone(obj1);
			utest_Assert.notEquals(obj1,obj2,null,{ fileName : "TestDynamics.hx", lineNumber : 33, className : "thx.TestDynamics", methodName : "testDynamics"});
			utest_Assert.same(obj1,obj2,null,null,null,{ fileName : "TestDynamics.hx", lineNumber : 34, className : "thx.TestDynamics", methodName : "testDynamics"});
			var inst1 = new thx_Point(5,6);
			utest_Assert.equals(inst1,thx_Dynamics.clone(inst1),null,{ fileName : "TestDynamics.hx", lineNumber : 38, className : "thx.TestDynamics", methodName : "testDynamics"});
			var inst3 = thx_Dynamics.clone(inst1,true);
			utest_Assert.notEquals(inst1,inst3,null,{ fileName : "TestDynamics.hx", lineNumber : 40, className : "thx.TestDynamics", methodName : "testDynamics"});
			utest_Assert.same(inst1.x,inst3.x,null,null,null,{ fileName : "TestDynamics.hx", lineNumber : 41, className : "thx.TestDynamics", methodName : "testDynamics"});
		}
	}
