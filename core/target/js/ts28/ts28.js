...
TS28.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS28.hx", lineNumber : 10, className : "TS28", methodName : "addTests"});
	runner.addCase(new thx_TestOrderedMap(Std.parseInt(w)));
};
TS28.main = function() {
	var runner = new utest_Runner();
	TS28.addTests(runner);
...
var thx_TestOrderedMap = function(i) {
	this.x = i;
};
...
thx_TestOrderedMap.prototype = {
	...
	,testBasics: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.equals(0,ml.length,null,{ fileName : "TestOrderedMap.hx", lineNumber : 19, className : "thx.TestOrderedMap", methodName : "testBasics"});
			utest_Assert.equals("[]",ml.toString(),null,{ fileName : "TestOrderedMap.hx", lineNumber : 20, className : "thx.TestOrderedMap", methodName : "testBasics"});
			ml.set("z","Z");
			ml.set("y","Y");
			ml.set("y","Y");
			ml.set("x","X");
			utest_Assert.equals(3,ml.length,null,{ fileName : "TestOrderedMap.hx", lineNumber : 27, className : "thx.TestOrderedMap", methodName : "testBasics"});
			utest_Assert.equals("[z => Z, y => Y, x => X]",ml.toString(),null,{ fileName : "TestOrderedMap.hx", lineNumber : 28, className : "thx.TestOrderedMap", methodName : "testBasics"});
			utest_Assert.isTrue(ml.remove("y"),null,{ fileName : "TestOrderedMap.hx", lineNumber : 30, className : "thx.TestOrderedMap", methodName : "testBasics"});
			utest_Assert.isFalse(ml.remove("y"),null,{ fileName : "TestOrderedMap.hx", lineNumber : 31, className : "thx.TestOrderedMap", methodName : "testBasics"});
			utest_Assert.equals(2,ml.length,null,{ fileName : "TestOrderedMap.hx", lineNumber : 33, className : "thx.TestOrderedMap", methodName : "testBasics"});
			utest_Assert.equals("[z => Z, x => X]",ml.toString(),null,{ fileName : "TestOrderedMap.hx", lineNumber : 34, className : "thx.TestOrderedMap", methodName : "testBasics"});
			ml.insert(1,"y","Y");
			utest_Assert.equals(3,ml.length,null,{ fileName : "TestOrderedMap.hx", lineNumber : 38, className : "thx.TestOrderedMap", methodName : "testBasics"});
			utest_Assert.equals("[z => Z, y => Y, x => X]",ml.toString(),null,{ fileName : "TestOrderedMap.hx", lineNumber : 39, className : "thx.TestOrderedMap", methodName : "testBasics"});
			utest_Assert.equals("y",ml.keyAt(1),null,{ fileName : "TestOrderedMap.hx", lineNumber : 41, className : "thx.TestOrderedMap", methodName : "testBasics"});
			utest_Assert.equals("Y",ml.at(1),null,{ fileName : "TestOrderedMap.hx", lineNumber : 42, className : "thx.TestOrderedMap", methodName : "testBasics"});
			utest_Assert.equals(1,ml.keyIndex("y"),null,{ fileName : "TestOrderedMap.hx", lineNumber : 44, className : "thx.TestOrderedMap", methodName : "testBasics"});
			utest_Assert.equals(1,ml.valueIndex("Y"),null,{ fileName : "TestOrderedMap.hx", lineNumber : 45, className : "thx.TestOrderedMap", methodName : "testBasics"});
			ml.removeAt(1);
			utest_Assert.equals(2,ml.length,null,{ fileName : "TestOrderedMap.hx", lineNumber : 49, className : "thx.TestOrderedMap", methodName : "testBasics"});
			utest_Assert.equals("[z => Z, x => X]",ml.toString(),null,{ fileName : "TestOrderedMap.hx", lineNumber : 50, className : "thx.TestOrderedMap", methodName : "testBasics"});
			utest_Assert.same(["Z","X"],ml.toArray(),null,null,null,{ fileName : "TestOrderedMap.hx", lineNumber : 52, className : "thx.TestOrderedMap", methodName : "testBasics"});
			utest_Assert.same(["z","x"],thx_Iterators.toArray(ml.keys()),null,null,null,{ fileName : "TestOrderedMap.hx", lineNumber : 53, className : "thx.TestOrderedMap", methodName : "testBasics"});
		}
	}
	,testGetOption: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(thx_Options.get(null == value?haxe_ds_Option.None:haxe_ds_Option.Some(value)),1,null,null,null,{ fileName : "TestOrderedMap.hx", lineNumber : 61, className : "thx.TestOrderedMap", methodName : "testGetOption"});
			var value1 = m.get("key2");
			utest_Assert.same(thx_Options.toBool(null == value1?haxe_ds_Option.None:haxe_ds_Option.Some(value1)),false,null,null,null,{ fileName : "TestOrderedMap.hx", lineNumber : 62, className : "thx.TestOrderedMap", methodName : "testGetOption"});
		}
	}
	,testToTuples: function() {
		...
		while(_g1 < _g) {
			...
			m.insert(2,"baz",30);
			var tuples = m.tuples();
			utest_Assert.same("foo",tuples[0]._0,null,null,null,{ fileName : "TestOrderedMap.hx", lineNumber : 74, className : "thx.TestOrderedMap", methodName : "testToTuples"});
			utest_Assert.same(20,tuples[1]._1,null,null,null,{ fileName : "TestOrderedMap.hx", lineNumber : 75, className : "thx.TestOrderedMap", methodName : "testToTuples"});
			utest_Assert.same("baz",tuples[2]._0,null,null,null,{ fileName : "TestOrderedMap.hx", lineNumber : 76, className : "thx.TestOrderedMap", methodName : "testToTuples"});
			utest_Assert.same(30,tuples[2]._1,null,null,null,{ fileName : "TestOrderedMap.hx", lineNumber : 77, className : "thx.TestOrderedMap", methodName : "testToTuples"});
		}
	}
	,testAbstract: function() {
		...
		while(_g1 < _g) {
			...
			var ml = new thx_StringOrderedMap();
			ml.setValue("k","value");
			utest_Assert.equals("value",ml.get("k"),null,{ fileName : "TestOrderedMap.hx", lineNumber : 84, className : "thx.TestOrderedMap", methodName : "testAbstract"});
			utest_Assert.equals("value",ml.at(0),null,{ fileName : "TestOrderedMap.hx", lineNumber : 85, className : "thx.TestOrderedMap", methodName : "testAbstract"});
			utest_Assert.equals("value",ml.at(0),null,{ fileName : "TestOrderedMap.hx", lineNumber : 86, className : "thx.TestOrderedMap", methodName : "testAbstract"});
			(function(m) {
				utest_Assert.equals("value",m.get("k"),null,{ fileName : "TestOrderedMap.hx", lineNumber : 89, className : "thx.TestOrderedMap", methodName : "testAbstract"});
			})(ml);
			utest_Assert.notNull(new thx_IntOrderedMap(),null,{ fileName : "TestOrderedMap.hx", lineNumber : 93, className : "thx.TestOrderedMap", methodName : "testAbstract"});
			utest_Assert.notNull(new thx_EnumValueOrderedMap(),null,{ fileName : "TestOrderedMap.hx", lineNumber : 94, className : "thx.TestOrderedMap", methodName : "testAbstract"});
			utest_Assert.notNull(new thx_ObjectOrderedMap(),null,{ fileName : "TestOrderedMap.hx", lineNumber : 95, className : "thx.TestOrderedMap", methodName : "testAbstract"});
		}
	}
	,testEmpty: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			var ml = new thx_StringOrderedMap();
			ml.setValue("k","value");
			utest_Assert.isNull(ml.empty().get("k"),null,{ fileName : "TestOrderedMap.hx", lineNumber : 103, className : "thx.TestOrderedMap", methodName : "testEmpty"});
		}
	}
	,testCopyTo: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			utest_Assert.equals("value",e.get("k"),null,{ fileName : "TestOrderedMap.hx", lineNumber : 112, className : "thx.TestOrderedMap", methodName : "testCopyTo"});
		}
	}
	,testClone: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			utest_Assert.equals("value",that.get("k"),null,{ fileName : "TestOrderedMap.hx", lineNumber : 120, className : "thx.TestOrderedMap", methodName : "testClone"});
		}
	}
