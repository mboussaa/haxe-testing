...
TS31.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS31.hx", lineNumber : 10, className : "TS31", methodName : "addTests"});
	runner.addCase(new thx_TestMaps(Std.parseInt(w)));
};
TS31.main = function() {
	var runner = new utest_Runner();
	TS31.addTests(runner);
...
var thx_TestMaps = function(i) {
	this.x = i;
};
thx_TestMaps.__name__ = ["thx","TestMaps"];
thx_TestMaps.prototype = {
	x: null
	,testTuples: function() {
		var _g1 = 0;
		var _g = this.x;
		while(_g1 < _g) {
			...
			if(__map_reserved.key1 != null) {
				_g2.setReserved("key1",1);
			} else {
				_g2.h["key1"] = 1;
			}
			if(__map_reserved.key2 != null) {
				_g2.setReserved("key2",2);
			} else {
				_g2.h["key2"] = 2;
			}
			var tuples = thx_Maps.tuples(_g2);
			tuples.sort(function(a,b) {
				return haxe_Utf8.compare(a._0,b._0);
			});
			utest_Assert.equals(2,tuples.length,null,{ fileName : "TestMaps.hx", lineNumber : 24, className : "thx.TestMaps", methodName : "testTuples"});
			utest_Assert.equals(tuples[0]._0,"key1",null,{ fileName : "TestMaps.hx", lineNumber : 25, className : "thx.TestMaps", methodName : "testTuples"});
			utest_Assert.equals(tuples[0]._1,1,null,{ fileName : "TestMaps.hx", lineNumber : 26, className : "thx.TestMaps", methodName : "testTuples"});
			utest_Assert.equals(tuples[1]._0,"key2",null,{ fileName : "TestMaps.hx", lineNumber : 27, className : "thx.TestMaps", methodName : "testTuples"});
			utest_Assert.equals(tuples[1]._1,2,null,{ fileName : "TestMaps.hx", lineNumber : 28, className : "thx.TestMaps", methodName : "testTuples"});
		}
	}
	,testValues: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			if(__map_reserved.key3 != null) {
				_g2.setReserved("key3",3);
			} else {
				_g2.h["key3"] = 3;
			}
			utest_Assert.same([1,2,3],thx_Arrays.order(thx_Maps.values(_g2),thx_Ints.compare),null,null,null,{ fileName : "TestMaps.hx", lineNumber : 39, className : "thx.TestMaps", methodName : "testValues"});
		}
	}
	,testGetOption: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(thx_Options.get(thx_Maps.getOption(_g2,"key1")),1,null,null,null,{ fileName : "TestMaps.hx", lineNumber : 46, className : "thx.TestMaps", methodName : "testGetOption"});
			utest_Assert.same(thx_Options.toBool(thx_Maps.getOption(_g2,"key2")),false,null,null,null,{ fileName : "TestMaps.hx", lineNumber : 47, className : "thx.TestMaps", methodName : "testGetOption"});
		}
	}
	,testMerge: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			if(__map_reserved.key2 != null) {
				_g2.setReserved("key2",1);
			} else {
				_g2.h["key2"] = 1;
			}
			if(__map_reserved.key3 != null) {
				_g2.setReserved("key3",1);
			} else {
				_g2.h["key3"] = 1;
			}
			var _g3 = new haxe_ds_StringMap();
			if(__map_reserved.key2 != null) {
				_g3.setReserved("key2",2);
			} else {
				_g3.h["key2"] = 2;
			}
			if(__map_reserved.key3 != null) {
				_g3.setReserved("key3",2);
			} else {
				_g3.h["key3"] = 2;
			}
			var _g4 = new haxe_ds_StringMap();
			if(__map_reserved.key3 != null) {
				_g4.setReserved("key3",3);
			} else {
				_g4.h["key3"] = 3;
			}
			var result1 = thx_Maps.merge(new haxe_ds_StringMap(),[_g2,_g3,_g4]);
			utest_Assert.same(3,thx_Iterators.toArray(result1.keys()).length,null,null,null,{ fileName : "TestMaps.hx", lineNumber : 66, className : "thx.TestMaps", methodName : "testMerge"});
			utest_Assert.same(1,result1.get("key1"),null,null,null,{ fileName : "TestMaps.hx", lineNumber : 67, className : "thx.TestMaps", methodName : "testMerge"});
			utest_Assert.same(2,result1.get("key2"),null,null,null,{ fileName : "TestMaps.hx", lineNumber : 68, className : "thx.TestMaps", methodName : "testMerge"});
			utest_Assert.same(3,result1.get("key3"),null,null,null,{ fileName : "TestMaps.hx", lineNumber : 69, className : "thx.TestMaps", methodName : "testMerge"});
			var _g5 = new haxe_ds_StringMap();
			if(__map_reserved.mykey != null) {
				_g5.setReserved("mykey",5);
			} else {
				_g5.h["mykey"] = 5;
			}
			var result2 = thx_Maps.merge(_g5,[]);
			utest_Assert.same(1,thx_Iterators.toArray(result2.keys()).length,null,null,null,{ fileName : "TestMaps.hx", lineNumber : 73, className : "thx.TestMaps", methodName : "testMerge"});
			utest_Assert.same(5,result2.get("mykey"),null,null,null,{ fileName : "TestMaps.hx", lineNumber : 74, className : "thx.TestMaps", methodName : "testMerge"});
			utest_Assert.same(3,thx_Iterators.toArray(_g2.keys()).length,null,null,null,{ fileName : "TestMaps.hx", lineNumber : 77, className : "thx.TestMaps", methodName : "testMerge"});
			utest_Assert.same(1,__map_reserved.key1 != null?_g2.getReserved("key1"):_g2.h["key1"],null,null,null,{ fileName : "TestMaps.hx", lineNumber : 78, className : "thx.TestMaps", methodName : "testMerge"});
			utest_Assert.same(1,__map_reserved.key2 != null?_g2.getReserved("key2"):_g2.h["key2"],null,null,null,{ fileName : "TestMaps.hx", lineNumber : 79, className : "thx.TestMaps", methodName : "testMerge"});
			utest_Assert.same(1,__map_reserved.key3 != null?_g2.getReserved("key3"):_g2.h["key3"],null,null,null,{ fileName : "TestMaps.hx", lineNumber : 80, className : "thx.TestMaps", methodName : "testMerge"});
			utest_Assert.same(2,thx_Iterators.toArray(_g3.keys()).length,null,null,null,{ fileName : "TestMaps.hx", lineNumber : 81, className : "thx.TestMaps", methodName : "testMerge"});
			utest_Assert.same(2,__map_reserved.key2 != null?_g3.getReserved("key2"):_g3.h["key2"],null,null,null,{ fileName : "TestMaps.hx", lineNumber : 82, className : "thx.TestMaps", methodName : "testMerge"});
			utest_Assert.same(2,__map_reserved.key3 != null?_g3.getReserved("key3"):_g3.h["key3"],null,null,null,{ fileName : "TestMaps.hx", lineNumber : 83, className : "thx.TestMaps", methodName : "testMerge"});
			utest_Assert.same(1,thx_Iterators.toArray(_g4.keys()).length,null,null,null,{ fileName : "TestMaps.hx", lineNumber : 84, className : "thx.TestMaps", methodName : "testMerge"});
			utest_Assert.same(3,__map_reserved.key3 != null?_g4.getReserved("key3"):_g4.h["key3"],null,null,null,{ fileName : "TestMaps.hx", lineNumber : 85, className : "thx.TestMaps", methodName : "testMerge"});
			var result3 = thx_Maps.merge(_g2,[_g3,_g4]);
			utest_Assert.same(3,thx_Iterators.toArray(result3.keys()).length,null,null,null,{ fileName : "TestMaps.hx", lineNumber : 90, className : "thx.TestMaps", methodName : "testMerge"});
			utest_Assert.same(1,result3.get("key1"),null,null,null,{ fileName : "TestMaps.hx", lineNumber : 91, className : "thx.TestMaps", methodName : "testMerge"});
			utest_Assert.same(2,result3.get("key2"),null,null,null,{ fileName : "TestMaps.hx", lineNumber : 92, className : "thx.TestMaps", methodName : "testMerge"});
			utest_Assert.same(3,result3.get("key3"),null,null,null,{ fileName : "TestMaps.hx", lineNumber : 93, className : "thx.TestMaps", methodName : "testMerge"});
			utest_Assert.same(3,thx_Iterators.toArray(_g2.keys()).length,null,null,null,{ fileName : "TestMaps.hx", lineNumber : 94, className : "thx.TestMaps", methodName : "testMerge"});
			utest_Assert.same(1,__map_reserved.key1 != null?_g2.getReserved("key1"):_g2.h["key1"],null,null,null,{ fileName : "TestMaps.hx", lineNumber : 95, className : "thx.TestMaps", methodName : "testMerge"});
			utest_Assert.same(2,__map_reserved.key2 != null?_g2.getReserved("key2"):_g2.h["key2"],null,null,null,{ fileName : "TestMaps.hx", lineNumber : 96, className : "thx.TestMaps", methodName : "testMerge"});
			utest_Assert.same(3,__map_reserved.key3 != null?_g2.getReserved("key3"):_g2.h["key3"],null,null,null,{ fileName : "TestMaps.hx", lineNumber : 97, className : "thx.TestMaps", methodName : "testMerge"});
			utest_Assert.same(2,thx_Iterators.toArray(_g3.keys()).length,null,null,null,{ fileName : "TestMaps.hx", lineNumber : 98, className : "thx.TestMaps", methodName : "testMerge"});
			utest_Assert.same(2,__map_reserved.key2 != null?_g3.getReserved("key2"):_g3.h["key2"],null,null,null,{ fileName : "TestMaps.hx", lineNumber : 99, className : "thx.TestMaps", methodName : "testMerge"});
			utest_Assert.same(2,__map_reserved.key3 != null?_g3.getReserved("key3"):_g3.h["key3"],null,null,null,{ fileName : "TestMaps.hx", lineNumber : 100, className : "thx.TestMaps", methodName : "testMerge"});
			utest_Assert.same(1,thx_Iterators.toArray(_g4.keys()).length,null,null,null,{ fileName : "TestMaps.hx", lineNumber : 101, className : "thx.TestMaps", methodName : "testMerge"});
			utest_Assert.same(3,__map_reserved.key3 != null?_g4.getReserved("key3"):_g4.h["key3"],null,null,null,{ fileName : "TestMaps.hx", lineNumber : 102, className : "thx.TestMaps", methodName : "testMerge"});
		}
	}
	,__class__: thx_TestMaps
};
