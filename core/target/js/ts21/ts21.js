...
TS21.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS21.hx", lineNumber : 10, className : "TS21", methodName : "addTests"});
	runner.addCase(new thx_TestFunctions(Std.parseInt(w)));
};
TS21.main = function() {
...
var thx_TestFunctions = function(i) {
	this.x = i;
};
...
thx_TestFunctions.prototype = {
	...
	,testAfter: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var counter = [0];
			var callback = [(function(counter1) {
				return function() {
					utest_Assert.equals(1,++counter1[0],null,{ fileName : "TestFunctions.hx", lineNumber : 15, className : "thx.TestFunctions", methodName : "testAfter"});
				};
			})(counter)];
			var manage = (function(n,callback1) {
				return function() {
					if(--n[0] == 0) {
						callback1[0]();
					}
			...
			utest_Assert.equals(0,counter[0],null,{ fileName : "TestFunctions.hx", lineNumber : 18, className : "thx.TestFunctions", methodName : "testAfter"});
			manage();
			utest_Assert.equals(0,counter[0],null,{ fileName : "TestFunctions.hx", lineNumber : 20, className : "thx.TestFunctions", methodName : "testAfter"});
			manage();
			utest_Assert.equals(0,counter[0],null,{ fileName : "TestFunctions.hx", lineNumber : 22, className : "thx.TestFunctions", methodName : "testAfter"});
			manage();
			utest_Assert.equals(1,counter[0],null,{ fileName : "TestFunctions.hx", lineNumber : 24, className : "thx.TestFunctions", methodName : "testAfter"});
			manage();
			utest_Assert.equals(1,counter[0],null,{ fileName : "TestFunctions.hx", lineNumber : 26, className : "thx.TestFunctions", methodName : "testAfter"});
		}
	}
	,testOnce: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			var counter = [0];
			var f = [(function(counter1) {
				return function() {
					utest_Assert.equals(1,++counter1[0],null,{ fileName : "TestFunctions.hx", lineNumber : 32, className : "thx.TestFunctions", methodName : "testOnce"});
				};
			})(counter)];
			var manage = (function(f1) {
				return function() {
					var t = f1[0];
					f1[0] = thx_Functions.noop;
					t();
				};
			})(f);
			utest_Assert.equals(0,counter[0],null,{ fileName : "TestFunctions.hx", lineNumber : 35, className : "thx.TestFunctions", methodName : "testOnce"});
			manage();
			utest_Assert.equals(1,counter[0],null,{ fileName : "TestFunctions.hx", lineNumber : 37, className : "thx.TestFunctions", methodName : "testOnce"});
			manage();
			utest_Assert.equals(1,counter[0],null,{ fileName : "TestFunctions.hx", lineNumber : 39, className : "thx.TestFunctions", methodName : "testOnce"});
		}
	}
	,testMemoize: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var counter = [0];
			var manage = thx_Functions1.memoize((function(counter1) {
				return function(x) {
					++counter1[0];
					return x * 10;
				};
			})(counter));
			utest_Assert.equals(0,counter[0],null,{ fileName : "TestFunctions.hx", lineNumber : 51, className : "thx.TestFunctions", methodName : "testMemoize"});
			utest_Assert.equals(10,manage(1),null,{ fileName : "TestFunctions.hx", lineNumber : 52, className : "thx.TestFunctions", methodName : "testMemoize"});
			utest_Assert.equals(1,counter[0],null,{ fileName : "TestFunctions.hx", lineNumber : 53, className : "thx.TestFunctions", methodName : "testMemoize"});
			utest_Assert.equals(10,manage(1),null,{ fileName : "TestFunctions.hx", lineNumber : 54, className : "thx.TestFunctions", methodName : "testMemoize"});
			utest_Assert.equals(1,counter[0],null,{ fileName : "TestFunctions.hx", lineNumber : 55, className : "thx.TestFunctions", methodName : "testMemoize"});
			utest_Assert.equals(20,manage(2),null,{ fileName : "TestFunctions.hx", lineNumber : 56, className : "thx.TestFunctions", methodName : "testMemoize"});
			utest_Assert.equals(2,counter[0],null,{ fileName : "TestFunctions.hx", lineNumber : 57, className : "thx.TestFunctions", methodName : "testMemoize"});
		}
	}
	,testNegate: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.isFalse(false,null,{ fileName : "TestFunctions.hx", lineNumber : 62, className : "thx.TestFunctions", methodName : "testNegate"});
		}
	}
