...
TS16.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS16.hx", lineNumber : 10, className : "TS16", methodName : "addTests"});
	runner.addCase(new thx_TestEithers(Std.parseInt(w)));
};
TS16.main = function() {
...
var thx_TestEithers = function(i) {
	this.x = i;
};
...
thx_TestEithers.prototype = {
	...
	,testIsLeft: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.isTrue(thx_Eithers.isLeft(thx_Either.Left(123)),null,{ fileName : "TestEithers.hx", lineNumber : 15, className : "thx.TestEithers", methodName : "testIsLeft"});
			utest_Assert.isFalse(thx_Eithers.isLeft(thx_Either.Right(123)),null,{ fileName : "TestEithers.hx", lineNumber : 16, className : "thx.TestEithers", methodName : "testIsLeft"});
		}
	}
	,testIsRight: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.isFalse(thx_Eithers.isRight(thx_Either.Left(123)),null,{ fileName : "TestEithers.hx", lineNumber : 21, className : "thx.TestEithers", methodName : "testIsRight"});
			utest_Assert.isTrue(thx_Eithers.isRight(thx_Either.Right(123)),null,{ fileName : "TestEithers.hx", lineNumber : 22, className : "thx.TestEithers", methodName : "testIsRight"});
		}
	}
	,testToLeft: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			var _g2 = thx_Eithers.toLeft(thx_Either.Left(123));
			var tmp;
			switch(_g2[1]) {
			case 0:
				tmp = _g2[2];
			...
			utest_Assert.same(123,tmp,null,null,null,{ fileName : "TestEithers.hx", lineNumber : 27, className : "thx.TestEithers", methodName : "testToLeft"});
			var _g3 = thx_Eithers.toLeft(thx_Either.Right(123));
			var tmp1;
			switch(_g3[1]) {
			case 0:
				tmp1 = _g3[2];
			...
			utest_Assert.isNull(tmp1,null,{ fileName : "TestEithers.hx", lineNumber : 32, className : "thx.TestEithers", methodName : "testToLeft"});
		}
	}
	,testToRight: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var _g2 = thx_Eithers.toRight(thx_Either.Right(123));
			var tmp;
			switch(_g2[1]) {
			case 0:
				tmp = _g2[2];
			...
			utest_Assert.same(123,tmp,null,null,null,{ fileName : "TestEithers.hx", lineNumber : 40, className : "thx.TestEithers", methodName : "testToRight"});
			var _g3 = thx_Eithers.toRight(thx_Either.Left(123));
			var tmp1;
			switch(_g3[1]) {
			case 0:
				tmp1 = _g3[2];
			...
			utest_Assert.isNull(tmp1,null,{ fileName : "TestEithers.hx", lineNumber : 45, className : "thx.TestEithers", methodName : "testToRight"});
		}
	}
	,testToLeftUnsafe: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.same(123,thx_Eithers.toLeftUnsafe(thx_Either.Left(123)),null,null,null,{ fileName : "TestEithers.hx", lineNumber : 53, className : "thx.TestEithers", methodName : "testToLeftUnsafe"});
			utest_Assert.same(null,thx_Eithers.toLeftUnsafe(thx_Either.Right(123)),null,null,null,{ fileName : "TestEithers.hx", lineNumber : 54, className : "thx.TestEithers", methodName : "testToLeftUnsafe"});
		}
	}
	,testToRightUnsafe: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.same(123,thx_Eithers.toRightUnsafe(thx_Either.Right(123)),null,null,null,{ fileName : "TestEithers.hx", lineNumber : 59, className : "thx.TestEithers", methodName : "testToRightUnsafe"});
			utest_Assert.same(null,thx_Eithers.toRightUnsafe(thx_Either.Left(123)),null,null,null,{ fileName : "TestEithers.hx", lineNumber : 60, className : "thx.TestEithers", methodName : "testToRightUnsafe"});
		}
	}
	,testFlatMap: function() {
		...
		while(_g1 < _g) {
			...
			})),null,null,null,{ fileName : "TestEithers.hx", lineNumber : 65, className : "thx.TestEithers", methodName : "testFlatMap"});
			utest_Assert.same(5,thx_Eithers.toLeftUnsafe(thx_Eithers.flatMap(thx_Either.Left(5),function(r1) {
				return thx_Either.Right(10);
			})),null,null,null,{ fileName : "TestEithers.hx", lineNumber : 69, className : "thx.TestEithers", methodName : "testFlatMap"});
			utest_Assert.same(10,thx_Eithers.toLeftUnsafe(thx_Eithers.flatMap(thx_Either.Right(5),function(r2) {
				return thx_Either.Left(10);
			})),null,null,null,{ fileName : "TestEithers.hx", lineNumber : 73, className : "thx.TestEithers", methodName : "testFlatMap"});
			utest_Assert.same(null,thx_Eithers.toLeftUnsafe(thx_Eithers.flatMap(thx_Either.Right(5),function(r3) {
				return thx_Either.Right(10);
			})),null,null,null,{ fileName : "TestEithers.hx", lineNumber : 77, className : "thx.TestEithers", methodName : "testFlatMap"});
			utest_Assert.same(null,thx_Eithers.toRightUnsafe(thx_Eithers.flatMap(thx_Either.Left(5),function(r4) {
				return thx_Either.Left(10);
			})),null,null,null,{ fileName : "TestEithers.hx", lineNumber : 81, className : "thx.TestEithers", methodName : "testFlatMap"});
			utest_Assert.same(null,thx_Eithers.toRightUnsafe(thx_Eithers.flatMap(thx_Either.Left(5),function(r5) {
				return thx_Either.Right(10);
			})),null,null,null,{ fileName : "TestEithers.hx", lineNumber : 85, className : "thx.TestEithers", methodName : "testFlatMap"});
			utest_Assert.same(null,thx_Eithers.toRightUnsafe(thx_Eithers.flatMap(thx_Either.Right(5),function(r6) {
				return thx_Either.Left(10);
			})),null,null,null,{ fileName : "TestEithers.hx", lineNumber : 89, className : "thx.TestEithers", methodName : "testFlatMap"});
			utest_Assert.same(10,thx_Eithers.toRightUnsafe(thx_Eithers.flatMap(thx_Either.Right(5),function(r7) {
				return thx_Either.Right(10);
			})),null,null,null,{ fileName : "TestEithers.hx", lineNumber : 93, className : "thx.TestEithers", methodName : "testFlatMap"});
		}
	}
	,testLeftMap: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(thx_Either.Left(2),thx_Eithers.leftMap(l,function(i) {
				return i + 1;
			}),null,null,null,{ fileName : "TestEithers.hx", lineNumber : 103, className : "thx.TestEithers", methodName : "testLeftMap"});
			utest_Assert.same(rt,thx_Eithers.leftMap(rt,function(i1) {
				return i1 + 1;
			}),null,null,null,{ fileName : "TestEithers.hx", lineNumber : 104, className : "thx.TestEithers", methodName : "testLeftMap"});
		}
	}
