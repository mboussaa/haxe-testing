...
TS18.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS18.hx", lineNumber : 10, className : "TS18", methodName : "addTests"});
	runner.addCase(new thx_TestERegs(Std.parseInt(w)));
};
TS18.main = function() {
...
thx_TestERegs.prototype = {
	...
	,testEscape: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("a\\.b",thx_ERegs.escape("a.b"),null,{ fileName : "TestERegs.hx", lineNumber : 21, className : "thx.TestERegs", methodName : "testEscape"});
			utest_Assert.equals("a\\.b\\.c",thx_ERegs.escape("a.b.c"),null,{ fileName : "TestERegs.hx", lineNumber : 22, className : "thx.TestERegs", methodName : "testEscape"});
			utest_Assert.equals("\\(\\[\\.\\]\\.\\)",thx_ERegs.escape("([.].)"),null,{ fileName : "TestERegs.hx", lineNumber : 23, className : "thx.TestERegs", methodName : "testEscape"});
		}
	}
