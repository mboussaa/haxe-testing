...
TS1.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS1.hx", lineNumber : 10, className : "TS1", methodName : "addTests"});
	runner.addCase(new thx_TestAnonymousMap(Std.parseInt(w)));
};
TS1.main = function() {
...
var thx_TestAnonymousMap = function(i) {
	this.x = i;
};
...
thx_TestAnonymousMap.prototype = {
	...
	,testFeatures: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.equals("thx",map.get("name"),null,{ fileName : "TestAnonymousMap.hx", lineNumber : 23, className : "thx.TestAnonymousMap", methodName : "testFeatures"});
			utest_Assert.isTrue(map.exists("type"),null,{ fileName : "TestAnonymousMap.hx", lineNumber : 24, className : "thx.TestAnonymousMap", methodName : "testFeatures"});
			map.remove("type");
			utest_Assert.isFalse(map.exists("type"),null,{ fileName : "TestAnonymousMap.hx", lineNumber : 26, className : "thx.TestAnonymousMap", methodName : "testFeatures"});
			utest_Assert.same(["name"],thx_Iterators.toArray(map.keys()),null,null,null,{ fileName : "TestAnonymousMap.hx", lineNumber : 27, className : "thx.TestAnonymousMap", methodName : "testFeatures"});
			utest_Assert.same(["thx"],thx_Iterators.toArray(map.iterator()),null,null,null,{ fileName : "TestAnonymousMap.hx", lineNumber : 28, className : "thx.TestAnonymousMap", methodName : "testFeatures"});
		}
	}
	,testGetOption: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(thx_Options.get(map.getOption("key1")),1,null,null,null,{ fileName : "TestAnonymousMap.hx", lineNumber : 35, className : "thx.TestAnonymousMap", methodName : "testGetOption"});
			utest_Assert.same(thx_Options.toBool(map.getOption("key2")),false,null,null,null,{ fileName : "TestAnonymousMap.hx", lineNumber : 36, className : "thx.TestAnonymousMap", methodName : "testGetOption"});
		}
	}
