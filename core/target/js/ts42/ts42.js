...
TS42.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS42.hx", lineNumber : 10, className : "TS42", methodName : "addTests"});
	runner.addCase(new thx_TestThx(Std.parseInt(w)));
};
TS42.main = function() {
	var runner = new utest_Runner();
	TS42.addTests(runner);
...
thx_TestThx.prototype = {
	...
	,testUsing: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("thx using",thx_Strings.humanize("ThxUsing"),null,{ fileName : "TestThx.hx", lineNumber : 14, className : "thx.TestThx", methodName : "testUsing"});
		}
	}
