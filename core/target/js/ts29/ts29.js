...
TS29.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS29.hx", lineNumber : 10, className : "TS29", methodName : "addTests"});
	runner.addCase(new thx_TestOrderedSet(Std.parseInt(w)));
};
TS29.main = function() {
	var runner = new utest_Runner();
	TS29.addTests(runner);
...
var thx_TestOrderedSet = function(i) {
	this.x = i;
};
...
thx_TestOrderedSet.prototype = {
	...
	,testCreate: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.equals(0,set.length,null,{ fileName : "TestOrderedSet.hx", lineNumber : 14, className : "thx.TestOrderedSet", methodName : "testCreate"});
			thx__$OrderedSet_OrderedSet_$Impl_$.add(set,1);
			thx__$OrderedSet_OrderedSet_$Impl_$.add(set,1);
			utest_Assert.equals(1,set.length,null,{ fileName : "TestOrderedSet.hx", lineNumber : 17, className : "thx.TestOrderedSet", methodName : "testCreate"});
		}
	}
	,testOrderedSet: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.same([1,2,3],thx__$OrderedSet_OrderedSet_$Impl_$.toArray(thx__$OrderedSet_OrderedSet_$Impl_$.toOrderedSet([1,2,2,2,3])),null,null,null,{ fileName : "TestOrderedSet.hx", lineNumber : 23, className : "thx.TestOrderedSet", methodName : "testOrderedSet"});
		}
	}
	,testUnion: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.same([1,2,3,4],thx__$OrderedSet_OrderedSet_$Impl_$.toArray(thx__$OrderedSet_OrderedSet_$Impl_$.toOrderedSet(thx__$OrderedSet_OrderedSet_$Impl_$.toOrderedSet([1,2,3]).concat(thx__$OrderedSet_OrderedSet_$Impl_$.toArray(thx__$OrderedSet_OrderedSet_$Impl_$.toOrderedSet([2,2,4]))))),null,null,null,{ fileName : "TestOrderedSet.hx", lineNumber : 30, className : "thx.TestOrderedSet", methodName : "testUnion"});
		}
	}
	,testDifference: function() {
		...
		while(_g1 < _g) {
			...
			while(tmp.hasNext()) HxOverrides.remove(result,tmp.next());
			utest_Assert.same([1,3],thx__$OrderedSet_OrderedSet_$Impl_$.toArray(result),null,null,null,{ fileName : "TestOrderedSet.hx", lineNumber : 37, className : "thx.TestOrderedSet", methodName : "testDifference"});
		}
	}
	,testBooleans: function() {
		...
		while(_g1 < _g) {
			...
			var tmp = HxOverrides.iter(set);
			while(tmp.hasNext()) HxOverrides.remove(result,tmp.next());
			utest_Assert.same([1,4],result,null,null,null,{ fileName : "TestOrderedSet.hx", lineNumber : 43, className : "thx.TestOrderedSet", methodName : "testBooleans"});
		}
	}
