...
TS26.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS26.hx", lineNumber : 10, className : "TS26", methodName : "addTests"});
	runner.addCase(new thx_TestIterators(Std.parseInt(w)));
};
TS26.main = function() {
	var runner = new utest_Runner();
	TS26.addTests(runner);
...
var thx_TestIterators = function(i) {
	this.x = i;
};
...
thx_TestIterators.prototype = {
	...
	,testEquals: function() {
		...
		while(_g1 < _g) {
			...
			var b = [1,2];
			var c = [1,2,4];
			utest_Assert.isTrue(thx_Iterators.equals(HxOverrides.iter(a),HxOverrides.iter(a)),null,{ fileName : "TestIterators.hx", lineNumber : 23, className : "thx.TestIterators", methodName : "testEquals"});
			utest_Assert.isFalse(thx_Iterators.equals(HxOverrides.iter(a),HxOverrides.iter(b)),null,{ fileName : "TestIterators.hx", lineNumber : 24, className : "thx.TestIterators", methodName : "testEquals"});
			utest_Assert.isFalse(thx_Iterators.equals(HxOverrides.iter(a),HxOverrides.iter(c)),null,{ fileName : "TestIterators.hx", lineNumber : 25, className : "thx.TestIterators", methodName : "testEquals"});
		}
	}
	,testReduce: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			utest_Assert.equals(17,thx_Iterators.reduce(HxOverrides.iter([2,3,5,7]),function(a,b) {
				return a + b;
			},0),null,{ fileName : "TestIterators.hx", lineNumber : 31, className : "thx.TestIterators", methodName : "testReduce"});
		}
	}
