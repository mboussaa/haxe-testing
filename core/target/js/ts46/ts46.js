...
TS46.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS46.hx", lineNumber : 10, className : "TS46", methodName : "addTests"});
	runner.addCase(new thx_TestUrl(Std.parseInt(w)));
};
TS46.main = function() {
	var runner = new utest_Runner();
	TS46.addTests(runner);
...
thx_TestUrl.prototype = {
	...
	,testBasics: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.equals("http",url.protocol,null,{ fileName : "TestUrl.hx", lineNumber : 15, className : "thx.TestUrl", methodName : "testBasics"});
			utest_Assert.equals("user:password",url.auth,null,{ fileName : "TestUrl.hx", lineNumber : 16, className : "thx.TestUrl", methodName : "testBasics"});
			utest_Assert.equals("www.example.com:8888",url.hostName + (url.port != null?":" + url.port:""),null,{ fileName : "TestUrl.hx", lineNumber : 17, className : "thx.TestUrl", methodName : "testBasics"});
			utest_Assert.equals("www.example.com",url.hostName,null,{ fileName : "TestUrl.hx", lineNumber : 18, className : "thx.TestUrl", methodName : "testBasics"});
			var tmp;
			var tmp1;
			var tmp2;
			if(url.search == null) {
			...
			utest_Assert.isTrue(tmp,null,{ fileName : "TestUrl.hx", lineNumber : 20, className : "thx.TestUrl", methodName : "testBasics"});
			utest_Assert.equals("/some/path/name.ext",url.pathName,null,{ fileName : "TestUrl.hx", lineNumber : 24, className : "thx.TestUrl", methodName : "testBasics"});
			utest_Assert.equals("hashtag/is/here",url.hash,null,{ fileName : "TestUrl.hx", lineNumber : 25, className : "thx.TestUrl", methodName : "testBasics"});
		}
	}
	,testToString: function() {
		...
		while(_g1 < _g) {
			...
			while(_g2 < urls.length) {
				var url = urls[_g2];
				++_g2;
				utest_Assert.equals(url,thx__$Url_Url_$Impl_$.toString(thx__$Url_Url_$Impl_$.parse(url,false)),null,{ fileName : "TestUrl.hx", lineNumber : 43, className : "thx.TestUrl", methodName : "testToString"});
			}
		}
	}
	,testAbsolute: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.isTrue(url.hostName != null,null,{ fileName : "TestUrl.hx", lineNumber : 49, className : "thx.TestUrl", methodName : "testAbsolute"});
			utest_Assert.isFalse(url.hostName == null,null,{ fileName : "TestUrl.hx", lineNumber : 50, className : "thx.TestUrl", methodName : "testAbsolute"});
			url = thx__$Url_Url_$Impl_$.fromString("example.com");
			utest_Assert.isTrue(url.hostName != null,null,{ fileName : "TestUrl.hx", lineNumber : 53, className : "thx.TestUrl", methodName : "testAbsolute"});
			utest_Assert.isFalse(url.hostName == null,null,{ fileName : "TestUrl.hx", lineNumber : 54, className : "thx.TestUrl", methodName : "testAbsolute"});
			url = thx__$Url_Url_$Impl_$.fromString("/some/path");
			utest_Assert.isFalse(url.hostName != null,null,{ fileName : "TestUrl.hx", lineNumber : 57, className : "thx.TestUrl", methodName : "testAbsolute"});
			utest_Assert.isTrue(url.hostName == null,null,{ fileName : "TestUrl.hx", lineNumber : 58, className : "thx.TestUrl", methodName : "testAbsolute"});
		}
	}
