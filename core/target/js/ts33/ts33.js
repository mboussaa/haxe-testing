...
TS33.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS33.hx", lineNumber : 10, className : "TS33", methodName : "addTests"});
	runner.addCase(new thx_TestObjects(Std.parseInt(w)));
};
TS33.main = function() {
	var runner = new utest_Runner();
	TS33.addTests(runner);
...
var thx_TestObjects = function(i) {
	this.x = i;
};
...
thx_TestObjects.prototype = {
	...
	,testIssue20151201: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.stringContains("oldId : \"1\"",s,null,{ fileName : "TestObjects.hx", lineNumber : 22, className : "thx.TestObjects", methodName : "testIssue20151201"});
			utest_Assert.stringContains("newId : \"2\"",s,null,{ fileName : "TestObjects.hx", lineNumber : 23, className : "thx.TestObjects", methodName : "testIssue20151201"});
			utest_Assert.stringContains(", ",s,null,{ fileName : "TestObjects.hx", lineNumber : 24, className : "thx.TestObjects", methodName : "testIssue20151201"});
			utest_Assert.isTrue(StringTools.startsWith(s,"{"),null,{ fileName : "TestObjects.hx", lineNumber : 25, className : "thx.TestObjects", methodName : "testIssue20151201"});
			utest_Assert.isTrue(StringTools.endsWith(s,"}"),null,{ fileName : "TestObjects.hx", lineNumber : 26, className : "thx.TestObjects", methodName : "testIssue20151201"});
		}
	}
	,testObjects: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var ob = { };
			utest_Assert.isTrue(Reflect.fields(ob).length == 0,null,{ fileName : "TestObjects.hx", lineNumber : 32, className : "thx.TestObjects", methodName : "testObjects"});
			utest_Assert.same([],Reflect.fields(ob),null,null,null,{ fileName : "TestObjects.hx", lineNumber : 33, className : "thx.TestObjects", methodName : "testObjects"});
			var ob1 = { a : "A", b : "B"};
			utest_Assert.isFalse(Reflect.fields(ob1).length == 0,null,{ fileName : "TestObjects.hx", lineNumber : 36, className : "thx.TestObjects", methodName : "testObjects"});
			var fields = Reflect.fields(ob1);
			utest_Assert.isTrue(HxOverrides.remove(fields,"a"),null,{ fileName : "TestObjects.hx", lineNumber : 39, className : "thx.TestObjects", methodName : "testObjects"});
			utest_Assert.isTrue(HxOverrides.remove(fields,"b"),null,{ fileName : "TestObjects.hx", lineNumber : 40, className : "thx.TestObjects", methodName : "testObjects"});
			utest_Assert.equals(0,fields.length,null,{ fileName : "TestObjects.hx", lineNumber : 41, className : "thx.TestObjects", methodName : "testObjects"});
			var o = [ob1];
			var values = Reflect.fields(o[0]).map((function(o1) {
				return function(key) {
					return Reflect.field(o1[0],key);
				};
			})(o));
			utest_Assert.isTrue(HxOverrides.remove(values,"A"),null,{ fileName : "TestObjects.hx", lineNumber : 44, className : "thx.TestObjects", methodName : "testObjects"});
			utest_Assert.isTrue(HxOverrides.remove(values,"B"),null,{ fileName : "TestObjects.hx", lineNumber : 45, className : "thx.TestObjects", methodName : "testObjects"});
			utest_Assert.equals(0,values.length,null,{ fileName : "TestObjects.hx", lineNumber : 46, className : "thx.TestObjects", methodName : "testObjects"});
			var tuples = thx_Objects.tuples(ob1);
			tuples.sort((function() {
				return function(a,b) {
					return haxe_Utf8.compare(a._0,b._0);
				};
			})());
			utest_Assert.same([{ _0 : "a", _1 : "A"},{ _0 : "b", _1 : "B"}],tuples,null,null,null,{ fileName : "TestObjects.hx", lineNumber : 52, className : "thx.TestObjects", methodName : "testObjects"});
		}
	}
	,testAssign: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			utest_Assert.same("Michael",out.name,null,null,null,{ fileName : "TestObjects.hx", lineNumber : 59, className : "thx.TestObjects", methodName : "testAssign"});
			utest_Assert.same("Two",out.age,null,null,null,{ fileName : "TestObjects.hx", lineNumber : 60, className : "thx.TestObjects", methodName : "testAssign"});
			utest_Assert.same("bar",out.foo,null,null,null,{ fileName : "TestObjects.hx", lineNumber : 61, className : "thx.TestObjects", methodName : "testAssign"});
			var _g2 = 0;
			var _g3 = Reflect.fields(out);
			while(_g2 < _g3.length) {
				var field = _g3[_g2];
				++_g2;
				utest_Assert.same(Reflect.field(out,field),Reflect.field(o,field),null,null,null,{ fileName : "TestObjects.hx", lineNumber : 64, className : "thx.TestObjects", methodName : "testAssign"});
			}
		}
	}
	,testCombine: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.same("Michael",out.name,null,null,null,{ fileName : "TestObjects.hx", lineNumber : 73, className : "thx.TestObjects", methodName : "testCombine"});
			utest_Assert.same("Two",out.age,null,null,null,{ fileName : "TestObjects.hx", lineNumber : 74, className : "thx.TestObjects", methodName : "testCombine"});
			utest_Assert.same("bar",out.foo,null,null,null,{ fileName : "TestObjects.hx", lineNumber : 75, className : "thx.TestObjects", methodName : "testCombine"});
			utest_Assert.same("Franco",o.name,null,null,null,{ fileName : "TestObjects.hx", lineNumber : 76, className : "thx.TestObjects", methodName : "testCombine"});
		}
	}
	,testMergeWithNullable: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.same("baz",thx_Objects.combine({ foo : "baz", bar : "qux"},{ }).foo,null,null,null,{ fileName : "TestObjects.hx", lineNumber : 89, className : "thx.TestObjects", methodName : "testMergeWithNullable"});
		}
	}
	,testMergeWithTypedef: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(merged.foo,from.foo,null,null,null,{ fileName : "TestObjects.hx", lineNumber : 104, className : "thx.TestObjects", methodName : "testMergeWithTypedef"});
			utest_Assert.same(merged.bar,to.bar,null,null,null,{ fileName : "TestObjects.hx", lineNumber : 105, className : "thx.TestObjects", methodName : "testMergeWithTypedef"});
			utest_Assert.same(Reflect.field(merged,"extra"),"field",null,null,null,{ fileName : "TestObjects.hx", lineNumber : 106, className : "thx.TestObjects", methodName : "testMergeWithTypedef"});
		}
	}
	,testHasPath: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.isTrue(thx_Objects.hasPath(o,"key1.key2"),null,{ fileName : "TestObjects.hx", lineNumber : 127, className : "thx.TestObjects", methodName : "testHasPath"});
			utest_Assert.isTrue(thx_Objects.hasPath(o,"key1.key4.1"),null,{ fileName : "TestObjects.hx", lineNumber : 128, className : "thx.TestObjects", methodName : "testHasPath"});
			utest_Assert.isTrue(thx_Objects.hasPath(o,"key1.key6"),null,{ fileName : "TestObjects.hx", lineNumber : 129, className : "thx.TestObjects", methodName : "testHasPath"});
			utest_Assert.isFalse(thx_Objects.hasPath(o,"key1.key4.2"),null,{ fileName : "TestObjects.hx", lineNumber : 131, className : "thx.TestObjects", methodName : "testHasPath"});
			utest_Assert.isFalse(thx_Objects.hasPath(o,"key1.key7"),null,{ fileName : "TestObjects.hx", lineNumber : 132, className : "thx.TestObjects", methodName : "testHasPath"});
		}
	}
	,testHasPathValue: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.isFalse(thx_Objects.hasPathValue(o,"key1.key6"),null,{ fileName : "TestObjects.hx", lineNumber : 154, className : "thx.TestObjects", methodName : "testHasPathValue"});
			utest_Assert.isFalse(thx_Objects.hasPathValue(o,"key1.key4.2"),null,{ fileName : "TestObjects.hx", lineNumber : 155, className : "thx.TestObjects", methodName : "testHasPathValue"});
			utest_Assert.isFalse(thx_Objects.hasPathValue(o,"key1.key7"),null,{ fileName : "TestObjects.hx", lineNumber : 156, className : "thx.TestObjects", methodName : "testHasPathValue"});
		}
	}
	,testGetPath: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(123,thx_Objects.getPath(o,"key1.key2"),null,null,null,{ fileName : "TestObjects.hx", lineNumber : 175, className : "thx.TestObjects", methodName : "testGetPath"});
			utest_Assert.same("abc",thx_Objects.getPath(o,"key1.key3"),null,null,null,{ fileName : "TestObjects.hx", lineNumber : 176, className : "thx.TestObjects", methodName : "testGetPath"});
			utest_Assert.same("one",thx_Objects.getPath(o,"key1.key4.0"),null,null,null,{ fileName : "TestObjects.hx", lineNumber : 177, className : "thx.TestObjects", methodName : "testGetPath"});
			utest_Assert.same("two",thx_Objects.getPath(o,"key1.key4.1"),null,null,null,{ fileName : "TestObjects.hx", lineNumber : 178, className : "thx.TestObjects", methodName : "testGetPath"});
			utest_Assert.same([{ key6 : "test1"},{ key6 : "test2"}],thx_Objects.getPath(o,"key1.key5"),null,null,null,{ fileName : "TestObjects.hx", lineNumber : 179, className : "thx.TestObjects", methodName : "testGetPath"});
			utest_Assert.same("test1",thx_Objects.getPath(o,"key1.key5.0.key6"),null,null,null,{ fileName : "TestObjects.hx", lineNumber : 180, className : "thx.TestObjects", methodName : "testGetPath"});
			utest_Assert.same("test2",thx_Objects.getPath(o,"key1.key5.1.key6"),null,null,null,{ fileName : "TestObjects.hx", lineNumber : 181, className : "thx.TestObjects", methodName : "testGetPath"});
			utest_Assert.isNull(thx_Objects.getPath(o,""),null,{ fileName : "TestObjects.hx", lineNumber : 183, className : "thx.TestObjects", methodName : "testGetPath"});
			utest_Assert.isNull(thx_Objects.getPath(o,"bad"),null,{ fileName : "TestObjects.hx", lineNumber : 184, className : "thx.TestObjects", methodName : "testGetPath"});
			utest_Assert.isNull(thx_Objects.getPath(o,"bad.key"),null,{ fileName : "TestObjects.hx", lineNumber : 185, className : "thx.TestObjects", methodName : "testGetPath"});
		}
	}
	,testSetPath: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.same({ key : "val"},thx_Objects.setPath({ },"key","val"),null,null,null,{ fileName : "TestObjects.hx", lineNumber : 190, className : "thx.TestObjects", methodName : "testSetPath"});
			utest_Assert.same({ key1 : "val1", key2 : "val2"},thx_Objects.setPath(thx_Objects.setPath({ },"key1","val1"),"key2","val2"),null,null,null,{ fileName : "TestObjects.hx", lineNumber : 191, className : "thx.TestObjects", methodName : "testSetPath"});
			utest_Assert.same({ key1 : { key2 : "val"}},thx_Objects.setPath({ },"key1.key2","val"),null,null,null,{ fileName : "TestObjects.hx", lineNumber : 192, className : "thx.TestObjects", methodName : "testSetPath"});
			utest_Assert.same({ key1 : [{ key2 : "val"}]},thx_Objects.setPath({ },"key1.0.key2","val"),null,null,null,{ fileName : "TestObjects.hx", lineNumber : 193, className : "thx.TestObjects", methodName : "testSetPath"});
			utest_Assert.same({ key1 : [[[null,123]]]},thx_Objects.setPath({ },"key1.0.0.1",123),null,null,null,{ fileName : "TestObjects.hx", lineNumber : 194, className : "thx.TestObjects", methodName : "testSetPath"});
			utest_Assert.same({ key1 : [[[null,{ key2 : "val"}]]]},thx_Objects.setPath({ },"key1.0.0.1.key2","val"),null,null,null,{ fileName : "TestObjects.hx", lineNumber : 195, className : "thx.TestObjects", methodName : "testSetPath"});
			utest_Assert.same({ key : "val"},thx_Objects.setPath({ key : "before"},"key","val"),null,null,null,{ fileName : "TestObjects.hx", lineNumber : 197, className : "thx.TestObjects", methodName : "testSetPath"});
			utest_Assert.same({ key1 : { key2 : "val"}},thx_Objects.setPath({ key1 : { key2 : "before"}},"key1.key2","val"),null,null,null,{ fileName : "TestObjects.hx", lineNumber : 198, className : "thx.TestObjects", methodName : "testSetPath"});
			utest_Assert.same({ key1 : { key2 : [1,55,3]}},thx_Objects.setPath({ key1 : { key2 : [1,2,3]}},"key1.key2.1",55),null,null,null,{ fileName : "TestObjects.hx", lineNumber : 199, className : "thx.TestObjects", methodName : "testSetPath"});
			utest_Assert.same({ key1 : 123, newKey : "val"},thx_Objects.setPath({ key1 : 123},"newKey","val"),null,null,null,{ fileName : "TestObjects.hx", lineNumber : 200, className : "thx.TestObjects", methodName : "testSetPath"});
			utest_Assert.same([1,2],thx_Objects.setPath(thx_Objects.setPath([],"*",1),"*",2),null,null,null,{ fileName : "TestObjects.hx", lineNumber : 202, className : "thx.TestObjects", methodName : "testSetPath"});
			utest_Assert.same({ list : [1,2]},thx_Objects.setPath(thx_Objects.setPath({ },"list.*",1),"list.*",2),null,null,null,{ fileName : "TestObjects.hx", lineNumber : 203, className : "thx.TestObjects", methodName : "testSetPath"});
			utest_Assert.same([[1,2]],thx_Objects.setPath(thx_Objects.setPath([],"0.*",1),"0.*",2),null,null,null,{ fileName : "TestObjects.hx", lineNumber : 204, className : "thx.TestObjects", methodName : "testSetPath"});
			utest_Assert.same([[1],[2]],thx_Objects.setPath(thx_Objects.setPath([],"0.*",1),"*.*",2),null,null,null,{ fileName : "TestObjects.hx", lineNumber : 205, className : "thx.TestObjects", methodName : "testSetPath"});
		}
	}
	,testRemovePath: function() {
		...
		while(_g1 < _g) {
			...
			var arr = { foo : [{ },{ bar : "baz"}]};
			utest_Assert.same({ },thx_Objects.removePath(simple,"foo"),null,null,null,{ fileName : "TestObjects.hx", lineNumber : 225, className : "thx.TestObjects", methodName : "testRemovePath"});
			utest_Assert.same({ },simple,null,null,null,{ fileName : "TestObjects.hx", lineNumber : 226, className : "thx.TestObjects", methodName : "testRemovePath"});
			utest_Assert.same(simple,thx_Objects.removePath(simple,"a.b.c.d"),null,null,null,{ fileName : "TestObjects.hx", lineNumber : 227, className : "thx.TestObjects", methodName : "testRemovePath"});
			utest_Assert.same({ foo : { bar : { baz : "qux"}}},thx_Objects.removePath(nested,"foo.bar.other"),null,null,null,{ fileName : "TestObjects.hx", lineNumber : 229, className : "thx.TestObjects", methodName : "testRemovePath"});
			utest_Assert.same(arr,thx_Objects.removePath(arr,"foo.0.bar"),null,null,null,{ fileName : "TestObjects.hx", lineNumber : 231, className : "thx.TestObjects", methodName : "testRemovePath"});
			utest_Assert.same({ foo : [{ },{ }]},thx_Objects.removePath(arr,"foo.1.bar"),null,null,null,{ fileName : "TestObjects.hx", lineNumber : 232, className : "thx.TestObjects", methodName : "testRemovePath"});
		}
	}
