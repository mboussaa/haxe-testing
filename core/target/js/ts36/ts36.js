...
TS36.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS36.hx", lineNumber : 10, className : "TS36", methodName : "addTests"});
	runner.addCase(new thx_TestReadonlyArray(Std.parseInt(w)));
};
TS36.main = function() {
	var runner = new utest_Runner();
	TS36.addTests(runner);
...
var thx_TestReadonlyArray = function(i) {
	this.x = i;
};
...
thx_TestReadonlyArray.prototype = {
	...
	,testInsertAt: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.isTrue(a != b,null,{ fileName : "TestReadonlyArray.hx", lineNumber : 20, className : "thx.TestReadonlyArray", methodName : "testInsertAt"});
			utest_Assert.same([0,1,2,4],b,null,null,null,{ fileName : "TestReadonlyArray.hx", lineNumber : 21, className : "thx.TestReadonlyArray", methodName : "testInsertAt"});
			b = a.slice(0,2).concat([3]).concat(a.slice(2));
			utest_Assert.same([1,2,3,4],b,null,null,null,{ fileName : "TestReadonlyArray.hx", lineNumber : 24, className : "thx.TestReadonlyArray", methodName : "testInsertAt"});
			b = a.slice(0,10).concat([5]).concat(a.slice(10));
			utest_Assert.same([1,2,4,5],b,null,null,null,{ fileName : "TestReadonlyArray.hx", lineNumber : 27, className : "thx.TestReadonlyArray", methodName : "testInsertAt"});
		}
	}
	,testReplaceAt: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.isTrue(a != b,null,{ fileName : "TestReadonlyArray.hx", lineNumber : 34, className : "thx.TestReadonlyArray", methodName : "testReplaceAt"});
			utest_Assert.same([0,2,4],b,null,null,null,{ fileName : "TestReadonlyArray.hx", lineNumber : 35, className : "thx.TestReadonlyArray", methodName : "testReplaceAt"});
			b = a.slice(0,2).concat([3]).concat(a.slice(3));
			utest_Assert.same([1,2,3],b,null,null,null,{ fileName : "TestReadonlyArray.hx", lineNumber : 38, className : "thx.TestReadonlyArray", methodName : "testReplaceAt"});
			b = a.slice(0,10).concat([5]).concat(a.slice(11));
			utest_Assert.same([1,2,4,5],b,null,null,null,{ fileName : "TestReadonlyArray.hx", lineNumber : 41, className : "thx.TestReadonlyArray", methodName : "testReplaceAt"});
		}
	}
	,testPush: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			var a = [1,2,3];
			var b = a.concat([4]);
			utest_Assert.same([1,2,3],a,null,null,null,{ fileName : "TestReadonlyArray.hx", lineNumber : 48, className : "thx.TestReadonlyArray", methodName : "testPush"});
			utest_Assert.same([1,2,3,4],b,null,null,null,{ fileName : "TestReadonlyArray.hx", lineNumber : 49, className : "thx.TestReadonlyArray", methodName : "testPush"});
		}
	}
	,testPop: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(2,result._0,null,null,null,{ fileName : "TestReadonlyArray.hx", lineNumber : 57, className : "thx.TestReadonlyArray", methodName : "testPop"});
			utest_Assert.same([1],result._1,null,null,null,{ fileName : "TestReadonlyArray.hx", lineNumber : 58, className : "thx.TestReadonlyArray", methodName : "testPop"});
			var b = result._1;
			if(b.length == 0) {
				result = { _0 : null, _1 : b};
			} else {
			...
			utest_Assert.same(1,result._0,null,null,null,{ fileName : "TestReadonlyArray.hx", lineNumber : 62, className : "thx.TestReadonlyArray", methodName : "testPop"});
			utest_Assert.same([],result._1,null,null,null,{ fileName : "TestReadonlyArray.hx", lineNumber : 63, className : "thx.TestReadonlyArray", methodName : "testPop"});
			var c = result._1;
			if(c.length == 0) {
				result = { _0 : null, _1 : c};
			} else {
			...
			utest_Assert.isNull(result._0,null,{ fileName : "TestReadonlyArray.hx", lineNumber : 67, className : "thx.TestReadonlyArray", methodName : "testPop"});
			utest_Assert.same([],result._1,null,null,null,{ fileName : "TestReadonlyArray.hx", lineNumber : 68, className : "thx.TestReadonlyArray", methodName : "testPop"});
			utest_Assert.same([1,2],a,null,null,null,{ fileName : "TestReadonlyArray.hx", lineNumber : 70, className : "thx.TestReadonlyArray", methodName : "testPop"});
		}
	}
	,testShift: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(1,result._0,null,null,null,{ fileName : "TestReadonlyArray.hx", lineNumber : 78, className : "thx.TestReadonlyArray", methodName : "testShift"});
			utest_Assert.same([2],result._1,null,null,null,{ fileName : "TestReadonlyArray.hx", lineNumber : 79, className : "thx.TestReadonlyArray", methodName : "testShift"});
			result = thx__$ReadonlyArray_ReadonlyArray_$Impl_$.shift(result._1);
			utest_Assert.same(2,result._0,null,null,null,{ fileName : "TestReadonlyArray.hx", lineNumber : 83, className : "thx.TestReadonlyArray", methodName : "testShift"});
			utest_Assert.same([],result._1,null,null,null,{ fileName : "TestReadonlyArray.hx", lineNumber : 84, className : "thx.TestReadonlyArray", methodName : "testShift"});
			result = thx__$ReadonlyArray_ReadonlyArray_$Impl_$.shift(result._1);
			utest_Assert.isNull(result._0,null,{ fileName : "TestReadonlyArray.hx", lineNumber : 88, className : "thx.TestReadonlyArray", methodName : "testShift"});
			utest_Assert.same([],result._1,null,null,null,{ fileName : "TestReadonlyArray.hx", lineNumber : 89, className : "thx.TestReadonlyArray", methodName : "testShift"});
			utest_Assert.same([1,2],a,null,null,null,{ fileName : "TestReadonlyArray.hx", lineNumber : 91, className : "thx.TestReadonlyArray", methodName : "testShift"});
		}
	}
	,testUnshift: function() {
		...
		while(_g1 < _g) {
			...
			var a = [1,2,3];
			var b = [4].concat(a);
			utest_Assert.same([1,2,3],a,null,null,null,{ fileName : "TestReadonlyArray.hx", lineNumber : 98, className : "thx.TestReadonlyArray", methodName : "testUnshift"});
			utest_Assert.same([4,1,2,3],b,null,null,null,{ fileName : "TestReadonlyArray.hx", lineNumber : 99, className : "thx.TestReadonlyArray", methodName : "testUnshift"});
		}
	}
