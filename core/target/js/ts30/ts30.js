...
TS30.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS30.hx", lineNumber : 10, className : "TS30", methodName : "addTests"});
	runner.addCase(new thx_TestMake(Std.parseInt(w)));
};
TS30.main = function() {
	var runner = new utest_Runner();
	TS30.addTests(runner);
...
thx_TestMake.prototype = {
	...
	,testConstructorLiteral: function() {
		...
		while(_g1 < _g) {
			...
			})("A",1,0.2,"D"),null,null,null,{ fileName : "TestMake.hx", lineNumber : 14, className : "thx.TestMake", methodName : "testConstructorLiteral"});
		}
	}
	,testConstructorFromTypedef: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.same({ c : "A", b : 1, a : 0.2, d : "D"},(function(c,b,a,d) {
				...
				return obj;
			})("A",1,0.2,"D"),null,null,null,{ fileName : "TestMake.hx", lineNumber : 25, className : "thx.TestMake", methodName : "testConstructorFromTypedef"});
		}
	}
