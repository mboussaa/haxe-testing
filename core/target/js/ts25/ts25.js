...
TS25.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS25.hx", lineNumber : 10, className : "TS25", methodName : "addTests"});
	runner.addCase(new thx_TestIterables(Std.parseInt(w)));
};
TS25.main = function() {
	var runner = new utest_Runner();
	TS25.addTests(runner);
...
var thx_TestIterables = function(i) {
	this.x = i;
};
...
thx_TestIterables.prototype = {
	...
	,testMin: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.same(haxe_ds_Option.Some(1),thx_Iterables.minBy([3,1,2],thx_Functions.identity,thx_Ints.order),null,null,null,{ fileName : "TestIterables.hx", lineNumber : 18, className : "thx.TestIterables", methodName : "testMin"});
			utest_Assert.same(haxe_ds_Option.None,thx_Iterables.minBy([],thx_Functions.identity,thx_Ints.order),null,null,null,{ fileName : "TestIterables.hx", lineNumber : 19, className : "thx.TestIterables", methodName : "testMin"});
		}
	}
	,testMinBy: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(haxe_ds_Option.Some({ a : 1}),thx_Iterables.minBy([{ a : 3},{ a : 1},{ a : 2}],function(o) {
				return o.a;
			},thx_Ints.order),null,null,null,{ fileName : "TestIterables.hx", lineNumber : 26, className : "thx.TestIterables", methodName : "testMinBy"});
			utest_Assert.same(haxe_ds_Option.None,thx_Iterables.minBy([],function(o1) {
				return o1.a;
			},thx_Ints.order),null,null,null,{ fileName : "TestIterables.hx", lineNumber : 27, className : "thx.TestIterables", methodName : "testMinBy"});
		}
	}
