...
TS48.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS48.hx", lineNumber : 10, className : "TS48", methodName : "addTests"});
	runner.addCase(new thx_fp_TestList(Std.parseInt(w)));
};
TS48.main = function() {
...
var thx_fp_TestList = function(i) {
	this.x = i;
};
...
thx_fp_TestList.prototype = {
	...
	,testFoldLeft: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.equals(6,thx_fp__$List_List_$Impl_$.foldLeft(list,0,function(_0,_1) {
				return _0 + _1;
			}),null,{ fileName : "TestList.hx", lineNumber : 17, className : "thx.fp.TestList", methodName : "testFoldLeft"});
			utest_Assert.same([1,2,3],thx_fp__$List_List_$Impl_$.foldLeft(list,[],function(acc,v) {
				acc.push(v);
				return acc;
			}),null,null,null,{ fileName : "TestList.hx", lineNumber : 19, className : "thx.fp.TestList", methodName : "testFoldLeft"});
		}
	}
	,testToArray: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.same([1,2,3],thx_fp__$List_List_$Impl_$.foldLeft(list,[],function(acc,a) {
				acc.push(a);
				return acc;
			}),null,null,null,{ fileName : "TestList.hx", lineNumber : 28, className : "thx.fp.TestList", methodName : "testToArray"});
		}
	}
	,testIntersperse: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(thx_fp_ListImpl.Cons(1,thx_fp_ListImpl.Cons(0,thx_fp_ListImpl.Cons(2,thx_fp_ListImpl.Cons(0,thx_fp_ListImpl.Cons(3,thx_fp_ListImpl.Nil))))),interspersed,null,null,null,{ fileName : "TestList.hx", lineNumber : 35, className : "thx.fp.TestList", methodName : "testIntersperse"});
		}
	}
	,testFromArray: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var arr = [1,2,3,4];
			utest_Assert.same(arr,thx_fp__$List_List_$Impl_$.foldLeft(((function(_e) {
				return function(f,initial) {
					var initial1 = initial;
					var i = _e[0].length;
					while(--i >= 0) initial1 = f(initial1,_e[0][i]);
					return initial1;
				};
			})([arr]))((function() {
			...
			})()),null,null,null,{ fileName : "TestList.hx", lineNumber : 41, className : "thx.fp.TestList", methodName : "testFromArray"});
		}
	}
	,testConcat: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(thx_fp_ListImpl.Cons(1,thx_fp_ListImpl.Cons(2,thx_fp_ListImpl.Cons(3,thx_fp_ListImpl.Cons(4,thx_fp_ListImpl.Nil)))),l,null,null,null,{ fileName : "TestList.hx", lineNumber : 49, className : "thx.fp.TestList", methodName : "testConcat"});
		}
	}
	,testToString: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.same("[1,2,3]",thx_fp__$List_List_$Impl_$.toStringWithShow(list,function(a1) {
				return thx_Ints.toString(a1,10);
			}),null,null,null,{ fileName : "TestList.hx", lineNumber : 55, className : "thx.fp.TestList", methodName : "testToString"});
			...
			utest_Assert.same("[1,2,3]","[" + thx_fp__$List_List_$Impl_$.foldLeft(thx_fp__$List_List_$Impl_$.intersperse(list1,","),"",function(_0,_1) {
				return _0 + _1;
			}) + "]",null,null,null,{ fileName : "TestList.hx", lineNumber : 58, className : "thx.fp.TestList", methodName : "testToString"});
		}
	}
	,testMap: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(thx_fp_ListImpl.Cons(2,thx_fp_ListImpl.Cons(4,thx_fp_ListImpl.Cons(6,thx_fp_ListImpl.Nil))),thx_fp__$List_List_$Impl_$.map(list,function(v) {
				return v * 2;
			}),null,null,null,{ fileName : "TestList.hx", lineNumber : 64, className : "thx.fp.TestList", methodName : "testMap"});
		}
	}
			...
			map[0] = (function(map1) {
				return function(v) {
					if(v == 0) {
						...
						return thx_fp_ListImpl.Cons(v,map1[0](v - 1));
					}
				};
			})(map);
			var slist = thx_fp__$List_List_$Impl_$.flatMap(list,map[0]);
			utest_Assert.same(thx_fp_ListImpl.Cons(1,thx_fp_ListImpl.Cons(2,thx_fp_ListImpl.Cons(1,thx_fp_ListImpl.Cons(3,thx_fp_ListImpl.Cons(2,thx_fp_ListImpl.Cons(1,thx_fp_ListImpl.Nil)))))),slist,null,null,null,{ fileName : "TestList.hx", lineNumber : 77, className : "thx.fp.TestList", methodName : "testFlatMap"});
		}
	}
	,testZip5Ap: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			var ix = ((function(_e1) {
				return function(f1,initial2) {
					var initial3 = initial2;
					var i1 = _e1[0].length;
					while(--i1 >= 0) initial3 = f1(initial3,_e1[0][i1]);
					return initial3;
				};
			})([[1,2]]))((function() {
				return function(_01,_11) {
					return thx_fp_ListImpl.Cons(_11,_01);
				};
			})(),thx_fp__$List_List_$Impl_$.empty());
			var tx = ((function(_e2) {
				return function(f2,initial4) {
					var initial5 = initial4;
					var i2 = _e2[0].length;
					while(--i2 >= 0) initial5 = f2(initial5,_e2[0][i2]);
					return initial5;
				};
			})([["x","y","z"]]))((function() {
				return function(_02,_12) {
					return thx_fp_ListImpl.Cons(_12,_02);
				};
			})(),thx_fp__$List_List_$Impl_$.empty());
			var jx = ((function(_e3) {
				return function(f3,initial6) {
					var initial7 = initial6;
					var i3 = _e3[0].length;
					while(--i3 >= 0) initial7 = f3(initial7,_e3[0][i3]);
					return initial7;
				};
			})([[3,4]]))((function() {
				return function(_03,_13) {
					return thx_fp_ListImpl.Cons(_13,_03);
				};
			})(),thx_fp__$List_List_$Impl_$.empty());
			var bx = ((function(_e4) {
				return function(f4,initial8) {
					var initial9 = initial8;
					var i4 = _e4[0].length;
					while(--i4 >= 0) initial9 = f4(initial9,_e4[0][i4]);
					return initial9;
				};
			})([[true,false,true]]))((function() {
				return function(_04,_14) {
					return thx_fp_ListImpl.Cons(_14,_04);
				};
			})(),thx_fp__$List_List_$Impl_$.empty());
			utest_Assert.same(((function(_e5) {
				return function(f5,initial10) {
					var initial11 = initial10;
					var i5 = _e5[0].length;
					while(--i5 >= 0) initial11 = f5(initial11,_e5[0][i5]);
					return initial11;
				};
			})([["a1x3true","b2y4false"]]))((function() {
				return function(_05,_15) {
					return thx_fp_ListImpl.Cons(_15,_05);
				};
			})(),thx_fp__$List_List_$Impl_$.empty()),thx_fp__$List_List_$Impl_$.zip5Ap((function() {
				return function(s,i6,t,j,b) {
					return "" + s + i6 + t + j + (b == null?"null":"" + b);
				};
			})(),sx,ix,tx,jx,bx),null,null,null,{ fileName : "TestList.hx", lineNumber : 89, className : "thx.fp.TestList", methodName : "testZip5Ap"});
		}
	}
