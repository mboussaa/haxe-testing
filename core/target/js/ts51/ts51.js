...
TS51.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS51.hx", lineNumber : 10, className : "TS51", methodName : "addTests"});
	runner.addCase(new thx_fp_TestState(Std.parseInt(w)));
};
TS51.main = function() {
	var runner = new utest_Runner();
	TS51.addTests(runner);
...
var thx_fp_TestState = function(i) {
	this.x = i;
};
...
thx_fp_TestState.prototype = {
	...
	,testMap: function() {
		...
		while(_g1 < _g) {
			...
			var s = (function(f1,this2) {
				return function(s1) {
					return thx__$Tuple_Tuple2_$Impl_$.map(this2[0](s1),f1[0]);
				};
			})(f,this1);
			utest_Assert.same({ _0 : "a", _1 : 2},s("a"),null,null,null,{ fileName : "TestState.hx", lineNumber : 17, className : "thx.fp.TestState", methodName : "testMap"});
		}
	}
	,testFlatMap: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.same({ _0 : "ab", _1 : 2},(thx_fp__$State_State_$Impl_$.flatMap(s[0],(function(s1) {
				return function(i) {
					var this1 = thx_fp__$State_State_$Impl_$.modify(s1[0],(function() {
						return function(v) {
							return v + "b";
						};
					})());
					...
					return (function() {
						return function(s2) {
							return thx__$Tuple_Tuple2_$Impl_$.map(this1(s2),f);
						};
					})();
				};
			})(s)))("a"),null,null,null,{ fileName : "TestState.hx", lineNumber : 28, className : "thx.fp.TestState", methodName : "testFlatMap"});
		}
	}
