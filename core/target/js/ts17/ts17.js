...
TS17.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS17.hx", lineNumber : 10, className : "TS17", methodName : "addTests"});
	runner.addCase(new thx_TestEnums(Std.parseInt(w)));
};
TS17.main = function() {
...
thx_TestEnums.prototype = {
	...
	,testIssue20151201: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.stringContains("oldId : \"1\"",s,null,{ fileName : "TestEnums.hx", lineNumber : 20, className : "thx.TestEnums", methodName : "testIssue20151201"});
			utest_Assert.stringContains("newId : \"2\"",s,null,{ fileName : "TestEnums.hx", lineNumber : 21, className : "thx.TestEnums", methodName : "testIssue20151201"});
			utest_Assert.stringContains(", ",s,null,{ fileName : "TestEnums.hx", lineNumber : 22, className : "thx.TestEnums", methodName : "testIssue20151201"});
			utest_Assert.isTrue(StringTools.startsWith(s,"Test({"),null,{ fileName : "TestEnums.hx", lineNumber : 23, className : "thx.TestEnums", methodName : "testIssue20151201"});
			utest_Assert.isTrue(StringTools.endsWith(s,"})"),null,{ fileName : "TestEnums.hx", lineNumber : 24, className : "thx.TestEnums", methodName : "testIssue20151201"});
		}
	}
	...
	,testString: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("A",thx_Enums.string(thx__$TestEnums_Sample.A),null,{ fileName : "TestEnums.hx", lineNumber : 39, className : "thx.TestEnums", methodName : "testString"});
			utest_Assert.equals("B(1)",thx_Enums.string(thx__$TestEnums_Sample.B(1)),null,{ fileName : "TestEnums.hx", lineNumber : 40, className : "thx.TestEnums", methodName : "testString"});
		}
	}
