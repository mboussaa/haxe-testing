...
TS45.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS45.hx", lineNumber : 10, className : "TS45", methodName : "addTests"});
	runner.addCase(new thx_TestTuple(Std.parseInt(w)));
};
TS45.main = function() {
...
thx_TestTuple.prototype = {
	...
	,testTuple0: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals(thx_Nil.nil,thx_Nil.nil,null,{ fileName : "TestTuple.hx", lineNumber : 16, className : "thx.TestTuple", methodName : "testTuple0"});
		}
	}
	,testTuple1: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("thx","thx",null,{ fileName : "TestTuple.hx", lineNumber : 22, className : "thx.TestTuple", methodName : "testTuple1"});
		}
	}
	,testTuple2: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			var t = { _0 : "thx", _1 : 7};
			utest_Assert.equals("thx",t._0,null,{ fileName : "TestTuple.hx", lineNumber : 28, className : "thx.TestTuple", methodName : "testTuple2"});
			utest_Assert.equals(7,t._1,null,{ fileName : "TestTuple.hx", lineNumber : 29, className : "thx.TestTuple", methodName : "testTuple2"});
			utest_Assert.equals("thx",t._0,null,{ fileName : "TestTuple.hx", lineNumber : 30, className : "thx.TestTuple", methodName : "testTuple2"});
			utest_Assert.equals(7,t._1,null,{ fileName : "TestTuple.hx", lineNumber : 31, className : "thx.TestTuple", methodName : "testTuple2"});
		}
	}
