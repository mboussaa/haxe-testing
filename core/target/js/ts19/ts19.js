...
TS19.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS19.hx", lineNumber : 10, className : "TS19", methodName : "addTests"});
	runner.addCase(new thx_TestError(Std.parseInt(w)));
};
TS19.main = function() {
...
thx_TestError.prototype = {
	...
	,testAbstract: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var error = new thx_error_AbstractMethod({ fileName : "TestError.hx", lineNumber : 16, className : "thx.TestError", methodName : "testAbstract"});
			utest_Assert.notNull(error,null,{ fileName : "TestError.hx", lineNumber : 18, className : "thx.TestError", methodName : "testAbstract"});
			utest_Assert.stringContains("TestError",error.message,null,{ fileName : "TestError.hx", lineNumber : 19, className : "thx.TestError", methodName : "testAbstract"});
			utest_Assert.stringContains("testAbstract",error.message,null,{ fileName : "TestError.hx", lineNumber : 20, className : "thx.TestError", methodName : "testAbstract"});
			utest_Assert.stringContains("is abstract",error.message,null,{ fileName : "TestError.hx", lineNumber : 21, className : "thx.TestError", methodName : "testAbstract"});
		}
	}
	,testNotImplemented: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var error = new thx_error_NotImplemented({ fileName : "TestError.hx", lineNumber : 26, className : "thx.TestError", methodName : "testNotImplemented"});
			utest_Assert.notNull(error,null,{ fileName : "TestError.hx", lineNumber : 28, className : "thx.TestError", methodName : "testNotImplemented"});
			utest_Assert.stringContains("TestError",error.message,null,{ fileName : "TestError.hx", lineNumber : 29, className : "thx.TestError", methodName : "testNotImplemented"});
			utest_Assert.stringContains("testNotImplemented",error.message,null,{ fileName : "TestError.hx", lineNumber : 30, className : "thx.TestError", methodName : "testNotImplemented"});
			utest_Assert.stringContains("needs to be implemented",error.message,null,{ fileName : "TestError.hx", lineNumber : 31, className : "thx.TestError", methodName : "testNotImplemented"});
		}
	}
	,testNullArgument: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.raises(function() {
				_gthis.nullInt(null);
			},thx_error_NullArgument,null,null,{ fileName : "TestError.hx", lineNumber : 36, className : "thx.TestError", methodName : "testNullArgument"});
			this.nullInt(1);
		}
	}
	,testNullArgumentUsing: function() {
		...
		while(_g1 < _g) {
			...
			},thx_error_NullArgument,null,null,{ fileName : "TestError.hx", lineNumber : 42, className : "thx.TestError", methodName : "testNullArgumentUsing"});
			this.nullUsingInt(1);
		}
	}
	,testEmptyArray: function() {
		...
		while(_g1 < _g) {
			...
			},thx_error_NullArgument,null,null,{ fileName : "TestError.hx", lineNumber : 48, className : "thx.TestError", methodName : "testEmptyArray"});
			utest_Assert.raises(function() {
				_gthis.emptyArray([]);
			},thx_error_NullArgument,null,null,{ fileName : "TestError.hx", lineNumber : 49, className : "thx.TestError", methodName : "testEmptyArray"});
			this.emptyArray([1]);
		}
	}
	,testEmptyString: function() {
		...
		while(_g1 < _g) {
			...
			},thx_error_NullArgument,null,null,{ fileName : "TestError.hx", lineNumber : 55, className : "thx.TestError", methodName : "testEmptyString"});
			utest_Assert.raises(function() {
				_gthis.emptyString("");
			},thx_error_NullArgument,null,null,{ fileName : "TestError.hx", lineNumber : 56, className : "thx.TestError", methodName : "testEmptyString"});
			this.emptyString("a");
		}
	}
	,testEmptyIterator: function() {
		...
		while(_g1 < _g) {
			...
			})(),thx_error_NullArgument,null,null,{ fileName : "TestError.hx", lineNumber : 63, className : "thx.TestError", methodName : "testEmptyIterator"});
			utest_Assert.raises((function(it1) {
				return function() {
					_gthis.emptyIterator(it1[0]);
				};
			})(it),thx_error_NullArgument,null,null,{ fileName : "TestError.hx", lineNumber : 64, className : "thx.TestError", methodName : "testEmptyIterator"});
	...
	,testEmptyIterable: function() {
		...
		while(_g1 < _g) {
			...
			})(),thx_error_NullArgument,null,null,{ fileName : "TestError.hx", lineNumber : 72, className : "thx.TestError", methodName : "testEmptyIterable"});
			utest_Assert.raises((function(it1) {
				return function() {
					_gthis.emptyIterable(it1[0]);
				};
			})(it),thx_error_NullArgument,null,null,{ fileName : "TestError.hx", lineNumber : 73, className : "thx.TestError", methodName : "testEmptyIterable"});
