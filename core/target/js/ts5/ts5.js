...
TS5.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS5.hx", lineNumber : 10, className : "TS5", methodName : "addTests"});
	runner.addCase(new thx_TestBitMatrix(Std.parseInt(w)));
};
TS5.main = function() {
...
var thx_TestBitMatrix = function(i) {
	this.x = i;
};
...
thx_TestBitMatrix.prototype = {
	...
	,testNew: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(0,thx__$BitMatrix_BitMatrix_$Impl_$.get_bitSetCount(bits),null,null,null,{ fileName : "TestBitMatrix.hx", lineNumber : 14, className : "thx.TestBitMatrix", methodName : "testNew"});
			utest_Assert.same(0,thx__$BitMatrix_BitMatrix_$Impl_$.get_length(bits),null,null,null,{ fileName : "TestBitMatrix.hx", lineNumber : 15, className : "thx.TestBitMatrix", methodName : "testNew"});
			bits = thx__$BitMatrix_BitMatrix_$Impl_$._new(5,10);
			utest_Assert.same(5,thx__$BitMatrix_BitMatrix_$Impl_$.get_bitSetCount(bits),null,null,null,{ fileName : "TestBitMatrix.hx", lineNumber : 18, className : "thx.TestBitMatrix", methodName : "testNew"});
			utest_Assert.same(10,thx__$BitMatrix_BitMatrix_$Impl_$.get_length(bits),null,null,null,{ fileName : "TestBitMatrix.hx", lineNumber : 19, className : "thx.TestBitMatrix", methodName : "testNew"});
		}
	}
	,testBitMatrix: function() {
		...
		while(_g1 < _g) {
			...
			thx__$BitMatrix_BitMatrix_$Impl_$.setBitAt(bits[0],0,0,true);
			thx__$BitMatrix_BitMatrix_$Impl_$.setBitAt(bits[0],0,1,true);
			thx__$BitMatrix_BitMatrix_$Impl_$.setBitAt(bits[0],0,2,true);
			thx__$BitMatrix_BitMatrix_$Impl_$.setBitAt(bits[0],1,0,false);
			thx__$BitMatrix_BitMatrix_$Impl_$.setBitAt(bits[0],1,1,false);
			thx__$BitMatrix_BitMatrix_$Impl_$.setBitAt(bits[0],1,2,false);
			thx__$BitMatrix_BitMatrix_$Impl_$.setBitAt(bits[0],2,0,true);
			thx__$BitMatrix_BitMatrix_$Impl_$.setBitAt(bits[0],2,1,false);
			thx__$BitMatrix_BitMatrix_$Impl_$.setBitAt(bits[0],2,2,true);
			utest_Assert.equals("111,000,101",thx__$BitMatrix_BitMatrix_$Impl_$.toString(bits[0]),null,{ fileName : "TestBitMatrix.hx", lineNumber : 34, className : "thx.TestBitMatrix", methodName : "testBitMatrix"});
			utest_Assert.raises((function(bits1) {
				return function() {
					thx__$BitMatrix_BitMatrix_$Impl_$.setBitAt(bits1[0],3,0,true);
				};
			})(bits),null,null,null,{ fileName : "TestBitMatrix.hx", lineNumber : 37, className : "thx.TestBitMatrix", methodName : "testBitMatrix"});
			thx__$BitMatrix_BitMatrix_$Impl_$.setBitAt(bits[0],0,3,true);
			utest_Assert.equals("1111,0000,1010",thx__$BitMatrix_BitMatrix_$Impl_$.toString(bits[0]),null,{ fileName : "TestBitMatrix.hx", lineNumber : 41, className : "thx.TestBitMatrix", methodName : "testBitMatrix"});
			utest_Assert.same(4,thx__$BitMatrix_BitMatrix_$Impl_$.get_length(bits[0]),null,null,null,{ fileName : "TestBitMatrix.hx", lineNumber : 42, className : "thx.TestBitMatrix", methodName : "testBitMatrix"});
			thx__$BitMatrix_BitMatrix_$Impl_$.setBitAt(bits[0],1,4,true);
			utest_Assert.equals("11110,00001,10100",thx__$BitMatrix_BitMatrix_$Impl_$.toString(bits[0]),null,{ fileName : "TestBitMatrix.hx", lineNumber : 45, className : "thx.TestBitMatrix", methodName : "testBitMatrix"});
			utest_Assert.same(5,thx__$BitMatrix_BitMatrix_$Impl_$.get_length(bits[0]),null,null,null,{ fileName : "TestBitMatrix.hx", lineNumber : 46, className : "thx.TestBitMatrix", methodName : "testBitMatrix"});
			thx__$BitMatrix_BitMatrix_$Impl_$.setBitAt(bits[0],2,5,true);
			utest_Assert.equals("111100,000010,101001",thx__$BitMatrix_BitMatrix_$Impl_$.toString(bits[0]),null,{ fileName : "TestBitMatrix.hx", lineNumber : 49, className : "thx.TestBitMatrix", methodName : "testBitMatrix"});
			utest_Assert.same(6,thx__$BitMatrix_BitMatrix_$Impl_$.get_length(bits[0]),null,null,null,{ fileName : "TestBitMatrix.hx", lineNumber : 50, className : "thx.TestBitMatrix", methodName : "testBitMatrix"});
		}
	}
	,testClone: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			utest_Assert.same("111,000",thx__$BitMatrix_BitMatrix_$Impl_$.toString(bits),null,null,null,{ fileName : "TestBitMatrix.hx", lineNumber : 65, className : "thx.TestBitMatrix", methodName : "testClone"});
			utest_Assert.same("101,010",thx__$BitMatrix_BitMatrix_$Impl_$.toString(clone),null,null,null,{ fileName : "TestBitMatrix.hx", lineNumber : 66, className : "thx.TestBitMatrix", methodName : "testClone"});
		}
	}
	,testFromToString: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.same("000,111,101,010",thx__$BitMatrix_BitMatrix_$Impl_$.toString(thx__$BitMatrix_BitMatrix_$Impl_$.fromString("000,111,101,010")),null,null,null,{ fileName : "TestBitMatrix.hx", lineNumber : 72, className : "thx.TestBitMatrix", methodName : "testFromToString"});
		}
	}
	,testFromToBools: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.same([[true,true],[false,false],[true,false],[false,true]],thx__$BitMatrix_BitMatrix_$Impl_$.toBools(thx__$BitMatrix_BitMatrix_$Impl_$.fromBools([[true,true],[false,false],[true,false],[false,true]])),null,null,null,{ fileName : "TestBitMatrix.hx", lineNumber : 78, className : "thx.TestBitMatrix", methodName : "testFromToBools"});
		}
	}
	,testConcat: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			utest_Assert.same("000,111,101,010",thx__$BitMatrix_BitMatrix_$Impl_$.toString(b1),null,null,null,{ fileName : "TestBitMatrix.hx", lineNumber : 86, className : "thx.TestBitMatrix", methodName : "testConcat"});
			utest_Assert.same("111,000,111,000",thx__$BitMatrix_BitMatrix_$Impl_$.toString(b2),null,null,null,{ fileName : "TestBitMatrix.hx", lineNumber : 87, className : "thx.TestBitMatrix", methodName : "testConcat"});
			utest_Assert.same("000111,111000,101111,010000",thx__$BitMatrix_BitMatrix_$Impl_$.toString(b3),null,null,null,{ fileName : "TestBitMatrix.hx", lineNumber : 88, className : "thx.TestBitMatrix", methodName : "testConcat"});
			utest_Assert.same(4,thx__$BitMatrix_BitMatrix_$Impl_$.get_bitSetCount(b1),null,null,null,{ fileName : "TestBitMatrix.hx", lineNumber : 89, className : "thx.TestBitMatrix", methodName : "testConcat"});
			utest_Assert.same(4,thx__$BitMatrix_BitMatrix_$Impl_$.get_bitSetCount(b2),null,null,null,{ fileName : "TestBitMatrix.hx", lineNumber : 90, className : "thx.TestBitMatrix", methodName : "testConcat"});
			utest_Assert.same(4,thx__$BitMatrix_BitMatrix_$Impl_$.get_bitSetCount(b3),null,null,null,{ fileName : "TestBitMatrix.hx", lineNumber : 91, className : "thx.TestBitMatrix", methodName : "testConcat"});
			utest_Assert.same(3,thx__$BitMatrix_BitMatrix_$Impl_$.get_length(b1),null,null,null,{ fileName : "TestBitMatrix.hx", lineNumber : 92, className : "thx.TestBitMatrix", methodName : "testConcat"});
			utest_Assert.same(3,thx__$BitMatrix_BitMatrix_$Impl_$.get_length(b2),null,null,null,{ fileName : "TestBitMatrix.hx", lineNumber : 93, className : "thx.TestBitMatrix", methodName : "testConcat"});
			utest_Assert.same(6,thx__$BitMatrix_BitMatrix_$Impl_$.get_length(b3),null,null,null,{ fileName : "TestBitMatrix.hx", lineNumber : 94, className : "thx.TestBitMatrix", methodName : "testConcat"});
			...
			},null,null,null,{ fileName : "TestBitMatrix.hx", lineNumber : 96, className : "thx.TestBitMatrix", methodName : "testConcat"});
		}
	}
	,testExpand: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			utest_Assert.same("000,111,101,010",thx__$BitMatrix_BitMatrix_$Impl_$.toString(b1),null,null,null,{ fileName : "TestBitMatrix.hx", lineNumber : 108, className : "thx.TestBitMatrix", methodName : "testExpand"});
			utest_Assert.same("000000,111111,110011,001100",thx__$BitMatrix_BitMatrix_$Impl_$.toString(b2),null,null,null,{ fileName : "TestBitMatrix.hx", lineNumber : 109, className : "thx.TestBitMatrix", methodName : "testExpand"});
			utest_Assert.same("000000000000,111111111111,111100001111,000011110000",thx__$BitMatrix_BitMatrix_$Impl_$.toString(b3),null,null,null,{ fileName : "TestBitMatrix.hx", lineNumber : 110, className : "thx.TestBitMatrix", methodName : "testExpand"});
		}
	}
	,testAnd: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			utest_Assert.isTrue(thx__$BitMatrix_BitMatrix_$Impl_$.equals(thx__$BitMatrix_BitMatrix_$Impl_$.fromString("10,00"),actual),null,{ fileName : "TestBitMatrix.hx", lineNumber : 119, className : "thx.TestBitMatrix", methodName : "testAnd"});
		}
	}
	,testOr: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			utest_Assert.isTrue(thx__$BitMatrix_BitMatrix_$Impl_$.equals(thx__$BitMatrix_BitMatrix_$Impl_$.fromString("11,10"),actual),null,{ fileName : "TestBitMatrix.hx", lineNumber : 128, className : "thx.TestBitMatrix", methodName : "testOr"});
		}
	}
	,testXor: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			utest_Assert.isTrue(thx__$BitMatrix_BitMatrix_$Impl_$.equals(thx__$BitMatrix_BitMatrix_$Impl_$.fromString("01,10"),actual),null,{ fileName : "TestBitMatrix.hx", lineNumber : 137, className : "thx.TestBitMatrix", methodName : "testXor"});
		}
	}
	,testNegate: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			utest_Assert.isTrue(thx__$BitMatrix_BitMatrix_$Impl_$.equals(thx__$BitMatrix_BitMatrix_$Impl_$.fromString("00,11"),actual),null,{ fileName : "TestBitMatrix.hx", lineNumber : 145, className : "thx.TestBitMatrix", methodName : "testNegate"});
		}
	}
