...
TS44.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS44.hx", lineNumber : 10, className : "TS44", methodName : "addTests"});
	runner.addCase(new thx_TestLambdaStaticExtension(Std.parseInt(w)));
};
TS44.main = function() {
	var runner = new utest_Runner();
	TS44.addTests(runner);
...
var thx_TestLambdaStaticExtension = function(i) {
	this.x = i;
};
...
thx_TestLambdaStaticExtension.prototype = {
	...
	,testFunctions: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.same([2,3],[1,2].map(function(_) {
				return _ + 1;
			}),null,null,null,{ fileName : "TestLambdaStaticExtension.hx", lineNumber : 15, className : "thx.TestLambdaStaticExtension", methodName : "testFunctions"});
			utest_Assert.same([2,3],[1,2,3].filter(function(_1) {
				return _1 > 1;
			}),null,null,null,{ fileName : "TestLambdaStaticExtension.hx", lineNumber : 16, className : "thx.TestLambdaStaticExtension", methodName : "testFunctions"});
			utest_Assert.equals(16,thx_Arrays.reduce([1,2,3],function(_0,_11) {
				return _0 + _11;
			},10),null,{ fileName : "TestLambdaStaticExtension.hx", lineNumber : 17, className : "thx.TestLambdaStaticExtension", methodName : "testFunctions"});
			utest_Assert.same(["Test 1"],[1].map(function(_2) {
				return "Test " + _2;
			}),null,null,null,{ fileName : "TestLambdaStaticExtension.hx", lineNumber : 18, className : "thx.TestLambdaStaticExtension", methodName : "testFunctions"});
		}
	}
	,testInStringInterpolation: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(["1","2"],[1,2].map(function(_) {
				return "" + _;
			}),null,null,null,{ fileName : "TestLambdaStaticExtension.hx", lineNumber : 23, className : "thx.TestLambdaStaticExtension", methodName : "testInStringInterpolation"});
			utest_Assert.same(["1","2"],[1,2].map(function(_1) {
				return "" + _1;
			}),null,null,null,{ fileName : "TestLambdaStaticExtension.hx", lineNumber : 24, className : "thx.TestLambdaStaticExtension", methodName : "testInStringInterpolation"});
			utest_Assert.same(["X1","X2"],[1,2].map(function(_2) {
				return "X" + _2;
			}),null,null,null,{ fileName : "TestLambdaStaticExtension.hx", lineNumber : 25, className : "thx.TestLambdaStaticExtension", methodName : "testInStringInterpolation"});
			utest_Assert.same(["1X","2X"],[1,2].map(function(_3) {
				return "" + _3 + "X";
			}),null,null,null,{ fileName : "TestLambdaStaticExtension.hx", lineNumber : 26, className : "thx.TestLambdaStaticExtension", methodName : "testInStringInterpolation"});
			utest_Assert.same(["X2X","X4X"],[1,2].map(function(_4) {
				return "X" + _4 * 2 + "X";
			}),null,null,null,{ fileName : "TestLambdaStaticExtension.hx", lineNumber : 27, className : "thx.TestLambdaStaticExtension", methodName : "testInStringInterpolation"});
		}
	}
	,testFillEmpty: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.same([0,1,2],((function(_e) {
			...
			})()),null,null,null,{ fileName : "TestLambdaStaticExtension.hx", lineNumber : 32, className : "thx.TestLambdaStaticExtension", methodName : "testFillEmpty"});
		}
	}
	,testOptionalArgs: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.equals(6,f(function(_0,_1) {
				return _0 * 3;
			}),null,{ fileName : "TestLambdaStaticExtension.hx", lineNumber : 41, className : "thx.TestLambdaStaticExtension", methodName : "testOptionalArgs"});
			utest_Assert.equals(6,f(function(_01,_11) {
				return _01 * _11;
			}),null,{ fileName : "TestLambdaStaticExtension.hx", lineNumber : 42, className : "thx.TestLambdaStaticExtension", methodName : "testOptionalArgs"});
		}
	}
