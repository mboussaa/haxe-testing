...
TS49.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS49.hx", lineNumber : 10, className : "TS49", methodName : "addTests"});
	runner.addCase(new thx_fp_TestMap(Std.parseInt(w)));
};
TS49.main = function() {
...
thx_fp_TestMap.prototype = {
	...
	,testRemove: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(haxe_ds_Option.Some(1),thx_fp__$Map_Map_$Impl_$.lookup(m,"Y",thx_Strings.order),null,null,null,{ fileName : "TestMap.hx", lineNumber : 22, className : "thx.fp.TestMap", methodName : "testRemove"});
			utest_Assert.same(haxe_ds_Option.Some(3),thx_fp__$Map_Map_$Impl_$.lookup(m,"Z",thx_Strings.order),null,null,null,{ fileName : "TestMap.hx", lineNumber : 23, className : "thx.fp.TestMap", methodName : "testRemove"});
			utest_Assert.equals(2,thx_fp__$Map_Map_$Impl_$.size(m),null,{ fileName : "TestMap.hx", lineNumber : 24, className : "thx.fp.TestMap", methodName : "testRemove"});
		}
	}
	,testEmpty: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			var m = thx_fp_MapImpl.Tip;
			utest_Assert.same(haxe_ds_Option.None,thx_fp__$Map_Map_$Impl_$.lookup(m,"some",thx_Strings.order),null,null,null,{ fileName : "TestMap.hx", lineNumber : 30, className : "thx.fp.TestMap", methodName : "testEmpty"});
			utest_Assert.equals(0,thx_fp__$Map_Map_$Impl_$.size(m),null,{ fileName : "TestMap.hx", lineNumber : 31, className : "thx.fp.TestMap", methodName : "testEmpty"});
		}
	}
	,testSizes: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals(3,thx_fp__$Map_Map_$Impl_$.size(thx_fp__$Map_Map_$Impl_$.insert(thx_fp__$Map_Map_$Impl_$.insert(thx_fp_MapImpl.Bin(1,"B",1,thx_fp_MapImpl.Tip,thx_fp_MapImpl.Tip),"A",1,thx_Strings.order),"C",1,thx_Strings.order)),null,{ fileName : "TestMap.hx", lineNumber : 36, className : "thx.fp.TestMap", methodName : "testSizes"});
			utest_Assert.equals(3,thx_fp__$Map_Map_$Impl_$.size(thx_fp__$Map_Map_$Impl_$.insert(thx_fp__$Map_Map_$Impl_$.insert(thx_fp_MapImpl.Bin(1,"A",1,thx_fp_MapImpl.Tip,thx_fp_MapImpl.Tip),"B",1,thx_Strings.order),"C",1,thx_Strings.order)),null,{ fileName : "TestMap.hx", lineNumber : 37, className : "thx.fp.TestMap", methodName : "testSizes"});
			utest_Assert.equals(3,thx_fp__$Map_Map_$Impl_$.size(thx_fp__$Map_Map_$Impl_$.insert(thx_fp__$Map_Map_$Impl_$.insert(thx_fp_MapImpl.Bin(1,"C",1,thx_fp_MapImpl.Tip,thx_fp_MapImpl.Tip),"B",1,thx_Strings.order),"A",1,thx_Strings.order)),null,{ fileName : "TestMap.hx", lineNumber : 38, className : "thx.fp.TestMap", methodName : "testSizes"});
			utest_Assert.equals(3,thx_fp__$Map_Map_$Impl_$.size(thx_fp__$Map_Map_$Impl_$.insert(thx_fp__$Map_Map_$Impl_$.insert(thx_fp_MapImpl.Bin(1,"B",1,thx_fp_MapImpl.Tip,thx_fp_MapImpl.Tip),"C",1,thx_Strings.order),"A",1,thx_Strings.order)),null,{ fileName : "TestMap.hx", lineNumber : 39, className : "thx.fp.TestMap", methodName : "testSizes"});
			utest_Assert.equals(3,thx_fp__$Map_Map_$Impl_$.size(thx_fp__$Map_Map_$Impl_$.insert(thx_fp__$Map_Map_$Impl_$.insert(thx_fp_MapImpl.Bin(1,"C",1,thx_fp_MapImpl.Tip,thx_fp_MapImpl.Tip),"A",1,thx_Strings.order),"B",1,thx_Strings.order)),null,{ fileName : "TestMap.hx", lineNumber : 40, className : "thx.fp.TestMap", methodName : "testSizes"});
			utest_Assert.equals(3,thx_fp__$Map_Map_$Impl_$.size(thx_fp__$Map_Map_$Impl_$.insert(thx_fp__$Map_Map_$Impl_$.insert(thx_fp_MapImpl.Bin(1,"A",1,thx_fp_MapImpl.Tip,thx_fp_MapImpl.Tip),"C",1,thx_Strings.order),"B",1,thx_Strings.order)),null,{ fileName : "TestMap.hx", lineNumber : 41, className : "thx.fp.TestMap", methodName : "testSizes"});
			utest_Assert.equals(1,thx_fp__$Map_Map_$Impl_$.size(thx_fp__$Map_Map_$Impl_$.insert(thx_fp__$Map_Map_$Impl_$.insert(thx_fp_MapImpl.Bin(1,"A",1,thx_fp_MapImpl.Tip,thx_fp_MapImpl.Tip),"A",1,thx_Strings.order),"A",1,thx_Strings.order)),null,{ fileName : "TestMap.hx", lineNumber : 43, className : "thx.fp.TestMap", methodName : "testSizes"});
		}
	}
	,testFoldLeft: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.same([1,2,3],thx_Arrays.order(thx_fp__$Map_Map_$Impl_$.foldLeft(thx_fp__$Map_Map_$Impl_$.insert(thx_fp__$Map_Map_$Impl_$.insert(thx_fp_MapImpl.Bin(1,"A",1,thx_fp_MapImpl.Tip,thx_fp_MapImpl.Tip),"B",2,thx_Strings.order),"C",3,thx_Strings.order),[],function(arr,v) {
				arr.push(v);
				return arr;
			}),thx_Ints.compare),null,null,null,{ fileName : "TestMap.hx", lineNumber : 53, className : "thx.fp.TestMap", methodName : "testFoldLeft"});
		}
	}
	,testFoldLeftKeys: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(["A","B","C"],thx_Arrays.order(thx_fp__$Map_Map_$Impl_$.foldLeftKeys(thx_fp__$Map_Map_$Impl_$.insert(thx_fp__$Map_Map_$Impl_$.insert(thx_fp_MapImpl.Bin(1,"A",1,thx_fp_MapImpl.Tip,thx_fp_MapImpl.Tip),"B",2,thx_Strings.order),"C",3,thx_Strings.order),[],function(arr,k) {
				arr.push(k);
				return arr;
			}),thx_Strings.compare),null,null,null,{ fileName : "TestMap.hx", lineNumber : 63, className : "thx.fp.TestMap", methodName : "testFoldLeftKeys"});
		}
	}
	,testSet: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(haxe_ds_Option.Some(2),thx_fp__$Map_Map_$Impl_$.lookup(m,"X",thx_Strings.order),null,null,null,{ fileName : "TestMap.hx", lineNumber : 69, className : "thx.fp.TestMap", methodName : "testSet"});
			utest_Assert.same(haxe_ds_Option.Some(1),thx_fp__$Map_Map_$Impl_$.lookup(m,"Y",thx_Strings.order),null,null,null,{ fileName : "TestMap.hx", lineNumber : 70, className : "thx.fp.TestMap", methodName : "testSet"});
			utest_Assert.same(haxe_ds_Option.Some(3),thx_fp__$Map_Map_$Impl_$.lookup(m,"Z",thx_Strings.order),null,null,null,{ fileName : "TestMap.hx", lineNumber : 71, className : "thx.fp.TestMap", methodName : "testSet"});
			utest_Assert.equals(3,thx_fp__$Map_Map_$Impl_$.size(m),null,{ fileName : "TestMap.hx", lineNumber : 72, className : "thx.fp.TestMap", methodName : "testSet"});
		}
	}
	,testObjectSet: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(haxe_ds_Option.Some(1),thx_fp__$Map_Map_$Impl_$.lookup(m,a,thx__$Ord_Ord_$Impl_$.forComparableOrd()),null,null,null,{ fileName : "TestMap.hx", lineNumber : 84, className : "thx.fp.TestMap", methodName : "testObjectSet"});
			utest_Assert.same(haxe_ds_Option.Some(2),thx_fp__$Map_Map_$Impl_$.lookup(m,b,thx__$Ord_Ord_$Impl_$.forComparableOrd()),null,null,null,{ fileName : "TestMap.hx", lineNumber : 85, className : "thx.fp.TestMap", methodName : "testObjectSet"});
			utest_Assert.same(haxe_ds_Option.Some(3),thx_fp__$Map_Map_$Impl_$.lookup(m,c,thx__$Ord_Ord_$Impl_$.forComparableOrd()),null,null,null,{ fileName : "TestMap.hx", lineNumber : 86, className : "thx.fp.TestMap", methodName : "testObjectSet"});
			utest_Assert.equals(3,thx_fp__$Map_Map_$Impl_$.size(m),null,{ fileName : "TestMap.hx", lineNumber : 87, className : "thx.fp.TestMap", methodName : "testObjectSet"});
		}
	}
	,testObjectSet2: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(haxe_ds_Option.Some(1),thx_fp__$Map_Map_$Impl_$.lookup(m,a,thx__$Ord_Ord_$Impl_$.forComparable()),null,null,null,{ fileName : "TestMap.hx", lineNumber : 99, className : "thx.fp.TestMap", methodName : "testObjectSet2"});
			utest_Assert.same(haxe_ds_Option.Some(2),thx_fp__$Map_Map_$Impl_$.lookup(m,b,thx__$Ord_Ord_$Impl_$.forComparable()),null,null,null,{ fileName : "TestMap.hx", lineNumber : 100, className : "thx.fp.TestMap", methodName : "testObjectSet2"});
			utest_Assert.same(haxe_ds_Option.Some(3),thx_fp__$Map_Map_$Impl_$.lookup(m,c,thx__$Ord_Ord_$Impl_$.forComparable()),null,null,null,{ fileName : "TestMap.hx", lineNumber : 101, className : "thx.fp.TestMap", methodName : "testObjectSet2"});
			utest_Assert.equals(3,thx_fp__$Map_Map_$Impl_$.size(m),null,{ fileName : "TestMap.hx", lineNumber : 102, className : "thx.fp.TestMap", methodName : "testObjectSet2"});
		}
	}
	,testFromNative: function() {
		...
		while(_g1 < _g) {
			...
			var map = thx_fp_StringMap.fromNative(_g2);
			utest_Assert.equals(2,thx_fp__$Map_Map_$Impl_$.size(map),null,{ fileName : "TestMap.hx", lineNumber : 109, className : "thx.fp.TestMap", methodName : "testFromNative"});
			utest_Assert.isTrue(thx_Options.toBool(thx_fp__$Map_Map_$Impl_$.lookup(map,"a",thx_Strings.order)),null,{ fileName : "TestMap.hx", lineNumber : 110, className : "thx.fp.TestMap", methodName : "testFromNative"});
			utest_Assert.isTrue(thx_Options.toBool(thx_fp__$Map_Map_$Impl_$.lookup(map,"b",thx_Strings.order)),null,{ fileName : "TestMap.hx", lineNumber : 111, className : "thx.fp.TestMap", methodName : "testFromNative"});
		}
	}
