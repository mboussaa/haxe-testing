...
TS23.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS23.hx", lineNumber : 10, className : "TS23", methodName : "addTests"});
	runner.addCase(new thx_TestInt64s(Std.parseInt(w)));
};
TS23.main = function() {
...
thx_TestInt64s.prototype = {
	...
	,testRounding: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var tests = [{ roundUp : 3, roundDown : 2, round : 3, num : 5, div : 2, pos : { fileName : "TestInt64s.hx", lineNumber : 21, className : "thx.TestInt64s", methodName : "testRounding"}},{ roundUp : 0, roundDown : 0, round : 0, num : 0, div : 2, pos : { fileName : "TestInt64s.hx", lineNumber : 22, className : "thx.TestInt64s", methodName : "testRounding"}},{ roundUp : 1, roundDown : 0, round : 0, num : 1, div : 4, pos : { fileName : "TestInt64s.hx", lineNumber : 23, className : "thx.TestInt64s", methodName : "testRounding"}},{ roundUp : -2, roundDown : -3, round : -2, num : -5, div : 2, pos : { fileName : "TestInt64s.hx", lineNumber : 25, className : "thx.TestInt64s", methodName : "testRounding"}},{ roundUp : 0, roundDown : -1, round : 0, num : -1, div : 4, pos : { fileName : "TestInt64s.hx", lineNumber : 26, className : "thx.TestInt64s", methodName : "testRounding"}},{ roundUp : 0, roundDown : 0, round : 0, num : 0, div : -2, pos : { fileName : "TestInt64s.hx", lineNumber : 28, className : "thx.TestInt64s", methodName : "testRounding"}},{ roundUp : -2, roundDown : -3, round : -2, num : 5, div : -2, pos : { fileName : "TestInt64s.hx", lineNumber : 29, className : "thx.TestInt64s", methodName : "testRounding"}},{ roundUp : 0, roundDown : -1, round : 0, num : 1, div : -4, pos : { fileName : "TestInt64s.hx", lineNumber : 30, className : "thx.TestInt64s", methodName : "testRounding"}}];
			var up;
			var down;
			var round;
			var num;
