...
TS47.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS47.hx", lineNumber : 10, className : "TS47", methodName : "addTests"});
	runner.addCase(new thx_TestValidation(Std.parseInt(w)));
};
TS47.main = function() {
	var runner = new utest_Runner();
	TS47.addTests(runner);
...
var thx_TestValidation = function(i) {
	this.x = i;
};
...
thx_TestValidation.prototype = {
	...
	,testAp: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(l1,thx__$Validation_Validation_$Impl_$.ap(l1,rbi,$bind(this,this.add)),null,null,null,{ fileName : "TestValidation.hx", lineNumber : 33, className : "thx.TestValidation", methodName : "testAp"});
			utest_Assert.same(thx_Either.Right(1),thx__$Validation_Validation_$Impl_$.ap(rt,rbi,$bind(this,this.add)),null,null,null,{ fileName : "TestValidation.hx", lineNumber : 34, className : "thx.TestValidation", methodName : "testAp"});
		}
	}
	,testVal4: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(t,thx__$Validation_Validation_$Impl_$.ap(f,thx__$Validation_Validation_$Impl_$.ap(f,thx__$Validation_Validation_$Impl_$.ap(f,thx__$Validation_Validation_$Impl_$.ap(t,thx_Either.Right(thx_Functions2.curry((function(f3) {
				return function(a1,b1) {
					return (function(f4) {
						return function(c1) {
							return f4[0](a1,b1,c1);
						};
					})(f3);
				};
			})([tmp]))),(function() {
			...
			})()),s),s),s),null,null,null,{ fileName : "TestValidation.hx", lineNumber : 45, className : "thx.TestValidation", methodName : "testVal4"});
			var tmp1 = thx_Either.Left(2);
			var s1 = $bind(this,this.add);
			var tmp2 = (function(f5) {
				return function(a2,b2,c2) {
					return (function(f6) {
						return function(d1) {
							return f6[0](a2,b2,c2,d1);
						};
					})(f5);
				};
			})([$bind(this,this.or4)]);
			utest_Assert.same(tmp1,thx__$Validation_Validation_$Impl_$.ap(err,thx__$Validation_Validation_$Impl_$.ap(err,thx__$Validation_Validation_$Impl_$.ap(f,thx__$Validation_Validation_$Impl_$.ap(t,thx_Either.Right(thx_Functions2.curry((function(f7) {
				return function(a3,b3) {
					return (function(f8) {
						return function(c3) {
							return f8[0](a3,b3,c3);
						};
					})(f7);
				};
			})([tmp2]))),(function() {
				return function(e11,e21) {
					throw new js__$Boot_HaxeError("Unreachable");
				};
			})()),s1),s1),s1),null,null,null,{ fileName : "TestValidation.hx", lineNumber : 46, className : "thx.TestValidation", methodName : "testVal4"});
		}
	}
	,testVal4Nel: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(tmp,thx__$Validation_Validation_$Impl_$.ap(err,thx__$Validation_Validation_$Impl_$.ap(err,thx__$Validation_Validation_$Impl_$.ap(t,thx__$Validation_Validation_$Impl_$.ap(t,thx_Either.Right(thx_Functions2.curry((function(f2) {
				return function(a1,b1) {
					return (function(f3) {
						return function(c1) {
							return f3[0](a1,b1,c1);
						};
					})(f2);
				};
			})([tmp1]))),(function() {
			...
			})()),s),s),s),null,null,null,{ fileName : "TestValidation.hx", lineNumber : 54, className : "thx.TestValidation", methodName : "testVal4Nel"});
		}
	}
