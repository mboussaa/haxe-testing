...
TS40.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS40.hx", lineNumber : 10, className : "TS40", methodName : "addTests"});
	runner.addCase(new thx_TestStrings(Std.parseInt(w)));
};
TS40.main = function() {
	var runner = new utest_Runner();
	TS40.addTests(runner);
...
var thx_TestStrings = function(i) {
	this.x = i;
};
...
thx_TestStrings.prototype = {
	...
	,testLowerUpperCaseFirst: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("aBC",thx_Strings.lowerCaseFirst("ABC"),null,{ fileName : "TestStrings.hx", lineNumber : 20, className : "thx.TestStrings", methodName : "testLowerUpperCaseFirst"});
			utest_Assert.equals("Abc",thx_Strings.upperCaseFirst("abc"),null,{ fileName : "TestStrings.hx", lineNumber : 21, className : "thx.TestStrings", methodName : "testLowerUpperCaseFirst"});
		}
	}
	,testContains: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.isTrue("test".indexOf("") >= 0,null,{ fileName : "TestStrings.hx", lineNumber : 26, className : "thx.TestStrings", methodName : "testContains"});
			utest_Assert.isTrue("test".indexOf("t") >= 0,null,{ fileName : "TestStrings.hx", lineNumber : 27, className : "thx.TestStrings", methodName : "testContains"});
			utest_Assert.isTrue("test".indexOf("te") >= 0,null,{ fileName : "TestStrings.hx", lineNumber : 28, className : "thx.TestStrings", methodName : "testContains"});
			utest_Assert.isTrue("test".indexOf("tes") >= 0,null,{ fileName : "TestStrings.hx", lineNumber : 29, className : "thx.TestStrings", methodName : "testContains"});
			utest_Assert.isTrue("test".indexOf("test") >= 0,null,{ fileName : "TestStrings.hx", lineNumber : 30, className : "thx.TestStrings", methodName : "testContains"});
			utest_Assert.isTrue("one two three".indexOf("one") >= 0,null,{ fileName : "TestStrings.hx", lineNumber : 31, className : "thx.TestStrings", methodName : "testContains"});
			utest_Assert.isTrue("one two three".indexOf("two") >= 0,null,{ fileName : "TestStrings.hx", lineNumber : 32, className : "thx.TestStrings", methodName : "testContains"});
			utest_Assert.isTrue("one two three".indexOf("three") >= 0,null,{ fileName : "TestStrings.hx", lineNumber : 33, className : "thx.TestStrings", methodName : "testContains"});
			utest_Assert.isFalse("test".indexOf("test ") >= 0,null,{ fileName : "TestStrings.hx", lineNumber : 34, className : "thx.TestStrings", methodName : "testContains"});
			utest_Assert.isFalse("test".indexOf(" test") >= 0,null,{ fileName : "TestStrings.hx", lineNumber : 35, className : "thx.TestStrings", methodName : "testContains"});
			utest_Assert.isFalse("test".indexOf("tes ") >= 0,null,{ fileName : "TestStrings.hx", lineNumber : 36, className : "thx.TestStrings", methodName : "testContains"});
		}
	}
	,testCount: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals(3,thx_Strings.count("one two three four five six seven eight nine ten","o"),null,{ fileName : "TestStrings.hx", lineNumber : 41, className : "thx.TestStrings", methodName : "testCount"});
			utest_Assert.equals(2,thx_Strings.count("one two three four five six seven eight nine ten","en"),null,{ fileName : "TestStrings.hx", lineNumber : 42, className : "thx.TestStrings", methodName : "testCount"});
			utest_Assert.equals(3,thx_Strings.count("one two three four five six seven eight nine ten"," t"),null,{ fileName : "TestStrings.hx", lineNumber : 43, className : "thx.TestStrings", methodName : "testCount"});
			utest_Assert.equals(2,thx_Strings.count("one two three four five six seven eight nine ten","ve"),null,{ fileName : "TestStrings.hx", lineNumber : 44, className : "thx.TestStrings", methodName : "testCount"});
			utest_Assert.equals(0,thx_Strings.count("xxxxxx","y"),null,{ fileName : "TestStrings.hx", lineNumber : 45, className : "thx.TestStrings", methodName : "testCount"});
			utest_Assert.equals(6,thx_Strings.count("xxxxxx","x"),null,{ fileName : "TestStrings.hx", lineNumber : 46, className : "thx.TestStrings", methodName : "testCount"});
			utest_Assert.equals(3,thx_Strings.count("xxxxxx","xx"),null,{ fileName : "TestStrings.hx", lineNumber : 47, className : "thx.TestStrings", methodName : "testCount"});
			utest_Assert.equals(2,thx_Strings.count("xxxxxx","xxx"),null,{ fileName : "TestStrings.hx", lineNumber : 48, className : "thx.TestStrings", methodName : "testCount"});
			utest_Assert.equals(1,thx_Strings.count("xxxxxx","xxxx"),null,{ fileName : "TestStrings.hx", lineNumber : 49, className : "thx.TestStrings", methodName : "testCount"});
			utest_Assert.equals(0,thx_Strings.count("x","xx"),null,{ fileName : "TestStrings.hx", lineNumber : 50, className : "thx.TestStrings", methodName : "testCount"});
		}
	}
	,testContainsAny: function() {
		...
		while(_g1 < _g) {
			...
			}),null,{ fileName : "TestStrings.hx", lineNumber : 60, className : "thx.TestStrings", methodName : "testContainsAny"});
			utest_Assert.isTrue(thx_Arrays.any(["x","y","t"],function(a16) {
				return thx_Strings.contains("test",a16);
			}),null,{ fileName : "TestStrings.hx", lineNumber : 61, className : "thx.TestStrings", methodName : "testContainsAny"});
			utest_Assert.isTrue(thx_Arrays.any(["x","y","e"],function(a17) {
				return thx_Strings.contains("test",a17);
			}),null,{ fileName : "TestStrings.hx", lineNumber : 62, className : "thx.TestStrings", methodName : "testContainsAny"});
			utest_Assert.isTrue(thx_Arrays.any(["x","y","s"],function(a18) {
				return thx_Strings.contains("test",a18);
			}),null,{ fileName : "TestStrings.hx", lineNumber : 63, className : "thx.TestStrings", methodName : "testContainsAny"});
			utest_Assert.isTrue(thx_Arrays.any(["zero","one","two"],function(a19) {
				return thx_Strings.contains("one two three",a19);
			}),null,{ fileName : "TestStrings.hx", lineNumber : 64, className : "thx.TestStrings", methodName : "testContainsAny"});
			utest_Assert.isTrue(thx_Arrays.any(["one","two","three"],function(a110) {
				return thx_Strings.contains("one two three",a110);
			}),null,{ fileName : "TestStrings.hx", lineNumber : 65, className : "thx.TestStrings", methodName : "testContainsAny"});
			utest_Assert.isTrue(thx_Arrays.any(["one two","x","three"],function(a111) {
				return thx_Strings.contains("one two three",a111);
			}),null,{ fileName : "TestStrings.hx", lineNumber : 66, className : "thx.TestStrings", methodName : "testContainsAny"});
		}
	}
	,testHashCode: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals(97,thx_Strings.hashCode("a"),null,{ fileName : "TestStrings.hx", lineNumber : 71, className : "thx.TestStrings", methodName : "testHashCode"});
			utest_Assert.equals(96354,thx_Strings.hashCode("abc"),null,{ fileName : "TestStrings.hx", lineNumber : 72, className : "thx.TestStrings", methodName : "testHashCode"});
			utest_Assert.equals(898829415,thx_Strings.hashCode("abcdefghijklm"),null,{ fileName : "TestStrings.hx", lineNumber : 73, className : "thx.TestStrings", methodName : "testHashCode"});
			utest_Assert.equals(410520826,thx_Strings.hashCode("abcdefghijklmabcdefghijklmabcdefghijklmabcdefghijklmabcdefghijklm!!!"),null,{ fileName : "TestStrings.hx", lineNumber : 74, className : "thx.TestStrings", methodName : "testHashCode"});
		}
	}
	,testUcwordsws: function() {
		...
		while(_g1 < _g) {
			...
			while(_g2 < tests.length) {
				var item = tests[_g2];
				++_g2;
				utest_Assert.equals(item.expected,thx_Strings.capitalizeWords(item.test,true),null,{ fileName : "TestStrings.hx", lineNumber : 87, className : "thx.TestStrings", methodName : "testUcwordsws"});
			}
		}
	}
	,testDifferAt: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals(3,thx_Strings.diffAt("abcdef","abc123"),null,{ fileName : "TestStrings.hx", lineNumber : 92, className : "thx.TestStrings", methodName : "testDifferAt"});
			utest_Assert.equals(0,thx_Strings.diffAt("","abc123"),null,{ fileName : "TestStrings.hx", lineNumber : 93, className : "thx.TestStrings", methodName : "testDifferAt"});
			utest_Assert.equals(1,thx_Strings.diffAt("a","abc123"),null,{ fileName : "TestStrings.hx", lineNumber : 94, className : "thx.TestStrings", methodName : "testDifferAt"});
			utest_Assert.equals(0,thx_Strings.diffAt("abc123",""),null,{ fileName : "TestStrings.hx", lineNumber : 95, className : "thx.TestStrings", methodName : "testDifferAt"});
			utest_Assert.equals(1,thx_Strings.diffAt("abc123","a"),null,{ fileName : "TestStrings.hx", lineNumber : 96, className : "thx.TestStrings", methodName : "testDifferAt"});
		}
	}
	,testEllipsis: function() {
		...
		while(_g1 < _g) {
			...
			while(_g2 < tests.length) {
				var item = tests[_g2];
				++_g2;
				utest_Assert.equals(item.expected,thx_Strings.ellipsis("abcdefghijkl",item.len,item.symbol),null,{ fileName : "TestStrings.hx", lineNumber : 111, className : "thx.TestStrings", methodName : "testEllipsis"});
			}
		}
	}
	,testEllipsisMiddle: function() {
		...
		while(_g1 < _g) {
			...
			while(_g2 < tests.length) {
				var item = tests[_g2];
				++_g2;
				utest_Assert.equals(item.expected,thx_Strings.ellipsisMiddle("abcdefghijkl",item.len,item.symbol),null,{ fileName : "TestStrings.hx", lineNumber : 126, className : "thx.TestStrings", methodName : "testEllipsisMiddle"});
			}
		}
	}
	,testUcwords: function() {
		...
		while(_g1 < _g) {
			...
			while(_g2 < tests.length) {
				var item = tests[_g2];
				++_g2;
				utest_Assert.equals(item.expected,thx_Strings.capitalizeWords(item.test),null,{ fileName : "TestStrings.hx", lineNumber : 139, className : "thx.TestStrings", methodName : "testUcwords"});
			}
		}
	}
	,testAlphaNum: function() {
		...
		while(_g1 < _g) {
			...
			while(_g2 < tests.length) {
				var item = tests[_g2];
				++_g2;
				utest_Assert.equals(item.expected,thx_Strings.ALPHANUM.match(item.test),null,{ fileName : "TestStrings.hx", lineNumber : 152, className : "thx.TestStrings", methodName : "testAlphaNum"});
			}
		}
	}
	,testHumanize: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("hello world",thx_Strings.humanize("helloWorld"),null,{ fileName : "TestStrings.hx", lineNumber : 157, className : "thx.TestStrings", methodName : "testHumanize"});
			utest_Assert.equals("my long string",thx_Strings.humanize("my_long_string"),null,{ fileName : "TestStrings.hx", lineNumber : 158, className : "thx.TestStrings", methodName : "testHumanize"});
			utest_Assert.equals("ignore many",thx_Strings.humanize("ignoreMANY"),null,{ fileName : "TestStrings.hx", lineNumber : 159, className : "thx.TestStrings", methodName : "testHumanize"});
		}
	}
	,testWrapColumn: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("Lorem ipsum dolor\nsit amet,\nconsectetur\nadipisicing elit,\nsed do eiusmod\ntempor incididunt ut\nlabore et dolore\nmagna aliqua. Ut\nenim ad minim\nveniam, quis nostrud\nexercitation ullamco\nlaboris nisi ut\naliquip ex ea\ncommodo consequat.",thx_Strings.wrapColumns("Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",20),null,{ fileName : "TestStrings.hx", lineNumber : 166, className : "thx.TestStrings", methodName : "testWrapColumn"});
			utest_Assert.equals("    Lorem ipsum\n    dolor sit amet,\n    consectetur\n    adipisicing\n    elit, sed do\n    eiusmod tempor\n    incididunt ut\n    labore et dolore\n    magna aliqua. Ut\n    enim ad minim\n    veniam, quis\n    nostrud\n    exercitation\n    ullamco laboris\n    nisi ut aliquip\n    ex ea commodo\n    consequat.",thx_Strings.wrapColumns("Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",20,"    "),null,{ fileName : "TestStrings.hx", lineNumber : 183, className : "thx.TestStrings", methodName : "testWrapColumn"});
		}
	}
	,testWrapColumnPreserveNewLines: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("Lorem ipsum dolor\nsit amet,\n\nconsectetur\nadipisicing elit",thx_Strings.wrapColumns("Lorem ipsum dolor sit amet,\n\nconsectetur adipisicing elit",18),null,{ fileName : "TestStrings.hx", lineNumber : 208, className : "thx.TestStrings", methodName : "testWrapColumnPreserveNewLines"});
		}
	}
	,testWrapColumnLong: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("aaaaaaaaaa\naaaa\naaa aa",thx_Strings.wrapColumns("aaaaaaaaaa aaaa aaa aa",6),null,{ fileName : "TestStrings.hx", lineNumber : 216, className : "thx.TestStrings", methodName : "testWrapColumnLong"});
		}
	}
	,testRepeat: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("XyXyXy",thx_Strings.repeat("Xy",3),null,{ fileName : "TestStrings.hx", lineNumber : 224, className : "thx.TestStrings", methodName : "testRepeat"});
		}
	}
	,testUpTo: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("abcdef",thx_Strings.upTo("abcdef","x"),null,{ fileName : "TestStrings.hx", lineNumber : 229, className : "thx.TestStrings", methodName : "testUpTo"});
			utest_Assert.equals("ab",thx_Strings.upTo("abcdef","cd"),null,{ fileName : "TestStrings.hx", lineNumber : 230, className : "thx.TestStrings", methodName : "testUpTo"});
		}
	}
	,testFrom: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("",thx_Strings.from("abcdef","x"),null,{ fileName : "TestStrings.hx", lineNumber : 235, className : "thx.TestStrings", methodName : "testFrom"});
			utest_Assert.equals("cdef",thx_Strings.from("abcdef","cd"),null,{ fileName : "TestStrings.hx", lineNumber : 236, className : "thx.TestStrings", methodName : "testFrom"});
		}
	}
	,testAfter: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("",thx_Strings.after("abcdef","x"),null,{ fileName : "TestStrings.hx", lineNumber : 241, className : "thx.TestStrings", methodName : "testAfter"});
			utest_Assert.equals("ef",thx_Strings.after("abcdef","cd"),null,{ fileName : "TestStrings.hx", lineNumber : 242, className : "thx.TestStrings", methodName : "testAfter"});
		}
	}
	,testStripTags: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("a code; x",thx_Strings.stripTags("a<br/> <script src=\"aaa\">code;</script> x"),null,{ fileName : "TestStrings.hx", lineNumber : 247, className : "thx.TestStrings", methodName : "testStripTags"});
		}
	}
	,testLtrim: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("abcde",thx_Strings.trimCharsLeft("abcde","x"),null,{ fileName : "TestStrings.hx", lineNumber : 252, className : "thx.TestStrings", methodName : "testLtrim"});
			utest_Assert.equals("de",thx_Strings.trimCharsLeft("abcde","cba"),null,{ fileName : "TestStrings.hx", lineNumber : 253, className : "thx.TestStrings", methodName : "testLtrim"});
			utest_Assert.equals("abcde",thx_Strings.trimCharsLeft("abcde","b"),null,{ fileName : "TestStrings.hx", lineNumber : 254, className : "thx.TestStrings", methodName : "testLtrim"});
			utest_Assert.equals("",thx_Strings.trimCharsLeft("/","/"),null,{ fileName : "TestStrings.hx", lineNumber : 256, className : "thx.TestStrings", methodName : "testLtrim"});
		}
	}
	,testRtrim: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("abcde",thx_Strings.trimCharsRight("abcde","x"),null,{ fileName : "TestStrings.hx", lineNumber : 261, className : "thx.TestStrings", methodName : "testRtrim"});
			utest_Assert.equals("ab",thx_Strings.trimCharsRight("abcde","ced"),null,{ fileName : "TestStrings.hx", lineNumber : 262, className : "thx.TestStrings", methodName : "testRtrim"});
			utest_Assert.equals("abcde",thx_Strings.trimCharsRight("abcde","d"),null,{ fileName : "TestStrings.hx", lineNumber : 263, className : "thx.TestStrings", methodName : "testRtrim"});
			utest_Assert.equals("",thx_Strings.trimCharsRight("/","/"),null,{ fileName : "TestStrings.hx", lineNumber : 265, className : "thx.TestStrings", methodName : "testRtrim"});
		}
	}
	,testTrim: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("abcde",thx_Strings.trimCharsRight(thx_Strings.trimCharsLeft("abcde","x"),"x"),null,{ fileName : "TestStrings.hx", lineNumber : 270, className : "thx.TestStrings", methodName : "testTrim"});
			utest_Assert.equals("cd",thx_Strings.trimCharsRight(thx_Strings.trimCharsLeft("abcde","abe"),"abe"),null,{ fileName : "TestStrings.hx", lineNumber : 271, className : "thx.TestStrings", methodName : "testTrim"});
			utest_Assert.equals("abcde",thx_Strings.trimCharsRight(thx_Strings.trimCharsLeft("abcde","bd"),"bd"),null,{ fileName : "TestStrings.hx", lineNumber : 272, className : "thx.TestStrings", methodName : "testTrim"});
			utest_Assert.equals("",thx_Strings.trimCharsRight(thx_Strings.trimCharsLeft("/","/"),"/"),null,{ fileName : "TestStrings.hx", lineNumber : 274, className : "thx.TestStrings", methodName : "testTrim"});
		}
	}
	,testToArray: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.same(["a","☺","b","☺","☺","c","☺","☺","☺"],"a☺b☺☺c☺☺☺".split(""),null,null,null,{ fileName : "TestStrings.hx", lineNumber : 281, className : "thx.TestStrings", methodName : "testToArray"});
		}
	}
	,testToLines: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.same(["Split","to","lines"],thx_Strings.SPLIT_LINES.split("Split\nto\nlines"),null,null,null,{ fileName : "TestStrings.hx", lineNumber : 289, className : "thx.TestStrings", methodName : "testToLines"});
		}
	}
	,testReverse: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.same("☺☺☺c☺☺b☺a",thx_Strings.reverse("a☺b☺☺c☺☺☺"),null,null,null,{ fileName : "TestStrings.hx", lineNumber : 296, className : "thx.TestStrings", methodName : "testReverse"});
		}
	}
	,testOrder: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals(thx_OrderingImpl.EQ,thx__$Ord_Ord_$Impl_$.order(thx_Strings.order,"companyId","companyId"),null,{ fileName : "TestStrings.hx", lineNumber : 301, className : "thx.TestStrings", methodName : "testOrder"});
			utest_Assert.equals(thx_OrderingImpl.LT,thx__$Ord_Ord_$Impl_$.order(thx_Strings.order,"companyIc","companyId"),null,{ fileName : "TestStrings.hx", lineNumber : 302, className : "thx.TestStrings", methodName : "testOrder"});
			utest_Assert.equals(thx_OrderingImpl.GT,thx__$Ord_Ord_$Impl_$.order(thx_Strings.order,"companyId","companyIc"),null,{ fileName : "TestStrings.hx", lineNumber : 303, className : "thx.TestStrings", methodName : "testOrder"});
		}
	}
