...
TS38.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS38.hx", lineNumber : 10, className : "TS38", methodName : "addTests"});
	runner.addCase(new thx_TestSet(Std.parseInt(w)));
};
TS38.main = function() {
	var runner = new utest_Runner();
	TS38.addTests(runner);
...
thx_TestSet.prototype = {
	...
	,testCreate: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.equals(0,thx__$Set_Set_$Impl_$.get_length(set),null,{ fileName : "TestSet.hx", lineNumber : 15, className : "thx.TestSet", methodName : "testCreate"});
			thx__$Set_Set_$Impl_$.add(set,1);
			thx__$Set_Set_$Impl_$.add(set,1);
			utest_Assert.equals(1,thx__$Set_Set_$Impl_$.get_length(set),null,{ fileName : "TestSet.hx", lineNumber : 18, className : "thx.TestSet", methodName : "testCreate"});
		}
	}
	,testSet: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.same([1,2,3],thx_Arrays.order(thx__$Set_Set_$Impl_$.toArray(thx__$Set_Set_$Impl_$.createInt([1,2,2,2,3])),thx_Ints.compare),null,null,null,{ fileName : "TestSet.hx", lineNumber : 24, className : "thx.TestSet", methodName : "testSet"});
		}
	}
	,testUnion: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			utest_Assert.same([1,2,3,4],thx_Arrays.order(thx__$Set_Set_$Impl_$.toArray(newset),thx_Ints.compare),null,null,null,{ fileName : "TestSet.hx", lineNumber : 31, className : "thx.TestSet", methodName : "testUnion"});
		}
	}
	,testDifference: function() {
		...
		while(_g1 < _g) {
			...
			while(tmp.hasNext()) result.remove(tmp.next());
			utest_Assert.same([1,3],thx_Arrays.order(thx__$Set_Set_$Impl_$.toArray(result),thx_Ints.compare),null,null,null,{ fileName : "TestSet.hx", lineNumber : 38, className : "thx.TestSet", methodName : "testDifference"});
		}
	}
	,testBooleans: function() {
		...
		while(_g1 < _g) {
			...
			while(tmp.hasNext()) result.remove(tmp.next());
			utest_Assert.same([1,4],thx_Arrays.order(thx__$Set_Set_$Impl_$.toArray(result),thx_Ints.compare),null,null,null,{ fileName : "TestSet.hx", lineNumber : 46, className : "thx.TestSet", methodName : "testBooleans"});
		}
	}
