...
TS12.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS12.hx", lineNumber : 10, className : "TS12", methodName : "addTests"});
	runner.addCase(new thx_TestDateTimeUtc(Std.parseInt(w)));
};
TS12.main = function() {
...
var thx_TestDateTimeUtc = function(i) {
...
thx_TestDateTimeUtc.prototype = {
	...
	,testCreate: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals(2015,thx__$DateTimeUtc_DateTimeUtc_$Impl_$.getDatePart(this.date,thx__$DateTimeUtc_DateTimeUtc_$Impl_$.DATE_PART_YEAR),"expected 2015 but got " + thx__$DateTimeUtc_DateTimeUtc_$Impl_$.getDatePart(this.date,thx__$DateTimeUtc_DateTimeUtc_$Impl_$.DATE_PART_YEAR) + " for year",{ fileName : "TestDateTimeUtc.hx", lineNumber : 20, className : "thx.TestDateTimeUtc", methodName : "testCreate"});
			utest_Assert.equals(7,thx__$DateTimeUtc_DateTimeUtc_$Impl_$.getDatePart(this.date,thx__$DateTimeUtc_DateTimeUtc_$Impl_$.DATE_PART_MONTH),"expected 7 but got " + thx__$DateTimeUtc_DateTimeUtc_$Impl_$.getDatePart(this.date,thx__$DateTimeUtc_DateTimeUtc_$Impl_$.DATE_PART_MONTH) + " for month",{ fileName : "TestDateTimeUtc.hx", lineNumber : 21, className : "thx.TestDateTimeUtc", methodName : "testCreate"});
			utest_Assert.equals(26,thx__$DateTimeUtc_DateTimeUtc_$Impl_$.getDatePart(this.date,thx__$DateTimeUtc_DateTimeUtc_$Impl_$.DATE_PART_DAY),"expected 26 but got " + thx__$DateTimeUtc_DateTimeUtc_$Impl_$.getDatePart(this.date,thx__$DateTimeUtc_DateTimeUtc_$Impl_$.DATE_PART_DAY) + " for day",{ fileName : "TestDateTimeUtc.hx", lineNumber : 22, className : "thx.TestDateTimeUtc", methodName : "testCreate"});
			utest_Assert.equals(21,thx__$DateTimeUtc_DateTimeUtc_$Impl_$.get_hour(this.date),"expected 21 but got " + thx__$DateTimeUtc_DateTimeUtc_$Impl_$.get_hour(this.date) + " for hour",{ fileName : "TestDateTimeUtc.hx", lineNumber : 24, className : "thx.TestDateTimeUtc", methodName : "testCreate"});
			utest_Assert.equals(40,thx__$DateTimeUtc_DateTimeUtc_$Impl_$.get_minute(this.date),"expected 40 but got " + thx__$DateTimeUtc_DateTimeUtc_$Impl_$.get_minute(this.date) + " for minute",{ fileName : "TestDateTimeUtc.hx", lineNumber : 25, className : "thx.TestDateTimeUtc", methodName : "testCreate"});
			utest_Assert.equals(30,thx__$DateTimeUtc_DateTimeUtc_$Impl_$.get_second(this.date),"expected 30 but got " + thx__$DateTimeUtc_DateTimeUtc_$Impl_$.get_second(this.date) + " for second",{ fileName : "TestDateTimeUtc.hx", lineNumber : 26, className : "thx.TestDateTimeUtc", methodName : "testCreate"});
			utest_Assert.equals(123,thx__$DateTimeUtc_DateTimeUtc_$Impl_$.get_millisecond(this.tomorrow),"expected 123 but got " + thx__$DateTimeUtc_DateTimeUtc_$Impl_$.get_millisecond(this.tomorrow) + " for millisecond",{ fileName : "TestDateTimeUtc.hx", lineNumber : 28, className : "thx.TestDateTimeUtc", methodName : "testCreate"});
			utest_Assert.equals(123000,thx__$DateTimeUtc_DateTimeUtc_$Impl_$.get_microsecond(this.tomorrow),"expected 123 but got " + thx__$DateTimeUtc_DateTimeUtc_$Impl_$.get_microsecond(this.tomorrow) + " for microsecond",{ fileName : "TestDateTimeUtc.hx", lineNumber : 29, className : "thx.TestDateTimeUtc", methodName : "testCreate"});
			utest_Assert.equals(1230000,thx__$DateTimeUtc_DateTimeUtc_$Impl_$.get_tickInSecond(this.tomorrow),"expected 123 but got " + thx__$DateTimeUtc_DateTimeUtc_$Impl_$.get_tickInSecond(this.tomorrow) + " for tickInSecond",{ fileName : "TestDateTimeUtc.hx", lineNumber : 30, className : "thx.TestDateTimeUtc", methodName : "testCreate"});
			utest_Assert.equals(0,thx__$DateTimeUtc_DateTimeUtc_$Impl_$.get_dayOfWeek(this.date),null,{ fileName : "TestDateTimeUtc.hx", lineNumber : 32, className : "thx.TestDateTimeUtc", methodName : "testCreate"});
		}
	}
	,testToString: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("2015-07-26T21:40:30Z",thx__$DateTimeUtc_DateTimeUtc_$Impl_$.toString(this.date),null,{ fileName : "TestDateTimeUtc.hx", lineNumber : 37, className : "thx.TestDateTimeUtc", methodName : "testToString"});
			utest_Assert.equals("1-01-01T00:00:00Z",thx__$DateTimeUtc_DateTimeUtc_$Impl_$.toString(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromInt64(new haxe__$Int64__$_$_$Int64(0,0))),null,{ fileName : "TestDateTimeUtc.hx", lineNumber : 38, className : "thx.TestDateTimeUtc", methodName : "testToString"});
		}
	}
	,testOverflowing: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("2014-12-01T00:00:00Z",thx__$DateTimeUtc_DateTimeUtc_$Impl_$.toString(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.create(2014,12,1)),null,{ fileName : "TestDateTimeUtc.hx", lineNumber : 43, className : "thx.TestDateTimeUtc", methodName : "testOverflowing"});
			utest_Assert.equals("2015-04-01T00:00:00Z",thx__$DateTimeUtc_DateTimeUtc_$Impl_$.toString(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.create(2014,16,1)),null,{ fileName : "TestDateTimeUtc.hx", lineNumber : 45, className : "thx.TestDateTimeUtc", methodName : "testOverflowing"});
			utest_Assert.equals("2013-10-01T00:00:00Z",thx__$DateTimeUtc_DateTimeUtc_$Impl_$.toString(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.create(2014,-2,1)),null,{ fileName : "TestDateTimeUtc.hx", lineNumber : 46, className : "thx.TestDateTimeUtc", methodName : "testOverflowing"});
			utest_Assert.equals("2014-03-04T00:00:00Z",thx__$DateTimeUtc_DateTimeUtc_$Impl_$.toString(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.create(2014,2,32)),null,{ fileName : "TestDateTimeUtc.hx", lineNumber : 49, className : "thx.TestDateTimeUtc", methodName : "testOverflowing"});
			utest_Assert.equals("2013-12-31T00:00:00Z",thx__$DateTimeUtc_DateTimeUtc_$Impl_$.toString(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.create(2014,1,0)),null,{ fileName : "TestDateTimeUtc.hx", lineNumber : 50, className : "thx.TestDateTimeUtc", methodName : "testOverflowing"});
			utest_Assert.equals("2014-02-02T02:00:00Z",thx__$DateTimeUtc_DateTimeUtc_$Impl_$.toString(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.create(2014,2,1,26)),null,{ fileName : "TestDateTimeUtc.hx", lineNumber : 53, className : "thx.TestDateTimeUtc", methodName : "testOverflowing"});
			utest_Assert.equals("2013-12-31T23:00:00Z",thx__$DateTimeUtc_DateTimeUtc_$Impl_$.toString(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.create(2014,1,1,-1)),null,{ fileName : "TestDateTimeUtc.hx", lineNumber : 54, className : "thx.TestDateTimeUtc", methodName : "testOverflowing"});
			utest_Assert.equals("2014-02-01T01:05:00Z",thx__$DateTimeUtc_DateTimeUtc_$Impl_$.toString(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.create(2014,2,1,0,65)),null,{ fileName : "TestDateTimeUtc.hx", lineNumber : 57, className : "thx.TestDateTimeUtc", methodName : "testOverflowing"});
			utest_Assert.equals("2013-12-31T23:59:00Z",thx__$DateTimeUtc_DateTimeUtc_$Impl_$.toString(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.create(2014,1,1,0,-1)),null,{ fileName : "TestDateTimeUtc.hx", lineNumber : 58, className : "thx.TestDateTimeUtc", methodName : "testOverflowing"});
			utest_Assert.equals("2014-02-01T00:01:05Z",thx__$DateTimeUtc_DateTimeUtc_$Impl_$.toString(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.create(2014,2,1,0,0,65)),null,{ fileName : "TestDateTimeUtc.hx", lineNumber : 61, className : "thx.TestDateTimeUtc", methodName : "testOverflowing"});
			utest_Assert.equals("2013-12-31T23:59:59Z",thx__$DateTimeUtc_DateTimeUtc_$Impl_$.toString(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.create(2014,1,1,0,0,-1)),null,{ fileName : "TestDateTimeUtc.hx", lineNumber : 62, className : "thx.TestDateTimeUtc", methodName : "testOverflowing"});
		}
	}
	,testEquals: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			var a = this.date;
			var b = this.date;
			utest_Assert.isTrue(a.high == b.high && a.low == b.low,null,{ fileName : "TestDateTimeUtc.hx", lineNumber : 67, className : "thx.TestDateTimeUtc", methodName : "testEquals"});
			var a1 = this.date;
			var b1 = this.tomorrow;
			utest_Assert.isTrue(a1.high != b1.high || a1.low != b1.low,null,{ fileName : "TestDateTimeUtc.hx", lineNumber : 68, className : "thx.TestDateTimeUtc", methodName : "testEquals"});
		}
	}
	,testCompare: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.isFalse((a.high < 0?b.high < 0?v:-1:b.high >= 0?v:1) > 0,null,{ fileName : "TestDateTimeUtc.hx", lineNumber : 73, className : "thx.TestDateTimeUtc", methodName : "testCompare"});
			var a1 = this.date;
			var b1 = this.date;
			...
			utest_Assert.isTrue((a1.high < 0?b1.high < 0?v1:-1:b1.high >= 0?v1:1) >= 0,null,{ fileName : "TestDateTimeUtc.hx", lineNumber : 74, className : "thx.TestDateTimeUtc", methodName : "testCompare"});
			var a2 = this.date;
			var b2 = this.date;
			...
			utest_Assert.isFalse((a2.high < 0?b2.high < 0?v2:-1:b2.high >= 0?v2:1) < 0,null,{ fileName : "TestDateTimeUtc.hx", lineNumber : 75, className : "thx.TestDateTimeUtc", methodName : "testCompare"});
			var a3 = this.date;
			var b3 = this.date;
			...
			utest_Assert.isTrue((a3.high < 0?b3.high < 0?v3:-1:b3.high >= 0?v3:1) <= 0,null,{ fileName : "TestDateTimeUtc.hx", lineNumber : 76, className : "thx.TestDateTimeUtc", methodName : "testCompare"});
			var a4 = this.date;
			...
			utest_Assert.isFalse((a4.high < 0?b4.high < 0?v4:-1:b4.high >= 0?v4:1) > 0,null,{ fileName : "TestDateTimeUtc.hx", lineNumber : 78, className : "thx.TestDateTimeUtc", methodName : "testCompare"});
			var a5 = this.date;
			...
			utest_Assert.isFalse((a5.high < 0?b5.high < 0?v5:-1:b5.high >= 0?v5:1) >= 0,null,{ fileName : "TestDateTimeUtc.hx", lineNumber : 79, className : "thx.TestDateTimeUtc", methodName : "testCompare"});
			var a6 = this.date;
			...
			utest_Assert.isTrue((a6.high < 0?b6.high < 0?v6:-1:b6.high >= 0?v6:1) < 0,null,{ fileName : "TestDateTimeUtc.hx", lineNumber : 80, className : "thx.TestDateTimeUtc", methodName : "testCompare"});
			var a7 = this.date;
			...
			utest_Assert.isTrue((a7.high < 0?b7.high < 0?v7:-1:b7.high >= 0?v7:1) <= 0,null,{ fileName : "TestDateTimeUtc.hx", lineNumber : 81, className : "thx.TestDateTimeUtc", methodName : "testCompare"});
			...
			utest_Assert.isTrue((a8.high < 0?b8.high < 0?v8:-1:b8.high >= 0?v8:1) > 0,null,{ fileName : "TestDateTimeUtc.hx", lineNumber : 83, className : "thx.TestDateTimeUtc", methodName : "testCompare"});
			...
			utest_Assert.isTrue((a9.high < 0?b9.high < 0?v9:-1:b9.high >= 0?v9:1) >= 0,null,{ fileName : "TestDateTimeUtc.hx", lineNumber : 84, className : "thx.TestDateTimeUtc", methodName : "testCompare"});
			...
			utest_Assert.isFalse((a10.high < 0?b10.high < 0?v10:-1:b10.high >= 0?v10:1) < 0,null,{ fileName : "TestDateTimeUtc.hx", lineNumber : 85, className : "thx.TestDateTimeUtc", methodName : "testCompare"});
			...
			utest_Assert.isFalse((a11.high < 0?b11.high < 0?v11:-1:b11.high >= 0?v11:1) <= 0,null,{ fileName : "TestDateTimeUtc.hx", lineNumber : 86, className : "thx.TestDateTimeUtc", methodName : "testCompare"});
		}
	}
	,testFromToDate: function() {
		...
		while(_g1 < _g) {
			...
			var a1 = this.date;
			var b1 = that;
			utest_Assert.isTrue(a1.high == b1.high && a1.low == b1.low,"expected " + thx__$DateTimeUtc_DateTimeUtc_$Impl_$.toString(this.date) + " but got " + thx__$DateTimeUtc_DateTimeUtc_$Impl_$.toString(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromDate(d)),{ fileName : "TestDateTimeUtc.hx", lineNumber : 92, className : "thx.TestDateTimeUtc", methodName : "testFromToDate"});
		}
	}
	,testFromToTime: function() {
		...
		while(_g1 < _g) {
			...
			var a1 = this.date;
			var b1 = date2;
			utest_Assert.isTrue(a1.high == b1.high && a1.low == b1.low,"expected " + thx__$DateTimeUtc_DateTimeUtc_$Impl_$.toString(this.date) + " but got " + thx__$DateTimeUtc_DateTimeUtc_$Impl_$.toString(date2),{ fileName : "TestDateTimeUtc.hx", lineNumber : 99, className : "thx.TestDateTimeUtc", methodName : "testFromToTime"});
		}
	}
	,testFromToString: function() {
		...
		while(_g1 < _g) {
			...
			var a = this.date;
			var b = that;
			utest_Assert.isTrue(a.high == b.high && a.low == b.low,null,{ fileName : "TestDateTimeUtc.hx", lineNumber : 105, className : "thx.TestDateTimeUtc", methodName : "testFromToString"});
			utest_Assert.equals("-1-07-27T00:00:00Z",thx__$DateTimeUtc_DateTimeUtc_$Impl_$.toString(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("0-06-07")),null,{ fileName : "TestDateTimeUtc.hx", lineNumber : 107, className : "thx.TestDateTimeUtc", methodName : "testFromToString"});
			utest_Assert.equals("-1-06-07T00:00:00Z",thx__$DateTimeUtc_DateTimeUtc_$Impl_$.toString(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("-1-06-07")),null,{ fileName : "TestDateTimeUtc.hx", lineNumber : 108, className : "thx.TestDateTimeUtc", methodName : "testFromToString"});
			utest_Assert.equals("1-06-07T00:00:00Z",thx__$DateTimeUtc_DateTimeUtc_$Impl_$.toString(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("1-06-07")),null,{ fileName : "TestDateTimeUtc.hx", lineNumber : 109, className : "thx.TestDateTimeUtc", methodName : "testFromToString"});
			utest_Assert.equals("-2014-01-01T00:00:00Z",thx__$DateTimeUtc_DateTimeUtc_$Impl_$.toString(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("-2014-01-01")),null,{ fileName : "TestDateTimeUtc.hx", lineNumber : 110, className : "thx.TestDateTimeUtc", methodName : "testFromToString"});
		}
	}
	,testAdd: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			var a = d;
			var b = that;
			utest_Assert.isTrue(a.high == b.high && a.low == b.low,"expected " + "2018-05-07 04:50:37.007" + " but got " + thx__$DateTimeUtc_DateTimeUtc_$Impl_$.toString(d),{ fileName : "TestDateTimeUtc.hx", lineNumber : 124, className : "thx.TestDateTimeUtc", methodName : "testAdd"});
		}
	}
	,testNow: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			var ref = thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2016-06-06T10:39:09Z");
			var date = thx__$DateTimeUtc_DateTimeUtc_$Impl_$.now();
			utest_Assert.isTrue(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.nearEqualsTo(date,ref,thx__$Time_Time_$Impl_$.create(0,10,0,0)),"expected " + thx__$DateTimeUtc_DateTimeUtc_$Impl_$.toString(ref) + " but got " + thx__$DateTimeUtc_DateTimeUtc_$Impl_$.toString(date),{ fileName : "TestDateTimeUtc.hx", lineNumber : 131, className : "thx.TestDateTimeUtc", methodName : "testNow"});
		}
	}
	,testSnapNext: function() {
		...
		while(_g1 < _g) {
			++_g1;
			this.assertSnapNext(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-01 10:07:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-01 10:06:10"),thx_TimePeriod.Minute,{ fileName : "TestDateTimeUtc.hx", lineNumber : 136, className : "thx.TestDateTimeUtc", methodName : "testSnapNext"});
			this.assertSnapNext(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-01 10:06:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-01 10:05:50"),thx_TimePeriod.Minute,{ fileName : "TestDateTimeUtc.hx", lineNumber : 137, className : "thx.TestDateTimeUtc", methodName : "testSnapNext"});
			this.assertSnapNext(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-01 11:00:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-01 10:10:10"),thx_TimePeriod.Hour,{ fileName : "TestDateTimeUtc.hx", lineNumber : 138, className : "thx.TestDateTimeUtc", methodName : "testSnapNext"});
			this.assertSnapNext(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-01 10:00:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-01 09:50:10"),thx_TimePeriod.Hour,{ fileName : "TestDateTimeUtc.hx", lineNumber : 139, className : "thx.TestDateTimeUtc", methodName : "testSnapNext"});
			this.assertSnapNext(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-02 00:00:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-01 10:00:00"),thx_TimePeriod.Day,{ fileName : "TestDateTimeUtc.hx", lineNumber : 140, className : "thx.TestDateTimeUtc", methodName : "testSnapNext"});
			this.assertSnapNext(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-01 00:00:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2013-12-31 20:00:00"),thx_TimePeriod.Day,{ fileName : "TestDateTimeUtc.hx", lineNumber : 141, className : "thx.TestDateTimeUtc", methodName : "testSnapNext"});
			this.assertSnapNext(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-12-21 00:00:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-12-17 11:00:00"),thx_TimePeriod.Week,{ fileName : "TestDateTimeUtc.hx", lineNumber : 142, className : "thx.TestDateTimeUtc", methodName : "testSnapNext"});
			this.assertSnapNext(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-12-21 00:00:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-12-18 00:00:00"),thx_TimePeriod.Week,{ fileName : "TestDateTimeUtc.hx", lineNumber : 143, className : "thx.TestDateTimeUtc", methodName : "testSnapNext"});
			this.assertSnapNext(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2015-01-01 00:00:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-12-12 00:00:00"),thx_TimePeriod.Month,{ fileName : "TestDateTimeUtc.hx", lineNumber : 144, className : "thx.TestDateTimeUtc", methodName : "testSnapNext"});
			this.assertSnapNext(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2015-01-01 00:00:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-12-18 00:00:00"),thx_TimePeriod.Month,{ fileName : "TestDateTimeUtc.hx", lineNumber : 145, className : "thx.TestDateTimeUtc", methodName : "testSnapNext"});
			this.assertSnapNext(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2015-01-01 00:00:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-05-12 00:00:00"),thx_TimePeriod.Year,{ fileName : "TestDateTimeUtc.hx", lineNumber : 146, className : "thx.TestDateTimeUtc", methodName : "testSnapNext"});
			this.assertSnapNext(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2015-01-01 00:00:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-12-18 00:00:00"),thx_TimePeriod.Year,{ fileName : "TestDateTimeUtc.hx", lineNumber : 147, className : "thx.TestDateTimeUtc", methodName : "testSnapNext"});
		}
	}
	,testSnapPrev: function() {
		...
		while(_g1 < _g) {
			++_g1;
			this.assertSnapPrev(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-01 10:06:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-01 10:06:10"),thx_TimePeriod.Minute,{ fileName : "TestDateTimeUtc.hx", lineNumber : 152, className : "thx.TestDateTimeUtc", methodName : "testSnapPrev"});
			this.assertSnapPrev(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-01 10:05:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-01 10:05:50"),thx_TimePeriod.Minute,{ fileName : "TestDateTimeUtc.hx", lineNumber : 153, className : "thx.TestDateTimeUtc", methodName : "testSnapPrev"});
			this.assertSnapPrev(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-01 10:00:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-01 10:10:10"),thx_TimePeriod.Hour,{ fileName : "TestDateTimeUtc.hx", lineNumber : 154, className : "thx.TestDateTimeUtc", methodName : "testSnapPrev"});
			this.assertSnapPrev(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-01 09:00:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-01 09:50:10"),thx_TimePeriod.Hour,{ fileName : "TestDateTimeUtc.hx", lineNumber : 155, className : "thx.TestDateTimeUtc", methodName : "testSnapPrev"});
			this.assertSnapPrev(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-01 00:00:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-01 10:00:00"),thx_TimePeriod.Day,{ fileName : "TestDateTimeUtc.hx", lineNumber : 156, className : "thx.TestDateTimeUtc", methodName : "testSnapPrev"});
			this.assertSnapPrev(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2013-12-31 00:00:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2013-12-31 20:00:00"),thx_TimePeriod.Day,{ fileName : "TestDateTimeUtc.hx", lineNumber : 157, className : "thx.TestDateTimeUtc", methodName : "testSnapPrev"});
			this.assertSnapPrev(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-12-14 00:00:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-12-17 11:00:00"),thx_TimePeriod.Week,{ fileName : "TestDateTimeUtc.hx", lineNumber : 158, className : "thx.TestDateTimeUtc", methodName : "testSnapPrev"});
			this.assertSnapPrev(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-12-14 00:00:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-12-18 00:00:00"),thx_TimePeriod.Week,{ fileName : "TestDateTimeUtc.hx", lineNumber : 159, className : "thx.TestDateTimeUtc", methodName : "testSnapPrev"});
			this.assertSnapPrev(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-12-01 00:00:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-12-12 00:00:00"),thx_TimePeriod.Month,{ fileName : "TestDateTimeUtc.hx", lineNumber : 160, className : "thx.TestDateTimeUtc", methodName : "testSnapPrev"});
			this.assertSnapPrev(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-12-01 00:00:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-12-18 00:00:00"),thx_TimePeriod.Month,{ fileName : "TestDateTimeUtc.hx", lineNumber : 161, className : "thx.TestDateTimeUtc", methodName : "testSnapPrev"});
			this.assertSnapPrev(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-01 00:00:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-05-12 00:00:00"),thx_TimePeriod.Year,{ fileName : "TestDateTimeUtc.hx", lineNumber : 162, className : "thx.TestDateTimeUtc", methodName : "testSnapPrev"});
			this.assertSnapPrev(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-01 00:00:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-12-18 00:00:00"),thx_TimePeriod.Year,{ fileName : "TestDateTimeUtc.hx", lineNumber : 163, className : "thx.TestDateTimeUtc", methodName : "testSnapPrev"});
		}
	}
	,testSnapTo: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			this.assertSnapTo(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-01 10:06:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-01 10:06:10"),thx_TimePeriod.Minute,{ fileName : "TestDateTimeUtc.hx", lineNumber : 168, className : "thx.TestDateTimeUtc", methodName : "testSnapTo"});
			this.assertSnapTo(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-01 10:06:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-01 10:05:50"),thx_TimePeriod.Minute,{ fileName : "TestDateTimeUtc.hx", lineNumber : 169, className : "thx.TestDateTimeUtc", methodName : "testSnapTo"});
			this.assertSnapTo(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-01 10:00:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-01 10:10:10"),thx_TimePeriod.Hour,{ fileName : "TestDateTimeUtc.hx", lineNumber : 170, className : "thx.TestDateTimeUtc", methodName : "testSnapTo"});
			this.assertSnapTo(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-01 10:00:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-01 09:50:10"),thx_TimePeriod.Hour,{ fileName : "TestDateTimeUtc.hx", lineNumber : 171, className : "thx.TestDateTimeUtc", methodName : "testSnapTo"});
			this.assertSnapTo(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-01 00:00:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-01 10:00:00"),thx_TimePeriod.Day,{ fileName : "TestDateTimeUtc.hx", lineNumber : 172, className : "thx.TestDateTimeUtc", methodName : "testSnapTo"});
			this.assertSnapTo(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-01 00:00:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2013-12-31 20:00:00"),thx_TimePeriod.Day,{ fileName : "TestDateTimeUtc.hx", lineNumber : 173, className : "thx.TestDateTimeUtc", methodName : "testSnapTo"});
			this.assertSnapTo(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-12-14 00:00:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-12-17 11:00:00"),thx_TimePeriod.Week,{ fileName : "TestDateTimeUtc.hx", lineNumber : 174, className : "thx.TestDateTimeUtc", methodName : "testSnapTo"});
			this.assertSnapTo(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-12-21 00:00:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-12-18 00:00:00"),thx_TimePeriod.Week,{ fileName : "TestDateTimeUtc.hx", lineNumber : 175, className : "thx.TestDateTimeUtc", methodName : "testSnapTo"});
			this.assertSnapTo(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-12-01 00:00:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-12-12 00:00:00"),thx_TimePeriod.Month,{ fileName : "TestDateTimeUtc.hx", lineNumber : 176, className : "thx.TestDateTimeUtc", methodName : "testSnapTo"});
			this.assertSnapTo(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2015-01-01 00:00:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-12-18 00:00:00"),thx_TimePeriod.Month,{ fileName : "TestDateTimeUtc.hx", lineNumber : 177, className : "thx.TestDateTimeUtc", methodName : "testSnapTo"});
			this.assertSnapTo(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-01-01 00:00:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-05-12 00:00:00"),thx_TimePeriod.Year,{ fileName : "TestDateTimeUtc.hx", lineNumber : 178, className : "thx.TestDateTimeUtc", methodName : "testSnapTo"});
			this.assertSnapTo(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2015-01-01 00:00:00"),thx__$DateTimeUtc_DateTimeUtc_$Impl_$.fromString("2014-12-18 00:00:00"),thx_TimePeriod.Year,{ fileName : "TestDateTimeUtc.hx", lineNumber : 179, className : "thx.TestDateTimeUtc", methodName : "testSnapTo"});
		}
	}
