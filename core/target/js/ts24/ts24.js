...
TS24.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS24.hx", lineNumber : 10, className : "TS24", methodName : "addTests"});
	runner.addCase(new thx_TestInts(Std.parseInt(w)));
};
TS24.main = function() {
	var runner = new utest_Runner();
	TS24.addTests(runner);
...
thx_TestInts.prototype = {
	...
	,testRange: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.same([2,3,4,5,6],range,null,null,null,{ fileName : "TestInts.hx", lineNumber : 20, className : "thx.TestInts", methodName : "testRange"});
			range = thx_Ints.range(2,7,2);
			utest_Assert.same([2,4,6],range,null,null,null,{ fileName : "TestInts.hx", lineNumber : 22, className : "thx.TestInts", methodName : "testRange"});
			range = thx_Ints.range(2,7,3);
			utest_Assert.same([2,5],range,null,null,null,{ fileName : "TestInts.hx", lineNumber : 24, className : "thx.TestInts", methodName : "testRange"});
			range = thx_Ints.range(7,2,-2);
			utest_Assert.same([7,5,3],range,null,null,null,{ fileName : "TestInts.hx", lineNumber : 27, className : "thx.TestInts", methodName : "testRange"});
		}
	}
	,testParse: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			while(_g2 < tests.length) {
				var test = tests[_g2];
				++_g2;
				utest_Assert.isTrue(thx_Ints.canParse(test.t),"Ints.parse should not be able to parse " + test.t,{ fileName : "TestInts.hx", lineNumber : 60, className : "thx.TestInts", methodName : "testParse"});
				utest_Assert.equals(test.e,thx_Ints.parse(test.t,test.b),"expected " + test.e + " converting \"" + test.t + "\" with base " + test.b + " but got " + thx_Ints.parse(test.t,test.b),{ fileName : "TestInts.hx", lineNumber : 61, className : "thx.TestInts", methodName : "testParse"});
			}
		}
	}
	,testToString: function() {
		...
		while(_g1 < _g) {
			...
			while(_g2 < tests.length) {
				var test = tests[_g2];
				++_g2;
				utest_Assert.equals(test.e,test.t.toString(test.b),null,{ fileName : "TestInts.hx", lineNumber : 75, className : "thx.TestInts", methodName : "testToString"});
			}
		}
	}
