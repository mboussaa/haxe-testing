...
TS15.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS15.hx", lineNumber : 10, className : "TS15", methodName : "addTests"});
	runner.addCase(new thx_TestEffects(Std.parseInt(w)));
};
TS15.main = function() {
...
var thx_TestEffects = function(i) {
	this.x = i;
};
...
thx_TestEffects.prototype = {
	...
	,testEffectsLog: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.isNull(this.logged,null,{ fileName : "TestEffects.hx", lineNumber : 30, className : "thx.TestEffects", methodName : "testEffectsLog"});
			((function(a2) {
				return function(a1) {
					thx_Effects.logger(a1,a2[0]);
				};
			})([{ fileName : "TestEffects.hx", lineNumber : 32, className : "thx.TestEffects", methodName : "testEffectsLog"}]))(2);
			utest_Assert.equals(2,2,null,{ fileName : "TestEffects.hx", lineNumber : 33, className : "thx.TestEffects", methodName : "testEffectsLog"});
			utest_Assert.equals(2,this.logged,null,{ fileName : "TestEffects.hx", lineNumber : 34, className : "thx.TestEffects", methodName : "testEffectsLog"});
		}
	}
