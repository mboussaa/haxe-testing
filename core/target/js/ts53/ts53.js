...
TS53.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS53.hx", lineNumber : 10, className : "TS53", methodName : "addTests"});
	runner.addCase(new thx_fp_TestTreeBag(Std.parseInt(w)));
};
TS53.main = function() {
	var runner = new utest_Runner();
	TS53.addTests(runner);
...
var thx_fp_TestTreeBag = function(i) {
	this.x = i;
};
...
thx_fp_TestTreeBag.prototype = {
	...
	,testMap: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.same(thx_fp_TestTreeBag.t0,thx_fp__$TreeBag_TreeBag_$Impl_$.map(thx_fp_TestTreeBag.t0,thx_Functions.identity),null,null,null,{ fileName : "TestTreeBag.hx", lineNumber : 28, className : "thx.fp.TestTreeBag", methodName : "testMap"});
			utest_Assert.same(thx_fp_TestTreeBag.t2,thx_fp__$TreeBag_TreeBag_$Impl_$.map(thx_fp_TestTreeBag.t1,function(i) {
				return i + 1;
			}),null,null,null,{ fileName : "TestTreeBag.hx", lineNumber : 29, className : "thx.fp.TestTreeBag", methodName : "testMap"});
		}
	}
	,testToArray: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.same([1,2],thx_fp__$TreeBag_TreeBag_$Impl_$.toArray(thx_fp_TestTreeBag.t1),null,null,null,{ fileName : "TestTreeBag.hx", lineNumber : 34, className : "thx.fp.TestTreeBag", methodName : "testToArray"});
		}
	}
	,testFlatMap: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(tmp,thx_fp__$TreeBag_TreeBag_$Impl_$.flatMap(thx_fp_TestTreeBag.t1,$bind(this,this.plusTwoBags)),null,null,null,{ fileName : "TestTreeBag.hx", lineNumber : 40, className : "thx.fp.TestTreeBag", methodName : "testFlatMap"});
		}
	}
