...
TS52.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS52.hx", lineNumber : 10, className : "TS52", methodName : "addTests"});
	runner.addCase(new thx_fp_TestWriter(Std.parseInt(w)));
};
TS52.main = function() {
	var runner = new utest_Runner();
	TS52.addTests(runner);
...
var thx_fp_TestWriter = function(i) {
	this.x = i;
};
...
thx_fp_TestWriter.prototype = {
	...
	,testMap: function() {
		...
		utest_Assert.same({ _0 : "", _1 : 2},thx_fp__$Writer_Writer_$Impl_$.run(thx_fp__$Writer_Writer_$Impl_$._new(thx__$Tuple_Tuple3_$Impl_$.map(thx_fp__$Writer_Writer_$Impl_$._new({ _0 : mw, _1 : thx__$Monoid_Monoid_$Impl_$.get_zero(mw), _2 : 1}),function(v) {
			return v + 1;
		}))),null,null,null,{ fileName : "TestWriter.hx", lineNumber : 18, className : "thx.fp.TestWriter", methodName : "testMap"});
	}
	,testFlatMap: function() {
		...
		})),null,null,null,{ fileName : "TestWriter.hx", lineNumber : 28, className : "thx.fp.TestWriter", methodName : "testFlatMap"});
	}
