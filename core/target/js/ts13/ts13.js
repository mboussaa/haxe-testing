...
TS13.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS13.hx", lineNumber : 10, className : "TS13", methodName : "addTests"});
	runner.addCase(new thx_TestDecimal(Std.parseInt(w)));
};
TS13.main = function() {
...
var thx_TestDecimal = function(i) {
	this.x = i;
};
...
thx_TestDecimal.prototype = {
	...
	,testToBigInt: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.isTrue(thx__$BigInt_BigInt_$Impl_$.equals(thx__$Decimal_Decimal_$Impl_$.toBigInt(v),thx_bigint_Bigs.parseBase("10234",10)),"expected 10234 but got " + thx__$Decimal_Decimal_$Impl_$.toBigInt(v).toString(),{ fileName : "TestDecimal.hx", lineNumber : 26, className : "thx.TestDecimal", methodName : "testToBigInt"});
		}
	}
	,testTrim: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			var v = thx_bigint_Decimals.parse("10234.0001040000");
			utest_Assert.isTrue(v.scale == 10,null,{ fileName : "TestDecimal.hx", lineNumber : 32, className : "thx.TestDecimal", methodName : "testTrim"});
			utest_Assert.isTrue(v.trim(null).scale == 6,null,{ fileName : "TestDecimal.hx", lineNumber : 33, className : "thx.TestDecimal", methodName : "testTrim"});
			utest_Assert.isTrue(v.trim(8).scale == 8,"expected " + v.trim(8).toString() + " to have a scale 8 but it is " + v.trim(8).scale,{ fileName : "TestDecimal.hx", lineNumber : 34, className : "thx.TestDecimal", methodName : "testTrim"});
			utest_Assert.isTrue(v.trim(2).scale == 6,"expected " + v.trim(2).toString() + " to have a scale 6 but it is " + v.trim(2).scale,{ fileName : "TestDecimal.hx", lineNumber : 35, className : "thx.TestDecimal", methodName : "testTrim"});
			v = thx_bigint_Decimals.parse("10234.00000000");
			utest_Assert.isTrue(v.trim(null).scale == 0,null,{ fileName : "TestDecimal.hx", lineNumber : 37, className : "thx.TestDecimal", methodName : "testTrim"});
			utest_Assert.isTrue(v.trim(2).scale == 2,"expected " + v.trim(2).toString() + ".scale == 2 but is " + v.trim(2).scale,{ fileName : "TestDecimal.hx", lineNumber : 38, className : "thx.TestDecimal", methodName : "testTrim"});
			v = thx_bigint_Decimals.parse("1.20000000");
			utest_Assert.isTrue(v.trim(null).scale == 1,"expected " + v.trim(null).toString() + ".scale == 1 but got " + v.trim(null).scale,{ fileName : "TestDecimal.hx", lineNumber : 40, className : "thx.TestDecimal", methodName : "testTrim"});
		}
	}
	,testStringExp: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx_bigint_Decimals.parse("1.12345e-10"),thx_bigint_Decimals.parse("0.000000000112345")),"expected " + thx_bigint_Decimals.parse("0.000000000112345").toString() + " but got " + thx_bigint_Decimals.parse("1.12345e-10").toString(),{ fileName : "TestDecimal.hx", lineNumber : 45, className : "thx.TestDecimal", methodName : "testStringExp"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx_bigint_Decimals.parse("1.12345e+10"),thx_bigint_Decimals.parse("11234500000")),"expected " + thx_bigint_Decimals.parse("11234500000").toString() + " but got " + thx_bigint_Decimals.parse("1.12345e+10").toString(),{ fileName : "TestDecimal.hx", lineNumber : 46, className : "thx.TestDecimal", methodName : "testStringExp"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx_bigint_Decimals.parse("-1.12345e-10"),thx_bigint_Decimals.parse("-0.000000000112345")),"expected " + thx_bigint_Decimals.parse("-0.000000000112345").toString() + " but got " + thx_bigint_Decimals.parse("-1.12345e-10").toString(),{ fileName : "TestDecimal.hx", lineNumber : 47, className : "thx.TestDecimal", methodName : "testStringExp"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx_bigint_Decimals.parse("-1.12345e+10"),thx_bigint_Decimals.parse("-11234500000")),"expected " + thx_bigint_Decimals.parse("-11234500000").toString() + " but got " + thx_bigint_Decimals.parse("-1.12345e+10").toString(),{ fileName : "TestDecimal.hx", lineNumber : 48, className : "thx.TestDecimal", methodName : "testStringExp"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx_bigint_Decimals.parse("0E7"),thx_bigint_Decimals.parse("0")),"expected " + thx_bigint_Decimals.parse("0").toString() + " but got " + thx_bigint_Decimals.parse("0E7").toString(),{ fileName : "TestDecimal.hx", lineNumber : 49, className : "thx.TestDecimal", methodName : "testStringExp"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx_bigint_Decimals.fromFloat(1.234e-50),thx_bigint_Decimals.parse("1.234000e-050")),"expected " + thx_bigint_Decimals.fromFloat(1.234e-50).toString() + " == " + thx_bigint_Decimals.parse("1.234000e-050").toString(),{ fileName : "TestDecimal.hx", lineNumber : 50, className : "thx.TestDecimal", methodName : "testStringExp"});
		}
	}
	,testModulo: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx_bigint_Decimals.fromFloat(10.2).modulo(thx__$Decimal_Decimal_$Impl_$.fromInt(3)),thx_bigint_Decimals.fromFloat(1.2)),null,{ fileName : "TestDecimal.hx", lineNumber : 56, className : "thx.TestDecimal", methodName : "testModulo"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx_bigint_Decimals.parse("12345678900000000").modulo(thx_bigint_Decimals.parse("0.0000000012345678")),thx_bigint_Decimals.parse("0.0000000009832122")),null,{ fileName : "TestDecimal.hx", lineNumber : 57, className : "thx.TestDecimal", methodName : "testModulo"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx_bigint_Decimals.fromFloat(16.80).modulo(thx_bigint_Decimals.fromFloat(4.10)),thx_bigint_Decimals.parse("0.4")),null,{ fileName : "TestDecimal.hx", lineNumber : 58, className : "thx.TestDecimal", methodName : "testModulo"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx__$Decimal_Decimal_$Impl_$.fromInt(10).modulo(thx__$Decimal_Decimal_$Impl_$.fromInt(3)),thx__$Decimal_Decimal_$Impl_$.fromInt(1)),null,{ fileName : "TestDecimal.hx", lineNumber : 59, className : "thx.TestDecimal", methodName : "testModulo"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx_bigint_Decimals.fromFloat(10.2).modulo(thx__$Decimal_Decimal_$Impl_$.fromInt(3)),thx_bigint_Decimals.fromFloat(1.2)),null,{ fileName : "TestDecimal.hx", lineNumber : 60, className : "thx.TestDecimal", methodName : "testModulo"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx__$Decimal_Decimal_$Impl_$.fromInt(10).modulo(thx__$Decimal_Decimal_$Impl_$.fromInt(-3)),thx__$Decimal_Decimal_$Impl_$.fromInt(1)),null,{ fileName : "TestDecimal.hx", lineNumber : 62, className : "thx.TestDecimal", methodName : "testModulo"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx__$Decimal_Decimal_$Impl_$.fromInt(-10).modulo(thx__$Decimal_Decimal_$Impl_$.fromInt(-3)),thx__$Decimal_Decimal_$Impl_$.fromInt(-1)),null,{ fileName : "TestDecimal.hx", lineNumber : 63, className : "thx.TestDecimal", methodName : "testModulo"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx__$Decimal_Decimal_$Impl_$.fromInt(-10).modulo(thx__$Decimal_Decimal_$Impl_$.fromInt(3)),thx__$Decimal_Decimal_$Impl_$.fromInt(-1)),null,{ fileName : "TestDecimal.hx", lineNumber : 64, className : "thx.TestDecimal", methodName : "testModulo"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx__$Decimal_Decimal_$Impl_$.fromInt(0).modulo(thx__$Decimal_Decimal_$Impl_$.fromInt(3)),thx_bigint_Decimals.parse("0.0")),null,{ fileName : "TestDecimal.hx", lineNumber : 66, className : "thx.TestDecimal", methodName : "testModulo"});
			utest_Assert.raises(function() {
				thx__$Decimal_Decimal_$Impl_$.fromInt(1).modulo(thx__$Decimal_Decimal_$Impl_$.fromInt(0));
			},null,null,null,{ fileName : "TestDecimal.hx", lineNumber : 68, className : "thx.TestDecimal", methodName : "testModulo"});
		}
	}
	,testDivision: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx_bigint_Decimals.parse("12345678900000000").divide(thx_bigint_Decimals.parse("0.0000000012345678")),thx_bigint_Decimals.parse("10000000729000059778004901.79640194730495967900669367854888")),null,{ fileName : "TestDecimal.hx", lineNumber : 73, className : "thx.TestDecimal", methodName : "testDivision"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx_bigint_Decimals.parse("12345678901234567890.12346789").divide(thx_bigint_Decimals.parse("987654321.987654321")),thx_bigint_Decimals.parse("12499999874.843750115314464248433558")),"expected " + thx_bigint_Decimals.parse("12345678901234567890.12346789").toString() + " / " + thx_bigint_Decimals.parse("987654321.987654321").toString() + " == " + thx_bigint_Decimals.parse("12499999874.843750115314464248433558").toString() + " but got " + thx_bigint_Decimals.parse("12345678901234567890.12346789").divide(thx_bigint_Decimals.parse("987654321.987654321")).toString(),{ fileName : "TestDecimal.hx", lineNumber : 74, className : "thx.TestDecimal", methodName : "testDivision"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx_bigint_Decimals.parse("12345678901234567890.12346789").divide(thx_bigint_Decimals.parse("-987654321.987654321")),thx_bigint_Decimals.parse("-12499999874.843750115314464248433558")),null,{ fileName : "TestDecimal.hx", lineNumber : 75, className : "thx.TestDecimal", methodName : "testDivision"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx_bigint_Decimals.parse("-12345678901234567890.12346789").divide(thx_bigint_Decimals.parse("-987654321.987654321")),thx_bigint_Decimals.parse("12499999874.843750115314464248433558")),null,{ fileName : "TestDecimal.hx", lineNumber : 76, className : "thx.TestDecimal", methodName : "testDivision"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx_bigint_Decimals.parse("-12345678901234567890.12346789").divide(thx_bigint_Decimals.parse("987654321.987654321")),thx_bigint_Decimals.parse("-12499999874.843750115314464248433558")),null,{ fileName : "TestDecimal.hx", lineNumber : 77, className : "thx.TestDecimal", methodName : "testDivision"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx_bigint_Decimals.parse("-12345678901234567890.12346789").divide(thx__$Decimal_Decimal_$Impl_$.fromInt(1)),thx_bigint_Decimals.parse("-12345678901234567890.12346789")),null,{ fileName : "TestDecimal.hx", lineNumber : 78, className : "thx.TestDecimal", methodName : "testDivision"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx_bigint_Decimals.parse("-12345678901234567890.12346789").divide(thx_bigint_Decimals.parse("-12345678901234567890.12346789")),thx__$Decimal_Decimal_$Impl_$.fromInt(1)),null,{ fileName : "TestDecimal.hx", lineNumber : 79, className : "thx.TestDecimal", methodName : "testDivision"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx__$Decimal_Decimal_$Impl_$.fromInt(10).divide(thx__$Decimal_Decimal_$Impl_$.fromInt(2)),thx__$Decimal_Decimal_$Impl_$.fromInt(5)),null,{ fileName : "TestDecimal.hx", lineNumber : 80, className : "thx.TestDecimal", methodName : "testDivision"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx__$Decimal_Decimal_$Impl_$.fromInt(10).divide(thx__$Decimal_Decimal_$Impl_$.fromInt(3)),thx_bigint_Decimals.parse("3.3333333333333333")),null,{ fileName : "TestDecimal.hx", lineNumber : 81, className : "thx.TestDecimal", methodName : "testDivision"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx__$Decimal_Decimal_$Impl_$.fromInt(1).divide(thx__$Decimal_Decimal_$Impl_$.fromInt(2)),thx_bigint_Decimals.fromFloat(0.5)),null,{ fileName : "TestDecimal.hx", lineNumber : 82, className : "thx.TestDecimal", methodName : "testDivision"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx__$Decimal_Decimal_$Impl_$.fromInt(1).divide(thx__$Decimal_Decimal_$Impl_$.fromInt(3)),thx_bigint_Decimals.parse("0.3333333333333333")),null,{ fileName : "TestDecimal.hx", lineNumber : 83, className : "thx.TestDecimal", methodName : "testDivision"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx__$Decimal_Decimal_$Impl_$.fromInt(0).divide(thx__$Decimal_Decimal_$Impl_$.fromInt(3)),thx_bigint_Decimals.parse("0.0")),null,{ fileName : "TestDecimal.hx", lineNumber : 85, className : "thx.TestDecimal", methodName : "testDivision"});
			utest_Assert.raises(function() {
				thx__$Decimal_Decimal_$Impl_$.fromInt(1).divide(thx__$Decimal_Decimal_$Impl_$.fromInt(0));
			},null,null,null,{ fileName : "TestDecimal.hx", lineNumber : 87, className : "thx.TestDecimal", methodName : "testDivision"});
		}
	}
	,testMultiply: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx_bigint_Decimals.parse("12345678900000000").multiply(thx_bigint_Decimals.parse("0.0000000012345678")),thx_bigint_Decimals.parse("15241577.63907942")),null,{ fileName : "TestDecimal.hx", lineNumber : 92, className : "thx.TestDecimal", methodName : "testMultiply"});
		}
	}
	,testInts: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx__$Decimal_Decimal_$Impl_$.fromInt(123),thx_bigint_Decimals.parse("123")),null,{ fileName : "TestDecimal.hx", lineNumber : 97, className : "thx.TestDecimal", methodName : "testInts"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx__$Decimal_Decimal_$Impl_$.fromInt(-123),thx_bigint_Decimals.parse("-123")),null,{ fileName : "TestDecimal.hx", lineNumber : 98, className : "thx.TestDecimal", methodName : "testInts"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx__$Decimal_Decimal_$Impl_$.fromInt(1234567890),thx_bigint_Decimals.parse("1234567890")),null,{ fileName : "TestDecimal.hx", lineNumber : 99, className : "thx.TestDecimal", methodName : "testInts"});
		}
	}
	,testFloats: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx_bigint_Decimals.fromFloat(123.456),thx_bigint_Decimals.parse("123.456")),null,{ fileName : "TestDecimal.hx", lineNumber : 104, className : "thx.TestDecimal", methodName : "testFloats"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx_bigint_Decimals.fromFloat(-123.456),thx_bigint_Decimals.parse("-123.456")),null,{ fileName : "TestDecimal.hx", lineNumber : 105, className : "thx.TestDecimal", methodName : "testFloats"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx_bigint_Decimals.fromFloat(0.123456789),thx_bigint_Decimals.parse("0.123456789")),null,{ fileName : "TestDecimal.hx", lineNumber : 106, className : "thx.TestDecimal", methodName : "testFloats"});
		}
	}
	,testEquality: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx_bigint_Decimals.parse("123.456"),thx_bigint_Decimals.parse("123.4560000")),null,{ fileName : "TestDecimal.hx", lineNumber : 111, className : "thx.TestDecimal", methodName : "testEquality"});
		}
	}
	,testAddition: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx_bigint_Decimals.parse("123.456").add(thx_bigint_Decimals.parse("76.544000")),thx_bigint_Decimals.parse("200")),null,{ fileName : "TestDecimal.hx", lineNumber : 116, className : "thx.TestDecimal", methodName : "testAddition"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx_bigint_Decimals.parse("123.456").add(thx_bigint_Decimals.parse("0.004")),thx_bigint_Decimals.parse("123.46")),null,{ fileName : "TestDecimal.hx", lineNumber : 117, className : "thx.TestDecimal", methodName : "testAddition"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx_bigint_Decimals.parse("123.456").add(thx_bigint_Decimals.parse("-0.456")),thx_bigint_Decimals.parse("123")),null,{ fileName : "TestDecimal.hx", lineNumber : 118, className : "thx.TestDecimal", methodName : "testAddition"});
		}
	}
	,testSubtraction: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx_bigint_Decimals.parse("123.456").subtract(thx_bigint_Decimals.parse("76.544000")),thx_bigint_Decimals.parse("46.912000")),null,{ fileName : "TestDecimal.hx", lineNumber : 123, className : "thx.TestDecimal", methodName : "testSubtraction"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx_bigint_Decimals.parse("123.456").subtract(thx_bigint_Decimals.parse("0.004")),thx_bigint_Decimals.parse("123.452")),null,{ fileName : "TestDecimal.hx", lineNumber : 124, className : "thx.TestDecimal", methodName : "testSubtraction"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx_bigint_Decimals.parse("123.456").subtract(thx_bigint_Decimals.parse("-0.456")),thx_bigint_Decimals.parse("123.912")),null,{ fileName : "TestDecimal.hx", lineNumber : 125, className : "thx.TestDecimal", methodName : "testSubtraction"});
		}
	}
	,testComparison: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.greater(thx_bigint_Decimals.parse("1"),thx_bigint_Decimals.parse("0.11111")),null,{ fileName : "TestDecimal.hx", lineNumber : 130, className : "thx.TestDecimal", methodName : "testComparison"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.greater(thx_bigint_Decimals.parse("1"),thx__$Decimal_Decimal_$Impl_$.fromInt(-1)),null,{ fileName : "TestDecimal.hx", lineNumber : 131, className : "thx.TestDecimal", methodName : "testComparison"});
			utest_Assert.isFalse(thx__$Decimal_Decimal_$Impl_$.greater(thx_bigint_Decimals.parse("1"),thx__$Decimal_Decimal_$Impl_$.fromInt(1)),null,{ fileName : "TestDecimal.hx", lineNumber : 132, className : "thx.TestDecimal", methodName : "testComparison"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.greaterEquals(thx_bigint_Decimals.parse("1"),thx__$Decimal_Decimal_$Impl_$.fromInt(1)),null,{ fileName : "TestDecimal.hx", lineNumber : 133, className : "thx.TestDecimal", methodName : "testComparison"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx_bigint_Decimals.parse("1"),thx__$Decimal_Decimal_$Impl_$.fromInt(1)),null,{ fileName : "TestDecimal.hx", lineNumber : 134, className : "thx.TestDecimal", methodName : "testComparison"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx_bigint_Decimals.parse("1.01001"),thx_bigint_Decimals.parse("1.0100100")),null,{ fileName : "TestDecimal.hx", lineNumber : 135, className : "thx.TestDecimal", methodName : "testComparison"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx_bigint_Decimals.parse("0"),thx_bigint_Decimals.parse("0")),null,{ fileName : "TestDecimal.hx", lineNumber : 136, className : "thx.TestDecimal", methodName : "testComparison"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx_bigint_Decimals.parse("0.000"),thx__$Decimal_Decimal_$Impl_$.fromInt(0)),null,{ fileName : "TestDecimal.hx", lineNumber : 137, className : "thx.TestDecimal", methodName : "testComparison"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.greaterEquals(thx_bigint_Decimals.parse("-1.12345e+10"),thx_bigint_Decimals.parse("-11234500000")),null,{ fileName : "TestDecimal.hx", lineNumber : 138, className : "thx.TestDecimal", methodName : "testComparison"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.lessEquals(thx_bigint_Decimals.parse("-1.12345e+10"),thx_bigint_Decimals.parse("-11234500000")),null,{ fileName : "TestDecimal.hx", lineNumber : 139, className : "thx.TestDecimal", methodName : "testComparison"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.greaterEquals(thx_bigint_Decimals.parse("1.12345e+10"),thx_bigint_Decimals.parse("11234500000")),null,{ fileName : "TestDecimal.hx", lineNumber : 140, className : "thx.TestDecimal", methodName : "testComparison"});
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.lessEquals(thx_bigint_Decimals.parse("1.12345e+10"),thx_bigint_Decimals.parse("11234500000")),null,{ fileName : "TestDecimal.hx", lineNumber : 141, className : "thx.TestDecimal", methodName : "testComparison"});
		}
	}
	,testString: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			while(_g2 < tests.length) {
				...
				utest_Assert.equals(test,dec.toString(),null,{ fileName : "TestDecimal.hx", lineNumber : 150, className : "thx.TestDecimal", methodName : "testString"});
				if(test == "0") {
					continue;
				}
				dec = thx_bigint_Decimals.parse("-" + test);
				utest_Assert.equals("-" + test,dec.toString(),null,{ fileName : "TestDecimal.hx", lineNumber : 155, className : "thx.TestDecimal", methodName : "testString"});
			}
		}
	}
	...
	,testRound: function() {
		...
		while(_g1 < _g) {
			++_g1;
			this.assertDecimalEquals(thx__$Decimal_Decimal_$Impl_$.fromInt(0).roundTo(0),thx__$Decimal_Decimal_$Impl_$.fromInt(0),{ fileName : "TestDecimal.hx", lineNumber : 165, className : "thx.TestDecimal", methodName : "testRound"});
			this.assertDecimalEquals(thx__$Decimal_Decimal_$Impl_$.fromInt(0).ceilTo(0),thx__$Decimal_Decimal_$Impl_$.fromInt(0),{ fileName : "TestDecimal.hx", lineNumber : 166, className : "thx.TestDecimal", methodName : "testRound"});
			this.assertDecimalEquals(thx__$Decimal_Decimal_$Impl_$.fromInt(0).floorTo(0),thx__$Decimal_Decimal_$Impl_$.fromInt(0),{ fileName : "TestDecimal.hx", lineNumber : 167, className : "thx.TestDecimal", methodName : "testRound"});
			this.assertDecimalEquals(thx__$Decimal_Decimal_$Impl_$.fromInt(1).roundTo(0),thx__$Decimal_Decimal_$Impl_$.fromInt(1),{ fileName : "TestDecimal.hx", lineNumber : 169, className : "thx.TestDecimal", methodName : "testRound"});
			this.assertDecimalEquals(thx__$Decimal_Decimal_$Impl_$.fromInt(-1).roundTo(0),thx__$Decimal_Decimal_$Impl_$.fromInt(-1),{ fileName : "TestDecimal.hx", lineNumber : 170, className : "thx.TestDecimal", methodName : "testRound"});
			this.assertDecimalEquals(thx__$Decimal_Decimal_$Impl_$.fromInt(1).ceilTo(0),thx__$Decimal_Decimal_$Impl_$.fromInt(1),{ fileName : "TestDecimal.hx", lineNumber : 171, className : "thx.TestDecimal", methodName : "testRound"});
			this.assertDecimalEquals(thx__$Decimal_Decimal_$Impl_$.fromInt(-1).ceilTo(0),thx__$Decimal_Decimal_$Impl_$.fromInt(-1),{ fileName : "TestDecimal.hx", lineNumber : 172, className : "thx.TestDecimal", methodName : "testRound"});
			this.assertDecimalEquals(thx__$Decimal_Decimal_$Impl_$.fromInt(1).floorTo(0),thx__$Decimal_Decimal_$Impl_$.fromInt(1),{ fileName : "TestDecimal.hx", lineNumber : 173, className : "thx.TestDecimal", methodName : "testRound"});
			this.assertDecimalEquals(thx__$Decimal_Decimal_$Impl_$.fromInt(-1).floorTo(0),thx__$Decimal_Decimal_$Impl_$.fromInt(-1),{ fileName : "TestDecimal.hx", lineNumber : 174, className : "thx.TestDecimal", methodName : "testRound"});
			this.assertDecimalEquals(thx_bigint_Decimals.parse("1234567890.1234567890").roundTo(0),thx_bigint_Decimals.parse("1234567890"),{ fileName : "TestDecimal.hx", lineNumber : 176, className : "thx.TestDecimal", methodName : "testRound"});
			this.assertDecimalEquals(thx_bigint_Decimals.parse("1234567890.1234567890").roundTo(3),thx_bigint_Decimals.parse("1234567890.123"),{ fileName : "TestDecimal.hx", lineNumber : 177, className : "thx.TestDecimal", methodName : "testRound"});
			this.assertDecimalEquals(thx_bigint_Decimals.parse("1234567890.1234567890").roundTo(5),thx_bigint_Decimals.parse("1234567890.12346"),{ fileName : "TestDecimal.hx", lineNumber : 178, className : "thx.TestDecimal", methodName : "testRound"});
			this.assertDecimalEquals(thx_bigint_Decimals.parse("1234567890.1234567890").roundTo(6),thx_bigint_Decimals.parse("1234567890.123457"),{ fileName : "TestDecimal.hx", lineNumber : 179, className : "thx.TestDecimal", methodName : "testRound"});
			this.assertDecimalEquals(thx_bigint_Decimals.parse("-1234567890.1234567890").roundTo(0),thx_bigint_Decimals.parse("-1234567890"),{ fileName : "TestDecimal.hx", lineNumber : 181, className : "thx.TestDecimal", methodName : "testRound"});
			this.assertDecimalEquals(thx_bigint_Decimals.parse("-1234567890.1234567890").roundTo(3),thx_bigint_Decimals.parse("-1234567890.123"),{ fileName : "TestDecimal.hx", lineNumber : 182, className : "thx.TestDecimal", methodName : "testRound"});
			this.assertDecimalEquals(thx_bigint_Decimals.parse("-1234567890.1234567890").roundTo(5),thx_bigint_Decimals.parse("-1234567890.12345"),{ fileName : "TestDecimal.hx", lineNumber : 183, className : "thx.TestDecimal", methodName : "testRound"});
			this.assertDecimalEquals(thx_bigint_Decimals.parse("-1234567890.1234567890").roundTo(6),thx_bigint_Decimals.parse("-1234567890.123456"),{ fileName : "TestDecimal.hx", lineNumber : 184, className : "thx.TestDecimal", methodName : "testRound"});
			this.assertDecimalEquals(thx_bigint_Decimals.parse("1234567890.1234567890").ceilTo(0),thx_bigint_Decimals.parse("1234567891"),{ fileName : "TestDecimal.hx", lineNumber : 186, className : "thx.TestDecimal", methodName : "testRound"});
			this.assertDecimalEquals(thx_bigint_Decimals.parse("1234567890.1234567890").ceilTo(3),thx_bigint_Decimals.parse("1234567890.124"),{ fileName : "TestDecimal.hx", lineNumber : 187, className : "thx.TestDecimal", methodName : "testRound"});
			this.assertDecimalEquals(thx_bigint_Decimals.parse("1234567890.1234567890").ceilTo(5),thx_bigint_Decimals.parse("1234567890.12346"),{ fileName : "TestDecimal.hx", lineNumber : 188, className : "thx.TestDecimal", methodName : "testRound"});
			this.assertDecimalEquals(thx_bigint_Decimals.parse("1234567890.1234567890").ceilTo(6),thx_bigint_Decimals.parse("1234567890.123457"),{ fileName : "TestDecimal.hx", lineNumber : 189, className : "thx.TestDecimal", methodName : "testRound"});
			this.assertDecimalEquals(thx_bigint_Decimals.parse("-1234567890.1234567890").ceilTo(0),thx_bigint_Decimals.parse("-1234567890"),{ fileName : "TestDecimal.hx", lineNumber : 191, className : "thx.TestDecimal", methodName : "testRound"});
			this.assertDecimalEquals(thx_bigint_Decimals.parse("-1234567890.1234567890").ceilTo(3),thx_bigint_Decimals.parse("-1234567890.123"),{ fileName : "TestDecimal.hx", lineNumber : 192, className : "thx.TestDecimal", methodName : "testRound"});
			this.assertDecimalEquals(thx_bigint_Decimals.parse("-1234567890.1234567890").ceilTo(5),thx_bigint_Decimals.parse("-1234567890.12345"),{ fileName : "TestDecimal.hx", lineNumber : 193, className : "thx.TestDecimal", methodName : "testRound"});
			this.assertDecimalEquals(thx_bigint_Decimals.parse("-1234567890.1234567890").ceilTo(6),thx_bigint_Decimals.parse("-1234567890.123456"),{ fileName : "TestDecimal.hx", lineNumber : 194, className : "thx.TestDecimal", methodName : "testRound"});
			this.assertDecimalEquals(thx_bigint_Decimals.parse("1234567890.1234567890").floorTo(0),thx_bigint_Decimals.parse("1234567890"),{ fileName : "TestDecimal.hx", lineNumber : 196, className : "thx.TestDecimal", methodName : "testRound"});
			this.assertDecimalEquals(thx_bigint_Decimals.parse("1234567890.1234567890").floorTo(3),thx_bigint_Decimals.parse("1234567890.123"),{ fileName : "TestDecimal.hx", lineNumber : 197, className : "thx.TestDecimal", methodName : "testRound"});
			this.assertDecimalEquals(thx_bigint_Decimals.parse("1234567890.1234567890").floorTo(5),thx_bigint_Decimals.parse("1234567890.12345"),{ fileName : "TestDecimal.hx", lineNumber : 198, className : "thx.TestDecimal", methodName : "testRound"});
			this.assertDecimalEquals(thx_bigint_Decimals.parse("1234567890.1234567890").floorTo(6),thx_bigint_Decimals.parse("1234567890.123456"),{ fileName : "TestDecimal.hx", lineNumber : 199, className : "thx.TestDecimal", methodName : "testRound"});
			this.assertDecimalEquals(thx_bigint_Decimals.parse("-1234567890.1234567890").floorTo(0),thx_bigint_Decimals.parse("-1234567890"),{ fileName : "TestDecimal.hx", lineNumber : 201, className : "thx.TestDecimal", methodName : "testRound"});
			this.assertDecimalEquals(thx_bigint_Decimals.parse("-1234567890.1234567890").floorTo(3),thx_bigint_Decimals.parse("-1234567890.123"),{ fileName : "TestDecimal.hx", lineNumber : 202, className : "thx.TestDecimal", methodName : "testRound"});
			this.assertDecimalEquals(thx_bigint_Decimals.parse("-1234567890.1234567890").floorTo(5),thx_bigint_Decimals.parse("-1234567890.12345"),{ fileName : "TestDecimal.hx", lineNumber : 203, className : "thx.TestDecimal", methodName : "testRound"});
			this.assertDecimalEquals(thx_bigint_Decimals.parse("-1234567890.1234567890").floorTo(6),thx_bigint_Decimals.parse("-1234567890.123456"),{ fileName : "TestDecimal.hx", lineNumber : 204, className : "thx.TestDecimal", methodName : "testRound"});
		}
	}
	,testScaleTo: function() {
		...
		while(_g1 < _g) {
			...
			while(_g2 < tests.length) {
				...
				utest_Assert.equals(test.exp,dec.scaleTo(test.scale).toString(),"expected " + test.src + " to be " + test.exp + " when scaled to " + test.scale + " but got " + dec.scaleTo(test.scale).toString(),{ fileName : "TestDecimal.hx", lineNumber : 221, className : "thx.TestDecimal", methodName : "testScaleTo"});
				if(test.src == "0") {
					continue;
				}
				dec = thx_bigint_Decimals.parse("-" + test.src);
				utest_Assert.equals("-" + test.exp,dec.scaleTo(test.scale).toString(),"expected -" + test.src + " to be -" + test.exp + " when scaled to " + test.scale + " but got -" + dec.scaleTo(test.scale).toString(),{ fileName : "TestDecimal.hx", lineNumber : 226, className : "thx.TestDecimal", methodName : "testScaleTo"});
			}
		}
	}
	,testNegativePow: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.isTrue(thx__$Decimal_Decimal_$Impl_$.equals(thx__$Decimal_Decimal_$Impl_$.fromInt(10).pow(-2),thx_bigint_Decimals.fromFloat(0.01)),null,{ fileName : "TestDecimal.hx", lineNumber : 232, className : "thx.TestDecimal", methodName : "testNegativePow"});
		}
	}
