...
TS50.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS50.hx", lineNumber : 10, className : "TS50", methodName : "addTests"});
	runner.addCase(new thx_fp_TestSet(Std.parseInt(w)));
};
TS50.main = function() {
...
thx_fp__$List_List_$Impl_$.fromArray = function(arr) {
	...
	},thx_fp__$List_List_$Impl_$.empty());
};
...
thx_fp_TestSet.prototype = {
	...
	,testEmpty: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.isFalse(thx_fp__$Set_Set_$Impl_$.member(set,"some",thx__$Ord_Ord_$Impl_$.fromIntComparison(thx_Strings.compare)),null,{ fileName : "TestSet.hx", lineNumber : 16, className : "thx.fp.TestSet", methodName : "testEmpty"});
			utest_Assert.equals(0,thx_fp__$Set_Set_$Impl_$.size(set),null,{ fileName : "TestSet.hx", lineNumber : 17, className : "thx.fp.TestSet", methodName : "testEmpty"});
		}
	}
	,testSizes: function() {
		var _g1 = 0;
	...
	,testSet: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.isTrue(thx_fp__$Set_Set_$Impl_$.member(m,"X",thx__$Ord_Ord_$Impl_$.fromIntComparison(thx_Strings.compare)),null,{ fileName : "TestSet.hx", lineNumber : 35, className : "thx.fp.TestSet", methodName : "testSet"});
			utest_Assert.isTrue(thx_fp__$Set_Set_$Impl_$.member(m,"Y",thx__$Ord_Ord_$Impl_$.fromIntComparison(thx_Strings.compare)),null,{ fileName : "TestSet.hx", lineNumber : 36, className : "thx.fp.TestSet", methodName : "testSet"});
			utest_Assert.isTrue(thx_fp__$Set_Set_$Impl_$.member(m,"Z",thx__$Ord_Ord_$Impl_$.fromIntComparison(thx_Strings.compare)),null,{ fileName : "TestSet.hx", lineNumber : 37, className : "thx.fp.TestSet", methodName : "testSet"});
			utest_Assert.isFalse(thx_fp__$Set_Set_$Impl_$.member(m,"W",thx__$Ord_Ord_$Impl_$.fromIntComparison(thx_Strings.compare)),null,{ fileName : "TestSet.hx", lineNumber : 38, className : "thx.fp.TestSet", methodName : "testSet"});
			utest_Assert.equals(3,thx_fp__$Set_Set_$Impl_$.size(m),null,{ fileName : "TestSet.hx", lineNumber : 39, className : "thx.fp.TestSet", methodName : "testSet"});
		}
	}
	,testMapList: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(["x","y","z"],thx_Arrays.order(thx_fp__$List_List_$Impl_$.foldLeft(thx_fp__$Set_Set_$Impl_$.mapList(thx_fp__$Set_Set_$Impl_$.insert(thx_fp__$Set_Set_$Impl_$.insert(thx_fp_SetImpl.Bin(1,"Y",thx_fp_SetImpl.Tip,thx_fp_SetImpl.Tip),"X",thx__$Ord_Ord_$Impl_$.fromIntComparison(thx_Strings.compare)),"Z",thx__$Ord_Ord_$Impl_$.fromIntComparison(thx_Strings.compare)),function(v) {
				...
				acc.push(a);
				return acc;
			}),thx_Strings.compare),null,null,null,{ fileName : "TestSet.hx", lineNumber : 47, className : "thx.fp.TestSet", methodName : "testMapList"});
		}
	}
	,testFoldLeft: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.same([1,2,3],thx_Arrays.order(thx_fp__$Set_Set_$Impl_$.foldLeft(thx_fp__$Set_Set_$Impl_$.insert(thx_fp__$Set_Set_$Impl_$.insert(thx_fp_SetImpl.Bin(1,1,thx_fp_SetImpl.Tip,thx_fp_SetImpl.Tip),2,thx__$Ord_Ord_$Impl_$.fromIntComparison(thx_Ints.compare)),3,thx__$Ord_Ord_$Impl_$.fromIntComparison(thx_Ints.compare)),[],function(acc,v) {
				acc.push(v);
				return acc;
			}),thx_Ints.compare),null,null,null,{ fileName : "TestSet.hx", lineNumber : 53, className : "thx.fp.TestSet", methodName : "testFoldLeft"});
		}
	}
	,testToList: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			utest_Assert.same(["X","Y","Z"],thx_Arrays.order(thx_fp__$List_List_$Impl_$.foldLeft(thx_fp__$Set_Set_$Impl_$.toList(thx_fp__$Set_Set_$Impl_$.insert(thx_fp__$Set_Set_$Impl_$.insert(thx_fp_SetImpl.Bin(1,"Y",thx_fp_SetImpl.Tip,thx_fp_SetImpl.Tip),"X",thx__$Ord_Ord_$Impl_$.fromIntComparison(thx_Strings.compare)),"Z",thx__$Ord_Ord_$Impl_$.fromIntComparison(thx_Strings.compare))),[],function(acc,a) {
				acc.push(a);
				return acc;
			}),thx_Strings.compare),null,null,null,{ fileName : "TestSet.hx", lineNumber : 64, className : "thx.fp.TestSet", methodName : "testToList"});
		}
	}
