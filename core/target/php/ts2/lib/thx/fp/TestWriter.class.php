...
class thx_fp_TestWriter {
	...
	public function testMap() {
		...
		utest_Assert::same(_hx_anonymous(array("_0" => "", "_1" => 2)), thx_fp__Writer_Writer_Impl_::run(thx_fp__Writer_Writer_Impl_::_new($tmp)), null, null, null, _hx_anonymous(array("fileName" => "TestWriter.hx", "lineNumber" => 18, "className" => "thx.fp.TestWriter", "methodName" => "testMap")));
	}
	public function testFlatMap() {
		...
		utest_Assert::same($tmp2, thx_fp__Writer_Writer_Impl_::run($tmp3), null, null, null, _hx_anonymous(array("fileName" => "TestWriter.hx", "lineNumber" => 28, "className" => "thx.fp.TestWriter", "methodName" => "testFlatMap")));
	}
