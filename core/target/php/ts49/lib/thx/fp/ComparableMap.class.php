...
class thx_fp_ComparableMap {
	...
	static function merge($a, $b) {
		return thx_fp__Map_Map_Impl_::foldLeftTuples($b, $a, array(new _hx_lambda(array(), "thx_fp_ComparableMap_0"), 'execute'));
	}
	function __toString() { return 'thx.fp.ComparableMap'; }
}
function thx_fp_ComparableMap_0($acc, $t) {
	{
		$tmp = thx__Ord_Ord_Impl_::forComparable();
