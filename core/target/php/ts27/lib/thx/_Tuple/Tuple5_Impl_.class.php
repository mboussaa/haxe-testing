...
class thx__Tuple_Tuple5_Impl_ {
	public function __construct(){}
	static function of($_0, $_1, $_2, $_3, $_4) {
	...
	static function toString($this1) {
		...
		$tmp1 = "Tuple5(" . _hx_string_or_null($tmp) . ",";
	...
	static function arrayToTuple5($v) {
		return _hx_anonymous(array("_0" => $v[0], "_1" => $v[1], "_2" => $v[2], "_3" => $v[3], "_4" => $v[4]));
	}
	function __toString() { return 'thx._Tuple.Tuple5_Impl_'; }
}
