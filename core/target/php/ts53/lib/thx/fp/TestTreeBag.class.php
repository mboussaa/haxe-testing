...
class thx_fp_TestTreeBag {
	...
	public function testMap() {
		...
		while($_g1 < $_g) {
			...
			utest_Assert::same(thx_fp_TestTreeBag::$t0, $tmp, null, null, null, _hx_anonymous(array("fileName" => "TestTreeBag.hx", "lineNumber" => 28, "className" => "thx.fp.TestTreeBag", "methodName" => "testMap")));
			$tmp1 = thx_fp__TreeBag_TreeBag_Impl_::map(thx_fp_TestTreeBag::$t1, array(new _hx_lambda(array(), "thx_fp_TestTreeBag_1"), 'execute'));
			utest_Assert::same(thx_fp_TestTreeBag::$t2, $tmp1, null, null, null, _hx_anonymous(array("fileName" => "TestTreeBag.hx", "lineNumber" => 29, "className" => "thx.fp.TestTreeBag", "methodName" => "testMap")));
			unset($tmp1,$tmp);
		}
	}
	public function testToArray() {
		...
		while($_g1 < $_g) {
			...
			utest_Assert::same((new _hx_array(array(1, 2))), $tmp, null, null, null, _hx_anonymous(array("fileName" => "TestTreeBag.hx", "lineNumber" => 34, "className" => "thx.fp.TestTreeBag", "methodName" => "testToArray")));
			unset($tmp);
		}
	}
	public function testFlatMap() {
		...
		while($_g1 < $_g) {
			...
			utest_Assert::same($tmp, $tmp2, null, null, null, _hx_anonymous(array("fileName" => "TestTreeBag.hx", "lineNumber" => 39, "className" => "thx.fp.TestTreeBag", "methodName" => "testFlatMap")));
			...
			utest_Assert::same($tmp7, $tmp12, null, null, null, _hx_anonymous(array("fileName" => "TestTreeBag.hx", "lineNumber" => 40, "className" => "thx.fp.TestTreeBag", "methodName" => "testFlatMap")));
			unset($xs1,$xs,$tmp8,$tmp7,$tmp3,$tmp2,$tmp12,$tmp1,$tmp,$this2,$this1,$other1,$other);
		}
	}
