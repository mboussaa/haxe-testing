...
class thx_TestInts {
	...
	public function testRange() {
		...
		utest_Assert::same((new _hx_array(array(2, 3, 4, 5, 6))), $range, null, null, null, _hx_anonymous(array("fileName" => "TestInts.hx", "lineNumber" => 16, "className" => "thx.TestInts", "methodName" => "testRange")));
		$range = thx_Ints::range(2, 7, 2);
		utest_Assert::same((new _hx_array(array(2, 4, 6))), $range, null, null, null, _hx_anonymous(array("fileName" => "TestInts.hx", "lineNumber" => 18, "className" => "thx.TestInts", "methodName" => "testRange")));
		$range = thx_Ints::range(2, 7, 3);
		utest_Assert::same((new _hx_array(array(2, 5))), $range, null, null, null, _hx_anonymous(array("fileName" => "TestInts.hx", "lineNumber" => 20, "className" => "thx.TestInts", "methodName" => "testRange")));
		$range = thx_Ints::range(7, 2, -2);
		utest_Assert::same((new _hx_array(array(7, 5, 3))), $range, null, null, null, _hx_anonymous(array("fileName" => "TestInts.hx", "lineNumber" => 23, "className" => "thx.TestInts", "methodName" => "testRange")));
	}
	public function testParse() {
		$tests = (new _hx_array(array(_hx_anonymous(array("e" => -50, "t" => "-50", "b" => 10)), _hx_anonymous(array("e" => 50, "t" => "50", "b" => 10)), _hx_anonymous(array("e" => 1, "t" => "1", "b" => 10)), _hx_anonymous(array("e" => 1, "t" => "+1", "b" => 10)), _hx_anonymous(array("e" => -1, "t" => "-1", "b" => 10)), _hx_anonymous(array("e" => 1, "t" => " 1 ", "b" => 10)), _hx_anonymous(array("e" => 1, "t" => " 1,234", "b" => 10)), _hx_anonymous(array("e" => 15, "t" => " 0xF", "b" => 16)), _hx_anonymous(array("e" => 15, "t" => "17", "b" => 8)), _hx_anonymous(array("e" => 15, "t" => "015", "b" => 10)), _hx_anonymous(array("e" => 15, "t" => "1111", "b" => 2)), _hx_anonymous(array("e" => 15, "t" => "15*3", "b" => 10)), _hx_anonymous(array("e" => 15, "t" => "15e2", "b" => 10)), _hx_anonymous(array("e" => 15, "t" => "15px", "b" => 10)), _hx_anonymous(array("e" => 15, "t" => "12", "b" => 13)), _hx_anonymous(array("e" => -15, "t" => "-0F", "b" => 16)), _hx_anonymous(array("e" => -15, "t" => "-0XF", "b" => 16)), _hx_anonymous(array("e" => -15, "t" => " -17", "b" => 8)), _hx_anonymous(array("e" => -15, "t" => " -15", "b" => 10)), _hx_anonymous(array("e" => -15, "t" => "-1111", "b" => 2)), _hx_anonymous(array("e" => -15, "t" => "-15e1", "b" => 10)), _hx_anonymous(array("e" => -15, "t" => "-12", "b" => 13)), _hx_anonymous(array("e" => 224, "t" => "0e0", "b" => 16)))));
		{
			...
			while($_g < $tests->length) {
				...
				utest_Assert::isTrue($tmp, "Ints.parse should not be able to parse " . _hx_string_or_null($test->t), _hx_anonymous(array("fileName" => "TestInts.hx", "lineNumber" => 55, "className" => "thx.TestInts", "methodName" => "testParse")));
				$tmp1 = $test->e;
				...
				utest_Assert::equals($tmp1, $tmp2, _hx_string_or_null($tmp3) . _hx_string_rec($tmp4, ""), _hx_anonymous(array("fileName" => "TestInts.hx", "lineNumber" => 56, "className" => "thx.TestInts", "methodName" => "testParse")));
	...
	public function testToString() {
		$tests = (new _hx_array(array(_hx_anonymous(array("e" => "1010", "t" => 10, "b" => 2)), _hx_anonymous(array("e" => "12", "t" => 10, "b" => 8)), _hx_anonymous(array("e" => "10", "t" => 10, "b" => 10)), _hx_anonymous(array("e" => "a", "t" => 10, "b" => 16)))));
		{
			...
			while($_g < $tests->length) {
				...
				utest_Assert::equals($test->e, $tmp, null, _hx_anonymous(array("fileName" => "TestInts.hx", "lineNumber" => 69, "className" => "thx.TestInts", "methodName" => "testToString")));
				unset($tmp,$test);
			}
		}
	}
