...
class thx_Arrays {
	...
	static function groupBy_Int_thx__TestArrays_Sample($arr, $resolver) {
	...
	static function groupBy_Int_Array_Int($arr, $resolver) {
		$map = new haxe_ds_IntMap();
		{
			$_g1 = 0;
			$_g = $arr->length;
	...
	static function groupBy_Int_Float($arr, $resolver) {
		$map = new haxe_ds_IntMap();
		{
			$_g1 = 0;
			$_g = $arr->length;
	...
	static function count_Int($arr) {
		$map = new haxe_ds_IntMap();
		$arr->map(array(new _hx_lambda(array(&$map), "thx_Arrays_0"), 'execute'));
		return $map;
	}
	...
	static function monoid() {
		return _hx_anonymous(array("zero" => (new _hx_array(array())), "append" => array(new _hx_lambda(array(), "thx_Arrays_1"), 'execute')));
	}
	...
	static function at($arr, $indexes) {
		return $indexes->map(array(new _hx_lambda(array(&$arr), "thx_Arrays_2"), 'execute'));
	}
	...
	static function compact($arr) {
		return $arr->filter(array(new _hx_lambda(array(), "thx_Arrays_3"), 'execute'));
	}
	...
	static function crossMulti($array) {
		$acopy = $array->copy();
		$result = $acopy->shift()->map(array(new _hx_lambda(array(), "thx_Arrays_4"), 'execute'));
	...
	static function distinct($array, $predicate = null) {
		...
		}
		{
			...
			while(true) {
				...
				$v = $tmp2->next();
				$keep = !thx_Arrays::any($result, array(new _hx_lambda(array(&$predicate, &$v), "thx_Arrays_5"), 'execute'));
				if($keep) {
					$result->push($v);
				}
				unset($v,$tmp3,$keep);
	...
	static function filterOption($a) {
		return thx_Arrays::reduce($a, array(new _hx_lambda(array(), "thx_Arrays_6"), 'execute'), (new _hx_array(array())));
	}
	...
	static function flatten($array) {
		return thx_Arrays::reduce($array, array(new _hx_lambda(array(), "thx_Arrays_7"), 'execute'), (new _hx_array(array())));
	}
	...
	static function intersperse($array, $value) {
		...
		return thx_Arrays::reducei($array, array(new _hx_lambda(array(), "thx_Arrays_8"), 'execute'), $tmp1);
	}
	...
	static function rank($array, $compare, $incrementDuplicates = null) {
		...
		$arr = thx_Arrays::mapi($array, array(new _hx_lambda(array(), "thx_Arrays_9"), 'execute'));
		$arr->sort(array(new _hx_lambda(array(&$compare), "thx_Arrays_10"), 'execute'));
		if($incrementDuplicates) {
			$usedIndexes = thx__Set_Set_Impl_::createInt(null);
			return thx_Arrays::reducei($arr, array(new _hx_lambda(array(&$arr, &$compare, &$usedIndexes), "thx_Arrays_11"), 'execute'), (new _hx_array(array())));
		} else {
			return thx_Arrays::reducei($arr, array(new _hx_lambda(array(&$arr, &$compare), "thx_Arrays_12"), 'execute'), (new _hx_array(array())));
		}
	}
	...
	static function foldMap($array, $f, $m) {
		...
		$_e = $m;
		$tmp = array(new _hx_lambda(array(&$_e), "thx_Arrays_13"), 'execute');
	...
	static function foldS($array, $s) {
		...
		return thx_Options::map($tmp, array(new _hx_lambda(array(&$s), "thx_Arrays_14"), 'execute'));
	}
	...
	static function traverseOption($arr, $f) {
		...
		return thx_Arrays::reduce($arr, array(new _hx_lambda(array(&$f), "thx_Arrays_15"), 'execute'), $tmp);
	}
	static function traverseValidation($arr, $f, $s) {
		return thx_Arrays::reduce($arr, array(new _hx_lambda(array(&$f, &$s), "thx_Arrays_16"), 'execute'), thx_Either::Right((new _hx_array(array()))));
	}
	static function traverseValidationIndexed($arr, $f, $s) {
		return thx_Arrays::reducei($arr, array(new _hx_lambda(array(&$f, &$s), "thx_Arrays_17"), 'execute'), thx_Either::Right((new _hx_array(array()))));
	}
	...
	static function unzip($array) {
		...
		$array->map(array(new _hx_lambda(array(&$a1, &$a2), "thx_Arrays_18"), 'execute'));
	...
	static function unzip3($array) {
		...
		$array->map(array(new _hx_lambda(array(&$a1, &$a2, &$a3), "thx_Arrays_19"), 'execute'));
	...
	static function unzip4($array) {
		...
		$array->map(array(new _hx_lambda(array(&$a1, &$a2, &$a3, &$a4), "thx_Arrays_20"), 'execute'));
	...
	static function unzip5($array) {
		...
		$array->map(array(new _hx_lambda(array(&$a1, &$a2, &$a3, &$a4, &$a5), "thx_Arrays_21"), 'execute'));
	...
	static function zip5Ap($f, $ax, $bx, $cx, $dx, $ex) {
		$f1 = $f;
		$tmp = array(new _hx_lambda(array(&$f1), "thx_Arrays_24"), 'execute');
	...
	static function minBy($arr, $ord) {
		...
		if($tmp) {
			...
			$_e = $ord;
			$tmp1 = array(new _hx_lambda(array(&$_e), "thx_Arrays_26"), 'execute');
			$tmp2 = thx_Arrays::reduce($arr, $tmp1, $arr[0]);
			return haxe_ds_Option::Some($tmp2);
		}
	}
...
function thx_Arrays_1($a, $b) {
	{
		return $a->concat($b);
	}
}
function thx_Arrays_2(&$arr, $i) {
	{
		return $arr[$i];
	}
}
...
function thx_Arrays_4($v) {
	{
		return (new _hx_array(array($v)));
	}
}
function thx_Arrays_5(&$predicate, &$v, $r) {
	{
		return call_user_func_array($predicate, array($r, $v));
	}
}
function thx_Arrays_6($acc, $maybeV) {
	{
		$tmp = $maybeV->index;
		switch($tmp) {
		case 0:{
...
function thx_Arrays_7($acc, $element) {
	{
		return $acc->concat($element);
	}
}
function thx_Arrays_8($acc, $v, $i) {
	{
		$acc[$i * 2] = $v;
		return $acc;
	}
}
function thx_Arrays_9($v, $i) {
	{
		return _hx_anonymous(array("_0" => $v, "_1" => $i));
	}
}
function thx_Arrays_10(&$compare, $a, $b) {
	{
		return call_user_func_array($compare, array($a->_0, $b->_0));
	}
}
function thx_Arrays_11(&$arr, &$compare, &$usedIndexes, $acc, $x, $i1) {
	{
		$index = null;
		$tmp = null;
		if($i1 > 0) {
...
function thx_Arrays_12(&$arr, &$compare, $acc1, $x1, $i2) {
	{
		$tmp3 = $x1->_1;
		$tmp4 = null;
		$tmp5 = null;
...
function thx_Arrays_13(&$_e, $a0, $a1) {
	{
		return thx__Monoid_Monoid_Impl_::append($_e, $a0, $a1);
	}
}
function thx_Arrays_14(&$s, $x) {
	{
		return thx__Nel_Nel_Impl_::fold($x, $s);
	}
}
function thx_Arrays_15(&$f, $acc, $t) {
	{
		$tmp1 = call_user_func_array($f, array($t));
		$tmp2 = thx_Options::map($acc, array(new _hx_lambda(array(), "thx_Arrays_27"), 'execute'));
		return thx_Options::ap($tmp1, $tmp2);
	}
}
function thx_Arrays_16(&$f, &$s, $acc, $t) {
	{
		$tmp = call_user_func_array($f, array($t));
		$tmp1 = thx_Either::Right(array(new _hx_lambda(array(), "thx_Arrays_28"), 'execute'));
		$tmp2 = thx__Validation_Validation_Impl_::ap($acc, $tmp1, array(new _hx_lambda(array(), "thx_Arrays_29"), 'execute'));
		return thx__Validation_Validation_Impl_::ap($tmp, $tmp2, $s);
	}
}
function thx_Arrays_17(&$f, &$s, $acc, $t, $i) {
	{
		$tmp = call_user_func_array($f, array($t, $i));
		$tmp1 = thx_Either::Right(array(new _hx_lambda(array(), "thx_Arrays_30"), 'execute'));
		$tmp2 = thx__Validation_Validation_Impl_::ap($acc, $tmp1, array(new _hx_lambda(array(), "thx_Arrays_31"), 'execute'));
		return thx__Validation_Validation_Impl_::ap($tmp, $tmp2, $s);
	}
}
function thx_Arrays_18(&$a1, &$a2, $t) {
	{
		$a1->push($t->_0);
		$a2->push($t->_1);
	}
}
function thx_Arrays_19(&$a1, &$a2, &$a3, $t) {
	{
		$a1->push($t->_0);
		$a2->push($t->_1);
		$a3->push($t->_2);
...
function thx_Arrays_20(&$a1, &$a2, &$a3, &$a4, $t) {
	{
		$a1->push($t->_0);
		$a2->push($t->_1);
		$a3->push($t->_2);
...
function thx_Arrays_21(&$a1, &$a2, &$a3, &$a4, &$a5, $t) {
	{
		$a1->push($t->_0);
		$a2->push($t->_1);
		$a3->push($t->_2);
...
function thx_Arrays_22(&$f1, $a, $b) {
	{
		return array(new _hx_lambda(array(&$a, &$b, &$f1), "thx_Arrays_32"), 'execute');
	}
}
function thx_Arrays_23(&$f1, $a, $b, $c) {
	{
		return array(new _hx_lambda(array(&$a, &$b, &$c, &$f1), "thx_Arrays_33"), 'execute');
	}
}
function thx_Arrays_24(&$f1, $a, $b, $c, $d) {
	{
		return array(new _hx_lambda(array(&$a, &$b, &$c, &$d, &$f1), "thx_Arrays_34"), 'execute');
	}
}
...
function thx_Arrays_26(&$_e, $a0, $a1) {
	{
...
function thx_Arrays_28($ux) {
	{
		return array(new _hx_lambda(array(&$ux), "thx_Arrays_36"), 'execute');
	}
}
function thx_Arrays_29($e1, $e2) {
	{
		throw new HException("Unreachable");
	}
}
function thx_Arrays_30($ux) {
	{
		return array(new _hx_lambda(array(&$ux), "thx_Arrays_37"), 'execute');
	}
}
function thx_Arrays_31($e1, $e2) {
	{
		throw new HException("Unreachable");
	}
}
function thx_Arrays_32(&$a, &$b, &$f1, $c) {
	{
		return call_user_func_array($f1, array($a, $b, $c));
	}
}
function thx_Arrays_33(&$a, &$b, &$c, &$f1, $d) {
	{
		return call_user_func_array($f1, array($a, $b, $c, $d));
	}
}
function thx_Arrays_34(&$a, &$b, &$c, &$d, &$f1, $e) {
	{
