...
class thx_TestBigInt {
	...
	public function testIssue82() {
		...
		$tmp8 = $r->toString();
		utest_Assert::isTrue($tmp3, _hx_string_or_null($tmp7) . _hx_string_or_null($tmp8), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 15, "className" => "thx.TestBigInt", "methodName" => "testIssue82")));
		...
		$tmp15 = $r1->toString();
		utest_Assert::isTrue($tmp10, _hx_string_or_null($tmp14) . _hx_string_or_null($tmp15), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 21, "className" => "thx.TestBigInt", "methodName" => "testIssue82")));
	}
	public function testFromInt64() {
		...
		$values = (new _hx_array(array($tmp, $tmp1, $tmp2, $x2, thx_Int64s::$maxValue)));
		{
			...
			while($_g < $values->length) {
				...
				utest_Assert::isTrue($tmp3, _hx_string_or_null($tmp7) . _hx_string_or_null($tmp8), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 29, "className" => "thx.TestBigInt", "methodName" => "testFromInt64")));
	...
	public function testLcmAndGcd() {
		...
		utest_Assert::isTrue($tmp2, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 34, "className" => "thx.TestBigInt", "methodName" => "testLcmAndGcd")));
		...
		utest_Assert::isTrue($tmp5, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 35, "className" => "thx.TestBigInt", "methodName" => "testLcmAndGcd")));
		...
		utest_Assert::isTrue($tmp8, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 36, "className" => "thx.TestBigInt", "methodName" => "testLcmAndGcd")));
		...
		utest_Assert::isTrue($tmp11, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 37, "className" => "thx.TestBigInt", "methodName" => "testLcmAndGcd")));
		...
		utest_Assert::isTrue($tmp14, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 38, "className" => "thx.TestBigInt", "methodName" => "testLcmAndGcd")));
	}
	public function testIncrements() {
		$tmp = thx__BigInt_BigInt_Impl_::$zero->isZero();
		utest_Assert::isTrue($tmp, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 42, "className" => "thx.TestBigInt", "methodName" => "testIncrements")));
		...
		utest_Assert::isTrue($tmp1, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 48, "className" => "thx.TestBigInt", "methodName" => "testIncrements")));
		$tmp2 = thx__BigInt_BigInt_Impl_::equals($b, thx_bigint_Bigs::fromInt(1));
		utest_Assert::isTrue($tmp2, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 49, "className" => "thx.TestBigInt", "methodName" => "testIncrements")));
		$tmp3 = thx__BigInt_BigInt_Impl_::equals($c, thx_bigint_Bigs::fromInt(1));
		utest_Assert::isTrue($tmp3, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 50, "className" => "thx.TestBigInt", "methodName" => "testIncrements")));
		$tmp4 = thx__BigInt_BigInt_Impl_::equals($d, thx_bigint_Bigs::fromInt(1));
		utest_Assert::isTrue($tmp4, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 51, "className" => "thx.TestBigInt", "methodName" => "testIncrements")));
		$tmp5 = thx__BigInt_BigInt_Impl_::equals($e, thx_bigint_Bigs::fromInt(1));
		utest_Assert::isTrue($tmp5, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 52, "className" => "thx.TestBigInt", "methodName" => "testIncrements")));
		$tmp6 = thx__BigInt_BigInt_Impl_::equals($a, thx_bigint_Bigs::fromInt(0));
		utest_Assert::isTrue($tmp6, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 53, "className" => "thx.TestBigInt", "methodName" => "testIncrements")));
	}
	public function testCanHandleLargeNumbers() {
		...
		utest_Assert::isTrue($tmp3, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 67, "className" => "thx.TestBigInt", "methodName" => "testCanHandleLargeNumbers")));
		...
		utest_Assert::isTrue($tmp5, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 68, "className" => "thx.TestBigInt", "methodName" => "testCanHandleLargeNumbers")));
		...
		$tmp11 = $pow->toString();
		utest_Assert::isTrue($tmp6, _hx_string_or_null($tmp10) . _hx_string_or_null($tmp11), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 73, "className" => "thx.TestBigInt", "methodName" => "testCanHandleLargeNumbers")));
	}
	public function testIsImmutable() {
		...
		utest_Assert::isTrue($tmp, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 83, "className" => "thx.TestBigInt", "methodName" => "testIsImmutable")));
		{
			$that1 = thx_bigint_Bigs::fromInt(123456);
			$n->subtract($that1);
		}
		$tmp1 = thx__BigInt_BigInt_Impl_::equals($n, thx_bigint_Bigs::fromInt(14930352));
		utest_Assert::isTrue($tmp1, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 85, "className" => "thx.TestBigInt", "methodName" => "testIsImmutable")));
	}
	public function testInts() {
		$tests = (new _hx_array(array(1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 10000, 100000, 1000000, 10000000)));
		{
			...
			while($_g < $tests->length) {
				...
				$tmp2 = $out->toInt();
				utest_Assert::equals($test, $tmp, _hx_string_or_null($tmp1) . _hx_string_rec($tmp2, ""), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 96, "className" => "thx.TestBigInt", "methodName" => "testInts")));
				$out1 = thx_bigint_Bigs::fromInt(-$test);
				$tmp3 = $out1->toInt();
				$tmp4 = "expected " . _hx_string_rec(-$test, "") . " but got ";
				$tmp5 = $out1->toInt();
				utest_Assert::equals(-$test, $tmp3, _hx_string_or_null($tmp4) . _hx_string_rec($tmp5, ""), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 99, "className" => "thx.TestBigInt", "methodName" => "testInts")));
	...
	public function testFloats() {
		$tests = (new _hx_array(array(0.0, 1.0, 5.0, 1.2e20, 1.2e40, 1.234e63, 5.432e80, 0.00001, 1.2345e-50)));
		{
			...
			while($_g < $tests->length) {
				...
				$tmp4 = $out->toFloat();
				utest_Assert::floatEquals($tmp, $tmp1, null, _hx_string_or_null($tmp3) . _hx_string_rec($tmp4, ""), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 108, "className" => "thx.TestBigInt", "methodName" => "testFloats")));
				...
				$tmp9 = $out1->toFloat();
				utest_Assert::floatEquals($tmp5, $tmp6, null, _hx_string_or_null($tmp8) . _hx_string_rec($tmp9, ""), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 111, "className" => "thx.TestBigInt", "methodName" => "testFloats")));
	...
	public function testStrings() {
		$tests = (new _hx_array(array("0", "3", "20", "12345678901234567890", "999999999999999999")));
		{
			...
			while($_g < $tests->length) {
				...
				$tmp2 = $out->toString();
				utest_Assert::equals($test, $tmp, _hx_string_or_null($tmp1) . _hx_string_or_null($tmp2), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 123, "className" => "thx.TestBigInt", "methodName" => "testStrings")));
				if($test === "0") {
					continue;
				}
				...
				$tmp6 = $out1->toString();
				utest_Assert::equals($tmp3, $tmp4, _hx_string_or_null($tmp5) . _hx_string_or_null($tmp6), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 129, "className" => "thx.TestBigInt", "methodName" => "testStrings")));
	...
	public function testEquals() {
		...
		utest_Assert::isTrue($tmp1, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 134, "className" => "thx.TestBigInt", "methodName" => "testEquals")));
		$tmp2 = thx_bigint_Bigs::fromInt(1);
		$tmp3 = thx__BigInt_BigInt_Impl_::equals($tmp2, thx_bigint_Bigs::fromInt(1));
		utest_Assert::isTrue($tmp3, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 135, "className" => "thx.TestBigInt", "methodName" => "testEquals")));
		...
		utest_Assert::isTrue($tmp5, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 136, "className" => "thx.TestBigInt", "methodName" => "testEquals")));
		$tmp6 = thx_bigint_Bigs::fromInt(-1);
		$tmp7 = thx__BigInt_BigInt_Impl_::equals($tmp6, thx_bigint_Bigs::fromInt(-1));
		utest_Assert::isTrue($tmp7, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 137, "className" => "thx.TestBigInt", "methodName" => "testEquals")));
		...
		utest_Assert::isTrue($tmp9, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 138, "className" => "thx.TestBigInt", "methodName" => "testEquals")));
		$tmp10 = thx_bigint_Bigs::fromInt(0);
		$tmp11 = thx__BigInt_BigInt_Impl_::notEquals($tmp10, thx_bigint_Bigs::fromInt(0));
		utest_Assert::isFalse($tmp11, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 140, "className" => "thx.TestBigInt", "methodName" => "testEquals")));
		$tmp12 = thx_bigint_Bigs::fromInt(1);
		$tmp13 = thx__BigInt_BigInt_Impl_::notEquals($tmp12, thx_bigint_Bigs::fromInt(1));
		utest_Assert::isFalse($tmp13, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 141, "className" => "thx.TestBigInt", "methodName" => "testEquals")));
		...
		utest_Assert::isFalse($tmp15, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 142, "className" => "thx.TestBigInt", "methodName" => "testEquals")));
		$tmp16 = thx_bigint_Bigs::fromInt(-1);
		$tmp17 = thx__BigInt_BigInt_Impl_::notEquals($tmp16, thx_bigint_Bigs::fromInt(-1));
		utest_Assert::isFalse($tmp17, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 143, "className" => "thx.TestBigInt", "methodName" => "testEquals")));
		...
		utest_Assert::isFalse($tmp19, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 144, "className" => "thx.TestBigInt", "methodName" => "testEquals")));
		...
		utest_Assert::isTrue($tmp21, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 145, "className" => "thx.TestBigInt", "methodName" => "testEquals")));
		$tmp22 = thx_bigint_Bigs::fromInt(0);
		$tmp23 = thx__BigInt_BigInt_Impl_::notEquals($tmp22, thx_bigint_Bigs::fromInt(1));
		utest_Assert::isTrue($tmp23, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 147, "className" => "thx.TestBigInt", "methodName" => "testEquals")));
		$tmp24 = thx_bigint_Bigs::fromInt(1);
		$tmp25 = thx__BigInt_BigInt_Impl_::notEquals($tmp24, thx_bigint_Bigs::fromInt(2));
		utest_Assert::isTrue($tmp25, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 148, "className" => "thx.TestBigInt", "methodName" => "testEquals")));
		...
		utest_Assert::isTrue($tmp27, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 149, "className" => "thx.TestBigInt", "methodName" => "testEquals")));
		$tmp28 = thx_bigint_Bigs::fromInt(-1);
		$tmp29 = thx__BigInt_BigInt_Impl_::notEquals($tmp28, thx_bigint_Bigs::fromInt(-2));
		utest_Assert::isTrue($tmp29, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 150, "className" => "thx.TestBigInt", "methodName" => "testEquals")));
		...
		utest_Assert::isTrue($tmp31, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 151, "className" => "thx.TestBigInt", "methodName" => "testEquals")));
		$tmp32 = thx_bigint_Bigs::fromInt(0);
		$tmp33 = thx__BigInt_BigInt_Impl_::equals($tmp32, thx_bigint_Bigs::fromInt(1));
		utest_Assert::isFalse($tmp33, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 153, "className" => "thx.TestBigInt", "methodName" => "testEquals")));
		$tmp34 = thx_bigint_Bigs::fromInt(1);
		$tmp35 = thx__BigInt_BigInt_Impl_::equals($tmp34, thx_bigint_Bigs::fromInt(2));
		utest_Assert::isFalse($tmp35, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 154, "className" => "thx.TestBigInt", "methodName" => "testEquals")));
		...
		utest_Assert::isFalse($tmp37, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 155, "className" => "thx.TestBigInt", "methodName" => "testEquals")));
		$tmp38 = thx_bigint_Bigs::fromInt(-1);
		$tmp39 = thx__BigInt_BigInt_Impl_::equals($tmp38, thx_bigint_Bigs::fromInt(-2));
		utest_Assert::isFalse($tmp39, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 156, "className" => "thx.TestBigInt", "methodName" => "testEquals")));
		$tmp40 = thx_bigint_Bigs::fromInt(2);
		$tmp41 = thx__BigInt_BigInt_Impl_::notEquals($tmp40, thx_bigint_Bigs::fromInt(-2));
		utest_Assert::isTrue($tmp41, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 157, "className" => "thx.TestBigInt", "methodName" => "testEquals")));
		$tmp42 = thx_bigint_Bigs::fromInt(2);
		$tmp43 = thx__BigInt_BigInt_Impl_::equals($tmp42, thx_bigint_Bigs::fromInt(-2));
		utest_Assert::isFalse($tmp43, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 158, "className" => "thx.TestBigInt", "methodName" => "testEquals")));
		...
		utest_Assert::isFalse($tmp45, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 159, "className" => "thx.TestBigInt", "methodName" => "testEquals")));
		$tmp46 = thx_bigint_Bigs::fromInt(0);
		$tmp47 = thx__BigInt_BigInt_Impl_::equals($tmp46, thx_bigint_Bigs::parseBase("-0", 10));
		utest_Assert::isTrue($tmp47, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 161, "className" => "thx.TestBigInt", "methodName" => "testEquals")));
	}
	public function testIgnoreLeadingZeros() {
		...
		utest_Assert::isTrue($tmp1, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 165, "className" => "thx.TestBigInt", "methodName" => "testIgnoreLeadingZeros")));
		$tmp2 = thx_bigint_Bigs::parseBase("000000000000023", 10);
		$tmp3 = thx__BigInt_BigInt_Impl_::equals($tmp2, thx_bigint_Bigs::fromInt(23));
		utest_Assert::isTrue($tmp3, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 166, "className" => "thx.TestBigInt", "methodName" => "testIgnoreLeadingZeros")));
		...
		$tmp8 = $this2->toString();
		utest_Assert::isTrue($tmp5, _hx_string_or_null($tmp7) . _hx_string_or_null($tmp8) . " to be true", _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 167, "className" => "thx.TestBigInt", "methodName" => "testIgnoreLeadingZeros")));
	}
	public function testNumbersShouldBeTheSameWhenConstructedDifferently() {
		...
		$tmp4 = $this2->toString();
		utest_Assert::isTrue($tmp1, _hx_string_or_null($tmp3) . _hx_string_or_null($tmp4) . " to be true", _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 171, "className" => "thx.TestBigInt", "methodName" => "testNumbersShouldBeTheSameWhenConstructedDifferently")));
		...
		$tmp9 = $this4->toString();
		utest_Assert::isTrue($tmp6, _hx_string_or_null($tmp8) . _hx_string_or_null($tmp9) . " to be true", _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 172, "className" => "thx.TestBigInt", "methodName" => "testNumbersShouldBeTheSameWhenConstructedDifferently")));
		...
		utest_Assert::isTrue($tmp11, _hx_string_or_null($tmp13) . _hx_string_or_null($tmp14) . " to be true", _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 173, "className" => "thx.TestBigInt", "methodName" => "testNumbersShouldBeTheSameWhenConstructedDifferently")));
		...
		utest_Assert::isTrue($tmp16, _hx_string_or_null($tmp18) . _hx_string_or_null($tmp19) . " to be true", _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 174, "className" => "thx.TestBigInt", "methodName" => "testNumbersShouldBeTheSameWhenConstructedDifferently")));
		...
		utest_Assert::isTrue($tmp21, _hx_string_or_null($tmp23) . _hx_string_or_null($tmp24) . " to be true", _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 175, "className" => "thx.TestBigInt", "methodName" => "testNumbersShouldBeTheSameWhenConstructedDifferently")));
	}
	public function testFibonacci() {
		...
		$last = thx_bigint_Bigs::fromInt(1);
		{
			...
			while($_g < 50) {
				...
				utest_Assert::isTrue($tmp49, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 186, "className" => "thx.TestBigInt", "methodName" => "testFibonacci")));
				unset($tmp49,$i);
			}
		}
	}
	public function testCarriesOverCorrectly() {
		...
		utest_Assert::isTrue($tmp1, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 191, "className" => "thx.TestBigInt", "methodName" => "testCarriesOverCorrectly")));
		...
		utest_Assert::isTrue($tmp3, _hx_string_or_null($tmp9) . _hx_string_or_null($tmp10), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 192, "className" => "thx.TestBigInt", "methodName" => "testCarriesOverCorrectly")));
		...
		utest_Assert::isTrue($tmp12, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 195, "className" => "thx.TestBigInt", "methodName" => "testCarriesOverCorrectly")));
		...
		utest_Assert::isTrue($tmp14, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 196, "className" => "thx.TestBigInt", "methodName" => "testCarriesOverCorrectly")));
		...
		utest_Assert::isTrue($tmp16, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 197, "className" => "thx.TestBigInt", "methodName" => "testCarriesOverCorrectly")));
		...
		utest_Assert::isTrue($tmp18, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 199, "className" => "thx.TestBigInt", "methodName" => "testCarriesOverCorrectly")));
	}
	public function testMisc() {
		...
		utest_Assert::isTrue($tmp1, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 203, "className" => "thx.TestBigInt", "methodName" => "testMisc")));
		...
		utest_Assert::isTrue($tmp3, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 204, "className" => "thx.TestBigInt", "methodName" => "testMisc")));
		...
		utest_Assert::isTrue($tmp5, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 205, "className" => "thx.TestBigInt", "methodName" => "testMisc")));
		...
		utest_Assert::isTrue($tmp7, _hx_string_or_null($tmp13) . _hx_string_or_null($tmp14), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 206, "className" => "thx.TestBigInt", "methodName" => "testMisc")));
		...
		utest_Assert::isTrue($tmp16, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 207, "className" => "thx.TestBigInt", "methodName" => "testMisc")));
		...
		utest_Assert::isTrue($tmp18, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 208, "className" => "thx.TestBigInt", "methodName" => "testMisc")));
		...
		utest_Assert::isTrue($tmp20, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 209, "className" => "thx.TestBigInt", "methodName" => "testMisc")));
		...
		utest_Assert::isTrue($tmp22, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 210, "className" => "thx.TestBigInt", "methodName" => "testMisc")));
		...
		utest_Assert::isTrue($tmp24, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 211, "className" => "thx.TestBigInt", "methodName" => "testMisc")));
		...
		utest_Assert::isTrue($tmp26, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 212, "className" => "thx.TestBigInt", "methodName" => "testMisc")));
		...
		utest_Assert::isTrue($tmp28, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 213, "className" => "thx.TestBigInt", "methodName" => "testMisc")));
	}
	public function testMultiplyHandlesSignsCorectly() {
		...
		utest_Assert::isTrue($tmp1, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 217, "className" => "thx.TestBigInt", "methodName" => "testMultiplyHandlesSignsCorectly")));
		...
		utest_Assert::isTrue($tmp3, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 218, "className" => "thx.TestBigInt", "methodName" => "testMultiplyHandlesSignsCorectly")));
		...
		utest_Assert::isTrue($tmp5, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 219, "className" => "thx.TestBigInt", "methodName" => "testMultiplyHandlesSignsCorectly")));
		...
		utest_Assert::isTrue($tmp7, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 220, "className" => "thx.TestBigInt", "methodName" => "testMultiplyHandlesSignsCorectly")));
		...
		utest_Assert::isTrue($tmp9, _hx_string_or_null($tmp15) . _hx_string_or_null($tmp16), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 222, "className" => "thx.TestBigInt", "methodName" => "testMultiplyHandlesSignsCorectly")));
		...
		utest_Assert::isTrue($tmp18, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 227, "className" => "thx.TestBigInt", "methodName" => "testMultiplyHandlesSignsCorectly")));
		...
		utest_Assert::isTrue($tmp20, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 228, "className" => "thx.TestBigInt", "methodName" => "testMultiplyHandlesSignsCorectly")));
		...
		utest_Assert::isTrue($tmp22, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 229, "className" => "thx.TestBigInt", "methodName" => "testMultiplyHandlesSignsCorectly")));
		...
		utest_Assert::isTrue($tmp24, _hx_string_or_null($tmp28) . _hx_string_or_null($tmp29), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 230, "className" => "thx.TestBigInt", "methodName" => "testMultiplyHandlesSignsCorectly")));
		...
		utest_Assert::isTrue($tmp31, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 234, "className" => "thx.TestBigInt", "methodName" => "testMultiplyHandlesSignsCorectly")));
		...
		utest_Assert::isTrue($tmp33, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 235, "className" => "thx.TestBigInt", "methodName" => "testMultiplyHandlesSignsCorectly")));
		...
		utest_Assert::isTrue($tmp35, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 236, "className" => "thx.TestBigInt", "methodName" => "testMultiplyHandlesSignsCorectly")));
		...
		utest_Assert::isTrue($tmp37, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 237, "className" => "thx.TestBigInt", "methodName" => "testMultiplyHandlesSignsCorectly")));
		...
		utest_Assert::isTrue($tmp39, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 238, "className" => "thx.TestBigInt", "methodName" => "testMultiplyHandlesSignsCorectly")));
		...
		utest_Assert::isTrue($tmp41, _hx_string_or_null($tmp47) . _hx_string_or_null($tmp48), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 239, "className" => "thx.TestBigInt", "methodName" => "testMultiplyHandlesSignsCorectly")));
		...
		utest_Assert::isTrue($tmp50, _hx_string_or_null($tmp56) . _hx_string_or_null($tmp57), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 240, "className" => "thx.TestBigInt", "methodName" => "testMultiplyHandlesSignsCorectly")));
		...
		utest_Assert::isTrue($tmp59, _hx_string_or_null($tmp65) . _hx_string_or_null($tmp66), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 241, "className" => "thx.TestBigInt", "methodName" => "testMultiplyHandlesSignsCorectly")));
	}
	public function testDivisionBy1IsTheIdentity() {
		...
		utest_Assert::isTrue($tmp1, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 245, "className" => "thx.TestBigInt", "methodName" => "testDivisionBy1IsTheIdentity")));
		$this2 = thx_bigint_Bigs::fromInt(-1);
		$that1 = thx_bigint_Bigs::fromInt(1);
		$tmp2 = $this2->divide($that1);
		$tmp3 = thx__BigInt_BigInt_Impl_::equals($tmp2, thx_bigint_Bigs::fromInt(-1));
		utest_Assert::isTrue($tmp3, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 246, "className" => "thx.TestBigInt", "methodName" => "testDivisionBy1IsTheIdentity")));
		...
		utest_Assert::isTrue($tmp5, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 247, "className" => "thx.TestBigInt", "methodName" => "testDivisionBy1IsTheIdentity")));
		...
		utest_Assert::isTrue($tmp7, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 248, "className" => "thx.TestBigInt", "methodName" => "testDivisionBy1IsTheIdentity")));
		...
		utest_Assert::isTrue($tmp9, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 249, "className" => "thx.TestBigInt", "methodName" => "testDivisionBy1IsTheIdentity")));
		...
		utest_Assert::isTrue($tmp11, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 250, "className" => "thx.TestBigInt", "methodName" => "testDivisionBy1IsTheIdentity")));
		...
		utest_Assert::isTrue($tmp13, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 251, "className" => "thx.TestBigInt", "methodName" => "testDivisionBy1IsTheIdentity")));
	}
	public function testDivisionBySelfIs1() {
		...
		$tmp = $this1->divide($that);
		$tmp1 = thx__BigInt_BigInt_Impl_::equals($tmp, thx_bigint_Bigs::fromInt(1));
		utest_Assert::isTrue($tmp1, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 255, "className" => "thx.TestBigInt", "methodName" => "testDivisionBySelfIs1")));
		$this2 = thx_bigint_Bigs::fromInt(-5);
		$that1 = thx_bigint_Bigs::fromInt(-5);
		$tmp2 = $this2->divide($that1);
		$tmp3 = thx__BigInt_BigInt_Impl_::equals($tmp2, thx_bigint_Bigs::fromInt(1));
		utest_Assert::isTrue($tmp3, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 256, "className" => "thx.TestBigInt", "methodName" => "testDivisionBySelfIs1")));
		$this3 = thx_bigint_Bigs::parseBase("20194965098495006574", 10);
		$that2 = thx_bigint_Bigs::parseBase("20194965098495006574", 10);
		$tmp4 = $this3->divide($that2);
		$tmp5 = thx__BigInt_BigInt_Impl_::equals($tmp4, thx_bigint_Bigs::fromInt(1));
		utest_Assert::isTrue($tmp5, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 257, "className" => "thx.TestBigInt", "methodName" => "testDivisionBySelfIs1")));
		$this4 = thx_bigint_Bigs::parseBase("-20194965098495006574", 10);
		$that3 = thx_bigint_Bigs::parseBase("-20194965098495006574", 10);
		$tmp6 = $this4->divide($that3);
		$tmp7 = thx__BigInt_BigInt_Impl_::equals($tmp6, thx_bigint_Bigs::fromInt(1));
		utest_Assert::isTrue($tmp7, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 258, "className" => "thx.TestBigInt", "methodName" => "testDivisionBySelfIs1")));
	}
	public function testDivisionOf0Equals0() {
		...
		$tmp = $this1->divide($that);
		$tmp1 = thx__BigInt_BigInt_Impl_::equals($tmp, thx_bigint_Bigs::fromInt(0));
		utest_Assert::isTrue($tmp1, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 262, "className" => "thx.TestBigInt", "methodName" => "testDivisionOf0Equals0")));
		$this2 = thx_bigint_Bigs::fromInt(0);
		$that1 = thx_bigint_Bigs::fromInt(1);
		$tmp2 = $this2->divide($that1);
		$tmp3 = thx__BigInt_BigInt_Impl_::equals($tmp2, thx_bigint_Bigs::fromInt(0));
		utest_Assert::isTrue($tmp3, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 263, "className" => "thx.TestBigInt", "methodName" => "testDivisionOf0Equals0")));
		...
		utest_Assert::isTrue($tmp5, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 264, "className" => "thx.TestBigInt", "methodName" => "testDivisionOf0Equals0")));
		...
		utest_Assert::isTrue($tmp7, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 265, "className" => "thx.TestBigInt", "methodName" => "testDivisionOf0Equals0")));
	}
	public function testModulo0ThrowsError() {
		utest_Assert::raises(array(new _hx_lambda(array(), "thx_TestBigInt_1"), 'execute'), _hx_qtype("thx.Error"), null, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 269, "className" => "thx.TestBigInt", "methodName" => "testModulo0ThrowsError")));
		utest_Assert::raises(array(new _hx_lambda(array(), "thx_TestBigInt_2"), 'execute'), _hx_qtype("thx.Error"), null, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 270, "className" => "thx.TestBigInt", "methodName" => "testModulo0ThrowsError")));
		utest_Assert::raises(array(new _hx_lambda(array(), "thx_TestBigInt_3"), 'execute'), _hx_qtype("thx.Error"), null, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 271, "className" => "thx.TestBigInt", "methodName" => "testModulo0ThrowsError")));
		utest_Assert::raises(array(new _hx_lambda(array(), "thx_TestBigInt_4"), 'execute'), _hx_qtype("thx.Error"), null, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 272, "className" => "thx.TestBigInt", "methodName" => "testModulo0ThrowsError")));
		utest_Assert::raises(array(new _hx_lambda(array(), "thx_TestBigInt_5"), 'execute'), _hx_qtype("thx.Error"), null, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 273, "className" => "thx.TestBigInt", "methodName" => "testModulo0ThrowsError")));
		utest_Assert::raises(array(new _hx_lambda(array(), "thx_TestBigInt_6"), 'execute'), _hx_qtype("thx.Error"), null, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 274, "className" => "thx.TestBigInt", "methodName" => "testModulo0ThrowsError")));
	}
	public function testModuloHandlesSignsCorrectly() {
		...
		$tmp1 = thx__BigInt_BigInt_Impl_::equals($tmp, thx_bigint_Bigs::fromInt(1));
		utest_Assert::isTrue($tmp1, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 278, "className" => "thx.TestBigInt", "methodName" => "testModuloHandlesSignsCorrectly")));
		$this2 = thx_bigint_Bigs::fromInt(124234233);
		$that1 = thx_bigint_Bigs::fromInt(-2);
		$tmp2 = $this2->modulo($that1);
		$tmp3 = thx__BigInt_BigInt_Impl_::equals($tmp2, thx_bigint_Bigs::fromInt(1));
		utest_Assert::isTrue($tmp3, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 279, "className" => "thx.TestBigInt", "methodName" => "testModuloHandlesSignsCorrectly")));
		$this3 = thx_bigint_Bigs::fromInt(-124234233);
		$that2 = thx_bigint_Bigs::fromInt(2);
		$tmp4 = $this3->modulo($that2);
		$tmp5 = thx__BigInt_BigInt_Impl_::equals($tmp4, thx_bigint_Bigs::fromInt(-1));
		utest_Assert::isTrue($tmp5, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 280, "className" => "thx.TestBigInt", "methodName" => "testModuloHandlesSignsCorrectly")));
		$this4 = thx_bigint_Bigs::fromInt(-124234233);
		$that3 = thx_bigint_Bigs::fromInt(-2);
		$tmp6 = $this4->modulo($that3);
		$tmp7 = thx__BigInt_BigInt_Impl_::equals($tmp6, thx_bigint_Bigs::fromInt(-1));
		utest_Assert::isTrue($tmp7, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 281, "className" => "thx.TestBigInt", "methodName" => "testModuloHandlesSignsCorrectly")));
		...
		$tmp14 = $this9->toString();
		utest_Assert::isTrue($tmp9, _hx_string_or_null($tmp13) . _hx_string_or_null($tmp14), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 282, "className" => "thx.TestBigInt", "methodName" => "testModuloHandlesSignsCorrectly")));
		...
		utest_Assert::isTrue($tmp16, _hx_string_or_null($tmp20) . _hx_string_or_null($tmp21), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 283, "className" => "thx.TestBigInt", "methodName" => "testModuloHandlesSignsCorrectly")));
		...
		utest_Assert::isTrue($tmp23, _hx_string_or_null($tmp29) . _hx_string_or_null($tmp30), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 284, "className" => "thx.TestBigInt", "methodName" => "testModuloHandlesSignsCorrectly")));
		...
		utest_Assert::isTrue($tmp32, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 285, "className" => "thx.TestBigInt", "methodName" => "testModuloHandlesSignsCorrectly")));
		...
		utest_Assert::isTrue($tmp34, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 286, "className" => "thx.TestBigInt", "methodName" => "testModuloHandlesSignsCorrectly")));
	}
	public function testPrevNext() {
		...
		$this4 = $this3->prev();
		$tmp4 = $this4->toString();
		utest_Assert::isTrue($tmp1, _hx_string_or_null($tmp3) . _hx_string_or_null($tmp4), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 290, "className" => "thx.TestBigInt", "methodName" => "testPrevNext")));
		$this5 = thx_bigint_Bigs::fromInt(1);
		$tmp5 = $this5->prev();
		$tmp6 = thx__BigInt_BigInt_Impl_::equals($tmp5, thx_bigint_Bigs::fromInt(0));
		utest_Assert::isTrue($tmp6, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 291, "className" => "thx.TestBigInt", "methodName" => "testPrevNext")));
		$this6 = thx_bigint_Bigs::fromInt(0);
		$tmp7 = $this6->prev();
		$tmp8 = thx__BigInt_BigInt_Impl_::equals($tmp7, thx_bigint_Bigs::fromInt(-1));
		utest_Assert::isTrue($tmp8, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 292, "className" => "thx.TestBigInt", "methodName" => "testPrevNext")));
		...
		utest_Assert::isTrue($tmp10, _hx_string_or_null($tmp12) . _hx_string_or_null($tmp13), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 293, "className" => "thx.TestBigInt", "methodName" => "testPrevNext")));
		$this11 = thx_bigint_Bigs::fromInt(-1987);
		$tmp14 = $this11->prev();
		$tmp15 = thx__BigInt_BigInt_Impl_::equals($tmp14, thx_bigint_Bigs::fromInt(-1988));
		utest_Assert::isTrue($tmp15, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 294, "className" => "thx.TestBigInt", "methodName" => "testPrevNext")));
		$this12 = thx_bigint_Bigs::fromInt(546);
		$tmp16 = $this12->next();
		$tmp17 = thx__BigInt_BigInt_Impl_::equals($tmp16, thx_bigint_Bigs::fromInt(547));
		utest_Assert::isTrue($tmp17, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 296, "className" => "thx.TestBigInt", "methodName" => "testPrevNext")));
		$this13 = thx_bigint_Bigs::fromInt(1);
		$tmp18 = $this13->next();
		$tmp19 = thx__BigInt_BigInt_Impl_::equals($tmp18, thx_bigint_Bigs::fromInt(2));
		utest_Assert::isTrue($tmp19, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 297, "className" => "thx.TestBigInt", "methodName" => "testPrevNext")));
		$this14 = thx_bigint_Bigs::fromInt(0);
		$tmp20 = $this14->next();
		$tmp21 = thx__BigInt_BigInt_Impl_::equals($tmp20, thx_bigint_Bigs::fromInt(1));
		utest_Assert::isTrue($tmp21, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 298, "className" => "thx.TestBigInt", "methodName" => "testPrevNext")));
		$this15 = thx_bigint_Bigs::fromInt(-1);
		$tmp22 = $this15->next();
		$tmp23 = thx__BigInt_BigInt_Impl_::equals($tmp22, thx_bigint_Bigs::fromInt(0));
		utest_Assert::isTrue($tmp23, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 299, "className" => "thx.TestBigInt", "methodName" => "testPrevNext")));
		$this16 = thx_bigint_Bigs::fromInt(-1987);
		$tmp24 = $this16->next();
		$tmp25 = thx__BigInt_BigInt_Impl_::equals($tmp24, thx_bigint_Bigs::fromInt(-1986));
		utest_Assert::isTrue($tmp25, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 300, "className" => "thx.TestBigInt", "methodName" => "testPrevNext")));
		$this17 = thx_bigint_Bigs::fromInt(0);
		$tmp26 = $this17->next();
		$tmp27 = thx__BigInt_BigInt_Impl_::equals($tmp26, thx_bigint_Bigs::fromInt(1));
		utest_Assert::isTrue($tmp27, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 302, "className" => "thx.TestBigInt", "methodName" => "testPrevNext")));
		$this18 = thx_bigint_Bigs::fromInt(-1);
		$tmp28 = $this18->next();
		$tmp29 = thx__BigInt_BigInt_Impl_::equals($tmp28, thx_bigint_Bigs::fromInt(0));
		utest_Assert::isTrue($tmp29, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 303, "className" => "thx.TestBigInt", "methodName" => "testPrevNext")));
		$this19 = thx_bigint_Bigs::fromInt(34);
		$tmp30 = $this19->next();
		$tmp31 = thx__BigInt_BigInt_Impl_::equals($tmp30, thx_bigint_Bigs::fromInt(35));
		utest_Assert::isTrue($tmp31, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 304, "className" => "thx.TestBigInt", "methodName" => "testPrevNext")));
		...
		utest_Assert::isTrue($tmp33, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 305, "className" => "thx.TestBigInt", "methodName" => "testPrevNext")));
		...
		utest_Assert::isTrue($tmp35, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 306, "className" => "thx.TestBigInt", "methodName" => "testPrevNext")));
		...
		utest_Assert::isTrue($tmp37, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 307, "className" => "thx.TestBigInt", "methodName" => "testPrevNext")));
		...
		utest_Assert::isTrue($tmp39, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 308, "className" => "thx.TestBigInt", "methodName" => "testPrevNext")));
		$this24 = thx_bigint_Bigs::fromInt(0);
		$tmp40 = $this24->prev();
		$tmp41 = thx__BigInt_BigInt_Impl_::equals($tmp40, thx_bigint_Bigs::fromInt(-1));
		utest_Assert::isTrue($tmp41, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 310, "className" => "thx.TestBigInt", "methodName" => "testPrevNext")));
		$this25 = thx_bigint_Bigs::fromInt(-1);
		$tmp42 = $this25->prev();
		$tmp43 = thx__BigInt_BigInt_Impl_::equals($tmp42, thx_bigint_Bigs::fromInt(-2));
		utest_Assert::isTrue($tmp43, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 311, "className" => "thx.TestBigInt", "methodName" => "testPrevNext")));
		$this26 = thx_bigint_Bigs::fromInt(34);
		$tmp44 = $this26->prev();
		$tmp45 = thx__BigInt_BigInt_Impl_::equals($tmp44, thx_bigint_Bigs::fromInt(33));
		utest_Assert::isTrue($tmp45, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 312, "className" => "thx.TestBigInt", "methodName" => "testPrevNext")));
		...
		utest_Assert::isTrue($tmp47, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 313, "className" => "thx.TestBigInt", "methodName" => "testPrevNext")));
		...
		utest_Assert::isTrue($tmp49, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 314, "className" => "thx.TestBigInt", "methodName" => "testPrevNext")));
		...
		utest_Assert::isTrue($tmp51, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 315, "className" => "thx.TestBigInt", "methodName" => "testPrevNext")));
		...
		utest_Assert::isTrue($tmp53, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 316, "className" => "thx.TestBigInt", "methodName" => "testPrevNext")));
		...
		utest_Assert::isTrue($tmp55, _hx_string_or_null($tmp57) . _hx_string_or_null($tmp58), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 318, "className" => "thx.TestBigInt", "methodName" => "testPrevNext")));
		...
		utest_Assert::isTrue($tmp60, _hx_string_or_null($tmp62) . _hx_string_or_null($tmp63), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 319, "className" => "thx.TestBigInt", "methodName" => "testPrevNext")));
		...
		utest_Assert::isTrue($tmp65, _hx_string_or_null($tmp67) . _hx_string_or_null($tmp68), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 320, "className" => "thx.TestBigInt", "methodName" => "testPrevNext")));
		...
		utest_Assert::isTrue($tmp70, _hx_string_or_null($tmp72) . _hx_string_or_null($tmp73), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 321, "className" => "thx.TestBigInt", "methodName" => "testPrevNext")));
	}
	public function testPrevNextCarriesOverCorrectly() {
		...
		utest_Assert::isTrue($tmp1, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 325, "className" => "thx.TestBigInt", "methodName" => "testPrevNextCarriesOverCorrectly")));
		$this2 = thx_bigint_Bigs::fromInt(10000000);
		$tmp2 = $this2->prev();
		$tmp3 = thx__BigInt_BigInt_Impl_::equals($tmp2, thx_bigint_Bigs::fromInt(9999999));
		utest_Assert::isTrue($tmp3, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 326, "className" => "thx.TestBigInt", "methodName" => "testPrevNextCarriesOverCorrectly")));
	}
	public function testAbs() {
		$this1 = thx_bigint_Bigs::fromInt(0);
		$tmp = $this1->abs();
		$tmp1 = thx__BigInt_BigInt_Impl_::equals($tmp, thx_bigint_Bigs::fromInt(0));
		utest_Assert::isTrue($tmp1, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 330, "className" => "thx.TestBigInt", "methodName" => "testAbs")));
		$this2 = thx_bigint_Bigs::parseBase("-0", 10);
		$tmp2 = $this2->abs();
		$tmp3 = thx__BigInt_BigInt_Impl_::equals($tmp2, thx_bigint_Bigs::fromInt(0));
		utest_Assert::isTrue($tmp3, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 331, "className" => "thx.TestBigInt", "methodName" => "testAbs")));
		$this3 = thx_bigint_Bigs::fromInt(54);
		$tmp4 = $this3->abs();
		$tmp5 = thx__BigInt_BigInt_Impl_::equals($tmp4, thx_bigint_Bigs::fromInt(54));
		utest_Assert::isTrue($tmp5, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 332, "className" => "thx.TestBigInt", "methodName" => "testAbs")));
		$this4 = thx_bigint_Bigs::fromInt(-54);
		$tmp6 = $this4->abs();
		$tmp7 = thx__BigInt_BigInt_Impl_::equals($tmp6, thx_bigint_Bigs::fromInt(54));
		utest_Assert::isTrue($tmp7, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 333, "className" => "thx.TestBigInt", "methodName" => "testAbs")));
		...
		utest_Assert::isTrue($tmp9, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 334, "className" => "thx.TestBigInt", "methodName" => "testAbs")));
		...
		utest_Assert::isTrue($tmp11, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 335, "className" => "thx.TestBigInt", "methodName" => "testAbs")));
	}
	public function testIsPositiveAndIsNegative() {
		$this1 = thx_bigint_Bigs::fromInt(0);
		$tmp = $this1->compareTo(thx__BigInt_BigInt_Impl_::$zero);
		utest_Assert::isFalse($tmp > 0, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 339, "className" => "thx.TestBigInt", "methodName" => "testIsPositiveAndIsNegative")));
		$this2 = thx_bigint_Bigs::fromInt(0);
		$tmp1 = $this2->sign;
		utest_Assert::isFalse($tmp1, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 340, "className" => "thx.TestBigInt", "methodName" => "testIsPositiveAndIsNegative")));
		$this3 = thx_bigint_Bigs::fromInt(0);
		$tmp2 = $this3->compareTo(thx__BigInt_BigInt_Impl_::$zero);
		utest_Assert::isFalse($tmp2 > 0, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 341, "className" => "thx.TestBigInt", "methodName" => "testIsPositiveAndIsNegative")));
		$this4 = thx_bigint_Bigs::fromInt(0);
		$tmp3 = $this4->sign;
		utest_Assert::isFalse($tmp3, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 342, "className" => "thx.TestBigInt", "methodName" => "testIsPositiveAndIsNegative")));
	}
	public function testIsPositiveAndIsNegativeWorkForSmallNumbers() {
		$this1 = thx_bigint_Bigs::fromInt(1);
		$tmp = $this1->compareTo(thx__BigInt_BigInt_Impl_::$zero);
		utest_Assert::isTrue($tmp > 0, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 346, "className" => "thx.TestBigInt", "methodName" => "testIsPositiveAndIsNegativeWorkForSmallNumbers")));
		$this2 = thx_bigint_Bigs::fromInt(543);
		$tmp1 = $this2->sign;
		utest_Assert::isFalse($tmp1, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 347, "className" => "thx.TestBigInt", "methodName" => "testIsPositiveAndIsNegativeWorkForSmallNumbers")));
		$this3 = thx_bigint_Bigs::fromInt(-1);
		$tmp2 = $this3->compareTo(thx__BigInt_BigInt_Impl_::$zero);
		utest_Assert::isFalse($tmp2 > 0, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 348, "className" => "thx.TestBigInt", "methodName" => "testIsPositiveAndIsNegativeWorkForSmallNumbers")));
		$this4 = thx_bigint_Bigs::fromInt(-765);
		$tmp3 = $this4->sign;
		utest_Assert::isTrue($tmp3, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 349, "className" => "thx.TestBigInt", "methodName" => "testIsPositiveAndIsNegativeWorkForSmallNumbers")));
	}
	public function testIsPositiveAndIsNegativeWorkForBigNumbers() {
		$this1 = thx_bigint_Bigs::parseBase("651987498619879841", 10);
		$tmp = $this1->compareTo(thx__BigInt_BigInt_Impl_::$zero);
		utest_Assert::isTrue($tmp > 0, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 353, "className" => "thx.TestBigInt", "methodName" => "testIsPositiveAndIsNegativeWorkForBigNumbers")));
		$this2 = thx_bigint_Bigs::parseBase("0054984980098460", 10);
		$tmp1 = $this2->sign;
		utest_Assert::isFalse($tmp1, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 354, "className" => "thx.TestBigInt", "methodName" => "testIsPositiveAndIsNegativeWorkForBigNumbers")));
		$this3 = thx_bigint_Bigs::parseBase("-1961987984109078496", 10);
		$tmp2 = $this3->compareTo(thx__BigInt_BigInt_Impl_::$zero);
		utest_Assert::isFalse($tmp2 > 0, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 355, "className" => "thx.TestBigInt", "methodName" => "testIsPositiveAndIsNegativeWorkForBigNumbers")));
		$this4 = thx_bigint_Bigs::parseBase("-98800984196109540984", 10);
		$tmp3 = $this4->sign;
		utest_Assert::isTrue($tmp3, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 356, "className" => "thx.TestBigInt", "methodName" => "testIsPositiveAndIsNegativeWorkForBigNumbers")));
	}
	public function testIsUnit() {
		$tmp = thx__BigInt_BigInt_Impl_::$one->isUnit();
		utest_Assert::isTrue($tmp, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 360, "className" => "thx.TestBigInt", "methodName" => "testIsUnit")));
		$tmp1 = thx__BigInt_BigInt_Impl_::$negativeOne->isUnit();
		utest_Assert::isTrue($tmp1, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 361, "className" => "thx.TestBigInt", "methodName" => "testIsUnit")));
		$tmp2 = thx__BigInt_BigInt_Impl_::$zero->isUnit();
		utest_Assert::isFalse($tmp2, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 362, "className" => "thx.TestBigInt", "methodName" => "testIsUnit")));
		$this1 = thx_bigint_Bigs::fromInt(5);
		$tmp3 = $this1->isUnit();
		utest_Assert::isFalse($tmp3, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 363, "className" => "thx.TestBigInt", "methodName" => "testIsUnit")));
		$this2 = thx_bigint_Bigs::fromInt(-5);
		$tmp4 = $this2->isUnit();
		utest_Assert::isFalse($tmp4, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 364, "className" => "thx.TestBigInt", "methodName" => "testIsUnit")));
		$this3 = thx_bigint_Bigs::parseBase("654609649089416160", 10);
		$tmp5 = $this3->isUnit();
		utest_Assert::isFalse($tmp5, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 365, "className" => "thx.TestBigInt", "methodName" => "testIsUnit")));
		$this4 = thx_bigint_Bigs::parseBase("-98410980984981094", 10);
		$tmp6 = $this4->isUnit();
		utest_Assert::isFalse($tmp6, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 366, "className" => "thx.TestBigInt", "methodName" => "testIsUnit")));
	}
	public function testIsZero() {
		$tmp = thx__BigInt_BigInt_Impl_::$zero->isZero();
		utest_Assert::isTrue($tmp, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 370, "className" => "thx.TestBigInt", "methodName" => "testIsZero")));
		$this1 = thx_bigint_Bigs::fromInt(0);
		$tmp1 = $this1->isZero();
		utest_Assert::isTrue($tmp1, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 371, "className" => "thx.TestBigInt", "methodName" => "testIsZero")));
		$this2 = thx_bigint_Bigs::parseBase("-0", 10);
		$tmp2 = $this2->isZero();
		utest_Assert::isTrue($tmp2, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 372, "className" => "thx.TestBigInt", "methodName" => "testIsZero")));
		$this3 = thx_bigint_Bigs::fromInt(15);
		$tmp3 = $this3->isZero();
		utest_Assert::isFalse($tmp3, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 373, "className" => "thx.TestBigInt", "methodName" => "testIsZero")));
		$this4 = thx_bigint_Bigs::fromInt(-15);
		$tmp4 = $this4->isZero();
		utest_Assert::isFalse($tmp4, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 374, "className" => "thx.TestBigInt", "methodName" => "testIsZero")));
		$this5 = thx_bigint_Bigs::parseBase("63213098189462109840", 10);
		$tmp5 = $this5->isZero();
		utest_Assert::isFalse($tmp5, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 375, "className" => "thx.TestBigInt", "methodName" => "testIsZero")));
		$this6 = thx_bigint_Bigs::parseBase("-64343745644564564563", 10);
		$tmp6 = $this6->isZero();
		utest_Assert::isFalse($tmp6, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 376, "className" => "thx.TestBigInt", "methodName" => "testIsZero")));
		$this7 = thx_bigint_Bigs::fromInt(0);
		$tmp7 = $this7->isZero();
		utest_Assert::isTrue($tmp7, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 377, "className" => "thx.TestBigInt", "methodName" => "testIsZero")));
	}
	public function testSquare() {
		$this1 = thx_bigint_Bigs::fromInt(0);
		$tmp = $this1->square();
		$tmp1 = thx__BigInt_BigInt_Impl_::equals($tmp, thx_bigint_Bigs::fromInt(0));
		utest_Assert::isTrue($tmp1, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 381, "className" => "thx.TestBigInt", "methodName" => "testSquare")));
		$this2 = thx_bigint_Bigs::fromInt(16);
		$tmp2 = $this2->square();
		$tmp3 = thx__BigInt_BigInt_Impl_::equals($tmp2, thx_bigint_Bigs::fromInt(256));
		utest_Assert::isTrue($tmp3, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 382, "className" => "thx.TestBigInt", "methodName" => "testSquare")));
		$this3 = thx_bigint_Bigs::fromInt(-16);
		$tmp4 = $this3->square();
		$tmp5 = thx__BigInt_BigInt_Impl_::equals($tmp4, thx_bigint_Bigs::fromInt(256));
		utest_Assert::isTrue($tmp5, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 383, "className" => "thx.TestBigInt", "methodName" => "testSquare")));
		...
		$this6 = $this5->square();
		$tmp8 = $this6->toString();
		utest_Assert::isTrue($tmp7, "expected " . _hx_string_or_null($tmp8) . " == 4294967296", _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 384, "className" => "thx.TestBigInt", "methodName" => "testSquare")));
	}
	public function testPowerToNegativeNumbersIs0() {
		...
		$tmp = $this1->pow($exp);
		$tmp1 = thx__BigInt_BigInt_Impl_::equals($tmp, thx_bigint_Bigs::fromInt(0));
		utest_Assert::isTrue($tmp1, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 388, "className" => "thx.TestBigInt", "methodName" => "testPowerToNegativeNumbersIs0")));
		$this2 = thx_bigint_Bigs::fromInt(543);
		$exp1 = thx_bigint_Bigs::fromInt(-2);
		$tmp2 = $this2->pow($exp1);
		$tmp3 = thx__BigInt_BigInt_Impl_::equals($tmp2, thx_bigint_Bigs::fromInt(0));
		utest_Assert::isTrue($tmp3, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 389, "className" => "thx.TestBigInt", "methodName" => "testPowerToNegativeNumbersIs0")));
		$this3 = thx_bigint_Bigs::parseBase("323434643534523", 10);
		$exp2 = thx_bigint_Bigs::fromInt(-1);
		$tmp4 = $this3->pow($exp2);
		$tmp5 = thx__BigInt_BigInt_Impl_::equals($tmp4, thx_bigint_Bigs::fromInt(0));
		utest_Assert::isTrue($tmp5, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 390, "className" => "thx.TestBigInt", "methodName" => "testPowerToNegativeNumbersIs0")));
		$this4 = thx_bigint_Bigs::fromInt(-54302);
		$exp3 = thx_bigint_Bigs::parseBase("-543624724341214223562", 10);
		$tmp6 = $this4->pow($exp3);
		$tmp7 = thx__BigInt_BigInt_Impl_::equals($tmp6, thx_bigint_Bigs::fromInt(0));
		utest_Assert::isTrue($tmp7, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 391, "className" => "thx.TestBigInt", "methodName" => "testPowerToNegativeNumbersIs0")));
		...
		utest_Assert::isTrue($tmp9, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 392, "className" => "thx.TestBigInt", "methodName" => "testPowerToNegativeNumbersIs0")));
		$this6 = thx_bigint_Bigs::fromInt(1);
		$exp5 = thx_bigint_Bigs::fromInt(-1);
		$tmp10 = $this6->pow($exp5);
		$tmp11 = thx__BigInt_BigInt_Impl_::equals($tmp10, thx_bigint_Bigs::fromInt(1));
		utest_Assert::isTrue($tmp11, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 394, "className" => "thx.TestBigInt", "methodName" => "testPowerToNegativeNumbersIs0")));
		$this7 = thx_bigint_Bigs::fromInt(-1);
		$exp6 = thx_bigint_Bigs::fromInt(-1);
		$tmp12 = $this7->pow($exp6);
		$tmp13 = thx__BigInt_BigInt_Impl_::equals($tmp12, thx_bigint_Bigs::fromInt(-1));
		utest_Assert::isTrue($tmp13, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 395, "className" => "thx.TestBigInt", "methodName" => "testPowerToNegativeNumbersIs0")));
		$this8 = thx_bigint_Bigs::fromInt(-1);
		$exp7 = thx_bigint_Bigs::fromInt(-2);
		$tmp14 = $this8->pow($exp7);
		$tmp15 = thx__BigInt_BigInt_Impl_::equals($tmp14, thx_bigint_Bigs::fromInt(1));
		utest_Assert::isTrue($tmp15, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 396, "className" => "thx.TestBigInt", "methodName" => "testPowerToNegativeNumbersIs0")));
	}
	public function testPowerHandlesSignsCorrectly() {
		...
		utest_Assert::isTrue($tmp1, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 400, "className" => "thx.TestBigInt", "methodName" => "testPowerHandlesSignsCorrectly")));
		...
		$tmp4 = $this4->toString();
		utest_Assert::isTrue($tmp3, "expected " . _hx_string_or_null($tmp4) . " == -8", _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 401, "className" => "thx.TestBigInt", "methodName" => "testPowerHandlesSignsCorrectly")));
		...
		$tmp9 = $this8->toString();
		utest_Assert::isTrue($tmp6, _hx_string_or_null($tmp8) . _hx_string_or_null($tmp9), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 402, "className" => "thx.TestBigInt", "methodName" => "testPowerHandlesSignsCorrectly")));
		...
		utest_Assert::isTrue($tmp11, _hx_string_or_null($tmp13) . _hx_string_or_null($tmp14), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 403, "className" => "thx.TestBigInt", "methodName" => "testPowerHandlesSignsCorrectly")));
		...
		utest_Assert::isTrue($tmp16, _hx_string_or_null($tmp18) . _hx_string_or_null($tmp19), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 404, "className" => "thx.TestBigInt", "methodName" => "testPowerHandlesSignsCorrectly")));
		$this17 = thx_bigint_Bigs::fromInt(1);
		$exp9 = thx_bigint_Bigs::fromInt(1);
		$tmp20 = $this17->pow($exp9);
		$tmp21 = thx__BigInt_BigInt_Impl_::equals($tmp20, thx_bigint_Bigs::fromInt(1));
		utest_Assert::isTrue($tmp21, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 406, "className" => "thx.TestBigInt", "methodName" => "testPowerHandlesSignsCorrectly")));
		$this18 = thx_bigint_Bigs::fromInt(-1);
		...
		utest_Assert::isTrue($tmp23, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 407, "className" => "thx.TestBigInt", "methodName" => "testPowerHandlesSignsCorrectly")));
		...
		utest_Assert::isTrue($tmp25, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 408, "className" => "thx.TestBigInt", "methodName" => "testPowerHandlesSignsCorrectly")));
		$this20 = thx_bigint_Bigs::fromInt(1);
		$exp12 = thx_bigint_Bigs::parseBase("1e100", 10);
		$tmp26 = $this20->pow($exp12);
		$tmp27 = thx__BigInt_BigInt_Impl_::equals($tmp26, thx_bigint_Bigs::fromInt(1));
		utest_Assert::isTrue($tmp27, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 410, "className" => "thx.TestBigInt", "methodName" => "testPowerHandlesSignsCorrectly")));
		...
		utest_Assert::isTrue($tmp29, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 411, "className" => "thx.TestBigInt", "methodName" => "testPowerHandlesSignsCorrectly")));
		...
		utest_Assert::isTrue($tmp31, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 412, "className" => "thx.TestBigInt", "methodName" => "testPowerHandlesSignsCorrectly")));
	}
	public function testPower() {
		...
		utest_Assert::isTrue($tmp2, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 417, "className" => "thx.TestBigInt", "methodName" => "testPower")));
	}
	public function testPowerOf0to0is1() {
		...
		$tmp = $this1->pow($exp);
		$tmp1 = thx__BigInt_BigInt_Impl_::equals($tmp, thx_bigint_Bigs::fromInt(1));
		utest_Assert::isTrue($tmp1, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 421, "className" => "thx.TestBigInt", "methodName" => "testPowerOf0to0is1")));
		$this2 = thx_bigint_Bigs::fromInt(0);
		$exp1 = thx_bigint_Bigs::parseBase("-0", 10);
		$tmp2 = $this2->pow($exp1);
		$tmp3 = thx__BigInt_BigInt_Impl_::equals($tmp2, thx_bigint_Bigs::fromInt(1));
		utest_Assert::isTrue($tmp3, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 422, "className" => "thx.TestBigInt", "methodName" => "testPowerOf0to0is1")));
		$this3 = thx_bigint_Bigs::parseBase("-0", 10);
		$exp2 = thx_bigint_Bigs::fromInt(0);
		$tmp4 = $this3->pow($exp2);
		$tmp5 = thx__BigInt_BigInt_Impl_::equals($tmp4, thx_bigint_Bigs::fromInt(1));
		utest_Assert::isTrue($tmp5, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 423, "className" => "thx.TestBigInt", "methodName" => "testPowerOf0to0is1")));
		$this4 = thx_bigint_Bigs::parseBase("-0", 10);
		$exp3 = thx_bigint_Bigs::parseBase("-0", 10);
		$tmp6 = $this4->pow($exp3);
		$tmp7 = thx__BigInt_BigInt_Impl_::equals($tmp6, thx_bigint_Bigs::fromInt(1));
		utest_Assert::isTrue($tmp7, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 424, "className" => "thx.TestBigInt", "methodName" => "testPowerOf0to0is1")));
	}
	public function testPowerCarriesOverCorrectly() {
		...
		utest_Assert::isTrue($tmp1, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 428, "className" => "thx.TestBigInt", "methodName" => "testPowerCarriesOverCorrectly")));
		...
		utest_Assert::isTrue($tmp3, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 429, "className" => "thx.TestBigInt", "methodName" => "testPowerCarriesOverCorrectly")));
		...
		$tmp8 = $this6->toString();
		utest_Assert::isTrue($tmp5, _hx_string_or_null($tmp7) . _hx_string_or_null($tmp8), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 430, "className" => "thx.TestBigInt", "methodName" => "testPowerCarriesOverCorrectly")));
		...
		utest_Assert::isTrue($tmp10, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 431, "className" => "thx.TestBigInt", "methodName" => "testPowerCarriesOverCorrectly")));
	}
	public function testDivision() {
		utest_Assert::raises(array(new _hx_lambda(array(), "thx_TestBigInt_7"), 'execute'), _hx_qtype("thx.Error"), null, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 435, "className" => "thx.TestBigInt", "methodName" => "testDivision")));
		utest_Assert::raises(array(new _hx_lambda(array(), "thx_TestBigInt_8"), 'execute'), _hx_qtype("thx.Error"), null, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 438, "className" => "thx.TestBigInt", "methodName" => "testDivision")));
		...
		$tests = (new _hx_array(array($tmp2, $tmp5, _hx_anonymous(array("num" => $tmp6, "div" => $tmp7, "res" => thx_bigint_Bigs::parseBase("20000000000000000", 10))))));
		{
			...
			while($_g < $tests->length) {
				...
				utest_Assert::isTrue($tmp8, _hx_string_or_null($tmp14) . _hx_string_or_null($tmp15), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 448, "className" => "thx.TestBigInt", "methodName" => "testDivision")));
	...
	public function testAddition() {
		...
		utest_Assert::isTrue($tmp, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 460, "className" => "thx.TestBigInt", "methodName" => "testAddition")));
		$tmp1 = thx__BigInt_BigInt_Impl_::equals($n->add($m), $m);
		utest_Assert::isTrue($tmp1, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 461, "className" => "thx.TestBigInt", "methodName" => "testAddition")));
		$tmp2 = thx__BigInt_BigInt_Impl_::equals($m->subtract($n), $m);
		utest_Assert::isTrue($tmp2, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 463, "className" => "thx.TestBigInt", "methodName" => "testAddition")));
		$tmp3 = $n->subtract($m);
		$tmp4 = thx__BigInt_BigInt_Impl_::equals($tmp3, $m->negate());
		utest_Assert::isTrue($tmp4, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 464, "className" => "thx.TestBigInt", "methodName" => "testAddition")));
		$m = thx_bigint_Bigs::fromInt(123);
		$n = thx_bigint_Bigs::fromInt(343);
		$s = thx_bigint_Bigs::fromInt(466);
		$tmp5 = thx__BigInt_BigInt_Impl_::equals($m->add($n), $s);
		utest_Assert::isTrue($tmp5, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 468, "className" => "thx.TestBigInt", "methodName" => "testAddition")));
		$tmp6 = thx__BigInt_BigInt_Impl_::equals($n->add($m), $s);
		utest_Assert::isTrue($tmp6, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 469, "className" => "thx.TestBigInt", "methodName" => "testAddition")));
		$tmp7 = thx__BigInt_BigInt_Impl_::equals($s->subtract($n), $m);
		utest_Assert::isTrue($tmp7, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 471, "className" => "thx.TestBigInt", "methodName" => "testAddition")));
		$tmp8 = $n->subtract($s);
		$tmp9 = thx__BigInt_BigInt_Impl_::equals($tmp8, $m->negate());
		utest_Assert::isTrue($tmp9, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 472, "className" => "thx.TestBigInt", "methodName" => "testAddition")));
		...
		utest_Assert::isTrue($tmp12, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 476, "className" => "thx.TestBigInt", "methodName" => "testAddition")));
		$this2 = $m->subtract($n);
		$tmp13 = $this2->add($o);
		$that1 = $n->subtract($o);
		$tmp14 = $m->subtract($that1);
		$tmp15 = thx__BigInt_BigInt_Impl_::equals($tmp13, $tmp14);
		utest_Assert::isTrue($tmp15, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 478, "className" => "thx.TestBigInt", "methodName" => "testAddition")));
		...
		utest_Assert::isTrue($tmp16, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 481, "className" => "thx.TestBigInt", "methodName" => "testAddition")));
		$tmp17 = thx__BigInt_BigInt_Impl_::equals($s->subtract($n), $m);
		utest_Assert::isTrue($tmp17, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 483, "className" => "thx.TestBigInt", "methodName" => "testAddition")));
		...
		utest_Assert::isTrue($tmp18, _hx_string_or_null($tmp24) . _hx_string_or_null($tmp25), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 488, "className" => "thx.TestBigInt", "methodName" => "testAddition")));
		$this4 = $m->subtract($n);
		$tmp26 = $this4->isZero();
		$tmp27 = $m->toString();
		...
		utest_Assert::isTrue($tmp26, _hx_string_or_null($tmp30) . _hx_string_or_null($tmp31), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 490, "className" => "thx.TestBigInt", "methodName" => "testAddition")));
		$tmp32 = $m->subtract($n);
		...
		utest_Assert::isTrue($tmp33, _hx_string_or_null($tmp37) . _hx_string_or_null($tmp38), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 491, "className" => "thx.TestBigInt", "methodName" => "testAddition")));
		...
		utest_Assert::isTrue($tmp39, _hx_string_or_null($tmp45) . _hx_string_or_null($tmp46), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 492, "className" => "thx.TestBigInt", "methodName" => "testAddition")));
		...
		utest_Assert::isTrue($tmp47, _hx_string_or_null($tmp53) . _hx_string_or_null($tmp54), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 498, "className" => "thx.TestBigInt", "methodName" => "testAddition")));
		...
		utest_Assert::isTrue($tmp55, _hx_string_or_null($tmp61) . _hx_string_or_null($tmp62), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 500, "className" => "thx.TestBigInt", "methodName" => "testAddition")));
		...
		utest_Assert::isTrue($tmp63, _hx_string_or_null($tmp69) . _hx_string_or_null($tmp70), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 505, "className" => "thx.TestBigInt", "methodName" => "testAddition")));
		...
		utest_Assert::isTrue($tmp71, _hx_string_or_null($tmp77) . _hx_string_or_null($tmp78), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 506, "className" => "thx.TestBigInt", "methodName" => "testAddition")));
		$m = thx_bigint_Bigs::parseBase("1", 10);
		...
		utest_Assert::isTrue($tmp79, _hx_string_or_null($tmp85) . _hx_string_or_null($tmp86), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 509, "className" => "thx.TestBigInt", "methodName" => "testAddition")));
		...
		utest_Assert::isTrue($tmp87, _hx_string_or_null($tmp93) . _hx_string_or_null($tmp94), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 510, "className" => "thx.TestBigInt", "methodName" => "testAddition")));
		...
		utest_Assert::isTrue($tmp95, _hx_string_or_null($tmp101) . _hx_string_or_null($tmp102), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 511, "className" => "thx.TestBigInt", "methodName" => "testAddition")));
	}
	public function testMultiplication() {
		...
		utest_Assert::isTrue($tmp, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 520, "className" => "thx.TestBigInt", "methodName" => "testMultiplication")));
		$tmp1 = thx__BigInt_BigInt_Impl_::equals($b->multiply($a), $b);
		utest_Assert::isTrue($tmp1, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 521, "className" => "thx.TestBigInt", "methodName" => "testMultiplication")));
		$a = thx_bigint_Bigs::fromInt(-99999);
		$b = thx_bigint_Bigs::fromInt(1);
		$tmp2 = thx__BigInt_BigInt_Impl_::equals($a->multiply($b), $a);
		utest_Assert::isTrue($tmp2, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 524, "className" => "thx.TestBigInt", "methodName" => "testMultiplication")));
		$tmp3 = thx__BigInt_BigInt_Impl_::equals($b->multiply($a), $a);
		utest_Assert::isTrue($tmp3, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 525, "className" => "thx.TestBigInt", "methodName" => "testMultiplication")));
		...
		utest_Assert::isTrue($tmp4, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 528, "className" => "thx.TestBigInt", "methodName" => "testMultiplication")));
		$tmp5 = thx__BigInt_BigInt_Impl_::equals($b->multiply($a), $m);
		utest_Assert::isTrue($tmp5, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 529, "className" => "thx.TestBigInt", "methodName" => "testMultiplication")));
		...
		utest_Assert::isTrue($tmp6, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 532, "className" => "thx.TestBigInt", "methodName" => "testMultiplication")));
		...
		utest_Assert::isTrue($tmp7, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 535, "className" => "thx.TestBigInt", "methodName" => "testMultiplication")));
		...
		utest_Assert::isTrue($tmp8, _hx_string_or_null($tmp14) . _hx_string_or_null($tmp15), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 541, "className" => "thx.TestBigInt", "methodName" => "testMultiplication")));
	}
	public function testComparison() {
		$a = thx_bigint_Bigs::fromInt(1);
		$b = thx_bigint_Bigs::fromInt(2);
		$tmp = thx__BigInt_BigInt_Impl_::less($a, $b);
		utest_Assert::isTrue($tmp, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 547, "className" => "thx.TestBigInt", "methodName" => "testComparison")));
		$tmp1 = thx__BigInt_BigInt_Impl_::lessEquals($a, $b);
		utest_Assert::isTrue($tmp1, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 548, "className" => "thx.TestBigInt", "methodName" => "testComparison")));
		$tmp2 = thx__BigInt_BigInt_Impl_::lessEquals($a, $a);
		utest_Assert::isTrue($tmp2, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 549, "className" => "thx.TestBigInt", "methodName" => "testComparison")));
		$tmp3 = thx__BigInt_BigInt_Impl_::greater($b, $a);
		utest_Assert::isTrue($tmp3, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 551, "className" => "thx.TestBigInt", "methodName" => "testComparison")));
		$tmp4 = thx__BigInt_BigInt_Impl_::greaterEquals($b, $a);
		utest_Assert::isTrue($tmp4, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 552, "className" => "thx.TestBigInt", "methodName" => "testComparison")));
		$tmp5 = thx__BigInt_BigInt_Impl_::greaterEquals($b, $b);
		utest_Assert::isTrue($tmp5, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 553, "className" => "thx.TestBigInt", "methodName" => "testComparison")));
		$tmp6 = thx__BigInt_BigInt_Impl_::lessEquals($b, $b);
		utest_Assert::isTrue($tmp6, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 554, "className" => "thx.TestBigInt", "methodName" => "testComparison")));
		$tmp7 = $a->compareTo($b);
		utest_Assert::equals(-1, $tmp7, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 556, "className" => "thx.TestBigInt", "methodName" => "testComparison")));
		$tmp8 = $b->compareTo($a);
		utest_Assert::equals(1, $tmp8, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 557, "className" => "thx.TestBigInt", "methodName" => "testComparison")));
		$tmp9 = $b->compareTo($b);
		utest_Assert::equals(0, $tmp9, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 558, "className" => "thx.TestBigInt", "methodName" => "testComparison")));
		...
		utest_Assert::isTrue($tmp10, _hx_string_or_null($tmp14) . _hx_string_or_null($tmp16), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 563, "className" => "thx.TestBigInt", "methodName" => "testComparison")));
		...
		utest_Assert::isTrue($tmp17, _hx_string_or_null($tmp21) . _hx_string_or_null($tmp23), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 564, "className" => "thx.TestBigInt", "methodName" => "testComparison")));
		$tmp24 = thx__BigInt_BigInt_Impl_::lessEquals($a, $a);
		utest_Assert::isTrue($tmp24, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 565, "className" => "thx.TestBigInt", "methodName" => "testComparison")));
		$tmp25 = thx__BigInt_BigInt_Impl_::greater($b, $a);
		utest_Assert::isTrue($tmp25, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 567, "className" => "thx.TestBigInt", "methodName" => "testComparison")));
		$tmp26 = thx__BigInt_BigInt_Impl_::greaterEquals($b, $a);
		utest_Assert::isTrue($tmp26, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 568, "className" => "thx.TestBigInt", "methodName" => "testComparison")));
		$tmp27 = thx__BigInt_BigInt_Impl_::greaterEquals($b, $b);
		utest_Assert::isTrue($tmp27, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 569, "className" => "thx.TestBigInt", "methodName" => "testComparison")));
		$tmp28 = thx__BigInt_BigInt_Impl_::lessEquals($b, $b);
		utest_Assert::isTrue($tmp28, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 570, "className" => "thx.TestBigInt", "methodName" => "testComparison")));
		$tmp29 = $a->compareTo($b);
		$tmp30 = $a->toString();
		...
		$tmp34 = $a->compareTo($b);
		utest_Assert::equals(-1, $tmp29, _hx_string_or_null($tmp33) . _hx_string_rec($tmp34, ""), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 572, "className" => "thx.TestBigInt", "methodName" => "testComparison")));
		$tmp35 = $b->compareTo($a);
		utest_Assert::equals(1, $tmp35, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 573, "className" => "thx.TestBigInt", "methodName" => "testComparison")));
		$tmp36 = $b->compareTo($b);
		utest_Assert::equals(0, $tmp36, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 574, "className" => "thx.TestBigInt", "methodName" => "testComparison")));
		...
		utest_Assert::isTrue($tmp37, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 579, "className" => "thx.TestBigInt", "methodName" => "testComparison")));
		$tmp38 = thx__BigInt_BigInt_Impl_::lessEquals($a, $b);
		utest_Assert::isTrue($tmp38, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 580, "className" => "thx.TestBigInt", "methodName" => "testComparison")));
		$tmp39 = thx__BigInt_BigInt_Impl_::lessEquals($a, $a);
		utest_Assert::isTrue($tmp39, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 581, "className" => "thx.TestBigInt", "methodName" => "testComparison")));
		$tmp40 = thx__BigInt_BigInt_Impl_::greater($b, $a);
		utest_Assert::isTrue($tmp40, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 583, "className" => "thx.TestBigInt", "methodName" => "testComparison")));
		$tmp41 = thx__BigInt_BigInt_Impl_::greaterEquals($b, $a);
		utest_Assert::isTrue($tmp41, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 584, "className" => "thx.TestBigInt", "methodName" => "testComparison")));
		$tmp42 = thx__BigInt_BigInt_Impl_::greaterEquals($b, $b);
		utest_Assert::isTrue($tmp42, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 585, "className" => "thx.TestBigInt", "methodName" => "testComparison")));
		$tmp43 = thx__BigInt_BigInt_Impl_::lessEquals($b, $b);
		utest_Assert::isTrue($tmp43, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 586, "className" => "thx.TestBigInt", "methodName" => "testComparison")));
		$tmp44 = $a->compareTo($b);
		utest_Assert::equals(-1, $tmp44, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 588, "className" => "thx.TestBigInt", "methodName" => "testComparison")));
		$tmp45 = $b->compareTo($a);
		utest_Assert::equals(1, $tmp45, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 589, "className" => "thx.TestBigInt", "methodName" => "testComparison")));
		$tmp46 = $a->compareTo($a);
		utest_Assert::equals(0, $tmp46, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 590, "className" => "thx.TestBigInt", "methodName" => "testComparison")));
		$tmp47 = $b->compareTo($b);
		utest_Assert::equals(0, $tmp47, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 591, "className" => "thx.TestBigInt", "methodName" => "testComparison")));
	}
	public function testNegation() {
		...
		$tmp3 = $n->toString();
		utest_Assert::isTrue($tmp, _hx_string_or_null($tmp2) . _hx_string_or_null($tmp3), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 600, "className" => "thx.TestBigInt", "methodName" => "testNegation")));
		$n = thx_bigint_Bigs::fromInt(1);
		$tmp4 = $n->negate();
		$tmp5 = thx__BigInt_BigInt_Impl_::equals($tmp4, thx_bigint_Bigs::fromInt(-1));
		utest_Assert::isTrue($tmp5, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 603, "className" => "thx.TestBigInt", "methodName" => "testNegation")));
		$this2 = $n->negate();
		$tmp6 = $this2->negate();
		$tmp7 = thx__BigInt_BigInt_Impl_::equals($tmp6, $n);
		utest_Assert::isTrue($tmp7, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 604, "className" => "thx.TestBigInt", "methodName" => "testNegation")));
		$n = thx_bigint_Bigs::fromInt(-1234);
		$tmp8 = $n->negate();
		$tmp9 = thx__BigInt_BigInt_Impl_::equals($tmp8, thx_bigint_Bigs::fromInt(1234));
		utest_Assert::isTrue($tmp9, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 607, "className" => "thx.TestBigInt", "methodName" => "testNegation")));
		$this3 = $n->negate();
		$tmp10 = $this3->negate();
		$tmp11 = thx__BigInt_BigInt_Impl_::equals($tmp10, $n);
		utest_Assert::isTrue($tmp11, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 608, "className" => "thx.TestBigInt", "methodName" => "testNegation")));
		...
		utest_Assert::isTrue($tmp12, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 612, "className" => "thx.TestBigInt", "methodName" => "testNegation")));
		$tmp13 = thx__BigInt_BigInt_Impl_::equals($m, $n->negate());
		utest_Assert::isTrue($tmp13, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 613, "className" => "thx.TestBigInt", "methodName" => "testNegation")));
	}
	public function testBigIntParsesNumbersCorrectly() {
		...
		utest_Assert::isTrue($tmp1, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 617, "className" => "thx.TestBigInt", "methodName" => "testBigIntParsesNumbersCorrectly")));
		$tmp2 = thx_bigint_Bigs::parseBase("FF", 16);
		$tmp3 = thx__BigInt_BigInt_Impl_::equals($tmp2, thx_bigint_Bigs::fromInt(255));
		utest_Assert::isTrue($tmp3, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 618, "className" => "thx.TestBigInt", "methodName" => "testBigIntParsesNumbersCorrectly")));
		...
		$tmp8 = $this2->toString();
		utest_Assert::isTrue($tmp5, _hx_string_or_null($tmp7) . _hx_string_or_null($tmp8), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 619, "className" => "thx.TestBigInt", "methodName" => "testBigIntParsesNumbersCorrectly")));
		$tmp9 = thx_bigint_Bigs::parseBase("-1", 16);
		$tmp10 = thx__BigInt_BigInt_Impl_::equals($tmp9, thx_bigint_Bigs::fromInt(-1));
		utest_Assert::isTrue($tmp10, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 621, "className" => "thx.TestBigInt", "methodName" => "testBigIntParsesNumbersCorrectly")));
		...
		utest_Assert::isTrue($tmp12, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 622, "className" => "thx.TestBigInt", "methodName" => "testBigIntParsesNumbersCorrectly")));
		...
		utest_Assert::isTrue($tmp14, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 623, "className" => "thx.TestBigInt", "methodName" => "testBigIntParsesNumbersCorrectly")));
		...
		utest_Assert::isTrue($tmp16, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 624, "className" => "thx.TestBigInt", "methodName" => "testBigIntParsesNumbersCorrectly")));
		...
		utest_Assert::isTrue($tmp18, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 625, "className" => "thx.TestBigInt", "methodName" => "testBigIntParsesNumbersCorrectly")));
		$tmp19 = thx_bigint_Bigs::parseBase("-10", 16);
		$tmp20 = thx__BigInt_BigInt_Impl_::equals($tmp19, thx_bigint_Bigs::parseBase("-16", 10));
		utest_Assert::isTrue($tmp20, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 626, "className" => "thx.TestBigInt", "methodName" => "testBigIntParsesNumbersCorrectly")));
	}
	public function testBigIntOutputsNumbersCorrectly() {
		...
		utest_Assert::isTrue($tmp === "4044654fce69424a651af2825b37124c25094658", null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 630, "className" => "thx.TestBigInt", "methodName" => "testBigIntOutputsNumbersCorrectly")));
		$this2 = thx_bigint_Bigs::parseBase("111111111111111111111111111111111111111111111111111111", 2);
		$tmp1 = $this2->toStringWithBase(2);
		utest_Assert::isTrue($tmp1 === "111111111111111111111111111111111111111111111111111111", null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 631, "className" => "thx.TestBigInt", "methodName" => "testBigIntOutputsNumbersCorrectly")));
		$this3 = thx_bigint_Bigs::parseBase("secretmessage000", 36);
		$tmp2 = $this3->toStringWithBase(36);
		utest_Assert::isTrue($tmp2 === "secretmessage000", null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 632, "className" => "thx.TestBigInt", "methodName" => "testBigIntOutputsNumbersCorrectly")));
		$this4 = thx_bigint_Bigs::fromInt(-256);
		$tmp3 = $this4->toStringWithBase(16);
		utest_Assert::isTrue($tmp3 === "-100", null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 633, "className" => "thx.TestBigInt", "methodName" => "testBigIntOutputsNumbersCorrectly")));
	}
	public function testShiftingLeftAndRight() {
		$this1 = thx_bigint_Bigs::fromInt(-5);
		$tmp = $this1->shiftRight(2);
		$tmp1 = thx__BigInt_BigInt_Impl_::equals($tmp, thx_bigint_Bigs::fromInt(-2));
		utest_Assert::isTrue($tmp1, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 637, "className" => "thx.TestBigInt", "methodName" => "testShiftingLeftAndRight")));
		$this2 = thx_bigint_Bigs::fromInt(5);
		...
		$tmp4 = $this4->toString();
		utest_Assert::isTrue($tmp3, "expected " . _hx_string_or_null($tmp4) . " == 20", _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 638, "className" => "thx.TestBigInt", "methodName" => "testShiftingLeftAndRight")));
		$this5 = thx_bigint_Bigs::fromInt(5);
		$tmp5 = $this5->shiftLeft(-2);
		$tmp6 = thx__BigInt_BigInt_Impl_::equals($tmp5, thx_bigint_Bigs::fromInt(1));
		utest_Assert::isTrue($tmp6, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 639, "className" => "thx.TestBigInt", "methodName" => "testShiftingLeftAndRight")));
		...
		$tmp13 = $this10->toString();
		utest_Assert::isTrue($tmp8, _hx_string_or_null($tmp12) . _hx_string_or_null($tmp13), _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 640, "className" => "thx.TestBigInt", "methodName" => "testShiftingLeftAndRight")));
		...
		utest_Assert::isTrue($tmp15, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 641, "className" => "thx.TestBigInt", "methodName" => "testShiftingLeftAndRight")));
		...
		utest_Assert::isTrue($tmp17, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 642, "className" => "thx.TestBigInt", "methodName" => "testShiftingLeftAndRight")));
		...
		utest_Assert::isTrue($tmp19, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 643, "className" => "thx.TestBigInt", "methodName" => "testShiftingLeftAndRight")));
		$this14 = thx_bigint_Bigs::parseBase("-1", 10);
		$tmp20 = $this14->shiftRight(25);
		$tmp21 = thx__BigInt_BigInt_Impl_::equals($tmp20, thx_bigint_Bigs::fromInt(-1));
		utest_Assert::isTrue($tmp21, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 644, "className" => "thx.TestBigInt", "methodName" => "testShiftingLeftAndRight")));
	}
	public function testBitwiseOperations() {
		...
		$tmp2 = $this3->toString();
		utest_Assert::isTrue($tmp1, "expected " . _hx_string_or_null($tmp2) . " to be 298352912", _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 648, "className" => "thx.TestBigInt", "methodName" => "testBitwiseOperations")));
		...
		utest_Assert::isTrue($tmp4, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 649, "className" => "thx.TestBigInt", "methodName" => "testBitwiseOperations")));
		...
		utest_Assert::isTrue($tmp6, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 650, "className" => "thx.TestBigInt", "methodName" => "testBitwiseOperations")));
		...
		utest_Assert::isTrue($tmp8, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 651, "className" => "thx.TestBigInt", "methodName" => "testBitwiseOperations")));
		...
		utest_Assert::isTrue($tmp10, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 652, "className" => "thx.TestBigInt", "methodName" => "testBitwiseOperations")));
		...
		utest_Assert::isTrue($tmp12, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 653, "className" => "thx.TestBigInt", "methodName" => "testBitwiseOperations")));
		...
		utest_Assert::isTrue($tmp14, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 654, "className" => "thx.TestBigInt", "methodName" => "testBitwiseOperations")));
		...
		utest_Assert::isTrue($tmp16, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 655, "className" => "thx.TestBigInt", "methodName" => "testBitwiseOperations")));
		$this11 = thx_bigint_Bigs::parseBase("0", 10);
		$tmp17 = $this11->not();
		$tmp18 = thx__BigInt_BigInt_Impl_::equals($tmp17, thx_bigint_Bigs::parseBase("-1", 10));
		utest_Assert::isTrue($tmp18, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 656, "className" => "thx.TestBigInt", "methodName" => "testBitwiseOperations")));
		...
		utest_Assert::isTrue($tmp20, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 657, "className" => "thx.TestBigInt", "methodName" => "testBitwiseOperations")));
		...
		utest_Assert::isTrue($tmp22, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 658, "className" => "thx.TestBigInt", "methodName" => "testBitwiseOperations")));
	}
	public function testIsEvenAndIsOdd() {
		$this1 = thx_bigint_Bigs::fromInt(0);
		$tmp = $this1->isEven();
		utest_Assert::isTrue($tmp, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 662, "className" => "thx.TestBigInt", "methodName" => "testIsEvenAndIsOdd")));
		$this2 = thx_bigint_Bigs::fromInt(0);
		$tmp1 = $this2->isOdd();
		utest_Assert::isFalse($tmp1, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 663, "className" => "thx.TestBigInt", "methodName" => "testIsEvenAndIsOdd")));
		$this3 = thx_bigint_Bigs::fromInt(654);
		$tmp2 = $this3->isEven();
		utest_Assert::isTrue($tmp2, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 665, "className" => "thx.TestBigInt", "methodName" => "testIsEvenAndIsOdd")));
		$this4 = thx_bigint_Bigs::fromInt(654);
		$tmp3 = $this4->isOdd();
		utest_Assert::isFalse($tmp3, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 666, "className" => "thx.TestBigInt", "methodName" => "testIsEvenAndIsOdd")));
		$this5 = thx_bigint_Bigs::fromInt(653);
		$tmp4 = $this5->isOdd();
		utest_Assert::isTrue($tmp4, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 668, "className" => "thx.TestBigInt", "methodName" => "testIsEvenAndIsOdd")));
		$this6 = thx_bigint_Bigs::fromInt(653);
		$tmp5 = $this6->isEven();
		utest_Assert::isFalse($tmp5, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 669, "className" => "thx.TestBigInt", "methodName" => "testIsEvenAndIsOdd")));
		$this7 = thx_bigint_Bigs::fromInt(-984);
		$tmp6 = $this7->isEven();
		utest_Assert::isTrue($tmp6, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 671, "className" => "thx.TestBigInt", "methodName" => "testIsEvenAndIsOdd")));
		$this8 = thx_bigint_Bigs::fromInt(-984);
		$tmp7 = $this8->isOdd();
		utest_Assert::isFalse($tmp7, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 672, "className" => "thx.TestBigInt", "methodName" => "testIsEvenAndIsOdd")));
		$this9 = thx_bigint_Bigs::fromInt(-987);
		$tmp8 = $this9->isOdd();
		utest_Assert::isTrue($tmp8, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 674, "className" => "thx.TestBigInt", "methodName" => "testIsEvenAndIsOdd")));
		$this10 = thx_bigint_Bigs::fromInt(-987);
		$tmp9 = $this10->isEven();
		utest_Assert::isFalse($tmp9, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 675, "className" => "thx.TestBigInt", "methodName" => "testIsEvenAndIsOdd")));
		$this11 = thx_bigint_Bigs::parseBase("9888651888888888", 10);
		$tmp10 = $this11->isEven();
		utest_Assert::isTrue($tmp10, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 677, "className" => "thx.TestBigInt", "methodName" => "testIsEvenAndIsOdd")));
		$this12 = thx_bigint_Bigs::parseBase("9888651888888888", 10);
		$tmp11 = $this12->isOdd();
		utest_Assert::isFalse($tmp11, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 678, "className" => "thx.TestBigInt", "methodName" => "testIsEvenAndIsOdd")));
		$this13 = thx_bigint_Bigs::parseBase("1026377777777777", 10);
		$tmp12 = $this13->isOdd();
		utest_Assert::isTrue($tmp12, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 680, "className" => "thx.TestBigInt", "methodName" => "testIsEvenAndIsOdd")));
		$this14 = thx_bigint_Bigs::parseBase("1026377777777777", 10);
		$tmp13 = $this14->isEven();
		utest_Assert::isFalse($tmp13, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 681, "className" => "thx.TestBigInt", "methodName" => "testIsEvenAndIsOdd")));
		$this15 = thx_bigint_Bigs::parseBase("-9888651888888888", 10);
		$tmp14 = $this15->isEven();
		utest_Assert::isTrue($tmp14, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 683, "className" => "thx.TestBigInt", "methodName" => "testIsEvenAndIsOdd")));
		$this16 = thx_bigint_Bigs::parseBase("-9888651888888888", 10);
		$tmp15 = $this16->isOdd();
		utest_Assert::isFalse($tmp15, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 684, "className" => "thx.TestBigInt", "methodName" => "testIsEvenAndIsOdd")));
		$this17 = thx_bigint_Bigs::parseBase("-1026377777777777", 10);
		$tmp16 = $this17->isOdd();
		utest_Assert::isTrue($tmp16, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 686, "className" => "thx.TestBigInt", "methodName" => "testIsEvenAndIsOdd")));
		$this18 = thx_bigint_Bigs::parseBase("-1026377777777777", 10);
		$tmp17 = $this18->isEven();
		utest_Assert::isFalse($tmp17, null, _hx_anonymous(array("fileName" => "TestBigInt.hx", "lineNumber" => 687, "className" => "thx.TestBigInt", "methodName" => "testIsEvenAndIsOdd")));
	}
