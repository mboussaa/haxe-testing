...
class thx_fp_TestList {
	...
	public function testFoldLeft() {
		...
		utest_Assert::equals(6, $tmp2, null, _hx_anonymous(array("fileName" => "TestList.hx", "lineNumber" => 13, "className" => "thx.fp.TestList", "methodName" => "testFoldLeft")));
		$tmp3 = thx_fp__List_List_Impl_::foldLeft($list, (new _hx_array(array())), array(new _hx_lambda(array(), "thx_fp_TestList_1"), 'execute'));
		utest_Assert::same((new _hx_array(array(1, 2, 3))), $tmp3, null, null, null, _hx_anonymous(array("fileName" => "TestList.hx", "lineNumber" => 15, "className" => "thx.fp.TestList", "methodName" => "testFoldLeft")));
	}
	public function testToArray() {
		...
		utest_Assert::same((new _hx_array(array(1, 2, 3))), $tmp2, null, null, null, _hx_anonymous(array("fileName" => "TestList.hx", "lineNumber" => 23, "className" => "thx.fp.TestList", "methodName" => "testToArray")));
	}
	public function testIntersperse() {
		...
		utest_Assert::same($tmp6, $interspersed, null, null, null, _hx_anonymous(array("fileName" => "TestList.hx", "lineNumber" => 29, "className" => "thx.fp.TestList", "methodName" => "testIntersperse")));
	}
	public function testFromArray() {
		$arr = (new _hx_array(array(1, 2, 3, 4)));
		$_e = $arr;
		$tmp = array(new _hx_lambda(array(&$_e), "thx_fp_TestList_3"), 'execute');
		$this1 = call_user_func_array($tmp, array(array(new _hx_lambda(array(), "thx_fp_TestList_4"), 'execute'), thx_fp_ListImpl::$Nil));
		$tmp2 = thx_fp__List_List_Impl_::foldLeft($this1, (new _hx_array(array())), array(new _hx_lambda(array(), "thx_fp_TestList_5"), 'execute'));
		utest_Assert::same($arr, $tmp2, null, null, null, _hx_anonymous(array("fileName" => "TestList.hx", "lineNumber" => 34, "className" => "thx.fp.TestList", "methodName" => "testFromArray")));
	}
	public function testConcat() {
		...
		utest_Assert::same($tmp5, $l, null, null, null, _hx_anonymous(array("fileName" => "TestList.hx", "lineNumber" => 41, "className" => "thx.fp.TestList", "methodName" => "testConcat")));
	}
	public function testToString() {
		...
		utest_Assert::same("[1,2,3]", $tmp2, null, null, null, _hx_anonymous(array("fileName" => "TestList.hx", "lineNumber" => 46, "className" => "thx.fp.TestList", "methodName" => "testToString")));
		...
		utest_Assert::same("[1,2,3]", "[" . _hx_string_or_null($tmp6) . "]", null, null, null, _hx_anonymous(array("fileName" => "TestList.hx", "lineNumber" => 49, "className" => "thx.fp.TestList", "methodName" => "testToString")));
	}
	public function testMap() {
		...
		utest_Assert::same($tmp4, $tmp5, null, null, null, _hx_anonymous(array("fileName" => "TestList.hx", "lineNumber" => 54, "className" => "thx.fp.TestList", "methodName" => "testMap")));
	}
	public function testFlatMap() {
		...
		utest_Assert::same($tmp7, $slist, null, null, null, _hx_anonymous(array("fileName" => "TestList.hx", "lineNumber" => 66, "className" => "thx.fp.TestList", "methodName" => "testFlatMap")));
	}
	public function testZip5Ap() {
		$_e = (new _hx_array(array("a", "b", "c")));
		$tmp = array(new _hx_lambda(array(&$_e), "thx_fp_TestList_10"), 'execute');
		$sx = call_user_func_array($tmp, array(array(new _hx_lambda(array(), "thx_fp_TestList_11"), 'execute'), thx_fp_ListImpl::$Nil));
		$_e1 = (new _hx_array(array(1, 2)));
		$tmp2 = array(new _hx_lambda(array(&$_e1), "thx_fp_TestList_12"), 'execute');
		$ix = call_user_func_array($tmp2, array(array(new _hx_lambda(array(), "thx_fp_TestList_13"), 'execute'), thx_fp_ListImpl::$Nil));
		$_e2 = (new _hx_array(array("x", "y", "z")));
		$tmp4 = array(new _hx_lambda(array(&$_e2), "thx_fp_TestList_14"), 'execute');
		$tx = call_user_func_array($tmp4, array(array(new _hx_lambda(array(), "thx_fp_TestList_15"), 'execute'), thx_fp_ListImpl::$Nil));
		$_e3 = (new _hx_array(array(3, 4)));
		$tmp6 = array(new _hx_lambda(array(&$_e3), "thx_fp_TestList_16"), 'execute');
		$jx = call_user_func_array($tmp6, array(array(new _hx_lambda(array(), "thx_fp_TestList_17"), 'execute'), thx_fp_ListImpl::$Nil));
		$_e4 = (new _hx_array(array(true, false, true)));
		$tmp8 = array(new _hx_lambda(array(&$_e4), "thx_fp_TestList_18"), 'execute');
		$bx = call_user_func_array($tmp8, array(array(new _hx_lambda(array(), "thx_fp_TestList_19"), 'execute'), thx_fp_ListImpl::$Nil));
		$_e5 = (new _hx_array(array("a1x3true", "b2y4false")));
		$tmp10 = array(new _hx_lambda(array(&$_e5), "thx_fp_TestList_20"), 'execute');
		$tmp12 = call_user_func_array($tmp10, array(array(new _hx_lambda(array(), "thx_fp_TestList_21"), 'execute'), thx_fp_ListImpl::$Nil));
		$tmp13 = thx_fp__List_List_Impl_::zip5Ap(array(new _hx_lambda(array(), "thx_fp_TestList_22"), 'execute'), $sx, $ix, $tx, $jx, $bx);
		utest_Assert::same($tmp12, $tmp13, null, null, null, _hx_anonymous(array("fileName" => "TestList.hx", "lineNumber" => 77, "className" => "thx.fp.TestList", "methodName" => "testZip5Ap")));
	}
