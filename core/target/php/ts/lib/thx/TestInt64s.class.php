...
class thx_TestInt64s {
	...
	public function testRounding() {
		$tests = (new _hx_array(array(_hx_anonymous(array("roundUp" => 3, "roundDown" => 2, "round" => 3, "num" => 5, "div" => 2, "pos" => _hx_anonymous(array("fileName" => "TestInt64s.hx", "lineNumber" => 17, "className" => "thx.TestInt64s", "methodName" => "testRounding")))), _hx_anonymous(array("roundUp" => 0, "roundDown" => 0, "round" => 0, "num" => 0, "div" => 2, "pos" => _hx_anonymous(array("fileName" => "TestInt64s.hx", "lineNumber" => 18, "className" => "thx.TestInt64s", "methodName" => "testRounding")))), _hx_anonymous(array("roundUp" => 1, "roundDown" => 0, "round" => 0, "num" => 1, "div" => 4, "pos" => _hx_anonymous(array("fileName" => "TestInt64s.hx", "lineNumber" => 19, "className" => "thx.TestInt64s", "methodName" => "testRounding")))), _hx_anonymous(array("roundUp" => -2, "roundDown" => -3, "round" => -2, "num" => -5, "div" => 2, "pos" => _hx_anonymous(array("fileName" => "TestInt64s.hx", "lineNumber" => 21, "className" => "thx.TestInt64s", "methodName" => "testRounding")))), _hx_anonymous(array("roundUp" => 0, "roundDown" => -1, "round" => 0, "num" => -1, "div" => 4, "pos" => _hx_anonymous(array("fileName" => "TestInt64s.hx", "lineNumber" => 22, "className" => "thx.TestInt64s", "methodName" => "testRounding")))), _hx_anonymous(array("roundUp" => 0, "roundDown" => 0, "round" => 0, "num" => 0, "div" => -2, "pos" => _hx_anonymous(array("fileName" => "TestInt64s.hx", "lineNumber" => 24, "className" => "thx.TestInt64s", "methodName" => "testRounding")))), _hx_anonymous(array("roundUp" => -2, "roundDown" => -3, "round" => -2, "num" => 5, "div" => -2, "pos" => _hx_anonymous(array("fileName" => "TestInt64s.hx", "lineNumber" => 25, "className" => "thx.TestInt64s", "methodName" => "testRounding")))), _hx_anonymous(array("roundUp" => 0, "roundDown" => -1, "round" => 0, "num" => 1, "div" => -4, "pos" => _hx_anonymous(array("fileName" => "TestInt64s.hx", "lineNumber" => 26, "className" => "thx.TestInt64s", "methodName" => "testRounding")))))));
		$up = null;
		$down = null;
		$round = null;
		$num = null;
