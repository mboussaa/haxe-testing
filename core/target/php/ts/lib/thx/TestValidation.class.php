...
class thx_TestValidation {
	...
	public function testAp() {
		...
		utest_Assert::same($l1, $tmp, null, null, null, _hx_anonymous(array("fileName" => "TestValidation.hx", "lineNumber" => 29, "className" => "thx.TestValidation", "methodName" => "testAp")));
		$tmp1 = thx_Either::Right(1);
		$tmp2 = thx__Validation_Validation_Impl_::ap($rt, $rbi, (isset($this->add) ? $this->add: array($this, "add")));
		utest_Assert::same($tmp1, $tmp2, null, null, null, _hx_anonymous(array("fileName" => "TestValidation.hx", "lineNumber" => 30, "className" => "thx.TestValidation", "methodName" => "testAp")));
	}
	public function testVal4() {
		...
		utest_Assert::same($t, $tmp5, null, null, null, _hx_anonymous(array("fileName" => "TestValidation.hx", "lineNumber" => 40, "className" => "thx.TestValidation", "methodName" => "testVal4")));
		...
		utest_Assert::same($tmp6, $tmp12, null, null, null, _hx_anonymous(array("fileName" => "TestValidation.hx", "lineNumber" => 41, "className" => "thx.TestValidation", "methodName" => "testVal4")));
	}
	public function testVal4Nel() {
		...
		utest_Assert::same($tmp3, $tmp9, null, null, null, _hx_anonymous(array("fileName" => "TestValidation.hx", "lineNumber" => 48, "className" => "thx.TestValidation", "methodName" => "testVal4Nel")));
	}
