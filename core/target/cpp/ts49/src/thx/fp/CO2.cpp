...
void CO2_obj::__construct(::String v){
            	HX_STACK_FRAME("thx.fp.CO2","new",0x15ddd87e,"thx.fp.CO2.new","thx/fp/TestMap.hx",124,0xd5adc18e)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(v,"v")
HXLINE( 124)		this->v = v;
            	}
...
Int CO2_obj::compareTo( ::thx::fp::CO2 that){
            	HX_STACK_FRAME("thx.fp.CO2","compareTo",0x66a0881e,"thx.fp.CO2.compareTo","thx/fp/TestMap.hx",126,0xd5adc18e)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(that,"that")
HXLINE( 126)		return ::haxe::Utf8_obj::compare(this->v,that->v);
            	}
