...
void CO_obj::__construct(::String v){
            	HX_STACK_FRAME("thx.fp.CO","new",0x370af3d8,"thx.fp.CO.new","thx/fp/TestMap.hx",117,0xd5adc18e)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(v,"v")
HXLINE( 117)		this->v = v;
            	}
...
::hx::EnumBase CO_obj::compareTo( ::thx::fp::CO that){
            	HX_STACK_FRAME("thx.fp.CO","compareTo",0x899fa2f8,"thx.fp.CO.compareTo","thx/fp/TestMap.hx",119,0xd5adc18e)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(that,"that")
HXLINE( 119)		Int _hx_tmp = ::haxe::Utf8_obj::compare(this->v,that->v);
HXDLIN( 119)		return ::thx::_Ord::Ordering_Impl__obj::fromInt(_hx_tmp);
            	}
