...
HXLINE(  10)		::haxe::Log_obj::trace((HX_("The value of loop_wrapper is ",79,76,58,6c) + w),hx::SourceInfo(HX_("TS7.hx",e6,73,ba,84),10,HX_("TS7",d8,05,40,00),HX_("addTests",00,a6,f2,86)));
HXLINE(  12)		HX_VARI( Int,x) = ::Std_obj::parseInt(w);
HXLINE(  19)		runner->addCase( ::thx::TestChar_obj::__new(x),null(),null(),null(),null());
            	}
...
void TS7_obj::main(){
            	HX_STACK_FRAME("TS7","main",0x0268b28f,"TS7.main","TS7.hx",72,0x84ba73e6)
HXLINE(  73)		HX_VARI(  ::utest::Runner,runner) =  ::utest::Runner_obj::__new();
HXLINE(  74)		::TS7_obj::addTests(runner);
