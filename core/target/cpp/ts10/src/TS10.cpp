...
void TS10_obj::addTests( ::utest::Runner runner){
            	HX_STACK_FRAME("TS10","addTests",0x5b163e50,"TS10.addTests","TS10.hx",5,0x2b29d760)
...
HXLINE(  10)		::haxe::Log_obj::trace((HX_("The value of loop_wrapper is ",79,76,58,6c) + w),hx::SourceInfo(HX_("TS10.hx",60,d7,29,2b),10,HX_("TS10",1e,12,c5,37),HX_("addTests",00,a6,f2,86)));
HXLINE(  12)		HX_VARI( Int,x) = ::Std_obj::parseInt(w);
HXLINE(  22)		runner->addCase( ::thx::TestDates_obj::__new(x),null(),null(),null(),null());
            	}
...
void TS10_obj::main(){
            	HX_STACK_FRAME("TS10","main",0xae136889,"TS10.main","TS10.hx",72,0x2b29d760)
HXLINE(  73)		HX_VARI(  ::utest::Runner,runner) =  ::utest::Runner_obj::__new();
HXLINE(  74)		::TS10_obj::addTests(runner);
