...
void Lock_obj::__construct(){
            	HX_STACK_FRAME("cpp.vm.Lock","new",0x9e13fec9,"cpp.vm.Lock.new","/usr/lib/haxe/std/cpp/vm/Lock.hx",28,0x2d3e8808)
            	HX_STACK_THIS(this)
...
Bool Lock_obj::wait( ::Dynamic __o_timeout){
 ::Dynamic timeout = __o_timeout.Default(-1);
            	HX_STACK_FRAME("cpp.vm.Lock","wait",0xb95ac7ec,"cpp.vm.Lock.wait","/usr/lib/haxe/std/cpp/vm/Lock.hx",31,0x2d3e8808)
            	HX_STACK_THIS(this)
