...
void TestEffects_obj::__construct(Int i){
            	HX_STACK_FRAME("thx.TestEffects","new",0x83590f78,"thx.TestEffects.new","thx/TestEffects.hx",9,0x52fd26b9)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(i,"i")
HXLINE(   9)		this->x = i;
            	}
...
hx::ObjectPtr< TestEffects_obj > TestEffects_obj::__new(Int i)
{
...
void TestEffects_obj::logger( ::Dynamic msg, ::Dynamic infos){
            	HX_STACK_FRAME("thx.TestEffects","logger",0x7ed21678,"thx.TestEffects.logger","thx/TestEffects.hx",15,0x52fd26b9)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(msg,"msg")
            	HX_STACK_ARG(infos,"infos")
HXLINE(  15)		this->logged = msg;
            	}
...
void TestEffects_obj::setup(){
            	HX_STACK_FRAME("thx.TestEffects","setup",0xb854e395,"thx.TestEffects.setup","thx/TestEffects.hx",18,0x52fd26b9)
            	HX_STACK_THIS(this)
HXLINE(  19)		this->logged = null();
HXLINE(  20)		this->oldLogger = ::thx::Effects_obj::logger;
HXLINE(  21)		::thx::Effects_obj::logger = this->logger_dyn();
            	}
...
void TestEffects_obj::teardown(){
            	HX_STACK_FRAME("thx.TestEffects","teardown",0x80b4b3ec,"thx.TestEffects.teardown","thx/TestEffects.hx",25,0x52fd26b9)
            	HX_STACK_THIS(this)
HXLINE(  25)		::thx::Effects_obj::logger = this->oldLogger;
            	}
...
void TestEffects_obj::testEffectsLog(){
            	HX_STACK_FRAME("thx.TestEffects","testEffectsLog",0x2eaa9bbc,"thx.TestEffects.testEffectsLog","thx/TestEffects.hx",29,0x52fd26b9)
            	HX_STACK_THIS(this)
...
HXDLIN(  29)		while((_g1 < _g)){
            			...
            			void _hx_run( ::Dynamic a1){
            				HX_STACK_FRAME("thx.TestEffects","testEffectsLog",0x2eaa9bbc,"thx.TestEffects.testEffectsLog","thx/TestEffects.hx",32,0x52fd26b9)
            				HX_STACK_ARG(a1,"a1")
HXLINE(  32)				::thx::Effects_obj::logger(a1,a2);
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE(  29)			++_g1;
HXLINE(  30)			::utest::Assert_obj::isNull(this->logged,null(),hx::SourceInfo(HX_("TestEffects.hx",4e,fe,e1,11),30,HX_("thx.TestEffects",86,33,56,ea),HX_("testEffectsLog",d4,33,a3,67)));
HXLINE(  32)			HX_VARI(  ::Dynamic,a2) = hx::SourceInfo(HX_("TestEffects.hx",4e,fe,e1,11),32,HX_("thx.TestEffects",86,33,56,ea),HX_("testEffectsLog",d4,33,a3,67));
HXDLIN(  32)			 ::Dynamic(new _hx_Closure_0(a2))((int)2);
HXLINE(  33)			::utest::Assert_obj::equals((int)2,(int)2,null(),hx::SourceInfo(HX_("TestEffects.hx",4e,fe,e1,11),33,HX_("thx.TestEffects",86,33,56,ea),HX_("testEffectsLog",d4,33,a3,67)));
HXLINE(  34)			::utest::Assert_obj::equals((int)2,this->logged,null(),hx::SourceInfo(HX_("TestEffects.hx",4e,fe,e1,11),34,HX_("thx.TestEffects",86,33,56,ea),HX_("testEffectsLog",d4,33,a3,67)));
            		}
            	}
...
static hx::StorageInfo TestEffects_obj_sMemberStorageInfo[] = {
	{hx::fsInt,(int)offsetof(TestEffects_obj,x),HX_HCSTRING("x","\x78","\x00","\x00","\x00")},
