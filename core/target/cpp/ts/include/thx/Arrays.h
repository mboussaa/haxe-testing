...
class HXCPP_CLASS_ATTRIBUTES Arrays_obj : public hx::Object
{
	...
	public:
		...
		static  ::haxe::ds::IntMap groupBy_Int_thx__TestArrays_Sample(::Array< ::Dynamic> arr, ::Dynamic resolver);
		static ::Dynamic groupBy_Int_thx__TestArrays_Sample_dyn();

		static  ::haxe::ds::IntMap groupBy_Int_Array_Int(::Array< ::Dynamic> arr, ::Dynamic resolver);
		static ::Dynamic groupBy_Int_Array_Int_dyn();

		static  ::haxe::ds::IntMap groupBy_Int_Float(::Array< Float > arr, ::Dynamic resolver);
		static ::Dynamic groupBy_Int_Float_dyn();

		static  ::haxe::ds::IntMap count_Int(::Array< Int > arr);
		static ::Dynamic count_Int_dyn();
