...
::thx::_TestAssert::Sample Sample_obj::None;

::thx::_TestAssert::Sample Sample_obj::Rec(::hx::EnumBase s)
{
	return hx::CreateEnum< Sample_obj >(HX_("Rec",30,91,3e,00),2,1)->_hx_init(0,s);
}

::thx::_TestAssert::Sample Sample_obj::Some(::String s)
{
...
hx::Static(__mClass) = hx::_hx_RegisterClass(HX_HCSTRING("thx._TestAssert.Sample","\x8b","\xaf","\x8b","\x32"), hx::TCanCast< Sample_obj >,Sample_obj_sStaticFields,0,
