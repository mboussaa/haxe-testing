...
void TestItem_obj::__construct(Int code){
            	HX_STACK_FRAME("thx.TestItem","new",0x5dd98841,"thx.TestItem.new","thx/TestHashSet.hx",156,0xd1666e47)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(code,"code")
HXLINE( 156)		this->code = code;
            	}
...
Int TestItem_obj::hashCode(){
            	HX_STACK_FRAME("thx.TestItem","hashCode",0xcd24249a,"thx.TestItem.hashCode","thx/TestHashSet.hx",160,0xd1666e47)
            	HX_STACK_THIS(this)
HXLINE( 160)		return this->code;
            	}
...
::String TestItem_obj::toString(){
            	HX_STACK_FRAME("thx.TestItem","toString",0xfe1de92b,"thx.TestItem.toString","thx/TestHashSet.hx",164,0xd1666e47)
            	HX_STACK_THIS(this)
HXLINE( 164)		return (HX_("TestItem ",db,c9,e1,2c) + this->code);
            	}
