...
void Utf8_obj::__construct( ::Dynamic size){
            	HX_STACK_FRAME("haxe.Utf8","new",0x67cc940b,"haxe.Utf8.new","/usr/lib/haxe/std/cpp/_std/haxe/Utf8.hx",31,0xa94b1f82)
            	HX_STACK_THIS(this)
...
HXLINE(  34)			this->__s[(size - (int)1)] = (int)0;
            		}
            	}
...
::String Utf8_obj::toString(){
            	HX_STACK_FRAME("haxe.Utf8","toString",0xb459e121,"haxe.Utf8.toString","/usr/lib/haxe/std/cpp/_std/haxe/Utf8.hx",42,0xa94b1f82)
            	HX_STACK_THIS(this)
...
Int Utf8_obj::charCodeAt(::String s,Int index){
            	HX_STACK_FRAME("haxe.Utf8","charCodeAt",0xce7cbeab,"haxe.Utf8.charCodeAt","/usr/lib/haxe/std/cpp/_std/haxe/Utf8.hx",66,0xa94b1f82)
            	HX_STACK_ARG(s,"s")
...
Int Utf8_obj::compare(::String a,::String b){
            	HX_STACK_FRAME("haxe.Utf8","compare",0x9f848dd0,"haxe.Utf8.compare","/usr/lib/haxe/std/cpp/_std/haxe/Utf8.hx",78,0xa94b1f82)
            	HX_STACK_ARG(a,"a")
            	HX_STACK_ARG(b,"b")
...
::String Utf8_obj::sub(::String s,Int pos,Int len){
            	HX_STACK_FRAME("haxe.Utf8","sub",0x67d06d2b,"haxe.Utf8.sub","/usr/lib/haxe/std/cpp/_std/haxe/Utf8.hx",82,0xa94b1f82)
            	HX_STACK_ARG(s,"s")
