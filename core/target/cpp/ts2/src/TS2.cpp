...
void TS2_obj::addTests( ::utest::Runner runner){
            	HX_STACK_FRAME("TS2","addTests",0x57cbabfb,"TS2.addTests","TS2.hx",5,0x816c62cb)
...
HXLINE(  10)		::haxe::Log_obj::trace((HX_("The value of loop_wrapper is ",79,76,58,6c) + w),hx::SourceInfo(HX_("TS2.hx",cb,62,6c,81),10,HX_("TS2",d3,05,40,00),HX_("addTests",00,a6,f2,86)));
HXLINE(  12)		HX_VARI( Int,x) = ::Std_obj::parseInt(w);
HXLINE(  14)		runner->addCase( ::thx::fp::TestWriter_obj::__new(x),null(),null(),null(),null());
            	}
...
void TS2_obj::main(){
            	HX_STACK_FRAME("TS2","main",0x029fe4b4,"TS2.main","TS2.hx",73,0x816c62cb)
HXLINE(  74)		HX_VARI(  ::utest::Runner,runner) =  ::utest::Runner_obj::__new();
HXLINE(  75)		::TS2_obj::addTests(runner);
