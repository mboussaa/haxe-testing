...
void TS16_obj::addTests( ::utest::Runner runner){
            	HX_STACK_FRAME("TS16","addTests",0xdcd50d8a,"TS16.addTests","TS16.hx",5,0x2f211f1a)
...
HXLINE(  10)		::haxe::Log_obj::trace((HX_("The value of loop_wrapper is ",79,76,58,6c) + w),hx::SourceInfo(HX_("TS16.hx",1a,1f,21,2f),10,HX_("TS16",24,12,c5,37),HX_("addTests",00,a6,f2,86)));
HXLINE(  12)		HX_VARI( Int,x) = ::Std_obj::parseInt(w);
HXLINE(  28)		runner->addCase( ::thx::TestEithers_obj::__new(x),null(),null(),null(),null());
            	}
...
void TS16_obj::main(){
            	HX_STACK_FRAME("TS16","main",0x143792c3,"TS16.main","TS16.hx",72,0x2f211f1a)
HXLINE(  73)		HX_VARI(  ::utest::Runner,runner) =  ::utest::Runner_obj::__new();
HXLINE(  74)		::TS16_obj::addTests(runner);
