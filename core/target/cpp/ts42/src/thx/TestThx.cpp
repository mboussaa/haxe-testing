...
void TestThx_obj::__construct(Int i){
            	HX_STACK_FRAME("thx.TestThx","new",0x5fb2e23a,"thx.TestThx.new","thx/TestThx.hx",9,0xa97a2db7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(i,"i")
HXLINE(   9)		this->x = i;
            	}
...
hx::ObjectPtr< TestThx_obj > TestThx_obj::__new(Int i)
{
...
void TestThx_obj::testUsing(){
            	HX_STACK_FRAME("thx.TestThx","testUsing",0x7a00a4ec,"thx.TestThx.testUsing","thx/TestThx.hx",13,0xa97a2db7)
            	HX_STACK_THIS(this)
HXLINE(  13)		HX_VARI( Int,_g1) = (int)0;
HXDLIN(  13)		HX_VARI( Int,_g) = this->x;
HXDLIN(  13)		while((_g1 < _g)){
HXLINE(  13)			++_g1;
HXLINE(  14)			::String _hx_tmp = ::thx::Strings_obj::humanize(HX_("ThxUsing",40,e2,7b,e1));
HXDLIN(  14)			::utest::Assert_obj::equals(HX_("thx using",a8,9c,92,c5),_hx_tmp,null(),hx::SourceInfo(HX_("TestThx.hx",cc,56,2c,a2),14,HX_("thx.TestThx",48,fd,5a,36),HX_("testUsing",92,b3,37,73)));
            		}
            	}
...
hx::Val TestThx_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 1:
...
void TestThx_obj::__GetFields(Array< ::String> &outFields)
{
...
#if HXCPP_SCRIPTABLE
static hx::StorageInfo TestThx_obj_sMemberStorageInfo[] = {
	{hx::fsInt,(int)offsetof(TestThx_obj,x),HX_HCSTRING("x","\x78","\x00","\x00","\x00")},
	{ hx::fsUnknown, 0, null()}
};
