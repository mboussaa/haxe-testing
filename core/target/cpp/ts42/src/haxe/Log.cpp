...
void _hx_run( ::Dynamic v, ::Dynamic infos){
            	HX_STACK_FRAME("haxe.Log","__default_trace",0xe2f5e5d5,"haxe.Log.__default_trace","/usr/lib/haxe/std/haxe/Log.hx",73,0x3a211262)
            	HX_STACK_ARG(v,"v")
            	HX_STACK_ARG(infos,"infos")
HXLINE(  73)		Bool _hx_tmp;
HXDLIN(  73)		if (hx::IsNotNull( infos )) {
...
HXDLIN(  75)					++_g;
HXLINE(  76)					::String _hx_tmp1 = ::Std_obj::string(v1);
HXDLIN(  76)					hx::AddEq(extra,(HX_(",",2c,00,00,00) + _hx_tmp1));
            				}
            			}
