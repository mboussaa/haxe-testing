...
void TestState_obj::__construct(Int i){
            	HX_STACK_FRAME("thx.fp.TestState","new",0xb1b289b7,"thx.fp.TestState.new","thx/fp/TestState.hx",11,0xa7910039)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(i,"i")
HXLINE(  11)		this->x = i;
            	}
...
hx::ObjectPtr< TestState_obj > TestState_obj::__new(Int i)
{
...
void TestState_obj::testMap(){
            	HX_STACK_FRAME("thx.fp.TestState","testMap",0xaf4d2a41,"thx.fp.TestState.testMap","thx/fp/TestState.hx",15,0xa7910039)
            	HX_STACK_THIS(this)
...
HXDLIN(  15)		while((_g1 < _g)){
            			...
            			Int _hx_run(Int v){
            				HX_STACK_FRAME("thx.fp.TestState","testMap",0xaf4d2a41,"thx.fp.TestState.testMap","thx/fp/TestState.hx",16,0xa7910039)
            				HX_STACK_ARG(v,"v")
HXLINE(  16)				return (v + (int)1);
            			}
            			...
            			HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_1, ::Dynamic,this1, ::Dynamic,f) HXARGC(1)
            			 ::Dynamic _hx_run(::String s1){
            				HX_STACK_FRAME("thx.fp.TestState","testMap",0xaf4d2a41,"thx.fp.TestState.testMap","thx/fp/TestState.hx",16,0xa7910039)
            				HX_STACK_ARG(s1,"s1")
HXLINE(  16)				 ::Dynamic _hx_tmp = this1(s1);
HXDLIN(  16)				return ::thx::_Tuple::Tuple2_Impl__obj::map(_hx_tmp,f);
            			}
            			HX_END_LOCAL_FUNC1(return)

HXLINE(  15)			++_g1;
HXLINE(  16)			HX_VARI_NAME(  ::Dynamic,this1,"this") = ::thx::fp::_State::State_Impl__obj::pure((int)1);
HXDLIN(  16)			HX_VARI(  ::Dynamic,f) =  ::Dynamic(new _hx_Closure_0());
HXDLIN(  16)			HX_VARI(  ::Dynamic,s) =  ::Dynamic(new _hx_Closure_1(this1,f));
HXLINE(  17)			 ::Dynamic _hx_tmp1 =  ::Dynamic(hx::Anon_obj::Create(2)
            				->setFixed(0,HX_("_0",f1,52,00,00),HX_("a",61,00,00,00))
            				->setFixed(1,HX_("_1",f2,52,00,00),(int)2));
HXDLIN(  17)			 ::Dynamic _hx_tmp2 = s(HX_("a",61,00,00,00));
HXDLIN(  17)			::utest::Assert_obj::same(_hx_tmp1,_hx_tmp2,null(),null(),null(),hx::SourceInfo(HX_("TestState.hx",df,9f,7b,9a),17,HX_("thx.fp.TestState",45,e2,b7,a1),HX_("testMap",6a,79,c1,bd)));
            		}
            	}
...
void TestState_obj::testFlatMap(){
            	HX_STACK_FRAME("thx.fp.TestState","testFlatMap",0x07f16688,"thx.fp.TestState.testFlatMap","thx/fp/TestState.hx",21,0xa7910039)
            	HX_STACK_THIS(this)
            			...
            			HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_hx_Closure_3, ::Dynamic,s) HXARGC(1)
            			 ::Dynamic _hx_run(Int i){
            				...
            				::String _hx_run(::String v){
            					HX_STACK_FRAME("thx.fp.TestState","testFlatMap",0x07f16688,"thx.fp.TestState.testFlatMap","thx/fp/TestState.hx",25,0xa7910039)
            					HX_STACK_ARG(v,"v")
HXLINE(  25)					return (v + HX_("b",62,00,00,00));
            				}
            				HX_END_LOCAL_FUNC1(return)
...
HXLINE(  25)					return (v1 + i);
            				...
            				HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_2, ::Dynamic,this1, ::Dynamic,f1) HXARGC(1)
            				 ::Dynamic _hx_run(::String s1){
            					HX_STACK_FRAME("thx.fp.TestState","testFlatMap",0x07f16688,"thx.fp.TestState.testFlatMap","thx/fp/TestState.hx",25,0xa7910039)
            					HX_STACK_ARG(s1,"s1")
HXLINE(  25)					 ::Dynamic _hx_tmp = this1(s1);
HXDLIN(  25)					return ::thx::_Tuple::Tuple2_Impl__obj::map(_hx_tmp,f1);
            				}
            				HX_END_LOCAL_FUNC1(return)

            				HX_STACK_FRAME("thx.fp.TestState","testFlatMap",0x07f16688,"thx.fp.TestState.testFlatMap","thx/fp/TestState.hx",25,0xa7910039)
            				HX_STACK_ARG(i,"i")
HXLINE(  25)				HX_VARI_NAME(  ::Dynamic,this1,"this") = ::thx::fp::_State::State_Impl__obj::modify(s, ::Dynamic(new _hx_Closure_0()));
HXDLIN(  25)				HX_VARI_NAME(  ::Dynamic,f1,"f") =  ::Dynamic(new _hx_Closure_1(i));
HXDLIN(  25)				return  ::Dynamic(new _hx_Closure_2(this1,f1));
            			}
            			HX_END_LOCAL_FUNC1(return)

HXLINE(  21)			++_g1;
HXLINE(  22)			HX_VARI(  ::Dynamic,s) = ::thx::fp::_State::State_Impl__obj::pure((int)1);
HXLINE(  24)			HX_VARI(  ::Dynamic,f) =  ::Dynamic(new _hx_Closure_3(s));
HXLINE(  28)			 ::Dynamic _hx_tmp1 =  ::Dynamic(hx::Anon_obj::Create(2)
            				->setFixed(0,HX_("_0",f1,52,00,00),HX_("ab",e1,54,00,00))
            				->setFixed(1,HX_("_1",f2,52,00,00),(int)2));
HXDLIN(  28)			 ::Dynamic _hx_tmp2 = ::thx::fp::_State::State_Impl__obj::flatMap(s,f);
HXDLIN(  28)			 ::Dynamic _hx_tmp3 = _hx_tmp2(HX_("a",61,00,00,00));
HXDLIN(  28)			::utest::Assert_obj::same(_hx_tmp1,_hx_tmp3,null(),null(),null(),hx::SourceInfo(HX_("TestState.hx",df,9f,7b,9a),28,HX_("thx.fp.TestState",45,e2,b7,a1),HX_("testFlatMap",31,fe,a6,a3)));
            		}
            	}
...
static hx::StorageInfo TestState_obj_sMemberStorageInfo[] = {
	{hx::fsInt,(int)offsetof(TestState_obj,x),HX_HCSTRING("x","\x78","\x00","\x00","\x00")},
	{ hx::fsUnknown, 0, null()}
};
