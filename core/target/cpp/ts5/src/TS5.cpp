...
void TS5_obj::addTests( ::utest::Runner runner){
            	HX_STACK_FRAME("TS5","addTests",0x98ab1398,"TS5.addTests","TS5.hx",5,0x836806a8)
...
HXLINE(  10)		::haxe::Log_obj::trace((HX_("The value of loop_wrapper is ",79,76,58,6c) + w),hx::SourceInfo(HX_("TS5.hx",a8,06,68,83),10,HX_("TS5",d6,05,40,00),HX_("addTests",00,a6,f2,86)));
HXLINE(  12)		HX_VARI( Int,x) = ::Std_obj::parseInt(w);
HXLINE(  17)		runner->addCase( ::thx::TestBitMatrix_obj::__new(x),null(),null(),null(),null());
            	}
...
void TS5_obj::main(){
            	HX_STACK_FRAME("TS5","main",0x35b1f9d1,"TS5.main","TS5.hx",72,0x836806a8)
HXLINE(  73)		HX_VARI(  ::utest::Runner,runner) =  ::utest::Runner_obj::__new();
HXLINE(  74)		::TS5_obj::addTests(runner);
