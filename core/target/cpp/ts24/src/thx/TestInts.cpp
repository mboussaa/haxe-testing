...
void TestInts_obj::__construct(Int i){
            	HX_STACK_FRAME("thx.TestInts","new",0xd81aa452,"thx.TestInts.new","thx/TestInts.hx",14,0x1dfb38fd)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(i,"i")
HXLINE(  14)		this->x = i;
            	}
...
hx::ObjectPtr< TestInts_obj > TestInts_obj::__new(Int i)
{
...
void TestInts_obj::testRange(){
            	HX_STACK_FRAME("thx.TestInts","testRange",0x1d93397d,"thx.TestInts.testRange","thx/TestInts.hx",18,0x1dfb38fd)
            	HX_STACK_THIS(this)
HXLINE(  18)		HX_VARI( Int,_g1) = (int)0;
HXDLIN(  18)		HX_VARI( Int,_g) = this->x;
HXDLIN(  18)		while((_g1 < _g)){
HXLINE(  18)			++_g1;
HXLINE(  19)			HX_VARI( ::Array< Int >,range) = ::thx::Ints_obj::range((int)2,(int)7,(int)1);
HXLINE(  20)			::utest::Assert_obj::same(::cpp::VirtualArray_obj::__new(5)->init(0,(int)2)->init(1,(int)3)->init(2,(int)4)->init(3,(int)5)->init(4,(int)6),range,null(),null(),null(),hx::SourceInfo(HX_("TestInts.hx",48,02,2d,c1),20,HX_("thx.TestInts",60,d3,01,52),HX_("testRange",0b,e4,21,ad)));
HXLINE(  21)			range = ::thx::Ints_obj::range((int)2,(int)7,(int)2);
HXLINE(  22)			::utest::Assert_obj::same(::cpp::VirtualArray_obj::__new(3)->init(0,(int)2)->init(1,(int)4)->init(2,(int)6),range,null(),null(),null(),hx::SourceInfo(HX_("TestInts.hx",48,02,2d,c1),22,HX_("thx.TestInts",60,d3,01,52),HX_("testRange",0b,e4,21,ad)));
HXLINE(  23)			range = ::thx::Ints_obj::range((int)2,(int)7,(int)3);
HXLINE(  24)			::utest::Assert_obj::same(::cpp::VirtualArray_obj::__new(2)->init(0,(int)2)->init(1,(int)5),range,null(),null(),null(),hx::SourceInfo(HX_("TestInts.hx",48,02,2d,c1),24,HX_("thx.TestInts",60,d3,01,52),HX_("testRange",0b,e4,21,ad)));
HXLINE(  26)			range = ::thx::Ints_obj::range((int)7,(int)2,(int)-2);
HXLINE(  27)			::utest::Assert_obj::same(::cpp::VirtualArray_obj::__new(3)->init(0,(int)7)->init(1,(int)5)->init(2,(int)3),range,null(),null(),null(),hx::SourceInfo(HX_("TestInts.hx",48,02,2d,c1),27,HX_("thx.TestInts",60,d3,01,52),HX_("testRange",0b,e4,21,ad)));
            		}
            	}
...
void TestInts_obj::testParse(){
            	HX_STACK_FRAME("thx.TestInts","testParse",0xf6c923f3,"thx.TestInts.testParse","thx/TestInts.hx",31,0x1dfb38fd)
            	HX_STACK_THIS(this)
HXLINE(  31)		HX_VARI( Int,_g1) = (int)0;
HXDLIN(  31)		HX_VARI( Int,_g) = this->x;
HXDLIN(  31)		while((_g1 < _g)){
HXLINE(  31)			++_g1;
HXLINE(  32)			HX_VARI( ::Array< ::Dynamic>,tests) = ::Array_obj< ::Dynamic>::__new(23)->init(0, ::Dynamic(hx::Anon_obj::Create(3)
...
HXLINE(  59)			{
HXLINE(  59)				HX_VARI( Int,_g2) = (int)0;
HXDLIN(  59)				while((_g2 < tests->length)){
HXLINE(  59)					HX_VARI(  ::Dynamic,test) = tests->__get(_g2);
HXDLIN(  59)					++_g2;
HXLINE(  60)					Bool _hx_tmp = ::thx::Ints_obj::canParse( ::Dynamic(test->__Field(HX_("t",74,00,00,00),hx::paccDynamic)));
HXDLIN(  60)					::utest::Assert_obj::isTrue(_hx_tmp,(HX_("Ints.parse should not be able to parse ",c6,47,b5,7b) + ( (::String)(test->__Field(HX_("t",74,00,00,00),hx::paccDynamic)) )),hx::SourceInfo(HX_("TestInts.hx",48,02,2d,c1),60,HX_("thx.TestInts",60,d3,01,52),HX_("testParse",81,ce,57,86)));
HXLINE(  61)					Int _hx_tmp1 = ( (Int)(test->__Field(HX_("e",65,00,00,00),hx::paccDynamic)) );
HXDLIN(  61)					 ::Dynamic _hx_tmp2 = ::thx::Ints_obj::parse( ::Dynamic(test->__Field(HX_("t",74,00,00,00),hx::paccDynamic)), ::Dynamic(test->__Field(HX_("b",62,00,00,00),hx::paccDynamic)));
HXDLIN(  61)					::String _hx_tmp3 = ((((((HX_("expected ",a8,7a,f8,e9) + ( (Int)(test->__Field(HX_("e",65,00,00,00),hx::paccDynamic)) )) + HX_(" converting \"",b1,e6,bf,15)) + ( (::String)(test->__Field(HX_("t",74,00,00,00),hx::paccDynamic)) )) + HX_("\" with base ",93,68,95,07)) + ( (Int)(test->__Field(HX_("b",62,00,00,00),hx::paccDynamic)) )) + HX_(" but got ",b3,1a,6e,57));
HXDLIN(  61)					 ::Dynamic _hx_tmp4 = ::thx::Ints_obj::parse( ::Dynamic(test->__Field(HX_("t",74,00,00,00),hx::paccDynamic)), ::Dynamic(test->__Field(HX_("b",62,00,00,00),hx::paccDynamic)));
HXDLIN(  61)					::utest::Assert_obj::equals(_hx_tmp1,_hx_tmp2,(_hx_tmp3 + _hx_tmp4),hx::SourceInfo(HX_("TestInts.hx",48,02,2d,c1),61,HX_("thx.TestInts",60,d3,01,52),HX_("testParse",81,ce,57,86)));
            				}
            			}
            		}
            	}
...
void TestInts_obj::testToString(){
            	HX_STACK_FRAME("thx.TestInts","testToString",0xd22214ec,"thx.TestInts.testToString","thx/TestInts.hx",66,0x1dfb38fd)
            	HX_STACK_THIS(this)
HXLINE(  66)		HX_VARI( Int,_g1) = (int)0;
HXDLIN(  66)		HX_VARI( Int,_g) = this->x;
HXDLIN(  66)		while((_g1 < _g)){
HXLINE(  66)			++_g1;
HXLINE(  67)			HX_VARI( ::Array< ::Dynamic>,tests) = ::Array_obj< ::Dynamic>::__new(4)->init(0, ::Dynamic(hx::Anon_obj::Create(3)
            				->setFixed(0,HX_("b",62,00,00,00),(int)2)
...
HXDLIN(  74)				while((_g2 < tests->length)){
HXLINE(  74)					HX_VARI(  ::Dynamic,test) = tests->__get(_g2);
HXDLIN(  74)					++_g2;
HXLINE(  75)					::String _hx_tmp = ::thx::Ints_obj::toString( ::Dynamic(test->__Field(HX_("t",74,00,00,00),hx::paccDynamic)), ::Dynamic(test->__Field(HX_("b",62,00,00,00),hx::paccDynamic)));
HXDLIN(  75)					::utest::Assert_obj::equals( ::Dynamic(test->__Field(HX_("e",65,00,00,00),hx::paccDynamic)),_hx_tmp,null(),hx::SourceInfo(HX_("TestInts.hx",48,02,2d,c1),75,HX_("thx.TestInts",60,d3,01,52),HX_("testToString",1e,f7,75,ab)));
            				}
            			}
            		}
            	}
...
hx::Val TestInts_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 1:
...
void TestInts_obj::__GetFields(Array< ::String> &outFields)
{
...
#if HXCPP_SCRIPTABLE
static hx::StorageInfo TestInts_obj_sMemberStorageInfo[] = {
	{hx::fsInt,(int)offsetof(TestInts_obj,x),HX_HCSTRING("x","\x78","\x00","\x00","\x00")},
	{ hx::fsUnknown, 0, null()}
};
