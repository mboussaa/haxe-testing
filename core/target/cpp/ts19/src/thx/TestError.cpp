...
void TestError_obj::__construct(Int i){
            	HX_STACK_FRAME("thx.TestError","new",0xe899787e,"thx.TestError.new","thx/TestError.hx",11,0xf1d81e33)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(i,"i")
HXLINE(  11)		this->x = i;
            	}
...
hx::ObjectPtr< TestError_obj > TestError_obj::__new(Int i)
{
...
void TestError_obj::testAbstract(){
            	HX_STACK_FRAME("thx.TestError","testAbstract",0xea054b76,"thx.TestError.testAbstract","thx/TestError.hx",15,0xf1d81e33)
            	HX_STACK_THIS(this)
HXLINE(  15)		HX_VARI( Int,_g1) = (int)0;
HXDLIN(  15)		HX_VARI( Int,_g) = this->x;
HXDLIN(  15)		while((_g1 < _g)){
HXLINE(  15)			++_g1;
HXLINE(  16)			HX_VARI(  ::thx::error::AbstractMethod,error) =  ::thx::error::AbstractMethod_obj::__new(hx::SourceInfo(HX_("TestError.hx",88,76,36,1a),16,HX_("thx.TestError",8c,21,a0,24),HX_("testAbstract",54,e7,85,1b)));
HXLINE(  18)			::utest::Assert_obj::notNull(error,null(),hx::SourceInfo(HX_("TestError.hx",88,76,36,1a),18,HX_("thx.TestError",8c,21,a0,24),HX_("testAbstract",54,e7,85,1b)));
HXLINE(  19)			::utest::Assert_obj::stringContains(HX_("TestError",f6,e9,fe,dd),error->message,null(),hx::SourceInfo(HX_("TestError.hx",88,76,36,1a),19,HX_("thx.TestError",8c,21,a0,24),HX_("testAbstract",54,e7,85,1b)));
HXLINE(  20)			::utest::Assert_obj::stringContains(HX_("testAbstract",54,e7,85,1b),error->message,null(),hx::SourceInfo(HX_("TestError.hx",88,76,36,1a),20,HX_("thx.TestError",8c,21,a0,24),HX_("testAbstract",54,e7,85,1b)));
HXLINE(  21)			::utest::Assert_obj::stringContains(HX_("is abstract",d8,b7,59,43),error->message,null(),hx::SourceInfo(HX_("TestError.hx",88,76,36,1a),21,HX_("thx.TestError",8c,21,a0,24),HX_("testAbstract",54,e7,85,1b)));
            		}
            	}
...
void TestError_obj::testNotImplemented(){
            	HX_STACK_FRAME("thx.TestError","testNotImplemented",0xed8cec03,"thx.TestError.testNotImplemented","thx/TestError.hx",25,0xf1d81e33)
            	HX_STACK_THIS(this)
HXLINE(  25)		HX_VARI( Int,_g1) = (int)0;
HXDLIN(  25)		HX_VARI( Int,_g) = this->x;
HXDLIN(  25)		while((_g1 < _g)){
HXLINE(  25)			++_g1;
HXLINE(  26)			HX_VARI(  ::thx::error::NotImplemented,error) =  ::thx::error::NotImplemented_obj::__new(hx::SourceInfo(HX_("TestError.hx",88,76,36,1a),26,HX_("thx.TestError",8c,21,a0,24),HX_("testNotImplemented",61,c2,90,cd)));
HXLINE(  28)			::utest::Assert_obj::notNull(error,null(),hx::SourceInfo(HX_("TestError.hx",88,76,36,1a),28,HX_("thx.TestError",8c,21,a0,24),HX_("testNotImplemented",61,c2,90,cd)));
HXLINE(  29)			::utest::Assert_obj::stringContains(HX_("TestError",f6,e9,fe,dd),error->message,null(),hx::SourceInfo(HX_("TestError.hx",88,76,36,1a),29,HX_("thx.TestError",8c,21,a0,24),HX_("testNotImplemented",61,c2,90,cd)));
HXLINE(  30)			::utest::Assert_obj::stringContains(HX_("testNotImplemented",61,c2,90,cd),error->message,null(),hx::SourceInfo(HX_("TestError.hx",88,76,36,1a),30,HX_("thx.TestError",8c,21,a0,24),HX_("testNotImplemented",61,c2,90,cd)));
HXLINE(  31)			::utest::Assert_obj::stringContains(HX_("needs to be implemented",67,1e,47,5c),error->message,null(),hx::SourceInfo(HX_("TestError.hx",88,76,36,1a),31,HX_("thx.TestError",8c,21,a0,24),HX_("testNotImplemented",61,c2,90,cd)));
            		}
            	}
...
void TestError_obj::testNullArgument(){
            	HX_STACK_FRAME("thx.TestError","testNullArgument",0x22678cb8,"thx.TestError.testNullArgument","thx/TestError.hx",34,0xf1d81e33)
            	HX_STACK_THIS(this)
...
HXDLIN(  35)			while((_g1 < _g)){
            				...
            				void _hx_run(){
            					HX_STACK_FRAME("thx.TestError","testNullArgument",0x22678cb8,"thx.TestError.testNullArgument","thx/TestError.hx",36,0xf1d81e33)
HXLINE(  36)					_gthis->nullInt(null());
            				}
            				HX_END_LOCAL_FUNC0((void))

HXLINE(  35)				++_g1;
HXLINE(  36)				::utest::Assert_obj::raises( ::Dynamic(new _hx_Closure_0(_gthis)),hx::ClassOf< ::thx::error::NullArgument >(),null(),null(),hx::SourceInfo(HX_("TestError.hx",88,76,36,1a),36,HX_("thx.TestError",8c,21,a0,24),HX_("testNullArgument",96,6f,c6,02)));
HXLINE(  37)				this->nullInt((int)1);
            			}
            		}
            	}
...
void TestError_obj::testNullArgumentUsing(){
            	HX_STACK_FRAME("thx.TestError","testNullArgumentUsing",0x8dca3d6c,"thx.TestError.testNullArgumentUsing","thx/TestError.hx",40,0xf1d81e33)
            	HX_STACK_THIS(this)
HXLINE(  40)		HX_VARI(  ::thx::TestError,_gthis) = hx::ObjectPtr<OBJ_>(this);
HXLINE(  41)		{
...
HXDLIN(  41)			while((_g1 < _g)){
            				HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_hx_Closure_0, ::thx::TestError,_gthis) HXARGC(0)
            				void _hx_run(){
            					HX_STACK_FRAME("thx.TestError","testNullArgumentUsing",0x8dca3d6c,"thx.TestError.testNullArgumentUsing","thx/TestError.hx",42,0xf1d81e33)
HXLINE(  42)					_gthis->nullUsingInt(null());
            				}
            				HX_END_LOCAL_FUNC0((void))

HXLINE(  41)				++_g1;
HXLINE(  42)				::utest::Assert_obj::raises( ::Dynamic(new _hx_Closure_0(_gthis)),hx::ClassOf< ::thx::error::NullArgument >(),null(),null(),hx::SourceInfo(HX_("TestError.hx",88,76,36,1a),42,HX_("thx.TestError",8c,21,a0,24),HX_("testNullArgumentUsing",ce,35,72,03)));
HXLINE(  43)				this->nullUsingInt((int)1);
            			}
            		}
            	}
...
void TestError_obj::testEmptyArray(){
            	HX_STACK_FRAME("thx.TestError","testEmptyArray",0x3e0f9b60,"thx.TestError.testEmptyArray","thx/TestError.hx",46,0xf1d81e33)
            	HX_STACK_THIS(this)
HXLINE(  46)		HX_VARI(  ::thx::TestError,_gthis) = hx::ObjectPtr<OBJ_>(this);
HXLINE(  47)		{
...
HXDLIN(  47)			while((_g1 < _g)){
            				HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_hx_Closure_0, ::thx::TestError,_gthis) HXARGC(0)
            				void _hx_run(){
            					HX_STACK_FRAME("thx.TestError","testEmptyArray",0x3e0f9b60,"thx.TestError.testEmptyArray","thx/TestError.hx",48,0xf1d81e33)
HXLINE(  48)					_gthis->emptyArray(null());
            				}
            				HX_END_LOCAL_FUNC0((void))

            				HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_hx_Closure_1, ::thx::TestError,_gthis) HXARGC(0)
            				void _hx_run(){
            					HX_STACK_FRAME("thx.TestError","testEmptyArray",0x3e0f9b60,"thx.TestError.testEmptyArray","thx/TestError.hx",49,0xf1d81e33)
HXLINE(  49)					_gthis->emptyArray(::Array_obj< Int >::__new(0));
            				}
            				HX_END_LOCAL_FUNC0((void))

HXLINE(  47)				++_g1;
HXLINE(  48)				::utest::Assert_obj::raises( ::Dynamic(new _hx_Closure_0(_gthis)),hx::ClassOf< ::thx::error::NullArgument >(),null(),null(),hx::SourceInfo(HX_("TestError.hx",88,76,36,1a),48,HX_("thx.TestError",8c,21,a0,24),HX_("testEmptyArray",be,6a,d5,45)));
HXLINE(  49)				::utest::Assert_obj::raises( ::Dynamic(new _hx_Closure_1(_gthis)),hx::ClassOf< ::thx::error::NullArgument >(),null(),null(),hx::SourceInfo(HX_("TestError.hx",88,76,36,1a),49,HX_("thx.TestError",8c,21,a0,24),HX_("testEmptyArray",be,6a,d5,45)));
HXLINE(  50)				this->emptyArray(::Array_obj< Int >::__new(1)->init(0,(int)1));
            			}
            		}
            	}
...
void TestError_obj::testEmptyString(){
            	HX_STACK_FRAME("thx.TestError","testEmptyString",0x68d8092a,"thx.TestError.testEmptyString","thx/TestError.hx",53,0xf1d81e33)
            	HX_STACK_THIS(this)
HXLINE(  53)		HX_VARI(  ::thx::TestError,_gthis) = hx::ObjectPtr<OBJ_>(this);
HXLINE(  54)		{
...
HXDLIN(  54)			while((_g1 < _g)){
            				HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_hx_Closure_0, ::thx::TestError,_gthis) HXARGC(0)
            				void _hx_run(){
            					HX_STACK_FRAME("thx.TestError","testEmptyString",0x68d8092a,"thx.TestError.testEmptyString","thx/TestError.hx",55,0xf1d81e33)
HXLINE(  55)					_gthis->emptyString(null());
            				}
            				HX_END_LOCAL_FUNC0((void))

            				HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_hx_Closure_1, ::thx::TestError,_gthis) HXARGC(0)
            				void _hx_run(){
            					HX_STACK_FRAME("thx.TestError","testEmptyString",0x68d8092a,"thx.TestError.testEmptyString","thx/TestError.hx",56,0xf1d81e33)
HXLINE(  56)					_gthis->emptyString(HX_("",00,00,00,00));
            				}
            				HX_END_LOCAL_FUNC0((void))

HXLINE(  54)				++_g1;
HXLINE(  55)				::utest::Assert_obj::raises( ::Dynamic(new _hx_Closure_0(_gthis)),hx::ClassOf< ::thx::error::NullArgument >(),null(),null(),hx::SourceInfo(HX_("TestError.hx",88,76,36,1a),55,HX_("thx.TestError",8c,21,a0,24),HX_("testEmptyString",0c,ac,27,2e)));
HXLINE(  56)				::utest::Assert_obj::raises( ::Dynamic(new _hx_Closure_1(_gthis)),hx::ClassOf< ::thx::error::NullArgument >(),null(),null(),hx::SourceInfo(HX_("TestError.hx",88,76,36,1a),56,HX_("thx.TestError",8c,21,a0,24),HX_("testEmptyString",0c,ac,27,2e)));
HXLINE(  57)				this->emptyString(HX_("a",61,00,00,00));
            			}
            		}
            	}
...
void TestError_obj::testEmptyIterator(){
            	HX_STACK_FRAME("thx.TestError","testEmptyIterator",0x0d3db287,"thx.TestError.testEmptyIterator","thx/TestError.hx",60,0xf1d81e33)
            	HX_STACK_THIS(this)
HXLINE(  60)		HX_VARI(  ::thx::TestError,_gthis) = hx::ObjectPtr<OBJ_>(this);
HXLINE(  61)		{
...
HXDLIN(  61)			while((_g1 < _g)){
            				HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_hx_Closure_0, ::thx::TestError,_gthis) HXARGC(0)
            				void _hx_run(){
            					HX_STACK_FRAME("thx.TestError","testEmptyIterator",0x0d3db287,"thx.TestError.testEmptyIterator","thx/TestError.hx",63,0xf1d81e33)
HXLINE(  63)					_gthis->emptyIterator(null());
            				}
            				HX_END_LOCAL_FUNC0((void))

            				HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_1, ::thx::TestError,_gthis, ::IntIterator,it) HXARGC(0)
            				void _hx_run(){
            					HX_STACK_FRAME("thx.TestError","testEmptyIterator",0x0d3db287,"thx.TestError.testEmptyIterator","thx/TestError.hx",64,0xf1d81e33)
HXLINE(  64)					_gthis->emptyIterator(it);
            				}
            				HX_END_LOCAL_FUNC0((void))

HXLINE(  61)				++_g1;
HXLINE(  62)				HX_VARI(  ::IntIterator,it) =  ::IntIterator_obj::__new((int)0,(int)0);
HXLINE(  63)				::utest::Assert_obj::raises( ::Dynamic(new _hx_Closure_0(_gthis)),hx::ClassOf< ::thx::error::NullArgument >(),null(),null(),hx::SourceInfo(HX_("TestError.hx",88,76,36,1a),63,HX_("thx.TestError",8c,21,a0,24),HX_("testEmptyIterator",e9,51,e5,7f)));
HXLINE(  64)				::utest::Assert_obj::raises( ::Dynamic(new _hx_Closure_1(_gthis,it)),hx::ClassOf< ::thx::error::NullArgument >(),null(),null(),hx::SourceInfo(HX_("TestError.hx",88,76,36,1a),64,HX_("thx.TestError",8c,21,a0,24),HX_("testEmptyIterator",e9,51,e5,7f)));
HXLINE(  66)				this->emptyIterator( ::IntIterator_obj::__new((int)0,(int)4));
            			}
            		}
            	}
...
void TestError_obj::testEmptyIterable(){
            	HX_STACK_FRAME("thx.TestError","testEmptyIterable",0x0d30074b,"thx.TestError.testEmptyIterable","thx/TestError.hx",69,0xf1d81e33)
            	HX_STACK_THIS(this)
HXLINE(  69)		HX_VARI(  ::thx::TestError,_gthis) = hx::ObjectPtr<OBJ_>(this);
HXLINE(  70)		{
...
HXDLIN(  70)			while((_g1 < _g)){
            				HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            				 ::IntIterator _hx_run(){
            					HX_STACK_FRAME("thx.TestError","testEmptyIterable",0x0d30074b,"thx.TestError.testEmptyIterable","thx/TestError.hx",71,0xf1d81e33)
HXLINE(  71)					return  ::IntIterator_obj::__new((int)0,(int)0);
            				}
            				HX_END_LOCAL_FUNC0(return)

            				HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_hx_Closure_1, ::thx::TestError,_gthis) HXARGC(0)
            				void _hx_run(){
            					HX_STACK_FRAME("thx.TestError","testEmptyIterable",0x0d30074b,"thx.TestError.testEmptyIterable","thx/TestError.hx",72,0xf1d81e33)
HXLINE(  72)					_gthis->emptyIterable(null());
            				}
            				HX_END_LOCAL_FUNC0((void))

            				HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_2, ::thx::TestError,_gthis, ::Dynamic,it) HXARGC(0)
            				void _hx_run(){
            					HX_STACK_FRAME("thx.TestError","testEmptyIterable",0x0d30074b,"thx.TestError.testEmptyIterable","thx/TestError.hx",73,0xf1d81e33)
HXLINE(  73)					_gthis->emptyIterable(it);
            				}
            				HX_END_LOCAL_FUNC0((void))

            				HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_3) HXARGC(0)
            				 ::IntIterator _hx_run(){
            					HX_STACK_FRAME("thx.TestError","testEmptyIterable",0x0d30074b,"thx.TestError.testEmptyIterable","thx/TestError.hx",74,0xf1d81e33)
HXLINE(  74)					return  ::IntIterator_obj::__new((int)0,(int)4);
            				}
            				HX_END_LOCAL_FUNC0(return)

HXLINE(  70)				++_g1;
HXLINE(  71)				HX_VARI(  ::Dynamic,it) =  ::Dynamic(hx::Anon_obj::Create(1)
            					->setFixed(0,HX_("iterator",ee,49,9a,93), ::Dynamic(new _hx_Closure_0())));
HXLINE(  72)				::utest::Assert_obj::raises( ::Dynamic(new _hx_Closure_1(_gthis)),hx::ClassOf< ::thx::error::NullArgument >(),null(),null(),hx::SourceInfo(HX_("TestError.hx",88,76,36,1a),72,HX_("thx.TestError",8c,21,a0,24),HX_("testEmptyIterable",ad,a6,d7,7f)));
HXLINE(  73)				::utest::Assert_obj::raises( ::Dynamic(new _hx_Closure_2(_gthis,it)),hx::ClassOf< ::thx::error::NullArgument >(),null(),null(),hx::SourceInfo(HX_("TestError.hx",88,76,36,1a),73,HX_("thx.TestError",8c,21,a0,24),HX_("testEmptyIterable",ad,a6,d7,7f)));
HXLINE(  75)				this->emptyIterable( ::Dynamic(hx::Anon_obj::Create(1)
...
hx::Val TestError_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 1:
...
#if HXCPP_SCRIPTABLE
static hx::StorageInfo TestError_obj_sMemberStorageInfo[] = {
	{hx::fsInt,(int)offsetof(TestError_obj,x),HX_HCSTRING("x","\x78","\x00","\x00","\x00")},
	{ hx::fsUnknown, 0, null()}
};
