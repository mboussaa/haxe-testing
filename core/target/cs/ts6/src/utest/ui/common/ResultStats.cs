...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me157) {
			__temp_me157.assertations = 0;
			__temp_me157.successes = 0;
			__temp_me157.failures = 0;
			__temp_me157.errors = 0;
			__temp_me157.warnings = 0;
			__temp_me157.isOk = true;
			__temp_me157.hasFailures = false;
			__temp_me157.hasErrors = false;
			__temp_me157.hasWarnings = false;
			__temp_me157.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me157.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me157.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me157.onAddWarnings = new global::utest.Dispatcher<int>();
		}
