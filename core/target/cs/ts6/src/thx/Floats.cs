...
namespace thx {
	public class Floats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_Floats(global::thx.Floats __temp_me99) {
		}
		...
		public static double angleDifference(double a, double b, global::haxe.lang.Null<double> turn) {
			unchecked {
				global::haxe.lang.Null<double> __temp_turn90 = ( ( ! (turn.hasValue) ) ? (new global::haxe.lang.Null<double>(360.0, true)) : (turn) );
				double r = ( (( b - a )) % (__temp_turn90).@value );
				if (( r < 0 )) {
					r += (__temp_turn90).@value;
				}
				
				if (( r > ( (__temp_turn90).@value / 2 ) )) {
					r -= (__temp_turn90).@value;
				}
		...
		public static double interpolateAngle(double f, double a, double b, global::haxe.lang.Null<double> turn) {
			unchecked {
				...
				return global::thx.Floats.wrapCircular(global::thx.Floats.interpolate(f, a, ( a + global::thx.Floats.angleDifference(a, b, new global::haxe.lang.Null<double>(__temp_turn91, true)) )), __temp_turn91);
			}
		}
		...
		public static double interpolateAngleWidest(double f, double a, double b, global::haxe.lang.Null<double> turn) {
			unchecked {
				...
				return global::thx.Floats.wrapCircular(( global::thx.Floats.interpolateAngle(f, a, b, new global::haxe.lang.Null<double>(__temp_turn92, true)) - ( __temp_turn92 / 2 ) ), __temp_turn92);
			}
		}
		...
		public static bool nearEquals(double a, double b, global::haxe.lang.Null<double> tollerance) {
			...
			if ((  ! (global::System.Double.IsInfinity(((double) (a) )))  &&  ! (global::System.Double.IsNaN(((double) (a) )))  )) {
				return ( global::System.Math.Abs(((double) (( a - b )) )) <= (__temp_tollerance95).@value );
			}
		...
		public static bool nearEqualAngles(double a, double b, global::haxe.lang.Null<double> turn, global::haxe.lang.Null<double> tollerance) {
			...
			global::haxe.lang.Null<double> __temp_turn96 = ( ( ! (turn.hasValue) ) ? (new global::haxe.lang.Null<double>(360.0, true)) : (turn) );
			return ( global::System.Math.Abs(((double) (global::thx.Floats.angleDifference(a, b, __temp_turn96)) )) <= (__temp_tollerance97).@value );
		}
		...
		public static bool nearZero(double n, global::haxe.lang.Null<double> tollerance) {
			...
			return ( global::System.Math.Abs(((double) (n) )) <= (__temp_tollerance98).@value );
		}
