...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me167) {
			__temp_me167.assertations = 0;
			__temp_me167.successes = 0;
			__temp_me167.failures = 0;
			__temp_me167.errors = 0;
			__temp_me167.warnings = 0;
			__temp_me167.isOk = true;
			__temp_me167.hasFailures = false;
			__temp_me167.hasErrors = false;
			__temp_me167.hasWarnings = false;
			__temp_me167.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me167.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me167.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me167.onAddWarnings = new global::utest.Dispatcher<int>();
		}
