...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me60) {
			__temp_me60.assertations = 0;
			__temp_me60.successes = 0;
			__temp_me60.failures = 0;
			__temp_me60.errors = 0;
			__temp_me60.warnings = 0;
			__temp_me60.isOk = true;
			__temp_me60.hasFailures = false;
			__temp_me60.hasErrors = false;
			__temp_me60.hasWarnings = false;
			__temp_me60.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me60.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me60.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me60.onAddWarnings = new global::utest.Dispatcher<int>();
		}
