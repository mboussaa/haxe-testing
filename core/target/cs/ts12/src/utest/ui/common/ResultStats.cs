...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me173) {
			__temp_me173.assertations = 0;
			__temp_me173.successes = 0;
			__temp_me173.failures = 0;
			__temp_me173.errors = 0;
			__temp_me173.warnings = 0;
			__temp_me173.isOk = true;
			__temp_me173.hasFailures = false;
			__temp_me173.hasErrors = false;
			__temp_me173.hasWarnings = false;
			__temp_me173.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me173.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me173.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me173.onAddWarnings = new global::utest.Dispatcher<int>();
		}
