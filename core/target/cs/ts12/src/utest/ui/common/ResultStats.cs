...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me174) {
			__temp_me174.assertations = 0;
			__temp_me174.successes = 0;
			__temp_me174.failures = 0;
			__temp_me174.errors = 0;
			__temp_me174.warnings = 0;
			__temp_me174.isOk = true;
			__temp_me174.hasFailures = false;
			__temp_me174.hasErrors = false;
			__temp_me174.hasWarnings = false;
			__temp_me174.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me174.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me174.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me174.onAddWarnings = new global::utest.Dispatcher<int>();
		}
