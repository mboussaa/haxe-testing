...
namespace utest {
	public class TestHandler<T> : global::haxe.lang.HxObject, global::utest.TestHandler {
		...
		public static void __hx_ctor_utest_TestHandler<T_c>(global::utest.TestHandler<T_c> __temp_me161, global::utest.TestFixture fixture) {
			if (( fixture == null )) {
				throw global::haxe.lang.HaxeException.wrap("fixture argument is null");
			}
			
			__temp_me161.fixture = fixture;
			__temp_me161.results = new global::List<object>();
			__temp_me161.asyncStack = new global::List<object>();
			__temp_me161.onTested = new global::utest.Dispatcher<object>();
			__temp_me161.onTimeout = new global::utest.Dispatcher<object>();
			__temp_me161.onComplete = new global::utest.Dispatcher<object>();
			__temp_me161.onPrecheck = new global::utest.Dispatcher<object>();
		}
		...
		public static global::Array<object> exceptionStack(global::haxe.lang.Null<int> pops) {
			unchecked {
				int __temp_pops160 = ( ( ! (pops.hasValue) ) ? (2) : ((pops).@value) );
				global::Array<object> stack = global::haxe.CallStack.exceptionStack();
				while (( __temp_pops160-- > 0 )) {
					stack.pop();
				}
		...
		public virtual global::haxe.lang.Function addAsync(global::haxe.lang.Function f, global::haxe.lang.Null<int> timeout) {
			unchecked {
				int __temp_timeout158 = ( ( ! (timeout.hasValue) ) ? (250) : ((timeout).@value) );
				if (( null == f )) {
				...
				this.setTimeout(__temp_timeout158);
		...
		public virtual global::haxe.lang.Function addEvent<EventArg>(global::haxe.lang.Function f, global::haxe.lang.Null<int> timeout) {
			unchecked {
				int __temp_timeout159 = ( ( ! (timeout.hasValue) ) ? (250) : ((timeout).@value) );
				global::haxe.lang.Runtime.callField(this.asyncStack, "add", 4846113, new global::Array<object>(new object[]{f}));
				global::utest.TestHandler<T> handler = this;
				this.setTimeout(__temp_timeout159);
