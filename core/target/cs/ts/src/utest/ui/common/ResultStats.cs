...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me291) {
			__temp_me291.assertations = 0;
			__temp_me291.successes = 0;
			__temp_me291.failures = 0;
			__temp_me291.errors = 0;
			__temp_me291.warnings = 0;
			__temp_me291.isOk = true;
			__temp_me291.hasFailures = false;
			__temp_me291.hasErrors = false;
			__temp_me291.hasWarnings = false;
			__temp_me291.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me291.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me291.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me291.onAddWarnings = new global::utest.Dispatcher<int>();
		}
