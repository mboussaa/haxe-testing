...
namespace utest {
	public class Runner : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_Runner(global::utest.Runner __temp_me274) {
			__temp_me274.globalPattern = null;
			__temp_me274.fixtures = new global::Array<object>();
			__temp_me274.onProgress = new global::utest.Dispatcher<object>();
			__temp_me274.onStart = new global::utest.Dispatcher<object>();
			__temp_me274.onComplete = new global::utest.Dispatcher<object>();
			__temp_me274.onPrecheck = new global::utest.Dispatcher<object>();
			__temp_me274.onTestStart = new global::utest.Dispatcher<object>();
			__temp_me274.onTestComplete = new global::utest.Dispatcher<object>();
			__temp_me274.length = 0;
		}
