...
namespace thx._DateTimeUtc {
	public sealed class DateTimeUtc_Impl_ {
		...
		public static long create(int year, int month, int day, global::haxe.lang.Null<int> hour, global::haxe.lang.Null<int> minute, global::haxe.lang.Null<int> second, global::haxe.lang.Null<int> millisecond) {
			unchecked {
				global::haxe.lang.Null<int> __temp_millisecond100 = ( ( ! (millisecond.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (millisecond) );
				global::haxe.lang.Null<int> __temp_second99 = ( ( ! (second.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (second) );
				global::haxe.lang.Null<int> __temp_minute98 = ( ( ! (minute.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (minute) );
				global::haxe.lang.Null<int> __temp_hour97 = ( ( ! (hour.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (hour) );
				__temp_second99 = new global::haxe.lang.Null<int>(( (__temp_second99).@value + ((int) (global::System.Math.Floor(((double) (( ((double) ((__temp_millisecond100).@value) ) / 1000 )) ))) ) ), true);
				__temp_millisecond100 = new global::haxe.lang.Null<int>(((int) (( (__temp_millisecond100).@value % (new global::haxe.lang.Null<int>(1000, true)).@value )) ), true);
				if (( (__temp_millisecond100).@value < 0 )) {
					__temp_millisecond100 = new global::haxe.lang.Null<int>(( (__temp_millisecond100).@value + 1000 ), true);
				}
				
				long ticks = ((long) (( ((long) (( ((long) (global::thx._DateTimeUtc.DateTimeUtc_Impl_.dateToTicks(year, month, day)) ) + ((long) (global::thx._Time.Time_Impl_.timeToTicks((__temp_hour97).@value, (__temp_minute98).@value, (__temp_second99).@value)) ) )) ) + ((long) (( ((long) ((__temp_millisecond100).@value) ) * ((long) (global::thx._DateTimeUtc.DateTimeUtc_Impl_.ticksPerMillisecondI64) ) )) ) )) );
				return ((long) (ticks) );
			}
		}
		...
		public static long snapToWeekDay(long this1, int weekday, global::haxe.lang.Null<int> firstDayOfWk) {
			unchecked {
				global::haxe.lang.Null<int> __temp_firstDayOfWk101 = ( ( ! (firstDayOfWk.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (firstDayOfWk) );
				int d = global::thx._DateTimeUtc.DateTimeUtc_Impl_.get_dayOfWeek(this1);
				int s = weekday;
				if (( s < (__temp_firstDayOfWk101).@value )) {
					s += 7;
				}
				
				if (( d < (__temp_firstDayOfWk101).@value )) {
					d += 7;
				}
