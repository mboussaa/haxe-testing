...
namespace haxe.ds {
	public class ObjectMap<K, V> : global::haxe.lang.HxObject, global::haxe.ds.ObjectMap, global::haxe.IMap<K, V> {
		...
		public static void __hx_ctor_haxe_ds_ObjectMap<K_c, V_c>(global::haxe.ds.ObjectMap<K_c, V_c> __temp_me56) {
			unchecked {
				__temp_me56.cachedIndex = -1;
			}
		}
			...
			unchecked {
				...
				while (( i < fields.length )) {
					...
					switch (field) {
						...
						{
							if (( this.vals != null )) {
								V_c[] __temp_new_arr50 = new V_c[this.vals.Length];
								int __temp_i51 = -1;
								while ((  ++ __temp_i51 < this.vals.Length )) {
									object __temp_obj52 = ((object) (this.vals[__temp_i51]) );
									if (( __temp_obj52 != null )) {
										__temp_new_arr50[__temp_i51] = global::haxe.lang.Runtime.genericCast<V_c>(__temp_obj52);
									}
									
								}
								
								new_me.vals = __temp_new_arr50;
							}
							else {
								new_me.vals = null;
							}
						...
						{
							if (( this._keys != null )) {
								K_c[] __temp_new_arr53 = new K_c[this._keys.Length];
								int __temp_i54 = -1;
								while ((  ++ __temp_i54 < this._keys.Length )) {
									object __temp_obj55 = ((object) (this._keys[__temp_i54]) );
									if (( __temp_obj55 != null )) {
										__temp_new_arr53[__temp_i54] = global::haxe.lang.Runtime.genericCast<K_c>(__temp_obj55);
									}
									
								}
								
								new_me._keys = __temp_new_arr53;
							}
							else {
								new_me._keys = null;
							}
				...
				K[] keys = this._keys;
				{
					...
					if (( hashes[i] == 0 )) {
						...
						while (true) {
							...
							if (( flag != 0 )) {
								if (( flag == k )) {
									tmp = global::haxe.lang.Runtime.eq(this._keys[i], key);
								}
								else {
									tmp = false;
								}
			...
			unchecked {
				if (( this.nBuckets != 0 )) {
					...
					while (true) {
						...
						if (( flag != 0 )) {
							if ( ! ((( ( flag == 1 ) || ( flag != hash ) ))) ) {
								tmp = ( ! (global::haxe.lang.Runtime.eq(keys[i], key)) );
							}
							else {
								tmp = true;
							}
...
namespace haxe.ds._ObjectMap {
	public sealed class ObjectMapKeyIterator<T, V> : global::haxe.lang.HxObject, global::haxe.ds._ObjectMap.ObjectMapKeyIterator {
		...
		public static void __hx_ctor_haxe_ds__ObjectMap_ObjectMapKeyIterator<T_c, V_c>(global::haxe.ds._ObjectMap.ObjectMapKeyIterator<T_c, V_c> __temp_me57, global::haxe.ds.ObjectMap<T_c, V_c> m) {
			__temp_me57.i = 0;
			__temp_me57.m = m;
			__temp_me57.len = m.nBuckets;
		}
...
namespace haxe.ds._ObjectMap {
	public sealed class ObjectMapValueIterator<K, T> : global::haxe.lang.HxObject, global::haxe.ds._ObjectMap.ObjectMapValueIterator {
		...
		public static void __hx_ctor_haxe_ds__ObjectMap_ObjectMapValueIterator<K_c, T_c>(global::haxe.ds._ObjectMap.ObjectMapValueIterator<K_c, T_c> __temp_me58, global::haxe.ds.ObjectMap<K_c, T_c> m) {
			__temp_me58.i = 0;
			__temp_me58.m = m;
			__temp_me58.len = m.nBuckets;
		}
