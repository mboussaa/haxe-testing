...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me159) {
			__temp_me159.assertations = 0;
			__temp_me159.successes = 0;
			__temp_me159.failures = 0;
			__temp_me159.errors = 0;
			__temp_me159.warnings = 0;
			__temp_me159.isOk = true;
			__temp_me159.hasFailures = false;
			__temp_me159.hasErrors = false;
			__temp_me159.hasWarnings = false;
			__temp_me159.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me159.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me159.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me159.onAddWarnings = new global::utest.Dispatcher<int>();
		}
