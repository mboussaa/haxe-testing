...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me162) {
			__temp_me162.assertations = 0;
			__temp_me162.successes = 0;
			__temp_me162.failures = 0;
			__temp_me162.errors = 0;
			__temp_me162.warnings = 0;
			__temp_me162.isOk = true;
			__temp_me162.hasFailures = false;
			__temp_me162.hasErrors = false;
			__temp_me162.hasWarnings = false;
			__temp_me162.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me162.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me162.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me162.onAddWarnings = new global::utest.Dispatcher<int>();
		}
