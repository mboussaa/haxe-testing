...
namespace utest {
	public class Runner : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_Runner(global::utest.Runner __temp_me142) {
			__temp_me142.globalPattern = null;
			__temp_me142.fixtures = new global::Array<object>();
			__temp_me142.onProgress = new global::utest.Dispatcher<object>();
			__temp_me142.onStart = new global::utest.Dispatcher<object>();
			__temp_me142.onComplete = new global::utest.Dispatcher<object>();
			__temp_me142.onPrecheck = new global::utest.Dispatcher<object>();
			__temp_me142.onTestStart = new global::utest.Dispatcher<object>();
			__temp_me142.onTestComplete = new global::utest.Dispatcher<object>();
			__temp_me142.length = 0;
		}
