...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me176) {
			__temp_me176.assertations = 0;
			__temp_me176.successes = 0;
			__temp_me176.failures = 0;
			__temp_me176.errors = 0;
			__temp_me176.warnings = 0;
			__temp_me176.isOk = true;
			__temp_me176.hasFailures = false;
			__temp_me176.hasErrors = false;
			__temp_me176.hasWarnings = false;
			__temp_me176.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me176.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me176.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me176.onAddWarnings = new global::utest.Dispatcher<int>();
		}
