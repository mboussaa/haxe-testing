...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me163) {
			__temp_me163.assertations = 0;
			__temp_me163.successes = 0;
			__temp_me163.failures = 0;
			__temp_me163.errors = 0;
			__temp_me163.warnings = 0;
			__temp_me163.isOk = true;
			__temp_me163.hasFailures = false;
			__temp_me163.hasErrors = false;
			__temp_me163.hasWarnings = false;
			__temp_me163.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me163.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me163.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me163.onAddWarnings = new global::utest.Dispatcher<int>();
		}
