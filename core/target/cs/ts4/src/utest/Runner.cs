...
namespace utest {
	public class Runner : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_Runner(global::utest.Runner __temp_me146) {
			__temp_me146.globalPattern = null;
			__temp_me146.fixtures = new global::Array<object>();
			__temp_me146.onProgress = new global::utest.Dispatcher<object>();
			__temp_me146.onStart = new global::utest.Dispatcher<object>();
			__temp_me146.onComplete = new global::utest.Dispatcher<object>();
			__temp_me146.onPrecheck = new global::utest.Dispatcher<object>();
			__temp_me146.onTestStart = new global::utest.Dispatcher<object>();
			__temp_me146.onTestComplete = new global::utest.Dispatcher<object>();
			__temp_me146.length = 0;
		}
