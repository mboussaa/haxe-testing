...
namespace utest {
	public class TestHandler<T> : global::haxe.lang.HxObject, global::utest.TestHandler {
		...
		public static void __hx_ctor_utest_TestHandler<T_c>(global::utest.TestHandler<T_c> __temp_me49, global::utest.TestFixture fixture) {
			if (( fixture == null )) {
				throw global::haxe.lang.HaxeException.wrap("fixture argument is null");
			}
			
			__temp_me49.fixture = fixture;
			__temp_me49.results = new global::List<object>();
			__temp_me49.asyncStack = new global::List<object>();
			__temp_me49.onTested = new global::utest.Dispatcher<object>();
			__temp_me49.onTimeout = new global::utest.Dispatcher<object>();
			__temp_me49.onComplete = new global::utest.Dispatcher<object>();
			__temp_me49.onPrecheck = new global::utest.Dispatcher<object>();
		}
		...
		public static global::Array<object> exceptionStack(global::haxe.lang.Null<int> pops) {
			unchecked {
				int __temp_pops48 = ( ( ! (pops.hasValue) ) ? (2) : ((pops).@value) );
		...
		public virtual global::haxe.lang.Function addAsync(global::haxe.lang.Function f, global::haxe.lang.Null<int> timeout) {
			unchecked {
				int __temp_timeout46 = ( ( ! (timeout.hasValue) ) ? (250) : ((timeout).@value) );
				if (( null == f )) {
