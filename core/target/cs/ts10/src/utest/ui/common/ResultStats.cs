...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me79) {
			__temp_me79.assertations = 0;
			__temp_me79.successes = 0;
			__temp_me79.failures = 0;
			__temp_me79.errors = 0;
			__temp_me79.warnings = 0;
			__temp_me79.isOk = true;
			__temp_me79.hasFailures = false;
			__temp_me79.hasErrors = false;
			__temp_me79.hasWarnings = false;
			__temp_me79.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me79.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me79.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me79.onAddWarnings = new global::utest.Dispatcher<int>();
		}
