...
namespace utest.ui.common {
	public class ClassResult : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ClassResult(global::utest.ui.common.ClassResult __temp_me71, string className, string setupName, string teardownName) {
			__temp_me71.fixtures = new global::haxe.ds.StringMap<object>();
			__temp_me71.className = className;
			__temp_me71.setupName = setupName;
			__temp_me71.hasSetup =  ! (string.Equals(setupName, null)) ;
			__temp_me71.teardownName = teardownName;
			__temp_me71.hasTeardown =  ! (string.Equals(teardownName, null)) ;
			__temp_me71.methods = 0;
			__temp_me71.stats = new global::utest.ui.common.ResultStats();
		}
		...
		public virtual global::Array<object> methodNames(global::haxe.lang.Null<bool> errorsHavePriority) {
			bool __temp_errorsHavePriority70 = ( ( ! (errorsHavePriority.hasValue) ) ? (true) : ((errorsHavePriority).@value) );
			...
			if (__temp_errorsHavePriority70) {
