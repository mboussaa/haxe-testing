...
namespace haxe.ds {
	public class StringMap<T> : global::haxe.lang.HxObject, global::haxe.ds.StringMap, global::haxe.IMap<object, T> {
		...
		public static void __hx_ctor_haxe_ds_StringMap<T_c>(global::haxe.ds.StringMap<T_c> __temp_me61) {
			unchecked {
				__temp_me61.cachedIndex = -1;
			}
		}
			...
			unchecked {
				...
				while (( i < fields.length )) {
					...
					switch (field) {
						...
						{
							if (( this.vals != null )) {
								T_c[] __temp_new_arr58 = new T_c[this.vals.Length];
								int __temp_i59 = -1;
								while ((  ++ __temp_i59 < this.vals.Length )) {
									object __temp_obj60 = ((object) (this.vals[__temp_i59]) );
									if (( __temp_obj60 != null )) {
										__temp_new_arr58[__temp_i59] = global::haxe.lang.Runtime.genericCast<T_c>(__temp_obj60);
									}
									
								}
								
								new_me.vals = __temp_new_arr58;
							}
							else {
								new_me.vals = null;
							}
...
namespace haxe.ds._StringMap {
	public sealed class StringMapKeyIterator<T> : global::haxe.lang.HxObject, global::haxe.ds._StringMap.StringMapKeyIterator {
		...
		public static void __hx_ctor_haxe_ds__StringMap_StringMapKeyIterator<T_c>(global::haxe.ds._StringMap.StringMapKeyIterator<T_c> __temp_me62, global::haxe.ds.StringMap<T_c> m) {
			__temp_me62.m = m;
			__temp_me62.i = 0;
...
namespace haxe.ds._StringMap {
	public sealed class StringMapValueIterator<T> : global::haxe.lang.HxObject, global::haxe.ds._StringMap.StringMapValueIterator {
		...
		public static void __hx_ctor_haxe_ds__StringMap_StringMapValueIterator<T_c>(global::haxe.ds._StringMap.StringMapValueIterator<T_c> __temp_me63, global::haxe.ds.StringMap<T_c> m) {
			__temp_me63.m = m;
			__temp_me63.i = 0;
			__temp_me63.len = m.nBuckets;
		}
