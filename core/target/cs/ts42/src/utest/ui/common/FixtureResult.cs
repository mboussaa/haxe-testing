...
namespace utest.ui.common {
	public class FixtureResult : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_FixtureResult(global::utest.ui.common.FixtureResult __temp_me196, string methodName) {
			__temp_me196.methodName = methodName;
			__temp_me196.list = new global::List<object>();
			__temp_me196.hasTestError = false;
			__temp_me196.hasSetupError = false;
			__temp_me196.hasTeardownError = false;
			__temp_me196.hasTimeoutError = false;
			__temp_me196.hasAsyncError = false;
			__temp_me196.stats = new global::utest.ui.common.ResultStats();
		}
