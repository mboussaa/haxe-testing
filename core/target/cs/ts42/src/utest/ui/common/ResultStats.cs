...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me203) {
			__temp_me203.assertations = 0;
			__temp_me203.successes = 0;
			__temp_me203.failures = 0;
			__temp_me203.errors = 0;
			__temp_me203.warnings = 0;
			__temp_me203.isOk = true;
			__temp_me203.hasFailures = false;
			__temp_me203.hasErrors = false;
			__temp_me203.hasWarnings = false;
			__temp_me203.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me203.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me203.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me203.onAddWarnings = new global::utest.Dispatcher<int>();
		}
