...
namespace thx._DateTime {
	public sealed class DateTime_Impl_ {
		...
		public static global::Array<long> create(int year, int month, int day, global::haxe.lang.Null<int> hour, global::haxe.lang.Null<int> minute, global::haxe.lang.Null<int> second, global::haxe.lang.Null<int> millisecond, long offset) {
			unchecked {
				global::haxe.lang.Null<int> __temp_millisecond84 = ( ( ! (millisecond.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (millisecond) );
				global::haxe.lang.Null<int> __temp_second83 = ( ( ! (second.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (second) );
				global::haxe.lang.Null<int> __temp_minute82 = ( ( ! (minute.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (minute) );
				global::haxe.lang.Null<int> __temp_hour81 = ( ( ! (hour.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (hour) );
				global::Array<long> this1 = new global::Array<long>(new long[]{((long) (global::thx._DateTimeUtc.DateTimeUtc_Impl_.create(year, month, day, __temp_hour81, __temp_minute82, __temp_second83, __temp_millisecond84)) ), ((long) (offset) )});
		...
		public static global::Array<long> snapToWeekDay(global::Array<long> this1, int weekday, global::haxe.lang.Null<int> firstDayOfWk) {
			unchecked {
				global::haxe.lang.Null<int> __temp_firstDayOfWk85 = ( ( ! (firstDayOfWk.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (firstDayOfWk) );
				...
				int s = weekday;
				if (( s < (__temp_firstDayOfWk85).@value )) {
					s += 7;
				}
				
				if (( d < (__temp_firstDayOfWk85).@value )) {
					d += 7;
				}
