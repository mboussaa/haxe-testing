...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me70) {
			__temp_me70.assertations = 0;
			__temp_me70.successes = 0;
			__temp_me70.failures = 0;
			__temp_me70.errors = 0;
			__temp_me70.warnings = 0;
			__temp_me70.isOk = true;
			__temp_me70.hasFailures = false;
			__temp_me70.hasErrors = false;
			__temp_me70.hasWarnings = false;
			__temp_me70.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me70.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me70.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me70.onAddWarnings = new global::utest.Dispatcher<int>();
		}
