...
namespace utest.ui.common {
	public class ClassResult : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ClassResult(global::utest.ui.common.ClassResult __temp_me62, string className, string setupName, string teardownName) {
			__temp_me62.fixtures = new global::haxe.ds.StringMap<object>();
			__temp_me62.className = className;
			__temp_me62.setupName = setupName;
			__temp_me62.hasSetup =  ! (string.Equals(setupName, null)) ;
			__temp_me62.teardownName = teardownName;
			__temp_me62.hasTeardown =  ! (string.Equals(teardownName, null)) ;
			__temp_me62.methods = 0;
