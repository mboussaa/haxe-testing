...
namespace thx {
	public class Dates : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_Dates(global::thx.Dates __temp_me82) {
		}
		...
		public static global::Date create(int year, global::haxe.lang.Null<int> month, global::haxe.lang.Null<int> day, global::haxe.lang.Null<int> hour, global::haxe.lang.Null<int> minute, global::haxe.lang.Null<int> second) {
			unchecked {
				...
				global::haxe.lang.Null<int> __temp_day76 = ( ( ! (day.hasValue) ) ? (new global::haxe.lang.Null<int>(1, true)) : (day) );
				global::haxe.lang.Null<int> __temp_month75 = ( ( ! (month.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (month) );
				__temp_minute78 = new global::haxe.lang.Null<int>(( (__temp_minute78).@value + ((int) (global::System.Math.Floor(((double) (( ((double) ((__temp_second79).@value) ) / 60 )) ))) ) ), true);
				__temp_second79 = new global::haxe.lang.Null<int>(((int) (( (__temp_second79).@value % (new global::haxe.lang.Null<int>(60, true)).@value )) ), true);
				if (( (__temp_second79).@value < 0 )) {
					__temp_second79 = new global::haxe.lang.Null<int>(( (__temp_second79).@value + 60 ), true);
				}
				
				__temp_hour77 = new global::haxe.lang.Null<int>(( (__temp_hour77).@value + ((int) (global::System.Math.Floor(((double) (( ((double) ((__temp_minute78).@value) ) / 60 )) ))) ) ), true);
				__temp_minute78 = new global::haxe.lang.Null<int>(((int) (( (__temp_minute78).@value % (new global::haxe.lang.Null<int>(60, true)).@value )) ), true);
				if (( (__temp_minute78).@value < 0 )) {
					__temp_minute78 = new global::haxe.lang.Null<int>(( (__temp_minute78).@value + 60 ), true);
				}
				
				__temp_day76 = new global::haxe.lang.Null<int>(( (__temp_day76).@value + ((int) (global::System.Math.Floor(((double) (( ((double) ((__temp_hour77).@value) ) / 24 )) ))) ) ), true);
				__temp_hour77 = new global::haxe.lang.Null<int>(((int) (( (__temp_hour77).@value % (new global::haxe.lang.Null<int>(24, true)).@value )) ), true);
				if (( (__temp_hour77).@value < 0 )) {
					__temp_hour77 = new global::haxe.lang.Null<int>(( (__temp_hour77).@value + 24 ), true);
				}
				
				if (global::haxe.lang.Runtime.eq((__temp_day76).toDynamic(), 0)) {
					{
						__temp_month75 = new global::haxe.lang.Null<int>(( (__temp_month75).@value - 1 ), true);
					}
					
					if (( (__temp_month75).@value < 0 )) {
						__temp_month75 = new global::haxe.lang.Null<int>(11, true);
						 -- year;
					}
					
					__temp_day76 = new global::haxe.lang.Null<int>(global::thx.Dates.daysInMonth(year, (__temp_month75).@value), true);
				}
				
				year += ((int) (global::System.Math.Floor(((double) (( ((double) ((__temp_month75).@value) ) / 12 )) ))) );
				__temp_month75 = new global::haxe.lang.Null<int>(((int) (( (__temp_month75).@value % (new global::haxe.lang.Null<int>(12, true)).@value )) ), true);
				if (( (__temp_month75).@value < 0 )) {
					__temp_month75 = new global::haxe.lang.Null<int>(( (__temp_month75).@value + 12 ), true);
				}
				
				int days = global::thx.Dates.daysInMonth(year, (__temp_month75).@value);
				while (( (__temp_day76).@value > days )) {
					if (( (__temp_day76).@value > days )) {
						__temp_day76 = new global::haxe.lang.Null<int>(((int) (( (__temp_day76).@value - (new global::haxe.lang.Null<int>(days, true)).@value )) ), true);
						{
							__temp_month75 = new global::haxe.lang.Null<int>(( (__temp_month75).@value + 1 ), true);
						}
					...
					if (( (__temp_month75).@value > 11 )) {
						__temp_month75 = new global::haxe.lang.Null<int>(((int) (( (__temp_month75).@value - (new global::haxe.lang.Null<int>(12, true)).@value )) ), true);
						 ++ year;
					}
					
					days = global::thx.Dates.daysInMonth(year, (__temp_month75).@value);
				}
				
				return new global::Date(year, (__temp_month75).@value, (__temp_day76).@value, (__temp_hour77).@value, (__temp_minute78).@value, (__temp_second79).@value);
			}
		}
		...
		public static bool nearEquals(global::Date self, global::Date other, global::haxe.lang.Null<int> units, global::thx.TimePeriod period) {
			unchecked {
				global::haxe.lang.Null<int> __temp_units80 = ( ( ! (units.hasValue) ) ? (new global::haxe.lang.Null<int>(1, true)) : (units) );
				if (( null == period )) {
					period = global::thx.TimePeriod.Second;
				}
				
				if (( (__temp_units80).@value < 0 )) {
					__temp_units80 = new global::haxe.lang.Null<int>(( - ((__temp_units80).@value) ), true);
				}
				
				global::Date min = global::thx.Dates.jump(self, period, ( - ((__temp_units80).@value) ));
				global::Date max = global::thx.Dates.jump(self, period, (__temp_units80).@value);
