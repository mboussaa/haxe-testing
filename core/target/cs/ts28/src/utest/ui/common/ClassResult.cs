...
namespace utest.ui.common {
	public class ClassResult : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ClassResult(global::utest.ui.common.ClassResult __temp_me153, string className, string setupName, string teardownName) {
			__temp_me153.fixtures = new global::haxe.ds.StringMap<object>();
			__temp_me153.className = className;
			__temp_me153.setupName = setupName;
			__temp_me153.hasSetup =  ! (string.Equals(setupName, null)) ;
			__temp_me153.teardownName = teardownName;
			__temp_me153.hasTeardown =  ! (string.Equals(teardownName, null)) ;
