...
namespace utest.ui.common {
	public class FixtureResult : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_FixtureResult(global::utest.ui.common.FixtureResult __temp_me58, string methodName) {
			__temp_me58.methodName = methodName;
			__temp_me58.list = new global::List<object>();
			__temp_me58.hasTestError = false;
			__temp_me58.hasSetupError = false;
			__temp_me58.hasTeardownError = false;
			__temp_me58.hasTimeoutError = false;
			__temp_me58.hasAsyncError = false;
