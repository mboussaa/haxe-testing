...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me65) {
			__temp_me65.assertations = 0;
			__temp_me65.successes = 0;
			__temp_me65.failures = 0;
			__temp_me65.errors = 0;
			__temp_me65.warnings = 0;
			__temp_me65.isOk = true;
			__temp_me65.hasFailures = false;
			__temp_me65.hasErrors = false;
			__temp_me65.hasWarnings = false;
			__temp_me65.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me65.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me65.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me65.onAddWarnings = new global::utest.Dispatcher<int>();
		}
