...
namespace utest.ui.common {
	public class ClassResult : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ClassResult(global::utest.ui.common.ClassResult __temp_me57, string className, string setupName, string teardownName) {
			__temp_me57.fixtures = new global::haxe.ds.StringMap<object>();
			__temp_me57.className = className;
			__temp_me57.setupName = setupName;
			__temp_me57.hasSetup =  ! (string.Equals(setupName, null)) ;
			__temp_me57.teardownName = teardownName;
			__temp_me57.hasTeardown =  ! (string.Equals(teardownName, null)) ;
			__temp_me57.methods = 0;
