...
namespace utest {
	public class Runner : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_Runner(global::utest.Runner __temp_me48) {
			__temp_me48.globalPattern = null;
			__temp_me48.fixtures = new global::Array<object>();
			__temp_me48.onProgress = new global::utest.Dispatcher<object>();
			__temp_me48.onStart = new global::utest.Dispatcher<object>();
			__temp_me48.onComplete = new global::utest.Dispatcher<object>();
			__temp_me48.onPrecheck = new global::utest.Dispatcher<object>();
			__temp_me48.onTestStart = new global::utest.Dispatcher<object>();
			__temp_me48.onTestComplete = new global::utest.Dispatcher<object>();
			__temp_me48.length = 0;
		}
