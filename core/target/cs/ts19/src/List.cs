...
public class List<T> : global::haxe.lang.HxObject, global::List {
	...
	public static void __hx_ctor__List<T_c>(global::List<T_c> __temp_me12) {
		__temp_me12.length = 0;
	}
...
namespace _List {
	public class ListNode<T> : global::haxe.lang.HxObject, global::_List.ListNode {
		...
		public static void __hx_ctor__List_ListNode<T_c>(global::_List.ListNode<T_c> __temp_me13, T_c item, global::_List.ListNode<T_c> next) {
			__temp_me13.item = item;
			__temp_me13.next = next;
		}
...
namespace _List {
	public class ListIterator<T> : global::haxe.lang.HxObject, global::_List.ListIterator {
		...
		public static void __hx_ctor__List_ListIterator<T_c>(global::_List.ListIterator<T_c> __temp_me14, global::_List.ListNode<T_c> head) {
			__temp_me14.head = head;
		}
