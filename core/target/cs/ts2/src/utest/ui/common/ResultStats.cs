...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me58) {
			__temp_me58.assertations = 0;
			__temp_me58.successes = 0;
			__temp_me58.failures = 0;
			__temp_me58.errors = 0;
			__temp_me58.warnings = 0;
			__temp_me58.isOk = true;
			__temp_me58.hasFailures = false;
			__temp_me58.hasErrors = false;
			__temp_me58.hasWarnings = false;
			__temp_me58.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me58.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me58.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me58.onAddWarnings = new global::utest.Dispatcher<int>();
		}
