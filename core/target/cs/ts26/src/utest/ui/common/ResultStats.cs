...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me155) {
			__temp_me155.assertations = 0;
			__temp_me155.successes = 0;
			__temp_me155.failures = 0;
			__temp_me155.errors = 0;
			__temp_me155.warnings = 0;
			__temp_me155.isOk = true;
			__temp_me155.hasFailures = false;
			__temp_me155.hasErrors = false;
			__temp_me155.hasWarnings = false;
			__temp_me155.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me155.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me155.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me155.onAddWarnings = new global::utest.Dispatcher<int>();
		}
