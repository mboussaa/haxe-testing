...
namespace utest.ui.common {
	public class ClassResult : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ClassResult(global::utest.ui.common.ClassResult __temp_me156, string className, string setupName, string teardownName) {
			__temp_me156.fixtures = new global::haxe.ds.StringMap<object>();
			__temp_me156.className = className;
			__temp_me156.setupName = setupName;
			__temp_me156.hasSetup =  ! (string.Equals(setupName, null)) ;
			__temp_me156.teardownName = teardownName;
			__temp_me156.hasTeardown =  ! (string.Equals(teardownName, null)) ;
			__temp_me156.methods = 0;
