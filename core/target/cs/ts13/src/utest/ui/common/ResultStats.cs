...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me166) {
			__temp_me166.assertations = 0;
			__temp_me166.successes = 0;
			__temp_me166.failures = 0;
			__temp_me166.errors = 0;
			__temp_me166.warnings = 0;
			__temp_me166.isOk = true;
			__temp_me166.hasFailures = false;
			__temp_me166.hasErrors = false;
			__temp_me166.hasWarnings = false;
			__temp_me166.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me166.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me166.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me166.onAddWarnings = new global::utest.Dispatcher<int>();
		}
