...
namespace utest.ui.common {
	public class ClassResult : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ClassResult(global::utest.ui.common.ClassResult __temp_me149, string className, string setupName, string teardownName) {
			__temp_me149.fixtures = new global::haxe.ds.StringMap<object>();
			__temp_me149.className = className;
			__temp_me149.setupName = setupName;
			__temp_me149.hasSetup =  ! (string.Equals(setupName, null)) ;
			__temp_me149.teardownName = teardownName;
			__temp_me149.hasTeardown =  ! (string.Equals(teardownName, null)) ;
			__temp_me149.methods = 0;
		...
		public virtual global::Array<object> methodNames(global::haxe.lang.Null<bool> errorsHavePriority) {
			bool __temp_errorsHavePriority148 = ( ( ! (errorsHavePriority.hasValue) ) ? (true) : ((errorsHavePriority).@value) );
