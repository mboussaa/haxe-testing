		
		protected static string[] fields = new string[]{"b", "e", "f", "h", "i", "k", "m", "q", "t", "x", "_0", "_1", "_2", "_3", "_4", "_5", "isGlobal", "__a", "add", "arr", "cls", "cur", "get", "has", "key", "len", "map", "pop", "pos", "run", "set", "sum", "split", "teardown", "compareTo", "flags", "match", "compare", "addSuccesses", "start", "stats", "failures", "executeMethod", "successes", "remove", "packageName", "filter", "merge", "startTime", "progress", "hasSetup", "target", "resize", "result", "warnings", "method", "matched", "addErrors", "newline", "setLoop", "stackToString", "compareArg", "append", "onPrecheck", "getPackage", "assertations", "string", "_trace", "methodName", "hasErrors", "packageNames", "assertSnapNext", "iterator", "indent", "assertSnapPrev", "testCreate", "lastIndexOf", "totals", "hasNext", "onAddFailures", "setHandler", "innerError", "message", "onStart", "keysLoop", "reverse", "expireson", "nOccupied", "onTestComplete", "onAddWarnings", "insert", "dumpStack", "dispatch", "length", "getTime", "addAsync", "allOk", "balance", "setupName", "hasTeardownError", "nextRun", "displaySuccessResults", "methods", "getClass", "addPackage", "testSnapTo", "replace", "testToString", "onAddErrors", "setTimeout", "onAddSuccesses", "onTimeout", "value", "asyncStack", "precheck", "aggregator", "onTested", "addHeader", "addFailures", "compareArgs", "cachedIndex", "checkTested", "globalPattern", "toString", "testFromToString", "identity", "packages", "addWarnings", "getResults", "methodNames", "priority", "hashes", "runner", "hasAsyncError", "tomorrow", "testAdd", "displayHeader", "splice", "exists", "equals", "expected", "testCompare", "addResult", "base", "getFixture", "addClass", "copy", "bindHandler", "date", "done", "matchSub", "upperMatch", "removeLoop", "minBinding", "head", "isOk", "item", "handler", "getOrCreateClass", "join", "keys", "left", "list", "concat", "clear", "next", "noop", "hasTestError", "flattenPackage", "pack", "path", "prev", "pure", "push", "root", "matchedPos", "current", "execute", "size", "sort", "step", "stop", "quicksort", "recursive", "test", "vals", "wire", "completed", "spliceVoid", "zero", "errors", "cachedKey", "hasTeardown", "handlers", "stackItems", "equality", "tested", "runNext", "hasFailures", "testEquals", "timeout", "classNames", "addFixture", "createFixture", "hasWarnings", "testFromToDate", "concatNative", "nBuckets", "className", "hasTimeoutError", "runFixture", "onComplete", "existsClass", "__unsafe_get", "__unsafe_set", "indents", "indexOf", "lookup", "isMethod", "fileName", "unbindHandler", "onProgress", "iteratorLoop", "toDynamic", "testFromToTime", "regex", "right", "existsPackage", "classes", "__hx_constructs", "results", "fixtures", "checkMethod", "getClassName", "teardownName", "unwire", "customParams", "getOrCreatePackage", "addEvent", "onTestStart", "hasSetupError", "_height", "getPosition", "fixture", "__get", "__set", "testComplete", "error", "lineNumber", "subtract", "upperBound", "unshift", "testAddMonth", "_keys", "setup", "shift", "__hx_createEmpty", "testSnapNext", "testSnapPrev", "addCase", "assertSnapTo", "removeMinBinding", "slice", "_handler", "complete"};
