...
public class Objects extends haxe.lang.HxObject
{
	...
	public static void __hx_ctor_thx_Objects(thx.Objects __temp_me105)
	{
	}
	...
	public static java.lang.Object copyTo(java.lang.Object src, java.lang.Object dst, java.lang.Object cloneInstances)
	{
		...
		//line 99 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Objects.hx"
		{
			...
			while (( _g < _g1.length ))
			{
				...
				java.lang.Object sv = thx.Dynamics.clone(haxe.root.Reflect.field(src, field), __temp_cloneInstances103);
	...
	public static <T> T clone(T src, java.lang.Object cloneInstances)
	{
		...
		boolean __temp_cloneInstances104 = ( (haxe.lang.Runtime.eq(cloneInstances, null)) ? (false) : (haxe.lang.Runtime.toBool(cloneInstances)) );
		//line 115 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Objects.hx"
		return ((T) (thx.Dynamics.clone(src, __temp_cloneInstances104)) );
	}
