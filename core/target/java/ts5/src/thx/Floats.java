...
public class Floats extends haxe.lang.HxObject
{
	...
	public static void __hx_ctor_thx_Floats(thx.Floats __temp_me83)
	{
	}
	...
	public static double angleDifference(double a, double b, java.lang.Object turn)
	{
		...
		double r = ( ((double) ((( b - a ))) ) % ((double) (haxe.lang.Runtime.toDouble(__temp_turn74)) ) );
		//line 20 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Floats.hx"
		if (( r < 0 )) 
		{
			//line 21 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Floats.hx"
			r = ((double) (haxe.lang.Runtime.toDouble(haxe.lang.Runtime.plus(r, __temp_turn74))) );
		}
		
		//line 22 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Floats.hx"
		if (( r > ( ((double) (haxe.lang.Runtime.toDouble(__temp_turn74)) ) / ((double) (2) ) ) )) 
		{
			//line 23 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Floats.hx"
			r = ( ((double) (r) ) - ((double) (haxe.lang.Runtime.toDouble(__temp_turn74)) ) );
		}
	...
	public static double interpolateAngle(double f, double a, double b, java.lang.Object turn)
	{
		...
		//line 86 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Floats.hx"
		return thx.Floats.wrapCircular(thx.Floats.interpolate(f, a, ( a + thx.Floats.angleDifference(a, b, __temp_turn75) )), __temp_turn75);
	}
	...
	public static double interpolateAngleWidest(double f, double a, double b, java.lang.Object turn)
	{
		...
		//line 94 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Floats.hx"
		return thx.Floats.wrapCircular(( thx.Floats.interpolateAngle(f, a, b, __temp_turn76) - ( __temp_turn76 / 2 ) ), __temp_turn76);
	}
	...
	public static double interpolateAngleCW(double f, double a, double b, java.lang.Object turn)
	{
		...
		double __temp_turn77 = ( (haxe.lang.Runtime.eq(turn, null)) ? (((double) (360) )) : (((double) (haxe.lang.Runtime.toDouble(turn)) )) );
		//line 101 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Floats.hx"
		a = thx.Floats.wrapCircular(a, __temp_turn77);
		//line 102 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Floats.hx"
		b = thx.Floats.wrapCircular(b, __temp_turn77);
		...
		return thx.Floats.wrapCircular(thx.Floats.interpolate(f, a, b), __temp_turn77);
	}
	...
	public static double interpolateAngleCCW(double f, double a, double b, java.lang.Object turn)
	{
		...
		a = thx.Floats.wrapCircular(a, __temp_turn78);
		//line 113 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Floats.hx"
		b = thx.Floats.wrapCircular(b, __temp_turn78);
		...
		return thx.Floats.wrapCircular(thx.Floats.interpolate(f, a, b), __temp_turn78);
	}
	...
	public static boolean nearEquals(double a, double b, java.lang.Object tollerance)
	{
		...
		if (haxe.lang.Runtime.isFinite(a)) 
		{
			...
			return ( haxe.lang.Runtime.compare(java.lang.Math.abs(( a - b )), __temp_tollerance79) <= 0 );
		}
	...
	public static boolean nearEqualAngles(double a, double b, java.lang.Object turn, java.lang.Object tollerance)
	{
		...
		java.lang.Object __temp_tollerance81 = ( (haxe.lang.Runtime.eq(tollerance, null)) ? (((java.lang.Object) (1e-9) )) : (tollerance) );
		//line 161 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Floats.hx"
		java.lang.Object __temp_turn80 = ( (haxe.lang.Runtime.eq(turn, null)) ? (((java.lang.Object) (360.0) )) : (turn) );
		//line 161 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Floats.hx"
		return ( haxe.lang.Runtime.compare(java.lang.Math.abs(thx.Floats.angleDifference(a, b, __temp_turn80)), __temp_tollerance81) <= 0 );
	}
	...
	public static boolean nearZero(double n, java.lang.Object tollerance)
	{
		...
		//line 168 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Floats.hx"
		return ( haxe.lang.Runtime.compare(java.lang.Math.abs(n), __temp_tollerance82) <= 0 );
	}
