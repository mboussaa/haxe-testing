...
public class DecimalImpl extends haxe.lang.HxObject
{
	...
	public static void __hx_ctor_thx_bigint_DecimalImpl(thx.bigint.DecimalImpl __temp_me83, thx.bigint.BigIntImpl value, int scale)
	{
		//line 21 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/bigint/DecimalImpl.hx"
		__temp_me83.value = value;
		//line 22 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/bigint/DecimalImpl.hx"
		__temp_me83.scale = scale;
	}
	...
	public thx.bigint.DecimalImpl trim(java.lang.Object min)
	{
		...
		java.lang.Object __temp_min82 = ( (haxe.lang.Runtime.eq(min, null)) ? (((java.lang.Object) (0) )) : (min) );
		...
		//line 164 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/bigint/DecimalImpl.hx"
		java.lang.String dec = thx.Strings.rpad(thx.Strings.trimCharsRight(parts.__get(1), "0"), "0", ((int) (haxe.lang.Runtime.toInt(__temp_min82)) ));
