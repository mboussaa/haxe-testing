...
public class StringBuf extends haxe.lang.HxObject
{
	...
	public static void __hx_ctor__StringBuf(haxe.root.StringBuf __temp_me13)
	{
		//line 31 "/usr/lib/haxe/std/java/_std/StringBuf.hx"
		__temp_me13.b = new java.lang.StringBuilder();
	}
	...
	{
		//line 50 "/usr/lib/haxe/std/java/_std/StringBuf.hx"
		int l = ( (haxe.lang.Runtime.eq(len, null)) ? (( s.length() - pos )) : (((int) (haxe.lang.Runtime.toInt(len)) )) );
		//line 51 "/usr/lib/haxe/std/java/_std/StringBuf.hx"
