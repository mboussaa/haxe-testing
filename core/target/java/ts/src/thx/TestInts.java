...
public class TestInts extends haxe.lang.HxObject
{
	...
	public TestInts()
	{
		//line 12 "/shared/core/thx/TestInts.hx"
		thx.TestInts.__hx_ctor_thx_TestInts(this);
	}
	
	
	public static void __hx_ctor_thx_TestInts(thx.TestInts __temp_me185)
	{
	}
	...
	{
		//line 11 "/shared/core/thx/TestInts.hx"
		return new thx.TestInts(haxe.lang.EmptyObject.EMPTY);
	}
	...
	{
		//line 11 "/shared/core/thx/TestInts.hx"
		return new thx.TestInts();
	}
	
	
	public void testRange()
	{
		//line 15 "/shared/core/thx/TestInts.hx"
		haxe.root.Array<java.lang.Object> range = thx.Ints.range(2, 7, 1);
		//line 16 "/shared/core/thx/TestInts.hx"
		utest.Assert.same(new haxe.root.Array(new java.lang.Object[]{2, 3, 4, 5, 6}), range, null, null, null, new haxe.lang.DynamicObject(new java.lang.String[]{"className", "fileName", "methodName"}, new java.lang.Object[]{"thx.TestInts", "TestInts.hx", "testRange"}, new java.lang.String[]{"lineNumber"}, new double[]{((double) (((double) (16) )) )}));
		//line 17 "/shared/core/thx/TestInts.hx"
		range = thx.Ints.range(2, 7, 2);
		//line 18 "/shared/core/thx/TestInts.hx"
		utest.Assert.same(new haxe.root.Array(new java.lang.Object[]{2, 4, 6}), range, null, null, null, new haxe.lang.DynamicObject(new java.lang.String[]{"className", "fileName", "methodName"}, new java.lang.Object[]{"thx.TestInts", "TestInts.hx", "testRange"}, new java.lang.String[]{"lineNumber"}, new double[]{((double) (((double) (18) )) )}));
		//line 19 "/shared/core/thx/TestInts.hx"
		range = thx.Ints.range(2, 7, 3);
		//line 20 "/shared/core/thx/TestInts.hx"
		utest.Assert.same(new haxe.root.Array(new java.lang.Object[]{2, 5}), range, null, null, null, new haxe.lang.DynamicObject(new java.lang.String[]{"className", "fileName", "methodName"}, new java.lang.Object[]{"thx.TestInts", "TestInts.hx", "testRange"}, new java.lang.String[]{"lineNumber"}, new double[]{((double) (((double) (20) )) )}));
		//line 22 "/shared/core/thx/TestInts.hx"
		range = thx.Ints.range(7, 2, -2);
		//line 23 "/shared/core/thx/TestInts.hx"
		utest.Assert.same(new haxe.root.Array(new java.lang.Object[]{7, 5, 3}), range, null, null, null, new haxe.lang.DynamicObject(new java.lang.String[]{"className", "fileName", "methodName"}, new java.lang.Object[]{"thx.TestInts", "TestInts.hx", "testRange"}, new java.lang.String[]{"lineNumber"}, new double[]{((double) (((double) (23) )) )}));
	}
	
	
	public void testParse()
	{
		//line 27 "/shared/core/thx/TestInts.hx"
		...
		//line 54 "/shared/core/thx/TestInts.hx"
		{
			//line 54 "/shared/core/thx/TestInts.hx"
			int _g = 0;
			//line 54 "/shared/core/thx/TestInts.hx"
			while (( _g < tests.length ))
			{
				...
				//line 54 "/shared/core/thx/TestInts.hx"
				 ++ _g;
				//line 55 "/shared/core/thx/TestInts.hx"
				utest.Assert.isTrue(thx.Ints.canParse(haxe.lang.Runtime.toString(haxe.lang.Runtime.getField(test, "t", true))), ( "Ints.parse should not be able to parse " + haxe.lang.Runtime.toString(haxe.lang.Runtime.getField(test, "t", true)) ), new haxe.lang.DynamicObject(new java.lang.String[]{"className", "fileName", "methodName"}, new java.lang.Object[]{"thx.TestInts", "TestInts.hx", "testParse"}, new java.lang.String[]{"lineNumber"}, new double[]{((double) (((double) (55) )) )}));
				//line 56 "/shared/core/thx/TestInts.hx"
				utest.Assert.equals(((int) (haxe.lang.Runtime.getField_f(test, "e", true)) ), thx.Ints.parse(haxe.lang.Runtime.toString(haxe.lang.Runtime.getField(test, "t", true)), ((int) (haxe.lang.Runtime.getField_f(test, "b", true)) )), ( haxe.lang.Runtime.toString(( ( ( ( ( ( "expected " + ((int) (haxe.lang.Runtime.getField_f(test, "e", true)) ) ) + " converting \"" ) + haxe.lang.Runtime.toString(haxe.lang.Runtime.getField(test, "t", true)) ) + "\" with base " ) + ((int) (haxe.lang.Runtime.getField_f(test, "b", true)) ) ) + " but got " )) + haxe.lang.Runtime.toString(thx.Ints.parse(haxe.lang.Runtime.toString(haxe.lang.Runtime.getField(test, "t", true)), ((int) (haxe.lang.Runtime.getField_f(test, "b", true)) ))) ), new haxe.lang.DynamicObject(new java.lang.String[]{"className", "fileName", "methodName"}, new java.lang.Object[]{"thx.TestInts", "TestInts.hx", "testParse"}, new java.lang.String[]{"lineNumber"}, new double[]{((double) (((double) (56) )) )}));
			}
	...
	{
		//line 61 "/shared/core/thx/TestInts.hx"
		...
		//line 68 "/shared/core/thx/TestInts.hx"
		{
			//line 68 "/shared/core/thx/TestInts.hx"
			int _g = 0;
			//line 68 "/shared/core/thx/TestInts.hx"
			while (( _g < tests.length ))
			{
				...
				//line 68 "/shared/core/thx/TestInts.hx"
				 ++ _g;
				//line 69 "/shared/core/thx/TestInts.hx"
				utest.Assert.equals(haxe.lang.Runtime.toString(haxe.lang.Runtime.getField(test, "e", true)), thx.Ints.toString(((int) (haxe.lang.Runtime.getField_f(test, "t", true)) ), ((int) (haxe.lang.Runtime.getField_f(test, "b", true)) )), null, new haxe.lang.DynamicObject(new java.lang.String[]{"className", "fileName", "methodName"}, new java.lang.Object[]{"thx.TestInts", "TestInts.hx", "testToString"}, new java.lang.String[]{"lineNumber"}, new double[]{((double) (((double) (69) )) )}));
			}
