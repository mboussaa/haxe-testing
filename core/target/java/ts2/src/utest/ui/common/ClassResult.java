...
public class ClassResult extends haxe.lang.HxObject
{
	...
	public haxe.root.Array<java.lang.String> methodNames(java.lang.Object errorsHavePriority)
	{
		...
		boolean __temp_errorsHavePriority43 = ( (haxe.lang.Runtime.eq(errorsHavePriority, null)) ? (true) : (haxe.lang.Runtime.toBool(errorsHavePriority)) );
		...
		if (__temp_errorsHavePriority43) 
		{
