...
public class TS44 extends haxe.lang.HxObject
{
	...
	public TS44()
	{
		//line 4 "/shared/core/test/TS44.hx"
		haxe.root.TS44.__hx_ctor__TS44(this);
	}
	
	
	public static void __hx_ctor__TS44(haxe.root.TS44 __temp_me15)
	{
	}
	...
	{
		//line 7 "/shared/core/test/TS44.hx"
		java.lang.String w = "";
		//line 8 "/shared/core/test/TS44.hx"
		{
			//line 8 "/shared/core/test/TS44.hx"
			int _g = 0;
			//line 8 "/shared/core/test/TS44.hx"
			...
			while (( _g < _g1.length ))
			{
				...
				//line 8 "/shared/core/test/TS44.hx"
				 ++ _g;
				//line 9 "/shared/core/test/TS44.hx"
				w = arg;
			}
			
		}
		
		//line 10 "/shared/core/test/TS44.hx"
		...
		//line 12 "/shared/core/test/TS44.hx"
		int x = ((int) (haxe.lang.Runtime.toInt(haxe.root.Std.parseInt(w))) );
		//line 56 "/shared/core/test/TS44.hx"
	...
	{
		//line 73 "/shared/core/test/TS44.hx"
		utest.Runner runner = new utest.Runner();
		//line 74 "/shared/core/test/TS44.hx"
		haxe.root.TS44.addTests(runner);
		//line 75 "/shared/core/test/TS44.hx"
		utest.ui.Report.create(runner, null, null);
		//line 76 "/shared/core/test/TS44.hx"
		runner.run();
	}
