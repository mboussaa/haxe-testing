...
public class TestFormat extends haxe.lang.HxObject
{
	...
	public TestFormat()
	{
		//line 12 "/shared/format/test/thx/format/TestFormat.hx"
		thx.format.TestFormat.__hx_ctor_thx_format_TestFormat(this);
	}
	
	
	public static void __hx_ctor_thx_format_TestFormat(thx.format.TestFormat __temp_me172)
	{
	}
	...
	public static java.lang.Object __hx_createEmpty()
	{
		...
		return new thx.format.TestFormat(haxe.lang.EmptyObject.EMPTY);
	}
	...
	{
		//line 9 "/shared/format/test/thx/format/TestFormat.hx"
		return new thx.format.TestFormat();
	}
	
	
	public void testF()
	{
		//line 15 "/shared/format/test/thx/format/TestFormat.hx"
		haxe.root.Array<java.lang.Object> date = thx._DateTime.DateTime_Impl_.fromString("2014-01-01");
		//line 16 "/shared/format/test/thx/format/TestFormat.hx"
		utest.Assert.equals("Wednesday, 01 January 2014", thx.format.DateFormat.format(date, "D", null), null, new haxe.lang.DynamicObject(new java.lang.String[]{"className", "fileName", "methodName"}, new java.lang.Object[]{"thx.format.TestFormat", "TestFormat.hx", "testF"}, new java.lang.String[]{"lineNumber"}, new double[]{((double) (((double) (16) )) )}));
		//line 17 "/shared/format/test/thx/format/TestFormat.hx"
		utest.Assert.equals("Wednesday, 01 January 2014", thx.format.DateFormat.format(thx._DateTime.DateTime_Impl_.fromString("2014-01-01"), "D", null), null, new haxe.lang.DynamicObject(new java.lang.String[]{"className", "fileName", "methodName"}, new java.lang.Object[]{"thx.format.TestFormat", "TestFormat.hx", "testF"}, new java.lang.String[]{"lineNumber"}, new double[]{((double) (((double) (17) )) )}));
		//line 18 "/shared/format/test/thx/format/TestFormat.hx"
		utest.Assert.equals("1,000.00", thx.format.NumberFormat.format(((double) (1000) ), "n", null), null, new haxe.lang.DynamicObject(new java.lang.String[]{"className", "fileName", "methodName"}, new java.lang.Object[]{"thx.format.TestFormat", "TestFormat.hx", "testF"}, new java.lang.String[]{"lineNumber"}, new double[]{((double) (((double) (18) )) )}));
		//line 20 "/shared/format/test/thx/format/TestFormat.hx"
		utest.Assert.equals("mercoled\u00ec 1 gennaio 2014", thx.format.DateFormat.format(thx._DateTime.DateTime_Impl_.fromString("2014-01-01"), "D", thx.format.TestFormat.it), null, new haxe.lang.DynamicObject(new java.lang.String[]{"className", "fileName", "methodName"}, new java.lang.Object[]{"thx.format.TestFormat", "TestFormat.hx", "testF"}, new java.lang.String[]{"lineNumber"}, new double[]{((double) (((double) (20) )) )}));
		//line 21 "/shared/format/test/thx/format/TestFormat.hx"
		utest.Assert.equals("1.000,00", thx.format.NumberFormat.format(((double) (1000) ), "n", thx.format.TestFormat.it), null, new haxe.lang.DynamicObject(new java.lang.String[]{"className", "fileName", "methodName"}, new java.lang.Object[]{"thx.format.TestFormat", "TestFormat.hx", "testF"}, new java.lang.String[]{"lineNumber"}, new double[]{((double) (((double) (21) )) )}));
	}
