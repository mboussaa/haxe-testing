...
public class TestTimeFormat extends haxe.lang.HxObject
{
	...
	public TestTimeFormat(int i)
	{
		//line 16 "/shared/format/test/thx/format/TestTimeFormat.hx"
		thx.format.TestTimeFormat.__hx_ctor_thx_format_TestTimeFormat(this, i);
	}
	
	
	public static void __hx_ctor_thx_format_TestTimeFormat(thx.format.TestTimeFormat __temp_me139, int i)
	{
		//line 17 "/shared/format/test/thx/format/TestTimeFormat.hx"
		__temp_me139.x = i;
	}
	...
	public static java.lang.Object __hx_createEmpty()
	{
		...
		return new thx.format.TestTimeFormat(((haxe.lang.EmptyObject) (haxe.lang.EmptyObject.EMPTY) ));
	}
	...
	{
		//line 9 "/shared/format/test/thx/format/TestTimeFormat.hx"
		return new thx.format.TestTimeFormat(((int) (haxe.lang.Runtime.toInt(arr.__get(0))) ));
	}
	...
	public void testCustomFormat()
	{
		...
		while (( _g1 < _g ))
		{
			...
			utest.Assert.equals("245 30, 0,12", thx.format.TimeFormat.format(thx._Time.Time_Impl_.fromString("245:30:00.1234567"), "H m, s.ff", thx.format.TestTimeFormat.it), null, new haxe.lang.DynamicObject(new java.lang.String[]{"className", "fileName", "methodName"}, new java.lang.Object[]{"thx.format.TestTimeFormat", "TestTimeFormat.hx", "testCustomFormat"}, new java.lang.String[]{"lineNumber"}, new double[]{((double) (((double) (23) )) )}));
			//line 24 "/shared/format/test/thx/format/TestTimeFormat.hx"
			utest.Assert.equals("10,05 30, 0,123", thx.format.TimeFormat.format(thx._Time.Time_Impl_.fromString("245:30:00.1234567"), "d.hh m, s.fff", thx.format.TestTimeFormat.it), null, new haxe.lang.DynamicObject(new java.lang.String[]{"className", "fileName", "methodName"}, new java.lang.Object[]{"thx.format.TestTimeFormat", "TestTimeFormat.hx", "testCustomFormat"}, new java.lang.String[]{"lineNumber"}, new double[]{((double) (((double) (24) )) )}));
			//line 25 "/shared/format/test/thx/format/TestTimeFormat.hx"
			utest.Assert.equals("245 30, 0 0", thx.format.TimeFormat.format(thx._Time.Time_Impl_.fromString("245:30:00"), "H m, s.ff f", thx.format.TestTimeFormat.it), null, new haxe.lang.DynamicObject(new java.lang.String[]{"className", "fileName", "methodName"}, new java.lang.Object[]{"thx.format.TestTimeFormat", "TestTimeFormat.hx", "testCustomFormat"}, new java.lang.String[]{"lineNumber"}, new double[]{((double) (((double) (25) )) )}));
			//line 26 "/shared/format/test/thx/format/TestTimeFormat.hx"
			utest.Assert.equals("10,05 30 1 0000", thx.format.TimeFormat.format(thx._Time.Time_Impl_.fromString("245:30:01"), "d.hh m s.fff ffff", thx.format.TestTimeFormat.it), null, new haxe.lang.DynamicObject(new java.lang.String[]{"className", "fileName", "methodName"}, new java.lang.Object[]{"thx.format.TestTimeFormat", "TestTimeFormat.hx", "testCustomFormat"}, new java.lang.String[]{"lineNumber"}, new double[]{((double) (((double) (26) )) )}));
			//line 27 "/shared/format/test/thx/format/TestTimeFormat.hx"
			utest.Assert.equals("245 30, 0 ", thx.format.TimeFormat.format(thx._Time.Time_Impl_.fromString("245:30:00"), "H m, s.FF F", thx.format.TestTimeFormat.it), null, new haxe.lang.DynamicObject(new java.lang.String[]{"className", "fileName", "methodName"}, new java.lang.Object[]{"thx.format.TestTimeFormat", "TestTimeFormat.hx", "testCustomFormat"}, new java.lang.String[]{"lineNumber"}, new double[]{((double) (((double) (27) )) )}));
			//line 28 "/shared/format/test/thx/format/TestTimeFormat.hx"
			utest.Assert.equals("10,05 30, 1 ", thx.format.TimeFormat.format(thx._Time.Time_Impl_.fromString("245:30:01"), "d.hh m, s.FFF FFFF", thx.format.TestTimeFormat.it), null, new haxe.lang.DynamicObject(new java.lang.String[]{"className", "fileName", "methodName"}, new java.lang.Object[]{"thx.format.TestTimeFormat", "TestTimeFormat.hx", "testCustomFormat"}, new java.lang.String[]{"lineNumber"}, new double[]{((double) (((double) (28) )) )}));
		}
