...
void TestBigIntFormat_obj::__construct(){
            	HX_STACK_FRAME("thx.format.TestBigIntFormat","new",0x2d9088d7,"thx.format.TestBigIntFormat.new","thx/format/TestBigIntFormat.hx",14,0x15300059)
            	HX_STACK_THIS(this)
            	}

Dynamic TestBigIntFormat_obj::__CreateEmpty() { return new TestBigIntFormat_obj; }

hx::ObjectPtr< TestBigIntFormat_obj > TestBigIntFormat_obj::__new()
{
...
void TestBigIntFormat_obj::testInteger(){
            	HX_STACK_FRAME("thx.format.TestBigIntFormat","testInteger",0x2ed13303,"thx.format.TestBigIntFormat.testInteger","thx/format/TestBigIntFormat.hx",17,0x15300059)
            	HX_STACK_THIS(this)
HXLINE(  17)		::String _hx_tmp = ::thx::format::BigIntFormat_obj::integer(::thx::bigint::Bigs_obj::fromInt((int)12345),null());
HXDLIN(  17)		::utest::Assert_obj::equals(HX_("12,345",29,f3,c1,7e),_hx_tmp,null(),hx::SourceInfo(HX_("TestBigIntFormat.hx",86,15,67,4d),17,HX_("thx.format.TestBigIntFormat",65,d1,9f,ec),HX_("testInteger",8c,ab,e4,d3)));
            	}
...
void TestBigIntFormat_obj::testFormatHex(){
            	HX_STACK_FRAME("thx.format.TestBigIntFormat","testFormatHex",0xa1379869,"thx.format.TestBigIntFormat.testFormatHex","thx/format/TestBigIntFormat.hx",20,0x15300059)
            	HX_STACK_THIS(this)
HXLINE(  21)		::String _hx_tmp = ::thx::format::BigIntFormat_obj::format(::thx::bigint::Bigs_obj::fromInt((int)123),HX_("x",78,00,00,00),null());
HXDLIN(  21)		::utest::Assert_obj::equals(HX_("7b",4b,30,00,00),_hx_tmp,null(),hx::SourceInfo(HX_("TestBigIntFormat.hx",86,15,67,4d),21,HX_("thx.format.TestBigIntFormat",65,d1,9f,ec),HX_("testFormatHex",32,05,81,4c)));
HXLINE(  22)		::String _hx_tmp1 = ::thx::format::BigIntFormat_obj::format(::thx::bigint::Bigs_obj::fromInt((int)123),HX_("X",58,00,00,00),null());
HXDLIN(  22)		::utest::Assert_obj::equals(HX_("7B",2b,30,00,00),_hx_tmp1,null(),hx::SourceInfo(HX_("TestBigIntFormat.hx",86,15,67,4d),22,HX_("thx.format.TestBigIntFormat",65,d1,9f,ec),HX_("testFormatHex",32,05,81,4c)));
HXLINE(  23)		::String _hx_tmp2 = ::thx::format::BigIntFormat_obj::format(::thx::bigint::Bigs_obj::fromInt((int)123),HX_("x4",bc,68,00,00),null());
HXDLIN(  23)		::utest::Assert_obj::equals(HX_("007b",4b,da,de,1f),_hx_tmp2,null(),hx::SourceInfo(HX_("TestBigIntFormat.hx",86,15,67,4d),23,HX_("thx.format.TestBigIntFormat",65,d1,9f,ec),HX_("testFormatHex",32,05,81,4c)));
HXLINE(  24)		::String _hx_tmp3 = ::thx::format::BigIntFormat_obj::format(::thx::bigint::Bigs_obj::fromInt((int)123),HX_("X6",de,4c,00,00),null());
HXDLIN(  24)		::utest::Assert_obj::equals(HX_("00007B",2b,04,3c,f4),_hx_tmp3,null(),hx::SourceInfo(HX_("TestBigIntFormat.hx",86,15,67,4d),24,HX_("thx.format.TestBigIntFormat",65,d1,9f,ec),HX_("testFormatHex",32,05,81,4c)));
            	}
...
void TestBigIntFormat_obj::testOctal(){
            	HX_STACK_FRAME("thx.format.TestBigIntFormat","testOctal",0x785607d0,"thx.format.TestBigIntFormat.testOctal","thx/format/TestBigIntFormat.hx",28,0x15300059)
            	HX_STACK_THIS(this)
HXLINE(  28)		::String _hx_tmp = ::thx::format::BigIntFormat_obj::octal(::thx::bigint::Bigs_obj::fromInt((int)74),null(),null());
HXDLIN(  28)		::utest::Assert_obj::equals(HX_("112",52,59,25,00),_hx_tmp,null(),hx::SourceInfo(HX_("TestBigIntFormat.hx",86,15,67,4d),28,HX_("thx.format.TestBigIntFormat",65,d1,9f,ec),HX_("testOctal",19,1c,45,f4)));
            	}
...
void TestBigIntFormat_obj::testHex(){
            	HX_STACK_FRAME("thx.format.TestBigIntFormat","testHex",0x786571a0,"thx.format.TestBigIntFormat.testHex","thx/format/TestBigIntFormat.hx",32,0x15300059)
            	HX_STACK_THIS(this)
HXLINE(  32)		::String _hx_tmp = ::thx::format::BigIntFormat_obj::hex(::thx::bigint::Bigs_obj::fromInt((int)10995),null(),null());
HXDLIN(  32)		::utest::Assert_obj::equals(HX_("2af3",bc,9e,56,21),_hx_tmp,null(),hx::SourceInfo(HX_("TestBigIntFormat.hx",86,15,67,4d),32,HX_("thx.format.TestBigIntFormat",65,d1,9f,ec),HX_("testHex",a9,b1,bd,bd)));
            	}
...
void TestBigIntFormat_obj::testBinary(){
            	HX_STACK_FRAME("thx.format.TestBigIntFormat","testBinary",0x10bd565c,"thx.format.TestBigIntFormat.testBinary","thx/format/TestBigIntFormat.hx",35,0x15300059)
            	HX_STACK_THIS(this)
HXLINE(  36)		::String _hx_tmp = ::thx::format::BigIntFormat_obj::binary(::thx::bigint::Bigs_obj::fromInt((int)25),null());
HXDLIN(  36)		::utest::Assert_obj::equals(HX_("11001",51,77,2a,57),_hx_tmp,null(),hx::SourceInfo(HX_("TestBigIntFormat.hx",86,15,67,4d),36,HX_("thx.format.TestBigIntFormat",65,d1,9f,ec),HX_("testBinary",f3,01,00,06)));
HXLINE(  37)		::String _hx_tmp1 = ::thx::format::BigIntFormat_obj::binary(::thx::bigint::Bigs_obj::fromInt((int)-133),null());
HXDLIN(  37)		::utest::Assert_obj::equals(HX_("-10000101",8e,51,5a,c7),_hx_tmp1,null(),hx::SourceInfo(HX_("TestBigIntFormat.hx",86,15,67,4d),37,HX_("thx.format.TestBigIntFormat",65,d1,9f,ec),HX_("testBinary",f3,01,00,06)));
            	}
...
#if HXCPP_SCRIPTABLE
static hx::StorageInfo *TestBigIntFormat_obj_sMemberStorageInfo = 0;
