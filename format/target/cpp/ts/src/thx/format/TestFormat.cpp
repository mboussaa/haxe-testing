...
void TestFormat_obj::__construct(){
            	HX_STACK_FRAME("thx.format.TestFormat","new",0x952b6ea8,"thx.format.TestFormat.new","thx/format/TestFormat.hx",12,0x7febd7a8)
            	HX_STACK_THIS(this)
            	}

Dynamic TestFormat_obj::__CreateEmpty() { return new TestFormat_obj; }

hx::ObjectPtr< TestFormat_obj > TestFormat_obj::__new()
{
...
void TestFormat_obj::testF(){
            	HX_STACK_FRAME("thx.format.TestFormat","testF",0x3e473ffc,"thx.format.TestFormat.testF","thx/format/TestFormat.hx",14,0x7febd7a8)
            	HX_STACK_THIS(this)
HXLINE(  15)		HX_VARI( ::Array< ::Dynamic>,date) = ::thx::_DateTime::DateTime_Impl__obj::fromString(HX_("2014-01-01",a1,e9,a3,42));
HXLINE(  30)		::String _hx_tmp = ::thx::format::DateFormat_obj::format(date,HX_("D",44,00,00,00),null());
HXLINE(  16)		::utest::Assert_obj::equals(HX_("Wednesday, 01 January 2014",0c,3e,f5,4f),_hx_tmp,null(),hx::SourceInfo(HX_("TestFormat.hx",15,9d,5d,94),16,HX_("thx.format.TestFormat",b6,3a,5d,fb),HX_("testF",b4,7f,95,0d)));
...
HXLINE(  17)		::utest::Assert_obj::equals(HX_("Wednesday, 01 January 2014",0c,3e,f5,4f),_hx_tmp1,null(),hx::SourceInfo(HX_("TestFormat.hx",15,9d,5d,94),17,HX_("thx.format.TestFormat",b6,3a,5d,fb),HX_("testF",b4,7f,95,0d)));
HXLINE(  38)		::String _hx_tmp2 = ::thx::format::NumberFormat_obj::format((int)1000,HX_("n",6e,00,00,00),null());
HXLINE(  18)		::utest::Assert_obj::equals(HX_("1,000.00",99,ba,92,0c),_hx_tmp2,null(),hx::SourceInfo(HX_("TestFormat.hx",15,9d,5d,94),18,HX_("thx.format.TestFormat",b6,3a,5d,fb),HX_("testF",b4,7f,95,0d)));
HXLINE(  20)		::Array< ::Dynamic> _hx_tmp3 = ::thx::_DateTime::DateTime_Impl__obj::fromString(HX_("2014-01-01",a1,e9,a3,42));
HXLINE(  30)		::String _hx_tmp4 = ::thx::format::DateFormat_obj::format(_hx_tmp3,HX_("D",44,00,00,00),::thx::format::TestFormat_obj::it);
HXLINE(  20)		::utest::Assert_obj::equals(HX_("mercoled\xc3""\xac"" 1 gennaio 2014",59,f9,46,9e),_hx_tmp4,null(),hx::SourceInfo(HX_("TestFormat.hx",15,9d,5d,94),20,HX_("thx.format.TestFormat",b6,3a,5d,fb),HX_("testF",b4,7f,95,0d)));
HXLINE(  38)		::String _hx_tmp5 = ::thx::format::NumberFormat_obj::format((int)1000,HX_("n",6e,00,00,00),::thx::format::TestFormat_obj::it);
HXLINE(  21)		::utest::Assert_obj::equals(HX_("1.000,00",99,23,bc,5f),_hx_tmp5,null(),hx::SourceInfo(HX_("TestFormat.hx",15,9d,5d,94),21,HX_("thx.format.TestFormat",b6,3a,5d,fb),HX_("testF",b4,7f,95,0d)));
            	}
...
#if HXCPP_SCRIPTABLE
static hx::StorageInfo *TestFormat_obj_sMemberStorageInfo = 0;
