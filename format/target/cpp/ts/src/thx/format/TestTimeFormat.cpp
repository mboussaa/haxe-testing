...
void TestTimeFormat_obj::__construct(){
            	HX_STACK_FRAME("thx.format.TestTimeFormat","new",0xf56c9c95,"thx.format.TestTimeFormat.new","thx/format/TestTimeFormat.hx",15,0xaf75f65b)
            	HX_STACK_THIS(this)
            	}

Dynamic TestTimeFormat_obj::__CreateEmpty() { return new TestTimeFormat_obj; }

hx::ObjectPtr< TestTimeFormat_obj > TestTimeFormat_obj::__new()
{
...
void TestTimeFormat_obj::testCustomFormat(){
            	HX_STACK_FRAME("thx.format.TestTimeFormat","testCustomFormat",0x05a623e5,"thx.format.TestTimeFormat.testCustomFormat","thx/format/TestTimeFormat.hx",18,0xaf75f65b)
            	HX_STACK_THIS(this)
HXLINE(  19)		::String _hx_tmp = ::thx::format::TimeFormat_obj::format(::thx::_Time::Time_Impl__obj::fromString(HX_("245:30:00.1234567",fc,b5,1b,be)),HX_("H m, s.ff",24,97,84,7f),::thx::format::TestTimeFormat_obj::it);
HXDLIN(  19)		::utest::Assert_obj::equals(HX_("245 30, 0,12",3b,60,9e,87),_hx_tmp,null(),hx::SourceInfo(HX_("TestTimeFormat.hx",48,76,5b,03),19,HX_("thx.format.TestTimeFormat",23,ae,3b,3d),HX_("testCustomFormat",3a,2d,6c,dd)));
HXLINE(  20)		::String _hx_tmp1 = ::thx::format::TimeFormat_obj::format(::thx::_Time::Time_Impl__obj::fromString(HX_("245:30:00.1234567",fc,b5,1b,be)),HX_("d.hh m, s.fff",00,f0,c0,87),::thx::format::TestTimeFormat_obj::it);
HXDLIN(  20)		::utest::Assert_obj::equals(HX_("10,05 30, 0,123",d7,61,1e,7e),_hx_tmp1,null(),hx::SourceInfo(HX_("TestTimeFormat.hx",48,76,5b,03),20,HX_("thx.format.TestTimeFormat",23,ae,3b,3d),HX_("testCustomFormat",3a,2d,6c,dd)));
HXLINE(  21)		::String _hx_tmp2 = ::thx::format::TimeFormat_obj::format(::thx::_Time::Time_Impl__obj::fromString(HX_("245:30:00",36,34,60,1b)),HX_("H m, s.ff f",6a,c4,33,db),::thx::format::TestTimeFormat_obj::it);
HXDLIN(  21)		::utest::Assert_obj::equals(HX_("245 30, 0 0",a2,29,af,f1),_hx_tmp2,null(),hx::SourceInfo(HX_("TestTimeFormat.hx",48,76,5b,03),21,HX_("thx.format.TestTimeFormat",23,ae,3b,3d),HX_("testCustomFormat",3a,2d,6c,dd)));
HXLINE(  22)		::String _hx_tmp3 = ::thx::format::TimeFormat_obj::format(::thx::_Time::Time_Impl__obj::fromString(HX_("245:30:01",37,34,60,1b)),HX_("d.hh m s.fff ffff",fe,56,55,7e),::thx::format::TestTimeFormat_obj::it);
HXDLIN(  22)		::utest::Assert_obj::equals(HX_("10,05 30 1 0000",84,c1,68,23),_hx_tmp3,null(),hx::SourceInfo(HX_("TestTimeFormat.hx",48,76,5b,03),22,HX_("thx.format.TestTimeFormat",23,ae,3b,3d),HX_("testCustomFormat",3a,2d,6c,dd)));
HXLINE(  23)		::String _hx_tmp4 = ::thx::format::TimeFormat_obj::format(::thx::_Time::Time_Impl__obj::fromString(HX_("245:30:00",36,34,60,1b)),HX_("H m, s.FF F",4a,a8,f4,c5),::thx::format::TestTimeFormat_obj::it);
HXDLIN(  23)		::utest::Assert_obj::equals(HX_("245 30, 0 ",ce,4a,52,96),_hx_tmp4,null(),hx::SourceInfo(HX_("TestTimeFormat.hx",48,76,5b,03),23,HX_("thx.format.TestTimeFormat",23,ae,3b,3d),HX_("testCustomFormat",3a,2d,6c,dd)));
HXLINE(  24)		::String _hx_tmp5 = ::thx::format::TimeFormat_obj::format(::thx::_Time::Time_Impl__obj::fromString(HX_("245:30:01",37,34,60,1b)),HX_("d.hh m, s.FFF FFFF",c0,42,bd,7d),::thx::format::TestTimeFormat_obj::it);
HXDLIN(  24)		::utest::Assert_obj::equals(HX_("10,05 30, 1 ",0e,f0,25,88),_hx_tmp5,null(),hx::SourceInfo(HX_("TestTimeFormat.hx",48,76,5b,03),24,HX_("thx.format.TestTimeFormat",23,ae,3b,3d),HX_("testCustomFormat",3a,2d,6c,dd)));
            	}
...
#if HXCPP_SCRIPTABLE
static hx::StorageInfo *TestTimeFormat_obj_sMemberStorageInfo = 0;
