...
void TestTimeFormat_obj::__construct(Int i){
            	HX_STACK_FRAME("thx.format.TestTimeFormat","new",0xf56c9c95,"thx.format.TestTimeFormat.new","thx/format/TestTimeFormat.hx",17,0xaf75f65b)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(i,"i")
HXLINE(  17)		this->x = i;
            	}

Dynamic TestTimeFormat_obj::__CreateEmpty() { return new TestTimeFormat_obj; }

hx::ObjectPtr< TestTimeFormat_obj > TestTimeFormat_obj::__new(Int i)
{
	hx::ObjectPtr< TestTimeFormat_obj > _hx_result = new TestTimeFormat_obj();
	_hx_result->__construct(i);
	return _hx_result;
}

Dynamic TestTimeFormat_obj::__Create(hx::DynamicArray inArgs)
{
	hx::ObjectPtr< TestTimeFormat_obj > _hx_result = new TestTimeFormat_obj();
...
void TestTimeFormat_obj::testCustomFormat(){
            	HX_STACK_FRAME("thx.format.TestTimeFormat","testCustomFormat",0x05a623e5,"thx.format.TestTimeFormat.testCustomFormat","thx/format/TestTimeFormat.hx",22,0xaf75f65b)
            	HX_STACK_THIS(this)
HXLINE(  22)		HX_VARI( Int,_g1) = (int)0;
HXDLIN(  22)		HX_VARI( Int,_g) = this->x;
HXDLIN(  22)		while((_g1 < _g)){
HXLINE(  22)			++_g1;
HXLINE(  23)			::String _hx_tmp = ::thx::format::TimeFormat_obj::format(::thx::_Time::Time_Impl__obj::fromString(HX_("245:30:00.1234567",fc,b5,1b,be)),HX_("H m, s.ff",24,97,84,7f),::thx::format::TestTimeFormat_obj::it);
HXDLIN(  23)			::utest::Assert_obj::equals(HX_("245 30, 0,12",3b,60,9e,87),_hx_tmp,null(),hx::SourceInfo(HX_("TestTimeFormat.hx",48,76,5b,03),23,HX_("thx.format.TestTimeFormat",23,ae,3b,3d),HX_("testCustomFormat",3a,2d,6c,dd)));
HXLINE(  24)			::String _hx_tmp1 = ::thx::format::TimeFormat_obj::format(::thx::_Time::Time_Impl__obj::fromString(HX_("245:30:00.1234567",fc,b5,1b,be)),HX_("d.hh m, s.fff",00,f0,c0,87),::thx::format::TestTimeFormat_obj::it);
HXDLIN(  24)			::utest::Assert_obj::equals(HX_("10,05 30, 0,123",d7,61,1e,7e),_hx_tmp1,null(),hx::SourceInfo(HX_("TestTimeFormat.hx",48,76,5b,03),24,HX_("thx.format.TestTimeFormat",23,ae,3b,3d),HX_("testCustomFormat",3a,2d,6c,dd)));
HXLINE(  25)			::String _hx_tmp2 = ::thx::format::TimeFormat_obj::format(::thx::_Time::Time_Impl__obj::fromString(HX_("245:30:00",36,34,60,1b)),HX_("H m, s.ff f",6a,c4,33,db),::thx::format::TestTimeFormat_obj::it);
HXDLIN(  25)			::utest::Assert_obj::equals(HX_("245 30, 0 0",a2,29,af,f1),_hx_tmp2,null(),hx::SourceInfo(HX_("TestTimeFormat.hx",48,76,5b,03),25,HX_("thx.format.TestTimeFormat",23,ae,3b,3d),HX_("testCustomFormat",3a,2d,6c,dd)));
HXLINE(  26)			::String _hx_tmp3 = ::thx::format::TimeFormat_obj::format(::thx::_Time::Time_Impl__obj::fromString(HX_("245:30:01",37,34,60,1b)),HX_("d.hh m s.fff ffff",fe,56,55,7e),::thx::format::TestTimeFormat_obj::it);
HXDLIN(  26)			::utest::Assert_obj::equals(HX_("10,05 30 1 0000",84,c1,68,23),_hx_tmp3,null(),hx::SourceInfo(HX_("TestTimeFormat.hx",48,76,5b,03),26,HX_("thx.format.TestTimeFormat",23,ae,3b,3d),HX_("testCustomFormat",3a,2d,6c,dd)));
HXLINE(  27)			::String _hx_tmp4 = ::thx::format::TimeFormat_obj::format(::thx::_Time::Time_Impl__obj::fromString(HX_("245:30:00",36,34,60,1b)),HX_("H m, s.FF F",4a,a8,f4,c5),::thx::format::TestTimeFormat_obj::it);
HXDLIN(  27)			::utest::Assert_obj::equals(HX_("245 30, 0 ",ce,4a,52,96),_hx_tmp4,null(),hx::SourceInfo(HX_("TestTimeFormat.hx",48,76,5b,03),27,HX_("thx.format.TestTimeFormat",23,ae,3b,3d),HX_("testCustomFormat",3a,2d,6c,dd)));
HXLINE(  28)			::String _hx_tmp5 = ::thx::format::TimeFormat_obj::format(::thx::_Time::Time_Impl__obj::fromString(HX_("245:30:01",37,34,60,1b)),HX_("d.hh m, s.FFF FFFF",c0,42,bd,7d),::thx::format::TestTimeFormat_obj::it);
HXDLIN(  28)			::utest::Assert_obj::equals(HX_("10,05 30, 1 ",0e,f0,25,88),_hx_tmp5,null(),hx::SourceInfo(HX_("TestTimeFormat.hx",48,76,5b,03),28,HX_("thx.format.TestTimeFormat",23,ae,3b,3d),HX_("testCustomFormat",3a,2d,6c,dd)));
            		}
            	}


HX_DEFINE_DYNAMIC_FUNC0(TestTimeFormat_obj,testCustomFormat,(void))

 ::thx::culture::Culture TestTimeFormat_obj::it;

 ::thx::culture::Culture TestTimeFormat_obj::bn;

 ::thx::culture::Culture TestTimeFormat_obj::us;

 ::cpp::Int64Struct TestTimeFormat_obj::t1;

 ::cpp::Int64Struct TestTimeFormat_obj::t2;


TestTimeFormat_obj::TestTimeFormat_obj()
{
}

hx::Val TestTimeFormat_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
	...
	case 1:
		...
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"testCustomFormat") ) { return hx::Val( testCustomFormat_dyn()); }
	}
	return super::__Field(inName,inCallProp);
}

bool TestTimeFormat_obj::__GetStatic(const ::String &inName, Dynamic &outValue, hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 2:
		if (HX_FIELD_EQ(inName,"it") ) { outValue = it; return true; }
		if (HX_FIELD_EQ(inName,"bn") ) { outValue = bn; return true; }
...
hx::Val TestTimeFormat_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 1:
...
bool TestTimeFormat_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 2:
		if (HX_FIELD_EQ(inName,"it") ) { it=ioValue.Cast<  ::thx::culture::Culture >(); return true; }
		if (HX_FIELD_EQ(inName,"bn") ) { bn=ioValue.Cast<  ::thx::culture::Culture >(); return true; }
		if (HX_FIELD_EQ(inName,"us") ) { us=ioValue.Cast<  ::thx::culture::Culture >(); return true; }
		if (HX_FIELD_EQ(inName,"t1") ) { t1=ioValue.Cast<  ::cpp::Int64Struct >(); return true; }
		if (HX_FIELD_EQ(inName,"t2") ) { t2=ioValue.Cast<  ::cpp::Int64Struct >(); return true; }
	}
	return false;
}

void TestTimeFormat_obj::__GetFields(Array< ::String> &outFields)
{
...
#if HXCPP_SCRIPTABLE
static hx::StorageInfo TestTimeFormat_obj_sMemberStorageInfo[] = {
	{hx::fsInt,(int)offsetof(TestTimeFormat_obj,x),HX_HCSTRING("x","\x78","\x00","\x00","\x00")},
	{ hx::fsUnknown, 0, null()}
};
static hx::StaticInfo TestTimeFormat_obj_sStaticStorageInfo[] = {
	{hx::fsObject /*::thx::culture::Culture*/ ,(void *) &TestTimeFormat_obj::it,HX_HCSTRING("it","\xeb","\x5b","\x00","\x00")},
	{hx::fsObject /*::thx::culture::Culture*/ ,(void *) &TestTimeFormat_obj::bn,HX_HCSTRING("bn","\xcc","\x55","\x00","\x00")},
	{hx::fsObject /*::thx::culture::Culture*/ ,(void *) &TestTimeFormat_obj::us,HX_HCSTRING("us","\x5e","\x66","\x00","\x00")},
	{hx::fsObject /*cpp::Int64Struct*/ ,(void *) &TestTimeFormat_obj::t1,HX_HCSTRING("t1","\x3d","\x65","\x00","\x00")},
	{hx::fsObject /*cpp::Int64Struct*/ ,(void *) &TestTimeFormat_obj::t2,HX_HCSTRING("t2","\x3e","\x65","\x00","\x00")},
	{ hx::fsUnknown, 0, null()}
};
#endif

static ::String TestTimeFormat_obj_sMemberFields[] = {
	HX_HCSTRING("x","\x78","\x00","\x00","\x00"),
	HX_HCSTRING("testCustomFormat","\x3a","\x2d","\x6c","\xdd"),
	::String(null()) };

static void TestTimeFormat_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(TestTimeFormat_obj::__mClass,"__mClass");
	HX_MARK_MEMBER_NAME(TestTimeFormat_obj::it,"it");
	HX_MARK_MEMBER_NAME(TestTimeFormat_obj::bn,"bn");
	HX_MARK_MEMBER_NAME(TestTimeFormat_obj::us,"us");
	HX_MARK_MEMBER_NAME(TestTimeFormat_obj::t1,"t1");
	HX_MARK_MEMBER_NAME(TestTimeFormat_obj::t2,"t2");
};

#ifdef HXCPP_VISIT_ALLOCS
static void TestTimeFormat_obj_sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(TestTimeFormat_obj::__mClass,"__mClass");
	HX_VISIT_MEMBER_NAME(TestTimeFormat_obj::it,"it");
	HX_VISIT_MEMBER_NAME(TestTimeFormat_obj::bn,"bn");
	HX_VISIT_MEMBER_NAME(TestTimeFormat_obj::us,"us");
	HX_VISIT_MEMBER_NAME(TestTimeFormat_obj::t1,"t1");
	HX_VISIT_MEMBER_NAME(TestTimeFormat_obj::t2,"t2");
};

#endif

hx::Class TestTimeFormat_obj::__mClass;

static ::String TestTimeFormat_obj_sStaticFields[] = {
	HX_HCSTRING("it","\xeb","\x5b","\x00","\x00"),
	HX_HCSTRING("bn","\xcc","\x55","\x00","\x00"),
...
void TestTimeFormat_obj::__register()
{
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_HCSTRING("thx.format.TestTimeFormat","\x23","\xae","\x3b","\x3d");
	__mClass->mSuper = &super::__SGetClass();
	__mClass->mConstructEmpty = &__CreateEmpty;
	__mClass->mConstructArgs = &__Create;
	__mClass->mGetStaticField = &TestTimeFormat_obj::__GetStatic;
	__mClass->mSetStaticField = &TestTimeFormat_obj::__SetStatic;
	__mClass->mMarkFunc = TestTimeFormat_obj_sMarkStatics;
	__mClass->mStatics = hx::Class_obj::dupFunctions(TestTimeFormat_obj_sStaticFields);
	__mClass->mMembers = hx::Class_obj::dupFunctions(TestTimeFormat_obj_sMemberFields);
	__mClass->mCanCast = hx::TCanCast< TestTimeFormat_obj >;
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = TestTimeFormat_obj_sVisitStatics;
#endif
#ifdef HXCPP_SCRIPTABLE
	__mClass->mMemberStorageInfo = TestTimeFormat_obj_sMemberStorageInfo;
#endif
#ifdef HXCPP_SCRIPTABLE
	__mClass->mStaticStorageInfo = TestTimeFormat_obj_sStaticStorageInfo;
#endif
	hx::_hx_RegisterClass(__mClass->mName, __mClass);
}

void TestTimeFormat_obj::__boot()
{
{
            	HX_STACK_FRAME("thx.format.TestTimeFormat","boot",0xc1b5665d,"thx.format.TestTimeFormat.boot","thx/culture/Embed.hx",36,0xb6a59b51)
...
HXLINE(  36)		HX_VARI(  ::Dynamic,o) =  ::Dynamic(hx::Anon_obj::Create(16)
            			...
            			->setFixed(1,HX_("number",c9,86,7a,a1), ::Dynamic(hx::Anon_obj::Create(25)
            				...
            				->setFixed(14,HX_("patternNegativePercent",60,30,21,0f),(int)2)
            				->setFixed(15,HX_("patternPositivePercent",9c,00,df,26),(int)2)
            				->setFixed(16,HX_("patternPositiveCurrency",9a,cd,0b,31),(int)2)
            			...
            			->setFixed(2,HX_("nameNative",42,fa,9b,a6),HX_("\xe0""\xa6""\xac""\xe0""\xa6""\xbe""\xe0""\xa6""\x82""\xe0""\xa6""\xb2""\xe0""\xa6""\xbe""",76,6c,82,a7))
            			->setFixed(3,HX_("nameRegionEnglish",51,9f,9c,cc),HX_("India",57,0e,42,51))
            			->setFixed(4,HX_("dateTime",5b,fd,0a,da), ::Dynamic(hx::Anon_obj::Create(27)
            				->setFixed(0,HX_("nameCalendar",29,50,56,86),HX_("Gregorian",c6,ad,49,c5))
            				->setFixed(1,HX_("patternUniversalSortable",33,cc,22,95),HX_("yyyy'-'MM'-'dd HH':'mm':'ss'Z'",d4,92,25,cb))
            				->setFixed(2,HX_("patternDateTimeFull",fa,e6,03,9b),HX_("dd MMMM yyyy HH.mm.ss",a0,38,99,6f))
            				->setFixed(3,HX_("nameCalendarNative",a0,92,93,9f),HX_("\xe0""\xa6""\x87""\xe0""\xa6""\x82""\xe0""\xa6""\xb0""\xe0""\xa7""\x87""\xe0""\xa6""\x9c""\xe0""\xa7""\x80"" \xe0""\xa6""\x95""\xe0""\xa7""\x8d""\xe0""\xa6""\xaf""\xe0""\xa6""\xbe""\xe0""\xa6""\xb2""\xe0""\xa7""\x87""\xe0""\xa6""\xa8""\xe0""\xa7""\x8d""\xe0""\xa6""\xa1""\xe0""\xa6""\xbe""\xe0""\xa6""\xb0""
\xe0""\xa7""\x8d""\xe0""\xa6""\xb0"".",a5,ed,67,69))->init(6,HX_("\xe0""\xa6""\xb6""\xe0""\xa6""\xa8""\xe0""\xa6""\xbf"".",c7,c6,75,c5)))
            				->setFixed(16,HX_("patternTimeShort",bf,e8,a8,30),HX_("HH.mm",0e,68,94,a4))
            				->setFixed(17,HX_("separatorTime",12,ef,fd,33),HX_(".",2e,00,00,00))
            				->setFixed(18,HX_("patternTimeLong",99,ba,28,36),HX_("HH.mm.ss",00,e1,80,37))
            				->setFixed(19,HX_("firstDayOfWeekIndex",bb,01,8c,37),(int)1)
            				->setFixed(20,HX_("patternYearMonth",d3,8f,70,3a),HX_("MMMM, yyyy",f4,2a,01,54))
            				->setFixed(21,HX_("nameDays",82,7a,ea,3e),::Array_obj< ::String >::__new(7)->init(0,HX_("\xe0""\xa6""\xb0""\xe0""\xa6""\xac""\xe0""\xa6""\xbf""\xe0""\xa6""\xac""\xe0""\xa6""\xbe""\xe0""\xa6""\xb0""",7b,64,e8,34))->init(1,HX_("\xe0""\xa6""\xb8""\xe0""\xa7""\x8b""\xe0""\xa6""\xae""\xe0""\xa6""\xac""\xe0""\xa6""\xbe""\xe0""\xa6""\xb0""",62,dd,54,6e))->init(2,HX_("\xe0""\xa6""\xae""\xe0""\xa6""\x99""\xe0""\xa7""\x8d""\xe0""\xa6""\x97""\xe0""\xa6""\xb2""\xe0""\xa6""\xac""\xe0""\xa6""\xbe""\xe0""\xa6""\xb0""",02,95,2a,23))->init(3,HX_("\xe0""\xa6""\xac""\xe0""\xa7""\x81""\xe0""\xa6""\xa7""\xe0""\xa6""\xac""\xe0""\xa6""\xbe""\xe0""\xa6""\xb0""",cb,c1,84,1c))->init(4,HX_("\xe0""\xa6""\xac""\xe0""\xa7""\x83""\xe0""\xa6""\xb9""\xe0""\xa6""\xb8""\xe0""\xa7""\x8d""\xe0""\xa6""\xaa""\xe0""\xa6""\xa4""\xe0""\xa6""\xbf""\xe0""\xa6""\xac""\xe0""\xa6""\xbe""\xe0""\xa6""\xb0""",2a,25,8c,b3))->init(5,HX_("\xe0""\xa6""\xb6""\xe0""\xa7""\x81""\xe0""\xa6""\x95""\xe0""\xa7""\x8d""\xe0""\xa6""\xb0""\xe0""\xa6""\xac""\xe0""\xa6""\xbe""\xe0""\xa6""\xb0""",0f,9a,e8,71))->init(6,HX_("\xe0""\xa6""\xb6""\xe0""\xa6""\xa8""\xe0""\xa6""\xbf""\xe0""\xa6""\xac""\xe0""\xa6""\xbe""\xe0""\xa6""\xb0""",31,65,07,c9)))
            				->setFixed(22,HX_("nameMonthsAbbreviated",db,78,52,40),::Array_obj< ::String >::__new(13)->init(0,HX_("\xe0""\xa6""\x9c""\xe0""\xa6""\xbe""\xe0""\xa6""\xa8""\xe0""\xa7""\x81"".",94,25,22,c1))->init(1,HX_("\xe0""\xa6""\xab""\xe0""\xa7""\x87""\xe0""\xa6""\xac""\xe0""\xa7""\x8d""\xe0""\xa6""\xb0""\xe0""\xa7""\x81"".",03,1c,53,3f))->init(2,HX_("\xe0""\xa6""\xae""\xe0""\xa6""\xbe""\xe0""\xa6""\xb0""\xe0""\xa7""\x8d""\xe0""\xa6""\x9a""",88,6d,d0,26))->init(3,HX_("\xe0""\xa6""\x8f""\xe0""\xa6""\xaa""\xe0""\xa7""\x8d""\xe0""\xa6""\xb0""\xe0""\xa6""\xbf""\xe0""\xa6""\xb2""",d2,2f,84,95))->init(4,HX_("\xe0""\xa6""\xae""\xe0""\xa7""\x87""",b8,c9,22,98))->init(5,HX_("\xe0""\xa6""\x9c""\xe0""\xa7""\x81""\xe0""\xa6""\xa8""",1e,02,d1,0e))->init(6,HX_("\xe0""\xa6""\x9c""\xe0""\xa7""\x81""\xe0""\xa6""\
            				->setFixed(26,HX_("calendarWeekRuleIndex",44,74,06,6c),(int)0)))
            			->setFixed(5,HX_("isNeutral",7d,6a,28,ef),false)
            			->setFixed(6,HX_("isRightToLeft",54,90,12,f0),false)
            			->setFixed(7,HX_("separatorList",63,3f,b4,2e),HX_(",",2c,00,00,00))
            			->setFixed(8,HX_("nameRegionNative",96,b0,9c,3e),HX_("\xe0""\xa6""\xad""\xe0""\xa6""\xbe""\xe0""\xa6""\xb0""\xe0""\xa6""\xa4""",65,b3,61,2a))
            			->setFixed(9,HX_("code",2d,b1,c4,41),HX_("bn-IN",06,b7,1c,b6))
            			->setFixed(10,HX_("ietf",4e,70,b4,45),HX_("bn-IN",06,b7,1c,b6))
            			->setFixed(11,HX_("iso2",4d,0b,bf,45),HX_("bn",cc,55,00,00))
            			->setFixed(12,HX_("iso3",4e,0b,bf,45),HX_("bng",1b,bd,4a,00))
            			->setFixed(13,HX_("lcid",12,86,ae,47),(int)1093)
            			->setFixed(14,HX_("win3",97,70,f8,4e),HX_("BNG",fb,58,32,00))
            			->setFixed(15,HX_("nameEnglish",25,cc,fd,63),HX_("Bengali",c2,d1,06,b5)));
HXDLIN(  36)		 ::Dynamic _hx_tmp =  ::Dynamic(o->__Field(HX_("code",2d,b1,c4,41),hx::paccDynamic));
HXDLIN(  36)		 ::thx::culture::DateFormatInfo _hx_tmp1;
HXDLIN(  36)		if (hx::IsNull(  ::Dynamic(o->__Field(HX_("dateTime",5b,fd,0a,da),hx::paccDynamic)) )) {
HXLINE(  36)			_hx_tmp1 = null();
...
HXDLIN(  36)		 ::thx::culture::Culture _hx_tmp14 =  ::thx::culture::Culture_obj::__new(_hx_tmp,_hx_tmp1,_hx_tmp2,_hx_tmp3,_hx_tmp4,_hx_tmp5,_hx_tmp6,_hx_tmp7,_hx_tmp8,_hx_tmp9,_hx_tmp10,_hx_tmp11,_hx_tmp12,_hx_tmp13, ::Dynamic(o->__Field(HX_("separatorList",63,3f,b4,2e),hx::paccDynamic)), ::Dynamic(o->__Field(HX_("win3",97,70,f8,4e),hx::paccDynamic)));
HXDLIN(  36)		bn = ::thx::culture::Culture_obj::_hx_register(_hx_tmp14);
            	}
{
            	HX_STACK_FRAME("thx.format.TestTimeFormat","boot",0xc1b5665d,"thx.format.TestTimeFormat.boot","thx/culture/Embed.hx",36,0xb6a59b51)
HXLINE(  36)		HX_VARI(  ::Dynamic,o) =  ::Dynamic(hx::Anon_obj::Create(16)
...
{
            	HX_STACK_FRAME("thx.format.TestTimeFormat","boot",0xc1b5665d,"thx.format.TestTimeFormat.boot","thx/format/TestTimeFormat.hx",13,0xaf75f65b)
HXLINE(  13)		t1 = ::thx::_Time::Time_Impl__obj::fromString(HX_("13:45:30",5e,16,2c,80));
            	}
{
            	HX_STACK_FRAME("thx.format.TestTimeFormat","boot",0xc1b5665d,"thx.format.TestTimeFormat.boot","thx/format/TestTimeFormat.hx",14,0xaf75f65b)
HXLINE(  14)		t2 = ::thx::_Time::Time_Impl__obj::fromString(HX_("-18:40:20",56,cb,38,61));
            	}
}
