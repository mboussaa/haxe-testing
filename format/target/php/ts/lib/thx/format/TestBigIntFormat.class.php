...
class thx_format_TestBigIntFormat {
	...
	public function testInteger() {
		...
		utest_Assert::equals("12,345", $tmp, null, _hx_anonymous(array("fileName" => "TestBigIntFormat.hx", "lineNumber" => 17, "className" => "thx.format.TestBigIntFormat", "methodName" => "testInteger")));
	}
	public function testFormatHex() {
		$tmp = thx_format_BigIntFormat::format(thx_bigint_Bigs::fromInt(123), "x", null);
		utest_Assert::equals("7b", $tmp, null, _hx_anonymous(array("fileName" => "TestBigIntFormat.hx", "lineNumber" => 21, "className" => "thx.format.TestBigIntFormat", "methodName" => "testFormatHex")));
		$tmp1 = thx_format_BigIntFormat::format(thx_bigint_Bigs::fromInt(123), "X", null);
		utest_Assert::equals("7B", $tmp1, null, _hx_anonymous(array("fileName" => "TestBigIntFormat.hx", "lineNumber" => 22, "className" => "thx.format.TestBigIntFormat", "methodName" => "testFormatHex")));
		$tmp2 = thx_format_BigIntFormat::format(thx_bigint_Bigs::fromInt(123), "x4", null);
		utest_Assert::equals("007b", $tmp2, null, _hx_anonymous(array("fileName" => "TestBigIntFormat.hx", "lineNumber" => 23, "className" => "thx.format.TestBigIntFormat", "methodName" => "testFormatHex")));
		$tmp3 = thx_format_BigIntFormat::format(thx_bigint_Bigs::fromInt(123), "X6", null);
		utest_Assert::equals("00007B", $tmp3, null, _hx_anonymous(array("fileName" => "TestBigIntFormat.hx", "lineNumber" => 24, "className" => "thx.format.TestBigIntFormat", "methodName" => "testFormatHex")));
	}
	public function testOctal() {
		$tmp = thx_format_BigIntFormat::octal(thx_bigint_Bigs::fromInt(74), null, null);
		utest_Assert::equals("112", $tmp, null, _hx_anonymous(array("fileName" => "TestBigIntFormat.hx", "lineNumber" => 28, "className" => "thx.format.TestBigIntFormat", "methodName" => "testOctal")));
	}
	public function testHex() {
		$tmp = thx_format_BigIntFormat::hex(thx_bigint_Bigs::fromInt(10995), null, null);
		utest_Assert::equals("2af3", $tmp, null, _hx_anonymous(array("fileName" => "TestBigIntFormat.hx", "lineNumber" => 32, "className" => "thx.format.TestBigIntFormat", "methodName" => "testHex")));
	}
	public function testBinary() {
		$tmp = thx_format_BigIntFormat::binary(thx_bigint_Bigs::fromInt(25), null);
		utest_Assert::equals("11001", $tmp, null, _hx_anonymous(array("fileName" => "TestBigIntFormat.hx", "lineNumber" => 36, "className" => "thx.format.TestBigIntFormat", "methodName" => "testBinary")));
		$tmp1 = thx_format_BigIntFormat::binary(thx_bigint_Bigs::fromInt(-133), null);
		utest_Assert::equals("-10000101", $tmp1, null, _hx_anonymous(array("fileName" => "TestBigIntFormat.hx", "lineNumber" => 37, "className" => "thx.format.TestBigIntFormat", "methodName" => "testBinary")));
	}
	static $it;
	static $us;
	static $asIn;
