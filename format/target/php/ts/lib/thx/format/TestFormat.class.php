...
class thx_format_TestFormat {
	...
	public function testF() {
		...
		utest_Assert::equals("Wednesday, 01 January 2014", $tmp, null, _hx_anonymous(array("fileName" => "TestFormat.hx", "lineNumber" => 16, "className" => "thx.format.TestFormat", "methodName" => "testF")));
		$tmp1 = thx_format_DateFormat::format(thx__DateTime_DateTime_Impl_::fromString("2014-01-01"), "D", null);
		utest_Assert::equals("Wednesday, 01 January 2014", $tmp1, null, _hx_anonymous(array("fileName" => "TestFormat.hx", "lineNumber" => 17, "className" => "thx.format.TestFormat", "methodName" => "testF")));
		$tmp2 = thx_format_NumberFormat::format(1000, "n", null);
		utest_Assert::equals("1,000.00", $tmp2, null, _hx_anonymous(array("fileName" => "TestFormat.hx", "lineNumber" => 18, "className" => "thx.format.TestFormat", "methodName" => "testF")));
		$tmp3 = thx__DateTime_DateTime_Impl_::fromString("2014-01-01");
		$tmp4 = thx_format_DateFormat::format($tmp3, "D", thx_format_TestFormat::$it);
		utest_Assert::equals("mercoledì 1 gennaio 2014", $tmp4, null, _hx_anonymous(array("fileName" => "TestFormat.hx", "lineNumber" => 20, "className" => "thx.format.TestFormat", "methodName" => "testF")));
		$tmp5 = thx_format_NumberFormat::format(1000, "n", thx_format_TestFormat::$it);
		utest_Assert::equals("1.000,00", $tmp5, null, _hx_anonymous(array("fileName" => "TestFormat.hx", "lineNumber" => 21, "className" => "thx.format.TestFormat", "methodName" => "testF")));
	}
	static $it;
