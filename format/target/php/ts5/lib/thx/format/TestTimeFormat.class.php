...
class thx_format_TestTimeFormat {
	...
	public function testCustomFormat() {
		...
		while($_g1 < $_g) {
			...
			utest_Assert::equals("245 30, 0,12", $tmp, null, _hx_anonymous(array("fileName" => "TestTimeFormat.hx", "lineNumber" => 23, "className" => "thx.format.TestTimeFormat", "methodName" => "testCustomFormat")));
			...
			utest_Assert::equals("10,05 30, 0,123", $tmp1, null, _hx_anonymous(array("fileName" => "TestTimeFormat.hx", "lineNumber" => 24, "className" => "thx.format.TestTimeFormat", "methodName" => "testCustomFormat")));
			$tmp2 = thx_format_TimeFormat::format(thx__Time_Time_Impl_::fromString("245:30:00"), "H m, s.ff f", thx_format_TestTimeFormat::$it);
			utest_Assert::equals("245 30, 0 0", $tmp2, null, _hx_anonymous(array("fileName" => "TestTimeFormat.hx", "lineNumber" => 25, "className" => "thx.format.TestTimeFormat", "methodName" => "testCustomFormat")));
			...
			utest_Assert::equals("10,05 30 1 0000", $tmp3, null, _hx_anonymous(array("fileName" => "TestTimeFormat.hx", "lineNumber" => 26, "className" => "thx.format.TestTimeFormat", "methodName" => "testCustomFormat")));
			$tmp4 = thx_format_TimeFormat::format(thx__Time_Time_Impl_::fromString("245:30:00"), "H m, s.FF F", thx_format_TestTimeFormat::$it);
			utest_Assert::equals("245 30, 0 ", $tmp4, null, _hx_anonymous(array("fileName" => "TestTimeFormat.hx", "lineNumber" => 27, "className" => "thx.format.TestTimeFormat", "methodName" => "testCustomFormat")));
			...
			utest_Assert::equals("10,05 30, 1 ", $tmp5, null, _hx_anonymous(array("fileName" => "TestTimeFormat.hx", "lineNumber" => 28, "className" => "thx.format.TestTimeFormat", "methodName" => "testCustomFormat")));
