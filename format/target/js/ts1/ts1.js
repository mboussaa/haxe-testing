...
TS1.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS1.hx", lineNumber : 17, className : "TS1", methodName : "addTests"});
	runner.addCase(new thx_format_TestBigIntFormat(Std.parseInt(w)));
};
TS1.main = function() {
...
var thx_format_TestBigIntFormat = function(i) {
	this.x = i;
};
...
thx_format_TestBigIntFormat.prototype = {
	...
	,testInteger: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("12,345",thx_format_BigIntFormat.integer(thx_bigint_Bigs.fromInt(12345)),null,{ fileName : "TestBigIntFormat.hx", lineNumber : 21, className : "thx.format.TestBigIntFormat", methodName : "testInteger"});
		}
	}
	,testFormatHex: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("7b",thx_format_BigIntFormat.format(thx_bigint_Bigs.fromInt(123),"x"),null,{ fileName : "TestBigIntFormat.hx", lineNumber : 26, className : "thx.format.TestBigIntFormat", methodName : "testFormatHex"});
			utest_Assert.equals("7B",thx_format_BigIntFormat.format(thx_bigint_Bigs.fromInt(123),"X"),null,{ fileName : "TestBigIntFormat.hx", lineNumber : 27, className : "thx.format.TestBigIntFormat", methodName : "testFormatHex"});
			utest_Assert.equals("007b",thx_format_BigIntFormat.format(thx_bigint_Bigs.fromInt(123),"x4"),null,{ fileName : "TestBigIntFormat.hx", lineNumber : 28, className : "thx.format.TestBigIntFormat", methodName : "testFormatHex"});
			utest_Assert.equals("00007B",thx_format_BigIntFormat.format(thx_bigint_Bigs.fromInt(123),"X6"),null,{ fileName : "TestBigIntFormat.hx", lineNumber : 29, className : "thx.format.TestBigIntFormat", methodName : "testFormatHex"});
		}
	}
	,testOctal: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("112",thx_format_BigIntFormat.octal(thx_bigint_Bigs.fromInt(74)),null,{ fileName : "TestBigIntFormat.hx", lineNumber : 34, className : "thx.format.TestBigIntFormat", methodName : "testOctal"});
		}
	}
	,testHex: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("2af3",thx_format_BigIntFormat.hex(thx_bigint_Bigs.fromInt(10995)),null,{ fileName : "TestBigIntFormat.hx", lineNumber : 39, className : "thx.format.TestBigIntFormat", methodName : "testHex"});
		}
	}
	,testBinary: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("11001",thx_format_BigIntFormat.binary(thx_bigint_Bigs.fromInt(25)),null,{ fileName : "TestBigIntFormat.hx", lineNumber : 44, className : "thx.format.TestBigIntFormat", methodName : "testBinary"});
			utest_Assert.equals("-10000101",thx_format_BigIntFormat.binary(thx_bigint_Bigs.fromInt(-133)),null,{ fileName : "TestBigIntFormat.hx", lineNumber : 45, className : "thx.format.TestBigIntFormat", methodName : "testBinary"});
		}
	}
