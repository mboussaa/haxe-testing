...
TS5.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS5.hx", lineNumber : 17, className : "TS5", methodName : "addTests"});
	runner.addCase(new thx_format_TestTimeFormat(Std.parseInt(w)));
};
TS5.main = function() {
...
var thx_format_TestTimeFormat = function(i) {
	this.x = i;
};
...
thx_format_TestTimeFormat.prototype = {
	...
	,testCustomFormat: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("245 30, 0,12",thx_format_TimeFormat.format(thx__$Time_Time_$Impl_$.fromString("245:30:00.1234567"),"H m, s.ff",thx_format_TestTimeFormat.it),null,{ fileName : "TestTimeFormat.hx", lineNumber : 23, className : "thx.format.TestTimeFormat", methodName : "testCustomFormat"});
			utest_Assert.equals("10,05 30, 0,123",thx_format_TimeFormat.format(thx__$Time_Time_$Impl_$.fromString("245:30:00.1234567"),"d.hh m, s.fff",thx_format_TestTimeFormat.it),null,{ fileName : "TestTimeFormat.hx", lineNumber : 24, className : "thx.format.TestTimeFormat", methodName : "testCustomFormat"});
			utest_Assert.equals("245 30, 0 0",thx_format_TimeFormat.format(thx__$Time_Time_$Impl_$.fromString("245:30:00"),"H m, s.ff f",thx_format_TestTimeFormat.it),null,{ fileName : "TestTimeFormat.hx", lineNumber : 25, className : "thx.format.TestTimeFormat", methodName : "testCustomFormat"});
			utest_Assert.equals("10,05 30 1 0000",thx_format_TimeFormat.format(thx__$Time_Time_$Impl_$.fromString("245:30:01"),"d.hh m s.fff ffff",thx_format_TestTimeFormat.it),null,{ fileName : "TestTimeFormat.hx", lineNumber : 26, className : "thx.format.TestTimeFormat", methodName : "testCustomFormat"});
			utest_Assert.equals("245 30, 0 ",thx_format_TimeFormat.format(thx__$Time_Time_$Impl_$.fromString("245:30:00"),"H m, s.FF F",thx_format_TestTimeFormat.it),null,{ fileName : "TestTimeFormat.hx", lineNumber : 27, className : "thx.format.TestTimeFormat", methodName : "testCustomFormat"});
			utest_Assert.equals("10,05 30, 1 ",thx_format_TimeFormat.format(thx__$Time_Time_$Impl_$.fromString("245:30:01"),"d.hh m, s.FFF FFFF",thx_format_TestTimeFormat.it),null,{ fileName : "TestTimeFormat.hx", lineNumber : 28, className : "thx.format.TestTimeFormat", methodName : "testCustomFormat"});
		}
	}
