...
TS4.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS4.hx", lineNumber : 18, className : "TS4", methodName : "addTests"});
	runner.addCase(new thx_format_TestFormat(Std.parseInt(w)));
};
TS4.main = function() {
...
var thx_format_TestFormat = function(i) {
	this.x = i;
};
...
thx_format_TestFormat.prototype = {
	...
	,testF: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("Wednesday, 01 January 2014",thx_format_DateFormat.format(thx__$DateTime_DateTime_$Impl_$.fromString("2014-01-01"),"D",null),null,{ fileName : "TestFormat.hx", lineNumber : 20, className : "thx.format.TestFormat", methodName : "testF"});
			utest_Assert.equals("Wednesday, 01 January 2014",thx_format_DateFormat.format(thx__$DateTime_DateTime_$Impl_$.fromString("2014-01-01"),"D",null),null,{ fileName : "TestFormat.hx", lineNumber : 21, className : "thx.format.TestFormat", methodName : "testF"});
			utest_Assert.equals("1,000.00",thx_format_NumberFormat.format(1000,"n",null),null,{ fileName : "TestFormat.hx", lineNumber : 22, className : "thx.format.TestFormat", methodName : "testF"});
			utest_Assert.equals("mercoledì 1 gennaio 2014",thx_format_DateFormat.format(thx__$DateTime_DateTime_$Impl_$.fromString("2014-01-01"),"D",thx_format_TestFormat.it),null,{ fileName : "TestFormat.hx", lineNumber : 24, className : "thx.format.TestFormat", methodName : "testF"});
			utest_Assert.equals("1.000,00",thx_format_NumberFormat.format(1000,"n",thx_format_TestFormat.it),null,{ fileName : "TestFormat.hx", lineNumber : 25, className : "thx.format.TestFormat", methodName : "testF"});
		}
	}
