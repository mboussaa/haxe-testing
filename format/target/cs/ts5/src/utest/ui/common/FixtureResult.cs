...
namespace utest.ui.common {
	public class FixtureResult : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_FixtureResult(global::utest.ui.common.FixtureResult __temp_me174, string methodName) {
			__temp_me174.methodName = methodName;
			__temp_me174.list = new global::List<object>();
			__temp_me174.hasTestError = false;
			__temp_me174.hasSetupError = false;
			__temp_me174.hasTeardownError = false;
			__temp_me174.hasTimeoutError = false;
			__temp_me174.hasAsyncError = false;
			__temp_me174.stats = new global::utest.ui.common.ResultStats();
		}
