...
namespace thx.culture {
	public class NumberFormatInfo : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_culture_NumberFormatInfo(global::thx.culture.NumberFormatInfo __temp_me153, int decimalDigitsCurrency, int decimalDigitsNumber, int decimalDigitsPercent, global::Array<int> groupSizesCurrency, global::Array<int> groupSizesNumber, global::Array<int> groupSizesPercent, int patternNegativeCurrency, int patternNegativeNumber, int patternNegativePercent, int patternPositiveCurrency, int patternPositivePercent, string separatorDecimalCurrency, string separatorDecimalNumber, string separatorDecimalPercent, string separatorGroupCurrency, string separatorGroupNumber, string separatorGroupPercent, string signNegative, string signPositive, string symbolCurrency, string symbolNaN, string symbolNegativeInfinity, string symbolPercent, string symbolPermille, string symbolPositiveInfinity) {
			__temp_me153.decimalDigitsCurrency = decimalDigitsCurrency;
			__temp_me153.decimalDigitsNumber = decimalDigitsNumber;
			__temp_me153.decimalDigitsPercent = decimalDigitsPercent;
			__temp_me153.groupSizesCurrency = groupSizesCurrency;
			__temp_me153.groupSizesNumber = groupSizesNumber;
			__temp_me153.groupSizesPercent = groupSizesPercent;
			__temp_me153.patternNegativeCurrency = patternNegativeCurrency;
			__temp_me153.patternNegativeNumber = patternNegativeNumber;
			__temp_me153.patternNegativePercent = patternNegativePercent;
			__temp_me153.patternPositiveCurrency = patternPositiveCurrency;
			__temp_me153.patternPositivePercent = patternPositivePercent;
			__temp_me153.separatorDecimalCurrency = separatorDecimalCurrency;
			__temp_me153.separatorDecimalNumber = separatorDecimalNumber;
			__temp_me153.separatorDecimalPercent = separatorDecimalPercent;
			__temp_me153.separatorGroupCurrency = separatorGroupCurrency;
			__temp_me153.separatorGroupNumber = separatorGroupNumber;
			__temp_me153.separatorGroupPercent = separatorGroupPercent;
			__temp_me153.signNegative = signNegative;
			__temp_me153.signPositive = signPositive;
			__temp_me153.symbolCurrency = symbolCurrency;
			__temp_me153.symbolNaN = symbolNaN;
			__temp_me153.symbolNegativeInfinity = symbolNegativeInfinity;
			__temp_me153.symbolPercent = symbolPercent;
			__temp_me153.symbolPermille = symbolPermille;
			__temp_me153.symbolPositiveInfinity = symbolPositiveInfinity;
		}
