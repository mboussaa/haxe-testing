...
namespace haxe.ds {
	public class ObjectMap<K, V> : global::haxe.lang.HxObject, global::haxe.ds.ObjectMap, global::haxe.IMap<K, V> {
		...
		public static void __hx_ctor_haxe_ds_ObjectMap<K_c, V_c>(global::haxe.ds.ObjectMap<K_c, V_c> __temp_me54) {
			unchecked {
				__temp_me54.cachedIndex = -1;
			}
		}
			...
			unchecked {
				...
				while (( i < fields.length )) {
					...
					switch (field) {
						...
						{
							if (( this.vals != null )) {
								V_c[] __temp_new_arr48 = new V_c[this.vals.Length];
								int __temp_i49 = -1;
								while ((  ++ __temp_i49 < this.vals.Length )) {
									object __temp_obj50 = ((object) (this.vals[__temp_i49]) );
									if (( __temp_obj50 != null )) {
										__temp_new_arr48[__temp_i49] = global::haxe.lang.Runtime.genericCast<V_c>(__temp_obj50);
									}
									
								}
								
								new_me.vals = __temp_new_arr48;
							}
							else {
								new_me.vals = null;
							}
						...
						{
							if (( this._keys != null )) {
								K_c[] __temp_new_arr51 = new K_c[this._keys.Length];
								int __temp_i52 = -1;
								while ((  ++ __temp_i52 < this._keys.Length )) {
									object __temp_obj53 = ((object) (this._keys[__temp_i52]) );
									if (( __temp_obj53 != null )) {
										__temp_new_arr51[__temp_i52] = global::haxe.lang.Runtime.genericCast<K_c>(__temp_obj53);
									}
									
								}
								
								new_me._keys = __temp_new_arr51;
							}
							else {
								new_me._keys = null;
							}
...
namespace haxe.ds._ObjectMap {
	public sealed class ObjectMapKeyIterator<T, V> : global::haxe.lang.HxObject, global::haxe.ds._ObjectMap.ObjectMapKeyIterator {
		...
		public static void __hx_ctor_haxe_ds__ObjectMap_ObjectMapKeyIterator<T_c, V_c>(global::haxe.ds._ObjectMap.ObjectMapKeyIterator<T_c, V_c> __temp_me55, global::haxe.ds.ObjectMap<T_c, V_c> m) {
			__temp_me55.i = 0;
			__temp_me55.m = m;
			__temp_me55.len = m.nBuckets;
		}
...
namespace haxe.ds._ObjectMap {
	public sealed class ObjectMapValueIterator<K, T> : global::haxe.lang.HxObject, global::haxe.ds._ObjectMap.ObjectMapValueIterator {
		...
		public static void __hx_ctor_haxe_ds__ObjectMap_ObjectMapValueIterator<K_c, T_c>(global::haxe.ds._ObjectMap.ObjectMapValueIterator<K_c, T_c> __temp_me56, global::haxe.ds.ObjectMap<K_c, T_c> m) {
			__temp_me56.i = 0;
			__temp_me56.m = m;
