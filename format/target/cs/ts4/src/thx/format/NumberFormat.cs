...
namespace thx.format {
	public class NumberFormat : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_format_NumberFormat(global::thx.format.NumberFormat __temp_me166) {
		}
		
		
		public static string binary(double f, global::haxe.lang.Null<int> significantDigits, global::thx.culture.Culture culture) {
			unchecked {
				global::haxe.lang.Null<int> __temp_significantDigits160 = ( ( ! (significantDigits.hasValue) ) ? (new global::haxe.lang.Null<int>(1, true)) : (significantDigits) );
				...
				if (( global::haxe.lang.Runtime.eq((__temp_significantDigits160).toDynamic(), 0) && ( f == 0 ) )) {
					return "";
				}
				else {
					return global::StringTools.lpad(global::thx.format.NumberFormat.toBase(((int) (f) ), 2, culture), "0", (__temp_significantDigits160).@value);
				}
		...
		public static string @decimal(double f, global::haxe.lang.Null<int> significantDigits, global::thx.culture.Culture culture) {
			unchecked {
				global::haxe.lang.Null<int> __temp_significantDigits161 = ( ( ! (significantDigits.hasValue) ) ? (new global::haxe.lang.Null<int>(1, true)) : (significantDigits) );
				global::thx.culture.NumberFormatInfo nf = global::thx.format.NumberFormat.numberFormat(culture);
				if (global::System.Double.IsNaN(((double) (f) ))) {
					return nf.symbolNaN;
				}
				...
				return global::haxe.lang.Runtime.concat((( (( f < 0 )) ? (nf.signNegative) : ("") )), global::StringTools.lpad(global::thx.format.NumberFormat.@value(f, 0, new global::Array<int>(new int[]{0}), "", ""), "0", (__temp_significantDigits161).@value));
			}
		}
		...
		public static string exponential(double f, global::haxe.lang.Null<int> precision, global::haxe.lang.Null<int> digits, string symbol, global::thx.culture.Culture culture) {
			unchecked {
				...
				global::haxe.lang.Null<int> __temp_digits163 = ( ( ! (digits.hasValue) ) ? (new global::haxe.lang.Null<int>(3, true)) : (digits) );
				global::haxe.lang.Null<int> __temp_precision162 = ( ( ! (precision.hasValue) ) ? (new global::haxe.lang.Null<int>(6, true)) : (precision) );
				global::thx.culture.NumberFormatInfo nf = global::thx.format.NumberFormat.numberFormat(culture);
				if (global::System.Double.IsNaN(((double) (f) ))) {
					return nf.symbolNaN;
				}
				...
				string tmp = global::haxe.lang.Runtime.concat(global::haxe.lang.Runtime.concat(global::thx.format.NumberFormat.number(global::haxe.lang.Runtime.getField_f(info, "f", 102, true), __temp_precision162, culture), symbol), (( (( global::haxe.lang.Runtime.compare(((object) (global::haxe.lang.Runtime.getField(info, "e", 101, true)) ), 0) < 0 )) ? (nf.signNegative) : (nf.signPositive) )));
				int v = ((int) (global::haxe.lang.Runtime.toInt(global::haxe.lang.Runtime.getField(info, "e", 101, true))) );
				return global::haxe.lang.Runtime.concat(tmp, global::StringTools.lpad(global::haxe.lang.Runtime.concat("", global::haxe.lang.Runtime.toString((( (( v < 0 )) ? ( - (v) ) : (v) )))), "0", (__temp_digits163).@value));
			}
		}
		...
		public static string hex(double f, global::haxe.lang.Null<int> significantDigits, global::thx.culture.Culture culture) {
			unchecked {
				global::haxe.lang.Null<int> __temp_significantDigits164 = ( ( ! (significantDigits.hasValue) ) ? (new global::haxe.lang.Null<int>(1, true)) : (significantDigits) );
				global::thx.culture.NumberFormatInfo nf = global::thx.format.NumberFormat.numberFormat(culture);
				if (global::System.Double.IsNaN(((double) (f) ))) {
					return nf.symbolNaN;
				}
				...
				if (( global::haxe.lang.Runtime.eq((__temp_significantDigits164).toDynamic(), 0) && ( f == 0 ) )) {
					return "";
				}
				else {
					return global::StringTools.lpad(global::thx.format.NumberFormat.toBase(((int) (f) ), 16, culture), "0", (__temp_significantDigits164).@value);
				}
		...
		public static string octal(double f, global::haxe.lang.Null<int> significantDigits, global::thx.culture.Culture culture) {
			unchecked {
				global::haxe.lang.Null<int> __temp_significantDigits165 = ( ( ! (significantDigits.hasValue) ) ? (new global::haxe.lang.Null<int>(1, true)) : (significantDigits) );
				global::thx.culture.NumberFormatInfo nf = global::thx.format.NumberFormat.numberFormat(culture);
				if (global::System.Double.IsNaN(((double) (f) ))) {
					return nf.symbolNaN;
				}
				...
				if (( global::haxe.lang.Runtime.eq((__temp_significantDigits165).toDynamic(), 0) && ( f == 0 ) )) {
					return "";
				}
				else {
					return global::StringTools.lpad(global::thx.format.NumberFormat.toBase(((int) (f) ), 8, culture), "0", (__temp_significantDigits165).@value);
				}
