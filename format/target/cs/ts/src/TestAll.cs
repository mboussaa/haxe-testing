...
public class TestAll : global::haxe.lang.HxObject {
	...
	public static void addTests(global::utest.Runner runner) {
		runner.addCase(new global::thx.format.TestBigIntFormat(), null, null, null, null);
		runner.addCase(new global::thx.format.TestDateFormat(), null, null, null, null);
		runner.addCase(new global::thx.format.TestDecimalFormat(), null, null, null, null);
		runner.addCase(new global::thx.format.TestFormat(), null, null, null, null);
		runner.addCase(new global::thx.format.TestTimeFormat(), null, null, null, null);
	}
