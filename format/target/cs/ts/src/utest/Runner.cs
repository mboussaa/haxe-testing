...
namespace utest {
	public class Runner : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_Runner(global::utest.Runner __temp_me198) {
			__temp_me198.globalPattern = null;
			__temp_me198.fixtures = new global::Array<object>();
			__temp_me198.onProgress = new global::utest.Dispatcher<object>();
			__temp_me198.onStart = new global::utest.Dispatcher<object>();
			__temp_me198.onComplete = new global::utest.Dispatcher<object>();
			__temp_me198.onPrecheck = new global::utest.Dispatcher<object>();
			__temp_me198.onTestStart = new global::utest.Dispatcher<object>();
			__temp_me198.onTestComplete = new global::utest.Dispatcher<object>();
			__temp_me198.length = 0;
		}
