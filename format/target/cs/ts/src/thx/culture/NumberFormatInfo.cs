...
namespace thx.culture {
	public class NumberFormatInfo : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_culture_NumberFormatInfo(global::thx.culture.NumberFormatInfo __temp_me162, int decimalDigitsCurrency, int decimalDigitsNumber, int decimalDigitsPercent, global::Array<int> groupSizesCurrency, global::Array<int> groupSizesNumber, global::Array<int> groupSizesPercent, int patternNegativeCurrency, int patternNegativeNumber, int patternNegativePercent, int patternPositiveCurrency, int patternPositivePercent, string separatorDecimalCurrency, string separatorDecimalNumber, string separatorDecimalPercent, string separatorGroupCurrency, string separatorGroupNumber, string separatorGroupPercent, string signNegative, string signPositive, string symbolCurrency, string symbolNaN, string symbolNegativeInfinity, string symbolPercent, string symbolPermille, string symbolPositiveInfinity) {
			__temp_me162.decimalDigitsCurrency = decimalDigitsCurrency;
			__temp_me162.decimalDigitsNumber = decimalDigitsNumber;
			__temp_me162.decimalDigitsPercent = decimalDigitsPercent;
			__temp_me162.groupSizesCurrency = groupSizesCurrency;
			__temp_me162.groupSizesNumber = groupSizesNumber;
			__temp_me162.groupSizesPercent = groupSizesPercent;
			__temp_me162.patternNegativeCurrency = patternNegativeCurrency;
			__temp_me162.patternNegativeNumber = patternNegativeNumber;
			__temp_me162.patternNegativePercent = patternNegativePercent;
			__temp_me162.patternPositiveCurrency = patternPositiveCurrency;
			__temp_me162.patternPositivePercent = patternPositivePercent;
			__temp_me162.separatorDecimalCurrency = separatorDecimalCurrency;
			__temp_me162.separatorDecimalNumber = separatorDecimalNumber;
			__temp_me162.separatorDecimalPercent = separatorDecimalPercent;
			__temp_me162.separatorGroupCurrency = separatorGroupCurrency;
			__temp_me162.separatorGroupNumber = separatorGroupNumber;
			__temp_me162.separatorGroupPercent = separatorGroupPercent;
			__temp_me162.signNegative = signNegative;
			__temp_me162.signPositive = signPositive;
			__temp_me162.symbolCurrency = symbolCurrency;
			__temp_me162.symbolNaN = symbolNaN;
			__temp_me162.symbolNegativeInfinity = symbolNegativeInfinity;
			__temp_me162.symbolPercent = symbolPercent;
			__temp_me162.symbolPermille = symbolPermille;
			__temp_me162.symbolPositiveInfinity = symbolPositiveInfinity;
		}
