...
namespace thx.culture {
	public class Culture : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_culture_Culture(global::thx.culture.Culture __temp_me163, string code, global::thx.culture.DateFormatInfo dateTime, string ietf, bool isNeutral, string iso2, string iso3, bool isRightToLeft, int lcid, string nameCalendar, string nameEnglish, string nameNative, string nameRegionEnglish, string nameRegionNative, global::thx.culture.NumberFormatInfo number, string separatorList, string win3) {
			__temp_me163.code = code;
			__temp_me163.dateTime = dateTime;
			__temp_me163.ietf = ietf;
			__temp_me163.isNeutral = isNeutral;
			__temp_me163.iso2 = iso2;
			__temp_me163.iso3 = iso3;
			__temp_me163.isRightToLeft = isRightToLeft;
			__temp_me163.lcid = lcid;
			__temp_me163.nameCalendar = nameCalendar;
			__temp_me163.nameEnglish = nameEnglish;
			__temp_me163.nameNative = nameNative;
			__temp_me163.nameRegionEnglish = nameRegionEnglish;
			__temp_me163.nameRegionNative = nameRegionNative;
			__temp_me163.number = number;
			__temp_me163.separatorList = separatorList;
			__temp_me163.win3 = win3;
		}
		...
		public static global::thx.culture.Culture register(global::thx.culture.Culture culture) {
			...
			if (global::thx.culture.Culture.cultures.exists(((string) (code) ))) {
			...
			global::thx.culture.Culture.cultures.@set(((string) (code) ), ((object) (culture) ));
			global::thx.culture.Culture.cultures.@set(((string) (global::haxe.lang.Runtime.concat("I2:", culture.iso2.ToLowerInvariant())) ), ((object) (culture) ));
			global::thx.culture.Culture.cultures.@set(((string) (global::haxe.lang.Runtime.concat("I3:", culture.iso3.ToLowerInvariant())) ), ((object) (culture) ));
			return culture;
		}
