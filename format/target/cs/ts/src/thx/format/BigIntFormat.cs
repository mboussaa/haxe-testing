...
namespace thx.format {
	public class BigIntFormat : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_format_BigIntFormat(global::thx.format.BigIntFormat __temp_me174) {
		}
		
		
		public static string binary(global::thx.bigint.BigIntImpl i, global::haxe.lang.Null<int> significantDigits) {
			unchecked {
				global::haxe.lang.Null<int> __temp_significantDigits168 = ( ( ! (significantDigits.hasValue) ) ? (new global::haxe.lang.Null<int>(1, true)) : (significantDigits) );
				if (( global::haxe.lang.Runtime.eq((__temp_significantDigits168).toDynamic(), 0) && ((global::thx.bigint.BigIntImpl) (i) ).isZero() )) {
					return "";
				}
				else {
					return global::StringTools.lpad(((global::thx.bigint.BigIntImpl) (i) ).toStringWithBase(2), "0", (__temp_significantDigits168).@value);
				}
		...
		public static string @decimal(global::thx.bigint.BigIntImpl i, global::haxe.lang.Null<int> significantDigits, global::thx.culture.Culture culture) {
			unchecked {
				global::haxe.lang.Null<int> __temp_significantDigits169 = ( ( ! (significantDigits.hasValue) ) ? (new global::haxe.lang.Null<int>(1, true)) : (significantDigits) );
				return global::thx.format.DecimalFormat.@decimal(global::thx._Decimal.Decimal_Impl_.fromBigInt(i), __temp_significantDigits169, culture);
			}
		}
		...
		public static string exponential(global::thx.bigint.BigIntImpl i, global::haxe.lang.Null<int> precision, global::haxe.lang.Null<int> digits, string symbol, global::thx.culture.Culture culture) {
			unchecked {
				...
				global::haxe.lang.Null<int> __temp_digits171 = ( ( ! (digits.hasValue) ) ? (new global::haxe.lang.Null<int>(3, true)) : (digits) );
				global::haxe.lang.Null<int> __temp_precision170 = ( ( ! (precision.hasValue) ) ? (new global::haxe.lang.Null<int>(6, true)) : (precision) );
				return global::thx.format.DecimalFormat.exponential(global::thx._Decimal.Decimal_Impl_.fromBigInt(i), __temp_precision170, __temp_digits171, symbol, culture);
			}
		}
		...
		public static string hex(global::thx.bigint.BigIntImpl i, global::haxe.lang.Null<int> significantDigits, global::thx.culture.Culture culture) {
			unchecked {
				global::haxe.lang.Null<int> __temp_significantDigits172 = ( ( ! (significantDigits.hasValue) ) ? (new global::haxe.lang.Null<int>(1, true)) : (significantDigits) );
				if (( global::haxe.lang.Runtime.eq((__temp_significantDigits172).toDynamic(), 0) && ((global::thx.bigint.BigIntImpl) (i) ).isZero() )) {
					return "";
				}
				else {
					return global::StringTools.lpad(global::thx.format.BigIntFormat.toBase(i, 16, culture), "0", (__temp_significantDigits172).@value);
				}
		...
		public static string octal(global::thx.bigint.BigIntImpl i, global::haxe.lang.Null<int> significantDigits, global::thx.culture.Culture culture) {
			unchecked {
				global::haxe.lang.Null<int> __temp_significantDigits173 = ( ( ! (significantDigits.hasValue) ) ? (new global::haxe.lang.Null<int>(1, true)) : (significantDigits) );
				if (( global::haxe.lang.Runtime.eq((__temp_significantDigits173).toDynamic(), 0) && ((global::thx.bigint.BigIntImpl) (i) ).isZero() )) {
					return "";
				}
				else {
					return global::StringTools.lpad(global::thx.format.BigIntFormat.toBase(i, 8, culture), "0", (__temp_significantDigits173).@value);
				}
