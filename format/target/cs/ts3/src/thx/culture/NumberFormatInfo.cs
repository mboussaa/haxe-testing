...
namespace thx.culture {
	public class NumberFormatInfo : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_culture_NumberFormatInfo(global::thx.culture.NumberFormatInfo __temp_me145, int decimalDigitsCurrency, int decimalDigitsNumber, int decimalDigitsPercent, global::Array<int> groupSizesCurrency, global::Array<int> groupSizesNumber, global::Array<int> groupSizesPercent, int patternNegativeCurrency, int patternNegativeNumber, int patternNegativePercent, int patternPositiveCurrency, int patternPositivePercent, string separatorDecimalCurrency, string separatorDecimalNumber, string separatorDecimalPercent, string separatorGroupCurrency, string separatorGroupNumber, string separatorGroupPercent, string signNegative, string signPositive, string symbolCurrency, string symbolNaN, string symbolNegativeInfinity, string symbolPercent, string symbolPermille, string symbolPositiveInfinity) {
			__temp_me145.decimalDigitsCurrency = decimalDigitsCurrency;
			__temp_me145.decimalDigitsNumber = decimalDigitsNumber;
			__temp_me145.decimalDigitsPercent = decimalDigitsPercent;
			__temp_me145.groupSizesCurrency = groupSizesCurrency;
			__temp_me145.groupSizesNumber = groupSizesNumber;
			__temp_me145.groupSizesPercent = groupSizesPercent;
			__temp_me145.patternNegativeCurrency = patternNegativeCurrency;
			__temp_me145.patternNegativeNumber = patternNegativeNumber;
			__temp_me145.patternNegativePercent = patternNegativePercent;
			__temp_me145.patternPositiveCurrency = patternPositiveCurrency;
			__temp_me145.patternPositivePercent = patternPositivePercent;
			__temp_me145.separatorDecimalCurrency = separatorDecimalCurrency;
			__temp_me145.separatorDecimalNumber = separatorDecimalNumber;
			__temp_me145.separatorDecimalPercent = separatorDecimalPercent;
			__temp_me145.separatorGroupCurrency = separatorGroupCurrency;
			__temp_me145.separatorGroupNumber = separatorGroupNumber;
			__temp_me145.separatorGroupPercent = separatorGroupPercent;
			__temp_me145.signNegative = signNegative;
			__temp_me145.signPositive = signPositive;
			__temp_me145.symbolCurrency = symbolCurrency;
			__temp_me145.symbolNaN = symbolNaN;
			__temp_me145.symbolNegativeInfinity = symbolNegativeInfinity;
			__temp_me145.symbolPercent = symbolPercent;
			__temp_me145.symbolPermille = symbolPermille;
			__temp_me145.symbolPositiveInfinity = symbolPositiveInfinity;
		}
