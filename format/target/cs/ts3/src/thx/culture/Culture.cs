...
namespace thx.culture {
	public class Culture : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_culture_Culture(global::thx.culture.Culture __temp_me146, string code, global::thx.culture.DateFormatInfo dateTime, string ietf, bool isNeutral, string iso2, string iso3, bool isRightToLeft, int lcid, string nameCalendar, string nameEnglish, string nameNative, string nameRegionEnglish, string nameRegionNative, global::thx.culture.NumberFormatInfo number, string separatorList, string win3) {
			__temp_me146.code = code;
			__temp_me146.dateTime = dateTime;
			__temp_me146.ietf = ietf;
			__temp_me146.isNeutral = isNeutral;
			__temp_me146.iso2 = iso2;
			__temp_me146.iso3 = iso3;
			__temp_me146.isRightToLeft = isRightToLeft;
			__temp_me146.lcid = lcid;
			__temp_me146.nameCalendar = nameCalendar;
			__temp_me146.nameEnglish = nameEnglish;
			__temp_me146.nameNative = nameNative;
			__temp_me146.nameRegionEnglish = nameRegionEnglish;
			__temp_me146.nameRegionNative = nameRegionNative;
			__temp_me146.number = number;
			__temp_me146.separatorList = separatorList;
			__temp_me146.win3 = win3;
		}
