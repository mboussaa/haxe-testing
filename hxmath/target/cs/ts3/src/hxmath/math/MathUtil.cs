...
namespace hxmath.math {
	public class MathUtil : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_hxmath_math_MathUtil(global::hxmath.math.MathUtil __temp_me29) {
		}
		...
		public static int sign(double x, global::haxe.lang.Null<double> w) {
			unchecked {
				double __temp_w28 = ( ( ! (w.hasValue) ) ? (((double) (0) )) : ((w).@value) );
				if (( global::System.Math.Abs(((double) (x) )) < __temp_w28 )) {
					return 0;
				}
				else if (( x <=  - (__temp_w28)  )) {
					return -1;
				}
				else {
					return 1;
