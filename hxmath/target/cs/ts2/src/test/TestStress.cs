...
namespace test {
	public class TestStress : global::test.MathTestCase {
		...
		public static void __hx_ctor_test_TestStress(global::test.TestStress __temp_me57, object posInfos) {
			unchecked {
				__temp_me57.a = 5;
				global::test.MathTestCase.__hx_ctor_test_MathTestCase(__temp_me57, posInfos);
			}
		}
