...
namespace haxe.lang {
	public sealed class FieldLookup {
		...
		protected static int[] fieldIds = new int[]{97, 98, 99, 100, 102, 104, 105, 113, 115, 119, 120, 121, 122, 25988, 25989, 1821933, 4745537, 4846113, 4849249, 5144726, 5246191, 5393365, 5431213, 5431214, 5431215, 5431216, 5431436, 5431437, 5431438, 5431439, 5431659, 5431660, 5431661, 5431662, 5431882, 5431883, 5431884, 5431885, 5442204, 5442212, 5443986, 5594513, 5695307, 5741474, 13096254, 24046298, 28978273, 56356288, 74394056, 74394057, 76061764, 86965936, 87367608, 93036843, 98248149, 100394802, 115073950, 115624547, 136073068, 142895325, 156956385, 157023084, 164354652, 200726388, 241751868, 270831766, 279665676, 291156297, 291852715, 302979532, 328878574, 349645622, 359333139, 407283053, 408752657, 409031409, 452737314, 501039929, 520590566, 641597244, 658867884, 736099074, 742648050, 743417354, 752681381, 939327441, 943677095, 944645571, 946786476, 984359795, 1002976833, 1009440223, 1031550996, 1054910055, 1067353468, 1092664259, 1102913285, 1103412149, 1107053462, 1109075101, 1114501250, 1135983070, 1136381564, 1156359202, 1158359328, 1170195731, 1181037546, 1204816148, 1217091629, 1224901875, 1233656925, 1247875546, 1247983110, 1248019663, 1257939113, 1270620251, 1280845662, 1282943179, 1293753579, 1328782604, 1330771252, 1352786672, 1355220828, 1357975336, 1364809927, 1382942234, 1393141576, 1393191305, 1393191306, 1393241036, 1401033194, 1413785040, 1417420914, 1449791717, 1491547185, 1512997393, 1520341977, 1532710347, 1547539107, 1575177880, 1609868020, 1614780307, 1620824029, 1621420777, 1622646110, 1623148745, 1648581351, 1705629508, 1723805383, 1744750013, 1781145963, 1809902070, 1818678820, 1830310359, 1831594137, 1862178380, 1862178381, 1862178382, 1873743348, 1874110430, 1899208339, 1915412854, 1916009602, 1932118984, 1981972957, 1985344456, 2025055113, 2028603587, 2049945213, 2074818547, 2082663554, 2084789794, 2105872637, 2113859280, 2127021138, 2141451521};
		
		protected static string[] fields = new string[]{"a", "b", "c", "d", "f", "h", "i", "q", "s", "w", "x", "y", "z", "tx", "ty", "isGlobal", "__a", "add", "arr", "get", "int", "len", "m00", "m01", "m02", "m03", "m10", "m11", "m12", "m13", "m20", "m21", "m22", "m23", "m30", "m31", "m32", "m33", "map", "max", "min", "pop", "run", "set", "precision", "split", "testIntApplyScalarFunc", "testMatrix3x2Constructor", "randomFrame2", "randomFrame3", "remove", "internalOffset", "filter", "currentTest", "center", "status", "applyScalarFunc", "testDeterminant", "testApplyScalarFunc", "result", "method", "isCached", "warning", "testRowColAccessors", "testMatrixProduct", "randomArray", "assertNotEquals", "testClamp", "testClone", "methodName", "iterator", "testNormalizeTo", "lastIndexOf", "hasNext", "set_angleDegrees", "internalAngleDegrees", "reverse", "insert", "length", "async", "randomInt", "testDistanceTo", "testVectorProj", "get_matrix", "assertEquals", "testAddSub", "globalTearDown", "success", "toString", "set_orientation", "matrix", "assertApproxEquals", "angleDegrees", "get_orientation", "splice", "cases", "ceil", "copy", "randomShortVector2", "get_angleDegrees", "done", "fail", "file", "testCase", "head", "item", "join", "concat", "print", "next", "testMatrix4x4Constructor", "push", "width", "count", "position", "printError", "sort", "quicksort", "testArrayAccess", "testCopyToFrom", "assertTrue", "spliceVoid", "get_offset", "zero", "testVectorMinMax", "globalSetup", "randomMatrix2x2", "randomMatrix3x2", "randomMatrix3x3", "randomMatrix4x4", "testSetAllFields", "set_offset", "_openPreprocessResult", "setArrayElement", "testEquals", "posInfos", "getArrayElement", "concatNative", "className", "testDotProduct", "testHasToString", "offset", "__unsafe_get", "__unsafe_set", "internalMatrix", "indexOf", "fileName", "toDynamic", "regex", "failed", "__hx_constructs", "currentResult", "tearDown", "customParams", "randomFloat", "randomVector2", "randomVector3", "randomVector4", "label", "testEqualsNullShouldNotThrow", "internalOrientation", "__get", "__set", "error", "lineNumber", "isDirty", "unshift", "randomIntVector2", "setup", "assertThrows", "shift", "__hx_createEmpty", "assertFalse", "orientation", "slice", "randomQuaternion"};
