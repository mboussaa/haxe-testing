...
namespace test {
	public class MathTestCase : global::nanotest.NanoTestCase {
		...
		public static void __hx_ctor_test_MathTestCase(global::test.MathTestCase __temp_me55, object posInfos) {
			global::nanotest.NanoTestCase.__hx_ctor_nanotest_NanoTestCase(__temp_me55, posInfos);
		}
		...
		public virtual double randomFloat(global::haxe.lang.Null<double> center, global::haxe.lang.Null<double> width, global::haxe.lang.Null<double> precision) {
			double __temp_precision43 = ( ( ! (precision.hasValue) ) ? (1e-4) : ((precision).@value) );
			double __temp_width42 = ( ( ! (width.hasValue) ) ? (1.0) : ((width).@value) );
			double __temp_center41 = ( ( ! (center.hasValue) ) ? (0.0) : ((center).@value) );
			return ( ((int) (global::System.Math.Floor(((double) (( (( ( (( global::Math.rand.NextDouble() - 0.5 )) * __temp_width42 ) + __temp_center41 )) / __temp_precision43 )) ))) ) * __temp_precision43 );
		}
		...
		public virtual void assertApproxEquals(double expected, double actual, global::haxe.lang.Null<double> tolerance, object p) {
			double __temp_tolerance44 = ( ( ! (tolerance.hasValue) ) ? (1e-6) : ((tolerance).@value) );
			if (( global::System.Math.Abs(((double) (( expected - actual )) )) < __temp_tolerance44 )) {
				this.success(p);
			}
			else {
				this.fail(global::haxe.lang.Runtime.concat(global::haxe.lang.Runtime.concat(global::haxe.lang.Runtime.concat(global::haxe.lang.Runtime.concat(global::haxe.lang.Runtime.concat("expected ", global::haxe.lang.Runtime.toString(expected)), " +-"), global::haxe.lang.Runtime.toString(__temp_tolerance44)), " but was "), global::haxe.lang.Runtime.toString(actual)), p);
			}
		...
		public virtual global::hxmath.frames.IFrame2 randomFrame2(global::haxe.lang.Null<double> precision) {
			...
			return global::hxmath.frames._Frame2.Frame2_Impl_._new(this.randomVector2(new global::haxe.lang.Null<double>(__temp_precision53, true)), ( this.randomFloat(new global::haxe.lang.Null<double>(0.0, true), new global::haxe.lang.Null<double>(1.0, true), new global::haxe.lang.Null<double>(__temp_precision53, true)) * global::Math.PI ));
		}
		...
		public virtual global::hxmath.frames.IFrame3 randomFrame3(global::haxe.lang.Null<double> precision) {
			...
			global::hxmath.math.Vector3Default tmp = this.randomVector3(new global::haxe.lang.Null<double>(__temp_precision54, true));
			global::hxmath.math.QuaternionDefault self = ((global::hxmath.math.QuaternionDefault) (this.randomQuaternion(new global::haxe.lang.Null<double>(__temp_precision54, true))) );
