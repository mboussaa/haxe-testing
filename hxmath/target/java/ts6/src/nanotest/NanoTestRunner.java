...
public class NanoTestRunner extends haxe.lang.HxObject
{
	...
	public static void __hx_ctor_nanotest_NanoTestRunner(nanotest.NanoTestRunner __temp_me45, haxe.lang.Function printError)
	{
		...
		if (( printError == null )) 
		{
			...
			__temp_me45.printError = ((haxe.lang.Function) (new haxe.lang.Closure(nanotest.NanoTestRunner.class, "warning")) );
		}
		else
		{
			//line 121 "/usr/lib/haxe/lib/nanotest/1,0,0/nanotest/NanoTestRunner.hx"
			__temp_me45.printError = printError;
		}
