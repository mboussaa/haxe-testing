...
public class NanoTestRunner extends haxe.lang.HxObject
{
	...
	public static void __hx_ctor_nanotest_NanoTestRunner(nanotest.NanoTestRunner __temp_me40, haxe.lang.Function printError)
	{
		...
		if (( printError == null )) 
		{
			...
			__temp_me40.printError = ((haxe.lang.Function) (new haxe.lang.Closure(nanotest.NanoTestRunner.class, "warning")) );
		}
		else
		{
