...
Bool TS2_obj::main(){
            	HX_STACK_FRAME("test.TS2","main",0x7b686050,"test.TS2.main","test/TS2.hx",13,0x1354f628)
...
HXLINE(  20)		::haxe::Log_obj::trace((HX_("The value of loop_wrapper is ",79,76,58,6c) + w),hx::SourceInfo(HX_("TS2.hx",cb,62,6c,81),20,HX_("test.TS2",b7,2f,01,37),HX_("main",39,38,56,48)));
HXLINE(  21)		HX_VARI( Int,x) = ::Std_obj::parseInt(w);
HXLINE(  22)		{
HXLINE(  22)			HX_VARI_NAME( Int,_g11,"_g1") = (int)0;
HXDLIN(  22)			while((_g11 < x)){
HXLINE(  22)				++_g11;
HXLINE(  23)				runner->add( ::test::Test2D_obj::__new(hx::SourceInfo(HX_("TS2.hx",cb,62,6c,81),23,HX_("test.TS2",b7,2f,01,37),HX_("main",39,38,56,48))));
            			}
            		}
