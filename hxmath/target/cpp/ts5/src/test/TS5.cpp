...
Bool TS5_obj::main(){
            	HX_STACK_FRAME("test.TS5","main",0xae7a756d,"test.TS5.main","test/TS5.hx",13,0x15509a05)
...
HXLINE(  20)		::haxe::Log_obj::trace((HX_("The value of loop_wrapper is ",79,76,58,6c) + w),hx::SourceInfo(HX_("TS5.hx",a8,06,68,83),20,HX_("test.TS5",ba,2f,01,37),HX_("main",39,38,56,48)));
HXLINE(  21)		HX_VARI( Int,x) = ::Std_obj::parseInt(w);
HXLINE(  22)		{
HXLINE(  22)			HX_VARI_NAME( Int,_g11,"_g1") = (int)0;
HXDLIN(  22)			while((_g11 < x)){
HXLINE(  22)				++_g11;
HXLINE(  23)				runner->add( ::test::TestConverters_obj::__new());
            			}
            		}
