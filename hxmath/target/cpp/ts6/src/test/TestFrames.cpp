...
HXLINE(  46)		HX_VARI(  ::hxmath::math::Vector2Default,p) = ::hxmath::frames::IFrame2_obj::get_offset(b);
...
HXLINE(  49)		HX_VARI_NAME(  ::hxmath::math::Vector2Default,a4,"a") = ::hxmath::frames::IFrame2_obj::get_offset(self);
...
HXLINE(  50)		Float _hx_tmp13 = ::hxmath::frames::IFrame2_obj::get_angleDegrees(self);
...
HXLINE(  53)		HX_VARI_NAME(  ::hxmath::math::Matrix3x2Default,m3,"m") = ::hxmath::frames::IFrame2_obj::get_matrix(self);
...
HXLINE(  63)		HX_VARI(  ::hxmath::math::Vector3Default,p) = ::hxmath::frames::IFrame3_obj::get_offset(b);
...
HXLINE(  66)		HX_VARI_NAME(  ::hxmath::math::Vector3Default,a7,"a") = ::hxmath::frames::IFrame3_obj::get_offset(self);
...
HXLINE(  69)		HX_VARI_NAME(  ::hxmath::math::QuaternionDefault,a9,"a") = ::hxmath::frames::IFrame3_obj::get_orientation(self);
...
HXDLIN( 121)		HX_VARI_NAME(  ::hxmath::math::Vector2Default,a2,"a") = ::hxmath::frames::IFrame2_obj::get_offset(self3);
...
HXDLIN( 122)		HX_VARI_NAME(  ::hxmath::math::Vector2Default,a4,"a") = ::hxmath::frames::IFrame2_obj::get_offset(self8);
...
HXDLIN( 123)		Float _hx_tmp19 = ::hxmath::frames::IFrame2_obj::get_angleDegrees(self13);
...
HXDLIN( 124)		Float _hx_tmp25 = ::hxmath::frames::IFrame2_obj::get_angleDegrees(self16);
...
HXLINE( 131)		::hxmath::frames::IFrame2_obj::set_offset(frame, ::hxmath::math::Vector2Default_obj::__new(((Float)0.0),((Float)0.0)));
HXLINE( 132)		::hxmath::frames::IFrame2_obj::set_angleDegrees(frame,(int)90);
HXLINE( 134)		this->assertEquals(::hxmath::frames::IFrame2_obj::get_offset(frame)->x,dummySprite->x,hx::SourceInfo(HX_("TestFrames.hx",06,2c,f9,c9),134,HX_("test.TestFrames",54,94,be,54),HX_("testFlxSpriteFrame2",aa,b0,56,3d)));
HXLINE( 135)		this->assertEquals(::hxmath::frames::IFrame2_obj::get_offset(frame)->y,dummySprite->y,hx::SourceInfo(HX_("TestFrames.hx",06,2c,f9,c9),135,HX_("test.TestFrames",54,94,be,54),HX_("testFlxSpriteFrame2",aa,b0,56,3d)));
HXLINE( 136)		Float _hx_tmp = ::hxmath::frames::IFrame2_obj::get_angleDegrees(frame);
...
HXLINE( 147)		HX_VARI_NAME(  ::hxmath::math::Vector2Default,a4,"a") = ::hxmath::frames::IFrame2_obj::get_offset(frameC);
...
HXLINE( 148)		Float _hx_tmp10 = ::hxmath::frames::IFrame2_obj::get_angleDegrees(frameC);
...
HXLINE( 149)		HX_VARI_NAME(  ::hxmath::math::Vector2Default,a5,"a") = ::hxmath::frames::IFrame2_obj::get_offset(frameC2);
...
HXLINE( 150)		Float _hx_tmp13 = ::hxmath::frames::IFrame2_obj::get_angleDegrees(frameC2);
...
HXLINE( 154)		HX_VARI_NAME(  ::hxmath::math::Vector2Default,a10,"a") = ::hxmath::frames::IFrame2_obj::get_offset(frameD);
...
HXLINE( 155)		Float _hx_tmp24 = ::hxmath::frames::IFrame2_obj::get_angleDegrees(frameD);
...
HXLINE( 156)		HX_VARI_NAME(  ::hxmath::math::Vector2Default,a11,"a") = ::hxmath::frames::IFrame2_obj::get_offset(frameD2);
...
HXLINE( 157)		Float _hx_tmp27 = ::hxmath::frames::IFrame2_obj::get_angleDegrees(frameD2);
...
HXLINE( 161)		HX_VARI_NAME(  ::hxmath::math::Vector2Default,a16,"a") = ::hxmath::frames::IFrame2_obj::get_offset(frameE);
...
HXLINE( 162)		Float _hx_tmp38 = ::hxmath::frames::IFrame2_obj::get_angleDegrees(frameE);
...
HXLINE( 163)		HX_VARI_NAME(  ::hxmath::math::Vector2Default,a17,"a") = ::hxmath::frames::IFrame2_obj::get_offset(frameE2);
...
HXLINE( 164)		Float _hx_tmp41 = ::hxmath::frames::IFrame2_obj::get_angleDegrees(frameE2);
