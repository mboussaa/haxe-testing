...
class TypeDefKind_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String __ToString() const { return HX_HCSTRING("TypeDefKind.","\x4f","\x39","\x51","\xac") + _hx_tag; }

		static ::haxe::macro::TypeDefKind TDAbstract(::hx::EnumBase tthis,::Array< ::Dynamic> from,::Array< ::Dynamic> to);
		static ::Dynamic TDAbstract_dyn();
		static ::haxe::macro::TypeDefKind TDAlias(::hx::EnumBase t);
		static ::Dynamic TDAlias_dyn();
		static ::haxe::macro::TypeDefKind TDClass( ::Dynamic superClass,::Array< ::Dynamic> interfaces, ::Dynamic isInterface);
