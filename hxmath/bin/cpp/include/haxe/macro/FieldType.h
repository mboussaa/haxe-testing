...
class FieldType_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String __ToString() const { return HX_HCSTRING("FieldType.","\x3a","\xed","\xfe","\xde") + _hx_tag; }

		static ::haxe::macro::FieldType FFun( ::Dynamic f);
		static ::Dynamic FFun_dyn();
		static ::haxe::macro::FieldType FProp(::String get,::String set,::hx::EnumBase t, ::Dynamic e);
		static ::Dynamic FProp_dyn();
		static ::haxe::macro::FieldType FVar(::hx::EnumBase t, ::Dynamic e);
