...
class ExprDef_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String __ToString() const { return HX_HCSTRING("ExprDef.","\xbe","\x76","\x8e","\x81") + _hx_tag; }
		...
		static ::haxe::macro::ExprDef EBinop(::hx::EnumBase op, ::Dynamic e1, ::Dynamic e2);
		...
		static ::haxe::macro::ExprDef ECast( ::Dynamic e,::hx::EnumBase t);
		static ::Dynamic ECast_dyn();
		static ::haxe::macro::ExprDef ECheckType( ::Dynamic e,::hx::EnumBase t);
		static ::Dynamic ECheckType_dyn();
		static ::haxe::macro::ExprDef EConst(::hx::EnumBase c);
		...
		static ::haxe::macro::ExprDef EUnop(::hx::EnumBase op,Bool postFix, ::Dynamic e);
