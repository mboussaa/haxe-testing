...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Reflect_obj,setField,(void))
 ...
 ::Dynamic Reflect_obj::getProperty( ::Dynamic o,::String field){
            	HX_STACK_FRAME("Reflect","getProperty",0x632ca13a,"Reflect.getProperty","/usr/lib/haxe/std/cpp/_std/Reflect.hx",43,0xe2153adf)
            	HX_STACK_ARG(o,"o")
            	HX_STACK_ARG(field,"field")
...
void Reflect_obj::setProperty( ::Dynamic o,::String field, ::Dynamic value){
            	HX_STACK_FRAME("Reflect","setProperty",0x6d99a846,"Reflect.setProperty","/usr/lib/haxe/std/cpp/_std/Reflect.hx",47,0xe2153adf)
            	HX_STACK_ARG(o,"o")
            	HX_STACK_ARG(field,"field")
            	HX_STACK_ARG(value,"value")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Reflect_obj,deleteField,return )
 ...
 ::Dynamic Reflect_obj::copy( ::Dynamic o){
            	HX_STACK_FRAME("Reflect","copy",0x47e2b5a6,"Reflect.copy","/usr/lib/haxe/std/cpp/_std/Reflect.hx",97,0xe2153adf)
            	HX_STACK_ARG(o,"o")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Reflect_obj,copy,return )
 ...
 ::Dynamic Reflect_obj::makeVarArgs( ::Dynamic f){
            	HX_STACK_FRAME("Reflect","makeVarArgs",0x978955c5,"Reflect.makeVarArgs","/usr/lib/haxe/std/cpp/_std/Reflect.hx",110,0xe2153adf)
            	HX_STACK_ARG(f,"f")
