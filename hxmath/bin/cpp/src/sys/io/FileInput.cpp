...
void FileInput_obj::__construct( ::Dynamic f){
            	HX_STACK_FRAME("sys.io.FileInput","new",0x565591b9,"sys.io.FileInput.new","/usr/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",32,0x81bc0699)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(f,"f")
...
Int FileInput_obj::readByte(){
            	HX_STACK_FRAME("sys.io.FileInput","readByte",0x25e0b585,"sys.io.FileInput.readByte","/usr/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",36,0x81bc0699)
            	HX_STACK_THIS(this)
HXLINE(  36)		try {
...
Int FileInput_obj::readBytes(::haxe::io::Bytes s,Int p,Int l){
            	HX_STACK_FRAME("sys.io.FileInput","readBytes",0xfebe1f4e,"sys.io.FileInput.readBytes","/usr/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",47,0x81bc0699)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(s,"s")
            	HX_STACK_ARG(p,"p")
            	HX_STACK_ARG(l,"l")
...
void FileInput_obj::close(){
            	HX_STACK_FRAME("sys.io.FileInput","close",0x735aa151,"sys.io.FileInput.close","/usr/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",57,0x81bc0699)
            	HX_STACK_THIS(this)
...
void FileInput_obj::seek(Int p,::hx::EnumBase pos){
            	HX_STACK_FRAME("sys.io.FileInput","seek",0x37d7f1ff,"sys.io.FileInput.seek","/usr/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",63,0x81bc0699)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(p,"p")
...
Int FileInput_obj::tell(){
            	HX_STACK_FRAME("sys.io.FileInput","tell",0x38812eb8,"sys.io.FileInput.tell","/usr/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",67,0x81bc0699)
            	HX_STACK_THIS(this)
HXLINE(  67)		return _hx_std_file_tell(this->_hx___f);
            	}
...
Bool FileInput_obj::eof(){
            	HX_STACK_FRAME("sys.io.FileInput","eof",0x564ec615,"sys.io.FileInput.eof","/usr/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",72,0x81bc0699)
            	HX_STACK_THIS(this)
HXLINE(  72)		return _hx_std_file_eof(this->_hx___f);
            	}
