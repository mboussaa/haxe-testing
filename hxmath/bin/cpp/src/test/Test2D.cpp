...
HXLINE( 126)			 ::Dynamic(frame->__Field(HX_("get_matrix",0a,a6,4f,ac),hx::paccDynamic))();
HXLINE( 129)			HX_VARI(  ::hxmath::math::Matrix3x2Default,invFrameMatrix) = ( ( ::hxmath::math::Matrix3x2Default)( ::Dynamic(invFrame->__Field(HX_("get_matrix",0a,a6,4f,ac),hx::paccDynamic))()) );
HXLINE( 130)			HX_VARI_NAME(  ::hxmath::math::Matrix3x2Default,this3,"this") = ( ( ::hxmath::math::Matrix3x2Default)( ::Dynamic(frame->__Field(HX_("get_matrix",0a,a6,4f,ac),hx::paccDynamic))()) );
