...
HXLINE( 113)			 ::Dynamic(frame->__Field(HX_("get_matrix",0a,a6,4f,ac),hx::paccDynamic))();
HXLINE( 116)			HX_VARI(  ::hxmath::math::Matrix4x4Default,invFrameMatrix) = ( ( ::hxmath::math::Matrix4x4Default)( ::Dynamic(invFrame->__Field(HX_("get_matrix",0a,a6,4f,ac),hx::paccDynamic))()) );
HXLINE( 117)			HX_VARI_NAME(  ::hxmath::math::Matrix4x4Default,this2,"this") = ( ( ::hxmath::math::Matrix4x4Default)( ::Dynamic(frame->__Field(HX_("get_matrix",0a,a6,4f,ac),hx::paccDynamic))()) );
