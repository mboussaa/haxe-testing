...
::haxe::macro::ExprDef ExprDef_obj::EBinop(::hx::EnumBase op, ::Dynamic e1, ::Dynamic e2)
{
...
::haxe::macro::ExprDef ExprDef_obj::ECast( ::Dynamic e,::hx::EnumBase t)
{
	return hx::CreateEnum< ExprDef_obj >(HX_("ECast",a4,51,39,e7),24,2)->_hx_init(0,e)->_hx_init(1,t);
}

::haxe::macro::ExprDef ExprDef_obj::ECheckType( ::Dynamic e,::hx::EnumBase t)
{
	return hx::CreateEnum< ExprDef_obj >(HX_("ECheckType",9d,ea,cd,16),28,2)->_hx_init(0,e)->_hx_init(1,t);
}

::haxe::macro::ExprDef ExprDef_obj::EConst(::hx::EnumBase c)
{
...
{
	return hx::CreateEnum< ExprDef_obj >(HX_("EDisplay",7d,14,34,f3),25,2)->_hx_init(0,e)->_hx_init(1,isCall);
}

::haxe::macro::ExprDef ExprDef_obj::EDisplayNew( ::Dynamic t)
{
	return hx::CreateEnum< ExprDef_obj >(HX_("EDisplayNew",e3,9f,6b,90),26,1)->_hx_init(0,t);
}

::haxe::macro::ExprDef ExprDef_obj::EField( ::Dynamic e,::String field)
{
	return hx::CreateEnum< ExprDef_obj >(HX_("EField",35,ea,60,2a),3,2)->_hx_init(0,e)->_hx_init(1,field);
}
...
{
	return hx::CreateEnum< ExprDef_obj >(HX_("EFunction",7d,b4,15,c9),11,2)->_hx_init(0,name)->_hx_init(1,f);
}

::haxe::macro::ExprDef ExprDef_obj::EIf( ::Dynamic econd, ::Dynamic eif, ::Dynamic eelse)
{
	return hx::CreateEnum< ExprDef_obj >(HX_("EIf",82,9b,34,00),15,3)->_hx_init(0,econd)->_hx_init(1,eif)->_hx_init(2,eelse);
}

::haxe::macro::ExprDef ExprDef_obj::EIn( ::Dynamic e1, ::Dynamic e2)
{
	return hx::CreateEnum< ExprDef_obj >(HX_("EIn",8a,9b,34,00),14,2)->_hx_init(0,e1)->_hx_init(1,e2);
}

::haxe::macro::ExprDef ExprDef_obj::EMeta( ::Dynamic s, ::Dynamic e)
{
	return hx::CreateEnum< ExprDef_obj >(HX_("EMeta",aa,7d,d8,ed),29,2)->_hx_init(0,s)->_hx_init(1,e);
}
...
{
	return hx::CreateEnum< ExprDef_obj >(HX_("EReturn",d5,1a,0b,73),19,1)->_hx_init(0,e);
}

::haxe::macro::ExprDef ExprDef_obj::ESwitch( ::Dynamic e,::Array< ::Dynamic> cases, ::Dynamic edef)
{
	return hx::CreateEnum< ExprDef_obj >(HX_("ESwitch",19,c0,56,2f),17,3)->_hx_init(0,e)->_hx_init(1,cases)->_hx_init(2,edef);
}

::haxe::macro::ExprDef ExprDef_obj::ETernary( ::Dynamic econd, ::Dynamic eif, ::Dynamic eelse)
{
	return hx::CreateEnum< ExprDef_obj >(HX_("ETernary",56,c3,5c,5e),27,3)->_hx_init(0,econd)->_hx_init(1,eif)->_hx_init(2,eelse);
}

::haxe::macro::ExprDef ExprDef_obj::EThrow( ::Dynamic e)
{
	return hx::CreateEnum< ExprDef_obj >(HX_("EThrow",a1,b2,5d,39),23,1)->_hx_init(0,e);
}

::haxe::macro::ExprDef ExprDef_obj::ETry( ::Dynamic e,::Array< ::Dynamic> catches)
{
	return hx::CreateEnum< ExprDef_obj >(HX_("ETry",f6,d9,db,2d),18,2)->_hx_init(0,e)->_hx_init(1,catches);
}

::haxe::macro::ExprDef ExprDef_obj::EUnop(::hx::EnumBase op,Bool postFix, ::Dynamic e)
{
...
{
	return hx::CreateEnum< ExprDef_obj >(HX_("EUntyped",ac,51,46,4f),22,1)->_hx_init(0,e);
}
...
{
	return hx::CreateEnum< ExprDef_obj >(HX_("EWhile",2c,99,8a,f3),16,3)->_hx_init(0,econd)->_hx_init(1,e)->_hx_init(2,normalWhile);
}
...
bool ExprDef_obj::__GetStatic(const ::String &inName, ::Dynamic &outValue, hx::PropertyAccess inCallProp)
{
	...
	if (inName==HX_("EDisplayNew",e3,9f,6b,90)) { outValue = ExprDef_obj::EDisplayNew_dyn(); return true; }
	...
	if (inName==HX_("EIn",8a,9b,34,00)) { outValue = ExprDef_obj::EIn_dyn(); return true; }
...
int ExprDef_obj::__FindIndex(::String inName)
{
	...
	if (inName==HX_("EBreak",3a,7a,b9,e2)) return 20;
	if (inName==HX_("ECall",83,4b,39,e7)) return 7;
	if (inName==HX_("ECast",a4,51,39,e7)) return 24;
	if (inName==HX_("ECheckType",9d,ea,cd,16)) return 28;
	if (inName==HX_("EConst",de,4e,2b,74)) return 0;
	if (inName==HX_("EContinue",cc,e9,8b,e6)) return 21;
	if (inName==HX_("EDisplay",7d,14,34,f3)) return 25;
	if (inName==HX_("EDisplayNew",e3,9f,6b,90)) return 26;
	...
	if (inName==HX_("EIf",82,9b,34,00)) return 15;
	if (inName==HX_("EIn",8a,9b,34,00)) return 14;
	if (inName==HX_("EMeta",aa,7d,d8,ed)) return 29;
	...
	if (inName==HX_("EReturn",d5,1a,0b,73)) return 19;
	if (inName==HX_("ESwitch",19,c0,56,2f)) return 17;
	if (inName==HX_("ETernary",56,c3,5c,5e)) return 27;
	if (inName==HX_("EThrow",a1,b2,5d,39)) return 23;
	if (inName==HX_("ETry",f6,d9,db,2d)) return 18;
	if (inName==HX_("EUnop",9f,02,29,f3)) return 9;
	if (inName==HX_("EUntyped",ac,51,46,4f)) return 22;
	if (inName==HX_("EVars",91,5e,c8,f3)) return 10;
	if (inName==HX_("EWhile",2c,99,8a,f3)) return 16;
...
int ExprDef_obj::__FindArgCount(::String inName)
{
	...
	if (inName==HX_("EDisplayNew",e3,9f,6b,90)) return 1;
	...
	if (inName==HX_("EIn",8a,9b,34,00)) return 2;
...
hx::Val ExprDef_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
	...
	if (inName==HX_("EDisplayNew",e3,9f,6b,90)) return EDisplayNew_dyn();
	...
	if (inName==HX_("EIn",8a,9b,34,00)) return EIn_dyn();
...
static void ExprDef_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(ExprDef_obj::EBreak,"EBreak");
	HX_MARK_MEMBER_NAME(ExprDef_obj::EContinue,"EContinue");
};

#ifdef HXCPP_VISIT_ALLOCS
static void ExprDef_obj_sVisitStatic(HX_VISIT_PARAMS) {
...
hx::Static(__mClass) = hx::_hx_RegisterClass(HX_HCSTRING("haxe.macro.ExprDef","\xc6","\x4e","\xed","\x01"), hx::TCanCast< ExprDef_obj >,ExprDef_obj_sStaticFields,0,
	&__Create_ExprDef_obj, &__Create,
	&super::__SGetClass(), &CreateExprDef_obj, ExprDef_obj_sMarkStatics
#ifdef HXCPP_VISIT_ALLOCS
    , ExprDef_obj_sVisitStatic
#endif
...
{
EBreak = hx::CreateEnum< ExprDef_obj >(HX_HCSTRING("EBreak","\x3a","\x7a","\xb9","\xe2"),20,0);
EContinue = hx::CreateEnum< ExprDef_obj >(HX_HCSTRING("EContinue","\xcc","\xe9","\x8b","\xe6"),21,0);
}
