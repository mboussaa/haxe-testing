...
{
	return hx::CreateEnum< Constant_obj >(HX_("CString",74,b1,e2,27),2,1)->_hx_init(0,s);
}
...
static void Constant_obj_sMarkStatics(HX_MARK_PARAMS) {
};

#ifdef HXCPP_VISIT_ALLOCS
static void Constant_obj_sVisitStatic(HX_VISIT_PARAMS) {
...
hx::Static(__mClass) = hx::_hx_RegisterClass(HX_HCSTRING("haxe.macro.Constant","\x6e","\xa5","\x78","\xab"), hx::TCanCast< Constant_obj >,Constant_obj_sStaticFields,0,
	&__Create_Constant_obj, &__Create,
	&super::__SGetClass(), &CreateConstant_obj, Constant_obj_sMarkStatics
#ifdef HXCPP_VISIT_ALLOCS
    , Constant_obj_sVisitStatic
#endif
