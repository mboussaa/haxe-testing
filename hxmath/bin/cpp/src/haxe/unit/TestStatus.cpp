...
void TestStatus_obj::__construct(){
            	HX_STACK_FRAME("haxe.unit.TestStatus","new",0x64df2298,"haxe.unit.TestStatus.new","/usr/lib/haxe/std/haxe/unit/TestStatus.hx",36,0x49165d77)
            	HX_STACK_THIS(this)
HXLINE(  37)		this->done = false;
HXLINE(  38)		this->success = false;
            	}
...
hx::Val TestStatus_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
	...
	case 9:
		...
		if (HX_FIELD_EQ(inName,"backtrace") ) { return hx::Val( backtrace); }
	}
