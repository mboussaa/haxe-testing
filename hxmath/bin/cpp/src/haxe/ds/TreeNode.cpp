...
Int h = __o_h.Default(-1);
            	HX_STACK_FRAME("haxe.ds.TreeNode","new",0x88d32f89,"haxe.ds.TreeNode.new","/usr/lib/haxe/std/haxe/ds/BalancedTree.hx",223,0xbda098e0)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(l,"l")
            	HX_STACK_ARG(k,"k")
            	HX_STACK_ARG(v,"v")
...
::String TreeNode_obj::toString(){
            	HX_STACK_FRAME("haxe.ds.TreeNode","toString",0xcf78dce3,"haxe.ds.TreeNode.toString","/usr/lib/haxe/std/haxe/ds/BalancedTree.hx",237,0xbda098e0)
            	HX_STACK_THIS(this)
HXLINE( 237)		::String _hx_tmp;
HXDLIN( 237)		if (hx::IsNull( this->left )) {
HXLINE( 237)			_hx_tmp = HX_("",00,00,00,00);
            		}
            		else {
HXLINE( 237)			::String _hx_tmp1 = this->left->toString();
HXDLIN( 237)			_hx_tmp = (_hx_tmp1 + HX_(", ",74,26,00,00));
            		}
HXDLIN( 237)		::String _hx_tmp2 = ::Std_obj::string(this->key);
HXDLIN( 237)		::String _hx_tmp3 = ((HX_("",00,00,00,00) + _hx_tmp2) + HX_("=",3d,00,00,00));
HXDLIN( 237)		::String _hx_tmp4 = ::Std_obj::string(this->value);
HXDLIN( 237)		::String _hx_tmp5 = (_hx_tmp + (_hx_tmp3 + _hx_tmp4));
HXDLIN( 237)		::String _hx_tmp6;
HXDLIN( 237)		if (hx::IsNull( this->right )) {
HXLINE( 237)			_hx_tmp6 = HX_("",00,00,00,00);
            		}
            		else {
HXLINE( 237)			::String _hx_tmp7 = this->right->toString();
HXDLIN( 237)			_hx_tmp6 = (HX_(", ",74,26,00,00) + _hx_tmp7);
            		}
HXDLIN( 237)		return (_hx_tmp5 + _hx_tmp6);
            	}
