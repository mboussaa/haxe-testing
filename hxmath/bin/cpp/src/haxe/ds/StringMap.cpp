...
HX_DEFINE_DYNAMIC_FUNC2(StringMap_obj,set,(void))
 ...
 ::Dynamic StringMap_obj::get(::String key){
            	HX_STACK_FRAME("haxe.ds.StringMap","get",0x0f0ea0fc,"haxe.ds.StringMap.get","/usr/lib/haxe/std/cpp/_std/haxe/ds/StringMap.hx",59,0x5168f5a8)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
...
Bool StringMap_obj::exists(::String key){
            	HX_STACK_FRAME("haxe.ds.StringMap","exists",0xd35fc136,"haxe.ds.StringMap.exists","/usr/lib/haxe/std/cpp/_std/haxe/ds/StringMap.hx",63,0x5168f5a8)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
...
::String StringMap_obj::toString(){
            	HX_STACK_FRAME("haxe.ds.StringMap","toString",0xe5a17e86,"haxe.ds.StringMap.toString","/usr/lib/haxe/std/cpp/_std/haxe/ds/StringMap.hx",81,0x5168f5a8)
            	HX_STACK_THIS(this)
