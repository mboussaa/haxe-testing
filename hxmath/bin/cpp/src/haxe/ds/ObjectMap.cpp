...
void ObjectMap_obj::__construct(){
            	HX_STACK_FRAME("haxe.ds.ObjectMap","new",0x27af5498,"haxe.ds.ObjectMap.new","/usr/lib/haxe/std/cpp/_std/haxe/ds/ObjectMap.hx",52,0x941a7216)
            	HX_STACK_THIS(this)
            	}
...
void ObjectMap_obj::set( ::Dynamic key, ::Dynamic value){
            	HX_STACK_FRAME("haxe.ds.ObjectMap","set",0x27b31fda,"haxe.ds.ObjectMap.set","/usr/lib/haxe/std/cpp/_std/haxe/ds/ObjectMap.hx",55,0x941a7216)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC2(ObjectMap_obj,set,(void))
 ...
 ::Dynamic ObjectMap_obj::get( ::Dynamic key){
            	HX_STACK_FRAME("haxe.ds.ObjectMap","get",0x27aa04ce,"haxe.ds.ObjectMap.get","/usr/lib/haxe/std/cpp/_std/haxe/ds/ObjectMap.hx",59,0x941a7216)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
...
Bool ObjectMap_obj::exists( ::Dynamic key){
            	HX_STACK_FRAME("haxe.ds.ObjectMap","exists",0xc8930ca4,"haxe.ds.ObjectMap.exists","/usr/lib/haxe/std/cpp/_std/haxe/ds/ObjectMap.hx",63,0x941a7216)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
...
Bool ObjectMap_obj::remove( ::Dynamic key){
            	HX_STACK_FRAME("haxe.ds.ObjectMap","remove",0x0d3b8b0c,"haxe.ds.ObjectMap.remove","/usr/lib/haxe/std/cpp/_std/haxe/ds/ObjectMap.hx",67,0x941a7216)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
...
HX_DEFINE_DYNAMIC_FUNC1(ObjectMap_obj,remove,return )
 ...
 ::Dynamic ObjectMap_obj::keys(){
            	HX_STACK_FRAME("haxe.ds.ObjectMap","keys",0x8fbf0ebc,"haxe.ds.ObjectMap.keys","/usr/lib/haxe/std/cpp/_std/haxe/ds/ObjectMap.hx",70,0x941a7216)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(ObjectMap_obj,keys,return )
 ...
 ::Dynamic ObjectMap_obj::iterator(){
            	HX_STACK_FRAME("haxe.ds.ObjectMap","iterator",0x61fc7ab6,"haxe.ds.ObjectMap.iterator","/usr/lib/haxe/std/cpp/_std/haxe/ds/ObjectMap.hx",75,0x941a7216)
            	HX_STACK_THIS(this)
...
::String ObjectMap_obj::toString(){
            	HX_STACK_FRAME("haxe.ds.ObjectMap","toString",0x06d10174,"haxe.ds.ObjectMap.toString","/usr/lib/haxe/std/cpp/_std/haxe/ds/ObjectMap.hx",81,0x941a7216)
            	HX_STACK_THIS(this)
