...
void StringBuf_obj::addSub(::String s,Int pos, ::Dynamic len){
            	HX_STACK_FRAME("StringBuf","addSub",0x5b08020b,"StringBuf.addSub","/usr/lib/haxe/std/cpp/_std/StringBuf.hx",45,0x629ed4da)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(s,"s")
            	HX_STACK_ARG(pos,"pos")
            	HX_STACK_ARG(len,"len")
HXLINE(  45)		::String _hx_tmp = s.substr(pos,len);
HXDLIN(  45)		this->b->push(_hx_tmp);
            	}
...
void StringBuf_obj::addChar(Int c){
            	HX_STACK_FRAME("StringBuf","addChar",0x415c7feb,"StringBuf.addChar","/usr/lib/haxe/std/cpp/_std/StringBuf.hx",49,0x629ed4da)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(c,"c")
HXLINE(  49)		this->b->push(::String::fromCharCode(c));
            	}
...
::String StringBuf_obj::toString(){
            	HX_STACK_FRAME("StringBuf","toString",0x68f17bd8,"StringBuf.toString","/usr/lib/haxe/std/cpp/_std/StringBuf.hx",53,0x629ed4da)
            	HX_STACK_THIS(this)
HXLINE(  53)		return this->b->join(HX_("",00,00,00,00));
            	}
