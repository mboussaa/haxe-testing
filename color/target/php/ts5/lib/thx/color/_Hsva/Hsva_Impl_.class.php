...
class thx_color__Hsva_Hsva_Impl_ {
	public function __construct(){}
	static function create($hue, $saturation, $value, $alpha) {
		return (new _hx_array(array($hue, $saturation, $value, $alpha)));
	}
	...
	static function fromString($color) {
		...
		try {
			...
			case "hsv":{
				...
				return thx_color__Hsv_Hsv_Impl_::toHsva($channels);
			}break;
			case "hsva":{
	...
	static function analogous($this1, $spread = null) {
		...
		return _hx_anonymous(array("_0" => thx_color__Hsva_Hsva_Impl_::rotate($this1, -$spread), "_1" => thx_color__Hsva_Hsva_Impl_::rotate($this1, $spread)));
	}
	static function complement($this1) {
		return thx_color__Hsva_Hsva_Impl_::rotate($this1, 180);
	}
	...
	static function interpolateWidest($this1, $other, $t) {
		return (new _hx_array(array(thx_Floats::interpolateAngleWidest($t, $this1[0], $other[0], null), thx_Floats::interpolate($t, $this1[1], $other[1]), thx_Floats::interpolate($t, $this1[2], $other[2]), thx_Floats::interpolate($t, $this1[3], $other[3]))));
	}
	static function rotate($this1, $angle) {
		return thx_color__Hsva_Hsva_Impl_::normalize((new _hx_array(array($this1->a[0] + $angle, $this1[1], $this1[2], $this1[3]))));
	}
	...
	static function withLightness($this1, $newvalue) {
		return (new _hx_array(array($this1[0], $this1[1], $newvalue, $this1[3])));
	}
	static function withSaturation($this1, $newsaturation) {
		return (new _hx_array(array($this1[0], $newsaturation, $this1[2], $this1[3])));
	}
	static function toString($this1) {
		return "hsva(" . _hx_string_rec($this1[0], "") . "," . _hx_string_rec($this1->a[1] * 100, "") . "%," . _hx_string_rec($this1->a[2] * 100, "") . "%," . _hx_string_rec($this1[3], "") . ")";
	}
	static function equals($this1, $other) {
		return thx_color__Hsva_Hsva_Impl_::nearEquals($this1, $other, null);
	}
	...
	static function toHsla($this1) {
		$tmp = thx_color__Hsva_Hsva_Impl_::toRgbxa($this1);
		return thx_color__Rgbxa_Rgbxa_Impl_::toHsla($tmp);
	}
	static function toRgb($this1) {
		$tmp = thx_color__Hsva_Hsva_Impl_::toRgbxa($this1);
		return thx_color__Rgbxa_Rgbxa_Impl_::toRgb($tmp);
	}
	...
	static function toRgbxa($this1) {
		if(_hx_equal($this1[1], 0)) {
			return (new _hx_array(array($this1[2], $this1[2], $this1[2], $this1[3])));
		}
		$r = null;
		$g = null;
		$b = null;
		...
		return (new _hx_array(array($r, $g, $b, $this1[3])));
	}
	...
	static $__properties__ = array("get_alpha" => "get_alpha","get_value" => "get_value","get_saturation" => "get_saturation","get_hue" => "get_hue");
	function __toString() { return 'thx.color._Hsva.Hsva_Impl_'; }
}
