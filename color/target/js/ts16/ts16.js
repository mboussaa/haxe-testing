...
TS16.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS16.hx", lineNumber : 18, className : "TS16", methodName : "addTests"});
	runner.addCase(new thx_color_TestTemperature(Std.parseInt(w)));
};
TS16.main = function() {
...
var thx_color_TestTemperature = function(i) {
	this.x = i;
};
...
thx_color_TestTemperature.prototype = {
	...
	,testBasics: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var this1 = 5000;
			utest_Assert.equals(5000,this1,null,{ fileName : "TestTemperature.hx", lineNumber : 14, className : "thx.color.TestTemperature", methodName : "testBasics"});
		}
	}
	,testStrings: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var this1 = 5000;
			utest_Assert.equals("temperature(5000)",thx_color__$Temperature_Temperature_$Impl_$.toString(this1),null,{ fileName : "TestTemperature.hx", lineNumber : 20, className : "thx.color.TestTemperature", methodName : "testStrings"});
		}
	}
	,testFromString: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var this1 = 5000;
			utest_Assert.isTrue(thx_color__$Temperature_Temperature_$Impl_$.equals(this1,thx_color__$Temperature_Temperature_$Impl_$.fromString("temperature(5000)")),null,{ fileName : "TestTemperature.hx", lineNumber : 25, className : "thx.color.TestTemperature", methodName : "testFromString"});
		}
	}
