...
TS12.addTests = function(runner) {
	runner.addCase(new thx_color_TestHsl());
};
TS12.main = function() {
...
var thx_color_TestHsl = function() {
};
thx_color_TestHsl.__name__ = ["thx","color","TestHsl"];
thx_color_TestHsl.prototype = {
	testBasics: function() {
		var hsl = [1,0,0];
		utest_Assert.equals(1,hsl[0],null,{ fileName : "TestHsl.hx", lineNumber : 11, className : "thx.color.TestHsl", methodName : "testBasics"});
		utest_Assert.equals(0,hsl[1],null,{ fileName : "TestHsl.hx", lineNumber : 12, className : "thx.color.TestHsl", methodName : "testBasics"});
		utest_Assert.equals(0,hsl[2],null,{ fileName : "TestHsl.hx", lineNumber : 13, className : "thx.color.TestHsl", methodName : "testBasics"});
	}
	,testStrings: function() {
		var hsl = [0,0,1];
		utest_Assert.equals("hsl(0,0%,100%)",thx_color__$Hsl_Hsl_$Impl_$.toString(hsl),null,{ fileName : "TestHsl.hx", lineNumber : 18, className : "thx.color.TestHsl", methodName : "testStrings"});
		utest_Assert.equals("hsl(0,0%,100%)",thx_color__$Hsl_Hsl_$Impl_$.toCss3(hsl),null,{ fileName : "TestHsl.hx", lineNumber : 19, className : "thx.color.TestHsl", methodName : "testStrings"});
	}
	,testFromString: function() {
		utest_Assert.isTrue(thx_color__$Hsl_Hsl_$Impl_$.equals([0.5,0.2,0.1],thx_color__$Hsl_Hsl_$Impl_$.fromString("hsl(50%,0.2,10%)")),null,{ fileName : "TestHsl.hx", lineNumber : 23, className : "thx.color.TestHsl", methodName : "testFromString"});
		utest_Assert.isTrue(thx_color__$Hsla_Hsla_$Impl_$.equals([0.5,0.2,0.1,0.3],thx_color__$Hsla_Hsla_$Impl_$.fromString("hsla(50%,0.2,10%,0.3)")),null,{ fileName : "TestHsl.hx", lineNumber : 24, className : "thx.color.TestHsl", methodName : "testFromString"});
	}
