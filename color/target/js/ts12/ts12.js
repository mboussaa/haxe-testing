...
TS12.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS12.hx", lineNumber : 17, className : "TS12", methodName : "addTests"});
	runner.addCase(new thx_color_TestHsl(Std.parseInt(w)));
};
TS12.main = function() {
...
var thx_color_TestHsl = function(i) {
	this.x = i;
};
thx_color_TestHsl.__name__ = ["thx","color","TestHsl"];
thx_color_TestHsl.prototype = {
	x: null
	,testBasics: function() {
		var _g1 = 0;
		var _g = this.x;
		while(_g1 < _g) {
			++_g1;
			var hsl = [1,0,0];
			utest_Assert.equals(1,hsl[0],null,{ fileName : "TestHsl.hx", lineNumber : 15, className : "thx.color.TestHsl", methodName : "testBasics"});
			utest_Assert.equals(0,hsl[1],null,{ fileName : "TestHsl.hx", lineNumber : 16, className : "thx.color.TestHsl", methodName : "testBasics"});
			utest_Assert.equals(0,hsl[2],null,{ fileName : "TestHsl.hx", lineNumber : 17, className : "thx.color.TestHsl", methodName : "testBasics"});
		}
	}
	,testStrings: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var hsl = [0,0,1];
			utest_Assert.equals("hsl(0,0%,100%)",thx_color__$Hsl_Hsl_$Impl_$.toString(hsl),null,{ fileName : "TestHsl.hx", lineNumber : 23, className : "thx.color.TestHsl", methodName : "testStrings"});
			utest_Assert.equals("hsl(0,0%,100%)",thx_color__$Hsl_Hsl_$Impl_$.toCss3(hsl),null,{ fileName : "TestHsl.hx", lineNumber : 24, className : "thx.color.TestHsl", methodName : "testStrings"});
		}
	}
	,testFromString: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.isTrue(thx_color__$Hsl_Hsl_$Impl_$.equals([0.5,0.2,0.1],thx_color__$Hsl_Hsl_$Impl_$.fromString("hsl(50%,0.2,10%)")),null,{ fileName : "TestHsl.hx", lineNumber : 29, className : "thx.color.TestHsl", methodName : "testFromString"});
			utest_Assert.isTrue(thx_color__$Hsla_Hsla_$Impl_$.equals([0.5,0.2,0.1,0.3],thx_color__$Hsla_Hsla_$Impl_$.fromString("hsla(50%,0.2,10%,0.3)")),null,{ fileName : "TestHsl.hx", lineNumber : 30, className : "thx.color.TestHsl", methodName : "testFromString"});
		}
	}
	,__class__: thx_color_TestHsl
};
