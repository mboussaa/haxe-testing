...
TS2.addTests = function(runner) {
	...
	runner.addCase(new thx_color_TestLCh(Std.parseInt(w)));
};
TS2.main = function() {
...
var thx_color_TestLCh = function(i) {
	this.x = i;
};
thx_color_TestLCh.__name__ = ["thx","color","TestLCh"];
thx_color_TestLCh.prototype = {
	x: null
	,testBasics: function() {
		var _g1 = 0;
		var _g = this.x;
		while(_g1 < _g) {
			++_g1;
			var color = thx_color__$LCh_LCh_$Impl_$.normalize([0.5,0.4,-10]);
			utest_Assert.equals(0.5,color[0],null,{ fileName : "TestLCh.hx", lineNumber : 14, className : "thx.color.TestLCh", methodName : "testBasics"});
			utest_Assert.equals(0.4,color[1],null,{ fileName : "TestLCh.hx", lineNumber : 15, className : "thx.color.TestLCh", methodName : "testBasics"});
			utest_Assert.equals(350,color[2],null,{ fileName : "TestLCh.hx", lineNumber : 16, className : "thx.color.TestLCh", methodName : "testBasics"});
		}
	}
	,testString: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("lch(0.5,0.4,350)",thx_color__$LCh_LCh_$Impl_$.toString(thx_color__$LCh_LCh_$Impl_$.normalize([0.5,0.4,-10])),null,{ fileName : "TestLCh.hx", lineNumber : 22, className : "thx.color.TestLCh", methodName : "testString"});
		}
	}
	,testParse: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("lch(100,10,-10)",thx_color__$LCh_LCh_$Impl_$.toString(thx_color__$LCh_LCh_$Impl_$.fromString("cielch(100,10,-10)")),null,{ fileName : "TestLCh.hx", lineNumber : 28, className : "thx.color.TestLCh", methodName : "testParse"});
		}
	}
	,testFromFloat: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.isTrue(thx_color__$LCh_LCh_$Impl_$.equals(thx_color__$LCh_LCh_$Impl_$.fromString("cielch(100,10,-10)"),thx_color__$LCh_LCh_$Impl_$.fromFloats([100.0,10.0,-10.0])),null,{ fileName : "TestLCh.hx", lineNumber : 35, className : "thx.color.TestLCh", methodName : "testFromFloat"});
		}
	}
	,__class__: thx_color_TestLCh
};
