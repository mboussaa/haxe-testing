...
TS2.addTests = function(runner) {
	runner.addCase(new thx_color_TestLCh());
};
TS2.main = function() {
...
var thx_color_TestLCh = function() {
};
...
thx_color_TestLCh.prototype = {
	testBasics: function() {
		...
		utest_Assert.equals(0.5,color[0],null,{ fileName : "TestLCh.hx", lineNumber : 10, className : "thx.color.TestLCh", methodName : "testBasics"});
		utest_Assert.equals(0.4,color[1],null,{ fileName : "TestLCh.hx", lineNumber : 11, className : "thx.color.TestLCh", methodName : "testBasics"});
		utest_Assert.equals(350,color[2],null,{ fileName : "TestLCh.hx", lineNumber : 12, className : "thx.color.TestLCh", methodName : "testBasics"});
	}
	,testString: function() {
		utest_Assert.equals("lch(0.5,0.4,350)",thx_color__$LCh_LCh_$Impl_$.toString(thx_color__$LCh_LCh_$Impl_$.normalize([0.5,0.4,-10])),null,{ fileName : "TestLCh.hx", lineNumber : 17, className : "thx.color.TestLCh", methodName : "testString"});
	}
	,testParse: function() {
		utest_Assert.equals("lch(100,10,-10)",thx_color__$LCh_LCh_$Impl_$.toString(thx_color__$LCh_LCh_$Impl_$.fromString("cielch(100,10,-10)")),null,{ fileName : "TestLCh.hx", lineNumber : 22, className : "thx.color.TestLCh", methodName : "testParse"});
	}
	,testFromFloat: function() {
		utest_Assert.isTrue(thx_color__$LCh_LCh_$Impl_$.equals(thx_color__$LCh_LCh_$Impl_$.fromString("cielch(100,10,-10)"),thx_color__$LCh_LCh_$Impl_$.fromFloats([100.0,10.0,-10.0])),null,{ fileName : "TestLCh.hx", lineNumber : 28, className : "thx.color.TestLCh", methodName : "testFromFloat"});
	}
