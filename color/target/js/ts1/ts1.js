...
TS1.addTests = function(runner) {
	runner.addCase(new thx_color_TestLab());
};
TS1.main = function() {
...
var thx_color_TestLab = function() {
};
thx_color_TestLab.__name__ = ["thx","color","TestLab"];
thx_color_TestLab.prototype = {
	testBasics: function() {
		var color = [100,10,-10];
		utest_Assert.equals(100,color[0],null,{ fileName : "TestLab.hx", lineNumber : 11, className : "thx.color.TestLab", methodName : "testBasics"});
		utest_Assert.equals(10,color[1],null,{ fileName : "TestLab.hx", lineNumber : 12, className : "thx.color.TestLab", methodName : "testBasics"});
		utest_Assert.equals(-10,color[2],null,{ fileName : "TestLab.hx", lineNumber : 13, className : "thx.color.TestLab", methodName : "testBasics"});
	}
	,testString: function() {
		utest_Assert.equals("lab(100,10,-10)",thx_color__$Lab_Lab_$Impl_$.toString([100,10,-10]),null,{ fileName : "TestLab.hx", lineNumber : 18, className : "thx.color.TestLab", methodName : "testString"});
	}
	,testParse: function() {
		utest_Assert.equals("lab(100,10,-10)",thx_color__$Lab_Lab_$Impl_$.toString(thx_color__$Lab_Lab_$Impl_$.fromString("lab(100,10,-10)")),null,{ fileName : "TestLab.hx", lineNumber : 23, className : "thx.color.TestLab", methodName : "testParse"});
	}
	,testFromFloat: function() {
		utest_Assert.same(thx_color__$Lab_Lab_$Impl_$.fromString("lab(50,10,-10)"),thx_color__$Lab_Lab_$Impl_$.fromFloats([50.0,10.0,-10.0]),null,null,null,{ fileName : "TestLab.hx", lineNumber : 29, className : "thx.color.TestLab", methodName : "testFromFloat"});
	}
	,testFromString: function() {
		utest_Assert.same([50,10,-10],thx_color__$Lab_Lab_$Impl_$.fromString("lab(50,10,-10)"),null,null,null,{ fileName : "TestLab.hx", lineNumber : 35, className : "thx.color.TestLab", methodName : "testFromString"});
	}
	,testDistance: function() {
		var orange = thx_color__$Rgb_Rgb_$Impl_$.toLab(thx_color_palettes_Web.orange);
		utest_Assert.isTrue(thx_color__$Lab_Lab_$Impl_$.distance(orange,thx_color__$Rgb_Rgb_$Impl_$.toLab(thx_color_palettes_Web.red)) < thx_color__$Lab_Lab_$Impl_$.distance(orange,thx_color__$Rgb_Rgb_$Impl_$.toLab(thx_color_palettes_Web.blue)),null,{ fileName : "TestLab.hx", lineNumber : 44, className : "thx.color.TestLab", methodName : "testDistance"});
	}
	,testMatch: function() {
		...
		utest_Assert.isTrue(thx_color__$Lab_Lab_$Impl_$.equals(thx_color__$Lab_Lab_$Impl_$.match(thx_color__$Rgb_Rgb_$Impl_$.toLab(thx_color_palettes_Web.orange),arr),thx_color__$Rgb_Rgb_$Impl_$.toLab(thx_color_palettes_Web.red)),null,{ fileName : "TestLab.hx", lineNumber : 49, className : "thx.color.TestLab", methodName : "testMatch"});
	}
