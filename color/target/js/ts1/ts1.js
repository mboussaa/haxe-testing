...
TS1.addTests = function(runner) {
	...
	runner.addCase(new thx_color_TestLab(Std.parseInt(w)));
};
TS1.main = function() {
...
var thx_color_TestLab = function(i) {
	this.x = i;
};
thx_color_TestLab.__name__ = ["thx","color","TestLab"];
thx_color_TestLab.prototype = {
	x: null
	,testBasics: function() {
		var _g1 = 0;
		var _g = this.x;
		while(_g1 < _g) {
			++_g1;
			var color = [100,10,-10];
			utest_Assert.equals(100,color[0],null,{ fileName : "TestLab.hx", lineNumber : 15, className : "thx.color.TestLab", methodName : "testBasics"});
			utest_Assert.equals(10,color[1],null,{ fileName : "TestLab.hx", lineNumber : 16, className : "thx.color.TestLab", methodName : "testBasics"});
			utest_Assert.equals(-10,color[2],null,{ fileName : "TestLab.hx", lineNumber : 17, className : "thx.color.TestLab", methodName : "testBasics"});
		}
	}
	,testString: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("lab(100,10,-10)",thx_color__$Lab_Lab_$Impl_$.toString([100,10,-10]),null,{ fileName : "TestLab.hx", lineNumber : 23, className : "thx.color.TestLab", methodName : "testString"});
		}
	}
	,testParse: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("lab(100,10,-10)",thx_color__$Lab_Lab_$Impl_$.toString(thx_color__$Lab_Lab_$Impl_$.fromString("lab(100,10,-10)")),null,{ fileName : "TestLab.hx", lineNumber : 29, className : "thx.color.TestLab", methodName : "testParse"});
		}
	}
	,testFromFloat: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.same(thx_color__$Lab_Lab_$Impl_$.fromString("lab(50,10,-10)"),thx_color__$Lab_Lab_$Impl_$.fromFloats([50.0,10.0,-10.0]),null,null,null,{ fileName : "TestLab.hx", lineNumber : 36, className : "thx.color.TestLab", methodName : "testFromFloat"});
		}
	}
	,testFromString: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.same([50,10,-10],thx_color__$Lab_Lab_$Impl_$.fromString("lab(50,10,-10)"),null,null,null,{ fileName : "TestLab.hx", lineNumber : 43, className : "thx.color.TestLab", methodName : "testFromString"});
		}
	}
	,testDistance: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var orange = thx_color__$Rgb_Rgb_$Impl_$.toLab(thx_color_palettes_Web.orange);
			utest_Assert.isTrue(thx_color__$Lab_Lab_$Impl_$.distance(orange,thx_color__$Rgb_Rgb_$Impl_$.toLab(thx_color_palettes_Web.red)) < thx_color__$Lab_Lab_$Impl_$.distance(orange,thx_color__$Rgb_Rgb_$Impl_$.toLab(thx_color_palettes_Web.blue)),null,{ fileName : "TestLab.hx", lineNumber : 53, className : "thx.color.TestLab", methodName : "testDistance"});
		}
	}
	,testMatch: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			var arr = [thx_color__$Rgb_Rgb_$Impl_$.toLab(thx_color_palettes_Web.red),thx_color__$Rgb_Rgb_$Impl_$.toLab(thx_color_palettes_Web.blue)];
			utest_Assert.isTrue(thx_color__$Lab_Lab_$Impl_$.equals(thx_color__$Lab_Lab_$Impl_$.match(thx_color__$Rgb_Rgb_$Impl_$.toLab(thx_color_palettes_Web.orange),arr),thx_color__$Rgb_Rgb_$Impl_$.toLab(thx_color_palettes_Web.red)),null,{ fileName : "TestLab.hx", lineNumber : 59, className : "thx.color.TestLab", methodName : "testMatch"});
		}
	}
	,__class__: thx_color_TestLab
};
