...
TS8.addTests = function(runner) {
	runner.addCase(new thx_color_TestCmyk());
};
TS8.main = function() {
...
var thx_color_TestCmyk = function() {
};
thx_color_TestCmyk.__name__ = ["thx","color","TestCmyk"];
thx_color_TestCmyk.prototype = {
	testBasics: function() {
		var cmyk = [0.1,0.2,0.3,0.4];
		utest_Assert.equals(0.1,cmyk[0],null,{ fileName : "TestCmyk.hx", lineNumber : 11, className : "thx.color.TestCmyk", methodName : "testBasics"});
		utest_Assert.equals(0.2,cmyk[1],null,{ fileName : "TestCmyk.hx", lineNumber : 12, className : "thx.color.TestCmyk", methodName : "testBasics"});
		utest_Assert.equals(0.3,cmyk[2],null,{ fileName : "TestCmyk.hx", lineNumber : 13, className : "thx.color.TestCmyk", methodName : "testBasics"});
		utest_Assert.equals(0.4,cmyk[3],null,{ fileName : "TestCmyk.hx", lineNumber : 14, className : "thx.color.TestCmyk", methodName : "testBasics"});
	}
	,testStrings: function() {
		utest_Assert.equals("cmyk(0,1,1,0)",thx_color__$Cmyk_Cmyk_$Impl_$.toString([0,1,1,0]),null,{ fileName : "TestCmyk.hx", lineNumber : 19, className : "thx.color.TestCmyk", methodName : "testStrings"});
	}
	,testWhite: function() {
		utest_Assert.isTrue(thx_color__$Cmyk_Cmyk_$Impl_$.equals(thx_color__$Rgb_Rgb_$Impl_$.toCmyk(thx_color_palettes_Web.white),[0,0,0,0]),null,{ fileName : "TestCmyk.hx", lineNumber : 23, className : "thx.color.TestCmyk", methodName : "testWhite"});
	}
	,testFromString: function() {
		utest_Assert.isTrue(thx_color__$Cmyk_Cmyk_$Impl_$.equals([0.5,0.2,0.1,0.3],thx_color__$Cmyk_Cmyk_$Impl_$.fromString("cmyk(50%,0.2,10%,0.3)")),null,{ fileName : "TestCmyk.hx", lineNumber : 27, className : "thx.color.TestCmyk", methodName : "testFromString"});
	}
