...
TS8.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS8.hx", lineNumber : 17, className : "TS8", methodName : "addTests"});
	runner.addCase(new thx_color_TestCmyk(Std.parseInt(w)));
};
TS8.main = function() {
...
var thx_color_TestCmyk = function(i) {
	this.x = i;
};
thx_color_TestCmyk.__name__ = ["thx","color","TestCmyk"];
thx_color_TestCmyk.prototype = {
	x: null
	,testBasics: function() {
		var _g1 = 0;
		var _g = this.x;
		while(_g1 < _g) {
			++_g1;
			var cmyk = [0.1,0.2,0.3,0.4];
			utest_Assert.equals(0.1,cmyk[0],null,{ fileName : "TestCmyk.hx", lineNumber : 15, className : "thx.color.TestCmyk", methodName : "testBasics"});
			utest_Assert.equals(0.2,cmyk[1],null,{ fileName : "TestCmyk.hx", lineNumber : 16, className : "thx.color.TestCmyk", methodName : "testBasics"});
			utest_Assert.equals(0.3,cmyk[2],null,{ fileName : "TestCmyk.hx", lineNumber : 17, className : "thx.color.TestCmyk", methodName : "testBasics"});
			utest_Assert.equals(0.4,cmyk[3],null,{ fileName : "TestCmyk.hx", lineNumber : 18, className : "thx.color.TestCmyk", methodName : "testBasics"});
		}
	}
	,testStrings: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("cmyk(0,1,1,0)",thx_color__$Cmyk_Cmyk_$Impl_$.toString([0,1,1,0]),null,{ fileName : "TestCmyk.hx", lineNumber : 24, className : "thx.color.TestCmyk", methodName : "testStrings"});
		}
	}
	,testWhite: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.isTrue(thx_color__$Cmyk_Cmyk_$Impl_$.equals(thx_color__$Rgb_Rgb_$Impl_$.toCmyk(thx_color_palettes_Web.white),[0,0,0,0]),null,{ fileName : "TestCmyk.hx", lineNumber : 29, className : "thx.color.TestCmyk", methodName : "testWhite"});
		}
	}
	,testFromString: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.isTrue(thx_color__$Cmyk_Cmyk_$Impl_$.equals([0.5,0.2,0.1,0.3],thx_color__$Cmyk_Cmyk_$Impl_$.fromString("cmyk(50%,0.2,10%,0.3)")),null,{ fileName : "TestCmyk.hx", lineNumber : 34, className : "thx.color.TestCmyk", methodName : "testFromString"});
		}
	}
	,__class__: thx_color_TestCmyk
};
