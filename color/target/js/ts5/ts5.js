...
TS5.addTests = function(runner) {
	...
	runner.addCase(new thx_color_TestColorParser(Std.parseInt(w)));
};
TS5.main = function() {
...
var thx_color_TestColorParser = function(i) {
	this.x = i;
};
thx_color_TestColorParser.__name__ = ["thx","color","TestColorParser"];
thx_color_TestColorParser.prototype = {
	x: null
	,testFeatures: function() {
		...
		while(_g1 < _g) {
			++_g1;
			this.assert("a",[thx_color_parse_ChannelInfo.CIInt8(2)],"a(2)",{ fileName : "TestColorParser.hx", lineNumber : 16, className : "thx.color.TestColorParser", methodName : "testFeatures"});
			this.assert("aa",[thx_color_parse_ChannelInfo.CIInt8(2)],"aa(2)",{ fileName : "TestColorParser.hx", lineNumber : 19, className : "thx.color.TestColorParser", methodName : "testFeatures"});
			this.assert("rgb",[thx_color_parse_ChannelInfo.CIInt8(2)],"rgb(2)",{ fileName : "TestColorParser.hx", lineNumber : 22, className : "thx.color.TestColorParser", methodName : "testFeatures"});
			this.assert("rgba",[thx_color_parse_ChannelInfo.CIInt8(2)],"rgba(2)",{ fileName : "TestColorParser.hx", lineNumber : 25, className : "thx.color.TestColorParser", methodName : "testFeatures"});
			this.assert("hsla",[thx_color_parse_ChannelInfo.CIDegree(1),thx_color_parse_ChannelInfo.CIPercent(2),thx_color_parse_ChannelInfo.CIPercent(3),thx_color_parse_ChannelInfo.CIFloat(0.5)],"hsla(1deg,2%,3%,0.5)",{ fileName : "TestColorParser.hx", lineNumber : 28, className : "thx.color.TestColorParser", methodName : "testFeatures"});
		}
	}
	,testChannels: function() {
		...
		while(_g1 < _g) {
			++_g1;
			this.assertStringChannel(thx_color_parse_ChannelInfo.CIDegree(1),"1deg",{ fileName : "TestColorParser.hx", lineNumber : 35, className : "thx.color.TestColorParser", methodName : "testChannels"});
			this.assertStringChannel(thx_color_parse_ChannelInfo.CIPercent(1),"1%",{ fileName : "TestColorParser.hx", lineNumber : 36, className : "thx.color.TestColorParser", methodName : "testChannels"});
			this.assertStringChannel(thx_color_parse_ChannelInfo.CIFloat(0.1),"0.1",{ fileName : "TestColorParser.hx", lineNumber : 37, className : "thx.color.TestColorParser", methodName : "testChannels"});
			this.assertStringChannel(thx_color_parse_ChannelInfo.CIBool(false),"0",{ fileName : "TestColorParser.hx", lineNumber : 38, className : "thx.color.TestColorParser", methodName : "testChannels"});
			this.assertStringChannel(thx_color_parse_ChannelInfo.CIBool(true),"1",{ fileName : "TestColorParser.hx", lineNumber : 39, className : "thx.color.TestColorParser", methodName : "testChannels"});
			this.assertStringChannel(thx_color_parse_ChannelInfo.CIInt8(2),"2",{ fileName : "TestColorParser.hx", lineNumber : 40, className : "thx.color.TestColorParser", methodName : "testChannels"});
			this.assertStringChannel(thx_color_parse_ChannelInfo.CIInt(256),"256",{ fileName : "TestColorParser.hx", lineNumber : 41, className : "thx.color.TestColorParser", methodName : "testChannels"});
		}
	}
	,testInvalidColor: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.isNull(thx_color_parse_ColorParser.parseColor("x"),null,{ fileName : "TestColorParser.hx", lineNumber : 46, className : "thx.color.TestColorParser", methodName : "testInvalidColor"});
			utest_Assert.isNull(thx_color_parse_ColorParser.parseColor("x[]"),null,{ fileName : "TestColorParser.hx", lineNumber : 47, className : "thx.color.TestColorParser", methodName : "testInvalidColor"});
			utest_Assert.isNull(thx_color_parse_ColorParser.parseColor("x(x)"),null,{ fileName : "TestColorParser.hx", lineNumber : 48, className : "thx.color.TestColorParser", methodName : "testInvalidColor"});
		}
	}
	,testInvalidChannel: function() {
		var _g1 = 0;
		var _g = this.x;
		while(_g1 < _g) {
			++_g1;
			utest_Assert.isNull(thx_color_parse_ColorParser.parseChannel("x"),null,{ fileName : "TestColorParser.hx", lineNumber : 53, className : "thx.color.TestColorParser", methodName : "testInvalidChannel"});
		}
	}
	,assertStringChannel: function(expected,test,pos) {
		this.assertChannel(expected,thx_color_parse_ColorParser.parseChannel(test),pos);
	}
	,assertChannel: function(expected,test,pos) {
		if(null == test) {
		...
		var ec = expected[0];
		var tc = test[0];
		var ep = expected.slice(2)[0];
		var tp = test.slice(2)[0];
		utest_Assert.equals(ec,tc,null,pos);
		utest_Assert.equals(ep,tp,null,pos);
	}
	,assert: function(name,channels,test_string,pos) {
		var expected = new thx_color_parse_ColorInfo(name,channels);
		var test = thx_color_parse_ColorParser.parseColor(test_string);
		if(null == test) {
		...
		var _g1 = 0;
		var _g = expected.channels.length;
		while(_g1 < _g) {
			var i = _g1++;
			this.assertChannel(expected.channels[i],test.channels[i],pos);
		}
	}
	,__class__: thx_color_TestColorParser
};
