...
TS5.addTests = function(runner) {
	runner.addCase(new thx_color_TestColorParser());
};
TS5.main = function() {
...
var thx_color_TestColorParser = function() {
};
thx_color_TestColorParser.__name__ = ["thx","color","TestColorParser"];
thx_color_TestColorParser.prototype = {
	testFeatures: function() {
		this.assert("a",[thx_color_parse_ChannelInfo.CIInt8(2)],"a(2)",{ fileName : "TestColorParser.hx", lineNumber : 12, className : "thx.color.TestColorParser", methodName : "testFeatures"});
		this.assert("aa",[thx_color_parse_ChannelInfo.CIInt8(2)],"aa(2)",{ fileName : "TestColorParser.hx", lineNumber : 15, className : "thx.color.TestColorParser", methodName : "testFeatures"});
		this.assert("rgb",[thx_color_parse_ChannelInfo.CIInt8(2)],"rgb(2)",{ fileName : "TestColorParser.hx", lineNumber : 18, className : "thx.color.TestColorParser", methodName : "testFeatures"});
		this.assert("rgba",[thx_color_parse_ChannelInfo.CIInt8(2)],"rgba(2)",{ fileName : "TestColorParser.hx", lineNumber : 21, className : "thx.color.TestColorParser", methodName : "testFeatures"});
		this.assert("hsla",[thx_color_parse_ChannelInfo.CIDegree(1),thx_color_parse_ChannelInfo.CIPercent(2),thx_color_parse_ChannelInfo.CIPercent(3),thx_color_parse_ChannelInfo.CIFloat(0.5)],"hsla(1deg,2%,3%,0.5)",{ fileName : "TestColorParser.hx", lineNumber : 24, className : "thx.color.TestColorParser", methodName : "testFeatures"});
	}
	,testChannels: function() {
		this.assertStringChannel(thx_color_parse_ChannelInfo.CIDegree(1),"1deg",{ fileName : "TestColorParser.hx", lineNumber : 30, className : "thx.color.TestColorParser", methodName : "testChannels"});
		this.assertStringChannel(thx_color_parse_ChannelInfo.CIPercent(1),"1%",{ fileName : "TestColorParser.hx", lineNumber : 31, className : "thx.color.TestColorParser", methodName : "testChannels"});
		this.assertStringChannel(thx_color_parse_ChannelInfo.CIFloat(0.1),"0.1",{ fileName : "TestColorParser.hx", lineNumber : 32, className : "thx.color.TestColorParser", methodName : "testChannels"});
		this.assertStringChannel(thx_color_parse_ChannelInfo.CIBool(false),"0",{ fileName : "TestColorParser.hx", lineNumber : 33, className : "thx.color.TestColorParser", methodName : "testChannels"});
		this.assertStringChannel(thx_color_parse_ChannelInfo.CIBool(true),"1",{ fileName : "TestColorParser.hx", lineNumber : 34, className : "thx.color.TestColorParser", methodName : "testChannels"});
		this.assertStringChannel(thx_color_parse_ChannelInfo.CIInt8(2),"2",{ fileName : "TestColorParser.hx", lineNumber : 35, className : "thx.color.TestColorParser", methodName : "testChannels"});
		this.assertStringChannel(thx_color_parse_ChannelInfo.CIInt(256),"256",{ fileName : "TestColorParser.hx", lineNumber : 36, className : "thx.color.TestColorParser", methodName : "testChannels"});
	}
	,testInvalidColor: function() {
		utest_Assert.isNull(thx_color_parse_ColorParser.parseColor("x"),null,{ fileName : "TestColorParser.hx", lineNumber : 40, className : "thx.color.TestColorParser", methodName : "testInvalidColor"});
		utest_Assert.isNull(thx_color_parse_ColorParser.parseColor("x[]"),null,{ fileName : "TestColorParser.hx", lineNumber : 41, className : "thx.color.TestColorParser", methodName : "testInvalidColor"});
		utest_Assert.isNull(thx_color_parse_ColorParser.parseColor("x(x)"),null,{ fileName : "TestColorParser.hx", lineNumber : 42, className : "thx.color.TestColorParser", methodName : "testInvalidColor"});
	}
	,testInvalidChannel: function() {
		utest_Assert.isNull(thx_color_parse_ColorParser.parseChannel("x"),null,{ fileName : "TestColorParser.hx", lineNumber : 46, className : "thx.color.TestColorParser", methodName : "testInvalidChannel"});
	}
