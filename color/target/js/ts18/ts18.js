...
TS18.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS18.hx", lineNumber : 17, className : "TS18", methodName : "addTests"});
	runner.addCase(new thx_color_TestYxy(Std.parseInt(w)));
};
TS18.main = function() {
	var runner = new utest_Runner();
	TS18.addTests(runner);
...
var thx_color_TestYxy = function(i) {
	this.x = i;
};
...
thx_color_TestYxy.prototype = {
	...
	,testBasics: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.equals(0.5,color[0],null,{ fileName : "TestYxy.hx", lineNumber : 14, className : "thx.color.TestYxy", methodName : "testBasics"});
			utest_Assert.equals(0.4,color[1],null,{ fileName : "TestYxy.hx", lineNumber : 15, className : "thx.color.TestYxy", methodName : "testBasics"});
			utest_Assert.equals(0.3,color[2],null,{ fileName : "TestYxy.hx", lineNumber : 16, className : "thx.color.TestYxy", methodName : "testBasics"});
		}
	}
	,testString: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("yxy(0.5,0.4,0.3)",thx_color__$Yxy_Yxy_$Impl_$.toString([0.5,0.4,0.3]),null,{ fileName : "TestYxy.hx", lineNumber : 22, className : "thx.color.TestYxy", methodName : "testString"});
		}
	}
	,testParse: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("yxy(0.5,0.4,0.3)",thx_color__$Yxy_Yxy_$Impl_$.toString(thx_color__$Yxy_Yxy_$Impl_$.fromString("yxy(0.5,0.4,0.3)")),null,{ fileName : "TestYxy.hx", lineNumber : 28, className : "thx.color.TestYxy", methodName : "testParse"});
		}
	}
	,testFromFloat: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.isTrue(thx_color__$Yxy_Yxy_$Impl_$.equals(thx_color__$Yxy_Yxy_$Impl_$.fromString("yxy(0.5,0.4,0.3)"),thx_color__$Yxy_Yxy_$Impl_$.fromFloats([0.5,0.4,0.3])),null,{ fileName : "TestYxy.hx", lineNumber : 35, className : "thx.color.TestYxy", methodName : "testFromFloat"});
		}
	}
