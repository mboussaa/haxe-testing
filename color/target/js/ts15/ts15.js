...
TS15.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS15.hx", lineNumber : 18, className : "TS15", methodName : "addTests"});
	runner.addCase(new thx_color_TestRgbx(Std.parseInt(w)));
};
TS15.main = function() {
...
var thx_color_TestRgbx = function(i) {
	this.x = i;
};
...
thx_color_TestRgbx.prototype = {
	...
	,testBasics: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var red = [1,0,0];
			utest_Assert.equals(255,thx_color__$Rgbx_Rgbx_$Impl_$.get_red(red),null,{ fileName : "TestRgbx.hx", lineNumber : 15, className : "thx.color.TestRgbx", methodName : "testBasics"});
			utest_Assert.equals(0,thx_color__$Rgbx_Rgbx_$Impl_$.get_green(red),null,{ fileName : "TestRgbx.hx", lineNumber : 16, className : "thx.color.TestRgbx", methodName : "testBasics"});
			utest_Assert.equals(0,thx_color__$Rgbx_Rgbx_$Impl_$.get_blue(red),null,{ fileName : "TestRgbx.hx", lineNumber : 17, className : "thx.color.TestRgbx", methodName : "testBasics"});
		}
	}
	,testStrings: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var color = [0,0,1];
			utest_Assert.equals("rgb(0%,0%,100%)",thx_color__$Rgbx_Rgbx_$Impl_$.toCss3(color),null,{ fileName : "TestRgbx.hx", lineNumber : 23, className : "thx.color.TestRgbx", methodName : "testStrings"});
			utest_Assert.equals("#0000FF",thx_color__$Rgbx_Rgbx_$Impl_$.toHex(color),null,{ fileName : "TestRgbx.hx", lineNumber : 24, className : "thx.color.TestRgbx", methodName : "testStrings"});
			utest_Assert.equals("rgb(0%,0%,100%)",thx_color__$Rgbx_Rgbx_$Impl_$.toString(color),null,{ fileName : "TestRgbx.hx", lineNumber : 25, className : "thx.color.TestRgbx", methodName : "testStrings"});
		}
	}
	,testFromString: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.isTrue(thx_color__$Rgbx_Rgbx_$Impl_$.equals([0,1,0],thx_color__$Rgbx_Rgbx_$Impl_$.fromString("#00ff00")),null,{ fileName : "TestRgbx.hx", lineNumber : 30, className : "thx.color.TestRgbx", methodName : "testFromString"});
			utest_Assert.isTrue(thx_color__$Rgbx_Rgbx_$Impl_$.equals([0,1,0],thx_color__$Rgbx_Rgbx_$Impl_$.fromString("#0f0")),null,{ fileName : "TestRgbx.hx", lineNumber : 31, className : "thx.color.TestRgbx", methodName : "testFromString"});
			utest_Assert.isTrue(thx_color__$Rgbx_Rgbx_$Impl_$.equals([0,1,0],thx_color__$Rgbx_Rgbx_$Impl_$.fromString("rgb(0,100%,0)")),null,{ fileName : "TestRgbx.hx", lineNumber : 32, className : "thx.color.TestRgbx", methodName : "testFromString"});
			utest_Assert.isTrue(thx_color__$Rgbx_Rgbx_$Impl_$.equals([0,1,0],thx_color__$Rgbx_Rgbx_$Impl_$.fromString("rgb(0,255,0)")),null,{ fileName : "TestRgbx.hx", lineNumber : 33, className : "thx.color.TestRgbx", methodName : "testFromString"});
			utest_Assert.isTrue(thx_color__$Rgbxa_Rgbxa_$Impl_$.equals([0,1,0,1],thx_color__$Rgbxa_Rgbxa_$Impl_$.fromString("#ff00ff00")),null,{ fileName : "TestRgbx.hx", lineNumber : 34, className : "thx.color.TestRgbx", methodName : "testFromString"});
			utest_Assert.isTrue(thx_color__$Rgbxa_Rgbxa_$Impl_$.equals([0,1,0,1],thx_color__$Rgbxa_Rgbxa_$Impl_$.fromString("#f0f0")),null,{ fileName : "TestRgbx.hx", lineNumber : 35, className : "thx.color.TestRgbx", methodName : "testFromString"});
			utest_Assert.isTrue(thx_color__$Rgbxa_Rgbxa_$Impl_$.equals([0,1,0,0.5],thx_color__$Rgbxa_Rgbxa_$Impl_$.fromString("rgba(0,255,0,50%)")),null,{ fileName : "TestRgbx.hx", lineNumber : 36, className : "thx.color.TestRgbx", methodName : "testFromString"});
			utest_Assert.isTrue(thx_color__$Rgbxa_Rgbxa_$Impl_$.equals([0,1,0,0.5],thx_color__$Rgbxa_Rgbxa_$Impl_$.fromString("rgba(0,100%,0,0.5)")),null,{ fileName : "TestRgbx.hx", lineNumber : 37, className : "thx.color.TestRgbx", methodName : "testFromString"});
		}
	}
