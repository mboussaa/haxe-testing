...
TS17.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS17.hx", lineNumber : 17, className : "TS17", methodName : "addTests"});
	runner.addCase(new thx_color_TestXyz(Std.parseInt(w)));
};
TS17.main = function() {
...
var thx_color_TestXyz = function(i) {
	this.x = i;
};
...
thx_color_TestXyz.prototype = {
	...
	,testBasics: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.equals(0.5,color[0],null,{ fileName : "TestXyz.hx", lineNumber : 14, className : "thx.color.TestXyz", methodName : "testBasics"});
			utest_Assert.equals(0.4,color[1],null,{ fileName : "TestXyz.hx", lineNumber : 15, className : "thx.color.TestXyz", methodName : "testBasics"});
			utest_Assert.equals(0.3,color[2],null,{ fileName : "TestXyz.hx", lineNumber : 16, className : "thx.color.TestXyz", methodName : "testBasics"});
		}
	}
	,testString: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("xyz(0.5,0.4,0.3)",thx_color__$Xyz_Xyz_$Impl_$.toString([0.5,0.4,0.3]),null,{ fileName : "TestXyz.hx", lineNumber : 22, className : "thx.color.TestXyz", methodName : "testString"});
		}
	}
	,testParse: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("xyz(0.5,0.4,0.3)",thx_color__$Xyz_Xyz_$Impl_$.toString(thx_color__$Xyz_Xyz_$Impl_$.fromString("xyz(0.5,0.4,0.3)")),null,{ fileName : "TestXyz.hx", lineNumber : 28, className : "thx.color.TestXyz", methodName : "testParse"});
		}
	}
	,testFromFloat: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.isTrue(thx_color__$Xyz_Xyz_$Impl_$.equals(thx_color__$Xyz_Xyz_$Impl_$.fromString("xyz(0.5,0.4,0.3)"),thx_color__$Xyz_Xyz_$Impl_$.fromFloats([0.5,0.4,0.3])),null,{ fileName : "TestXyz.hx", lineNumber : 35, className : "thx.color.TestXyz", methodName : "testFromFloat"});
		}
	}
