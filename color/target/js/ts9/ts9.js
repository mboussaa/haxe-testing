...
TS9.addTests = function(runner) {
	runner.addCase(new thx_color_TestCubeHelix());
};
TS9.main = function() {
...
var thx_color_TestCubeHelix = function() {
};
thx_color_TestCubeHelix.__name__ = ["thx","color","TestCubeHelix"];
thx_color_TestCubeHelix.prototype = {
	testBasics: function() {
		var cubeHelix = [1,0,0,1.0];
		utest_Assert.equals(1,cubeHelix[0],null,{ fileName : "TestCubeHelix.hx", lineNumber : 11, className : "thx.color.TestCubeHelix", methodName : "testBasics"});
		utest_Assert.equals(0,cubeHelix[1],null,{ fileName : "TestCubeHelix.hx", lineNumber : 12, className : "thx.color.TestCubeHelix", methodName : "testBasics"});
		utest_Assert.equals(0,cubeHelix[2],null,{ fileName : "TestCubeHelix.hx", lineNumber : 13, className : "thx.color.TestCubeHelix", methodName : "testBasics"});
	}
	,testStrings: function() {
		utest_Assert.equals("cubehelix(0,0,1)",thx_color__$CubeHelix_CubeHelix_$Impl_$.toString([0,0,1,1.0]),null,{ fileName : "TestCubeHelix.hx", lineNumber : 18, className : "thx.color.TestCubeHelix", methodName : "testStrings"});
	}
	,testFromString: function() {
		utest_Assert.isTrue(thx_color__$CubeHelix_CubeHelix_$Impl_$.equals([0.5,0.2,0.1,1.0],thx_color__$CubeHelix_CubeHelix_$Impl_$.fromString("cubehelix(50%,0.2,10%)")),null,{ fileName : "TestCubeHelix.hx", lineNumber : 22, className : "thx.color.TestCubeHelix", methodName : "testFromString"});
	}
	,testNearEquals: function() {
		var c1 = [206.182,0.441,0.090,1.0];
		var c2 = [206.181,0.440,0.090,1.0];
		utest_Assert.isFalse(thx_color__$CubeHelix_CubeHelix_$Impl_$.equals(c1,c2),null,{ fileName : "TestCubeHelix.hx", lineNumber : 28, className : "thx.color.TestCubeHelix", methodName : "testNearEquals"});
		utest_Assert.isTrue(thx_color__$CubeHelix_CubeHelix_$Impl_$.nearEquals(c1,c2,0.01),null,{ fileName : "TestCubeHelix.hx", lineNumber : 29, className : "thx.color.TestCubeHelix", methodName : "testNearEquals"});
	}
