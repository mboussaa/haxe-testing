...
TS9.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS9.hx", lineNumber : 17, className : "TS9", methodName : "addTests"});
	runner.addCase(new thx_color_TestCubeHelix(Std.parseInt(w)));
};
TS9.main = function() {
...
var thx_color_TestCubeHelix = function(i) {
	this.x = i;
};
thx_color_TestCubeHelix.__name__ = ["thx","color","TestCubeHelix"];
thx_color_TestCubeHelix.prototype = {
	x: null
	,testBasics: function() {
		var _g1 = 0;
		var _g = this.x;
		while(_g1 < _g) {
			++_g1;
			var cubeHelix = [1,0,0,1.0];
			utest_Assert.equals(1,cubeHelix[0],null,{ fileName : "TestCubeHelix.hx", lineNumber : 15, className : "thx.color.TestCubeHelix", methodName : "testBasics"});
			utest_Assert.equals(0,cubeHelix[1],null,{ fileName : "TestCubeHelix.hx", lineNumber : 16, className : "thx.color.TestCubeHelix", methodName : "testBasics"});
			utest_Assert.equals(0,cubeHelix[2],null,{ fileName : "TestCubeHelix.hx", lineNumber : 17, className : "thx.color.TestCubeHelix", methodName : "testBasics"});
		}
	}
	,testStrings: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("cubehelix(0,0,1)",thx_color__$CubeHelix_CubeHelix_$Impl_$.toString([0,0,1,1.0]),null,{ fileName : "TestCubeHelix.hx", lineNumber : 23, className : "thx.color.TestCubeHelix", methodName : "testStrings"});
		}
	}
	,testFromString: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.isTrue(thx_color__$CubeHelix_CubeHelix_$Impl_$.equals([0.5,0.2,0.1,1.0],thx_color__$CubeHelix_CubeHelix_$Impl_$.fromString("cubehelix(50%,0.2,10%)")),null,{ fileName : "TestCubeHelix.hx", lineNumber : 28, className : "thx.color.TestCubeHelix", methodName : "testFromString"});
		}
	}
	,testNearEquals: function() {
		var _g1 = 0;
		var _g = this.x;
		while(_g1 < _g) {
			++_g1;
			var c1 = [206.182,0.441,0.090,1.0];
			var c2 = [206.181,0.440,0.090,1.0];
			utest_Assert.isFalse(thx_color__$CubeHelix_CubeHelix_$Impl_$.equals(c1,c2),null,{ fileName : "TestCubeHelix.hx", lineNumber : 35, className : "thx.color.TestCubeHelix", methodName : "testNearEquals"});
			utest_Assert.isTrue(thx_color__$CubeHelix_CubeHelix_$Impl_$.nearEquals(c1,c2,0.01),null,{ fileName : "TestCubeHelix.hx", lineNumber : 36, className : "thx.color.TestCubeHelix", methodName : "testNearEquals"});
		}
	}
	,__class__: thx_color_TestCubeHelix
};
