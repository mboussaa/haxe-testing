...
TS11.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS11.hx", lineNumber : 16, className : "TS11", methodName : "addTests"});
	runner.addCase(new thx_color_TestHcl(Std.parseInt(w)));
};
TS11.main = function() {
...
var thx_color_TestHcl = function(i) {
	this.x = i;
};
thx_color_TestHcl.__name__ = ["thx","color","TestHcl"];
thx_color_TestHcl.prototype = {
	x: null
	,testParse: function() {
		var _g1 = 0;
		var _g = this.x;
		while(_g1 < _g) {
			++_g1;
			var hcl = thx_color__$LCh_LCh_$Impl_$.fromString("hcl(0.5,0,1)");
			utest_Assert.equals(0.5,hcl[2],null,{ fileName : "TestHcl.hx", lineNumber : 15, className : "thx.color.TestHcl", methodName : "testParse"});
			utest_Assert.equals(0,hcl[1],null,{ fileName : "TestHcl.hx", lineNumber : 16, className : "thx.color.TestHcl", methodName : "testParse"});
			utest_Assert.equals(1,hcl[0],null,{ fileName : "TestHcl.hx", lineNumber : 17, className : "thx.color.TestHcl", methodName : "testParse"});
		}
	}
	,testStrings: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("hcl(0,0.5,1)",thx_color__$LCh_LCh_$Impl_$.toHclString([1,0.5,0]),null,{ fileName : "TestHcl.hx", lineNumber : 23, className : "thx.color.TestHcl", methodName : "testStrings"});
		}
	}
	,__class__: thx_color_TestHcl
};
