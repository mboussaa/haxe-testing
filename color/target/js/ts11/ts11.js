...
TS11.addTests = function(runner) {
	runner.addCase(new thx_color_TestHcl());
};
TS11.main = function() {
...
var thx_color_TestHcl = function() {
};
...
thx_color_TestHcl.prototype = {
	testParse: function() {
		...
		utest_Assert.equals(0.5,hcl[2],null,{ fileName : "TestHcl.hx", lineNumber : 11, className : "thx.color.TestHcl", methodName : "testParse"});
		utest_Assert.equals(0,hcl[1],null,{ fileName : "TestHcl.hx", lineNumber : 12, className : "thx.color.TestHcl", methodName : "testParse"});
		utest_Assert.equals(1,hcl[0],null,{ fileName : "TestHcl.hx", lineNumber : 13, className : "thx.color.TestHcl", methodName : "testParse"});
	}
	,testStrings: function() {
		utest_Assert.equals("hcl(0,0.5,1)",thx_color__$LCh_LCh_$Impl_$.toHclString([1,0.5,0]),null,{ fileName : "TestHcl.hx", lineNumber : 18, className : "thx.color.TestHcl", methodName : "testStrings"});
	}
