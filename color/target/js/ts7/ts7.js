...
var thx_color_TestCmy = function(i) {
	this.x = i;
};
...
thx_color_TestCmy.prototype = {
	...
	,testBasics: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.equals(0.5,color[0],null,{ fileName : "TestCmy.hx", lineNumber : 14, className : "thx.color.TestCmy", methodName : "testBasics"});
			utest_Assert.equals(0.5,color[1],null,{ fileName : "TestCmy.hx", lineNumber : 15, className : "thx.color.TestCmy", methodName : "testBasics"});
			utest_Assert.equals(0.5,color[2],null,{ fileName : "TestCmy.hx", lineNumber : 16, className : "thx.color.TestCmy", methodName : "testBasics"});
			color = thx_color__$Cmy_Cmy_$Impl_$.normalize([2,-2,2]);
			utest_Assert.equals(1,color[0],null,{ fileName : "TestCmy.hx", lineNumber : 19, className : "thx.color.TestCmy", methodName : "testBasics"});
			utest_Assert.equals(0,color[1],null,{ fileName : "TestCmy.hx", lineNumber : 20, className : "thx.color.TestCmy", methodName : "testBasics"});
			utest_Assert.equals(1,color[2],null,{ fileName : "TestCmy.hx", lineNumber : 21, className : "thx.color.TestCmy", methodName : "testBasics"});
		}
	}
	,testString: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("cmy(0.5,0.5,0.5)",thx_color__$Cmy_Cmy_$Impl_$.toString([0.5,0.5,0.5]),null,{ fileName : "TestCmy.hx", lineNumber : 28, className : "thx.color.TestCmy", methodName : "testString"});
		}
	}
	,testParse: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("cmy(0.5,0.5,0.5)",thx_color__$Cmy_Cmy_$Impl_$.toString(thx_color__$Cmy_Cmy_$Impl_$.fromString("cmy(0.5,0.5,0.5)")),null,{ fileName : "TestCmy.hx", lineNumber : 34, className : "thx.color.TestCmy", methodName : "testParse"});
		}
	}
	,testFromFloat: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.isTrue(thx_color__$Cmy_Cmy_$Impl_$.equals(thx_color__$Cmy_Cmy_$Impl_$.fromString("cmy(0.5,0.5,0.5)"),thx_color__$Cmy_Cmy_$Impl_$.fromFloats([0.5,0.5,0.5])),null,{ fileName : "TestCmy.hx", lineNumber : 41, className : "thx.color.TestCmy", methodName : "testFromFloat"});
		}
	}
