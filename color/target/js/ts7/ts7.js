...
var TS7 = function() { };
TS7.__name__ = ["TS7"];
TS7.addTests = function(runner) {
	runner.addCase(new thx_color_TestCmy());
};
TS7.main = function() {
...
var thx_color_TestCmy = function() {
};
thx_color_TestCmy.__name__ = ["thx","color","TestCmy"];
thx_color_TestCmy.prototype = {
	testBasics: function() {
		var color = [0.5,0.5,0.5];
		utest_Assert.equals(0.5,color[0],null,{ fileName : "TestCmy.hx", lineNumber : 10, className : "thx.color.TestCmy", methodName : "testBasics"});
		utest_Assert.equals(0.5,color[1],null,{ fileName : "TestCmy.hx", lineNumber : 11, className : "thx.color.TestCmy", methodName : "testBasics"});
		utest_Assert.equals(0.5,color[2],null,{ fileName : "TestCmy.hx", lineNumber : 12, className : "thx.color.TestCmy", methodName : "testBasics"});
		color = thx_color__$Cmy_Cmy_$Impl_$.normalize([2,-2,2]);
		utest_Assert.equals(1,color[0],null,{ fileName : "TestCmy.hx", lineNumber : 15, className : "thx.color.TestCmy", methodName : "testBasics"});
		utest_Assert.equals(0,color[1],null,{ fileName : "TestCmy.hx", lineNumber : 16, className : "thx.color.TestCmy", methodName : "testBasics"});
		utest_Assert.equals(1,color[2],null,{ fileName : "TestCmy.hx", lineNumber : 17, className : "thx.color.TestCmy", methodName : "testBasics"});
	}
	,testString: function() {
		utest_Assert.equals("cmy(0.5,0.5,0.5)",thx_color__$Cmy_Cmy_$Impl_$.toString([0.5,0.5,0.5]),null,{ fileName : "TestCmy.hx", lineNumber : 22, className : "thx.color.TestCmy", methodName : "testString"});
	}
	,testParse: function() {
		utest_Assert.equals("cmy(0.5,0.5,0.5)",thx_color__$Cmy_Cmy_$Impl_$.toString(thx_color__$Cmy_Cmy_$Impl_$.fromString("cmy(0.5,0.5,0.5)")),null,{ fileName : "TestCmy.hx", lineNumber : 27, className : "thx.color.TestCmy", methodName : "testParse"});
	}
	,testFromFloat: function() {
		utest_Assert.isTrue(thx_color__$Cmy_Cmy_$Impl_$.equals(thx_color__$Cmy_Cmy_$Impl_$.fromString("cmy(0.5,0.5,0.5)"),thx_color__$Cmy_Cmy_$Impl_$.fromFloats([0.5,0.5,0.5])),null,{ fileName : "TestCmy.hx", lineNumber : 33, className : "thx.color.TestCmy", methodName : "testFromFloat"});
	}
	,__class__: thx_color_TestCmy
};
