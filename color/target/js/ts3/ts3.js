...
TS3.addTests = function(runner) {
	runner.addCase(new thx_color_TestLuv());
};
TS3.main = function() {
...
var thx_color_TestLuv = function() {
};
...
thx_color_TestLuv.prototype = {
	testBasics: function() {
		...
		utest_Assert.equals(0.5,color[0],null,{ fileName : "TestLuv.hx", lineNumber : 10, className : "thx.color.TestLuv", methodName : "testBasics"});
		utest_Assert.equals(0.4,color[1],null,{ fileName : "TestLuv.hx", lineNumber : 11, className : "thx.color.TestLuv", methodName : "testBasics"});
		utest_Assert.equals(0.6,color[2],null,{ fileName : "TestLuv.hx", lineNumber : 12, className : "thx.color.TestLuv", methodName : "testBasics"});
	}
	,testString: function() {
		utest_Assert.equals("cieluv(0.5,0.4,0.6)",thx_color__$Luv_Luv_$Impl_$.toString(thx_color__$Luv_Luv_$Impl_$.normalize([0.5,0.4,0.6])),null,{ fileName : "TestLuv.hx", lineNumber : 17, className : "thx.color.TestLuv", methodName : "testString"});
	}
	,testParse: function() {
		utest_Assert.equals("cieluv(0.5,0.4,0.6)",thx_color__$Luv_Luv_$Impl_$.toString(thx_color__$Luv_Luv_$Impl_$.fromString("cieluv(0.5,0.4,0.6)")),null,{ fileName : "TestLuv.hx", lineNumber : 22, className : "thx.color.TestLuv", methodName : "testParse"});
	}
	,testFromFloat: function() {
		utest_Assert.isTrue(thx_color__$Luv_Luv_$Impl_$.equals(thx_color__$Luv_Luv_$Impl_$.fromString("cieluv(0.5,0.4,0.6)"),thx_color__$Luv_Luv_$Impl_$.fromFloats([0.5,0.4,0.6])),null,{ fileName : "TestLuv.hx", lineNumber : 28, className : "thx.color.TestLuv", methodName : "testFromFloat"});
	}
	,testXyz: function() {
		var luv = [0.5,0.4,0.6];
		var xyz = thx_color__$Luv_Luv_$Impl_$.toXyz(luv);
		thx_color__$Xyz_Xyz_$Impl_$.toLuv(xyz);
		utest_Assert.isTrue(thx_color__$Luv_Luv_$Impl_$.nearEquals(luv,thx_color__$Xyz_Xyz_$Impl_$.toLuv(xyz)),null,{ fileName : "TestLuv.hx", lineNumber : 35, className : "thx.color.TestLuv", methodName : "testXyz"});
	}
