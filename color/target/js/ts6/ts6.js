...
TS6.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS6.hx", lineNumber : 18, className : "TS6", methodName : "addTests"});
	runner.addCase(new thx_color_TestConversion(Std.parseInt(w)));
};
TS6.main = function() {
...
var thx_color_TestConversion = function(i) {
	this.x = i;
};
thx_color_TestConversion.__name__ = ["thx","color","TestConversion"];
thx_color_TestConversion.prototype = {
	x: null
	,testLab: function() {
		var _g1 = 0;
		var _g = this.x;
		while(_g1 < _g) {
			++_g1;
			thx_Iterators.map(thx_color_palettes_Web.names.keys(),function(name) {
				var _this = thx_color_palettes_Web.names;
				var expected = __map_reserved[name] != null?_this.getReserved(name):_this.h[name];
				var test = thx_color__$Lab_Lab_$Impl_$.toRgb(thx_color__$Rgb_Rgb_$Impl_$.toLab(expected));
				utest_Assert.equals(thx_color__$Rgb_Rgb_$Impl_$.toString(expected),thx_color__$Rgb_Rgb_$Impl_$.toString(test),"expected " + thx_color__$Rgb_Rgb_$Impl_$.toString(expected) + " but was " + thx_color__$Rgb_Rgb_$Impl_$.toString(test) + " for " + name,{ fileName : "TestConversion.hx", lineNumber : 20, className : "thx.color.TestConversion", methodName : "testLab"});
			});
		}
	}
	,testLCh: function() {
		...
		while(_g1 < _g) {
			...
			thx_Iterators.map(thx_color_palettes_Web.names.keys(),function(name) {
				var _this = thx_color_palettes_Web.names;
				var expected = __map_reserved[name] != null?_this.getReserved(name):_this.h[name];
				var test = thx_color__$LCh_LCh_$Impl_$.toRgb(thx_color__$Rgb_Rgb_$Impl_$.toLCh(expected));
				utest_Assert.equals(thx_color__$Rgb_Rgb_$Impl_$.toString(expected),thx_color__$Rgb_Rgb_$Impl_$.toString(test),"expected " + thx_color__$Rgb_Rgb_$Impl_$.toString(expected) + " but was " + thx_color__$Rgb_Rgb_$Impl_$.toString(test) + " for " + name,{ fileName : "TestConversion.hx", lineNumber : 30, className : "thx.color.TestConversion", methodName : "testLCh"});
			});
		}
	}
	,testLuv: function() {
		...
		while(_g1 < _g) {
			...
			thx_Iterators.map(thx_color_palettes_Web.names.keys(),function(name) {
				var _this = thx_color_palettes_Web.names;
				var expected = __map_reserved[name] != null?_this.getReserved(name):_this.h[name];
				var test = thx_color__$Luv_Luv_$Impl_$.toRgb(thx_color__$Rgb_Rgb_$Impl_$.toLuv(expected));
				utest_Assert.equals(thx_color__$Rgb_Rgb_$Impl_$.toString(expected),thx_color__$Rgb_Rgb_$Impl_$.toString(test),"expected " + thx_color__$Rgb_Rgb_$Impl_$.toString(expected) + " but was " + thx_color__$Rgb_Rgb_$Impl_$.toString(test) + " for " + name,{ fileName : "TestConversion.hx", lineNumber : 40, className : "thx.color.TestConversion", methodName : "testLuv"});
			});
		}
	}
	,testCmy: function() {
		...
		while(_g1 < _g) {
			...
			thx_Iterators.map(thx_color_palettes_Web.names.keys(),function(name) {
				var _this = thx_color_palettes_Web.names;
				var expected = __map_reserved[name] != null?_this.getReserved(name):_this.h[name];
				var test = thx_color__$Cmy_Cmy_$Impl_$.toRgb(thx_color__$Rgb_Rgb_$Impl_$.toCmy(expected));
				utest_Assert.equals(thx_color__$Rgb_Rgb_$Impl_$.toString(expected),thx_color__$Rgb_Rgb_$Impl_$.toString(test),"expected " + thx_color__$Rgb_Rgb_$Impl_$.toString(expected) + " but was " + thx_color__$Rgb_Rgb_$Impl_$.toString(test) + " for " + name,{ fileName : "TestConversion.hx", lineNumber : 50, className : "thx.color.TestConversion", methodName : "testCmy"});
			});
		}
	}
	,testCmyk: function() {
		...
		while(_g1 < _g) {
			...
			thx_Iterators.map(thx_color_palettes_Web.names.keys(),function(name) {
				var _this = thx_color_palettes_Web.names;
				var expected = __map_reserved[name] != null?_this.getReserved(name):_this.h[name];
				var test = thx_color__$Cmyk_Cmyk_$Impl_$.toRgb(thx_color__$Rgb_Rgb_$Impl_$.toCmyk(expected));
				utest_Assert.equals(thx_color__$Rgb_Rgb_$Impl_$.toString(expected),thx_color__$Rgb_Rgb_$Impl_$.toString(test),"expected " + thx_color__$Rgb_Rgb_$Impl_$.toString(expected) + " but was " + thx_color__$Rgb_Rgb_$Impl_$.toString(test) + " for " + name,{ fileName : "TestConversion.hx", lineNumber : 60, className : "thx.color.TestConversion", methodName : "testCmyk"});
			});
		}
	}
	,testCubehelix: function() {
		var _g1 = 0;
		var _g = this.x;
		while(_g1 < _g) {
			++_g1;
			thx_Iterators.map(thx_color_palettes_Web.names.keys(),function(name) {
				var _this = thx_color_palettes_Web.names;
				var expected = __map_reserved[name] != null?_this.getReserved(name):_this.h[name];
				var test = thx_color__$CubeHelix_CubeHelix_$Impl_$.toRgb(thx_color__$Rgb_Rgb_$Impl_$.toCubeHelix(expected));
				utest_Assert.equals(thx_color__$Rgb_Rgb_$Impl_$.toString(expected),thx_color__$Rgb_Rgb_$Impl_$.toString(test),"expected " + thx_color__$Rgb_Rgb_$Impl_$.toString(expected) + " but was " + thx_color__$Rgb_Rgb_$Impl_$.toString(test) + " for " + name,{ fileName : "TestConversion.hx", lineNumber : 70, className : "thx.color.TestConversion", methodName : "testCubehelix"});
			});
		}
	}
	,testHsl: function() {
		...
		while(_g1 < _g) {
			...
			thx_Iterators.map(thx_color_palettes_Web.names.keys(),function(name) {
				var _this = thx_color_palettes_Web.names;
				var expected = __map_reserved[name] != null?_this.getReserved(name):_this.h[name];
				var test = thx_color__$Hsl_Hsl_$Impl_$.toRgb(thx_color__$Rgb_Rgb_$Impl_$.toHsl(expected));
				utest_Assert.equals(thx_color__$Rgb_Rgb_$Impl_$.toString(expected),thx_color__$Rgb_Rgb_$Impl_$.toString(test),"expected " + thx_color__$Rgb_Rgb_$Impl_$.toString(expected) + " but was " + thx_color__$Rgb_Rgb_$Impl_$.toString(test) + " for " + name,{ fileName : "TestConversion.hx", lineNumber : 80, className : "thx.color.TestConversion", methodName : "testHsl"});
			});
		}
	}
	,testHsv: function() {
		...
		while(_g1 < _g) {
			...
			thx_Iterators.map(thx_color_palettes_Web.names.keys(),function(name) {
				var _this = thx_color_palettes_Web.names;
				var expected = __map_reserved[name] != null?_this.getReserved(name):_this.h[name];
				var test = thx_color__$Hsv_Hsv_$Impl_$.toRgb(thx_color__$Rgb_Rgb_$Impl_$.toHsv(expected));
				utest_Assert.equals(thx_color__$Rgb_Rgb_$Impl_$.toString(expected),thx_color__$Rgb_Rgb_$Impl_$.toString(test),"expected " + thx_color__$Rgb_Rgb_$Impl_$.toString(expected) + " but was " + thx_color__$Rgb_Rgb_$Impl_$.toString(test) + " for " + name,{ fileName : "TestConversion.hx", lineNumber : 90, className : "thx.color.TestConversion", methodName : "testHsv"});
			});
		}
	}
	,testHunterLab: function() {
		var _g1 = 0;
		var _g = this.x;
		while(_g1 < _g) {
			++_g1;
			thx_Iterators.map(thx_color_palettes_Web.names.keys(),function(name) {
				var _this = thx_color_palettes_Web.names;
				var expected = __map_reserved[name] != null?_this.getReserved(name):_this.h[name];
				var test = thx_color__$HunterLab_HunterLab_$Impl_$.toRgb(thx_color__$Rgb_Rgb_$Impl_$.toHunterLab(expected));
				utest_Assert.equals(thx_color__$Rgb_Rgb_$Impl_$.toString(expected),thx_color__$Rgb_Rgb_$Impl_$.toString(test),"expected " + thx_color__$Rgb_Rgb_$Impl_$.toString(expected) + " but was " + thx_color__$Rgb_Rgb_$Impl_$.toString(test) + " for " + name,{ fileName : "TestConversion.hx", lineNumber : 100, className : "thx.color.TestConversion", methodName : "testHunterLab"});
			});
		}
	}
	,testRgbx: function() {
		...
		while(_g1 < _g) {
			...
			thx_Iterators.map(thx_color_palettes_Web.names.keys(),function(name) {
				var _this = thx_color_palettes_Web.names;
				var expected = __map_reserved[name] != null?_this.getReserved(name):_this.h[name];
				var test = thx_color__$Rgbx_Rgbx_$Impl_$.toRgb(thx_color__$Rgb_Rgb_$Impl_$.toRgbx(expected));
				utest_Assert.equals(thx_color__$Rgb_Rgb_$Impl_$.toString(expected),thx_color__$Rgb_Rgb_$Impl_$.toString(test),"expected " + thx_color__$Rgb_Rgb_$Impl_$.toString(expected) + " but was " + thx_color__$Rgb_Rgb_$Impl_$.toString(test) + " for " + name,{ fileName : "TestConversion.hx", lineNumber : 110, className : "thx.color.TestConversion", methodName : "testRgbx"});
			});
		}
	}
	,testXyz: function() {
		...
		while(_g1 < _g) {
			...
			thx_Iterators.map(thx_color_palettes_Web.names.keys(),function(name) {
				var _this = thx_color_palettes_Web.names;
				var expected = __map_reserved[name] != null?_this.getReserved(name):_this.h[name];
				var test = thx_color__$Xyz_Xyz_$Impl_$.toRgb(thx_color__$Rgb_Rgb_$Impl_$.toXyz(expected));
				utest_Assert.equals(thx_color__$Rgb_Rgb_$Impl_$.toString(expected),thx_color__$Rgb_Rgb_$Impl_$.toString(test),"expected " + thx_color__$Rgb_Rgb_$Impl_$.toString(expected) + " but was " + thx_color__$Rgb_Rgb_$Impl_$.toString(test) + " for " + name,{ fileName : "TestConversion.hx", lineNumber : 120, className : "thx.color.TestConversion", methodName : "testXyz"});
			});
		}
	}
	,testYuv: function() {
		...
		while(_g1 < _g) {
			...
			thx_Iterators.map(thx_color_palettes_Web.names.keys(),function(name) {
				var _this = thx_color_palettes_Web.names;
				var expected = __map_reserved[name] != null?_this.getReserved(name):_this.h[name];
				var test = thx_color__$Yuv_Yuv_$Impl_$.toRgb(thx_color__$Rgb_Rgb_$Impl_$.toYuv(expected));
				utest_Assert.equals(thx_color__$Rgb_Rgb_$Impl_$.toString(expected),thx_color__$Rgb_Rgb_$Impl_$.toString(test),"expected " + thx_color__$Rgb_Rgb_$Impl_$.toString(expected) + " but was " + thx_color__$Rgb_Rgb_$Impl_$.toString(test) + " for " + name,{ fileName : "TestConversion.hx", lineNumber : 130, className : "thx.color.TestConversion", methodName : "testYuv"});
			});
		}
	}
	,testYxy: function() {
		...
		while(_g1 < _g) {
			...
			thx_Iterators.map(thx_color_palettes_Web.names.keys(),function(name) {
				var _this = thx_color_palettes_Web.names;
				var expected = __map_reserved[name] != null?_this.getReserved(name):_this.h[name];
				var test = thx_color__$Yxy_Yxy_$Impl_$.toRgb(thx_color__$Rgb_Rgb_$Impl_$.toYxy(expected));
				utest_Assert.equals(thx_color__$Rgb_Rgb_$Impl_$.toString(expected),thx_color__$Rgb_Rgb_$Impl_$.toString(test),"expected " + thx_color__$Rgb_Rgb_$Impl_$.toString(expected) + " but was " + thx_color__$Rgb_Rgb_$Impl_$.toString(test) + " for " + name,{ fileName : "TestConversion.hx", lineNumber : 140, className : "thx.color.TestConversion", methodName : "testYxy"});
			});
		}
	}
	,__class__: thx_color_TestConversion
};
