...
TS6.addTests = function(runner) {
	runner.addCase(new thx_color_TestConversion());
};
TS6.main = function() {
...
var thx_color_TestConversion = function() {
};
...
thx_color_TestConversion.prototype = {
	testLab: function() {
		thx_Iterators.map(thx_color_palettes_Web.names.keys(),function(name) {
			...
			utest_Assert.equals(thx_color__$Rgb_Rgb_$Impl_$.toString(expected),thx_color__$Rgb_Rgb_$Impl_$.toString(test),"expected " + thx_color__$Rgb_Rgb_$Impl_$.toString(expected) + " but was " + thx_color__$Rgb_Rgb_$Impl_$.toString(test) + " for " + name,{ fileName : "TestConversion.hx", lineNumber : 16, className : "thx.color.TestConversion", methodName : "testLab"});
		});
	}
	,testLCh: function() {
		thx_Iterators.map(thx_color_palettes_Web.names.keys(),function(name) {
			...
			utest_Assert.equals(thx_color__$Rgb_Rgb_$Impl_$.toString(expected),thx_color__$Rgb_Rgb_$Impl_$.toString(test),"expected " + thx_color__$Rgb_Rgb_$Impl_$.toString(expected) + " but was " + thx_color__$Rgb_Rgb_$Impl_$.toString(test) + " for " + name,{ fileName : "TestConversion.hx", lineNumber : 25, className : "thx.color.TestConversion", methodName : "testLCh"});
		});
	}
	,testLuv: function() {
		thx_Iterators.map(thx_color_palettes_Web.names.keys(),function(name) {
			...
			utest_Assert.equals(thx_color__$Rgb_Rgb_$Impl_$.toString(expected),thx_color__$Rgb_Rgb_$Impl_$.toString(test),"expected " + thx_color__$Rgb_Rgb_$Impl_$.toString(expected) + " but was " + thx_color__$Rgb_Rgb_$Impl_$.toString(test) + " for " + name,{ fileName : "TestConversion.hx", lineNumber : 34, className : "thx.color.TestConversion", methodName : "testLuv"});
		});
	}
	,testCmy: function() {
		thx_Iterators.map(thx_color_palettes_Web.names.keys(),function(name) {
			...
			utest_Assert.equals(thx_color__$Rgb_Rgb_$Impl_$.toString(expected),thx_color__$Rgb_Rgb_$Impl_$.toString(test),"expected " + thx_color__$Rgb_Rgb_$Impl_$.toString(expected) + " but was " + thx_color__$Rgb_Rgb_$Impl_$.toString(test) + " for " + name,{ fileName : "TestConversion.hx", lineNumber : 43, className : "thx.color.TestConversion", methodName : "testCmy"});
		});
	}
	,testCmyk: function() {
		thx_Iterators.map(thx_color_palettes_Web.names.keys(),function(name) {
			...
			utest_Assert.equals(thx_color__$Rgb_Rgb_$Impl_$.toString(expected),thx_color__$Rgb_Rgb_$Impl_$.toString(test),"expected " + thx_color__$Rgb_Rgb_$Impl_$.toString(expected) + " but was " + thx_color__$Rgb_Rgb_$Impl_$.toString(test) + " for " + name,{ fileName : "TestConversion.hx", lineNumber : 52, className : "thx.color.TestConversion", methodName : "testCmyk"});
		});
	}
	,testCubehelix: function() {
		thx_Iterators.map(thx_color_palettes_Web.names.keys(),function(name) {
			...
			utest_Assert.equals(thx_color__$Rgb_Rgb_$Impl_$.toString(expected),thx_color__$Rgb_Rgb_$Impl_$.toString(test),"expected " + thx_color__$Rgb_Rgb_$Impl_$.toString(expected) + " but was " + thx_color__$Rgb_Rgb_$Impl_$.toString(test) + " for " + name,{ fileName : "TestConversion.hx", lineNumber : 61, className : "thx.color.TestConversion", methodName : "testCubehelix"});
		});
	}
	,testHsl: function() {
		thx_Iterators.map(thx_color_palettes_Web.names.keys(),function(name) {
	...
	,testHsv: function() {
		thx_Iterators.map(thx_color_palettes_Web.names.keys(),function(name) {
			...
			utest_Assert.equals(thx_color__$Rgb_Rgb_$Impl_$.toString(expected),thx_color__$Rgb_Rgb_$Impl_$.toString(test),"expected " + thx_color__$Rgb_Rgb_$Impl_$.toString(expected) + " but was " + thx_color__$Rgb_Rgb_$Impl_$.toString(test) + " for " + name,{ fileName : "TestConversion.hx", lineNumber : 79, className : "thx.color.TestConversion", methodName : "testHsv"});
		});
	}
	,testHunterLab: function() {
		thx_Iterators.map(thx_color_palettes_Web.names.keys(),function(name) {
			...
			utest_Assert.equals(thx_color__$Rgb_Rgb_$Impl_$.toString(expected),thx_color__$Rgb_Rgb_$Impl_$.toString(test),"expected " + thx_color__$Rgb_Rgb_$Impl_$.toString(expected) + " but was " + thx_color__$Rgb_Rgb_$Impl_$.toString(test) + " for " + name,{ fileName : "TestConversion.hx", lineNumber : 88, className : "thx.color.TestConversion", methodName : "testHunterLab"});
		});
	}
	,testRgbx: function() {
		thx_Iterators.map(thx_color_palettes_Web.names.keys(),function(name) {
			...
			utest_Assert.equals(thx_color__$Rgb_Rgb_$Impl_$.toString(expected),thx_color__$Rgb_Rgb_$Impl_$.toString(test),"expected " + thx_color__$Rgb_Rgb_$Impl_$.toString(expected) + " but was " + thx_color__$Rgb_Rgb_$Impl_$.toString(test) + " for " + name,{ fileName : "TestConversion.hx", lineNumber : 97, className : "thx.color.TestConversion", methodName : "testRgbx"});
		});
	}
	,testXyz: function() {
		thx_Iterators.map(thx_color_palettes_Web.names.keys(),function(name) {
			...
			utest_Assert.equals(thx_color__$Rgb_Rgb_$Impl_$.toString(expected),thx_color__$Rgb_Rgb_$Impl_$.toString(test),"expected " + thx_color__$Rgb_Rgb_$Impl_$.toString(expected) + " but was " + thx_color__$Rgb_Rgb_$Impl_$.toString(test) + " for " + name,{ fileName : "TestConversion.hx", lineNumber : 106, className : "thx.color.TestConversion", methodName : "testXyz"});
		});
	}
	,testYuv: function() {
		thx_Iterators.map(thx_color_palettes_Web.names.keys(),function(name) {
			...
			utest_Assert.equals(thx_color__$Rgb_Rgb_$Impl_$.toString(expected),thx_color__$Rgb_Rgb_$Impl_$.toString(test),"expected " + thx_color__$Rgb_Rgb_$Impl_$.toString(expected) + " but was " + thx_color__$Rgb_Rgb_$Impl_$.toString(test) + " for " + name,{ fileName : "TestConversion.hx", lineNumber : 115, className : "thx.color.TestConversion", methodName : "testYuv"});
		});
	}
	,testYxy: function() {
		thx_Iterators.map(thx_color_palettes_Web.names.keys(),function(name) {
			...
			utest_Assert.equals(thx_color__$Rgb_Rgb_$Impl_$.toString(expected),thx_color__$Rgb_Rgb_$Impl_$.toString(test),"expected " + thx_color__$Rgb_Rgb_$Impl_$.toString(expected) + " but was " + thx_color__$Rgb_Rgb_$Impl_$.toString(test) + " for " + name,{ fileName : "TestConversion.hx", lineNumber : 124, className : "thx.color.TestConversion", methodName : "testYxy"});
		});
	}
