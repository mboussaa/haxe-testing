...
TS10.addTests = function(runner) {
	runner.addCase(new thx_color_TestGrey());
};
TS10.main = function() {
...
var thx_color_TestGrey = function() {
};
thx_color_TestGrey.__name__ = ["thx","color","TestGrey"];
thx_color_TestGrey.prototype = {
	testBasics: function() {
		utest_Assert.equals(0.2,0.2,null,{ fileName : "TestGrey.hx", lineNumber : 10, className : "thx.color.TestGrey", methodName : "testBasics"});
	}
	,testStrings: function() {
		utest_Assert.equals("grey(50%)",thx_color__$Grey_Grey_$Impl_$.toString(0.5),null,{ fileName : "TestGrey.hx", lineNumber : 15, className : "thx.color.TestGrey", methodName : "testStrings"});
	}
	,testFromString: function() {
		utest_Assert.isTrue(thx_color__$Grey_Grey_$Impl_$.equals(0.2,thx_color__$Grey_Grey_$Impl_$.fromString("grey(20%)")),null,{ fileName : "TestGrey.hx", lineNumber : 19, className : "thx.color.TestGrey", methodName : "testFromString"});
	}
