...
TS10.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS10.hx", lineNumber : 17, className : "TS10", methodName : "addTests"});
	runner.addCase(new thx_color_TestGrey(Std.parseInt(w)));
};
TS10.main = function() {
...
var thx_color_TestGrey = function(i) {
	this.x = i;
};
thx_color_TestGrey.__name__ = ["thx","color","TestGrey"];
thx_color_TestGrey.prototype = {
	x: null
	,testBasics: function() {
		var _g1 = 0;
		var _g = this.x;
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals(0.2,0.2,null,{ fileName : "TestGrey.hx", lineNumber : 14, className : "thx.color.TestGrey", methodName : "testBasics"});
		}
	}
	,testStrings: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("grey(50%)",thx_color__$Grey_Grey_$Impl_$.toString(0.5),null,{ fileName : "TestGrey.hx", lineNumber : 20, className : "thx.color.TestGrey", methodName : "testStrings"});
		}
	}
	,testFromString: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.isTrue(thx_color__$Grey_Grey_$Impl_$.equals(0.2,thx_color__$Grey_Grey_$Impl_$.fromString("grey(20%)")),null,{ fileName : "TestGrey.hx", lineNumber : 25, className : "thx.color.TestGrey", methodName : "testFromString"});
		}
	}
	,__class__: thx_color_TestGrey
};
