...
TS4.addTests = function(runner) {
	...
	runner.addCase(new thx_color_TestColor(Std.parseInt(w)));
};
TS4.main = function() {
...
var thx_color_TestColor = function(i) {
	this.x = i;
};
...
thx_color_TestColor.prototype = {
	...
	,testParseHex: function() {
		...
		while(_g1 < _g) {
			...
			this.assertEquals(thx_color__$Rgb_Rgb_$Impl_$.toRgbxa(thx_color_palettes_Web.red),thx_color_Color.parse("#FF0000"),{ fileName : "TestColor.hx", lineNumber : 17, className : "thx.color.TestColor", methodName : "testParseHex"});
			this.assertEquals(thx_color__$Rgba_Rgba_$Impl_$.toRgbxa(thx_color__$Rgb_Rgb_$Impl_$.withAlpha(thx_color_palettes_Web.red,0)),thx_color_Color.parse("#00FF0000"),{ fileName : "TestColor.hx", lineNumber : 18, className : "thx.color.TestColor", methodName : "testParseHex"});
			this.assertEquals(thx_color__$Rgb_Rgb_$Impl_$.toRgbxa(thx_color_palettes_Web.red),thx_color_Color.parse("ff0000"),{ fileName : "TestColor.hx", lineNumber : 19, className : "thx.color.TestColor", methodName : "testParseHex"});
			this.assertEquals(thx_color__$Rgba_Rgba_$Impl_$.toRgbxa(thx_color__$Rgb_Rgb_$Impl_$.withAlpha(thx_color_palettes_Web.red,0)),thx_color_Color.parse("00ff0000"),{ fileName : "TestColor.hx", lineNumber : 20, className : "thx.color.TestColor", methodName : "testParseHex"});
			this.assertEquals(thx_color__$Rgb_Rgb_$Impl_$.toRgbxa(thx_color_palettes_Web.red),thx_color_Color.parse("0xff0000"),{ fileName : "TestColor.hx", lineNumber : 21, className : "thx.color.TestColor", methodName : "testParseHex"});
			this.assertEquals(thx_color__$Rgba_Rgba_$Impl_$.toRgbxa(thx_color__$Rgb_Rgb_$Impl_$.withAlpha(thx_color_palettes_Web.red,0)),thx_color_Color.parse("0x00ff0000"),{ fileName : "TestColor.hx", lineNumber : 22, className : "thx.color.TestColor", methodName : "testParseHex"});
		}
	}
	,testParseGrey: function() {
		...
		while(_g1 < _g) {
			++_g1;
			this.assertEquals(thx_color__$Grey_Grey_$Impl_$.toRgbxa(0.5),thx_color_Color.parse("grey(0.5)"),{ fileName : "TestColor.hx", lineNumber : 27, className : "thx.color.TestColor", methodName : "testParseGrey"});
			this.assertEquals(thx_color__$Grey_Grey_$Impl_$.toRgbxa(0.5),thx_color_Color.parse("grey(50%)"),{ fileName : "TestColor.hx", lineNumber : 28, className : "thx.color.TestColor", methodName : "testParseGrey"});
		}
	}
	,testParseCmyk: function() {
		...
		while(_g1 < _g) {
			++_g1;
			this.assertEquals(thx_color__$Cmyk_Cmyk_$Impl_$.toRgbxa([1,0.5,0.25,0.1]),thx_color_Color.parse("cmyk(100%,0.5,25%,0.1)"),{ fileName : "TestColor.hx", lineNumber : 33, className : "thx.color.TestColor", methodName : "testParseCmyk"});
		}
	}
	,testParseHsl: function() {
		...
		while(_g1 < _g) {
			++_g1;
			this.assertEquals(thx_color__$Rgb_Rgb_$Impl_$.toRgbxa(thx_color_palettes_Web.red),thx_color_Color.parse("hsl(0,100%,50%)"),{ fileName : "TestColor.hx", lineNumber : 38, className : "thx.color.TestColor", methodName : "testParseHsl"});
			this.assertEquals(thx_color__$Rgb_Rgb_$Impl_$.toRgbxa(thx_color_palettes_Web.red),thx_color_Color.parse("hsl(0deg,100%,50%)"),{ fileName : "TestColor.hx", lineNumber : 39, className : "thx.color.TestColor", methodName : "testParseHsl"});
			this.assertEquals(thx_color__$Rgb_Rgb_$Impl_$.toRgbxa(thx_color_palettes_Web.red),thx_color_Color.parse("hsla(0deg,100%,50%,1)"),{ fileName : "TestColor.hx", lineNumber : 40, className : "thx.color.TestColor", methodName : "testParseHsl"});
			this.assertEquals(thx_color__$Rgb_Rgb_$Impl_$.toRgbxa(thx_color_palettes_Web.red),thx_color_Color.parse("hsla(0,100%,50%,100%)"),{ fileName : "TestColor.hx", lineNumber : 41, className : "thx.color.TestColor", methodName : "testParseHsl"});
		}
	}
	,testParseHsv: function() {
		...
		while(_g1 < _g) {
			++_g1;
			this.assertEquals(thx_color__$Rgb_Rgb_$Impl_$.toRgbxa(thx_color_palettes_Web.red),thx_color_Color.parse("hsv(0,100%, 100%)"),{ fileName : "TestColor.hx", lineNumber : 46, className : "thx.color.TestColor", methodName : "testParseHsv"});
			this.assertEquals(thx_color__$Rgb_Rgb_$Impl_$.toRgbxa(thx_color_palettes_Web.red),thx_color_Color.parse("hsv(0deg,100%,100%)"),{ fileName : "TestColor.hx", lineNumber : 47, className : "thx.color.TestColor", methodName : "testParseHsv"});
		}
	}
	,testParseRgb: function() {
		...
		while(_g1 < _g) {
			++_g1;
			this.assertEquals(thx_color__$Rgb_Rgb_$Impl_$.toRgbxa(thx_color_palettes_Web.red),thx_color_Color.parse("rgb(255,0,0)"),{ fileName : "TestColor.hx", lineNumber : 52, className : "thx.color.TestColor", methodName : "testParseRgb"});
			this.assertEquals(thx_color__$Rgb_Rgb_$Impl_$.toRgbxa(thx_color_palettes_Web.red),thx_color_Color.parse("rgb(100%,0,0)"),{ fileName : "TestColor.hx", lineNumber : 53, className : "thx.color.TestColor", methodName : "testParseRgb"});
			this.assertEquals(thx_color__$Rgbx_Rgbx_$Impl_$.toRgbxa([0.5,0,0]),thx_color_Color.parse("rgb(0.5,0,0)"),{ fileName : "TestColor.hx", lineNumber : 54, className : "thx.color.TestColor", methodName : "testParseRgb"});
			this.assertEquals(thx_color__$Rgba_Rgba_$Impl_$.toRgbxa(16711935),thx_color_Color.parse("rgba(0,255,0,1)"),{ fileName : "TestColor.hx", lineNumber : 55, className : "thx.color.TestColor", methodName : "testParseRgb"});
			this.assertEquals(thx_color__$Rgba_Rgba_$Impl_$.toRgbxa(16711935),thx_color_Color.parse("rgba(0,100%,0,1)"),{ fileName : "TestColor.hx", lineNumber : 56, className : "thx.color.TestColor", methodName : "testParseRgb"});
		}
	}
