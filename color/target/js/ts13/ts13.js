...
TS13.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS13.hx", lineNumber : 17, className : "TS13", methodName : "addTests"});
	runner.addCase(new thx_color_TestHsv(Std.parseInt(w)));
};
TS13.main = function() {
...
var thx_color_TestHsv = function(i) {
	this.x = i;
};
...
thx_color_TestHsv.prototype = {
	...
	,testBasics: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var hsv = [1,0,0];
			utest_Assert.equals(1,hsv[0],null,{ fileName : "TestHsv.hx", lineNumber : 15, className : "thx.color.TestHsv", methodName : "testBasics"});
			utest_Assert.equals(0,hsv[1],null,{ fileName : "TestHsv.hx", lineNumber : 16, className : "thx.color.TestHsv", methodName : "testBasics"});
			utest_Assert.equals(0,hsv[2],null,{ fileName : "TestHsv.hx", lineNumber : 17, className : "thx.color.TestHsv", methodName : "testBasics"});
		}
	}
	,testHsb: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			++_g1;
			var hsb = [1,0,0];
			utest_Assert.equals(1,hsb[0],null,{ fileName : "TestHsv.hx", lineNumber : 23, className : "thx.color.TestHsv", methodName : "testHsb"});
			utest_Assert.equals(0,hsb[1],null,{ fileName : "TestHsv.hx", lineNumber : 24, className : "thx.color.TestHsv", methodName : "testHsb"});
			utest_Assert.equals(0,hsb[2],null,{ fileName : "TestHsv.hx", lineNumber : 25, className : "thx.color.TestHsv", methodName : "testHsb"});
		}
	}
	,testStrings: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("hsv(0,0%,100%)",thx_color__$Hsv_Hsv_$Impl_$.toString([0,0,1]),null,{ fileName : "TestHsv.hx", lineNumber : 31, className : "thx.color.TestHsv", methodName : "testStrings"});
		}
	}
	,testFromString: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.isTrue(thx_color__$Hsv_Hsv_$Impl_$.equals([0.5,0.2,0.1],thx_color__$Hsv_Hsv_$Impl_$.fromString("hsv(50%,0.2,10%)")),null,{ fileName : "TestHsv.hx", lineNumber : 36, className : "thx.color.TestHsv", methodName : "testFromString"});
			utest_Assert.isTrue(thx_color__$Hsva_Hsva_$Impl_$.equals([0.5,0.2,0.1,0.3],thx_color__$Hsva_Hsva_$Impl_$.fromString("hsva(50%,0.2,10%,0.3)")),null,{ fileName : "TestHsv.hx", lineNumber : 37, className : "thx.color.TestHsv", methodName : "testFromString"});
		}
	}
