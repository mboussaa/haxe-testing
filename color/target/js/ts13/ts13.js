...
var TS13 = function() { };
TS13.__name__ = ["TS13"];
TS13.addTests = function(runner) {
	runner.addCase(new thx_color_TestHsv());
	runner.addCase(new thx_color_TestRgb());
	runner.addCase(new thx_color_TestRgbx());
	runner.addCase(new thx_color_TestTemperature());
	runner.addCase(new thx_color_TestXyz());
	runner.addCase(new thx_color_TestYxy());
	runner.addCase(new thx_color_TestRoundTrip());
};
TS13.main = function() {
...
var thx_color_TestHsv = function() {
};
thx_color_TestHsv.__name__ = ["thx","color","TestHsv"];
thx_color_TestHsv.prototype = {
	testBasics: function() {
		var hsv = [1,0,0];
		utest_Assert.equals(1,hsv[0],null,{ fileName : "TestHsv.hx", lineNumber : 11, className : "thx.color.TestHsv", methodName : "testBasics"});
		utest_Assert.equals(0,hsv[1],null,{ fileName : "TestHsv.hx", lineNumber : 12, className : "thx.color.TestHsv", methodName : "testBasics"});
		utest_Assert.equals(0,hsv[2],null,{ fileName : "TestHsv.hx", lineNumber : 13, className : "thx.color.TestHsv", methodName : "testBasics"});
	}
	,testHsb: function() {
		var hsb = [1,0,0];
		utest_Assert.equals(1,hsb[0],null,{ fileName : "TestHsv.hx", lineNumber : 18, className : "thx.color.TestHsv", methodName : "testHsb"});
		utest_Assert.equals(0,hsb[1],null,{ fileName : "TestHsv.hx", lineNumber : 19, className : "thx.color.TestHsv", methodName : "testHsb"});
		utest_Assert.equals(0,hsb[2],null,{ fileName : "TestHsv.hx", lineNumber : 20, className : "thx.color.TestHsv", methodName : "testHsb"});
	}
	,testStrings: function() {
		utest_Assert.equals("hsv(0,0%,100%)",thx_color__$Hsv_Hsv_$Impl_$.toString([0,0,1]),null,{ fileName : "TestHsv.hx", lineNumber : 25, className : "thx.color.TestHsv", methodName : "testStrings"});
	}
	,testFromString: function() {
		utest_Assert.isTrue(thx_color__$Hsv_Hsv_$Impl_$.equals([0.5,0.2,0.1],thx_color__$Hsv_Hsv_$Impl_$.fromString("hsv(50%,0.2,10%)")),null,{ fileName : "TestHsv.hx", lineNumber : 29, className : "thx.color.TestHsv", methodName : "testFromString"});
		utest_Assert.isTrue(thx_color__$Hsva_Hsva_$Impl_$.equals([0.5,0.2,0.1,0.3],thx_color__$Hsva_Hsva_$Impl_$.fromString("hsva(50%,0.2,10%,0.3)")),null,{ fileName : "TestHsv.hx", lineNumber : 30, className : "thx.color.TestHsv", methodName : "testFromString"});
	}
	,__class__: thx_color_TestHsv
};
var thx_color_TestRgb = function() {
};
thx_color_TestRgb.__name__ = ["thx","color","TestRgb"];
thx_color_TestRgb.prototype = {
	testBasics: function() {
		var red = 16711680;
		utest_Assert.equals(255,thx_color__$Rgb_Rgb_$Impl_$.get_red(red),null,{ fileName : "TestRgb.hx", lineNumber : 11, className : "thx.color.TestRgb", methodName : "testBasics"});
		utest_Assert.equals(0,thx_color__$Rgb_Rgb_$Impl_$.get_green(red),null,{ fileName : "TestRgb.hx", lineNumber : 12, className : "thx.color.TestRgb", methodName : "testBasics"});
		utest_Assert.equals(0,thx_color__$Rgb_Rgb_$Impl_$.get_blue(red),null,{ fileName : "TestRgb.hx", lineNumber : 13, className : "thx.color.TestRgb", methodName : "testBasics"});
		var green = 65280;
		utest_Assert.equals(0,thx_color__$Rgb_Rgb_$Impl_$.get_red(green),null,{ fileName : "TestRgb.hx", lineNumber : 16, className : "thx.color.TestRgb", methodName : "testBasics"});
		utest_Assert.equals(255,thx_color__$Rgb_Rgb_$Impl_$.get_green(green),null,{ fileName : "TestRgb.hx", lineNumber : 17, className : "thx.color.TestRgb", methodName : "testBasics"});
		utest_Assert.equals(0,thx_color__$Rgb_Rgb_$Impl_$.get_blue(green),null,{ fileName : "TestRgb.hx", lineNumber : 18, className : "thx.color.TestRgb", methodName : "testBasics"});
		var blue = 255;
		utest_Assert.equals(0,thx_color__$Rgb_Rgb_$Impl_$.get_red(blue),null,{ fileName : "TestRgb.hx", lineNumber : 21, className : "thx.color.TestRgb", methodName : "testBasics"});
		utest_Assert.equals(0,thx_color__$Rgb_Rgb_$Impl_$.get_green(blue),null,{ fileName : "TestRgb.hx", lineNumber : 22, className : "thx.color.TestRgb", methodName : "testBasics"});
		utest_Assert.equals(255,thx_color__$Rgb_Rgb_$Impl_$.get_blue(blue),null,{ fileName : "TestRgb.hx", lineNumber : 23, className : "thx.color.TestRgb", methodName : "testBasics"});
		var cyan = 65535;
		utest_Assert.equals(0,thx_color__$Rgb_Rgb_$Impl_$.get_red(cyan),null,{ fileName : "TestRgb.hx", lineNumber : 26, className : "thx.color.TestRgb", methodName : "testBasics"});
		utest_Assert.equals(255,thx_color__$Rgb_Rgb_$Impl_$.get_green(cyan),null,{ fileName : "TestRgb.hx", lineNumber : 27, className : "thx.color.TestRgb", methodName : "testBasics"});
		utest_Assert.equals(255,thx_color__$Rgb_Rgb_$Impl_$.get_blue(cyan),null,{ fileName : "TestRgb.hx", lineNumber : 28, className : "thx.color.TestRgb", methodName : "testBasics"});
		var yellow = 16776960;
		utest_Assert.equals(255,thx_color__$Rgb_Rgb_$Impl_$.get_red(yellow),null,{ fileName : "TestRgb.hx", lineNumber : 31, className : "thx.color.TestRgb", methodName : "testBasics"});
		utest_Assert.equals(255,thx_color__$Rgb_Rgb_$Impl_$.get_green(yellow),null,{ fileName : "TestRgb.hx", lineNumber : 32, className : "thx.color.TestRgb", methodName : "testBasics"});
		utest_Assert.equals(0,thx_color__$Rgb_Rgb_$Impl_$.get_blue(yellow),null,{ fileName : "TestRgb.hx", lineNumber : 33, className : "thx.color.TestRgb", methodName : "testBasics"});
		var magenta = 16711935;
		utest_Assert.equals(255,thx_color__$Rgb_Rgb_$Impl_$.get_red(magenta),null,{ fileName : "TestRgb.hx", lineNumber : 36, className : "thx.color.TestRgb", methodName : "testBasics"});
		utest_Assert.equals(0,thx_color__$Rgb_Rgb_$Impl_$.get_green(magenta),null,{ fileName : "TestRgb.hx", lineNumber : 37, className : "thx.color.TestRgb", methodName : "testBasics"});
		utest_Assert.equals(255,thx_color__$Rgb_Rgb_$Impl_$.get_blue(magenta),null,{ fileName : "TestRgb.hx", lineNumber : 38, className : "thx.color.TestRgb", methodName : "testBasics"});
		var white = 16777215;
		utest_Assert.equals(255,thx_color__$Rgb_Rgb_$Impl_$.get_red(white),null,{ fileName : "TestRgb.hx", lineNumber : 41, className : "thx.color.TestRgb", methodName : "testBasics"});
		utest_Assert.equals(255,thx_color__$Rgb_Rgb_$Impl_$.get_green(white),null,{ fileName : "TestRgb.hx", lineNumber : 42, className : "thx.color.TestRgb", methodName : "testBasics"});
		utest_Assert.equals(255,thx_color__$Rgb_Rgb_$Impl_$.get_blue(white),null,{ fileName : "TestRgb.hx", lineNumber : 43, className : "thx.color.TestRgb", methodName : "testBasics"});
		var black = 0;
		utest_Assert.equals(0,thx_color__$Rgb_Rgb_$Impl_$.get_red(black),null,{ fileName : "TestRgb.hx", lineNumber : 46, className : "thx.color.TestRgb", methodName : "testBasics"});
		utest_Assert.equals(0,thx_color__$Rgb_Rgb_$Impl_$.get_green(black),null,{ fileName : "TestRgb.hx", lineNumber : 47, className : "thx.color.TestRgb", methodName : "testBasics"});
		utest_Assert.equals(0,thx_color__$Rgb_Rgb_$Impl_$.get_blue(black),null,{ fileName : "TestRgb.hx", lineNumber : 48, className : "thx.color.TestRgb", methodName : "testBasics"});
	}
	,testStrings: function() {
		var color = 43775;
		utest_Assert.equals("#00AAFF",thx_color__$Rgb_Rgb_$Impl_$.toHex(color),null,{ fileName : "TestRgb.hx", lineNumber : 53, className : "thx.color.TestRgb", methodName : "testStrings"});
		utest_Assert.equals("#00AAFF",thx_color__$Rgb_Rgb_$Impl_$.toString(color),null,{ fileName : "TestRgb.hx", lineNumber : 54, className : "thx.color.TestRgb", methodName : "testStrings"});
		utest_Assert.equals("rgb(0,170,255)",thx_color__$Rgb_Rgb_$Impl_$.toCss3(color),null,{ fileName : "TestRgb.hx", lineNumber : 55, className : "thx.color.TestRgb", methodName : "testStrings"});
	}
	,testFromString: function() {
		utest_Assert.isTrue(thx_color__$Rgb_Rgb_$Impl_$.equals(16711680,thx_color__$Rgb_Rgb_$Impl_$.fromString("#ff0000")),null,{ fileName : "TestRgb.hx", lineNumber : 59, className : "thx.color.TestRgb", methodName : "testFromString"});
		utest_Assert.isTrue(thx_color__$Rgb_Rgb_$Impl_$.equals(16711680,thx_color__$Rgb_Rgb_$Impl_$.fromString("#f00")),null,{ fileName : "TestRgb.hx", lineNumber : 60, className : "thx.color.TestRgb", methodName : "testFromString"});
		utest_Assert.isTrue(thx_color__$Rgb_Rgb_$Impl_$.equals(16711680,thx_color__$Rgb_Rgb_$Impl_$.fromString("rgb(255,0,0)")),null,{ fileName : "TestRgb.hx", lineNumber : 61, className : "thx.color.TestRgb", methodName : "testFromString"});
		utest_Assert.isTrue(thx_color__$Rgb_Rgb_$Impl_$.equals(16711680,thx_color__$Rgb_Rgb_$Impl_$.fromString("rgb(100%,0,0)")),null,{ fileName : "TestRgb.hx", lineNumber : 62, className : "thx.color.TestRgb", methodName : "testFromString"});
		utest_Assert.isTrue(thx_color__$Rgba_Rgba_$Impl_$.equals(16711935,thx_color__$Rgba_Rgba_$Impl_$.fromString("#ff00ff00")),null,{ fileName : "TestRgb.hx", lineNumber : 64, className : "thx.color.TestRgb", methodName : "testFromString"});
		utest_Assert.isTrue(thx_color__$Rgba_Rgba_$Impl_$.equals(16711935,thx_color__$Rgba_Rgba_$Impl_$.fromString("#f0f0")),null,{ fileName : "TestRgb.hx", lineNumber : 65, className : "thx.color.TestRgb", methodName : "testFromString"});
		utest_Assert.isTrue(thx_color__$Rgba_Rgba_$Impl_$.equals(16711935,thx_color__$Rgba_Rgba_$Impl_$.fromString("rgba(0,255,0,1)")),null,{ fileName : "TestRgb.hx", lineNumber : 66, className : "thx.color.TestRgb", methodName : "testFromString"});
		utest_Assert.isTrue(thx_color__$Rgba_Rgba_$Impl_$.equals(16711935,thx_color__$Rgba_Rgba_$Impl_$.fromString("rgba(0,100%,0,1)")),null,{ fileName : "TestRgb.hx", lineNumber : 67, className : "thx.color.TestRgb", methodName : "testFromString"});
	}
	,testCombineColor: function() {
		var combined = thx_color__$Rgba_Rgba_$Impl_$.combineColor(thx_color__$Rgb_Rgb_$Impl_$.withAlphaf(thx_color__$Rgb_Rgb_$Impl_$.fromInts([255,0,0]),.42),thx_color__$Rgb_Rgb_$Impl_$.fromInts([153,200,224]));
		var result = thx_color__$Rgb_Rgb_$Impl_$.fromInts([196,116,130]);
		utest_Assert.isTrue(thx_color__$Rgb_Rgb_$Impl_$.equals(result,combined),"expected " + thx_color__$Rgb_Rgb_$Impl_$.toString(result) + " but it is " + thx_color__$Rgb_Rgb_$Impl_$.toString(combined),{ fileName : "TestRgb.hx", lineNumber : 76, className : "thx.color.TestRgb", methodName : "testCombineColor"});
	}
	,__class__: thx_color_TestRgb
};
var thx_color_TestRgbx = function() {
};
thx_color_TestRgbx.__name__ = ["thx","color","TestRgbx"];
thx_color_TestRgbx.prototype = {
	testBasics: function() {
		var red = [1,0,0];
		utest_Assert.equals(255,thx_color__$Rgbx_Rgbx_$Impl_$.get_red(red),null,{ fileName : "TestRgbx.hx", lineNumber : 11, className : "thx.color.TestRgbx", methodName : "testBasics"});
		utest_Assert.equals(0,thx_color__$Rgbx_Rgbx_$Impl_$.get_green(red),null,{ fileName : "TestRgbx.hx", lineNumber : 12, className : "thx.color.TestRgbx", methodName : "testBasics"});
		utest_Assert.equals(0,thx_color__$Rgbx_Rgbx_$Impl_$.get_blue(red),null,{ fileName : "TestRgbx.hx", lineNumber : 13, className : "thx.color.TestRgbx", methodName : "testBasics"});
	}
	,testStrings: function() {
		var color = [0,0,1];
		utest_Assert.equals("rgb(0%,0%,100%)",thx_color__$Rgbx_Rgbx_$Impl_$.toCss3(color),null,{ fileName : "TestRgbx.hx", lineNumber : 18, className : "thx.color.TestRgbx", methodName : "testStrings"});
		utest_Assert.equals("#0000FF",thx_color__$Rgbx_Rgbx_$Impl_$.toHex(color),null,{ fileName : "TestRgbx.hx", lineNumber : 19, className : "thx.color.TestRgbx", methodName : "testStrings"});
		utest_Assert.equals("rgb(0%,0%,100%)",thx_color__$Rgbx_Rgbx_$Impl_$.toString(color),null,{ fileName : "TestRgbx.hx", lineNumber : 20, className : "thx.color.TestRgbx", methodName : "testStrings"});
	}
	,testFromString: function() {
		utest_Assert.isTrue(thx_color__$Rgbx_Rgbx_$Impl_$.equals([0,1,0],thx_color__$Rgbx_Rgbx_$Impl_$.fromString("#00ff00")),null,{ fileName : "TestRgbx.hx", lineNumber : 24, className : "thx.color.TestRgbx", methodName : "testFromString"});
		utest_Assert.isTrue(thx_color__$Rgbx_Rgbx_$Impl_$.equals([0,1,0],thx_color__$Rgbx_Rgbx_$Impl_$.fromString("#0f0")),null,{ fileName : "TestRgbx.hx", lineNumber : 25, className : "thx.color.TestRgbx", methodName : "testFromString"});
		utest_Assert.isTrue(thx_color__$Rgbx_Rgbx_$Impl_$.equals([0,1,0],thx_color__$Rgbx_Rgbx_$Impl_$.fromString("rgb(0,100%,0)")),null,{ fileName : "TestRgbx.hx", lineNumber : 26, className : "thx.color.TestRgbx", methodName : "testFromString"});
		utest_Assert.isTrue(thx_color__$Rgbx_Rgbx_$Impl_$.equals([0,1,0],thx_color__$Rgbx_Rgbx_$Impl_$.fromString("rgb(0,255,0)")),null,{ fileName : "TestRgbx.hx", lineNumber : 27, className : "thx.color.TestRgbx", methodName : "testFromString"});
		utest_Assert.isTrue(thx_color__$Rgbxa_Rgbxa_$Impl_$.equals([0,1,0,1],thx_color__$Rgbxa_Rgbxa_$Impl_$.fromString("#ff00ff00")),null,{ fileName : "TestRgbx.hx", lineNumber : 28, className : "thx.color.TestRgbx", methodName : "testFromString"});
		utest_Assert.isTrue(thx_color__$Rgbxa_Rgbxa_$Impl_$.equals([0,1,0,1],thx_color__$Rgbxa_Rgbxa_$Impl_$.fromString("#f0f0")),null,{ fileName : "TestRgbx.hx", lineNumber : 29, className : "thx.color.TestRgbx", methodName : "testFromString"});
		utest_Assert.isTrue(thx_color__$Rgbxa_Rgbxa_$Impl_$.equals([0,1,0,0.5],thx_color__$Rgbxa_Rgbxa_$Impl_$.fromString("rgba(0,255,0,50%)")),null,{ fileName : "TestRgbx.hx", lineNumber : 30, className : "thx.color.TestRgbx", methodName : "testFromString"});
		utest_Assert.isTrue(thx_color__$Rgbxa_Rgbxa_$Impl_$.equals([0,1,0,0.5],thx_color__$Rgbxa_Rgbxa_$Impl_$.fromString("rgba(0,100%,0,0.5)")),null,{ fileName : "TestRgbx.hx", lineNumber : 31, className : "thx.color.TestRgbx", methodName : "testFromString"});
	}
	,__class__: thx_color_TestRgbx
};
var thx_color_TestRoundTrip = function() {
	this.tests = [[0.05,0.10,0.15],[1,0,0],[0,1,0],[0.2,0.2,1],[0.9,0.9,1],[0.2,0.4,0.52]].map(function(_) {
		return { rgbx : _, rgb : thx_color__$Rgbx_Rgbx_$Impl_$.toRgb(_), lab : thx_color__$Rgbx_Rgbx_$Impl_$.toLab(_), lch : thx_color__$Rgbx_Rgbx_$Impl_$.toLCh(_), cmy : thx_color__$Rgbx_Rgbx_$Impl_$.toCmy(_), cmyk : thx_color__$Rgbx_Rgbx_$Impl_$.toCmyk(_), ch : thx_color__$Rgbx_Rgbx_$Impl_$.toCubeHelixWithGamma(_,1), g : thx_color__$Rgbx_Rgbx_$Impl_$.toGrey(_), hsl : thx_color__$Rgbx_Rgbx_$Impl_$.toHsl(_), hsv : thx_color__$Rgbx_Rgbx_$Impl_$.toHsv(_), hl : thx_color__$Rgbx_Rgbx_$Impl_$.toHunterLab(_), xyz : thx_color__$Rgbx_Rgbx_$Impl_$.toXyz(_), yuv : thx_color__$Rgbx_Rgbx_$Impl_$.toYuv(_), yxy : thx_color__$Rgbx_Rgbx_$Impl_$.toYxy(_)};
	});
};
thx_color_TestRoundTrip.__name__ = ["thx","color","TestRoundTrip"];
thx_color_TestRoundTrip.assertRgbx = function(e,t,s,pos) {
	utest_Assert.isTrue(thx_color__$Rgbx_Rgbx_$Impl_$.nearEquals(e,t,0.01),"\n      " + thx_color__$Rgbx_Rgbx_$Impl_$.toString(e) + " expected, but was\n      " + thx_color__$Rgbx_Rgbx_$Impl_$.toString(t) + " for\n      " + s,pos);
};
thx_color_TestRoundTrip.assertLab = function(e,t,s,pos) {
	utest_Assert.isTrue(thx_color__$Lab_Lab_$Impl_$.nearEquals(e,t,0.01),"\n      " + thx_color__$Lab_Lab_$Impl_$.toString(e) + " expected, but was\n      " + thx_color__$Lab_Lab_$Impl_$.toString(t) + " for\n      " + s,pos);
};
thx_color_TestRoundTrip.assertLCh = function(e,t,s,pos) {
	utest_Assert.isTrue(thx_color__$LCh_LCh_$Impl_$.nearEquals(e,t,0.01),"\n      " + thx_color__$LCh_LCh_$Impl_$.toString(e) + " expected, but was\n      " + thx_color__$LCh_LCh_$Impl_$.toString(t) + " for\n      " + s,pos);
};
thx_color_TestRoundTrip.assertCmy = function(e,t,s,pos) {
	utest_Assert.isTrue(thx_color__$Cmy_Cmy_$Impl_$.nearEquals(e,t,0.01),"\n      " + thx_color__$Cmy_Cmy_$Impl_$.toString(e) + " expected, but was\n      " + thx_color__$Cmy_Cmy_$Impl_$.toString(t) + " for\n      " + s,pos);
};
thx_color_TestRoundTrip.assertCmyk = function(e,t,s,pos) {
	utest_Assert.isTrue(thx_color__$Cmyk_Cmyk_$Impl_$.nearEquals(e,t,0.01),"\n      " + thx_color__$Cmyk_Cmyk_$Impl_$.toString(e) + " expected, but was\n      " + thx_color__$Cmyk_Cmyk_$Impl_$.toString(t) + " for\n      " + s,pos);
};
thx_color_TestRoundTrip.assertCubeHelix = function(e,t,s,pos) {
	utest_Assert.isTrue(thx_color__$CubeHelix_CubeHelix_$Impl_$.nearEquals(e,t,0.1),"\n      " + thx_color__$CubeHelix_CubeHelix_$Impl_$.toString(e) + " expected, but was\n      " + thx_color__$CubeHelix_CubeHelix_$Impl_$.toString(t) + " for\n      " + s,pos);
};
thx_color_TestRoundTrip.assertHsl = function(e,t,s,pos) {
	utest_Assert.isTrue(thx_color__$Hsl_Hsl_$Impl_$.nearEquals(e,t,0.1),"\n      " + thx_color__$Hsl_Hsl_$Impl_$.toString(e) + " expected, but was\n      " + thx_color__$Hsl_Hsl_$Impl_$.toString(t) + " for\n      " + s,pos);
};
thx_color_TestRoundTrip.assertHsv = function(e,t,s,pos) {
	utest_Assert.isTrue(thx_color__$Hsv_Hsv_$Impl_$.nearEquals(e,t,0.1),"\n      " + thx_color__$Hsv_Hsv_$Impl_$.toString(e) + " expected, but was\n      " + thx_color__$Hsv_Hsv_$Impl_$.toString(t) + " for\n      " + s,pos);
};
thx_color_TestRoundTrip.assertXyz = function(e,t,s,pos) {
	utest_Assert.isTrue(thx_color__$Xyz_Xyz_$Impl_$.nearEquals(e,t,0.01),"\n      " + thx_color__$Xyz_Xyz_$Impl_$.toString(e) + " expected, but was\n      " + thx_color__$Xyz_Xyz_$Impl_$.toString(t) + " for\n      " + s,pos);
};
thx_color_TestRoundTrip.assertYuv = function(e,t,s,pos) {
	utest_Assert.isTrue(thx_color__$Yuv_Yuv_$Impl_$.nearEquals(e,t,0.01),"\n      " + thx_color__$Yuv_Yuv_$Impl_$.toString(e) + " expected, but was\n      " + thx_color__$Yuv_Yuv_$Impl_$.toString(t) + " for\n      " + s,pos);
};
thx_color_TestRoundTrip.assertYxy = function(e,t,s,pos) {
	utest_Assert.isTrue(thx_color__$Yxy_Yxy_$Impl_$.nearEquals(e,t,0.01),"\n      " + thx_color__$Yxy_Yxy_$Impl_$.toString(e) + " expected, but was\n      " + thx_color__$Yxy_Yxy_$Impl_$.toString(t) + " for\n      " + s,pos);
};
thx_color_TestRoundTrip.prototype = {
	tests: null
	,testRgbxRoundtrip: function() {
		this.tests.map(function(_) {
			thx_color_TestRoundTrip.assertRgbx(_.rgbx,thx_color__$Lab_Lab_$Impl_$.toRgbx(_.lab),thx_color__$Lab_Lab_$Impl_$.toString(_.lab),{ fileName : "TestRoundTrip.hx", lineNumber : 59, className : "thx.color.TestRoundTrip", methodName : "testRgbxRoundtrip"});
			thx_color_TestRoundTrip.assertRgbx(_.rgbx,thx_color__$LCh_LCh_$Impl_$.toRgbx(_.lch),thx_color__$LCh_LCh_$Impl_$.toString(_.lch),{ fileName : "TestRoundTrip.hx", lineNumber : 60, className : "thx.color.TestRoundTrip", methodName : "testRgbxRoundtrip"});
			thx_color_TestRoundTrip.assertRgbx(_.rgbx,thx_color__$Cmy_Cmy_$Impl_$.toRgbx(_.cmy),thx_color__$Cmy_Cmy_$Impl_$.toString(_.cmy),{ fileName : "TestRoundTrip.hx", lineNumber : 61, className : "thx.color.TestRoundTrip", methodName : "testRgbxRoundtrip"});
			thx_color_TestRoundTrip.assertRgbx(_.rgbx,thx_color__$Cmyk_Cmyk_$Impl_$.toRgbx(_.cmyk),thx_color__$Cmyk_Cmyk_$Impl_$.toString(_.cmyk),{ fileName : "TestRoundTrip.hx", lineNumber : 62, className : "thx.color.TestRoundTrip", methodName : "testRgbxRoundtrip"});
			thx_color_TestRoundTrip.assertRgbx(_.rgbx,thx_color__$CubeHelix_CubeHelix_$Impl_$.toRgbx(_.ch),thx_color__$CubeHelix_CubeHelix_$Impl_$.toString(_.ch),{ fileName : "TestRoundTrip.hx", lineNumber : 63, className : "thx.color.TestRoundTrip", methodName : "testRgbxRoundtrip"});
			thx_color_TestRoundTrip.assertRgbx(_.rgbx,thx_color__$Hsl_Hsl_$Impl_$.toRgbx(_.hsl),thx_color__$Hsl_Hsl_$Impl_$.toString(_.hsl),{ fileName : "TestRoundTrip.hx", lineNumber : 64, className : "thx.color.TestRoundTrip", methodName : "testRgbxRoundtrip"});
			thx_color_TestRoundTrip.assertRgbx(_.rgbx,thx_color__$Hsv_Hsv_$Impl_$.toRgbx(_.hsv),thx_color__$Hsv_Hsv_$Impl_$.toString(_.hsv),{ fileName : "TestRoundTrip.hx", lineNumber : 65, className : "thx.color.TestRoundTrip", methodName : "testRgbxRoundtrip"});
			thx_color_TestRoundTrip.assertRgbx(_.rgbx,thx_color__$HunterLab_HunterLab_$Impl_$.toRgbx(_.hl),thx_color__$HunterLab_HunterLab_$Impl_$.toString(_.hl),{ fileName : "TestRoundTrip.hx", lineNumber : 66, className : "thx.color.TestRoundTrip", methodName : "testRgbxRoundtrip"});
			thx_color_TestRoundTrip.assertRgbx(_.rgbx,thx_color__$Xyz_Xyz_$Impl_$.toRgbx(_.xyz),thx_color__$Xyz_Xyz_$Impl_$.toString(_.xyz),{ fileName : "TestRoundTrip.hx", lineNumber : 67, className : "thx.color.TestRoundTrip", methodName : "testRgbxRoundtrip"});
			thx_color_TestRoundTrip.assertRgbx(_.rgbx,thx_color__$Yuv_Yuv_$Impl_$.toRgbx(_.yuv),thx_color__$Yuv_Yuv_$Impl_$.toString(_.yuv),{ fileName : "TestRoundTrip.hx", lineNumber : 68, className : "thx.color.TestRoundTrip", methodName : "testRgbxRoundtrip"});
			thx_color_TestRoundTrip.assertRgbx(_.rgbx,thx_color__$Yxy_Yxy_$Impl_$.toRgbx(_.yxy),thx_color__$Yxy_Yxy_$Impl_$.toString(_.yxy),{ fileName : "TestRoundTrip.hx", lineNumber : 69, className : "thx.color.TestRoundTrip", methodName : "testRgbxRoundtrip"});
			return;
		});
	}
	,testLabRoundtrip: function() {
		this.tests.map(function(_) {
			thx_color_TestRoundTrip.assertLab(_.lab,thx_color__$Rgbx_Rgbx_$Impl_$.toLab(_.rgbx),thx_color__$Rgbx_Rgbx_$Impl_$.toString(_.rgbx),{ fileName : "TestRoundTrip.hx", lineNumber : 76, className : "thx.color.TestRoundTrip", methodName : "testLabRoundtrip"});
			thx_color_TestRoundTrip.assertLab(_.lab,thx_color__$LCh_LCh_$Impl_$.toLab(_.lch),thx_color__$LCh_LCh_$Impl_$.toString(_.lch),{ fileName : "TestRoundTrip.hx", lineNumber : 77, className : "thx.color.TestRoundTrip", methodName : "testLabRoundtrip"});
			thx_color_TestRoundTrip.assertLab(_.lab,thx_color__$Cmy_Cmy_$Impl_$.toLab(_.cmy),thx_color__$Cmy_Cmy_$Impl_$.toString(_.cmy),{ fileName : "TestRoundTrip.hx", lineNumber : 78, className : "thx.color.TestRoundTrip", methodName : "testLabRoundtrip"});
			thx_color_TestRoundTrip.assertLab(_.lab,thx_color__$Cmyk_Cmyk_$Impl_$.toLab(_.cmyk),thx_color__$Cmyk_Cmyk_$Impl_$.toString(_.cmyk),{ fileName : "TestRoundTrip.hx", lineNumber : 79, className : "thx.color.TestRoundTrip", methodName : "testLabRoundtrip"});
			thx_color_TestRoundTrip.assertLab(_.lab,thx_color__$CubeHelix_CubeHelix_$Impl_$.toLab(_.ch),thx_color__$CubeHelix_CubeHelix_$Impl_$.toString(_.ch),{ fileName : "TestRoundTrip.hx", lineNumber : 80, className : "thx.color.TestRoundTrip", methodName : "testLabRoundtrip"});
			thx_color_TestRoundTrip.assertLab(_.lab,thx_color__$Hsl_Hsl_$Impl_$.toLab(_.hsl),thx_color__$Hsl_Hsl_$Impl_$.toString(_.hsl),{ fileName : "TestRoundTrip.hx", lineNumber : 81, className : "thx.color.TestRoundTrip", methodName : "testLabRoundtrip"});
			thx_color_TestRoundTrip.assertLab(_.lab,thx_color__$Hsv_Hsv_$Impl_$.toLab(_.hsv),thx_color__$Hsv_Hsv_$Impl_$.toString(_.hsv),{ fileName : "TestRoundTrip.hx", lineNumber : 82, className : "thx.color.TestRoundTrip", methodName : "testLabRoundtrip"});
			thx_color_TestRoundTrip.assertLab(_.lab,thx_color__$HunterLab_HunterLab_$Impl_$.toLab(_.hl),thx_color__$HunterLab_HunterLab_$Impl_$.toString(_.hl),{ fileName : "TestRoundTrip.hx", lineNumber : 83, className : "thx.color.TestRoundTrip", methodName : "testLabRoundtrip"});
			thx_color_TestRoundTrip.assertLab(_.lab,thx_color__$Xyz_Xyz_$Impl_$.toLab(_.xyz),thx_color__$Xyz_Xyz_$Impl_$.toString(_.xyz),{ fileName : "TestRoundTrip.hx", lineNumber : 84, className : "thx.color.TestRoundTrip", methodName : "testLabRoundtrip"});
			thx_color_TestRoundTrip.assertLab(_.lab,thx_color__$Yuv_Yuv_$Impl_$.toLab(_.yuv),thx_color__$Yuv_Yuv_$Impl_$.toString(_.yuv),{ fileName : "TestRoundTrip.hx", lineNumber : 85, className : "thx.color.TestRoundTrip", methodName : "testLabRoundtrip"});
			thx_color_TestRoundTrip.assertLab(_.lab,thx_color__$Yxy_Yxy_$Impl_$.toLab(_.yxy),thx_color__$Yxy_Yxy_$Impl_$.toString(_.yxy),{ fileName : "TestRoundTrip.hx", lineNumber : 86, className : "thx.color.TestRoundTrip", methodName : "testLabRoundtrip"});
			return;
		});
	}
	,testLChRoundtrip: function() {
		this.tests.map(function(_) {
			thx_color_TestRoundTrip.assertLCh(_.lch,thx_color__$Lab_Lab_$Impl_$.toLCh(_.lab),thx_color__$Lab_Lab_$Impl_$.toString(_.lab),{ fileName : "TestRoundTrip.hx", lineNumber : 93, className : "thx.color.TestRoundTrip", methodName : "testLChRoundtrip"});
			thx_color_TestRoundTrip.assertLCh(_.lch,thx_color__$Rgbx_Rgbx_$Impl_$.toLCh(_.rgbx),thx_color__$Rgbx_Rgbx_$Impl_$.toString(_.rgbx),{ fileName : "TestRoundTrip.hx", lineNumber : 94, className : "thx.color.TestRoundTrip", methodName : "testLChRoundtrip"});
			thx_color_TestRoundTrip.assertLCh(_.lch,thx_color__$Cmy_Cmy_$Impl_$.toLCh(_.cmy),thx_color__$Cmy_Cmy_$Impl_$.toString(_.cmy),{ fileName : "TestRoundTrip.hx", lineNumber : 95, className : "thx.color.TestRoundTrip", methodName : "testLChRoundtrip"});
			thx_color_TestRoundTrip.assertLCh(_.lch,thx_color__$Cmyk_Cmyk_$Impl_$.toLCh(_.cmyk),thx_color__$Cmyk_Cmyk_$Impl_$.toString(_.cmyk),{ fileName : "TestRoundTrip.hx", lineNumber : 96, className : "thx.color.TestRoundTrip", methodName : "testLChRoundtrip"});
			thx_color_TestRoundTrip.assertLCh(_.lch,thx_color__$CubeHelix_CubeHelix_$Impl_$.toLCh(_.ch),thx_color__$CubeHelix_CubeHelix_$Impl_$.toString(_.ch),{ fileName : "TestRoundTrip.hx", lineNumber : 97, className : "thx.color.TestRoundTrip", methodName : "testLChRoundtrip"});
			thx_color_TestRoundTrip.assertLCh(_.lch,thx_color__$Hsl_Hsl_$Impl_$.toLCh(_.hsl),thx_color__$Hsl_Hsl_$Impl_$.toString(_.hsl),{ fileName : "TestRoundTrip.hx", lineNumber : 98, className : "thx.color.TestRoundTrip", methodName : "testLChRoundtrip"});
			thx_color_TestRoundTrip.assertLCh(_.lch,thx_color__$Hsv_Hsv_$Impl_$.toLCh(_.hsv),thx_color__$Hsv_Hsv_$Impl_$.toString(_.hsv),{ fileName : "TestRoundTrip.hx", lineNumber : 99, className : "thx.color.TestRoundTrip", methodName : "testLChRoundtrip"});
			thx_color_TestRoundTrip.assertLCh(_.lch,thx_color__$HunterLab_HunterLab_$Impl_$.toLCh(_.hl),thx_color__$HunterLab_HunterLab_$Impl_$.toString(_.hl),{ fileName : "TestRoundTrip.hx", lineNumber : 100, className : "thx.color.TestRoundTrip", methodName : "testLChRoundtrip"});
			thx_color_TestRoundTrip.assertLCh(_.lch,thx_color__$Xyz_Xyz_$Impl_$.toLCh(_.xyz),thx_color__$Xyz_Xyz_$Impl_$.toString(_.xyz),{ fileName : "TestRoundTrip.hx", lineNumber : 101, className : "thx.color.TestRoundTrip", methodName : "testLChRoundtrip"});
			thx_color_TestRoundTrip.assertLCh(_.lch,thx_color__$Yuv_Yuv_$Impl_$.toLCh(_.yuv),thx_color__$Yuv_Yuv_$Impl_$.toString(_.yuv),{ fileName : "TestRoundTrip.hx", lineNumber : 102, className : "thx.color.TestRoundTrip", methodName : "testLChRoundtrip"});
			thx_color_TestRoundTrip.assertLCh(_.lch,thx_color__$Yxy_Yxy_$Impl_$.toLCh(_.yxy),thx_color__$Yxy_Yxy_$Impl_$.toString(_.yxy),{ fileName : "TestRoundTrip.hx", lineNumber : 103, className : "thx.color.TestRoundTrip", methodName : "testLChRoundtrip"});
			return;
		});
	}
	,testCmyRoundtrip: function() {
		this.tests.map(function(_) {
			thx_color_TestRoundTrip.assertCmy(_.cmy,thx_color__$Lab_Lab_$Impl_$.toCmy(_.lab),thx_color__$Lab_Lab_$Impl_$.toString(_.lab),{ fileName : "TestRoundTrip.hx", lineNumber : 110, className : "thx.color.TestRoundTrip", methodName : "testCmyRoundtrip"});
			thx_color_TestRoundTrip.assertCmy(_.cmy,thx_color__$LCh_LCh_$Impl_$.toCmy(_.lch),thx_color__$LCh_LCh_$Impl_$.toString(_.lch),{ fileName : "TestRoundTrip.hx", lineNumber : 111, className : "thx.color.TestRoundTrip", methodName : "testCmyRoundtrip"});
			thx_color_TestRoundTrip.assertCmy(_.cmy,thx_color__$Rgbx_Rgbx_$Impl_$.toCmy(_.rgbx),thx_color__$Rgbx_Rgbx_$Impl_$.toString(_.rgbx),{ fileName : "TestRoundTrip.hx", lineNumber : 112, className : "thx.color.TestRoundTrip", methodName : "testCmyRoundtrip"});
			thx_color_TestRoundTrip.assertCmy(_.cmy,thx_color__$Cmyk_Cmyk_$Impl_$.toCmy(_.cmyk),thx_color__$Cmyk_Cmyk_$Impl_$.toString(_.cmyk),{ fileName : "TestRoundTrip.hx", lineNumber : 113, className : "thx.color.TestRoundTrip", methodName : "testCmyRoundtrip"});
			thx_color_TestRoundTrip.assertCmy(_.cmy,thx_color__$CubeHelix_CubeHelix_$Impl_$.toCmy(_.ch),thx_color__$CubeHelix_CubeHelix_$Impl_$.toString(_.ch),{ fileName : "TestRoundTrip.hx", lineNumber : 114, className : "thx.color.TestRoundTrip", methodName : "testCmyRoundtrip"});
			thx_color_TestRoundTrip.assertCmy(_.cmy,thx_color__$Hsl_Hsl_$Impl_$.toCmy(_.hsl),thx_color__$Hsl_Hsl_$Impl_$.toString(_.hsl),{ fileName : "TestRoundTrip.hx", lineNumber : 115, className : "thx.color.TestRoundTrip", methodName : "testCmyRoundtrip"});
			thx_color_TestRoundTrip.assertCmy(_.cmy,thx_color__$Hsv_Hsv_$Impl_$.toCmy(_.hsv),thx_color__$Hsv_Hsv_$Impl_$.toString(_.hsv),{ fileName : "TestRoundTrip.hx", lineNumber : 116, className : "thx.color.TestRoundTrip", methodName : "testCmyRoundtrip"});
			thx_color_TestRoundTrip.assertCmy(_.cmy,thx_color__$HunterLab_HunterLab_$Impl_$.toCmy(_.hl),thx_color__$HunterLab_HunterLab_$Impl_$.toString(_.hl),{ fileName : "TestRoundTrip.hx", lineNumber : 117, className : "thx.color.TestRoundTrip", methodName : "testCmyRoundtrip"});
			thx_color_TestRoundTrip.assertCmy(_.cmy,thx_color__$Xyz_Xyz_$Impl_$.toCmy(_.xyz),thx_color__$Xyz_Xyz_$Impl_$.toString(_.xyz),{ fileName : "TestRoundTrip.hx", lineNumber : 118, className : "thx.color.TestRoundTrip", methodName : "testCmyRoundtrip"});
			thx_color_TestRoundTrip.assertCmy(_.cmy,thx_color__$Yuv_Yuv_$Impl_$.toCmy(_.yuv),thx_color__$Yuv_Yuv_$Impl_$.toString(_.yuv),{ fileName : "TestRoundTrip.hx", lineNumber : 119, className : "thx.color.TestRoundTrip", methodName : "testCmyRoundtrip"});
			thx_color_TestRoundTrip.assertCmy(_.cmy,thx_color__$Yxy_Yxy_$Impl_$.toCmy(_.yxy),thx_color__$Yxy_Yxy_$Impl_$.toString(_.yxy),{ fileName : "TestRoundTrip.hx", lineNumber : 120, className : "thx.color.TestRoundTrip", methodName : "testCmyRoundtrip"});
			return;
		});
	}
	,testCmykRoundtrip: function() {
		this.tests.map(function(_) {
			thx_color_TestRoundTrip.assertCmyk(_.cmyk,thx_color__$Lab_Lab_$Impl_$.toCmyk(_.lab),thx_color__$Lab_Lab_$Impl_$.toString(_.lab),{ fileName : "TestRoundTrip.hx", lineNumber : 127, className : "thx.color.TestRoundTrip", methodName : "testCmykRoundtrip"});
			thx_color_TestRoundTrip.assertCmyk(_.cmyk,thx_color__$LCh_LCh_$Impl_$.toCmyk(_.lch),thx_color__$LCh_LCh_$Impl_$.toString(_.lch),{ fileName : "TestRoundTrip.hx", lineNumber : 128, className : "thx.color.TestRoundTrip", methodName : "testCmykRoundtrip"});
			thx_color_TestRoundTrip.assertCmyk(_.cmyk,thx_color__$Cmy_Cmy_$Impl_$.toCmyk(_.cmy),thx_color__$Cmy_Cmy_$Impl_$.toString(_.cmy),{ fileName : "TestRoundTrip.hx", lineNumber : 129, className : "thx.color.TestRoundTrip", methodName : "testCmykRoundtrip"});
			thx_color_TestRoundTrip.assertCmyk(_.cmyk,thx_color__$Rgbx_Rgbx_$Impl_$.toCmyk(_.rgbx),thx_color__$Rgbx_Rgbx_$Impl_$.toString(_.rgbx),{ fileName : "TestRoundTrip.hx", lineNumber : 130, className : "thx.color.TestRoundTrip", methodName : "testCmykRoundtrip"});
			thx_color_TestRoundTrip.assertCmyk(_.cmyk,thx_color__$CubeHelix_CubeHelix_$Impl_$.toCmyk(_.ch),thx_color__$CubeHelix_CubeHelix_$Impl_$.toString(_.ch),{ fileName : "TestRoundTrip.hx", lineNumber : 131, className : "thx.color.TestRoundTrip", methodName : "testCmykRoundtrip"});
			thx_color_TestRoundTrip.assertCmyk(_.cmyk,thx_color__$Hsl_Hsl_$Impl_$.toCmyk(_.hsl),thx_color__$Hsl_Hsl_$Impl_$.toString(_.hsl),{ fileName : "TestRoundTrip.hx", lineNumber : 132, className : "thx.color.TestRoundTrip", methodName : "testCmykRoundtrip"});
			thx_color_TestRoundTrip.assertCmyk(_.cmyk,thx_color__$Hsv_Hsv_$Impl_$.toCmyk(_.hsv),thx_color__$Hsv_Hsv_$Impl_$.toString(_.hsv),{ fileName : "TestRoundTrip.hx", lineNumber : 133, className : "thx.color.TestRoundTrip", methodName : "testCmykRoundtrip"});
			thx_color_TestRoundTrip.assertCmyk(_.cmyk,thx_color__$HunterLab_HunterLab_$Impl_$.toCmyk(_.hl),thx_color__$HunterLab_HunterLab_$Impl_$.toString(_.hl),{ fileName : "TestRoundTrip.hx", lineNumber : 134, className : "thx.color.TestRoundTrip", methodName : "testCmykRoundtrip"});
			thx_color_TestRoundTrip.assertCmyk(_.cmyk,thx_color__$Xyz_Xyz_$Impl_$.toCmyk(_.xyz),thx_color__$Xyz_Xyz_$Impl_$.toString(_.xyz),{ fileName : "TestRoundTrip.hx", lineNumber : 135, className : "thx.color.TestRoundTrip", methodName : "testCmykRoundtrip"});
			thx_color_TestRoundTrip.assertCmyk(_.cmyk,thx_color__$Yuv_Yuv_$Impl_$.toCmyk(_.yuv),thx_color__$Yuv_Yuv_$Impl_$.toString(_.yuv),{ fileName : "TestRoundTrip.hx", lineNumber : 136, className : "thx.color.TestRoundTrip", methodName : "testCmykRoundtrip"});
			thx_color_TestRoundTrip.assertCmyk(_.cmyk,thx_color__$Yxy_Yxy_$Impl_$.toCmyk(_.yxy),thx_color__$Yxy_Yxy_$Impl_$.toString(_.yxy),{ fileName : "TestRoundTrip.hx", lineNumber : 137, className : "thx.color.TestRoundTrip", methodName : "testCmykRoundtrip"});
			return;
		});
	}
	,testCubeHelixRoundtrip: function() {
		this.tests.map(function(_) {
			thx_color_TestRoundTrip.assertCubeHelix(_.ch,thx_color__$Lab_Lab_$Impl_$.toCubeHelix(_.lab),thx_color__$Lab_Lab_$Impl_$.toString(_.lab),{ fileName : "TestRoundTrip.hx", lineNumber : 144, className : "thx.color.TestRoundTrip", methodName : "testCubeHelixRoundtrip"});
			thx_color_TestRoundTrip.assertCubeHelix(_.ch,thx_color__$LCh_LCh_$Impl_$.toCubeHelix(_.lch),thx_color__$LCh_LCh_$Impl_$.toString(_.lch),{ fileName : "TestRoundTrip.hx", lineNumber : 145, className : "thx.color.TestRoundTrip", methodName : "testCubeHelixRoundtrip"});
			thx_color_TestRoundTrip.assertCubeHelix(_.ch,thx_color__$Cmy_Cmy_$Impl_$.toCubeHelix(_.cmy),thx_color__$Cmy_Cmy_$Impl_$.toString(_.cmy),{ fileName : "TestRoundTrip.hx", lineNumber : 146, className : "thx.color.TestRoundTrip", methodName : "testCubeHelixRoundtrip"});
			thx_color_TestRoundTrip.assertCubeHelix(_.ch,thx_color__$Cmyk_Cmyk_$Impl_$.toCubeHelix(_.cmyk),thx_color__$Cmyk_Cmyk_$Impl_$.toString(_.cmyk),{ fileName : "TestRoundTrip.hx", lineNumber : 147, className : "thx.color.TestRoundTrip", methodName : "testCubeHelixRoundtrip"});
			thx_color_TestRoundTrip.assertCubeHelix(_.ch,thx_color__$Rgbx_Rgbx_$Impl_$.toCubeHelixWithGamma(_.rgbx,1),thx_color__$Rgbx_Rgbx_$Impl_$.toString(_.rgbx),{ fileName : "TestRoundTrip.hx", lineNumber : 148, className : "thx.color.TestRoundTrip", methodName : "testCubeHelixRoundtrip"});
			thx_color_TestRoundTrip.assertCubeHelix(_.ch,thx_color__$Hsl_Hsl_$Impl_$.toCubeHelix(_.hsl),thx_color__$Hsl_Hsl_$Impl_$.toString(_.hsl),{ fileName : "TestRoundTrip.hx", lineNumber : 149, className : "thx.color.TestRoundTrip", methodName : "testCubeHelixRoundtrip"});
			thx_color_TestRoundTrip.assertCubeHelix(_.ch,thx_color__$Hsv_Hsv_$Impl_$.toCubeHelix(_.hsv),thx_color__$Hsv_Hsv_$Impl_$.toString(_.hsv),{ fileName : "TestRoundTrip.hx", lineNumber : 150, className : "thx.color.TestRoundTrip", methodName : "testCubeHelixRoundtrip"});
			thx_color_TestRoundTrip.assertCubeHelix(_.ch,thx_color__$HunterLab_HunterLab_$Impl_$.toCubeHelix(_.hl),thx_color__$HunterLab_HunterLab_$Impl_$.toString(_.hl),{ fileName : "TestRoundTrip.hx", lineNumber : 151, className : "thx.color.TestRoundTrip", methodName : "testCubeHelixRoundtrip"});
			thx_color_TestRoundTrip.assertCubeHelix(_.ch,thx_color__$Xyz_Xyz_$Impl_$.toCubeHelix(_.xyz),thx_color__$Xyz_Xyz_$Impl_$.toString(_.xyz),{ fileName : "TestRoundTrip.hx", lineNumber : 152, className : "thx.color.TestRoundTrip", methodName : "testCubeHelixRoundtrip"});
			thx_color_TestRoundTrip.assertCubeHelix(_.ch,thx_color__$Yuv_Yuv_$Impl_$.toCubeHelix(_.yuv),thx_color__$Yuv_Yuv_$Impl_$.toString(_.yuv),{ fileName : "TestRoundTrip.hx", lineNumber : 153, className : "thx.color.TestRoundTrip", methodName : "testCubeHelixRoundtrip"});
			thx_color_TestRoundTrip.assertCubeHelix(_.ch,thx_color__$Yxy_Yxy_$Impl_$.toCubeHelix(_.yxy),thx_color__$Yxy_Yxy_$Impl_$.toString(_.yxy),{ fileName : "TestRoundTrip.hx", lineNumber : 154, className : "thx.color.TestRoundTrip", methodName : "testCubeHelixRoundtrip"});
			return;
		});
	}
	,testHslRoundtrip: function() {
		this.tests.map(function(_) {
			thx_color_TestRoundTrip.assertHsl(_.hsl,thx_color__$Lab_Lab_$Impl_$.toHsl(_.lab),thx_color__$Lab_Lab_$Impl_$.toString(_.lab),{ fileName : "TestRoundTrip.hx", lineNumber : 161, className : "thx.color.TestRoundTrip", methodName : "testHslRoundtrip"});
			thx_color_TestRoundTrip.assertHsl(_.hsl,thx_color__$LCh_LCh_$Impl_$.toHsl(_.lch),thx_color__$LCh_LCh_$Impl_$.toString(_.lch),{ fileName : "TestRoundTrip.hx", lineNumber : 162, className : "thx.color.TestRoundTrip", methodName : "testHslRoundtrip"});
			thx_color_TestRoundTrip.assertHsl(_.hsl,thx_color__$Cmy_Cmy_$Impl_$.toHsl(_.cmy),thx_color__$Cmy_Cmy_$Impl_$.toString(_.cmy),{ fileName : "TestRoundTrip.hx", lineNumber : 163, className : "thx.color.TestRoundTrip", methodName : "testHslRoundtrip"});
			thx_color_TestRoundTrip.assertHsl(_.hsl,thx_color__$Cmyk_Cmyk_$Impl_$.toHsl(_.cmyk),thx_color__$Cmyk_Cmyk_$Impl_$.toString(_.cmyk),{ fileName : "TestRoundTrip.hx", lineNumber : 164, className : "thx.color.TestRoundTrip", methodName : "testHslRoundtrip"});
			thx_color_TestRoundTrip.assertHsl(_.hsl,thx_color__$CubeHelix_CubeHelix_$Impl_$.toHsl(_.ch),thx_color__$CubeHelix_CubeHelix_$Impl_$.toString(_.ch),{ fileName : "TestRoundTrip.hx", lineNumber : 165, className : "thx.color.TestRoundTrip", methodName : "testHslRoundtrip"});
			thx_color_TestRoundTrip.assertHsl(_.hsl,thx_color__$Rgbx_Rgbx_$Impl_$.toHsl(_.rgbx),thx_color__$Rgbx_Rgbx_$Impl_$.toString(_.rgbx),{ fileName : "TestRoundTrip.hx", lineNumber : 166, className : "thx.color.TestRoundTrip", methodName : "testHslRoundtrip"});
			thx_color_TestRoundTrip.assertHsl(_.hsl,thx_color__$Hsv_Hsv_$Impl_$.toHsl(_.hsv),thx_color__$Hsv_Hsv_$Impl_$.toString(_.hsv),{ fileName : "TestRoundTrip.hx", lineNumber : 167, className : "thx.color.TestRoundTrip", methodName : "testHslRoundtrip"});
			thx_color_TestRoundTrip.assertHsl(_.hsl,thx_color__$HunterLab_HunterLab_$Impl_$.toHsl(_.hl),thx_color__$HunterLab_HunterLab_$Impl_$.toString(_.hl),{ fileName : "TestRoundTrip.hx", lineNumber : 168, className : "thx.color.TestRoundTrip", methodName : "testHslRoundtrip"});
			thx_color_TestRoundTrip.assertHsl(_.hsl,thx_color__$Xyz_Xyz_$Impl_$.toHsl(_.xyz),thx_color__$Xyz_Xyz_$Impl_$.toString(_.xyz),{ fileName : "TestRoundTrip.hx", lineNumber : 169, className : "thx.color.TestRoundTrip", methodName : "testHslRoundtrip"});
			thx_color_TestRoundTrip.assertHsl(_.hsl,thx_color__$Yuv_Yuv_$Impl_$.toHsl(_.yuv),thx_color__$Yuv_Yuv_$Impl_$.toString(_.yuv),{ fileName : "TestRoundTrip.hx", lineNumber : 170, className : "thx.color.TestRoundTrip", methodName : "testHslRoundtrip"});
			thx_color_TestRoundTrip.assertHsl(_.hsl,thx_color__$Yxy_Yxy_$Impl_$.toHsl(_.yxy),thx_color__$Yxy_Yxy_$Impl_$.toString(_.yxy),{ fileName : "TestRoundTrip.hx", lineNumber : 171, className : "thx.color.TestRoundTrip", methodName : "testHslRoundtrip"});
			return;
		});
	}
	,testHsvRoundtrip: function() {
		this.tests.map(function(_) {
			thx_color_TestRoundTrip.assertHsv(_.hsv,thx_color__$Lab_Lab_$Impl_$.toHsv(_.lab),thx_color__$Lab_Lab_$Impl_$.toString(_.lab),{ fileName : "TestRoundTrip.hx", lineNumber : 178, className : "thx.color.TestRoundTrip", methodName : "testHsvRoundtrip"});
			thx_color_TestRoundTrip.assertHsv(_.hsv,thx_color__$LCh_LCh_$Impl_$.toHsv(_.lch),thx_color__$LCh_LCh_$Impl_$.toString(_.lch),{ fileName : "TestRoundTrip.hx", lineNumber : 179, className : "thx.color.TestRoundTrip", methodName : "testHsvRoundtrip"});
			thx_color_TestRoundTrip.assertHsv(_.hsv,thx_color__$Cmy_Cmy_$Impl_$.toHsv(_.cmy),thx_color__$Cmy_Cmy_$Impl_$.toString(_.cmy),{ fileName : "TestRoundTrip.hx", lineNumber : 180, className : "thx.color.TestRoundTrip", methodName : "testHsvRoundtrip"});
			thx_color_TestRoundTrip.assertHsv(_.hsv,thx_color__$Cmyk_Cmyk_$Impl_$.toHsv(_.cmyk),thx_color__$Cmyk_Cmyk_$Impl_$.toString(_.cmyk),{ fileName : "TestRoundTrip.hx", lineNumber : 181, className : "thx.color.TestRoundTrip", methodName : "testHsvRoundtrip"});
			thx_color_TestRoundTrip.assertHsv(_.hsv,thx_color__$CubeHelix_CubeHelix_$Impl_$.toHsv(_.ch),thx_color__$CubeHelix_CubeHelix_$Impl_$.toString(_.ch),{ fileName : "TestRoundTrip.hx", lineNumber : 182, className : "thx.color.TestRoundTrip", methodName : "testHsvRoundtrip"});
			thx_color_TestRoundTrip.assertHsv(_.hsv,thx_color__$Hsl_Hsl_$Impl_$.toHsv(_.hsl),thx_color__$Hsl_Hsl_$Impl_$.toString(_.hsl),{ fileName : "TestRoundTrip.hx", lineNumber : 183, className : "thx.color.TestRoundTrip", methodName : "testHsvRoundtrip"});
			thx_color_TestRoundTrip.assertHsv(_.hsv,thx_color__$HunterLab_HunterLab_$Impl_$.toHsv(_.hl),thx_color__$HunterLab_HunterLab_$Impl_$.toString(_.hl),{ fileName : "TestRoundTrip.hx", lineNumber : 184, className : "thx.color.TestRoundTrip", methodName : "testHsvRoundtrip"});
			thx_color_TestRoundTrip.assertHsv(_.hsv,thx_color__$Rgbx_Rgbx_$Impl_$.toHsv(_.rgbx),thx_color__$Rgbx_Rgbx_$Impl_$.toString(_.rgbx),{ fileName : "TestRoundTrip.hx", lineNumber : 185, className : "thx.color.TestRoundTrip", methodName : "testHsvRoundtrip"});
			thx_color_TestRoundTrip.assertHsv(_.hsv,thx_color__$Xyz_Xyz_$Impl_$.toHsv(_.xyz),thx_color__$Xyz_Xyz_$Impl_$.toString(_.xyz),{ fileName : "TestRoundTrip.hx", lineNumber : 186, className : "thx.color.TestRoundTrip", methodName : "testHsvRoundtrip"});
			thx_color_TestRoundTrip.assertHsv(_.hsv,thx_color__$Yuv_Yuv_$Impl_$.toHsv(_.yuv),thx_color__$Yuv_Yuv_$Impl_$.toString(_.yuv),{ fileName : "TestRoundTrip.hx", lineNumber : 187, className : "thx.color.TestRoundTrip", methodName : "testHsvRoundtrip"});
			thx_color_TestRoundTrip.assertHsv(_.hsv,thx_color__$Yxy_Yxy_$Impl_$.toHsv(_.yxy),thx_color__$Yxy_Yxy_$Impl_$.toString(_.yxy),{ fileName : "TestRoundTrip.hx", lineNumber : 188, className : "thx.color.TestRoundTrip", methodName : "testHsvRoundtrip"});
			return;
		});
	}
	,testXyzRoundtrip: function() {
		this.tests.map(function(_) {
			thx_color_TestRoundTrip.assertXyz(_.xyz,thx_color__$Lab_Lab_$Impl_$.toXyz(_.lab),thx_color__$Lab_Lab_$Impl_$.toString(_.lab),{ fileName : "TestRoundTrip.hx", lineNumber : 195, className : "thx.color.TestRoundTrip", methodName : "testXyzRoundtrip"});
			thx_color_TestRoundTrip.assertXyz(_.xyz,thx_color__$LCh_LCh_$Impl_$.toXyz(_.lch),thx_color__$LCh_LCh_$Impl_$.toString(_.lch),{ fileName : "TestRoundTrip.hx", lineNumber : 196, className : "thx.color.TestRoundTrip", methodName : "testXyzRoundtrip"});
			thx_color_TestRoundTrip.assertXyz(_.xyz,thx_color__$Cmy_Cmy_$Impl_$.toXyz(_.cmy),thx_color__$Cmy_Cmy_$Impl_$.toString(_.cmy),{ fileName : "TestRoundTrip.hx", lineNumber : 197, className : "thx.color.TestRoundTrip", methodName : "testXyzRoundtrip"});
			thx_color_TestRoundTrip.assertXyz(_.xyz,thx_color__$Cmyk_Cmyk_$Impl_$.toXyz(_.cmyk),thx_color__$Cmyk_Cmyk_$Impl_$.toString(_.cmyk),{ fileName : "TestRoundTrip.hx", lineNumber : 198, className : "thx.color.TestRoundTrip", methodName : "testXyzRoundtrip"});
			thx_color_TestRoundTrip.assertXyz(_.xyz,thx_color__$CubeHelix_CubeHelix_$Impl_$.toXyz(_.ch),thx_color__$CubeHelix_CubeHelix_$Impl_$.toString(_.ch),{ fileName : "TestRoundTrip.hx", lineNumber : 199, className : "thx.color.TestRoundTrip", methodName : "testXyzRoundtrip"});
			thx_color_TestRoundTrip.assertXyz(_.xyz,thx_color__$Hsl_Hsl_$Impl_$.toXyz(_.hsl),thx_color__$Hsl_Hsl_$Impl_$.toString(_.hsl),{ fileName : "TestRoundTrip.hx", lineNumber : 200, className : "thx.color.TestRoundTrip", methodName : "testXyzRoundtrip"});
			thx_color_TestRoundTrip.assertXyz(_.xyz,thx_color__$Hsv_Hsv_$Impl_$.toXyz(_.hsv),thx_color__$Hsv_Hsv_$Impl_$.toString(_.hsv),{ fileName : "TestRoundTrip.hx", lineNumber : 201, className : "thx.color.TestRoundTrip", methodName : "testXyzRoundtrip"});
			thx_color_TestRoundTrip.assertXyz(_.xyz,thx_color__$HunterLab_HunterLab_$Impl_$.toXyz(_.hl),thx_color__$HunterLab_HunterLab_$Impl_$.toString(_.hl),{ fileName : "TestRoundTrip.hx", lineNumber : 202, className : "thx.color.TestRoundTrip", methodName : "testXyzRoundtrip"});
			thx_color_TestRoundTrip.assertXyz(_.xyz,thx_color__$Rgbx_Rgbx_$Impl_$.toXyz(_.rgbx),thx_color__$Rgbx_Rgbx_$Impl_$.toString(_.rgbx),{ fileName : "TestRoundTrip.hx", lineNumber : 203, className : "thx.color.TestRoundTrip", methodName : "testXyzRoundtrip"});
			thx_color_TestRoundTrip.assertXyz(_.xyz,thx_color__$Yuv_Yuv_$Impl_$.toXyz(_.yuv),thx_color__$Yuv_Yuv_$Impl_$.toString(_.yuv),{ fileName : "TestRoundTrip.hx", lineNumber : 204, className : "thx.color.TestRoundTrip", methodName : "testXyzRoundtrip"});
			thx_color_TestRoundTrip.assertXyz(_.xyz,thx_color__$Yxy_Yxy_$Impl_$.toXyz(_.yxy),thx_color__$Yxy_Yxy_$Impl_$.toString(_.yxy),{ fileName : "TestRoundTrip.hx", lineNumber : 205, className : "thx.color.TestRoundTrip", methodName : "testXyzRoundtrip"});
			return;
		});
	}
	,testYuvRoundtrip: function() {
		this.tests.map(function(_) {
			thx_color_TestRoundTrip.assertYuv(thx_color__$Xyz_Xyz_$Impl_$.toYuv(_.xyz),thx_color__$Lab_Lab_$Impl_$.toYuv(_.lab),thx_color__$Lab_Lab_$Impl_$.toString(_.lab),{ fileName : "TestRoundTrip.hx", lineNumber : 212, className : "thx.color.TestRoundTrip", methodName : "testYuvRoundtrip"});
			thx_color_TestRoundTrip.assertYuv(thx_color__$Xyz_Xyz_$Impl_$.toYuv(_.xyz),thx_color__$LCh_LCh_$Impl_$.toYuv(_.lch),thx_color__$LCh_LCh_$Impl_$.toString(_.lch),{ fileName : "TestRoundTrip.hx", lineNumber : 213, className : "thx.color.TestRoundTrip", methodName : "testYuvRoundtrip"});
			thx_color_TestRoundTrip.assertYuv(thx_color__$Xyz_Xyz_$Impl_$.toYuv(_.xyz),thx_color__$Cmy_Cmy_$Impl_$.toYuv(_.cmy),thx_color__$Cmy_Cmy_$Impl_$.toString(_.cmy),{ fileName : "TestRoundTrip.hx", lineNumber : 214, className : "thx.color.TestRoundTrip", methodName : "testYuvRoundtrip"});
			thx_color_TestRoundTrip.assertYuv(thx_color__$Xyz_Xyz_$Impl_$.toYuv(_.xyz),thx_color__$Cmyk_Cmyk_$Impl_$.toYuv(_.cmyk),thx_color__$Cmyk_Cmyk_$Impl_$.toString(_.cmyk),{ fileName : "TestRoundTrip.hx", lineNumber : 215, className : "thx.color.TestRoundTrip", methodName : "testYuvRoundtrip"});
			thx_color_TestRoundTrip.assertYuv(thx_color__$Xyz_Xyz_$Impl_$.toYuv(_.xyz),thx_color__$CubeHelix_CubeHelix_$Impl_$.toYuv(_.ch),thx_color__$CubeHelix_CubeHelix_$Impl_$.toString(_.ch),{ fileName : "TestRoundTrip.hx", lineNumber : 216, className : "thx.color.TestRoundTrip", methodName : "testYuvRoundtrip"});
			thx_color_TestRoundTrip.assertYuv(thx_color__$Xyz_Xyz_$Impl_$.toYuv(_.xyz),thx_color__$Hsl_Hsl_$Impl_$.toYuv(_.hsl),thx_color__$Hsl_Hsl_$Impl_$.toString(_.hsl),{ fileName : "TestRoundTrip.hx", lineNumber : 217, className : "thx.color.TestRoundTrip", methodName : "testYuvRoundtrip"});
			thx_color_TestRoundTrip.assertYuv(thx_color__$Xyz_Xyz_$Impl_$.toYuv(_.xyz),thx_color__$Hsv_Hsv_$Impl_$.toYuv(_.hsv),thx_color__$Hsv_Hsv_$Impl_$.toString(_.hsv),{ fileName : "TestRoundTrip.hx", lineNumber : 218, className : "thx.color.TestRoundTrip", methodName : "testYuvRoundtrip"});
			thx_color_TestRoundTrip.assertYuv(thx_color__$Xyz_Xyz_$Impl_$.toYuv(_.xyz),thx_color__$HunterLab_HunterLab_$Impl_$.toYuv(_.hl),thx_color__$HunterLab_HunterLab_$Impl_$.toString(_.hl),{ fileName : "TestRoundTrip.hx", lineNumber : 219, className : "thx.color.TestRoundTrip", methodName : "testYuvRoundtrip"});
			thx_color_TestRoundTrip.assertYuv(thx_color__$Xyz_Xyz_$Impl_$.toYuv(_.xyz),thx_color__$Rgbx_Rgbx_$Impl_$.toYuv(_.rgbx),thx_color__$Rgbx_Rgbx_$Impl_$.toString(_.rgbx),{ fileName : "TestRoundTrip.hx", lineNumber : 220, className : "thx.color.TestRoundTrip", methodName : "testYuvRoundtrip"});
			thx_color_TestRoundTrip.assertYuv(thx_color__$Xyz_Xyz_$Impl_$.toYuv(_.xyz),thx_color__$Xyz_Xyz_$Impl_$.toYuv(_.xyz),thx_color__$Xyz_Xyz_$Impl_$.toString(_.xyz),{ fileName : "TestRoundTrip.hx", lineNumber : 221, className : "thx.color.TestRoundTrip", methodName : "testYuvRoundtrip"});
			thx_color_TestRoundTrip.assertYuv(thx_color__$Xyz_Xyz_$Impl_$.toYuv(_.xyz),thx_color__$Yxy_Yxy_$Impl_$.toYuv(_.yxy),thx_color__$Yxy_Yxy_$Impl_$.toString(_.yxy),{ fileName : "TestRoundTrip.hx", lineNumber : 222, className : "thx.color.TestRoundTrip", methodName : "testYuvRoundtrip"});
			return;
		});
	}
	,testYxyRoundtrip: function() {
		this.tests.map(function(_) {
			thx_color_TestRoundTrip.assertYxy(_.yxy,thx_color__$Lab_Lab_$Impl_$.toYxy(_.lab),thx_color__$Lab_Lab_$Impl_$.toString(_.lab),{ fileName : "TestRoundTrip.hx", lineNumber : 229, className : "thx.color.TestRoundTrip", methodName : "testYxyRoundtrip"});
			thx_color_TestRoundTrip.assertYxy(_.yxy,thx_color__$LCh_LCh_$Impl_$.toYxy(_.lch),thx_color__$LCh_LCh_$Impl_$.toString(_.lch),{ fileName : "TestRoundTrip.hx", lineNumber : 230, className : "thx.color.TestRoundTrip", methodName : "testYxyRoundtrip"});
			thx_color_TestRoundTrip.assertYxy(_.yxy,thx_color__$Cmy_Cmy_$Impl_$.toYxy(_.cmy),thx_color__$Cmy_Cmy_$Impl_$.toString(_.cmy),{ fileName : "TestRoundTrip.hx", lineNumber : 231, className : "thx.color.TestRoundTrip", methodName : "testYxyRoundtrip"});
			thx_color_TestRoundTrip.assertYxy(_.yxy,thx_color__$Cmyk_Cmyk_$Impl_$.toYxy(_.cmyk),thx_color__$Cmyk_Cmyk_$Impl_$.toString(_.cmyk),{ fileName : "TestRoundTrip.hx", lineNumber : 232, className : "thx.color.TestRoundTrip", methodName : "testYxyRoundtrip"});
			thx_color_TestRoundTrip.assertYxy(_.yxy,thx_color__$CubeHelix_CubeHelix_$Impl_$.toYxy(_.ch),thx_color__$CubeHelix_CubeHelix_$Impl_$.toString(_.ch),{ fileName : "TestRoundTrip.hx", lineNumber : 233, className : "thx.color.TestRoundTrip", methodName : "testYxyRoundtrip"});
			thx_color_TestRoundTrip.assertYxy(_.yxy,thx_color__$Hsl_Hsl_$Impl_$.toYxy(_.hsl),thx_color__$Hsl_Hsl_$Impl_$.toString(_.hsl),{ fileName : "TestRoundTrip.hx", lineNumber : 234, className : "thx.color.TestRoundTrip", methodName : "testYxyRoundtrip"});
			thx_color_TestRoundTrip.assertYxy(_.yxy,thx_color__$Hsv_Hsv_$Impl_$.toYxy(_.hsv),thx_color__$Hsv_Hsv_$Impl_$.toString(_.hsv),{ fileName : "TestRoundTrip.hx", lineNumber : 235, className : "thx.color.TestRoundTrip", methodName : "testYxyRoundtrip"});
			thx_color_TestRoundTrip.assertYxy(_.yxy,thx_color__$HunterLab_HunterLab_$Impl_$.toYxy(_.hl),thx_color__$HunterLab_HunterLab_$Impl_$.toString(_.hl),{ fileName : "TestRoundTrip.hx", lineNumber : 236, className : "thx.color.TestRoundTrip", methodName : "testYxyRoundtrip"});
			thx_color_TestRoundTrip.assertYxy(_.yxy,thx_color__$Xyz_Xyz_$Impl_$.toYxy(_.xyz),thx_color__$Xyz_Xyz_$Impl_$.toString(_.xyz),{ fileName : "TestRoundTrip.hx", lineNumber : 237, className : "thx.color.TestRoundTrip", methodName : "testYxyRoundtrip"});
			thx_color_TestRoundTrip.assertYxy(_.yxy,thx_color__$Rgbx_Rgbx_$Impl_$.toYxy(_.rgbx),thx_color__$Rgbx_Rgbx_$Impl_$.toString(_.rgbx),{ fileName : "TestRoundTrip.hx", lineNumber : 238, className : "thx.color.TestRoundTrip", methodName : "testYxyRoundtrip"});
			thx_color_TestRoundTrip.assertYxy(_.yxy,thx_color__$Yuv_Yuv_$Impl_$.toYxy(_.yuv),thx_color__$Yuv_Yuv_$Impl_$.toString(_.yuv),{ fileName : "TestRoundTrip.hx", lineNumber : 239, className : "thx.color.TestRoundTrip", methodName : "testYxyRoundtrip"});
			return;
		});
	}
	,testToStringRoundtrip: function() {
		this.tests.map(function(_) {
			var t = thx_color__$Lab_Lab_$Impl_$.fromString(thx_color__$Lab_Lab_$Impl_$.toString(_.lab));
			utest_Assert.isTrue(thx_color__$Lab_Lab_$Impl_$.equals(_.lab,t),"expected " + thx_color__$Lab_Lab_$Impl_$.toString(_.lab) + " but was " + thx_color__$Lab_Lab_$Impl_$.toString(t),{ fileName : "TestRoundTrip.hx", lineNumber : 247, className : "thx.color.TestRoundTrip", methodName : "testToStringRoundtrip"});
			var t1 = thx_color__$LCh_LCh_$Impl_$.fromString(thx_color__$LCh_LCh_$Impl_$.toString(_.lch));
			utest_Assert.isTrue(thx_color__$LCh_LCh_$Impl_$.equals(_.lch,t1),"expected " + thx_color__$LCh_LCh_$Impl_$.toString(_.lch) + " but was " + thx_color__$LCh_LCh_$Impl_$.toString(t1),{ fileName : "TestRoundTrip.hx", lineNumber : 249, className : "thx.color.TestRoundTrip", methodName : "testToStringRoundtrip"});
			var t2 = thx_color__$Cmy_Cmy_$Impl_$.fromString(thx_color__$Cmy_Cmy_$Impl_$.toString(_.cmy));
			utest_Assert.isTrue(thx_color__$Cmy_Cmy_$Impl_$.equals(_.cmy,t2),"expected " + thx_color__$Cmy_Cmy_$Impl_$.toString(_.cmy) + " but was " + thx_color__$Cmy_Cmy_$Impl_$.toString(t2),{ fileName : "TestRoundTrip.hx", lineNumber : 251, className : "thx.color.TestRoundTrip", methodName : "testToStringRoundtrip"});
			var t3 = thx_color__$Cmyk_Cmyk_$Impl_$.fromString(thx_color__$Cmyk_Cmyk_$Impl_$.toString(_.cmyk));
			utest_Assert.isTrue(thx_color__$Cmyk_Cmyk_$Impl_$.equals(_.cmyk,t3),"expected " + thx_color__$Cmyk_Cmyk_$Impl_$.toString(_.cmyk) + " but was " + thx_color__$Cmyk_Cmyk_$Impl_$.toString(t3),{ fileName : "TestRoundTrip.hx", lineNumber : 253, className : "thx.color.TestRoundTrip", methodName : "testToStringRoundtrip"});
			var t4 = thx_color__$CubeHelix_CubeHelix_$Impl_$.fromString(thx_color__$CubeHelix_CubeHelix_$Impl_$.toString(_.ch));
			utest_Assert.isTrue(thx_color__$CubeHelix_CubeHelix_$Impl_$.equals(_.ch,t4),"expected " + thx_color__$CubeHelix_CubeHelix_$Impl_$.toString(_.ch) + " but was " + thx_color__$CubeHelix_CubeHelix_$Impl_$.toString(t4),{ fileName : "TestRoundTrip.hx", lineNumber : 255, className : "thx.color.TestRoundTrip", methodName : "testToStringRoundtrip"});
			var t5 = thx_color__$Grey_Grey_$Impl_$.fromString(thx_color__$Grey_Grey_$Impl_$.toString(_.g));
			utest_Assert.isTrue(thx_color__$Grey_Grey_$Impl_$.equals(_.g,t5),"expected " + thx_color__$Grey_Grey_$Impl_$.toString(_.g) + " but was " + thx_color__$Grey_Grey_$Impl_$.toString(t5),{ fileName : "TestRoundTrip.hx", lineNumber : 257, className : "thx.color.TestRoundTrip", methodName : "testToStringRoundtrip"});
			var t6 = thx_color__$Hsl_Hsl_$Impl_$.fromString(thx_color__$Hsl_Hsl_$Impl_$.toString(_.hsl));
			utest_Assert.isTrue(thx_color__$Hsl_Hsl_$Impl_$.equals(_.hsl,t6),"expected " + thx_color__$Hsl_Hsl_$Impl_$.toString(_.hsl) + " but was " + thx_color__$Hsl_Hsl_$Impl_$.toString(t6),{ fileName : "TestRoundTrip.hx", lineNumber : 259, className : "thx.color.TestRoundTrip", methodName : "testToStringRoundtrip"});
			var t7 = thx_color__$Hsv_Hsv_$Impl_$.fromString(thx_color__$Hsv_Hsv_$Impl_$.toString(_.hsv));
			utest_Assert.isTrue(thx_color__$Hsv_Hsv_$Impl_$.equals(_.hsv,t7),"expected " + thx_color__$Hsv_Hsv_$Impl_$.toString(_.hsv) + " but was " + thx_color__$Hsv_Hsv_$Impl_$.toString(t7),{ fileName : "TestRoundTrip.hx", lineNumber : 261, className : "thx.color.TestRoundTrip", methodName : "testToStringRoundtrip"});
			var t8 = thx_color__$Rgbx_Rgbx_$Impl_$.fromString(thx_color__$Rgbx_Rgbx_$Impl_$.toString(_.rgbx));
			utest_Assert.isTrue(thx_color__$Rgbx_Rgbx_$Impl_$.equals(_.rgbx,t8),"expected " + thx_color__$Rgbx_Rgbx_$Impl_$.toString(_.rgbx) + " but was " + thx_color__$Rgbx_Rgbx_$Impl_$.toString(t8),{ fileName : "TestRoundTrip.hx", lineNumber : 263, className : "thx.color.TestRoundTrip", methodName : "testToStringRoundtrip"});
			var t9 = thx_color__$Xyz_Xyz_$Impl_$.fromString(thx_color__$Xyz_Xyz_$Impl_$.toString(_.xyz));
			utest_Assert.isTrue(thx_color__$Xyz_Xyz_$Impl_$.equals(_.xyz,t9),"expected " + thx_color__$Xyz_Xyz_$Impl_$.toString(_.xyz) + " but was " + thx_color__$Xyz_Xyz_$Impl_$.toString(t9),{ fileName : "TestRoundTrip.hx", lineNumber : 265, className : "thx.color.TestRoundTrip", methodName : "testToStringRoundtrip"});
			var t10 = thx_color__$Yxy_Yxy_$Impl_$.fromString(thx_color__$Yxy_Yxy_$Impl_$.toString(_.yxy));
			utest_Assert.isTrue(thx_color__$Yxy_Yxy_$Impl_$.equals(_.yxy,t10),"expected " + thx_color__$Yxy_Yxy_$Impl_$.toString(_.yxy) + " but was " + thx_color__$Yxy_Yxy_$Impl_$.toString(t10),{ fileName : "TestRoundTrip.hx", lineNumber : 267, className : "thx.color.TestRoundTrip", methodName : "testToStringRoundtrip"});
			var t11 = thx_color__$Yuv_Yuv_$Impl_$.fromString(thx_color__$Yuv_Yuv_$Impl_$.toString(_.yuv));
			utest_Assert.isTrue(thx_color__$Yuv_Yuv_$Impl_$.equals(_.yuv,t11),"expected " + thx_color__$Yuv_Yuv_$Impl_$.toString(_.yuv) + " but was " + thx_color__$Yuv_Yuv_$Impl_$.toString(t11),{ fileName : "TestRoundTrip.hx", lineNumber : 269, className : "thx.color.TestRoundTrip", methodName : "testToStringRoundtrip"});
			return;
		});
	}
	,__class__: thx_color_TestRoundTrip
};
var thx_color_TestTemperature = function() {
};
thx_color_TestTemperature.__name__ = ["thx","color","TestTemperature"];
thx_color_TestTemperature.prototype = {
	testBasics: function() {
		var this1 = 5000;
		utest_Assert.equals(5000,this1,null,{ fileName : "TestTemperature.hx", lineNumber : 10, className : "thx.color.TestTemperature", methodName : "testBasics"});
	}
	,testStrings: function() {
		var this1 = 5000;
		utest_Assert.equals("temperature(5000)",thx_color__$Temperature_Temperature_$Impl_$.toString(this1),null,{ fileName : "TestTemperature.hx", lineNumber : 15, className : "thx.color.TestTemperature", methodName : "testStrings"});
	}
	,testFromString: function() {
		var this1 = 5000;
		utest_Assert.isTrue(thx_color__$Temperature_Temperature_$Impl_$.equals(this1,thx_color__$Temperature_Temperature_$Impl_$.fromString("temperature(5000)")),null,{ fileName : "TestTemperature.hx", lineNumber : 19, className : "thx.color.TestTemperature", methodName : "testFromString"});
	}
	,__class__: thx_color_TestTemperature
};
...
var thx_color_TestYxy = function() {
};
thx_color_TestYxy.__name__ = ["thx","color","TestYxy"];
thx_color_TestYxy.prototype = {
	testBasics: function() {
		var color = [0.5,0.4,0.3];
		utest_Assert.equals(0.5,color[0],null,{ fileName : "TestYxy.hx", lineNumber : 10, className : "thx.color.TestYxy", methodName : "testBasics"});
		utest_Assert.equals(0.4,color[1],null,{ fileName : "TestYxy.hx", lineNumber : 11, className : "thx.color.TestYxy", methodName : "testBasics"});
		utest_Assert.equals(0.3,color[2],null,{ fileName : "TestYxy.hx", lineNumber : 12, className : "thx.color.TestYxy", methodName : "testBasics"});
	}
	,testString: function() {
		utest_Assert.equals("yxy(0.5,0.4,0.3)",thx_color__$Yxy_Yxy_$Impl_$.toString([0.5,0.4,0.3]),null,{ fileName : "TestYxy.hx", lineNumber : 17, className : "thx.color.TestYxy", methodName : "testString"});
	}
	,testParse: function() {
		utest_Assert.equals("yxy(0.5,0.4,0.3)",thx_color__$Yxy_Yxy_$Impl_$.toString(thx_color__$Yxy_Yxy_$Impl_$.fromString("yxy(0.5,0.4,0.3)")),null,{ fileName : "TestYxy.hx", lineNumber : 22, className : "thx.color.TestYxy", methodName : "testParse"});
	}
	,testFromFloat: function() {
		utest_Assert.isTrue(thx_color__$Yxy_Yxy_$Impl_$.equals(thx_color__$Yxy_Yxy_$Impl_$.fromString("yxy(0.5,0.4,0.3)"),thx_color__$Yxy_Yxy_$Impl_$.fromFloats([0.5,0.4,0.3])),null,{ fileName : "TestYxy.hx", lineNumber : 28, className : "thx.color.TestYxy", methodName : "testFromFloat"});
	}
	,__class__: thx_color_TestYxy
};
