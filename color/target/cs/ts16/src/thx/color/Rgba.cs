			...
			unchecked {
				...
				try {
					switch (info.name) {
						case "rgb":
						{
							return global::thx.color._Rgb.Rgb_Impl_.toRgba(global::thx.color._Rgb.Rgb_Impl_.fromInts(global::thx.color.parse.ColorParser.getInt8Channels(info.channels, 3)));
						}
