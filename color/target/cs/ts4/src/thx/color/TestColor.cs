...
namespace thx.color {
	public class TestColor : global::haxe.lang.HxObject {
		...
		public TestColor(int i) {
			global::thx.color.TestColor.__hx_ctor_thx_color_TestColor(this, i);
		}
		
		
		public static void __hx_ctor_thx_color_TestColor(global::thx.color.TestColor __temp_me161, int i) {
			__temp_me161.x = i;
		}
		
		
		public static new object __hx_createEmpty() {
			return new global::thx.color.TestColor(((global::haxe.lang.EmptyObject) (global::haxe.lang.EmptyObject.EMPTY) ));
		}
		
		
		public static new object __hx_create(global::Array arr) {
			return new global::thx.color.TestColor(((int) (global::haxe.lang.Runtime.toInt(arr[0])) ));
		}
		...
		public virtual void testParseHex() {
			unchecked {
				...
				while (( _g1 < _g )) {
					...
					this.assertEquals(global::thx.color._Rgb.Rgb_Impl_.toRgbxa(global::thx.color.palettes.Web.red), global::thx.color.Color.parse("#FF0000"), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"testParseHex", "thx.color.TestColor", "TestColor.hx"}, new int[]{1981972957}, new double[]{((double) (17) )}));
					this.assertEquals(global::thx.color._Rgba.Rgba_Impl_.toRgbxa((global::thx.color._Rgb.Rgb_Impl_.withAlpha(global::thx.color.palettes.Web.red, 0)).@value), global::thx.color.Color.parse("#00FF0000"), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"testParseHex", "thx.color.TestColor", "TestColor.hx"}, new int[]{1981972957}, new double[]{((double) (18) )}));
					this.assertEquals(global::thx.color._Rgb.Rgb_Impl_.toRgbxa(global::thx.color.palettes.Web.red), global::thx.color.Color.parse("ff0000"), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"testParseHex", "thx.color.TestColor", "TestColor.hx"}, new int[]{1981972957}, new double[]{((double) (19) )}));
		...
		public virtual void testParseGrey() {
			unchecked {
				...
				while (( _g1 < _g )) {
					 ++ _g1;
					this.assertEquals(global::thx.color._Grey.Grey_Impl_.toRgbxa(((double) (0.5) )), global::thx.color.Color.parse("grey(0.5)"), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"testParseGrey", "thx.color.TestColor", "TestColor.hx"}, new int[]{1981972957}, new double[]{((double) (27) )}));
					this.assertEquals(global::thx.color._Grey.Grey_Impl_.toRgbxa(((double) (0.5) )), global::thx.color.Color.parse("grey(50%)"), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"testParseGrey", "thx.color.TestColor", "TestColor.hx"}, new int[]{1981972957}, new double[]{((double) (28) )}));
				}
		...
		public virtual void testParseRgb() {
			unchecked {
				...
				while (( _g1 < _g )) {
					...
					this.assertEquals(global::thx.color._Rgba.Rgba_Impl_.toRgbxa(((int) (16711935) )), global::thx.color.Color.parse("rgba(0,255,0,1)"), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"testParseRgb", "thx.color.TestColor", "TestColor.hx"}, new int[]{1981972957}, new double[]{((double) (55) )}));
					this.assertEquals(global::thx.color._Rgba.Rgba_Impl_.toRgbxa(((int) (16711935) )), global::thx.color.Color.parse("rgba(0,100%,0,1)"), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"testParseRgb", "thx.color.TestColor", "TestColor.hx"}, new int[]{1981972957}, new double[]{((double) (56) )}));
				}
