...
public class TS14 : global::haxe.lang.HxObject {
	...
	public static void addTests(global::utest.Runner runner) {
		unchecked {
			...
			global::haxe.Log.trace.__hx_invoke2_o(default(double), global::haxe.lang.Runtime.concat("The value of loop_wrapper is ", w), default(double), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"addTests", "TS14", "TS14.hx"}, new int[]{1981972957}, new double[]{((double) (17) )}));
			int x = (global::Std.parseInt(w)).@value;
			runner.addCase(new global::thx.color.TestRgb(((int) (x) )), null, null, null, null);
		}
	}
