...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me189) {
			__temp_me189.assertations = 0;
			__temp_me189.successes = 0;
			__temp_me189.failures = 0;
			__temp_me189.errors = 0;
			__temp_me189.warnings = 0;
			__temp_me189.isOk = true;
			__temp_me189.hasFailures = false;
			__temp_me189.hasErrors = false;
			__temp_me189.hasWarnings = false;
			__temp_me189.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me189.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me189.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me189.onAddWarnings = new global::utest.Dispatcher<int>();
		}
