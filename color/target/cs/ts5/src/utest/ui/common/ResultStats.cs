...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me158) {
			__temp_me158.assertations = 0;
			__temp_me158.successes = 0;
			__temp_me158.failures = 0;
			__temp_me158.errors = 0;
			__temp_me158.warnings = 0;
			__temp_me158.isOk = true;
			__temp_me158.hasFailures = false;
			__temp_me158.hasErrors = false;
			__temp_me158.hasWarnings = false;
			__temp_me158.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me158.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me158.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me158.onAddWarnings = new global::utest.Dispatcher<int>();
		}
