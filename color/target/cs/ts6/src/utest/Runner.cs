...
namespace utest {
	public class Runner : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_Runner(global::utest.Runner __temp_me174) {
			__temp_me174.globalPattern = null;
			__temp_me174.fixtures = new global::Array<object>();
			__temp_me174.onProgress = new global::utest.Dispatcher<object>();
			__temp_me174.onStart = new global::utest.Dispatcher<object>();
			__temp_me174.onComplete = new global::utest.Dispatcher<object>();
			__temp_me174.onPrecheck = new global::utest.Dispatcher<object>();
			__temp_me174.onTestStart = new global::utest.Dispatcher<object>();
			__temp_me174.onTestComplete = new global::utest.Dispatcher<object>();
			__temp_me174.length = 0;
		}
