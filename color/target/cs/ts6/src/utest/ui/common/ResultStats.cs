...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me191) {
			__temp_me191.assertations = 0;
			__temp_me191.successes = 0;
			__temp_me191.failures = 0;
			__temp_me191.errors = 0;
			__temp_me191.warnings = 0;
			__temp_me191.isOk = true;
			__temp_me191.hasFailures = false;
			__temp_me191.hasErrors = false;
			__temp_me191.hasWarnings = false;
			__temp_me191.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me191.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me191.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me191.onAddWarnings = new global::utest.Dispatcher<int>();
		}
