...
namespace utest.ui.common {
	public class FixtureResult : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_FixtureResult(global::utest.ui.common.FixtureResult __temp_me184, string methodName) {
			__temp_me184.methodName = methodName;
			__temp_me184.list = new global::List<object>();
			__temp_me184.hasTestError = false;
			__temp_me184.hasSetupError = false;
			__temp_me184.hasTeardownError = false;
			__temp_me184.hasTimeoutError = false;
			__temp_me184.hasAsyncError = false;
			__temp_me184.stats = new global::utest.ui.common.ResultStats();
		}
