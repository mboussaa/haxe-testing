...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me190) {
			__temp_me190.assertations = 0;
			__temp_me190.successes = 0;
			__temp_me190.failures = 0;
			__temp_me190.errors = 0;
			__temp_me190.warnings = 0;
			__temp_me190.isOk = true;
			__temp_me190.hasFailures = false;
			__temp_me190.hasErrors = false;
			__temp_me190.hasWarnings = false;
			__temp_me190.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me190.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me190.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me190.onAddWarnings = new global::utest.Dispatcher<int>();
		}
