...
public final class Temperature_Impl_
{
	...
	{
		//line 29 "/shared/color/src/thx/color/Temperature.hx"
		double t = ( kelvin / 100.0 );
		//line 30 "/shared/color/src/thx/color/Temperature.hx"
		double r = 0.0;
		//line 30 "/shared/color/src/thx/color/Temperature.hx"
		double g = 0.0;
		//line 30 "/shared/color/src/thx/color/Temperature.hx"
		double b = 0.0;
		//line 33 "/shared/color/src/thx/color/Temperature.hx"
		if (( t < 66.0 )) 
		{
			//line 34 "/shared/color/src/thx/color/Temperature.hx"
			r = ((double) (1) );
		}
		else
		{
			//line 36 "/shared/color/src/thx/color/Temperature.hx"
			r = ( t - 55.0 );
			//line 37 "/shared/color/src/thx/color/Temperature.hx"
			r = ( (( ( 351.97690566805693 + ( 0.114206453784165 * r ) ) - ( 40.25366309332127 * java.lang.Math.log(r) ) )) / 255 );
			//line 38 "/shared/color/src/thx/color/Temperature.hx"
			if (( r < 0 )) 
			{
				//line 38 "/shared/color/src/thx/color/Temperature.hx"
				r = ((double) (0) );
			...
			//line 39 "/shared/color/src/thx/color/Temperature.hx"
			if (( r > 1 )) 
			{
				//line 39 "/shared/color/src/thx/color/Temperature.hx"
				r = ((double) (1) );
		...
		//line 43 "/shared/color/src/thx/color/Temperature.hx"
		if (( t < 66.0 )) 
		{
			//line 44 "/shared/color/src/thx/color/Temperature.hx"
			g = ( t - 2 );
			//line 45 "/shared/color/src/thx/color/Temperature.hx"
			g = ( (( ( -155.254855627091786 - ( 0.44596950469579133 * g ) ) + ( 104.49216199393888 * java.lang.Math.log(g) ) )) / 255 );
			//line 46 "/shared/color/src/thx/color/Temperature.hx"
			if (( g < 0 )) 
			{
				//line 46 "/shared/color/src/thx/color/Temperature.hx"
				g = ((double) (0) );
			...
			//line 47 "/shared/color/src/thx/color/Temperature.hx"
			if (( g > 1 )) 
			{
				//line 47 "/shared/color/src/thx/color/Temperature.hx"
				g = ((double) (1) );
		...
		{
			//line 49 "/shared/color/src/thx/color/Temperature.hx"
			g = ( t - 50 );
			//line 50 "/shared/color/src/thx/color/Temperature.hx"
			g = ( (( ( 325.4494125711974 + ( 0.07943456536662342 * g ) ) - ( 28.0852963507957 * java.lang.Math.log(g) ) )) / 255 );
			//line 51 "/shared/color/src/thx/color/Temperature.hx"
			if (( g < 0 )) 
			{
				//line 51 "/shared/color/src/thx/color/Temperature.hx"
				g = ((double) (0) );
			...
			//line 52 "/shared/color/src/thx/color/Temperature.hx"
			if (( g > 1 )) 
			{
				//line 52 "/shared/color/src/thx/color/Temperature.hx"
				g = ((double) (1) );
		...
		//line 56 "/shared/color/src/thx/color/Temperature.hx"
		if (( t >= 66.0 )) 
		{
			//line 57 "/shared/color/src/thx/color/Temperature.hx"
			b = ((double) (1) );
		}
		else
		{
			//line 58 "/shared/color/src/thx/color/Temperature.hx"
			if (( t <= 20.0 )) 
			{
				//line 59 "/shared/color/src/thx/color/Temperature.hx"
				b = ((double) (0) );
			}
			else
			{
				//line 61 "/shared/color/src/thx/color/Temperature.hx"
				b = ( t - 10 );
				//line 62 "/shared/color/src/thx/color/Temperature.hx"
				b = ( (( ( -254.769351841209016 + ( 0.8274096064007395 * b ) ) + ( 115.67994401066147 * java.lang.Math.log(b) ) )) / 255 );
				//line 63 "/shared/color/src/thx/color/Temperature.hx"
				if (( b < 0 )) 
				{
					//line 63 "/shared/color/src/thx/color/Temperature.hx"
					b = ((double) (0) );
				...
				//line 64 "/shared/color/src/thx/color/Temperature.hx"
				if (( b > 1 )) 
				{
					//line 64 "/shared/color/src/thx/color/Temperature.hx"
					b = ((double) (1) );
		...
		//line 67 "/shared/color/src/thx/color/Temperature.hx"
	...
	{
		//line 71 "/shared/color/src/thx/color/Temperature.hx"
		return ((double) (v) );
	}
	...
	{
		//line 74 "/shared/color/src/thx/color/Temperature.hx"
		thx.color.parse.ColorInfo info = thx.color.parse.ColorParser.parseColor(color);
		//line 75 "/shared/color/src/thx/color/Temperature.hx"
		if (( null == info )) 
		{
			//line 76 "/shared/color/src/thx/color/Temperature.hx"
			return null;
		}
		
		//line 78 "/shared/color/src/thx/color/Temperature.hx"
		try 
		{
			//line 78 "/shared/color/src/thx/color/Temperature.hx"
	...
	{
		//line 87 "/shared/color/src/thx/color/Temperature.hx"
	...
	{
		//line 91 "/shared/color/src/thx/color/Temperature.hx"
	...
	{
		//line 94 "/shared/color/src/thx/color/Temperature.hx"
	...
	{
		//line 97 "/shared/color/src/thx/color/Temperature.hx"
	...
	{
		//line 100 "/shared/color/src/thx/color/Temperature.hx"
	...
	{
		//line 103 "/shared/color/src/thx/color/Temperature.hx"
	...
	{
		//line 106 "/shared/color/src/thx/color/Temperature.hx"
	...
	public static boolean nearEquals(double this1, double other, java.lang.Object tolerance)
	{
		...
		//line 109 "/shared/color/src/thx/color/Temperature.hx"
		return thx.Floats.nearEquals(this1, ((double) (other) ), __temp_tolerance139);
	}
	
	
	public static double get_kelvin(double this1)
	{
		//line 112 "/shared/color/src/thx/color/Temperature.hx"
		return this1;
	}
	...
	{
		//line 115 "/shared/color/src/thx/color/Temperature.hx"
	...
	{
		//line 118 "/shared/color/src/thx/color/Temperature.hx"
	...
	{
		//line 121 "/shared/color/src/thx/color/Temperature.hx"
	...
	{
		//line 124 "/shared/color/src/thx/color/Temperature.hx"
	...
	{
		//line 127 "/shared/color/src/thx/color/Temperature.hx"
	...
	{
		//line 130 "/shared/color/src/thx/color/Temperature.hx"
	...
	{
		//line 133 "/shared/color/src/thx/color/Temperature.hx"
	...
	{
		//line 136 "/shared/color/src/thx/color/Temperature.hx"
	...
	{
		//line 139 "/shared/color/src/thx/color/Temperature.hx"
	...
	{
		//line 142 "/shared/color/src/thx/color/Temperature.hx"
	...
	{
		//line 145 "/shared/color/src/thx/color/Temperature.hx"
	...
	{
		//line 148 "/shared/color/src/thx/color/Temperature.hx"
		...
		//line 148 "/shared/color/src/thx/color/Temperature.hx"
		double b = 0.0;
		//line 152 "/shared/color/src/thx/color/Temperature.hx"
		if (( t <= 66 )) 
		{
			//line 153 "/shared/color/src/thx/color/Temperature.hx"
			r = ((double) (1) );
		}
		else
		{
			//line 155 "/shared/color/src/thx/color/Temperature.hx"
			r = ( t - 60 );
			//line 156 "/shared/color/src/thx/color/Temperature.hx"
			r = ( ( 329.698727446 * java.lang.Math.pow(r, -0.1332047592) ) / 1 );
			//line 157 "/shared/color/src/thx/color/Temperature.hx"
			if (( r < 0 )) 
			{
				//line 157 "/shared/color/src/thx/color/Temperature.hx"
				r = ((double) (0) );
			...
			//line 158 "/shared/color/src/thx/color/Temperature.hx"
			if (( r > 1 )) 
			{
				//line 158 "/shared/color/src/thx/color/Temperature.hx"
				r = ((double) (1) );
		...
		//line 162 "/shared/color/src/thx/color/Temperature.hx"
		if (( t <= 66.0 )) 
		{
			//line 163 "/shared/color/src/thx/color/Temperature.hx"
			g = t;
			//line 164 "/shared/color/src/thx/color/Temperature.hx"
			g = ( (( ( 99.4708025861 * java.lang.Math.log(t) ) - 161.1195681661 )) / 1 );
			//line 165 "/shared/color/src/thx/color/Temperature.hx"
			if (( g < 0 )) 
			{
				//line 165 "/shared/color/src/thx/color/Temperature.hx"
				g = ((double) (0) );
			...
			//line 166 "/shared/color/src/thx/color/Temperature.hx"
			if (( g > 1 )) 
			{
				//line 166 "/shared/color/src/thx/color/Temperature.hx"
				g = ((double) (1) );
		...
		{
			//line 168 "/shared/color/src/thx/color/Temperature.hx"
			g = ( t - 60.0 );
			//line 169 "/shared/color/src/thx/color/Temperature.hx"
			g = ( ( 288.1221695283 * java.lang.Math.pow(g, -0.0755148492) ) / 1 );
			//line 170 "/shared/color/src/thx/color/Temperature.hx"
			if (( g < 0 )) 
			{
				//line 170 "/shared/color/src/thx/color/Temperature.hx"
				g = ((double) (0) );
			...
			//line 171 "/shared/color/src/thx/color/Temperature.hx"
			if (( g > 1 )) 
			{
				//line 171 "/shared/color/src/thx/color/Temperature.hx"
				g = ((double) (1) );
		...
		//line 175 "/shared/color/src/thx/color/Temperature.hx"
		if (( t >= 66.0 )) 
		{
			//line 176 "/shared/color/src/thx/color/Temperature.hx"
			b = ((double) (1) );
		}
		else
		{
			//line 177 "/shared/color/src/thx/color/Temperature.hx"
			if (( t <= 19.0 )) 
			{
				//line 178 "/shared/color/src/thx/color/Temperature.hx"
				b = ((double) (0) );
			}
			else
			{
				//line 180 "/shared/color/src/thx/color/Temperature.hx"
				b = ( t - 10 );
				//line 181 "/shared/color/src/thx/color/Temperature.hx"
				b = ( (( ( 138.5177312231 * java.lang.Math.log(b) ) - 305.0447927307 )) / 1 );
				//line 182 "/shared/color/src/thx/color/Temperature.hx"
				if (( b < 0 )) 
				{
					//line 182 "/shared/color/src/thx/color/Temperature.hx"
					b = ((double) (0) );
				...
				//line 183 "/shared/color/src/thx/color/Temperature.hx"
				if (( b > 1 )) 
				{
					//line 183 "/shared/color/src/thx/color/Temperature.hx"
					b = ((double) (1) );
		...
		//line 185 "/shared/color/src/thx/color/Temperature.hx"
	...
	{
		//line 189 "/shared/color/src/thx/color/Temperature.hx"
	...
	{
		//line 192 "/shared/color/src/thx/color/Temperature.hx"
	...
	{
		//line 195 "/shared/color/src/thx/color/Temperature.hx"
	...
	{
		//line 198 "/shared/color/src/thx/color/Temperature.hx"
	...
	{
		//line 201 "/shared/color/src/thx/color/Temperature.hx"
