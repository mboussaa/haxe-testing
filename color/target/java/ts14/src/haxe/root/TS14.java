...
public class TS14 extends haxe.lang.HxObject
{
	...
	public TS14()
	{
		//line 6 "/shared/color/test/TS14.hx"
	...
	{
		//line 14 "/shared/color/test/TS14.hx"
		java.lang.String w = "";
		//line 15 "/shared/color/test/TS14.hx"
		{
			//line 15 "/shared/color/test/TS14.hx"
			int _g = 0;
			//line 15 "/shared/color/test/TS14.hx"
			...
			while (( _g < _g1.length ))
			{
				...
				//line 15 "/shared/color/test/TS14.hx"
				 ++ _g;
				//line 16 "/shared/color/test/TS14.hx"
				w = arg;
			}
			
		}
		
		//line 17 "/shared/color/test/TS14.hx"
		haxe.Log.trace.__hx_invoke2_o(0.0, ( "The value of loop_wrapper is " + w ), 0.0, new haxe.lang.DynamicObject(new java.lang.String[]{"className", "fileName", "methodName"}, new java.lang.Object[]{"TS14", "TS14.hx", "addTests"}, new java.lang.String[]{"lineNumber"}, new double[]{((double) (((double) (17) )) )}));
		//line 19 "/shared/color/test/TS14.hx"
		int x = ((int) (haxe.lang.Runtime.toInt(haxe.root.Std.parseInt(w))) );
		//line 20 "/shared/color/test/TS14.hx"
		runner.addCase(new thx.color.TestRgb(((int) (x) )), null, null, null, null);
	}
	...
	public static void main()
	{
		...
		//line 27 "/shared/color/test/TS14.hx"
		utest.ui.Report.create(runner, null, null);
		//line 28 "/shared/color/test/TS14.hx"
		runner.run();
	}
