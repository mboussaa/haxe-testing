...
public class Color extends haxe.lang.HxObject
{
	static
	{
		//line 11 "/shared/color/src/thx/color/Color.hx"
	...
	public Color()
	{
		//line 10 "/shared/color/src/thx/color/Color.hx"
	...
	{
		//line 17 "/shared/color/src/thx/color/Color.hx"
		thx.color.parse.ColorInfo info = thx.color.parse.ColorParser.parseHex(color);
		//line 18 "/shared/color/src/thx/color/Color.hx"
		if (( null == info )) 
		{
			//line 19 "/shared/color/src/thx/color/Color.hx"
			info = thx.color.parse.ColorParser.parseColor(color);
		}
		
		//line 20 "/shared/color/src/thx/color/Color.hx"
		if (( null == info )) 
		{
			//line 21 "/shared/color/src/thx/color/Color.hx"
			haxe.root.Array<java.lang.Object> rgb = ((haxe.root.Array<java.lang.Object>) (thx.color.Color.namedColors.get(color)) );
			//line 22 "/shared/color/src/thx/color/Color.hx"
			if (( null == rgb )) 
			{
				//line 23 "/shared/color/src/thx/color/Color.hx"
				return null;
			}
			else
			{
				//line 25 "/shared/color/src/thx/color/Color.hx"
				return thx.color._Rgbx.Rgbx_Impl_.toRgbxa(rgb);
			}
			
		}
		
		//line 28 "/shared/color/src/thx/color/Color.hx"
		try 
		{
			//line 28 "/shared/color/src/thx/color/Color.hx"
	...
	{
		//line 75 "/shared/color/src/thx/color/Color.hx"
