...
public class Std
{
	...
	{
		//line 139 "/usr/lib/haxe/std/java/_std/Std.hx"
		if (( x == null )) 
		{
			//line 139 "/usr/lib/haxe/std/java/_std/Std.hx"
		...
		//line 140 "/usr/lib/haxe/std/java/_std/Std.hx"
		x = haxe.root.StringTools.ltrim(x);
		//line 141 "/usr/lib/haxe/std/java/_std/Std.hx"
		boolean found = false;
		//line 141 "/usr/lib/haxe/std/java/_std/Std.hx"
		...
		//line 143 "/usr/lib/haxe/std/java/_std/Std.hx"
		int i = -1;
		//line 146 "/usr/lib/haxe/std/java/_std/Std.hx"
		{
			//line 146 "/usr/lib/haxe/std/java/_std/Std.hx"
			label1:
			//line 146 "/usr/lib/haxe/std/java/_std/Std.hx"
			while ((  ++ i < x.length() ))
			{
				//line 148 "/usr/lib/haxe/std/java/_std/Std.hx"
				int chr = ((int) (((char) (x.charAt(i)) )) );
				//line 149 "/usr/lib/haxe/std/java/_std/Std.hx"
				if (( ( chr >= 48 ) && ( chr <= 57 ) )) 
				{
					//line 151 "/usr/lib/haxe/std/java/_std/Std.hx"
					if (hasE) 
					{
						//line 153 "/usr/lib/haxe/std/java/_std/Std.hx"
						hasEData = true;
					}
					
					//line 155 "/usr/lib/haxe/std/java/_std/Std.hx"
					found = true;
				}
				else
				{
					//line 156 "/usr/lib/haxe/std/java/_std/Std.hx"
					switch (chr)
					{
						case 43:
						case 45:
						{
							//line 161 "/usr/lib/haxe/std/java/_std/Std.hx"
							if ((  ! (found)  &&  ! (hasSign)  )) 
							{
								//line 162 "/usr/lib/haxe/std/java/_std/Std.hx"
								hasSign = true;
							}
							else
							{
								//line 163 "/usr/lib/haxe/std/java/_std/Std.hx"
								if (( ( ( found &&  ! (hasESign)  ) && hasE ) &&  ! (hasEData)  )) 
								{
									//line 164 "/usr/lib/haxe/std/java/_std/Std.hx"
									hasESign = true;
								}
								else
								{
									//line 166 "/usr/lib/haxe/std/java/_std/Std.hx"
									break label1;
								}
						...
						case 46:
						{
							//line 159 "/usr/lib/haxe/std/java/_std/Std.hx"
							if ( ! (hasDot) ) 
							{
								//line 160 "/usr/lib/haxe/std/java/_std/Std.hx"
								hasDot = true;
							}
							else
							{
						...
						case 101:
						{
							//line 157 "/usr/lib/haxe/std/java/_std/Std.hx"
							if ( ! (hasE) ) 
							{
								//line 158 "/usr/lib/haxe/std/java/_std/Std.hx"
								hasE = true;
							}
							else
							{
		...
		//line 169 "/usr/lib/haxe/std/java/_std/Std.hx"
		if (( hasE &&  ! (hasEData)  )) 
		{
			//line 171 "/usr/lib/haxe/std/java/_std/Std.hx"
			 -- i;
			//line 172 "/usr/lib/haxe/std/java/_std/Std.hx"
			if (hasESign) 
			{
				//line 173 "/usr/lib/haxe/std/java/_std/Std.hx"
				 -- i;
			}
			
		}
		
		//line 176 "/usr/lib/haxe/std/java/_std/Std.hx"
		if (( i != x.length() )) 
		{
			//line 178 "/usr/lib/haxe/std/java/_std/Std.hx"
			x = haxe.lang.StringExt.substr(x, 0, i);
		}
		
		//line 180 "/usr/lib/haxe/std/java/_std/Std.hx"
		try 
		{
			//line 180 "/usr/lib/haxe/std/java/_std/Std.hx"
	...
	{
		//line 191 "/usr/lib/haxe/std/java/_std/Std.hx"
		if (( x <= 0 )) 
		{
			//line 191 "/usr/lib/haxe/std/java/_std/Std.hx"
			return 0;
		...
		//line 192 "/usr/lib/haxe/std/java/_std/Std.hx"
