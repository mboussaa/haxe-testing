...
void TS6_obj::addTests( ::utest::Runner runner){
            	HX_STACK_FRAME("TS6","addTests",0x58f58b77,"TS6.addTests","TS6.hx",8,0x84113d47)
...
HXLINE(  18)		::haxe::Log_obj::trace((HX_("The value of loop_wrapper is ",79,76,58,6c) + w),hx::SourceInfo(HX_("TS6.hx",47,3d,11,84),18,HX_("TS6",d7,05,40,00),HX_("addTests",00,a6,f2,86)));
HXLINE(  20)		HX_VARI( Int,x) = ::Std_obj::parseInt(w);
HXLINE(  21)		runner->addCase( ::thx::color::TestConversion_obj::__new(x),null(),null(),null(),null());
            	}
...
void TS6_obj::main(){
            	HX_STACK_FRAME("TS6","main",0x9c0d5630,"TS6.main","TS6.hx",24,0x84113d47)
HXLINE(  26)		HX_VARI(  ::utest::Runner,runner) =  ::utest::Runner_obj::__new();
HXLINE(  27)		::TS6_obj::addTests(runner);
