...
::thx::color::palettes::Web_obj::__register();
...
::thx::color::Color_obj::__register();
...
::thx::color::TestConversion_obj::__register();
...
::thx::color::palettes::Web_obj::__init__();
::haxe::Log_obj::__boot();
