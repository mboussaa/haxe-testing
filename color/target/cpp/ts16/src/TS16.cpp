...
void TS16_obj::addTests( ::utest::Runner runner){
            	HX_STACK_FRAME("TS16","addTests",0xdcd50d8a,"TS16.addTests","TS16.hx",7,0x2f211f1a)
            	HX_STACK_ARG(runner,"runner")
HXLINE(   7)		runner->addCase( ::thx::color::TestTemperature_obj::__new(),null(),null(),null(),null());
            	}
...
void TS16_obj::main(){
            	HX_STACK_FRAME("TS16","main",0x143792c3,"TS16.main","TS16.hx",14,0x2f211f1a)
HXLINE(  15)		HX_VARI(  ::utest::Runner,runner) =  ::utest::Runner_obj::__new();
HXLINE(  16)		::TS16_obj::addTests(runner);
