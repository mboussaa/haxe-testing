...
void TS3_obj::addTests( ::utest::Runner runner){
            	HX_STACK_FRAME("TS3","addTests",0x181623da,"TS3.addTests","TS3.hx",8,0x8215996a)
            	HX_STACK_ARG(runner,"runner")
HXLINE(   8)		runner->addCase( ::thx::color::TestLuv_obj::__new(),null(),null(),null(),null());
            	}
...
void TS3_obj::main(){
            	HX_STACK_FRAME("TS3","main",0x68fb4113,"TS3.main","TS3.hx",11,0x8215996a)
HXLINE(  12)		HX_VARI(  ::utest::Runner,runner) =  ::utest::Runner_obj::__new();
HXLINE(  13)		::TS3_obj::addTests(runner);
