...
#define INCLUDED_thx_color__Yuv_Yuv_Impl_

#ifndef HXCPP_H
#include <hxcpp.h>
#endif

HX_DECLARE_CLASS3(thx,color,_Yuv,Yuv_Impl_)
...
class HXCPP_CLASS_ATTRIBUTES Yuv_Impl__obj : public hx::Object
{
	public:
		typedef hx::Object super;
		typedef Yuv_Impl__obj OBJ_;
		Yuv_Impl__obj();

	public:
		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=false,const char *inName="thx.color._Yuv.Yuv_Impl_")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,false,"thx.color._Yuv.Yuv_Impl_"); }
		static hx::ObjectPtr< Yuv_Impl__obj > __new();
		...
		::String __ToString() const { return HX_HCSTRING("Yuv_Impl_","\x1a","\xa3","\x69","\xf1"); }

		static ::Array< Float > create(Float y,Float u,Float v);
...
#endif /* INCLUDED_thx_color__Yuv_Yuv_Impl_ */ 
