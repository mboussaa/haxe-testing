...
#define INCLUDED_thx_color__Rgbx_Rgbx_Impl_

#ifndef HXCPP_H
#include <hxcpp.h>
#endif

HX_DECLARE_CLASS3(thx,color,_Rgbx,Rgbx_Impl_)
...
class HXCPP_CLASS_ATTRIBUTES Rgbx_Impl__obj : public hx::Object
{
	public:
		typedef hx::Object super;
		typedef Rgbx_Impl__obj OBJ_;
		Rgbx_Impl__obj();

	public:
		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=false,const char *inName="thx.color._Rgbx.Rgbx_Impl_")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,false,"thx.color._Rgbx.Rgbx_Impl_"); }
		static hx::ObjectPtr< Rgbx_Impl__obj > __new();
		...
		::String __ToString() const { return HX_HCSTRING("Rgbx_Impl_","\xcb","\x3b","\xe4","\x26"); }

		static ::Array< Float > create(Float red,Float green,Float blue);
		...
		static ::Array< Float > toCubeHelixWithGamma(::Array< Float > this1,Float gamma);
		static ::Dynamic toCubeHelixWithGamma_dyn();

		static Float toGrey(::Array< Float > this1);
		static ::Dynamic toGrey_dyn();

		static Float toPerceivedGrey(::Array< Float > this1);
		static ::Dynamic toPerceivedGrey_dyn();

		static Float toPerceivedAccurateGrey(::Array< Float > this1);
		static ::Dynamic toPerceivedAccurateGrey_dyn();
...
#endif /* INCLUDED_thx_color__Rgbx_Rgbx_Impl_ */ 
