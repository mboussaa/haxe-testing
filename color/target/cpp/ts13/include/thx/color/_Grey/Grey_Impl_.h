...
#define INCLUDED_thx_color__Grey_Grey_Impl_

#ifndef HXCPP_H
#include <hxcpp.h>
#endif

HX_DECLARE_CLASS3(thx,color,_Grey,Grey_Impl_)
...
class HXCPP_CLASS_ATTRIBUTES Grey_Impl__obj : public hx::Object
{
	public:
		typedef hx::Object super;
		typedef Grey_Impl__obj OBJ_;
		Grey_Impl__obj();

	public:
		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=false,const char *inName="thx.color._Grey.Grey_Impl_")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,false,"thx.color._Grey.Grey_Impl_"); }
		static hx::ObjectPtr< Grey_Impl__obj > __new();
		...
		::String __ToString() const { return HX_HCSTRING("Grey_Impl_","\x5f","\x65","\x3d","\xc9"); }
		...
		static Float _new(Float grey);
		static ::Dynamic _new_dyn();

		static Float contrast(Float this1);
		static ::Dynamic contrast_dyn();

		static Float darker(Float this1,Float t);
		static ::Dynamic darker_dyn();

		static Float lighter(Float this1,Float t);
		...
		static Float normalize(Float this1);
		...
		static Float get_grey(Float this1);
		static ::Dynamic get_grey_dyn();
		...
		static Float toTemperature(Float this1);
...
#endif /* INCLUDED_thx_color__Grey_Grey_Impl_ */ 
