...
#define INCLUDED_thx_color__CubeHelix_CubeHelix_Impl_

#ifndef HXCPP_H
#include <hxcpp.h>
#endif

HX_DECLARE_CLASS3(thx,color,_CubeHelix,CubeHelix_Impl_)
...
class HXCPP_CLASS_ATTRIBUTES CubeHelix_Impl__obj : public hx::Object
{
	public:
		typedef hx::Object super;
		typedef CubeHelix_Impl__obj OBJ_;
		CubeHelix_Impl__obj();

	public:
		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=false,const char *inName="thx.color._CubeHelix.CubeHelix_Impl_")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,false,"thx.color._CubeHelix.CubeHelix_Impl_"); }
		static hx::ObjectPtr< CubeHelix_Impl__obj > __new();
		...
		::String __ToString() const { return HX_HCSTRING("CubeHelix_Impl_","\x89","\xac","\x59","\xf5"); }
		...
		static Float EB;
		static Float BC_DA;
		static ::Array< Float > create(Float hue,Float saturation,Float lightness, ::Dynamic gamma);
		...
		static ::Array< Float > withGamma(::Array< Float > this1,Float newgamma);
		static ::Dynamic withGamma_dyn();
		...
		static Float get_gamma(::Array< Float > this1);
		static ::Dynamic get_gamma_dyn();
...
#endif /* INCLUDED_thx_color__CubeHelix_CubeHelix_Impl_ */ 
