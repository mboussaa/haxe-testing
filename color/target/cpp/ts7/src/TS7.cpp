...
void TS7_obj::addTests( ::utest::Runner runner){
            	HX_STACK_FRAME("TS7","addTests",0x19400356,"TS7.addTests","TS7.hx",12,0x84ba73e6)
            	HX_STACK_ARG(runner,"runner")
HXLINE(  12)		runner->addCase( ::thx::color::TestCmy_obj::__new(),null(),null(),null(),null());
            	}
...
void TS7_obj::main(){
            	HX_STACK_FRAME("TS7","main",0x0268b28f,"TS7.main","TS7.hx",15,0x84ba73e6)
HXLINE(  16)		HX_VARI(  ::utest::Runner,runner) =  ::utest::Runner_obj::__new();
HXLINE(  17)		::TS7_obj::addTests(runner);
HXLINE(  18)		::utest::ui::Report_obj::create(runner,null(),null());
HXLINE(  19)		runner->run();
            	}
