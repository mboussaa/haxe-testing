...
void TS5_obj::addTests( ::utest::Runner runner){
            	HX_STACK_FRAME("TS5","addTests",0x98ab1398,"TS5.addTests","TS5.hx",10,0x836806a8)
            	HX_STACK_ARG(runner,"runner")
HXLINE(  10)		runner->addCase( ::thx::color::TestColorParser_obj::__new(),null(),null(),null(),null());
            	}
...
void TS5_obj::main(){
            	HX_STACK_FRAME("TS5","main",0x35b1f9d1,"TS5.main","TS5.hx",13,0x836806a8)
HXLINE(  14)		HX_VARI(  ::utest::Runner,runner) =  ::utest::Runner_obj::__new();
HXLINE(  15)		::TS5_obj::addTests(runner);
HXLINE(  16)		::utest::ui::Report_obj::create(runner,null(),null());
HXLINE(  17)		runner->run();
            	}
