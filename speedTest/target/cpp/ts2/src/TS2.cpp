...
HXLINE(  13)		runner->addCase( ::thx::speedTest::TestArray_obj::__new(x),null(),null(),null(),null());
            	}
...
void TS2_obj::main(){
            	HX_STACK_FRAME("TS2","main",0x029fe4b4,"TS2.main","TS2.hx",16,0x816c62cb)
HXLINE(  18)		HX_VARI(  ::utest::Runner,runner) =  ::utest::Runner_obj::__new();
HXLINE(  19)		::TS2_obj::addTests(runner);
