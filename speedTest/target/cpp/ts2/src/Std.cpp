...
Bool Std_obj::is( ::Dynamic v, ::Dynamic t){
            	HX_STACK_FRAME("Std","is",0x3c56d6f5,"Std.is","/usr/lib/haxe/std/cpp/_std/Std.hx",24,0x1614e339)
            	HX_STACK_ARG(v,"v")
            	HX_STACK_ARG(t,"t")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Std_obj,is,return )
 ...
 ::Dynamic Std_obj::instance( ::Dynamic value,hx::Class c){
            	HX_STACK_FRAME("Std","instance",0x1431f4e0,"Std.instance","/usr/lib/haxe/std/cpp/_std/Std.hx",28,0x1614e339)
...
Int Std_obj::_hx_int(Float x){
            	HX_STACK_FRAME("Std","int",0x8fa53b84,"Std.int","/usr/lib/haxe/std/cpp/_std/Std.hx",36,0x1614e339)
            	HX_STACK_ARG(x,"x")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Std_obj,_hx_int,return )
 ...
 ::Dynamic Std_obj::parseInt(::String x){
            	HX_STACK_FRAME("Std","parseInt",0x90c2ebc7,"Std.parseInt","/usr/lib/haxe/std/cpp/_std/Std.hx",40,0x1614e339)
            	HX_STACK_ARG(x,"x")
...
Float Std_obj::parseFloat(::String x){
            	HX_STACK_FRAME("Std","parseFloat",0xbca10a74,"Std.parseFloat","/usr/lib/haxe/std/cpp/_std/Std.hx",44,0x1614e339)
            	HX_STACK_ARG(x,"x")
