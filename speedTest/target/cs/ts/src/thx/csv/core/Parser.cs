...
namespace thx.csv.core {
	public class Parser : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_csv_core_Parser(global::thx.csv.core.Parser __temp_me136, string delimiter, string quote, string escapedQuote) {
			__temp_me136.delimiter = delimiter;
			__temp_me136.quote = quote;
			__temp_me136.escapedQuote = escapedQuote;
		}
