...
TS1.addTests = function(runner) {
	...
	runner.addCase(new thx_speedTest_TestVector(Std.parseInt(w)));
};
TS1.main = function() {
...
var thx_speedTest_TestVector = function(i) {
	this.x = i;
};
thx_speedTest_TestVector.__name__ = ["thx","speedTest","TestVector"];
thx_speedTest_TestVector.prototype = {
	x: null
