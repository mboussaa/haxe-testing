...
TS3.addTests = function(runner) {
	...
	runner.addCase(new thx_speedTest_TestArrayFill(Std.parseInt(w)));
};
TS3.main = function() {
...
var thx_speedTest_TestArrayFill = function(i) {
	this.x = i;
};
thx_speedTest_TestArrayFill.__name__ = ["thx","speedTest","TestArrayFill"];
thx_speedTest_TestArrayFill.prototype = {
	x: null
	,testInitialisation: function() {
		var x = [];
		var _g = 0;
		while(_g < 10000000) x[_g++] = 0;
	}
	,__class__: thx_speedTest_TestArrayFill
};
