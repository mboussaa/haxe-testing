...
TS2.addTests = function(runner) {
	...
	runner.addCase(new thx_speedTest_TestArray(Std.parseInt(w)));
};
TS2.main = function() {
...
var thx_speedTest_TestArray = function(i) {
	this.x = i;
};
thx_speedTest_TestArray.__name__ = ["thx","speedTest","TestArray"];
thx_speedTest_TestArray.prototype = {
	x: null
