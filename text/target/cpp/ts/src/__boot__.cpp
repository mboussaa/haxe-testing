...
::thx::text::table::Border_obj::__register();
::thx::text::table::BorderStyle_obj::__register();
::thx::text::table::CellType_obj::__register();
::thx::text::table::Span_obj::__register();
::thx::text::table::HAlign_obj::__register();
::thx::text::table::CellValueImpl_obj::__register();
::thx::text::table::SymbolImpl_obj::__register();
::thx::fp::MapImpl_obj::__register();
::thx::format::_NumberFormat::CustomFormat_obj::__register();
...
::thx::text::table::DefaultStyle_obj::__register();
::thx::text::Inflections_obj::__register();
::thx::fp::_Map::Map_Impl__obj::__register();
::thx::format::NumberFormat_obj::__register();
::thx::culture::Pattern_obj::__register();
::thx::culture::Culture_obj::__register();
::thx::culture::NumberFormatInfo_obj::__register();
...
::thx::text::table::CompositeStyle_obj::__register();
::thx::text::table::Style_obj::__register();
::thx::text::table::IStyle_obj::__register();
::thx::text::table::StringBlock_obj::__register();
::thx::text::table::Row_obj::__register();
::thx::text::table::Renderer_obj::__register();
::thx::text::table::Col_obj::__register();
::thx::text::table::_CellValue::CellValue_Impl__obj::__register();
::thx::text::table::CellSet_obj::__register();
::thx::text::table::Cell_obj::__register();
::thx::text::table::_Canvas::Symbol_Impl__obj::__register();
::thx::text::table::Canvas_obj::__register();
::thx::text::TestTable_obj::__register();
::thx::text::TestInflections_obj::__register();
::thx::text::Table_obj::__register();
::thx::format::TimeFormat_obj::__register();
::thx::format::Format_obj::__register();
::thx::format::DateFormat_obj::__register();
::thx::error::ErrorWrapper_obj::__register();
::thx::culture::Embed_obj::__register();
...
::thx::text::table::Border_obj::__boot();
::thx::text::table::BorderStyle_obj::__boot();
::thx::text::table::CellType_obj::__boot();
::thx::text::table::Span_obj::__boot();
::thx::text::table::HAlign_obj::__boot();
::thx::text::table::CellValueImpl_obj::__boot();
::thx::text::table::SymbolImpl_obj::__boot();
::thx::fp::MapImpl_obj::__boot();
::thx::format::_NumberFormat::CustomFormat_obj::__boot();
...
::thx::culture::Culture_obj::__init__();
::haxe::Log_obj::__boot();
...
::thx::culture::NumberFormatInfo_obj::__boot();
::thx::culture::Culture_obj::__boot();
::thx::culture::Pattern_obj::__boot();
::thx::format::NumberFormat_obj::__boot();
::thx::fp::_Map::Map_Impl__obj::__boot();
::thx::text::Inflections_obj::__boot();
::thx::text::table::DefaultStyle_obj::__boot();
