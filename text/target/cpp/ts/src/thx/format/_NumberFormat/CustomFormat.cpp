...
::thx::format::_NumberFormat::CustomFormat CustomFormat_obj::Hash(Bool first)
{
	return hx::CreateEnum< CustomFormat_obj >(HX_("Hash",ee,5b,e1,2f),1,1)->_hx_init(0,first);
}

::thx::format::_NumberFormat::CustomFormat CustomFormat_obj::Literal(::String s)
{
	return hx::CreateEnum< CustomFormat_obj >(HX_("Literal",4f,d1,6c,61),0,1)->_hx_init(0,s);
}

::thx::format::_NumberFormat::CustomFormat CustomFormat_obj::Zero(Bool first)
{
...
hx::Static(__mClass) = hx::_hx_RegisterClass(HX_HCSTRING("thx.format._NumberFormat.CustomFormat","\x44","\xe5","\xa7","\xab"), hx::TCanCast< CustomFormat_obj >,CustomFormat_obj_sStaticFields,0,
