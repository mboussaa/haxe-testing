...
TS1.addTests = function(runner) {
	...
	runner.addCase(new thx_text_TestInflections(Std.parseInt(w)));
};
TS1.main = function() {
...
var thx_text_TestInflections = function(i) {
	this.x = i;
};
...
thx_text_TestInflections.prototype = {
	...
	,testUncountable: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("information",thx_text_Inflections.pluralize("information"),null,{ fileName : "TestInflections.hx", lineNumber : 14, className : "thx.text.TestInflections", methodName : "testUncountable"});
			utest_Assert.equals("news",thx_text_Inflections.pluralize("news"),null,{ fileName : "TestInflections.hx", lineNumber : 15, className : "thx.text.TestInflections", methodName : "testUncountable"});
		}
	}
	,testPluralize: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("days",thx_text_Inflections.pluralize("day"),null,{ fileName : "TestInflections.hx", lineNumber : 20, className : "thx.text.TestInflections", methodName : "testPluralize"});
			utest_Assert.equals("women",thx_text_Inflections.pluralize("woman"),null,{ fileName : "TestInflections.hx", lineNumber : 21, className : "thx.text.TestInflections", methodName : "testPluralize"});
			utest_Assert.equals("autobuses",thx_text_Inflections.pluralize("autobus"),null,{ fileName : "TestInflections.hx", lineNumber : 22, className : "thx.text.TestInflections", methodName : "testPluralize"});
			utest_Assert.equals("quizzes",thx_text_Inflections.pluralize("quiz"),null,{ fileName : "TestInflections.hx", lineNumber : 23, className : "thx.text.TestInflections", methodName : "testPluralize"});
		}
	}
	,testSingularize: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals("day",thx_text_Inflections.singularize("days"),null,{ fileName : "TestInflections.hx", lineNumber : 28, className : "thx.text.TestInflections", methodName : "testSingularize"});
			utest_Assert.equals("woman",thx_text_Inflections.singularize("women"),null,{ fileName : "TestInflections.hx", lineNumber : 29, className : "thx.text.TestInflections", methodName : "testSingularize"});
			utest_Assert.equals("autobus",thx_text_Inflections.singularize("autobuses"),null,{ fileName : "TestInflections.hx", lineNumber : 30, className : "thx.text.TestInflections", methodName : "testSingularize"});
			utest_Assert.equals("quiz",thx_text_Inflections.singularize("quizzes"),null,{ fileName : "TestInflections.hx", lineNumber : 31, className : "thx.text.TestInflections", methodName : "testSingularize"});
		}
	}
