...
TS2.addTests = function(runner) {
	...
	runner.addCase(new thx_text_TestTable(Std.parseInt(w)));
};
TS2.main = function() {
...
var thx_text_TestTable = function(i) {
	this.x = i;
};
...
thx_text_TestTable.prototype = {
	...
	,testPaintBorder: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.equals("┌─┐\n│ │\n└─┘",canvas.toString(),null,{ fileName : "TestTable.hx", lineNumber : 25, className : "thx.text.TestTable", methodName : "testPaintBorder"});
			canvas = new thx_text_table_Canvas(4,4);
			canvas.paintBorder(thx_text_table_CellType.Body,1,0,3,3);
			utest_Assert.equals(" ┌─┐\n │ │\n └─┘\n    ",canvas.toString(),null,{ fileName : "TestTable.hx", lineNumber : 29, className : "thx.text.TestTable", methodName : "testPaintBorder"});
			canvas = new thx_text_table_Canvas(4,4);
			canvas.paintBorder(thx_text_table_CellType.Body,1,1,3,3);
			utest_Assert.equals("    \n ┌─┐\n │ │\n └─┘",canvas.toString(),null,{ fileName : "TestTable.hx", lineNumber : 33, className : "thx.text.TestTable", methodName : "testPaintBorder"});
		}
	}
	...
	,testSequence: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.equals(1,last.col.index,null,{ fileName : "TestTable.hx", lineNumber : 48, className : "thx.text.TestTable", methodName : "testSequence"});
			utest_Assert.equals(0,first.col.index,null,{ fileName : "TestTable.hx", lineNumber : 49, className : "thx.text.TestTable", methodName : "testSequence"});
		}
	}
	,testStyle: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			utest_Assert.isNull(style.get_formatter(),null,{ fileName : "TestTable.hx", lineNumber : 55, className : "thx.text.TestTable", methodName : "testStyle"});
			var dstyle = new thx_text_table_DefaultStyle();
			utest_Assert.notNull(dstyle.get_formatter(),null,{ fileName : "TestTable.hx", lineNumber : 57, className : "thx.text.TestTable", methodName : "testStyle"});
			var cstyle = new thx_text_table_CompositeStyle([style]);
			utest_Assert.isNull(cstyle.get_formatter(),null,{ fileName : "TestTable.hx", lineNumber : 59, className : "thx.text.TestTable", methodName : "testStyle"});
			cstyle = new thx_text_table_CompositeStyle([style,dstyle]);
			utest_Assert.notNull(cstyle.get_formatter(),null,{ fileName : "TestTable.hx", lineNumber : 61, className : "thx.text.TestTable", methodName : "testStyle"});
		}
	}
	,testCanvas: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			utest_Assert.equals("   \n   ",canvas.toString(),null,{ fileName : "TestTable.hx", lineNumber : 67, className : "thx.text.TestTable", methodName : "testCanvas"});
			canvas.expand(4,3);
			utest_Assert.equals("    \n    \n    ",canvas.toString(),null,{ fileName : "TestTable.hx", lineNumber : 69, className : "thx.text.TestTable", methodName : "testCanvas"});
		}
	}
	,testTableSize: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.equals(0,this.table.get_rows(),null,{ fileName : "TestTable.hx", lineNumber : 74, className : "thx.text.TestTable", methodName : "testTableSize"});
			utest_Assert.equals(0,this.table.get_cols(),null,{ fileName : "TestTable.hx", lineNumber : 75, className : "thx.text.TestTable", methodName : "testTableSize"});
			this.table.getCol(2);
			utest_Assert.equals(0,this.table.get_cols(),null,{ fileName : "TestTable.hx", lineNumber : 77, className : "thx.text.TestTable", methodName : "testTableSize"});
			this.table.ensureCol(3);
			utest_Assert.equals(4,this.table.get_cols(),null,{ fileName : "TestTable.hx", lineNumber : 79, className : "thx.text.TestTable", methodName : "testTableSize"});
			utest_Assert.equals(0,this.table.get_rows(),null,{ fileName : "TestTable.hx", lineNumber : 80, className : "thx.text.TestTable", methodName : "testTableSize"});
			this.table.ensureRow(1);
			utest_Assert.equals(2,this.table.get_rows(),null,{ fileName : "TestTable.hx", lineNumber : 82, className : "thx.text.TestTable", methodName : "testTableSize"});
		}
	}
	,testCellResizeTable: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.equals(3,this.table.get_cols(),null,{ fileName : "TestTable.hx", lineNumber : 88, className : "thx.text.TestTable", methodName : "testCellResizeTable"});
			utest_Assert.equals(4,this.table.get_rows(),null,{ fileName : "TestTable.hx", lineNumber : 89, className : "thx.text.TestTable", methodName : "testCellResizeTable"});
		}
	}
	,testIdentityOfCellsCreatedFromTable: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.isTrue(cell == this.table.get(3,2),null,{ fileName : "TestTable.hx", lineNumber : 95, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromTable"});
			utest_Assert.isTrue(cell == this.table.getRow(3).get(2),null,{ fileName : "TestTable.hx", lineNumber : 97, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromTable"});
			utest_Assert.isTrue(cell == this.table.getCol(2).get(3),null,{ fileName : "TestTable.hx", lineNumber : 98, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromTable"});
			utest_Assert.isTrue(cell.row == this.table.getRow(3),null,{ fileName : "TestTable.hx", lineNumber : 100, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromTable"});
			utest_Assert.isTrue(cell.col == this.table.getCol(2),null,{ fileName : "TestTable.hx", lineNumber : 101, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromTable"});
			utest_Assert.isTrue(cell.table == this.table,null,{ fileName : "TestTable.hx", lineNumber : 103, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromTable"});
			utest_Assert.isTrue(cell.row.table == this.table,null,{ fileName : "TestTable.hx", lineNumber : 104, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromTable"});
			utest_Assert.isTrue(cell.col.table == this.table,null,{ fileName : "TestTable.hx", lineNumber : 105, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromTable"});
		}
	}
	,testIdentityOfCellsCreatedFromRow: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.isTrue(cell == this.table.get(3,2),null,{ fileName : "TestTable.hx", lineNumber : 112, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromRow"});
			utest_Assert.isTrue(cell == this.table.getRow(3).get(2),null,{ fileName : "TestTable.hx", lineNumber : 114, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromRow"});
			utest_Assert.isTrue(cell == this.table.getCol(2).get(3),null,{ fileName : "TestTable.hx", lineNumber : 115, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromRow"});
			utest_Assert.isTrue(cell.row == this.table.getRow(3),null,{ fileName : "TestTable.hx", lineNumber : 117, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromRow"});
			utest_Assert.isTrue(cell.col == this.table.getCol(2),null,{ fileName : "TestTable.hx", lineNumber : 118, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromRow"});
			utest_Assert.isTrue(cell.table == this.table,null,{ fileName : "TestTable.hx", lineNumber : 120, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromRow"});
			utest_Assert.isTrue(cell.row.table == this.table,null,{ fileName : "TestTable.hx", lineNumber : 121, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromRow"});
			utest_Assert.isTrue(cell.col.table == this.table,null,{ fileName : "TestTable.hx", lineNumber : 122, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromRow"});
		}
	}
	,testIdentityOfCellsCreatedFromCol: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.isTrue(cell == this.table.get(3,2),null,{ fileName : "TestTable.hx", lineNumber : 129, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromCol"});
			utest_Assert.isTrue(cell == this.table.getRow(3).get(2),null,{ fileName : "TestTable.hx", lineNumber : 131, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromCol"});
			utest_Assert.isTrue(cell == this.table.getCol(2).get(3),null,{ fileName : "TestTable.hx", lineNumber : 132, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromCol"});
			utest_Assert.isTrue(cell.row == this.table.getRow(3),null,{ fileName : "TestTable.hx", lineNumber : 134, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromCol"});
			utest_Assert.isTrue(cell.col == this.table.getCol(2),null,{ fileName : "TestTable.hx", lineNumber : 135, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromCol"});
			utest_Assert.isTrue(cell.table == this.table,null,{ fileName : "TestTable.hx", lineNumber : 137, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromCol"});
			utest_Assert.isTrue(cell.row.table == this.table,null,{ fileName : "TestTable.hx", lineNumber : 138, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromCol"});
			utest_Assert.isTrue(cell.col.table == this.table,null,{ fileName : "TestTable.hx", lineNumber : 139, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromCol"});
		}
	}
