...
TestAll.addTests = function(runner) {
	runner.addCase(new thx_text_TestInflections());
	runner.addCase(new thx_text_TestTable());
};
...
thx_culture_Culture.prototype = {
	...
	,__properties__: {get_nameDisplayNative:"get_nameDisplayNative",get_nameDisplayEnglish:"get_nameDisplayEnglish"}
};
...
thx_format_Format.__properties__ = {set_defaultCulture:"set_defaultCulture",get_defaultCulture:"get_defaultCulture"}
...
var thx_text_Inflections = function() { };
thx_text_Inflections.__name__ = ["thx","text","Inflections"];
thx_text_Inflections.pluralize = function(singular) {
	return thx_text_Inflections.process(singular,thx_text_Inflections.plural_rules);
};
thx_text_Inflections.singularize = function(plural) {
	return thx_text_Inflections.process(plural,thx_text_Inflections.singular_rules);
};
thx_text_Inflections.process = function(word,rules) {
	if(Lambda.has(thx_text_Inflections.uncountable_words,word)) {
		return word;
	}
	var _g = 0;
	while(_g < rules.length) {
		...
		if(rule.pattern.match(word)) {
			return word.replace(rule.pattern.r,rule.replace);
		}
	}
	return word;
};
var thx_text_Table = function() {
	this._rows = [];
	this._cols = [];
	this.style = new thx_text_table_Style();
};
thx_text_Table.__name__ = ["thx","text","Table"];
thx_text_Table.fromData = function(data,hasHeader,title) {
	if(hasHeader == null) {
		hasHeader = true;
	}
	var offset = title == null?0:1;
	var table = new thx_text_Table();
	if(hasHeader) {
	...
	while(_g1 < _g) {
		...
		while(_g3 < _g2) {
			var c = _g3++;
			table.set(thx_text_table__$CellValue_CellValue_$Impl_$.fromDynamic(row[c]),r + offset,c);
		}
	}
	return table;
};
thx_text_Table.fromObjects = function(data,title) {
	var offset = title == null?0:1;
	var table = new thx_text_Table();
	...
	while(_g1 < _g) {
		...
		while(_g2 < fields.length) {
			...
			++_g2;
			var col = __map_reserved[field] != null?headers.getReserved(field):headers.h[field];
			if(null == col) {
				col = cols++;
				if(__map_reserved[field] != null) {
					headers.setReserved(field,col);
				} else {
					headers.h[field] = col;
				}
				table.set(thx_text_table_CellValueImpl.StringCell(thx_Strings.humanize(field)),offset,col);
			}
			table.set(thx_text_table__$CellValue_CellValue_$Impl_$.fromDynamic(Reflect.field(data[r],field)),r + offset + 1,col);
		}
	}
	return table;
};
thx_text_Table.prototype = {
	style: null
	,_rows: null
	,_cols: null
	,set: function(value,row,col,span) {
		if(null == span) {
			span = thx_text_table_Span.NoSpan;
		}
		var r = this.ensureRow(row);
		var c = this.ensureCol(col);
		var cell = new thx_text_table_Cell(value,r,c,span);
		c.setCell(row,cell);
		return cell;
	}
	,get: function(row,col) {
		var col1 = this.getCol(col);
		if(null == col1) {
			return null;
		}
		return col1.get(row);
	}
	,ensureCol: function(index) {
		var _g1 = this._cols.length;
		var _g = index + 1;
		while(_g1 < _g) {
			var i = _g1++;
	...
	,ensureRow: function(index) {
		var _g1 = this._rows.length;
		var _g = index + 1;
		while(_g1 < _g) {
			var i = _g1++;
	...
	,toArray: function() {
		...
		while(_g < _g1.length) {
			var row = _g1[_g];
			++_g;
			var tmp = row.iterator();
			while(tmp.hasNext()) collector.push(tmp.next());
		}
		return collector;
	}
	,toString: function() {
		return new thx_text_table_Renderer().render(this);
	}
	,get_rows: function() {
	...
	,__class__: thx_text_Table
	,__properties__: {set_cols:"set_cols",get_cols:"get_cols",set_rows:"set_rows",get_rows:"get_rows"}
};
var thx_text_TestInflections = function() {
};
thx_text_TestInflections.__name__ = ["thx","text","TestInflections"];
thx_text_TestInflections.prototype = {
	testUncountable: function() {
		utest_Assert.equals("information",thx_text_Inflections.pluralize("information"),null,{ fileName : "TestInflections.hx", lineNumber : 10, className : "thx.text.TestInflections", methodName : "testUncountable"});
		utest_Assert.equals("news",thx_text_Inflections.pluralize("news"),null,{ fileName : "TestInflections.hx", lineNumber : 11, className : "thx.text.TestInflections", methodName : "testUncountable"});
	}
	,testPluralize: function() {
		utest_Assert.equals("days",thx_text_Inflections.pluralize("day"),null,{ fileName : "TestInflections.hx", lineNumber : 15, className : "thx.text.TestInflections", methodName : "testPluralize"});
		utest_Assert.equals("women",thx_text_Inflections.pluralize("woman"),null,{ fileName : "TestInflections.hx", lineNumber : 16, className : "thx.text.TestInflections", methodName : "testPluralize"});
		utest_Assert.equals("autobuses",thx_text_Inflections.pluralize("autobus"),null,{ fileName : "TestInflections.hx", lineNumber : 17, className : "thx.text.TestInflections", methodName : "testPluralize"});
		utest_Assert.equals("quizzes",thx_text_Inflections.pluralize("quiz"),null,{ fileName : "TestInflections.hx", lineNumber : 18, className : "thx.text.TestInflections", methodName : "testPluralize"});
	}
	,testSingularize: function() {
		utest_Assert.equals("day",thx_text_Inflections.singularize("days"),null,{ fileName : "TestInflections.hx", lineNumber : 22, className : "thx.text.TestInflections", methodName : "testSingularize"});
		utest_Assert.equals("woman",thx_text_Inflections.singularize("women"),null,{ fileName : "TestInflections.hx", lineNumber : 23, className : "thx.text.TestInflections", methodName : "testSingularize"});
		utest_Assert.equals("autobus",thx_text_Inflections.singularize("autobuses"),null,{ fileName : "TestInflections.hx", lineNumber : 24, className : "thx.text.TestInflections", methodName : "testSingularize"});
		utest_Assert.equals("quiz",thx_text_Inflections.singularize("quizzes"),null,{ fileName : "TestInflections.hx", lineNumber : 25, className : "thx.text.TestInflections", methodName : "testSingularize"});
	}
	,__class__: thx_text_TestInflections
};
var thx_text_TestTable = function() {
};
thx_text_TestTable.__name__ = ["thx","text","TestTable"];
thx_text_TestTable.prototype = {
	table: null
	,setup: function() {
		this.table = new thx_text_Table();
	}
	,testSpanRight: function() {
		this.table.style.set_type(thx_text_table_CellType.Body);
		this.table.style.setAlign(thx_text_table_HAlign.Center);
		this.table.set(thx_text_table_CellValueImpl.IntCell(1),0,0,thx_text_table_Span.SpanRight(2));
		this.table.set(thx_text_table_CellValueImpl.IntCell(2),1,0);
		this.table.set(thx_text_table_CellValueImpl.IntCell(3),1,1);
		utest_Assert.equals("\n┌───────┐\n│   1   │\n├───┬───┤\n│ 2 │ 3 │\n└───┴───┘",this.table.toString(),null,{ fileName : "TestTable.hx", lineNumber : 24, className : "thx.text.TestTable", methodName : "testSpanRight"});
	}
	,testSpanDown: function() {
		this.table.style.set_type(thx_text_table_CellType.Body);
		this.table.style.setAlign(thx_text_table_HAlign.Center);
		this.table.set(thx_text_table_CellValueImpl.IntCell(1),0,0,thx_text_table_Span.SpanDown(2));
		this.table.set(thx_text_table_CellValueImpl.IntCell(2),0,1);
		this.table.set(thx_text_table_CellValueImpl.IntCell(3),1,1);
		utest_Assert.equals("\n┌───┬───┐\n│ 1 │ 2 │\n│   ├───┤\n│   │ 3 │\n└───┴───┘",this.table.toString(),null,{ fileName : "TestTable.hx", lineNumber : 38, className : "thx.text.TestTable", methodName : "testSpanDown"});
	}
	,testSpanning: function() {
		this.table.style.set_type(thx_text_table_CellType.Body);
		this.table.style.setAlign(thx_text_table_HAlign.Center);
		this.table.set(thx_text_table_CellValueImpl.StringCell("0/0"),0,0);
		this.table.set(thx_text_table_CellValueImpl.StringCell("0/1"),0,1,thx_text_table_Span.SpanBoth(2,2));
		this.table.set(thx_text_table_CellValueImpl.StringCell("0/3"),0,3,thx_text_table_Span.SpanDown(2));
		this.table.set(thx_text_table_CellValueImpl.StringCell("1/0"),1,0);
		this.table.set(thx_text_table_CellValueImpl.StringCell("2/0"),2,0,thx_text_table_Span.SpanRight(2));
		this.table.set(thx_text_table_CellValueImpl.StringCell("2/2"),2,2,thx_text_table_Span.SpanRight(2));
		utest_Assert.equals("\n┌─────┬─────┬─────┐\n│ 0/0 │ 0/1 │ 0/3 │\n├─────┤     │     │\n│ 1/0 │     │     │\n├─────┴──┬──┴─────┤\n│  2/0   │  2/2   │\n└────────┴────────┘",this.table.toString(),null,{ fileName : "TestTable.hx", lineNumber : 56, className : "thx.text.TestTable", methodName : "testSpanning"});
	}
	,testFromData: function() {
		utest_Assert.equals("\n┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓\n┃            average earnings            ┃\n┣━━━━━━┳━━━━━━━━━━━━━━━━━━━━━━━┳━━━━━━━━━┫\n┃ rank ┃ country               ┃ US $    ┃\n┡━━━━━━╇━━━━━━━━━━━━━━━━━━━━━━━╇━━━━━━━━━┩\n│    1 │ Luxembourg            │ 113,533 │\n│    2 │ Qatar                 │  98,329 │\n│    3 │ Norway                │  97,255 │\n│    4 │ Switzerland           │  81,161 │\n│    5 │ United Arab  Emirates │  67,008 │\n│    6 │ Australia             │  65,477 │\n│    7 │ Denmark               │  59,928 │\n│    8 │ Sweden                │  56,956 │\n│    9 │ Canada                │  50,436 │\n│   10 │ Netherlands           │  50,355 │\n└──────┴───────────────────────┴─────────┘",thx_text_Table.fromData([["rank","country","US $"],[1,"Luxembourg",113533],[2,"Qatar",98329],[3,"Norway",97255],[4,"Switzerland",81161],[5,"United Arab  Emirates",67008],[6,"Australia",65477],[7,"Denmark",59928],[8,"Sweden",56956],[9,"Canada",50436],[10,"Netherlands",50355]],null,"average earnings").toString(),null,{ fileName : "TestTable.hx", lineNumber : 81, className : "thx.text.TestTable", methodName : "testFromData"});
	}
	,testFromObjects: function() {
		utest_Assert.equals("\n┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓\n┃                     countries                      ┃\n┣━━━━━━┳━━━━━━━━━━┳━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━━━━━━┫\n┃ code ┃ latitude ┃ longitude ┃ name                 ┃\n┡━━━━━━╇━━━━━━━━━━╇━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━━━━┩\n│ AD   │     42.5 │       1.6 │ Andorra              │\n│ AE   │     23.4 │      53.8 │ United Arab Emirates │\n│ AF   │     33.9 │      67.7 │ Afghanistan          │\n└──────┴──────────┴───────────┴──────────────────────┘",thx_text_Table.fromObjects([{ code : "AD", latitude : 42.5, longitude : 1.6, name : "Andorra"},{ code : "AE", latitude : 23.4, longitude : 53.8, name : "United Arab Emirates"},{ code : "AF", latitude : 33.9, longitude : 67.7, name : "Afghanistan"}],"countries").toString(),null,{ fileName : "TestTable.hx", lineNumber : 118, className : "thx.text.TestTable", methodName : "testFromObjects"});
	}
	,testPaintBorder: function() {
		var canvas = new thx_text_table_Canvas(3,3);
		canvas.paintBorder(thx_text_table_CellType.Body,0,0,3,3);
		utest_Assert.equals("┌─┐\n│ │\n└─┘",canvas.toString(),null,{ fileName : "TestTable.hx", lineNumber : 133, className : "thx.text.TestTable", methodName : "testPaintBorder"});
		canvas = new thx_text_table_Canvas(4,4);
		canvas.paintBorder(thx_text_table_CellType.Body,1,0,3,3);
		utest_Assert.equals(" ┌─┐\n │ │\n └─┘\n    ",canvas.toString(),null,{ fileName : "TestTable.hx", lineNumber : 137, className : "thx.text.TestTable", methodName : "testPaintBorder"});
		canvas = new thx_text_table_Canvas(4,4);
		canvas.paintBorder(thx_text_table_CellType.Body,1,1,3,3);
		utest_Assert.equals("    \n ┌─┐\n │ │\n └─┘",canvas.toString(),null,{ fileName : "TestTable.hx", lineNumber : 141, className : "thx.text.TestTable", methodName : "testPaintBorder"});
	}
	,testRender: function() {
		var renderer = new thx_text_table_Renderer();
		this.table.set(thx_text_table_CellValueImpl.BoolCell(true),0,1);
		this.table.set(thx_text_table_CellValueImpl.StringCell("Franco"),0,0);
		this.table.set(thx_text_table_CellValueImpl.BoolCell(false),0,2);
		this.table.set(thx_text_table_CellValueImpl.DateTimeCell(thx__$DateTime_DateTime_$Impl_$.fromDate(HxOverrides.strDate("2015-11-19"))),1,0);
		this.table.set(thx_text_table_CellValueImpl.IntCell(200),1,2);
		this.table.style.set_type(thx_text_table_CellType.Body);
		this.table.getRow(0).style.set_type(thx_text_table_CellType.Header);
		utest_Assert.equals("\n┏━━━━━━━━━━━━┳━━━┳━━━━━┓\n┃ Franco     ┃ ✓ ┃  ✕  ┃\n┡━━━━━━━━━━━━╇━━━╇━━━━━┩\n│ 11/19/2015 │   │ 200 │\n└────────────┴───┴─────┘",renderer.render(this.table),null,{ fileName : "TestTable.hx", lineNumber : 154, className : "thx.text.TestTable", methodName : "testRender"});
	}
	,oneCell: function(value,width) {
		this.table = new thx_text_Table();
		this.table.style.set_type(thx_text_table_CellType.Body);
		this.table.style.set_minWidth(width);
		this.table.set(value,0,0);
	}
	,testAlign: function() {
		this.oneCell(thx_text_table_CellValueImpl.IntCell(0),8);
		utest_Assert.equals("\n┌──────────┐\n│        0 │\n└──────────┘",this.table.toString(),null,{ fileName : "TestTable.hx", lineNumber : 171, className : "thx.text.TestTable", methodName : "testAlign"});
		this.oneCell(thx_text_table_CellValueImpl.StringCell("0"),8);
		utest_Assert.equals("\n┌──────────┐\n│ 0        │\n└──────────┘",this.table.toString(),null,{ fileName : "TestTable.hx", lineNumber : 176, className : "thx.text.TestTable", methodName : "testAlign"});
		this.oneCell(thx_text_table_CellValueImpl.BoolCell(true),8);
		utest_Assert.equals("\n┌──────────┐\n│    ✓     │\n└──────────┘",this.table.toString(),null,{ fileName : "TestTable.hx", lineNumber : 181, className : "thx.text.TestTable", methodName : "testAlign"});
		this.oneCell(thx_text_table_CellValueImpl.FloatCell(0.5),8);
		utest_Assert.equals("\n┌──────────┐\n│      0.5 │\n└──────────┘",this.table.toString(),null,{ fileName : "TestTable.hx", lineNumber : 186, className : "thx.text.TestTable", methodName : "testAlign"});
	}
	,testAlignOnSymbol: function() {
		this.table.set(thx_text_table_CellValueImpl.FloatCell(0.001),0,0);
		this.table.set(thx_text_table_CellValueImpl.FloatCell(2.0),0,1);
		this.table.set(thx_text_table_CellValueImpl.IntCell(3333),0,2);
		this.table.set(thx_text_table_CellValueImpl.FloatCell(12.5),0,3);
		this.table.style.set_type(thx_text_table_CellType.Body);
		utest_Assert.equals("\n┌───────┬─────┬───────┬──────┐\n│ 0.001 │ 2.0 │ 3,333 │ 12.5 │\n└───────┴─────┴───────┴──────┘",this.table.toString(),null,{ fileName : "TestTable.hx", lineNumber : 198, className : "thx.text.TestTable", methodName : "testAlignOnSymbol"});
	}
	,testAlignOnSymbolVertical: function() {
		this.table.set(thx_text_table_CellValueImpl.FloatCell(0.001),0,0);
		this.table.set(thx_text_table_CellValueImpl.FloatCell(2.0),1,0);
		this.table.set(thx_text_table_CellValueImpl.IntCell(3333),2,0);
		this.table.set(thx_text_table_CellValueImpl.FloatCell(12.5),3,0);
		this.table.style.set_type(thx_text_table_CellType.Body);
		utest_Assert.equals("\n┌───────────┐\n│     0.001 │\n├───────────┤\n│     2.0   │\n├───────────┤\n│ 3,333     │\n├───────────┤\n│    12.5   │\n└───────────┘",this.table.toString(),null,{ fileName : "TestTable.hx", lineNumber : 210, className : "thx.text.TestTable", methodName : "testAlignOnSymbolVertical"});
	}
	,testSequence: function() {
		var last = this.table.set(thx_text_table_CellValueImpl.BoolCell(true),0,1);
		var first = this.table.set(thx_text_table_CellValueImpl.BoolCell(false),0,0);
		utest_Assert.equals(1,last.col.index,null,{ fileName : "TestTable.hx", lineNumber : 225, className : "thx.text.TestTable", methodName : "testSequence"});
		utest_Assert.equals(0,first.col.index,null,{ fileName : "TestTable.hx", lineNumber : 226, className : "thx.text.TestTable", methodName : "testSequence"});
	}
	,testStyle: function() {
		var style = new thx_text_table_Style();
		utest_Assert.isNull(style.get_formatter(),null,{ fileName : "TestTable.hx", lineNumber : 231, className : "thx.text.TestTable", methodName : "testStyle"});
		var dstyle = new thx_text_table_DefaultStyle();
		utest_Assert.notNull(dstyle.get_formatter(),null,{ fileName : "TestTable.hx", lineNumber : 233, className : "thx.text.TestTable", methodName : "testStyle"});
		var cstyle = new thx_text_table_CompositeStyle([style]);
		utest_Assert.isNull(cstyle.get_formatter(),null,{ fileName : "TestTable.hx", lineNumber : 235, className : "thx.text.TestTable", methodName : "testStyle"});
		cstyle = new thx_text_table_CompositeStyle([style,dstyle]);
		utest_Assert.notNull(cstyle.get_formatter(),null,{ fileName : "TestTable.hx", lineNumber : 237, className : "thx.text.TestTable", methodName : "testStyle"});
	}
	,testCanvas: function() {
		var canvas = new thx_text_table_Canvas(3,2);
		utest_Assert.equals("   \n   ",canvas.toString(),null,{ fileName : "TestTable.hx", lineNumber : 242, className : "thx.text.TestTable", methodName : "testCanvas"});
		canvas.expand(4,3);
		utest_Assert.equals("    \n    \n    ",canvas.toString(),null,{ fileName : "TestTable.hx", lineNumber : 244, className : "thx.text.TestTable", methodName : "testCanvas"});
	}
	,testTableSize: function() {
		utest_Assert.equals(0,this.table.get_rows(),null,{ fileName : "TestTable.hx", lineNumber : 248, className : "thx.text.TestTable", methodName : "testTableSize"});
		utest_Assert.equals(0,this.table.get_cols(),null,{ fileName : "TestTable.hx", lineNumber : 249, className : "thx.text.TestTable", methodName : "testTableSize"});
		this.table.getCol(2);
		utest_Assert.equals(0,this.table.get_cols(),null,{ fileName : "TestTable.hx", lineNumber : 251, className : "thx.text.TestTable", methodName : "testTableSize"});
		this.table.ensureCol(3);
		utest_Assert.equals(4,this.table.get_cols(),null,{ fileName : "TestTable.hx", lineNumber : 253, className : "thx.text.TestTable", methodName : "testTableSize"});
		utest_Assert.equals(0,this.table.get_rows(),null,{ fileName : "TestTable.hx", lineNumber : 254, className : "thx.text.TestTable", methodName : "testTableSize"});
		this.table.ensureRow(1);
		utest_Assert.equals(2,this.table.get_rows(),null,{ fileName : "TestTable.hx", lineNumber : 256, className : "thx.text.TestTable", methodName : "testTableSize"});
	}
	,testCellResizeTable: function() {
		this.table.set(thx_text_table_CellValueImpl.IntCell(1),3,2);
		utest_Assert.equals(3,this.table.get_cols(),null,{ fileName : "TestTable.hx", lineNumber : 261, className : "thx.text.TestTable", methodName : "testCellResizeTable"});
		utest_Assert.equals(4,this.table.get_rows(),null,{ fileName : "TestTable.hx", lineNumber : 262, className : "thx.text.TestTable", methodName : "testCellResizeTable"});
	}
	,testIdentityOfCellsCreatedFromTable: function() {
		var cell = this.table.set(thx_text_table_CellValueImpl.IntCell(1),3,2);
		utest_Assert.isTrue(cell == this.table.get(3,2),null,{ fileName : "TestTable.hx", lineNumber : 267, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromTable"});
		utest_Assert.isTrue(cell == this.table.getRow(3).get(2),null,{ fileName : "TestTable.hx", lineNumber : 269, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromTable"});
		utest_Assert.isTrue(cell == this.table.getCol(2).get(3),null,{ fileName : "TestTable.hx", lineNumber : 270, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromTable"});
		utest_Assert.isTrue(cell.row == this.table.getRow(3),null,{ fileName : "TestTable.hx", lineNumber : 272, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromTable"});
		utest_Assert.isTrue(cell.col == this.table.getCol(2),null,{ fileName : "TestTable.hx", lineNumber : 273, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromTable"});
		utest_Assert.isTrue(cell.table == this.table,null,{ fileName : "TestTable.hx", lineNumber : 275, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromTable"});
		utest_Assert.isTrue(cell.row.table == this.table,null,{ fileName : "TestTable.hx", lineNumber : 276, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromTable"});
		utest_Assert.isTrue(cell.col.table == this.table,null,{ fileName : "TestTable.hx", lineNumber : 277, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromTable"});
	}
	,testIdentityOfCellsCreatedFromRow: function() {
		var cell = this.table.ensureRow(3).set(thx_text_table_CellValueImpl.IntCell(1),2);
		utest_Assert.isTrue(cell == this.table.get(3,2),null,{ fileName : "TestTable.hx", lineNumber : 283, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromRow"});
		utest_Assert.isTrue(cell == this.table.getRow(3).get(2),null,{ fileName : "TestTable.hx", lineNumber : 285, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromRow"});
		utest_Assert.isTrue(cell == this.table.getCol(2).get(3),null,{ fileName : "TestTable.hx", lineNumber : 286, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromRow"});
		utest_Assert.isTrue(cell.row == this.table.getRow(3),null,{ fileName : "TestTable.hx", lineNumber : 288, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromRow"});
		utest_Assert.isTrue(cell.col == this.table.getCol(2),null,{ fileName : "TestTable.hx", lineNumber : 289, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromRow"});
		utest_Assert.isTrue(cell.table == this.table,null,{ fileName : "TestTable.hx", lineNumber : 291, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromRow"});
		utest_Assert.isTrue(cell.row.table == this.table,null,{ fileName : "TestTable.hx", lineNumber : 292, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromRow"});
		utest_Assert.isTrue(cell.col.table == this.table,null,{ fileName : "TestTable.hx", lineNumber : 293, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromRow"});
	}
	,testIdentityOfCellsCreatedFromCol: function() {
		var cell = this.table.ensureCol(2).set(thx_text_table_CellValueImpl.IntCell(1),3);
		utest_Assert.isTrue(cell == this.table.get(3,2),null,{ fileName : "TestTable.hx", lineNumber : 299, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromCol"});
		utest_Assert.isTrue(cell == this.table.getRow(3).get(2),null,{ fileName : "TestTable.hx", lineNumber : 301, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromCol"});
		utest_Assert.isTrue(cell == this.table.getCol(2).get(3),null,{ fileName : "TestTable.hx", lineNumber : 302, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromCol"});
		utest_Assert.isTrue(cell.row == this.table.getRow(3),null,{ fileName : "TestTable.hx", lineNumber : 304, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromCol"});
		utest_Assert.isTrue(cell.col == this.table.getCol(2),null,{ fileName : "TestTable.hx", lineNumber : 305, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromCol"});
		utest_Assert.isTrue(cell.table == this.table,null,{ fileName : "TestTable.hx", lineNumber : 307, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromCol"});
		utest_Assert.isTrue(cell.row.table == this.table,null,{ fileName : "TestTable.hx", lineNumber : 308, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromCol"});
		utest_Assert.isTrue(cell.col.table == this.table,null,{ fileName : "TestTable.hx", lineNumber : 309, className : "thx.text.TestTable", methodName : "testIdentityOfCellsCreatedFromCol"});
	}
	,__class__: thx_text_TestTable
};
var thx_text_table_Canvas = function(width,height) {
	this.values = [];
	this.expand(width,height);
};
thx_text_table_Canvas.__name__ = ["thx","text","table","Canvas"];
thx_text_table_Canvas.prototype = {
	width: null
	,height: null
	,values: null
	,expand: function(width,height) {
		...
		while(_g1 < height) {
			...
			while(_g4 < width) {
				++_g4;
				_g2.push(thx_text_table_SymbolImpl.Empty);
			}
		...
		if(width > this.width) {
			...
			var _g = this.height;
			while(_g11 < _g) {
				var row = this.values[_g11++];
				var _g3 = this.width;
				while(_g3 < width) {
					++_g3;
					row.push(thx_text_table_SymbolImpl.Empty);
				}
			}
		}
		var a = this.width;
	...
	,get: function(x,y) {
		var row = this.values[y];
		if(null == row) {
			return null;
		}
		return row[x];
	}
	,set: function(x,y,symbol) {
		this.values[y][x] = symbol;
	}
	,setChar: function(x,y,$char) {
		this.set(x,y,thx_text_table_SymbolImpl.Char($char));
	}
	,combine: function(x,y,symbol) {
		this.values[y][x] = thx_text_table__$Canvas_Symbol_$Impl_$.combine(this.values[y][x],symbol);
	}
	,combineChar: function(x,y,$char) {
		this.combine(x,y,thx_text_table_SymbolImpl.Char($char));
	}
	,paintBlock: function(block,x,y,width,height,halign,symbolPos) {
		var _g1 = 0;
		var _g = block.height;
		while(_g1 < _g) {
			var i = _g1++;
			...
			case 2:
				...
				break;
			case 3:
				var pos = line.lastIndexOf(halign[2]);
				if(pos < 0) {
	...
	,paintBorder: function(type,x,y,w,h) {
	...
	,paintBottomLine: function(type,x,y,w) {
		this.combine(x,y,this.pickBottomLeft(type));
		this.combine(x + w - 1,y,this.pickBottomRight(type));
		var _g1 = 1;
		var _g = w - 1;
		while(_g1 < _g) this.combine(x + _g1++,y,this.pickBottom(type));
	}
	,typeToBorder: function(type) {
		switch(type[1]) {
		case 0:case 1:
	...
	,pickTopLeft: function(type) {
		...
		case 1:
			...
			break;
		case 0:case 2:
			tmp = thx_text_table_Border.Cross(thx_text_table_BorderStyle.None,this.typeToBorder(type),this.typeToBorder(type),thx_text_table_BorderStyle.None);
			break;
		case 3:
			tmp = thx_text_table_Border.RemovableCross(thx_text_table_BorderStyle.None,thx_text_table_BorderStyle.None,this.typeToBorder(type),thx_text_table_BorderStyle.None);
			break;
		}
		return thx_text_table_SymbolImpl.Border(tmp);
	}
	,pickTopRight: function(type) {
		var tmp;
		switch(type[1]) {
		case 1:
			tmp = thx_text_table_Border.Removable;
			break;
		case 0:case 2:
			tmp = thx_text_table_Border.Cross(thx_text_table_BorderStyle.None,thx_text_table_BorderStyle.None,this.typeToBorder(type),this.typeToBorder(type));
			break;
		case 3:
			tmp = thx_text_table_Border.RemovableCross(thx_text_table_BorderStyle.None,thx_text_table_BorderStyle.None,this.typeToBorder(type),thx_text_table_BorderStyle.None);
			break;
	...
	,pickBottomLeft: function(type) {
		var tmp;
		switch(type[1]) {
		case 1:
			tmp = thx_text_table_Border.Cross(thx_text_table_BorderStyle.None,this.typeToBorder(type),thx_text_table_BorderStyle.None,thx_text_table_BorderStyle.None);
			break;
		case 0:case 2:
			tmp = thx_text_table_Border.Cross(this.typeToBorder(type),this.typeToBorder(type),thx_text_table_BorderStyle.None,thx_text_table_BorderStyle.None);
			break;
		case 3:
			tmp = thx_text_table_Border.RemovableCross(this.typeToBorder(type),thx_text_table_BorderStyle.None,thx_text_table_BorderStyle.None,thx_text_table_BorderStyle.None);
			break;
		}
		return thx_text_table_SymbolImpl.Border(tmp);
	}
	,pickBottomRight: function(type) {
		var tmp;
		switch(type[1]) {
		case 1:
			tmp = thx_text_table_Border.Cross(thx_text_table_BorderStyle.None,thx_text_table_BorderStyle.None,thx_text_table_BorderStyle.None,this.typeToBorder(type));
			break;
		case 0:case 2:
			tmp = thx_text_table_Border.Cross(this.typeToBorder(type),thx_text_table_BorderStyle.None,thx_text_table_BorderStyle.None,this.typeToBorder(type));
			break;
		case 3:
			tmp = thx_text_table_Border.RemovableCross(this.typeToBorder(type),thx_text_table_BorderStyle.None,thx_text_table_BorderStyle.None,thx_text_table_BorderStyle.None);
			break;
	...
	,pickTop: function(type) {
		...
		case 1:case 3:
			...
			break;
		case 0:case 2:
			tmp = thx_text_table_Border.Cross(thx_text_table_BorderStyle.None,this.typeToBorder(type),thx_text_table_BorderStyle.None,this.typeToBorder(type));
			break;
		}
		return thx_text_table_SymbolImpl.Border(tmp);
	}
	,pickBottom: function(type) {
		var tmp;
		switch(type[1]) {
	...
	,pickLeft: function(type) {
		...
		case 0:case 2:case 3:
			tmp = thx_text_table_Border.Cross(this.typeToBorder(type),thx_text_table_BorderStyle.None,this.typeToBorder(type),thx_text_table_BorderStyle.None);
			break;
		}
		return thx_text_table_SymbolImpl.Border(tmp);
	}
	,pickRight: function(type) {
		var tmp;
		switch(type[1]) {
		case 1:
			tmp = thx_text_table_Border.Removable;
	...
	,toString: function() {
		var _gthis = this;
		return this.values.filter(function(row) {
			return !thx_Arrays.all(row,function(symbol) {
				if(symbol[1] == 2) {
					switch(symbol[2][1]) {
					case 0:case 1:
						return true;
			...
			return thx_Arrays.reduce(row1,function(buff,symbol1) {
				return buff + _gthis.render(symbol1);
			},"");
		}).join("\n");
	}
	,__class__: thx_text_table_Canvas
};
var thx_text_table__$Canvas_Symbol_$Impl_$ = {};
thx_text_table__$Canvas_Symbol_$Impl_$.__name__ = ["thx","text","table","_Canvas","Symbol_Impl_"];
thx_text_table__$Canvas_Symbol_$Impl_$.combine = function(this1,that) {
	if(null == this1) {
		return that;
	}
	if(null == that) {
	...
	case 2:
		...
		case 0:
			return this1;
		case 2:
			return thx_text_table_SymbolImpl.Border(thx_text_table__$Canvas_Symbol_$Impl_$.mergeBorders(this1[2],that[2]));
		default:
			return that;
		}
		break;
...
thx_text_table__$Canvas_Symbol_$Impl_$.mergeBorders = function(b1,b2) {
	switch(b1[1]) {
	case 0:
		switch(b2[1]) {
		case 0:
	...
	case 1:
		...
		case 0:
			return b1;
		case 1:
			return thx_text_table_Border.RemovableCross(thx_Enums.max(b1[2],b2[2]),thx_Enums.max(b1[3],b2[3]),thx_Enums.max(b1[4],b2[4]),thx_Enums.max(b1[5],b2[5]));
		case 2:
			return thx_text_table_Border.Cross(thx_Enums.max(b1[2],b2[2]),thx_Enums.max(b1[3],b2[3]),thx_Enums.max(b1[4],b2[4]),thx_Enums.max(b1[5],b2[5]));
		}
		break;
	case 2:
		switch(b2[1]) {
...
var thx_text_table_SymbolImpl = { __ename__ : ["thx","text","table","SymbolImpl"], __constructs__ : ["Empty","Char","Border"] };
thx_text_table_SymbolImpl.Empty = ["Empty",0];
thx_text_table_SymbolImpl.Empty.__enum__ = thx_text_table_SymbolImpl;
thx_text_table_SymbolImpl.Char = function(s) { var $x = ["Char",1,s]; $x.__enum__ = thx_text_table_SymbolImpl; return $x; };
thx_text_table_SymbolImpl.Border = function(b) { var $x = ["Border",2,b]; $x.__enum__ = thx_text_table_SymbolImpl; return $x; };
var thx_text_table_Cell = function(value,row,col,span) {
	this.value = value;
	this.row = row;
	this.col = col;
	this.span = span;
	this.table = col.table;
	this.style = new thx_text_table_CompositeStyle([col.style,row.style,this.table.style,thx_text_table_DefaultStyle.instance]);
};
thx_text_table_Cell.__name__ = ["thx","text","table","Cell"];
thx_text_table_Cell.prototype = {
	value: null
	,row: null
	,col: null
	,rowIndex: null
	...
	,style: null
	,toString: function() {
		var maxWidth = this.style.get_maxWidth();
		return (this.style.get_formatter())(this.value,maxWidth).toString();
	}
	...
	,__class__: thx_text_table_Cell
	,__properties__: {get_colIndex:"get_colIndex",get_rowIndex:"get_rowIndex"}
};
var thx_text_table_CellSet = function(table,index) {
	this.index = index;
	this.table = table;
...
thx_text_table_CellSet.__name__ = ["thx","text","table","CellSet"];
thx_text_table_CellSet.prototype = {
	values: null
	,size: null
	,table: null
	,index: null
	,style: null
	,get: function(index) {
		return this.values.h[index];
	}
	,iterator: function() {
		return this.values.iterator();
	}
	,_set: function(index,cell) {
		var b = this.size;
		this.size = index > b?index:b;
		this.values.h[index] = cell;
	}
	,__class__: thx_text_table_CellSet
};
var thx_text_table__$CellValue_CellValue_$Impl_$ = {};
thx_text_table__$CellValue_CellValue_$Impl_$.__name__ = ["thx","text","table","_CellValue","CellValue_Impl_"];
thx_text_table__$CellValue_CellValue_$Impl_$.fromInt = function(v) {
	return thx_text_table_CellValueImpl.IntCell(v);
};
thx_text_table__$CellValue_CellValue_$Impl_$.fromFloat = function(v) {
	return thx_text_table_CellValueImpl.FloatCell(v);
};
thx_text_table__$CellValue_CellValue_$Impl_$.fromString = function(v) {
	return thx_text_table_CellValueImpl.StringCell(v);
};
thx_text_table__$CellValue_CellValue_$Impl_$.fromBool = function(v) {
	return thx_text_table_CellValueImpl.BoolCell(v);
};
thx_text_table__$CellValue_CellValue_$Impl_$.fromDate = function(v) {
	return thx_text_table_CellValueImpl.DateTimeCell(thx__$DateTime_DateTime_$Impl_$.fromDate(v));
};
thx_text_table__$CellValue_CellValue_$Impl_$.fromDateTime = function(v) {
	return thx_text_table_CellValueImpl.DateTimeCell(v);
};
thx_text_table__$CellValue_CellValue_$Impl_$.fromTime = function(v) {
	return thx_text_table_CellValueImpl.TimeCell(v);
};
thx_text_table__$CellValue_CellValue_$Impl_$.fromDynamic = function(value) {
	if(null == value) {
		return thx_text_table_CellValueImpl.Empty;
	}
	switch(thx_Types.toString(Type["typeof"](value))) {
	case "Bool":
		return thx_text_table_CellValueImpl.BoolCell(value);
	case "Date":
		return thx_text_table_CellValueImpl.DateTimeCell(thx__$DateTime_DateTime_$Impl_$.fromDate(value));
	case "Float":
		return thx_text_table_CellValueImpl.FloatCell(value);
	case "Int":
		return thx_text_table_CellValueImpl.IntCell(value);
	case "String":
		return thx_text_table__$CellValue_CellValue_$Impl_$.parseString(value);
	default:
		return thx_text_table_CellValueImpl.StringCell(Std.string(value));
	}
};
thx_text_table__$CellValue_CellValue_$Impl_$.parseString = function(value) {
	if(null == value) {
		return thx_text_table_CellValueImpl.Empty;
	}
	...
	default:
		if(thx_Ints.canParse(_g)) {
			return thx_text_table_CellValueImpl.IntCell(thx_Ints.parse(_g));
		} else if(thx_Floats.canParse(_g)) {
			return thx_text_table_CellValueImpl.FloatCell(thx_Ints.parse(_g));
		} else {
			try {
				return thx_text_table_CellValueImpl.DateTimeCell(thx__$DateTime_DateTime_$Impl_$.fromString(value));
			} catch( _ ) {
				haxe_CallStack.lastException = _;
				try {
					return thx_text_table_CellValueImpl.TimeCell(thx__$Time_Time_$Impl_$.fromString(value));
				} catch( _1 ) {
...
thx_text_table__$CellValue_CellValue_$Impl_$.empty = function() {
	return thx_text_table_CellValueImpl.Empty;
};
thx_text_table__$CellValue_CellValue_$Impl_$.na = function() {
	return thx_text_table_CellValueImpl.NA;
};
var thx_text_table_CellValueImpl = { __ename__ : ["thx","text","table","CellValueImpl"], __constructs__ : ["IntCell","FloatCell","StringCell","BoolCell","DateTimeCell","TimeCell","Empty","NA"] };
thx_text_table_CellValueImpl.IntCell = function(v) { var $x = ["IntCell",0,v]; $x.__enum__ = thx_text_table_CellValueImpl; return $x; };
thx_text_table_CellValueImpl.FloatCell = function(v) { var $x = ["FloatCell",1,v]; $x.__enum__ = thx_text_table_CellValueImpl; return $x; };
thx_text_table_CellValueImpl.StringCell = function(v) { var $x = ["StringCell",2,v]; $x.__enum__ = thx_text_table_CellValueImpl; return $x; };
thx_text_table_CellValueImpl.BoolCell = function(v) { var $x = ["BoolCell",3,v]; $x.__enum__ = thx_text_table_CellValueImpl; return $x; };
thx_text_table_CellValueImpl.DateTimeCell = function(v) { var $x = ["DateTimeCell",4,v]; $x.__enum__ = thx_text_table_CellValueImpl; return $x; };
thx_text_table_CellValueImpl.TimeCell = function(v) { var $x = ["TimeCell",5,v]; $x.__enum__ = thx_text_table_CellValueImpl; return $x; };
thx_text_table_CellValueImpl.Empty = ["Empty",6];
thx_text_table_CellValueImpl.Empty.__enum__ = thx_text_table_CellValueImpl;
thx_text_table_CellValueImpl.NA = ["NA",7];
thx_text_table_CellValueImpl.NA.__enum__ = thx_text_table_CellValueImpl;
var thx_text_table_Col = function(table,index) {
	thx_text_table_CellSet.call(this,table,index);
};
thx_text_table_Col.__name__ = ["thx","text","table","Col"];
thx_text_table_Col.__super__ = thx_text_table_CellSet;
thx_text_table_Col.prototype = $extend(thx_text_table_CellSet.prototype,{
	setCell: function(rowIndex,cell) {
		thx_text_table_CellSet.prototype._set.call(this,rowIndex,cell);
		this.table.ensureRow(rowIndex)._set(this.index,cell);
	}
	,set: function(value,row,span) {
		return this.table.set(value,row,this.index,span);
	}
	,__class__: thx_text_table_Col
});
var thx_text_table_HAlign = { __ename__ : ["thx","text","table","HAlign"], __constructs__ : ["Left","Right","Center","OnSymbol"] };
thx_text_table_HAlign.Left = ["Left",0];
thx_text_table_HAlign.Left.__enum__ = thx_text_table_HAlign;
thx_text_table_HAlign.Right = ["Right",1];
thx_text_table_HAlign.Right.__enum__ = thx_text_table_HAlign;
thx_text_table_HAlign.Center = ["Center",2];
thx_text_table_HAlign.Center.__enum__ = thx_text_table_HAlign;
thx_text_table_HAlign.OnSymbol = function(symbol) { var $x = ["OnSymbol",3,symbol]; $x.__enum__ = thx_text_table_HAlign; return $x; };
var thx_text_table_Renderer = function(padding) {
	if(padding == null) {
		padding = 1;
	}
	this.padding = padding;
};
thx_text_table_Renderer.__name__ = ["thx","text","table","Renderer"];
thx_text_table_Renderer.prototype = {
	padding: null
	,canvas: null
	,colWidths: null
	,rowHeights: null
	...
	,processContents: function() {
		...
		var _g22 = [];
		var _g4 = 0;
		var _g31 = this.table.get_rows();
		while(_g4 < _g31) {
			++_g4;
			_g22.push(0);
		}
		this.rowHeights = _g22;
		var blocks = thx_Arrays.order(this.table.toArray(),function(a,b) {
			return thx_Enums.compare(b.span,a.span);
		}).map(function(cell) {
			var maxWidth = cell.style.get_maxWidth();
			var maxHeight = cell.style.get_maxHeight();
			var minWidth = cell.style.get_minWidth();
			var minHeight = cell.style.get_minHeight();
			var spanRight = 1;
			var spanDown = 1;
			var _g32 = cell.span;
			switch(_g32[1]) {
			...
			var block = (cell.style.get_formatter())(cell.value,maxWidth);
			var halign = (cell.style.get_aligner())(cell.value,cell.style.get_type());
			var a1;
			if(maxWidth == null) {
				a1 = block.width;
			} else {
			...
			var width = a1 > minWidth?a1:minWidth;
			var a2;
			if(maxHeight == null) {
				a2 = block.height;
			} else {
			...
			var height = a2 > minHeight?a2:minHeight;
			if(halign[1] == 3) {
				var pos = block.symbolPos(halign[2]);
				var a3 = _gthis.symbolPos[cell.col.index];
				_gthis.symbolPos[cell.col.index] = a3 > pos?a3:pos;
				var extra = _gthis.symbolPos[cell.col.index] - pos;
				if(spanRight == 1) {
					var a4 = _gthis.colWidths[cell.col.index];
					var b3 = width + extra;
					_gthis.colWidths[cell.col.index] = a4 > b3?a4:b3;
				}
			} else if(spanRight == 1) {
				var a5 = _gthis.colWidths[cell.col.index];
				_gthis.colWidths[cell.col.index] = a5 > width?a5:width;
			}
			var a6 = _gthis.rowHeights[cell.row.index];
			_gthis.rowHeights[cell.row.index] = a6 > height?a6:height;
			return { block : block, cell : cell, halign : halign, spanRight : spanRight, spanDown : spanDown};
		});
		var width1 = thx_Arrays.reduce(this.colWidths,$bind(this,this.reduceWidth),1);
		var height1 = thx_Arrays.reduce(this.rowHeights,$bind(this,this.reduceHeight),1);
		this.canvas.expand(width1,height1);
		thx_Arrays.each(blocks,function(item) {
			var x = thx_Arrays.reduce(_gthis.colWidths.slice(0,item.cell.col.index),$bind(_gthis,_gthis.reduceWidth),0);
			var y = thx_Arrays.reduce(_gthis.rowHeights.slice(0,item.cell.row.index),$bind(_gthis,_gthis.reduceHeight),0);
			var _g33 = [];
			var _g5 = 0;
			var _g42 = item.spanRight;
			while(_g5 < _g42) {
				var i = _g5++;
				_g33.push(_gthis.colWidths[item.cell.col.index + i] + (i > 0?2 * _gthis.padding + 1:0));
			}
			var width2 = thx_ArrayInts.sum(_g33);
			var _g43 = [];
			var _g6 = 0;
			var _g51 = item.spanDown;
			while(_g6 < _g51) {
				var i1 = _g6++;
				_g43.push(_gthis.rowHeights[item.cell.row.index + i1] + (i1 > 0?1:0));
			}
			var height2 = thx_ArrayInts.sum(_g43);
			_gthis.canvas.paintBlock(item.block,x + 1 + _gthis.padding,y + 1,width2,1,item.halign,_gthis.symbolPos[item.cell.col.index]);
			var w = width2 + (1 + _gthis.padding) * 2;
			_gthis.canvas.paintBorder(item.cell.style.get_type(),x,y,w,height2 + 2);
		});
		this.canvas.paintBottomLine(thx_text_table_CellType.Body,0,height1 - 1,width1);
	}
	,reduceWidth: function(acc,width) {
		return acc + width + this.padding * 2 + 1;
	}
	,reduceHeight: function(acc,height) {
		return acc + height + 1;
	}
	,__class__: thx_text_table_Renderer
};
var thx_text_table_Row = function(table,index) {
	thx_text_table_CellSet.call(this,table,index);
};
thx_text_table_Row.__name__ = ["thx","text","table","Row"];
thx_text_table_Row.__super__ = thx_text_table_CellSet;
thx_text_table_Row.prototype = $extend(thx_text_table_CellSet.prototype,{
	setCell: function(colIndex,cell) {
		thx_text_table_CellSet.prototype._set.call(this,colIndex,cell);
		this.table.ensureCol(colIndex)._set(this.index,cell);
	}
	,set: function(value,col,span) {
		return this.table.set(value,this.index,col,span);
	}
	,__class__: thx_text_table_Row
});
var thx_text_table_Span = { __ename__ : ["thx","text","table","Span"], __constructs__ : ["NoSpan","SpanBoth","SpanRight","SpanDown","FillRight","FillDown","FillBoth"] };
thx_text_table_Span.NoSpan = ["NoSpan",0];
thx_text_table_Span.NoSpan.__enum__ = thx_text_table_Span;
thx_text_table_Span.SpanBoth = function(rows,cols) { var $x = ["SpanBoth",1,rows,cols]; $x.__enum__ = thx_text_table_Span; return $x; };
thx_text_table_Span.SpanRight = function(cols) { var $x = ["SpanRight",2,cols]; $x.__enum__ = thx_text_table_Span; return $x; };
thx_text_table_Span.SpanDown = function(rows) { var $x = ["SpanDown",3,rows]; $x.__enum__ = thx_text_table_Span; return $x; };
thx_text_table_Span.FillRight = ["FillRight",4];
thx_text_table_Span.FillRight.__enum__ = thx_text_table_Span;
thx_text_table_Span.FillDown = ["FillDown",5];
thx_text_table_Span.FillDown.__enum__ = thx_text_table_Span;
thx_text_table_Span.FillBoth = ["FillBoth",6];
thx_text_table_Span.FillBoth.__enum__ = thx_text_table_Span;
var thx_text_table_StringBlock = function(lines) {
	this.lines = lines;
	this.width = thx_Arrays.reduce(lines,function(width,line) {
		var b = line.length;
		if(width > b) {
			return width;
		} else {
...
thx_text_table_StringBlock.__name__ = ["thx","text","table","StringBlock"];
thx_text_table_StringBlock.fromString = function(s) {
	return new thx_text_table_StringBlock(new EReg("(\r\n|\n\r|\n|\r)","g").split(s));
};
thx_text_table_StringBlock.empty = function() {
	return new thx_text_table_StringBlock([]);
};
thx_text_table_StringBlock.prototype = {
	lines: null
	,width: null
	,height: null
	,getLine: function(index) {
		...
		return this.lines[index].split("");
	}
	,symbolPos: function(s) {
		var max = 0;
		var pos;
		var _g = 0;
		var _g1 = this.lines;
	...
	,__class__: thx_text_table_StringBlock
};
var thx_text_table_IStyle = function() { };
thx_text_table_IStyle.__name__ = ["thx","text","table","IStyle"];
thx_text_table_IStyle.prototype = {
	get_type: null
	,set_type: null
	,get_minWidth: null
	,set_minWidth: null
	...
	,set_aligner: null
	,setAlign: null
	,__class__: thx_text_table_IStyle
	,__properties__: {set_aligner:"set_aligner",get_aligner:"get_aligner",set_formatter:"set_formatter",get_formatter:"get_formatter",set_maxHeight:"set_maxHeight",get_maxHeight:"get_maxHeight",set_minHeight:"set_minHeight",get_minHeight:"get_minHeight",set_maxWidth:"set_maxWidth",get_maxWidth:"get_maxWidth",set_minWidth:"set_minWidth",get_minWidth:"get_minWidth",set_type:"set_type",get_type:"get_type"}
};
var thx_text_table_Style = function() {
};
thx_text_table_Style.__name__ = ["thx","text","table","Style"];
thx_text_table_Style.__interfaces__ = [thx_text_table_IStyle];
thx_text_table_Style.prototype = {
	type: null
	,maxHeight: null
	,minHeight: null
	,maxWidth: null
	...
	,setAlign: function(align) {
		this.set_aligner(function(_,_1) {
			return align;
		});
	}
	,get_type: function() {
	...
	,get_aligner: function() {
		return this.aligner;
	}
	,set_aligner: function(value) {
		return this.aligner = value;
	}
	,__class__: thx_text_table_Style
...
var thx_text_table_CompositeStyle = function(parents) {
	thx_text_table_Style.call(this);
	this.parents = parents;
};
thx_text_table_CompositeStyle.__name__ = ["thx","text","table","CompositeStyle"];
thx_text_table_CompositeStyle.__super__ = thx_text_table_Style;
thx_text_table_CompositeStyle.prototype = $extend(thx_text_table_Style.prototype,{
	parents: null
	,get_type: function() {
	...
	,get_aligner: function() {
		return this.getProperty("aligner");
	}
	,set_aligner: function(value) {
		return this.aligner = value;
	}
	,getProperty: function(name) {
		...
		while(_g < _g1.length) {
			...
			if(parent == null) {
				...
				var tmp2;
				if(parent.__properties__) {
					tmp = parent.__properties__["get_" + name];
					tmp2 = tmp;
				} else {
					tmp2 = false;
				}
	...
	,__class__: thx_text_table_CompositeStyle
});
var thx_text_table_CellType = { __ename__ : ["thx","text","table","CellType"], __constructs__ : ["Header","HeaderCompact","Body","BodyCompact"] };
thx_text_table_CellType.Header = ["Header",0];
thx_text_table_CellType.Header.__enum__ = thx_text_table_CellType;
thx_text_table_CellType.HeaderCompact = ["HeaderCompact",1];
thx_text_table_CellType.HeaderCompact.__enum__ = thx_text_table_CellType;
thx_text_table_CellType.Body = ["Body",2];
thx_text_table_CellType.Body.__enum__ = thx_text_table_CellType;
thx_text_table_CellType.BodyCompact = ["BodyCompact",3];
thx_text_table_CellType.BodyCompact.__enum__ = thx_text_table_CellType;
var thx_text_table_DefaultStyle = function() {
};
thx_text_table_DefaultStyle.__name__ = ["thx","text","table","DefaultStyle"];
thx_text_table_DefaultStyle.__interfaces__ = [thx_text_table_IStyle];
thx_text_table_DefaultStyle.defaultIntFormatter = function(v) {
	return thx_format_NumberFormat.integer(v,thx_text_table_DefaultStyle.defaultCulture);
};
thx_text_table_DefaultStyle.defaultFloatFormatter = function(v) {
	return thx_format_NumberFormat.format(v,"#,#.#####",thx_text_table_DefaultStyle.defaultCulture);
};
thx_text_table_DefaultStyle.defaultStringFormatter = function(v) {
	return v;
};
thx_text_table_DefaultStyle.defaultBoolFormatter = function(v) {
	if(v) {
		return "✓";
	} else {
		return "✕";
...
thx_text_table_DefaultStyle.defaultDateTimeFormatter = function(v) {
	return thx_format_DateFormat.dateShort(v,thx_text_table_DefaultStyle.defaultCulture);
};
thx_text_table_DefaultStyle.defaultTimeFormatter = function(v) {
	return thx_format_TimeFormat.timeLong(v,thx_text_table_DefaultStyle.defaultCulture);
};
thx_text_table_DefaultStyle.defaultNAFormatter = function() {
	return "NA";
};
thx_text_table_DefaultStyle.defaultEmptyFormatter = function() {
	return "";
};
thx_text_table_DefaultStyle.defaultFormatter = function(value,maxWidth) {
	if(value[1] == 2) {
		var v = value[2];
		if(null != maxWidth && maxWidth > 0) {
			v = thx_Strings.wrapColumns(v,maxWidth);
		}
	...
	switch(value[1]) {
	case 0:
		s = thx_text_table_DefaultStyle.defaultIntFormatter(value[2]);
		break;
	case 1:
		s = thx_text_table_DefaultStyle.defaultFloatFormatter(value[2]);
		break;
	case 2:
		s = thx_text_table_DefaultStyle.defaultStringFormatter(value[2]);
		break;
	case 3:
		s = thx_text_table_DefaultStyle.defaultBoolFormatter(value[2]);
		break;
	case 4:
		s = thx_text_table_DefaultStyle.defaultDateTimeFormatter(value[2]);
		break;
	case 5:
		s = thx_text_table_DefaultStyle.defaultTimeFormatter(value[2]);
		break;
	case 6:
	...
	if(null != maxWidth && maxWidth > 0) {
		s = thx_Strings.ellipsisMiddle(s);
	}
	return new thx_text_table_StringBlock([s]);
};
thx_text_table_DefaultStyle.defaultAligner = function(value,type) {
	switch(type[1]) {
	case 0:
		switch(value[1]) {
...
thx_text_table_DefaultStyle.prototype = {
	setAlign: function(align) {
		this.set_aligner(function(_,_1) {
			return align;
		});
	...
	,get_formatter: function() {
		return thx_text_table_DefaultStyle.defaultFormatter;
	}
	,set_formatter: function(value) {
		return thx_text_table_DefaultStyle.defaultFormatter = value;
	}
	,get_aligner: function() {
		return thx_text_table_DefaultStyle.defaultAligner;
	}
	,set_aligner: function(value) {
		return thx_text_table_DefaultStyle.defaultAligner = value;
	}
	,__class__: thx_text_table_DefaultStyle
	,__properties__: {set_aligner:"set_aligner",get_aligner:"get_aligner",set_formatter:"set_formatter",get_formatter:"get_formatter",set_minWidth:"set_minWidth",get_minWidth:"get_minWidth",set_maxWidth:"set_maxWidth",get_maxWidth:"get_maxWidth",set_minHeight:"set_minHeight",get_minHeight:"get_minHeight",set_maxHeight:"set_maxHeight",get_maxHeight:"get_maxHeight",set_type:"set_type",get_type:"get_type"}
};
var thx_text_table_BorderStyle = { __ename__ : ["thx","text","table","BorderStyle"], __constructs__ : ["None","Normal","Double"] };
thx_text_table_BorderStyle.None = ["None",0];
thx_text_table_BorderStyle.None.__enum__ = thx_text_table_BorderStyle;
thx_text_table_BorderStyle.Normal = ["Normal",1];
thx_text_table_BorderStyle.Normal.__enum__ = thx_text_table_BorderStyle;
thx_text_table_BorderStyle.Double = ["Double",2];
thx_text_table_BorderStyle.Double.__enum__ = thx_text_table_BorderStyle;
var thx_text_table_Border = { __ename__ : ["thx","text","table","Border"], __constructs__ : ["Removable","RemovableCross","Cross"] };
thx_text_table_Border.Removable = ["Removable",0];
thx_text_table_Border.Removable.__enum__ = thx_text_table_Border;
thx_text_table_Border.RemovableCross = function(top,right,bottom,left) { var $x = ["RemovableCross",1,top,right,bottom,left]; $x.__enum__ = thx_text_table_Border; return $x; };
thx_text_table_Border.Cross = function(top,right,bottom,left) { var $x = ["Cross",2,top,right,bottom,left]; $x.__enum__ = thx_text_table_Border; return $x; };
...
thx_text_Inflections.uncountable_words = ["equipment","information","rice","money","species","series","fish","sheep","moose","deer","news"];
thx_text_Inflections.plural_rules = [{ pattern : new EReg("(m)an$","gi"), replace : "$1en"},{ pattern : new EReg("(pe)rson$","gi"), replace : "$1ople"},{ pattern : new EReg("(child)$","gi"), replace : "$1ren"},{ pattern : new EReg("(ax|test)is$","gi"), replace : "$1es"},{ pattern : new EReg("(octop|vir)us$","gi"), replace : "$1i"},{ pattern : new EReg("(alias|status)$","gi"), replace : "$1es"},{ pattern : new EReg("(bu)s$","gi"), replace : "$1ses"},{ pattern : new EReg("(buffal|tomat)o$","gi"), replace : "$1oes"},{ pattern : new EReg("([ti])um$","gi"), replace : "$1a"},{ pattern : new EReg("sis$","gi"), replace : "ses"},{ pattern : new EReg("(?:([^f])fe|([lr])f)$","gi"), replace : "$1$2ves"},{ pattern : new EReg("(hive)$","gi"), replace : "$1s"},{ pattern : new EReg("([^aeiouy]|qu)y$","gi"), replace : "$1ies"},{ pattern : new EReg("(x|ch|ss|sh)$","gi"), replace : "$1es"},{ pattern : new EReg("(matr|vert|ind)ix|ex$","gi"), replace : "$1ices"},{ pattern : new EReg("([m|l])ouse$","gi"), replace : "$1ice"},{ pattern : new EReg("^(ox)$","gi"), replace : "$1en"},{ pattern : new EReg("(quiz)$","gi"), replace : "$1zes"},{ pattern : new EReg("s$","gi"), replace : "s"},{ pattern : new EReg("$","gi"), replace : "s"}];
thx_text_Inflections.singular_rules = [{ pattern : new EReg("(m)en$","gi"), replace : "$1an"},{ pattern : new EReg("(pe)ople$","gi"), replace : "$1rson"},{ pattern : new EReg("(child)ren$","gi"), replace : "$1"},{ pattern : new EReg("([ti])a$","gi"), replace : "$1um"},{ pattern : new EReg("((a)naly|(b)a|(d)iagno|(p)arenthe|(p)rogno|(s)ynop|(t)he)ses$","gi"), replace : "$1$2sis"},{ pattern : new EReg("(hive)s$","gi"), replace : "$1"},{ pattern : new EReg("(tive)s$","gi"), replace : "$1"},{ pattern : new EReg("([lr])ves$","gi"), replace : "$1f"},{ pattern : new EReg("([^fo])ves$","gi"), replace : "$1fe"},{ pattern : new EReg("([^aeiouy]|qu)ies$","gi"), replace : "$1y"},{ pattern : new EReg("(s)eries$","gi"), replace : "$1eries"},{ pattern : new EReg("(m)ovies$","gi"), replace : "$1ovie"},{ pattern : new EReg("(x|ch|ss|sh)es$","gi"), replace : "$1"},{ pattern : new EReg("([m|l])ice$","gi"), replace : "$1ouse"},{ pattern : new EReg("(bus)es$","gi"), replace : "$1"},{ pattern : new EReg("(o)es$","gi"), replace : "$1"},{ pattern : new EReg("(shoe)s$","gi"), replace : "$1"},{ pattern : new EReg("(cris|ax|test)es$","gi"), replace : "$1is"},{ pattern : new EReg("(octop|vir)i$","gi"), replace : "$1us"},{ pattern : new EReg("(alias|status)es$","gi"), replace : "$1"},{ pattern : new EReg("^(ox)en","gi"), replace : "$1"},{ pattern : new EReg("(vert|ind)ices$","gi"), replace : "$1ex"},{ pattern : new EReg("(matr)ices$","gi"), replace : "$1ix"},{ pattern : new EReg("(quiz)zes$","gi"), replace : "$1"},{ pattern : new EReg("s$","gi"), replace : ""}];
...
thx_text_table_DefaultStyle.defaultMinHeight = 1;
thx_text_table_DefaultStyle.defaultMinWidth = 1;
thx_text_table_DefaultStyle.defaultCulture = (function($this) {
	var $r;
