...
namespace thx.text.table {
	public class Renderer : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_text_table_Renderer(global::thx.text.table.Renderer __temp_me179, global::haxe.lang.Null<int> padding) {
			unchecked {
				global::haxe.lang.Null<int> __temp_padding178 = ( ( ! (padding.hasValue) ) ? (new global::haxe.lang.Null<int>(1, true)) : (padding) );
				__temp_me179.padding = (__temp_padding178).@value;
			}
		}
