...
namespace thx.text.table {
	public class Canvas : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_text_table_Canvas(global::thx.text.table.Canvas __temp_me174, int width, int height) {
			__temp_me174.values = new global::Array<object>(new object[]{});
			__temp_me174.expand(width, height);
		}
