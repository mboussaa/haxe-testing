...
namespace thx.text.table {
	public class CellSet : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_text_table_CellSet(global::thx.text.table.CellSet __temp_me176, global::thx.text.Table table, int index) {
			__temp_me176.index = index;
			__temp_me176.table = table;
			__temp_me176.values = new global::haxe.ds.IntMap<object>();
			__temp_me176.size = 0;
			__temp_me176.style = new global::thx.text.table.Style();
		}
