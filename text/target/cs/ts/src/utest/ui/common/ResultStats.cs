...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me205) {
			__temp_me205.assertations = 0;
			__temp_me205.successes = 0;
			__temp_me205.failures = 0;
			__temp_me205.errors = 0;
			__temp_me205.warnings = 0;
			__temp_me205.isOk = true;
			__temp_me205.hasFailures = false;
			__temp_me205.hasErrors = false;
			__temp_me205.hasWarnings = false;
			__temp_me205.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me205.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me205.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me205.onAddWarnings = new global::utest.Dispatcher<int>();
		}
