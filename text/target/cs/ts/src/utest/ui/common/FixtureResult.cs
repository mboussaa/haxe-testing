...
namespace utest.ui.common {
	public class FixtureResult : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_FixtureResult(global::utest.ui.common.FixtureResult __temp_me198, string methodName) {
			__temp_me198.methodName = methodName;
			__temp_me198.list = new global::List<object>();
			__temp_me198.hasTestError = false;
			__temp_me198.hasSetupError = false;
			__temp_me198.hasTeardownError = false;
			__temp_me198.hasTimeoutError = false;
			__temp_me198.hasAsyncError = false;
			__temp_me198.stats = new global::utest.ui.common.ResultStats();
		}
