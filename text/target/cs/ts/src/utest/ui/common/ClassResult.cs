...
namespace utest.ui.common {
	public class ClassResult : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ClassResult(global::utest.ui.common.ClassResult __temp_me197, string className, string setupName, string teardownName) {
			__temp_me197.fixtures = new global::haxe.ds.StringMap<object>();
			__temp_me197.className = className;
			__temp_me197.setupName = setupName;
			__temp_me197.hasSetup =  ! (string.Equals(setupName, null)) ;
			__temp_me197.teardownName = teardownName;
			__temp_me197.hasTeardown =  ! (string.Equals(teardownName, null)) ;
			__temp_me197.methods = 0;
			__temp_me197.stats = new global::utest.ui.common.ResultStats();
		}
		...
		public virtual global::Array<object> methodNames(global::haxe.lang.Null<bool> errorsHavePriority) {
			bool __temp_errorsHavePriority196 = ( ( ! (errorsHavePriority.hasValue) ) ? (true) : ((errorsHavePriority).@value) );
			...
			if (__temp_errorsHavePriority196) {
