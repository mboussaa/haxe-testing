...
namespace thx.text {
	public class Table : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_text_Table(global::thx.text.Table __temp_me170) {
			__temp_me170._rows = new global::Array<object>(new object[]{});
			__temp_me170._cols = new global::Array<object>(new object[]{});
			__temp_me170.style = new global::thx.text.table.Style();
		}
		
		
		public static global::thx.text.Table fromData(global::Array<object> data, global::haxe.lang.Null<bool> hasHeader, string title) {
			unchecked {
				global::haxe.lang.Null<bool> __temp_hasHeader169 = ( ( ! (hasHeader.hasValue) ) ? (new global::haxe.lang.Null<bool>(true, true)) : (hasHeader) );
				int offset = ( (string.Equals(title, null)) ? (0) : (1) );
				global::thx.text.Table table = new global::thx.text.Table();
				if (((__temp_hasHeader169)).@value) {
