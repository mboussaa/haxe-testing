...
namespace thx.text.table {
	public class Cell : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_text_table_Cell(global::thx.text.table.Cell __temp_me173, global::thx.text.table.CellValueImpl @value, global::thx.text.table.Row row, global::thx.text.table.Col col, global::thx.text.table.Span span) {
			__temp_me173.@value = @value;
			__temp_me173.row = row;
			__temp_me173.col = col;
			__temp_me173.span = span;
			__temp_me173.table = col.table;
			__temp_me173.style = new global::thx.text.table.CompositeStyle(((global::Array<object>) (new global::Array<object>(new object[]{col.style, row.style, __temp_me173.table.style, global::thx.text.table.DefaultStyle.instance})) ));
		}
