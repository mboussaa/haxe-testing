...
namespace utest.ui.common {
	public class ClassResult : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ClassResult(global::utest.ui.common.ClassResult __temp_me195, string className, string setupName, string teardownName) {
			__temp_me195.fixtures = new global::haxe.ds.StringMap<object>();
			__temp_me195.className = className;
			__temp_me195.setupName = setupName;
			__temp_me195.hasSetup =  ! (string.Equals(setupName, null)) ;
			__temp_me195.teardownName = teardownName;
			__temp_me195.hasTeardown =  ! (string.Equals(teardownName, null)) ;
			__temp_me195.methods = 0;
			__temp_me195.stats = new global::utest.ui.common.ResultStats();
		}
		...
		public virtual global::Array<object> methodNames(global::haxe.lang.Null<bool> errorsHavePriority) {
			bool __temp_errorsHavePriority194 = ( ( ! (errorsHavePriority.hasValue) ) ? (true) : ((errorsHavePriority).@value) );
			...
			if (__temp_errorsHavePriority194) {
