...
Float EntryPoint_obj::processEvents(){
            	HX_STACK_FRAME("haxe.EntryPoint","processEvents",0x04eb4e60,"haxe.EntryPoint.processEvents","/usr/lib/haxe/std/haxe/EntryPoint.hx",91,0x5ab6a258)
...
void EntryPoint_obj::run(){
            	HX_STACK_FRAME("haxe.EntryPoint","run",0xf0324cc3,"haxe.EntryPoint.run","/usr/lib/haxe/std/haxe/EntryPoint.hx",132,0x5ab6a258)
...
{
{
            	HX_STACK_FRAME("haxe.EntryPoint","boot",0x3138e7ba,"haxe.EntryPoint.boot","/usr/lib/haxe/std/haxe/EntryPoint.hx",46,0x5ab6a258)
HXLINE(  46)		sleepLock =  ::cpp::vm::Lock_obj::__new();
            	}
{
            	HX_STACK_FRAME("haxe.EntryPoint","boot",0x3138e7ba,"haxe.EntryPoint.boot","/usr/lib/haxe/std/haxe/EntryPoint.hx",47,0x5ab6a258)
HXLINE(  47)		mutex =  ::cpp::vm::Mutex_obj::__new();
            	}
{
            	HX_STACK_FRAME("haxe.EntryPoint","boot",0x3138e7ba,"haxe.EntryPoint.boot","/usr/lib/haxe/std/haxe/EntryPoint.hx",49,0x5ab6a258)
HXLINE(  49)		pending = ::Array_obj< ::Dynamic>::__new();
            	}
{
            	HX_STACK_FRAME("haxe.EntryPoint","boot",0x3138e7ba,"haxe.EntryPoint.boot","/usr/lib/haxe/std/haxe/EntryPoint.hx",51,0x5ab6a258)
