...
void TS2_obj::addTests( ::utest::Runner runner){
            	HX_STACK_FRAME("TS2","addTests",0x57cbabfb,"TS2.addTests","TS2.hx",6,0x816c62cb)
...
HXLINE(  16)		::haxe::Log_obj::trace((HX_("The value of loop_wrapper is ",79,76,58,6c) + w),hx::SourceInfo(HX_("TS2.hx",cb,62,6c,81),16,HX_("TS2",d3,05,40,00),HX_("addTests",00,a6,f2,86)));
HXLINE(  18)		HX_VARI( Int,x) = ::Std_obj::parseInt(w);
HXLINE(  19)		runner->addCase( ::thx::math::random::TestPseudoRandom_obj::__new(x),null(),null(),null(),null());
            	}
...
void TS2_obj::main(){
            	HX_STACK_FRAME("TS2","main",0x029fe4b4,"TS2.main","TS2.hx",22,0x816c62cb)
HXLINE(  24)		HX_VARI(  ::utest::Runner,runner) =  ::utest::Runner_obj::__new();
HXLINE(  25)		::TS2_obj::addTests(runner);
