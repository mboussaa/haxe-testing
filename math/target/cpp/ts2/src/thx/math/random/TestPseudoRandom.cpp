...
void TestPseudoRandom_obj::__construct(Int i){
            	HX_STACK_FRAME("thx.math.random.TestPseudoRandom","new",0xaf4c65f4,"thx.math.random.TestPseudoRandom.new","thx/math/random/TestPseudoRandom.hx",8,0xc2638cfb)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(i,"i")
HXLINE(   8)		this->x = i;
            	}
...
hx::ObjectPtr< TestPseudoRandom_obj > TestPseudoRandom_obj::__new(Int i)
{
...
hx::Val TestPseudoRandom_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 1:
...
void TestPseudoRandom_obj::__GetFields(Array< ::String> &outFields)
{
...
#if HXCPP_SCRIPTABLE
static hx::StorageInfo TestPseudoRandom_obj_sMemberStorageInfo[] = {
	{hx::fsInt,(int)offsetof(TestPseudoRandom_obj,x),HX_HCSTRING("x","\x78","\x00","\x00","\x00")},
	{ hx::fsUnknown, 0, null()}
};
