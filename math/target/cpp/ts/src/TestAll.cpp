...
HXLINE(   6)		runner->addCase( ::thx::math::random::TestNativeRandom_obj::__new(),null(),null(),null(),null());
HXLINE(   7)		runner->addCase( ::thx::math::random::TestPseudoRandom_obj::__new(),null(),null(),null(),null());
HXLINE(   8)		runner->addCase( ::thx::math::random::TestRandomAbstract_obj::__new(),null(),null(),null(),null());
            	}
...
void TestAll_obj::main(){
            	HX_STACK_FRAME("TestAll","main",0x6594a938,"TestAll.main","TestAll.hx",11,0x4f103e4f)
HXLINE(  12)		HX_VARI(  ::utest::Runner,runner) =  ::utest::Runner_obj::__new();
HXLINE(  13)		::TestAll_obj::addTests(runner);
