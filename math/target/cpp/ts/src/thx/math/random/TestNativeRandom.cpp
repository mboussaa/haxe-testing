...
void TestNativeRandom_obj::__construct(){
            	HX_STACK_FRAME("thx.math.random.TestNativeRandom","new",0x61225d4d,"thx.math.random.TestNativeRandom.new","thx/math/random/TestNativeRandom.hx",6,0x764583c2)
            	HX_STACK_THIS(this)
            	}

Dynamic TestNativeRandom_obj::__CreateEmpty() { return new TestNativeRandom_obj; }

hx::ObjectPtr< TestNativeRandom_obj > TestNativeRandom_obj::__new()
{
...
void TestNativeRandom_obj::testIntBoundaries(){
            	HX_STACK_FRAME("thx.math.random.TestNativeRandom","testIntBoundaries",0x3bf92b92,"thx.math.random.TestNativeRandom.testIntBoundaries","thx/math/random/TestNativeRandom.hx",8,0x764583c2)
            	HX_STACK_THIS(this)
HXLINE(   9)		HX_VARI(  ::thx::math::random::NativeRandom,random) =  ::thx::math::random::NativeRandom_obj::__new();
HXLINE(  11)		{
HXLINE(  11)			HX_VARI( Int,_g) = (int)0;
HXDLIN(  11)			while((_g < (int)1000)){
HXLINE(  11)				HX_VARI( Int,i) = _g++;
HXLINE(  12)				HX_VARI( Int,v) = random->_hx_int();
HXLINE(  13)				Bool _hx_tmp;
HXDLIN(  13)				if ((v >= (int)0)) {
HXLINE(  13)					_hx_tmp = (v <= (int)2147483647);
            				}
            				else {
HXLINE(  13)					_hx_tmp = false;
            				}
HXDLIN(  13)				::utest::Assert_obj::isTrue(_hx_tmp,(HX_("expected value to be between 0 and 0x7FFFFFFF, but is ",0c,60,53,31) + i),hx::SourceInfo(HX_("TestNativeRandom.hx",b2,93,10,47),13,HX_("thx.math.random.TestNativeRandom",db,b2,64,d4),HX_("testIntBoundaries",e5,b9,5a,c6)));
            			}
            		}
            	}
...
void TestNativeRandom_obj::testFloatBoundaries(){
            	HX_STACK_FRAME("thx.math.random.TestNativeRandom","testFloatBoundaries",0x2828133f,"thx.math.random.TestNativeRandom.testFloatBoundaries","thx/math/random/TestNativeRandom.hx",17,0x764583c2)
            	HX_STACK_THIS(this)
HXLINE(  18)		HX_VARI(  ::thx::math::random::NativeRandom,random) =  ::thx::math::random::NativeRandom_obj::__new();
HXLINE(  20)		{
HXLINE(  20)			HX_VARI( Int,_g) = (int)0;
HXDLIN(  20)			while((_g < (int)1000)){
HXLINE(  20)				HX_VARI( Int,i) = _g++;
HXLINE(  21)				HX_VARI( Float,v) = random->_hx_float();
HXLINE(  22)				Bool _hx_tmp;
HXDLIN(  22)				if ((v >= (int)0)) {
HXLINE(  22)					_hx_tmp = (v <= ((Float)1.0));
            				}
            				else {
HXLINE(  22)					_hx_tmp = false;
            				}
HXDLIN(  22)				::utest::Assert_obj::isTrue(_hx_tmp,(HX_("expected value to be between 0 and 1, but is ",92,24,5d,d0) + i),hx::SourceInfo(HX_("TestNativeRandom.hx",b2,93,10,47),22,HX_("thx.math.random.TestNativeRandom",db,b2,64,d4),HX_("testFloatBoundaries",52,1c,c8,38)));
            			}
            		}
            	}
...
#if HXCPP_SCRIPTABLE
static hx::StorageInfo *TestNativeRandom_obj_sMemberStorageInfo = 0;
