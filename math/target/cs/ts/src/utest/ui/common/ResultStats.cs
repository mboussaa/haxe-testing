...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me160) {
			__temp_me160.assertations = 0;
			__temp_me160.successes = 0;
			__temp_me160.failures = 0;
			__temp_me160.errors = 0;
			__temp_me160.warnings = 0;
			__temp_me160.isOk = true;
			__temp_me160.hasFailures = false;
			__temp_me160.hasErrors = false;
			__temp_me160.hasWarnings = false;
			__temp_me160.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me160.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me160.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me160.onAddWarnings = new global::utest.Dispatcher<int>();
		}
