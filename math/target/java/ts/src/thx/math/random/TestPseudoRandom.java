...
public class TestPseudoRandom extends haxe.lang.HxObject
{
	...
	public TestPseudoRandom()
	{
		//line 6 "/shared/math/test/thx/math/random/TestPseudoRandom.hx"
		thx.math.random.TestPseudoRandom.__hx_ctor_thx_math_random_TestPseudoRandom(this);
	}
	
	
	public static void __hx_ctor_thx_math_random_TestPseudoRandom(thx.math.random.TestPseudoRandom __temp_me118)
	{
	}
	...
	{
		//line 5 "/shared/math/test/thx/math/random/TestPseudoRandom.hx"
		return new thx.math.random.TestPseudoRandom(haxe.lang.EmptyObject.EMPTY);
	}
	...
	public void testSequence1()
	{
		...
		//line 12 "/shared/math/test/thx/math/random/TestPseudoRandom.hx"
		{
			...
			{
				//line 12 "/shared/math/test/thx/math/random/TestPseudoRandom.hx"
				int e = ((int) (haxe.lang.Runtime.toInt(expected.__get(_g))) );
				//line 12 "/shared/math/test/thx/math/random/TestPseudoRandom.hx"
				 ++ _g;
				//line 13 "/shared/math/test/thx/math/random/TestPseudoRandom.hx"
				utest.Assert.equals(e, random._int(), null, new haxe.lang.DynamicObject(new java.lang.String[]{"className", "fileName", "methodName"}, new java.lang.Object[]{"thx.math.random.TestPseudoRandom", "TestPseudoRandom.hx", "testSequence1"}, new java.lang.String[]{"lineNumber"}, new double[]{((double) (((double) (13) )) )}));
			}
	...
	public void testSequence2()
	{
		...
		//line 20 "/shared/math/test/thx/math/random/TestPseudoRandom.hx"
		{
			...
			while (( _g < expected.length ))
			{
				...
				//line 20 "/shared/math/test/thx/math/random/TestPseudoRandom.hx"
				 ++ _g;
				//line 21 "/shared/math/test/thx/math/random/TestPseudoRandom.hx"
				utest.Assert.equals(e, random._int(), null, new haxe.lang.DynamicObject(new java.lang.String[]{"className", "fileName", "methodName"}, new java.lang.Object[]{"thx.math.random.TestPseudoRandom", "TestPseudoRandom.hx", "testSequence2"}, new java.lang.String[]{"lineNumber"}, new double[]{((double) (((double) (21) )) )}));
			}
	...
	@Override public java.lang.Object __hx_getField(java.lang.String field, boolean throwErrors, boolean isCheck, boolean handleProperties)
	{
		//line 5 "/shared/math/test/thx/math/random/TestPseudoRandom.hx"
		{
			...
			switch (field.hashCode())
			{
				...
				{
					//line 5 "/shared/math/test/thx/math/random/TestPseudoRandom.hx"
					if (field.equals("testSequence2")) 
					{
						//line 5 "/shared/math/test/thx/math/random/TestPseudoRandom.hx"
						__temp_executeDef1 = false;
						//line 5 "/shared/math/test/thx/math/random/TestPseudoRandom.hx"
						return ((haxe.lang.Function) (new haxe.lang.Closure(this, "testSequence2")) );
					}
				...
				{
					//line 5 "/shared/math/test/thx/math/random/TestPseudoRandom.hx"
					if (field.equals("testSequence1")) 
					{
						//line 5 "/shared/math/test/thx/math/random/TestPseudoRandom.hx"
						__temp_executeDef1 = false;
						//line 5 "/shared/math/test/thx/math/random/TestPseudoRandom.hx"
						return ((haxe.lang.Function) (new haxe.lang.Closure(this, "testSequence1")) );
					}
