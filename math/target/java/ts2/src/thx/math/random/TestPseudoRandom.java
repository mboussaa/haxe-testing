...
public class TestPseudoRandom extends haxe.lang.HxObject
{
	...
	{
		//line 7 "/shared/math/test/thx/math/random/TestPseudoRandom.hx"
		thx.math.random.TestPseudoRandom.__hx_ctor_thx_math_random_TestPseudoRandom(this, i);
	}
	
	
	public static void __hx_ctor_thx_math_random_TestPseudoRandom(thx.math.random.TestPseudoRandom __temp_me34, int i)
	{
		//line 8 "/shared/math/test/thx/math/random/TestPseudoRandom.hx"
		__temp_me34.x = i;
	}
	...
	public void testSequence1()
	{
		...
		while (( _g1 < _g ))
		{
			...
			//line 16 "/shared/math/test/thx/math/random/TestPseudoRandom.hx"
			{
				//line 16 "/shared/math/test/thx/math/random/TestPseudoRandom.hx"
				int _g2 = 0;
				//line 16 "/shared/math/test/thx/math/random/TestPseudoRandom.hx"
				while (( _g2 < expected.length ))
				{
					//line 16 "/shared/math/test/thx/math/random/TestPseudoRandom.hx"
					int e = ((int) (haxe.lang.Runtime.toInt(expected.__get(_g2))) );
					//line 16 "/shared/math/test/thx/math/random/TestPseudoRandom.hx"
					 ++ _g2;
					//line 17 "/shared/math/test/thx/math/random/TestPseudoRandom.hx"
					utest.Assert.equals(e, random._int(), null, new haxe.lang.DynamicObject(new java.lang.String[]{"className", "fileName", "methodName"}, new java.lang.Object[]{"thx.math.random.TestPseudoRandom", "TestPseudoRandom.hx", "testSequence1"}, new java.lang.String[]{"lineNumber"}, new double[]{((double) (((double) (17) )) )}));
				}
	...
	public void testSequence2()
	{
		...
		while (( _g1 < _g ))
		{
			//line 21 "/shared/math/test/thx/math/random/TestPseudoRandom.hx"
			 ++ _g1;
			//line 22 "/shared/math/test/thx/math/random/TestPseudoRandom.hx"
			...
			//line 25 "/shared/math/test/thx/math/random/TestPseudoRandom.hx"
			{
				//line 25 "/shared/math/test/thx/math/random/TestPseudoRandom.hx"
				int _g2 = 0;
				//line 25 "/shared/math/test/thx/math/random/TestPseudoRandom.hx"
				while (( _g2 < expected.length ))
				{
					...
					//line 25 "/shared/math/test/thx/math/random/TestPseudoRandom.hx"
					 ++ _g2;
					//line 26 "/shared/math/test/thx/math/random/TestPseudoRandom.hx"
					utest.Assert.equals(e, random._int(), null, new haxe.lang.DynamicObject(new java.lang.String[]{"className", "fileName", "methodName"}, new java.lang.Object[]{"thx.math.random.TestPseudoRandom", "TestPseudoRandom.hx", "testSequence2"}, new java.lang.String[]{"lineNumber"}, new double[]{((double) (((double) (26) )) )}));
				}
