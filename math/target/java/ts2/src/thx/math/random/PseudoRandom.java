...
public class PseudoRandom extends haxe.lang.HxObject
{
	...
	public static void __hx_ctor_thx_math_random_PseudoRandom(thx.math.random.PseudoRandom __temp_me33, java.lang.Object seed)
	{
		//line 7 "/shared/math/src/thx/math/random/PseudoRandom.hx"
		int __temp_seed32 = ( (haxe.lang.Runtime.eq(seed, null)) ? (1) : (((int) (haxe.lang.Runtime.toInt(seed)) )) );
		//line 7 "/shared/math/src/thx/math/random/PseudoRandom.hx"
		__temp_me33.seed = __temp_seed32;
	}
