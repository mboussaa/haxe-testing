...
TestAll.addTests = function(runner) {
	runner.addCase(new thx_math_random_TestNativeRandom());
	runner.addCase(new thx_math_random_TestPseudoRandom());
	runner.addCase(new thx_math_random_TestRandomAbstract());
};
...
var thx_math_random_NativeRandom = function() {
};
thx_math_random_NativeRandom.__name__ = ["thx","math","random","NativeRandom"];
thx_math_random_NativeRandom.prototype = {
	'int': function() {
	...
	,__class__: thx_math_random_NativeRandom
};
...
var thx_math_random_TestNativeRandom = function() {
};
thx_math_random_TestNativeRandom.__name__ = ["thx","math","random","TestNativeRandom"];
thx_math_random_TestNativeRandom.prototype = {
	testIntBoundaries: function() {
		var random = new thx_math_random_NativeRandom();
		var _g = 0;
		while(_g < 1000) {
			var i = _g++;
			var v = random["int"]();
			utest_Assert.isTrue(v >= 0 && v <= 2147483647,"expected value to be between 0 and 0x7FFFFFFF, but is " + i,{ fileName : "TestNativeRandom.hx", lineNumber : 13, className : "thx.math.random.TestNativeRandom", methodName : "testIntBoundaries"});
		}
	}
	,testFloatBoundaries: function() {
		var random = new thx_math_random_NativeRandom();
		var _g = 0;
		while(_g < 1000) {
			var i = _g++;
			var v = random["float"]();
			utest_Assert.isTrue(v >= 0 && v <= 1.0,"expected value to be between 0 and 1, but is " + i,{ fileName : "TestNativeRandom.hx", lineNumber : 22, className : "thx.math.random.TestNativeRandom", methodName : "testFloatBoundaries"});
		}
	}
	,__class__: thx_math_random_TestNativeRandom
};
var thx_math_random_TestPseudoRandom = function() {
};
thx_math_random_TestPseudoRandom.__name__ = ["thx","math","random","TestPseudoRandom"];
thx_math_random_TestPseudoRandom.prototype = {
	testSequence1: function() {
		...
		var random = new thx_math_random_PseudoRandom(1);
		var _g = 0;
		while(_g < expected.length) {
			var e = expected[_g];
			++_g;
			utest_Assert.equals(e,random["int"](),null,{ fileName : "TestPseudoRandom.hx", lineNumber : 13, className : "thx.math.random.TestPseudoRandom", methodName : "testSequence1"});
		}
	}
	,testSequence2: function() {
		...
		var random = new thx_math_random_PseudoRandom(777);
		var _g = 0;
		while(_g < expected.length) {
			var e = expected[_g];
			++_g;
			utest_Assert.equals(e,random["int"](),null,{ fileName : "TestPseudoRandom.hx", lineNumber : 21, className : "thx.math.random.TestPseudoRandom", methodName : "testSequence2"});
		}
	}
	,__class__: thx_math_random_TestPseudoRandom
};
var thx_math_random_TestRandomAbstract = function() {
};
thx_math_random_TestRandomAbstract.__name__ = ["thx","math","random","TestRandomAbstract"];
thx_math_random_TestRandomAbstract.prototype = {
	testLessThan: function() {
		var random = new thx_math_random_PseudoRandom();
		var _g = 0;
		while(_g < 100) {
			++_g;
			var r = thx_math_random__$Random_Random_$Impl_$.lessThan(random,10);
			utest_Assert.isTrue(r >= 0,null,{ fileName : "TestRandomAbstract.hx", lineNumber : 13, className : "thx.math.random.TestRandomAbstract", methodName : "testLessThan"});
			utest_Assert.isTrue(r < 10,null,{ fileName : "TestRandomAbstract.hx", lineNumber : 14, className : "thx.math.random.TestRandomAbstract", methodName : "testLessThan"});
		}
	}
	,__class__: thx_math_random_TestRandomAbstract
};
