...
TS2.addTests = function(runner) {
	...
	runner.addCase(new thx_math_random_TestPseudoRandom(Std.parseInt(w)));
};
TS2.main = function() {
...
var thx_math_random_TestPseudoRandom = function(i) {
	this.x = i;
};
	...
	,testSequence1: function() {
		...
		while(_g1 < _g) {
			...
			while(_g2 < expected.length) {
				var e = expected[_g2];
				++_g2;
				utest_Assert.equals(e,random["int"](),null,{ fileName : "TestPseudoRandom.hx", lineNumber : 17, className : "thx.math.random.TestPseudoRandom", methodName : "testSequence1"});
			}
		}
	}
	,testSequence2: function() {
		...
		while(_g1 < _g) {
			...
			while(_g2 < expected.length) {
				var e = expected[_g2];
				++_g2;
				utest_Assert.equals(e,random["int"](),null,{ fileName : "TestPseudoRandom.hx", lineNumber : 26, className : "thx.math.random.TestPseudoRandom", methodName : "testSequence2"});
			}
		}
	}
