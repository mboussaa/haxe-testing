...
TS1.addTests = function(runner) {
	...
	runner.addCase(new thx_math_random_TestNativeRandom(Std.parseInt(w)));
};
TS1.main = function() {
...
var thx_math_random_TestNativeRandom = function(i) {
	this.x = i;
};
	...
	,testIntBoundaries: function() {
		...
		while(_g1 < _g) {
			...
			while(_g2 < 1000) {
				var i = _g2++;
				var v = random["int"]();
				utest_Assert.isTrue(v >= 0 && v <= 2147483647,"expected value to be between 0 and 0x7FFFFFFF, but is " + i,{ fileName : "TestNativeRandom.hx", lineNumber : 17, className : "thx.math.random.TestNativeRandom", methodName : "testIntBoundaries"});
			}
		}
	}
	,testFloatBoundaries: function() {
		...
		while(_g1 < _g) {
			...
			while(_g2 < 1000) {
				var i = _g2++;
				var v = random["float"]();
				utest_Assert.isTrue(v >= 0 && v <= 1.0,"expected value to be between 0 and 1, but is " + i,{ fileName : "TestNativeRandom.hx", lineNumber : 27, className : "thx.math.random.TestNativeRandom", methodName : "testFloatBoundaries"});
			}
		}
	}
