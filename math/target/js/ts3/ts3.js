...
TS3.addTests = function(runner) {
	...
	runner.addCase(new thx_math_random_TestRandomAbstract(Std.parseInt(w)));
};
TS3.main = function() {
...
var thx_math_random_TestRandomAbstract = function(i) {
	this.x = i;
};
	...
	,testLessThan: function() {
		...
		while(_g1 < _g) {
			...
			while(_g2 < 100) {
				...
				utest_Assert.isTrue(r >= 0,null,{ fileName : "TestRandomAbstract.hx", lineNumber : 17, className : "thx.math.random.TestRandomAbstract", methodName : "testLessThan"});
				utest_Assert.isTrue(r < 10,null,{ fileName : "TestRandomAbstract.hx", lineNumber : 18, className : "thx.math.random.TestRandomAbstract", methodName : "testLessThan"});
			}
		}
	}
