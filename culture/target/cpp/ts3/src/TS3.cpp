...
void TS3_obj::addTests( ::utest::Runner runner){
            	HX_STACK_FRAME("TS3","addTests",0x181623da,"TS3.addTests","TS3.hx",7,0x8215996a)
...
HXLINE(  12)		::haxe::Log_obj::trace((HX_("The value of loop_wrapper is ",79,76,58,6c) + w),hx::SourceInfo(HX_("TS3.hx",6a,99,15,82),12,HX_("TS3",d4,05,40,00),HX_("addTests",00,a6,f2,86)));
HXLINE(  14)		HX_VARI( Int,x) = ::Std_obj::parseInt(w);
HXLINE(  15)		runner->addCase( ::thx::culture::TestNumberFormatInfo_obj::__new(x),null(),null(),null(),null());
            	}
...
void TS3_obj::main(){
            	HX_STACK_FRAME("TS3","main",0x68fb4113,"TS3.main","TS3.hx",18,0x8215996a)
HXLINE(  20)		HX_VARI(  ::utest::Runner,runner) =  ::utest::Runner_obj::__new();
HXLINE(  21)		::TS3_obj::addTests(runner);
