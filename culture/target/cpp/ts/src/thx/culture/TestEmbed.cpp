...
void TestEmbed_obj::__construct(){
            	HX_STACK_FRAME("thx.culture.TestEmbed","new",0x4436928f,"thx.culture.TestEmbed.new","thx/culture/TestEmbed.hx",6,0x5b0717c3)
            	HX_STACK_THIS(this)
            	}

Dynamic TestEmbed_obj::__CreateEmpty() { return new TestEmbed_obj; }

hx::ObjectPtr< TestEmbed_obj > TestEmbed_obj::__new()
{
...
void TestEmbed_obj::testEmbed(){
            	HX_STACK_FRAME("thx.culture.TestEmbed","testEmbed",0x78a2db96,"thx.culture.TestEmbed.testEmbed","thx/culture/TestEmbed.hx",8,0x5b0717c3)
            	HX_STACK_THIS(this)
...
HXLINE(   9)		HX_VARI(  ::thx::culture::Culture,itit) = ::thx::culture::Culture_obj::_hx_register(_hx_tmp14);
HXLINE(  10)		::String _hx_tmp15;
HXDLIN(  10)		if (hx::IsNull( itit->nameRegionNative )) {
HXLINE(  10)			_hx_tmp15 = HX_("",00,00,00,00);
            		}
            		else {
HXLINE(  10)			_hx_tmp15 = ((HX_(" (",08,1c,00,00) + itit->nameRegionNative) + HX_(")",29,00,00,00));
            		}
HXDLIN(  10)		::utest::Assert_obj::equals(HX_("italiano (Italia)",c4,89,47,7e),(itit->nameNative + _hx_tmp15),null(),hx::SourceInfo(HX_("TestEmbed.hx",17,95,52,19),10,HX_("thx.culture.TestEmbed",1d,9f,a0,ec),HX_("testEmbed",27,cc,d1,38)));
HXLINE(  11)		::utest::Assert_obj::equals(HX_("italiano",af,a6,00,8b),itit->nameNative,null(),hx::SourceInfo(HX_("TestEmbed.hx",17,95,52,19),11,HX_("thx.culture.TestEmbed",1d,9f,a0,ec),HX_("testEmbed",27,cc,d1,38)));
HXLINE(  12)		::utest::Assert_obj::equals(HX_("Italia",0e,a3,f8,3a),itit->nameRegionNative,null(),hx::SourceInfo(HX_("TestEmbed.hx",17,95,52,19),12,HX_("thx.culture.TestEmbed",1d,9f,a0,ec),HX_("testEmbed",27,cc,d1,38)));
            	}
...
void TestEmbed_obj::testEmbedMany(){
            	HX_STACK_FRAME("thx.culture.TestEmbed","testEmbedMany",0xc3f6c755,"thx.culture.TestEmbed.testEmbedMany","thx/culture/TestEmbed.hx",25,0x5b0717c3)
            	HX_STACK_THIS(this)
HXLINE(  26)		{
HXLINE(  36)			HX_VARI(  ::Dynamic,o) =  ::Dynamic(hx::Anon_obj::Create(16)
            				->setFixed(0,HX_("nameCalendar",29,50,56,86),HX_("Gregorian",c6,ad,49,c5))
...
HXLINE(  27)		 ::thx::culture::Culture _hx_tmp90 = ::thx::culture::Culture_obj::getByIso2(HX_("fr",4c,59,00,00));
HXDLIN(  27)		::utest::Assert_obj::notNull(_hx_tmp90,null(),hx::SourceInfo(HX_("TestEmbed.hx",17,95,52,19),27,HX_("thx.culture.TestEmbed",1d,9f,a0,ec),HX_("testEmbedMany",66,d4,77,db)));
HXLINE(  28)		 ::thx::culture::Culture _hx_tmp91 = ::thx::culture::Culture_obj::getByIso3(HX_("fra",95,c9,4d,00));
HXDLIN(  28)		::utest::Assert_obj::notNull(_hx_tmp91,null(),hx::SourceInfo(HX_("TestEmbed.hx",17,95,52,19),28,HX_("thx.culture.TestEmbed",1d,9f,a0,ec),HX_("testEmbedMany",66,d4,77,db)));
HXLINE(  29)		 ::thx::culture::Culture _hx_tmp92 = ::thx::culture::Culture_obj::getByCode(HX_("fr-fr",ed,fc,5b,06));
HXDLIN(  29)		::utest::Assert_obj::notNull(_hx_tmp92,null(),hx::SourceInfo(HX_("TestEmbed.hx",17,95,52,19),29,HX_("thx.culture.TestEmbed",1d,9f,a0,ec),HX_("testEmbedMany",66,d4,77,db)));
            	}
...
#if HXCPP_SCRIPTABLE
static hx::StorageInfo *TestEmbed_obj_sMemberStorageInfo = 0;
