...
HXLINE(   6)		runner->addCase( ::thx::culture::TestCulture_obj::__new(),null(),null(),null(),null());
HXLINE(   7)		runner->addCase( ::thx::culture::TestDateFormatInfo_obj::__new(),null(),null(),null(),null());
HXLINE(   8)		runner->addCase( ::thx::culture::TestNumberFormatInfo_obj::__new(),null(),null(),null(),null());
HXLINE(   9)		runner->addCase( ::thx::culture::TestEmbed_obj::__new(),null(),null(),null(),null());
            	}
...
void TestAll_obj::main(){
            	HX_STACK_FRAME("TestAll","main",0x6594a938,"TestAll.main","TestAll.hx",12,0x4f103e4f)
HXLINE(  13)		HX_VARI(  ::utest::Runner,runner) =  ::utest::Runner_obj::__new();
HXLINE(  14)		::TestAll_obj::addTests(runner);
