...
TS1.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS1.hx", lineNumber : 12, className : "TS1", methodName : "addTests"});
	runner.addCase(new thx_culture_TestCulture(Std.parseInt(w)));
};
TS1.main = function() {
...
var thx_culture_TestCulture = function(i) {
	this.x = i;
};
...
thx_culture_TestCulture.prototype = {
	...
	,testInvariant: function() {
		...
		while(_g1 < _g) {
			++_g1;
			utest_Assert.isFalse(thx_culture_Culture.invariant.isNeutral,null,{ fileName : "TestCulture.hx", lineNumber : 14, className : "thx.culture.TestCulture", methodName : "testInvariant"});
			utest_Assert.isFalse(thx_culture_Culture.invariant.isRightToLeft,null,{ fileName : "TestCulture.hx", lineNumber : 15, className : "thx.culture.TestCulture", methodName : "testInvariant"});
			utest_Assert.equals("",thx_culture_Culture.invariant.code,null,{ fileName : "TestCulture.hx", lineNumber : 16, className : "thx.culture.TestCulture", methodName : "testInvariant"});
			utest_Assert.equals("iv",thx_culture_Culture.invariant.iso2,null,{ fileName : "TestCulture.hx", lineNumber : 17, className : "thx.culture.TestCulture", methodName : "testInvariant"});
			utest_Assert.equals("IVL",thx_culture_Culture.invariant.iso3,null,{ fileName : "TestCulture.hx", lineNumber : 18, className : "thx.culture.TestCulture", methodName : "testInvariant"});
			utest_Assert.equals("Invariant Language",thx_culture_Culture.invariant.nameEnglish,null,{ fileName : "TestCulture.hx", lineNumber : 19, className : "thx.culture.TestCulture", methodName : "testInvariant"});
			utest_Assert.equals("Invariant Language",thx_culture_Culture.invariant.nameNative,null,{ fileName : "TestCulture.hx", lineNumber : 20, className : "thx.culture.TestCulture", methodName : "testInvariant"});
		}
	}
