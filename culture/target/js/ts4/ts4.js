...
TS4.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS4.hx", lineNumber : 12, className : "TS4", methodName : "addTests"});
	runner.addCase(new thx_culture_TestEmbed(Std.parseInt(w)));
};
TS4.main = function() {
...
var thx_culture_TestEmbed = function(i) {
	this.x = i;
};
...
thx_culture_TestEmbed.prototype = {
	...
	,testEmbed: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.equals("italiano (Italia)",itit.nameNative + (null == itit.nameRegionNative?"":" (" + itit.nameRegionNative + ")"),null,{ fileName : "TestEmbed.hx", lineNumber : 14, className : "thx.culture.TestEmbed", methodName : "testEmbed"});
			utest_Assert.equals("italiano",itit.nameNative,null,{ fileName : "TestEmbed.hx", lineNumber : 15, className : "thx.culture.TestEmbed", methodName : "testEmbed"});
			utest_Assert.equals("Italia",itit.nameRegionNative,null,{ fileName : "TestEmbed.hx", lineNumber : 16, className : "thx.culture.TestEmbed", methodName : "testEmbed"});
		}
	}
	,testListLanguages: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.contains("it",list,null,{ fileName : "TestEmbed.hx", lineNumber : 22, className : "thx.culture.TestEmbed", methodName : "testListLanguages"});
			utest_Assert.contains("en",list,null,{ fileName : "TestEmbed.hx", lineNumber : 23, className : "thx.culture.TestEmbed", methodName : "testListLanguages"});
			utest_Assert.contains("fr",list,null,{ fileName : "TestEmbed.hx", lineNumber : 24, className : "thx.culture.TestEmbed", methodName : "testListLanguages"});
			utest_Assert.contains("it-it",list,null,{ fileName : "TestEmbed.hx", lineNumber : 25, className : "thx.culture.TestEmbed", methodName : "testListLanguages"});
			utest_Assert.contains("en-us",list,null,{ fileName : "TestEmbed.hx", lineNumber : 26, className : "thx.culture.TestEmbed", methodName : "testListLanguages"});
			utest_Assert.contains("en-gb",list,null,{ fileName : "TestEmbed.hx", lineNumber : 27, className : "thx.culture.TestEmbed", methodName : "testListLanguages"});
		}
	}
	,testEmbedMany: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.notNull(thx_culture_Culture.getByIso2("fr"),null,{ fileName : "TestEmbed.hx", lineNumber : 33, className : "thx.culture.TestEmbed", methodName : "testEmbedMany"});
			utest_Assert.notNull(thx_culture_Culture.getByIso3("fra"),null,{ fileName : "TestEmbed.hx", lineNumber : 34, className : "thx.culture.TestEmbed", methodName : "testEmbedMany"});
			utest_Assert.notNull(thx_culture_Culture.getByCode("fr-fr"),null,{ fileName : "TestEmbed.hx", lineNumber : 35, className : "thx.culture.TestEmbed", methodName : "testEmbedMany"});
		}
	}
