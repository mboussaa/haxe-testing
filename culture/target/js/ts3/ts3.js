...
TS3.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS3.hx", lineNumber : 12, className : "TS3", methodName : "addTests"});
	runner.addCase(new thx_culture_TestNumberFormatInfo(Std.parseInt(w)));
};
TS3.main = function() {
...
var thx_culture_TestNumberFormatInfo = function(i) {
	this.x = i;
};
...
thx_culture_TestNumberFormatInfo.prototype = {
	...
	,testInvariant: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.same([3],n.groupSizesNumber,null,null,null,{ fileName : "TestNumberFormatInfo.hx", lineNumber : 16, className : "thx.culture.TestNumberFormatInfo", methodName : "testInvariant"});
			utest_Assert.equals(".",n.separatorDecimalNumber,null,{ fileName : "TestNumberFormatInfo.hx", lineNumber : 17, className : "thx.culture.TestNumberFormatInfo", methodName : "testInvariant"});
			utest_Assert.equals(",",n.separatorGroupNumber,null,{ fileName : "TestNumberFormatInfo.hx", lineNumber : 18, className : "thx.culture.TestNumberFormatInfo", methodName : "testInvariant"});
			utest_Assert.equals("-",n.signNegative,null,{ fileName : "TestNumberFormatInfo.hx", lineNumber : 19, className : "thx.culture.TestNumberFormatInfo", methodName : "testInvariant"});
			utest_Assert.equals("+",n.signPositive,null,{ fileName : "TestNumberFormatInfo.hx", lineNumber : 20, className : "thx.culture.TestNumberFormatInfo", methodName : "testInvariant"});
			utest_Assert.equals("NaN",n.symbolNaN,null,{ fileName : "TestNumberFormatInfo.hx", lineNumber : 21, className : "thx.culture.TestNumberFormatInfo", methodName : "testInvariant"});
		}
	}
