...
TS2.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS2.hx", lineNumber : 12, className : "TS2", methodName : "addTests"});
	runner.addCase(new thx_culture_TestDateFormatInfo(Std.parseInt(w)));
};
TS2.main = function() {
...
var thx_culture_TestDateFormatInfo = function(i) {
	this.x = i;
};
...
thx_culture_TestDateFormatInfo.prototype = {
	...
	,testInvariant: function() {
		...
		while(_g1 < _g) {
			...
			utest_Assert.equals("Gregorian",dt.nameCalendar,null,{ fileName : "TestDateFormatInfo.hx", lineNumber : 15, className : "thx.culture.TestDateFormatInfo", methodName : "testInvariant"});
			utest_Assert.equals("Sunday",dt.firstDayOfWeekName,null,{ fileName : "TestDateFormatInfo.hx", lineNumber : 16, className : "thx.culture.TestDateFormatInfo", methodName : "testInvariant"});
			utest_Assert.equals("AM",dt.designatorAm,null,{ fileName : "TestDateFormatInfo.hx", lineNumber : 17, className : "thx.culture.TestDateFormatInfo", methodName : "testInvariant"});
			utest_Assert.equals("PM",dt.designatorPm,null,{ fileName : "TestDateFormatInfo.hx", lineNumber : 18, className : "thx.culture.TestDateFormatInfo", methodName : "testInvariant"});
			utest_Assert.equals("January",dt.nameMonths[0],null,{ fileName : "TestDateFormatInfo.hx", lineNumber : 19, className : "thx.culture.TestDateFormatInfo", methodName : "testInvariant"});
		}
	}
