...
namespace utest.ui.common {
	public class ClassResult : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ClassResult(global::utest.ui.common.ClassResult __temp_me53, string className, string setupName, string teardownName) {
			__temp_me53.fixtures = new global::haxe.ds.StringMap<object>();
			__temp_me53.className = className;
			__temp_me53.setupName = setupName;
			__temp_me53.hasSetup =  ! (string.Equals(setupName, null)) ;
			__temp_me53.teardownName = teardownName;
			__temp_me53.hasTeardown =  ! (string.Equals(teardownName, null)) ;
			__temp_me53.methods = 0;
			__temp_me53.stats = new global::utest.ui.common.ResultStats();
		}
