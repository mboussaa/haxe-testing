...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me63) {
			__temp_me63.assertations = 0;
			__temp_me63.successes = 0;
			__temp_me63.failures = 0;
			__temp_me63.errors = 0;
			__temp_me63.warnings = 0;
			__temp_me63.isOk = true;
			__temp_me63.hasFailures = false;
			__temp_me63.hasErrors = false;
			__temp_me63.hasWarnings = false;
			__temp_me63.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me63.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me63.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me63.onAddWarnings = new global::utest.Dispatcher<int>();
		}
