...
namespace utest {
	public class Runner : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_Runner(global::utest.Runner __temp_me45) {
			__temp_me45.globalPattern = null;
			__temp_me45.fixtures = new global::Array<object>();
			__temp_me45.onProgress = new global::utest.Dispatcher<object>();
			__temp_me45.onStart = new global::utest.Dispatcher<object>();
			__temp_me45.onComplete = new global::utest.Dispatcher<object>();
			__temp_me45.onPrecheck = new global::utest.Dispatcher<object>();
			__temp_me45.onTestStart = new global::utest.Dispatcher<object>();
			__temp_me45.onTestComplete = new global::utest.Dispatcher<object>();
			__temp_me45.length = 0;
		}
