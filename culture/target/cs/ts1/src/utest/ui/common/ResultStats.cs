...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me62) {
			__temp_me62.assertations = 0;
			__temp_me62.successes = 0;
			__temp_me62.failures = 0;
			__temp_me62.errors = 0;
			__temp_me62.warnings = 0;
			__temp_me62.isOk = true;
			__temp_me62.hasFailures = false;
			__temp_me62.hasErrors = false;
			__temp_me62.hasWarnings = false;
			__temp_me62.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me62.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me62.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me62.onAddWarnings = new global::utest.Dispatcher<int>();
		}
