...
namespace utest.ui.common {
	public class FixtureResult : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_FixtureResult(global::utest.ui.common.FixtureResult __temp_me55, string methodName) {
			__temp_me55.methodName = methodName;
			__temp_me55.list = new global::List<object>();
			__temp_me55.hasTestError = false;
			__temp_me55.hasSetupError = false;
			__temp_me55.hasTeardownError = false;
			__temp_me55.hasTimeoutError = false;
			__temp_me55.hasAsyncError = false;
