...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me67) {
			__temp_me67.assertations = 0;
			__temp_me67.successes = 0;
			__temp_me67.failures = 0;
			__temp_me67.errors = 0;
			__temp_me67.warnings = 0;
			__temp_me67.isOk = true;
			__temp_me67.hasFailures = false;
			__temp_me67.hasErrors = false;
			__temp_me67.hasWarnings = false;
			__temp_me67.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me67.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me67.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me67.onAddWarnings = new global::utest.Dispatcher<int>();
		}
