...
namespace thx.culture {
	public class NumberFormatInfo : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_culture_NumberFormatInfo(global::thx.culture.NumberFormatInfo __temp_me39, int decimalDigitsCurrency, int decimalDigitsNumber, int decimalDigitsPercent, global::Array<int> groupSizesCurrency, global::Array<int> groupSizesNumber, global::Array<int> groupSizesPercent, int patternNegativeCurrency, int patternNegativeNumber, int patternNegativePercent, int patternPositiveCurrency, int patternPositivePercent, string separatorDecimalCurrency, string separatorDecimalNumber, string separatorDecimalPercent, string separatorGroupCurrency, string separatorGroupNumber, string separatorGroupPercent, string signNegative, string signPositive, string symbolCurrency, string symbolNaN, string symbolNegativeInfinity, string symbolPercent, string symbolPermille, string symbolPositiveInfinity) {
			__temp_me39.decimalDigitsCurrency = decimalDigitsCurrency;
			__temp_me39.decimalDigitsNumber = decimalDigitsNumber;
			__temp_me39.decimalDigitsPercent = decimalDigitsPercent;
			__temp_me39.groupSizesCurrency = groupSizesCurrency;
			__temp_me39.groupSizesNumber = groupSizesNumber;
			__temp_me39.groupSizesPercent = groupSizesPercent;
			__temp_me39.patternNegativeCurrency = patternNegativeCurrency;
			__temp_me39.patternNegativeNumber = patternNegativeNumber;
			__temp_me39.patternNegativePercent = patternNegativePercent;
			__temp_me39.patternPositiveCurrency = patternPositiveCurrency;
			__temp_me39.patternPositivePercent = patternPositivePercent;
			__temp_me39.separatorDecimalCurrency = separatorDecimalCurrency;
			__temp_me39.separatorDecimalNumber = separatorDecimalNumber;
			__temp_me39.separatorDecimalPercent = separatorDecimalPercent;
			__temp_me39.separatorGroupCurrency = separatorGroupCurrency;
			__temp_me39.separatorGroupNumber = separatorGroupNumber;
			__temp_me39.separatorGroupPercent = separatorGroupPercent;
			__temp_me39.signNegative = signNegative;
			__temp_me39.signPositive = signPositive;
			__temp_me39.symbolCurrency = symbolCurrency;
			__temp_me39.symbolNaN = symbolNaN;
			__temp_me39.symbolNegativeInfinity = symbolNegativeInfinity;
			__temp_me39.symbolPercent = symbolPercent;
			__temp_me39.symbolPermille = symbolPermille;
			__temp_me39.symbolPositiveInfinity = symbolPositiveInfinity;
		}
