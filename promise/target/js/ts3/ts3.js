...
TS3.addTests = function(runner) {
	...
	haxe_Log.trace("The value of loop_wrapper is " + w,{ fileName : "TS3.hx", lineNumber : 16, className : "TS3", methodName : "addTests"});
	runner.addCase(new thx_promise_TestTryPromise(Std.parseInt(w)));
};
TS3.main = function() {
...
var thx_promise_TestTryPromise = function(i) {
	this.x = i;
};
...
thx_promise_TestTryPromise.prototype = {
	...
	,testTryCreate: function() {
		...
		while(_g1 < _g) {
			...
			thx_promise__$Promise_Promise_$Impl_$.always(thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise__$Promise_Promise_$Impl_$.create(function(resolve,reject) {
				...
				utest_Assert.fail("exception triggered resolve",{ fileName : "TestTryPromise.hx", lineNumber : 17, className : "thx.promise.TestTryPromise", methodName : "testTryCreate"});
			}),function(_1) {
				utest_Assert.pass(null,{ fileName : "TestTryPromise.hx", lineNumber : 18, className : "thx.promise.TestTryPromise", methodName : "testTryCreate"});
	...
	,testTryEitherSuccess: function() {
		...
		while(_g1 < _g) {
			++_g1;
			thx_promise__$Promise_Promise_$Impl_$.either(thx_promise__$Promise_Promise_$Impl_$.nil,(function() {
				return function(_) {
					throw new js__$Boot_HaxeError("nops");
				};
			})(),(function() {
				return function(_1) {
					utest_Assert.fail("no reason to get here",{ fileName : "TestTryPromise.hx", lineNumber : 28, className : "thx.promise.TestTryPromise", methodName : "testTryEitherSuccess"});
				};
			})()).then((function(done) {
				return function(r) {
					switch(r[1]) {
					case 0:
						utest_Assert.pass(null,{ fileName : "TestTryPromise.hx", lineNumber : 32, className : "thx.promise.TestTryPromise", methodName : "testTryEitherSuccess"});
						break;
					case 1:
						utest_Assert.fail("not good",{ fileName : "TestTryPromise.hx", lineNumber : 33, className : "thx.promise.TestTryPromise", methodName : "testTryEitherSuccess"});
						break;
					}
					done[0]();
				};
	...
	,testTryEitherFailure: function() {
		...
		while(_g1 < _g) {
			++_g1;
			thx_promise__$Promise_Promise_$Impl_$.either(thx_promise__$Promise_Promise_$Impl_$.fail("no go",{ fileName : "TestTryPromise.hx", lineNumber : 42, className : "thx.promise.TestTryPromise", methodName : "testTryEitherFailure"}),(function() {
				return function(_) {
					utest_Assert.fail("no reason to get here",{ fileName : "TestTryPromise.hx", lineNumber : 44, className : "thx.promise.TestTryPromise", methodName : "testTryEitherFailure"});
				};
			})(),(function() {
				return function(_1) {
					throw new js__$Boot_HaxeError("nops");
				...
				return function(r) {
					switch(r[1]) {
					case 0:
						utest_Assert.pass(null,{ fileName : "TestTryPromise.hx", lineNumber : 49, className : "thx.promise.TestTryPromise", methodName : "testTryEitherFailure"});
						break;
					case 1:
						utest_Assert.fail("not good",{ fileName : "TestTryPromise.hx", lineNumber : 50, className : "thx.promise.TestTryPromise", methodName : "testTryEitherFailure"});
						break;
					}
					done[0]();
				};
	...
	,testTrySuccess: function() {
		...
		while(_g1 < _g) {
			...
			thx_promise__$Promise_Promise_$Impl_$.always(thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise__$Promise_Promise_$Impl_$.nil,function(_) {
				...
				utest_Assert.fail("not piped to a failing promise",{ fileName : "TestTryPromise.hx", lineNumber : 60, className : "thx.promise.TestTryPromise", methodName : "testTrySuccess"});
			}),function(_2) {
				utest_Assert.pass(null,{ fileName : "TestTryPromise.hx", lineNumber : 61, className : "thx.promise.TestTryPromise", methodName : "testTrySuccess"});
			}),utest_Assert.createAsync());
		}
	}
	,testTryReject: function() {
		...
		while(_g1 < _g) {
			++_g1;
			thx_promise__$Promise_Promise_$Impl_$.always(thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.fail("nops",{ fileName : "TestTryPromise.hx", lineNumber : 67, className : "thx.promise.TestTryPromise", methodName : "testTryReject"}),function(_) {
				throw new js__$Boot_HaxeError("niet");
			}),function(_1) {
				utest_Assert.fail("not piped to a failing promise",{ fileName : "TestTryPromise.hx", lineNumber : 69, className : "thx.promise.TestTryPromise", methodName : "testTryReject"});
			}),function(e) {
				utest_Assert.stringContains("niet",e.message,null,{ fileName : "TestTryPromise.hx", lineNumber : 70, className : "thx.promise.TestTryPromise", methodName : "testTryReject"});
			}),utest_Assert.createAsync());
		}
	}
	,testTryAlways: function() {
		...
		while(_g1 < _g) {
			...
			thx_promise__$Promise_Promise_$Impl_$.always(thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.always(thx_promise__$Promise_Promise_$Impl_$.nil,function() {
				...
				utest_Assert.stringContains("bad",e.message,null,{ fileName : "TestTryPromise.hx", lineNumber : 78, className : "thx.promise.TestTryPromise", methodName : "testTryAlways"});
			}),utest_Assert.createAsync());
		}
	}
	,testTryThrowFailure: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var _e = [thx_promise__$Promise_Promise_$Impl_$.fail("meh",{ fileName : "TestTryPromise.hx", lineNumber : 84, className : "thx.promise.TestTryPromise", methodName : "testTryThrowFailure"})];
			utest_Assert.raises((function(_e1) {
				return function() {
					return thx_promise__$Promise_Promise_$Impl_$.throwFailure(_e1[0]);
				};
			})(_e),thx_Error,null,null,{ fileName : "TestTryPromise.hx", lineNumber : 84, className : "thx.promise.TestTryPromise", methodName : "testTryThrowFailure"});
		}
	}
	,testTryMap: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			thx_promise__$Promise_Promise_$Impl_$.always(thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.map(thx_promise__$Promise_Promise_$Impl_$.nil,function(_) {
				...
				utest_Assert.stringContains("meh",e.message,null,{ fileName : "TestTryPromise.hx", lineNumber : 91, className : "thx.promise.TestTryPromise", methodName : "testTryMap"});
			}),utest_Assert.createAsync());
		}
	}
	,testTryFlatMap: function() {
		...
		while(_g1 < _g) {
			...
			thx_promise__$Promise_Promise_$Impl_$.always(thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.flatMapEither(thx_promise__$Promise_Promise_$Impl_$.nil,function(_) {
				...
				utest_Assert.stringContains("meh",e.message,null,{ fileName : "TestTryPromise.hx", lineNumber : 99, className : "thx.promise.TestTryPromise", methodName : "testTryFlatMap"});
			}),utest_Assert.createAsync());
		}
	}
	,testTryFlatMapEitherSuccess: function() {
		...
		while(_g1 < _g) {
			...
			thx_promise__$Promise_Promise_$Impl_$.always(thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.flatMapEither(thx_promise__$Promise_Promise_$Impl_$.nil,function(_) {
				...
				utest_Assert.stringContains("meh",e1.message,null,{ fileName : "TestTryPromise.hx", lineNumber : 110, className : "thx.promise.TestTryPromise", methodName : "testTryFlatMapEitherSuccess"});
			}),utest_Assert.createAsync());
		}
	}
	,testTryFlatMapEitherFailure: function() {
		...
		while(_g1 < _g) {
			++_g1;
			thx_promise__$Promise_Promise_$Impl_$.always(thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.flatMapEither(thx_promise__$Promise_Promise_$Impl_$.fail("bah",{ fileName : "TestTryPromise.hx", lineNumber : 116, className : "thx.promise.TestTryPromise", methodName : "testTryFlatMapEitherFailure"}),function(_) {
				throw new js__$Boot_HaxeError("meh");
			},function(e) {
				throw new js__$Boot_HaxeError("mah");
			}),function(e1) {
				utest_Assert.stringContains("mah",e1.message,null,{ fileName : "TestTryPromise.hx", lineNumber : 121, className : "thx.promise.TestTryPromise", methodName : "testTryFlatMapEitherFailure"});
			}),utest_Assert.createAsync());
		}
	}
	,testTryRecoverNull: function() {
		...
		while(_g1 < _g) {
			...
			thx_promise__$Promise_Promise_$Impl_$.always(thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.recoverNull(thx_promise__$Promise_Promise_$Impl_$.value(null),function() {
				...
				utest_Assert.stringContains("meh",e.message,null,{ fileName : "TestTryPromise.hx", lineNumber : 129, className : "thx.promise.TestTryPromise", methodName : "testTryRecoverNull"});
			}),utest_Assert.createAsync());
		}
	}
