...
TS1.addTests = function(runner) {
	...
	runner.addCase(new thx_promise_TestFuture(Std.parseInt(w)));
};
TS1.main = function() {
...
var thx_promise_TestFuture = function(i) {
	this.x = i;
};
...
thx_promise_TestFuture.prototype = {
	...
	,testThenBefore: function() {
		...
		while(_g1 < _g) {
			...
			thx_promise_Future.value(1).then(function(v) {
				utest_Assert.equals(1,v,null,{ fileName : "TestFuture.hx", lineNumber : 17, className : "thx.promise.TestFuture", methodName : "testThenBefore"});
			});
		}
	}
	,testThenAfter: function() {
		...
		while(_g1 < _g) {
			++_g1;
			thx_promise_Timer.delayValue("x",10).then((function(done) {
				return function(v) {
					utest_Assert.equals("x",v,null,{ fileName : "TestFuture.hx", lineNumber : 26, className : "thx.promise.TestFuture", methodName : "testThenAfter"});
					done[0]();
				};
	...
	,testImmediateThenAfter: function() {
		...
		while(_g1 < _g) {
			++_g1;
			thx_promise_Timer.immediateValue("x").then((function(done) {
				return function(v) {
					utest_Assert.equals("x",v,null,{ fileName : "TestFuture.hx", lineNumber : 36, className : "thx.promise.TestFuture", methodName : "testImmediateThenAfter"});
					done[0]();
				};
			})([utest_Assert.createAsync()]));
		}
	...
	,testHasValue: function() {
		...
		while(_g1 < _g) {
			...
			var future = [null];
			future[0] = thx_promise_Timer.delay(10).then((function(future1,done1) {
				return function(_) {
					utest_Assert.isTrue(thx_Options.toBool(future1[0].state),null,{ fileName : "TestFuture.hx", lineNumber : 47, className : "thx.promise.TestFuture", methodName : "testHasValue"});
					done1[0]();
				};
			})(future,done));
			utest_Assert.isFalse(thx_Options.toBool(future[0].state),null,{ fileName : "TestFuture.hx", lineNumber : 50, className : "thx.promise.TestFuture", methodName : "testHasValue"});
		}
	}
	,testMap: function() {
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			thx_promise_Future.value(1).map(function(i) {
				...
				utest_Assert.equals("1",a2,{ fileName : "TestFuture.hx", lineNumber : 58, className : "thx.promise.TestFuture", methodName : "testMap"});
			});
		}
	}
	,testMapAsync: function() {
		...
		while(_g1 < _g) {
			...
			thx_promise_Future.value(1).mapAsync(function(v,callback) {
				...
				utest_Assert.equals("1",a2,{ fileName : "TestFuture.hx", lineNumber : 65, className : "thx.promise.TestFuture", methodName : "testMapAsync"});
			});
		}
	}
	,testFlatten: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var tmp = thx_promise_Future.value(thx_promise_Future.value(1));
			thx_promise_Future.create((function(future) {
				return function(callback) {
					future[0].then((function() {
						return function(future1) {
							future1.then(callback);
						};
					})());
				};
				...
				return function(a2) {
					utest_Assert.equals(1,a2,{ fileName : "TestFuture.hx", lineNumber : 72, className : "thx.promise.TestFuture", methodName : "testFlatten"});
				};
			})());
		}
	}
	,testFlatMap: function() {
		...
		while(_g1 < _g) {
			...
			thx_promise_Future.value(1).flatMap(function(v) {
				...
				utest_Assert.equals("1",a2,{ fileName : "TestFuture.hx", lineNumber : 79, className : "thx.promise.TestFuture", methodName : "testFlatMap"});
			});
		}
	}
	,testSequence: function() {
		...
		while(_g1 < _g) {
			++_g1;
			thx_promise_Future.sequence([thx_promise_Timer.delayValue(1,10),thx_promise_Future.value(2)]).then((function(done) {
				return function(values) {
					utest_Assert.same([1,2],values,null,null,null,{ fileName : "TestFuture.hx", lineNumber : 90, className : "thx.promise.TestFuture", methodName : "testSequence"});
					done[0]();
				};
			})([utest_Assert.createAsync()]));
		}
	...
	,testJoin: function() {
		...
		while(_g1 < _g) {
			++_g1;
			thx_promise_Futures.join(thx_promise_Timer.delayValue(1,20),thx_promise_Timer.delayValue(2,10)).then((function(done) {
				return function(p) {
					utest_Assert.same({ _0 : 1, _1 : 2},p,null,null,null,{ fileName : "TestFuture.hx", lineNumber : 101, className : "thx.promise.TestFuture", methodName : "testJoin"});
					done[0]();
				};
			})([utest_Assert.createAsync()]));
		}
	...
	,testTuple3: function() {
		...
		while(_g1 < _g) {
			++_g1;
			thx_promise_FutureTuple3.tuple(thx_promise_Future.value({ _0 : 1, _1 : "a", _2 : 0.2}),(function(done) {
				return function(a,b,c) {
					utest_Assert.equals(1,a,null,{ fileName : "TestFuture.hx", lineNumber : 113, className : "thx.promise.TestFuture", methodName : "testTuple3"});
					utest_Assert.equals("a",b,null,{ fileName : "TestFuture.hx", lineNumber : 114, className : "thx.promise.TestFuture", methodName : "testTuple3"});
					utest_Assert.equals(0.2,c,null,{ fileName : "TestFuture.hx", lineNumber : 115, className : "thx.promise.TestFuture", methodName : "testTuple3"});
					done[0]();
				};
			})([utest_Assert.createAsync()]));
		}
