...
TestAll.main = function() {
	...
	runner.addCase(new thx_promise_TestFuture());
	runner.addCase(new thx_promise_TestPromise());
	runner.addCase(new thx_promise_TestTryPromise());
...
var thx_promise_TestFuture = function() {
};
thx_promise_TestFuture.__name__ = ["thx","promise","TestFuture"];
thx_promise_TestFuture.prototype = {
	testThenBefore: function() {
		thx_promise_Future.value(1).then(function(v) {
			utest_Assert.equals(1,v,null,{ fileName : "TestFuture.hx", lineNumber : 13, className : "thx.promise.TestFuture", methodName : "testThenBefore"});
		});
	}
	,testThenAfter: function() {
		var done = utest_Assert.createAsync();
		thx_promise_Timer.delayValue("x",10).then(function(v) {
			utest_Assert.equals("x",v,null,{ fileName : "TestFuture.hx", lineNumber : 21, className : "thx.promise.TestFuture", methodName : "testThenAfter"});
			done();
		});
	}
	,testImmediateThenAfter: function() {
		var done = utest_Assert.createAsync();
		thx_promise_Timer.immediateValue("x").then(function(v) {
			utest_Assert.equals("x",v,null,{ fileName : "TestFuture.hx", lineNumber : 30, className : "thx.promise.TestFuture", methodName : "testImmediateThenAfter"});
			done();
		});
	}
	,testHasValue: function() {
		var done = utest_Assert.createAsync();
		var future = null;
		future = thx_promise_Timer.delay(10).then(function(_) {
			utest_Assert.isTrue(thx_Options.toBool(future.state),null,{ fileName : "TestFuture.hx", lineNumber : 40, className : "thx.promise.TestFuture", methodName : "testHasValue"});
			done();
		});
		utest_Assert.isFalse(thx_Options.toBool(future.state),null,{ fileName : "TestFuture.hx", lineNumber : 43, className : "thx.promise.TestFuture", methodName : "testHasValue"});
	}
	,testMap: function() {
		thx_promise_Future.value(1).map(function(i) {
			return "" + i;
		}).then(function(a2) {
			utest_Assert.equals("1",a2,{ fileName : "TestFuture.hx", lineNumber : 50, className : "thx.promise.TestFuture", methodName : "testMap"});
		});
	}
	,testMapAsync: function() {
		thx_promise_Future.value(1).mapAsync(function(v,callback) {
			callback("" + v);
		}).then(function(a2) {
			utest_Assert.equals("1",a2,{ fileName : "TestFuture.hx", lineNumber : 56, className : "thx.promise.TestFuture", methodName : "testMapAsync"});
		});
	}
	,testFlatten: function() {
		var future = thx_promise_Future.value(thx_promise_Future.value(1));
		thx_promise_Future.create(function(callback) {
			future.then(function(future1) {
				future1.then(callback);
			});
		}).then(function(a2) {
			utest_Assert.equals(1,a2,{ fileName : "TestFuture.hx", lineNumber : 62, className : "thx.promise.TestFuture", methodName : "testFlatten"});
		});
	}
	,testFlatMap: function() {
		thx_promise_Future.value(1).flatMap(function(v) {
			return thx_promise_Future.value("" + v);
		}).then(function(a2) {
			utest_Assert.equals("1",a2,{ fileName : "TestFuture.hx", lineNumber : 68, className : "thx.promise.TestFuture", methodName : "testFlatMap"});
		});
	}
	,testSequence: function() {
		var done = utest_Assert.createAsync();
		thx_promise_Future.sequence([thx_promise_Timer.delayValue(1,10),thx_promise_Future.value(2)]).then(function(values) {
			utest_Assert.same([1,2],values,null,null,null,{ fileName : "TestFuture.hx", lineNumber : 78, className : "thx.promise.TestFuture", methodName : "testSequence"});
			done();
		});
	}
	,testJoin: function() {
		var done = utest_Assert.createAsync();
		thx_promise_Futures.join(thx_promise_Timer.delayValue(1,20),thx_promise_Timer.delayValue(2,10)).then(function(p) {
			utest_Assert.same({ _0 : 1, _1 : 2},p,null,null,null,{ fileName : "TestFuture.hx", lineNumber : 88, className : "thx.promise.TestFuture", methodName : "testJoin"});
			done();
		});
	}
	,testTuple3: function() {
		var done = utest_Assert.createAsync();
		thx_promise_FutureTuple3.tuple(thx_promise_Future.value({ _0 : 1, _1 : "a", _2 : 0.2}),function(a,b,c) {
			utest_Assert.equals(1,a,null,{ fileName : "TestFuture.hx", lineNumber : 99, className : "thx.promise.TestFuture", methodName : "testTuple3"});
			utest_Assert.equals("a",b,null,{ fileName : "TestFuture.hx", lineNumber : 100, className : "thx.promise.TestFuture", methodName : "testTuple3"});
			utest_Assert.equals(0.2,c,null,{ fileName : "TestFuture.hx", lineNumber : 101, className : "thx.promise.TestFuture", methodName : "testTuple3"});
			done();
		});
	}
	,__class__: thx_promise_TestFuture
};
var thx_promise_TestPromise = function() {
};
thx_promise_TestPromise.__name__ = ["thx","promise","TestPromise"];
thx_promise_TestPromise.prototype = {
	testResolveBefore: function() {
		var done = utest_Assert.createAsync();
		thx_promise__$Promise_Promise_$Impl_$.success(thx_promise__$Promise_Promise_$Impl_$.value(1),function(v) {
			utest_Assert.equals(1,v,null,{ fileName : "TestPromise.hx", lineNumber : 16, className : "thx.promise.TestPromise", methodName : "testResolveBefore"});
			done();
		});
	}
	,testResolveAfter: function() {
		var done = utest_Assert.createAsync();
		thx_promise__$Promise_Promise_$Impl_$.success(thx_promise__$Promise_Promise_$Impl_$.delay(thx_promise__$Promise_Promise_$Impl_$.value(1)),function(v) {
			utest_Assert.equals(1,v,null,{ fileName : "TestPromise.hx", lineNumber : 27, className : "thx.promise.TestPromise", methodName : "testResolveAfter"});
			done();
		});
	}
	,testRejectAfter: function() {
		var done = utest_Assert.createAsync();
		var error = new thx_Error("Nooooo!",null,{ fileName : "TestPromise.hx", lineNumber : 34, className : "thx.promise.TestPromise", methodName : "testRejectAfter"});
		thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.delay(thx_promise__$Promise_Promise_$Impl_$.error(error)),function(e) {
			utest_Assert.equals(error,e,null,{ fileName : "TestPromise.hx", lineNumber : 39, className : "thx.promise.TestPromise", methodName : "testRejectAfter"});
			done();
		});
	}
	,testDelay: function() {
		...
		thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise__$Promise_Promise_$Impl_$.delay(thx_promise__$Promise_Promise_$Impl_$.value("a"),50),function(v) {
			utest_Assert.equals("a",v,null,{ fileName : "TestPromise.hx", lineNumber : 50, className : "thx.promise.TestPromise", methodName : "testDelay"});
			utest_Assert.isTrue(new Date().getTime() - start >= 40.,null,{ fileName : "TestPromise.hx", lineNumber : 51, className : "thx.promise.TestPromise", methodName : "testDelay"});
			done();
		}),function(e) {
			utest_Assert.fail(e.toString(),{ fileName : "TestPromise.hx", lineNumber : 55, className : "thx.promise.TestPromise", methodName : "testDelay"});
		});
	}
	,testRejectBefore: function() {
		var done = utest_Assert.createAsync();
		var error = new thx_Error("Nooooo!",null,{ fileName : "TestPromise.hx", lineNumber : 62, className : "thx.promise.TestPromise", methodName : "testRejectBefore"});
		thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.error(error),function(e) {
			utest_Assert.equals(error,e,null,{ fileName : "TestPromise.hx", lineNumber : 66, className : "thx.promise.TestPromise", methodName : "testRejectBefore"});
			done();
		});
	}
	,testMapSuccessWithValue: function() {
		var done = utest_Assert.createAsync();
		thx_promise__$Promise_Promise_$Impl_$.success(thx_promise__$Promise_Promise_$Impl_$.flatMapEither(thx_promise__$Promise_Promise_$Impl_$.value(1),function(v) {
			return thx_promise__$Promise_Promise_$Impl_$.value(v * 2);
		},function(err) {
			return thx_promise__$Promise_Promise_$Impl_$.error(err);
		}),function(v1) {
			utest_Assert.equals(2,v1,null,{ fileName : "TestPromise.hx", lineNumber : 76, className : "thx.promise.TestPromise", methodName : "testMapSuccessWithValue"});
			done();
		});
	}
	,testMapSuccessWithFailure: function() {
		var done = utest_Assert.createAsync();
		var err = new thx_Error("error",null,{ fileName : "TestPromise.hx", lineNumber : 83, className : "thx.promise.TestPromise", methodName : "testMapSuccessWithFailure"});
		thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.flatMapEither(thx_promise__$Promise_Promise_$Impl_$.error(err),function(v) {
			utest_Assert.fail("should never touch this",{ fileName : "TestPromise.hx", lineNumber : 85, className : "thx.promise.TestPromise", methodName : "testMapSuccessWithFailure"});
			return thx_promise__$Promise_Promise_$Impl_$.value(v * 2);
		},function(err1) {
			return thx_promise__$Promise_Promise_$Impl_$.error(err1);
		}),function(e) {
			utest_Assert.equals(err,e,null,{ fileName : "TestPromise.hx", lineNumber : 88, className : "thx.promise.TestPromise", methodName : "testMapSuccessWithFailure"});
			done();
		});
	}
	,testAllSuccess: function() {
		var done = utest_Assert.createAsync();
		thx_promise__$Promise_Promise_$Impl_$.success(thx_promise__$Promise_Promise_$Impl_$.sequence([thx_promise__$Promise_Promise_$Impl_$.value(1),thx_promise__$Promise_Promise_$Impl_$.value(2)]),function(arr) {
			utest_Assert.equals(3,thx_Arrays.reduce(arr,function(acc,v) {
				return acc + v;
			},0),null,{ fileName : "TestPromise.hx", lineNumber : 99, className : "thx.promise.TestPromise", methodName : "testAllSuccess"});
			done();
		});
	}
	,testAllFailure1: function() {
		var done = utest_Assert.createAsync();
		var err = new thx_Error("error",null,{ fileName : "TestPromise.hx", lineNumber : 106, className : "thx.promise.TestPromise", methodName : "testAllFailure1"});
		thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise__$Promise_Promise_$Impl_$.sequence([thx_promise__$Promise_Promise_$Impl_$.value(1),thx_promise__$Promise_Promise_$Impl_$.error(err)]),function(arr) {
			utest_Assert.fail("should never happen",{ fileName : "TestPromise.hx", lineNumber : 112, className : "thx.promise.TestPromise", methodName : "testAllFailure1"});
		}),function(e) {
			utest_Assert.equals(err,e,null,{ fileName : "TestPromise.hx", lineNumber : 115, className : "thx.promise.TestPromise", methodName : "testAllFailure1"});
			done();
		});
	}
	,testAllFailure2: function() {
		var done = utest_Assert.createAsync();
		thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise__$Promise_Promise_$Impl_$.sequence([this.res(),this.res(),this.rej()]),function(arr) {
			utest_Assert.fail("should never happen",{ fileName : "TestPromise.hx", lineNumber : 124, className : "thx.promise.TestPromise", methodName : "testAllFailure2"});
		}),function(e) {
			utest_Assert.pass(null,{ fileName : "TestPromise.hx", lineNumber : 127, className : "thx.promise.TestPromise", methodName : "testAllFailure2"});
			done();
		});
	}
	,testAfterAllSuccess: function() {
		var done = utest_Assert.createAsync();
		thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise__$Promise_Promise_$Impl_$.afterAll([thx_promise__$Promise_Promise_$Impl_$.value(1),thx_promise__$Promise_Promise_$Impl_$.value(2),thx_promise__$Promise_Promise_$Impl_$.value(3)]),function(n) {
			utest_Assert.equals(thx_Nil.nil,n,null,{ fileName : "TestPromise.hx", lineNumber : 136, className : "thx.promise.TestPromise", methodName : "testAfterAllSuccess"});
			done();
		}),function(err) {
			utest_Assert.fail(null,{ fileName : "TestPromise.hx", lineNumber : 140, className : "thx.promise.TestPromise", methodName : "testAfterAllSuccess"});
			done();
		});
	}
	,testAfterAllFailure1: function() {
		var done = utest_Assert.createAsync();
		thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise__$Promise_Promise_$Impl_$.afterAll([thx_promise__$Promise_Promise_$Impl_$.value(1),thx_promise__$Promise_Promise_$Impl_$.value(2),thx_promise__$Promise_Promise_$Impl_$.error(new thx_Error("rejected",null,{ fileName : "TestPromise.hx", lineNumber : 147, className : "thx.promise.TestPromise", methodName : "testAfterAllFailure1"}))]),function(n) {
			utest_Assert.fail("should never happen",{ fileName : "TestPromise.hx", lineNumber : 149, className : "thx.promise.TestPromise", methodName : "testAfterAllFailure1"});
			done();
		}),function(err) {
			utest_Assert.pass(null,{ fileName : "TestPromise.hx", lineNumber : 153, className : "thx.promise.TestPromise", methodName : "testAfterAllFailure1"});
			done();
		});
	}
	,testAfterAllFailure2: function() {
		var done = utest_Assert.createAsync();
		thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise__$Promise_Promise_$Impl_$.afterAll([this.res(),this.res(),this.rej()]),function(n) {
			utest_Assert.fail("should never happen",{ fileName : "TestPromise.hx", lineNumber : 163, className : "thx.promise.TestPromise", methodName : "testAfterAllFailure2"});
			done();
		}),function(err) {
			utest_Assert.pass(null,{ fileName : "TestPromise.hx", lineNumber : 167, className : "thx.promise.TestPromise", methodName : "testAfterAllFailure2"});
			done();
		});
	}
	,testJoinSuccess: function() {
		var done = utest_Assert.createAsync();
		thx_promise__$Promise_Promise_$Impl_$.success(thx_promise_Promises.par(thx__$Tuple_Tuple2_$Impl_$.of,thx_promise__$Promise_Promise_$Impl_$.value(1),thx_promise__$Promise_Promise_$Impl_$.value(2)),function(t) {
			utest_Assert.equals(1,t._0,null,{ fileName : "TestPromise.hx", lineNumber : 177, className : "thx.promise.TestPromise", methodName : "testJoinSuccess"});
			utest_Assert.equals(2,t._1,null,{ fileName : "TestPromise.hx", lineNumber : 178, className : "thx.promise.TestPromise", methodName : "testJoinSuccess"});
			done();
		});
	}
	,testJoinFailure: function() {
		var done = utest_Assert.createAsync();
		var err = new thx_Error("error",null,{ fileName : "TestPromise.hx", lineNumber : 185, className : "thx.promise.TestPromise", methodName : "testJoinFailure"});
		thx_promise__$Promise_Promise_$Impl_$.success(thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise_Promises.par(thx__$Tuple_Tuple2_$Impl_$.of,thx_promise__$Promise_Promise_$Impl_$.value(1),thx_promise__$Promise_Promise_$Impl_$.error(err)),function(e) {
			utest_Assert.equals(err,e,null,{ fileName : "TestPromise.hx", lineNumber : 189, className : "thx.promise.TestPromise", methodName : "testJoinFailure"});
			done();
		}),function(t) {
			utest_Assert.fail("should never happen",{ fileName : "TestPromise.hx", lineNumber : 193, className : "thx.promise.TestPromise", methodName : "testJoinFailure"});
		});
	}
	,testJoin3Success: function() {
		var done = utest_Assert.createAsync();
		thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise_Promises.join3(this.res("1"),this.res("2"),this.res("3")),function(tuple) {
			utest_Assert.same("1",tuple._0,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 201, className : "thx.promise.TestPromise", methodName : "testJoin3Success"});
			utest_Assert.same("2",tuple._1,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 202, className : "thx.promise.TestPromise", methodName : "testJoin3Success"});
			utest_Assert.same("3",tuple._2,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 203, className : "thx.promise.TestPromise", methodName : "testJoin3Success"});
			done();
		}),function(err) {
			utest_Assert.fail(null,{ fileName : "TestPromise.hx", lineNumber : 207, className : "thx.promise.TestPromise", methodName : "testJoin3Success"});
		});
	}
	,testJoin3Failure1: function() {
		var done = utest_Assert.createAsync();
		thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise_Promises.join3(thx_promise__$Promise_Promise_$Impl_$.value("1"),thx_promise__$Promise_Promise_$Impl_$.value("2"),thx_promise__$Promise_Promise_$Impl_$.error(new thx_Error("3",null,{ fileName : "TestPromise.hx", lineNumber : 213, className : "thx.promise.TestPromise", methodName : "testJoin3Failure1"}))),function(tuple) {
			utest_Assert.fail(null,{ fileName : "TestPromise.hx", lineNumber : 215, className : "thx.promise.TestPromise", methodName : "testJoin3Failure1"});
			done();
		}),function(err) {
			utest_Assert.same("3",err.message,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 219, className : "thx.promise.TestPromise", methodName : "testJoin3Failure1"});
			done();
		});
	}
	,testJoin3Failure2: function() {
		var done = utest_Assert.createAsync();
		thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise_Promises.join3(this.res(),this.res(),this.rej("3")),function(tuple) {
			utest_Assert.fail(null,{ fileName : "TestPromise.hx", lineNumber : 228, className : "thx.promise.TestPromise", methodName : "testJoin3Failure2"});
			done();
		}),function(err) {
			utest_Assert.same("3",err.message,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 232, className : "thx.promise.TestPromise", methodName : "testJoin3Failure2"});
			done();
		});
	}
	,testJoin4Success: function() {
		var done = utest_Assert.createAsync();
		thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise_Promises.join4(this.res("1"),this.res("2"),this.res("3"),this.res("4")),function(tuple) {
			utest_Assert.same("1",tuple._0,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 241, className : "thx.promise.TestPromise", methodName : "testJoin4Success"});
			utest_Assert.same("2",tuple._1,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 242, className : "thx.promise.TestPromise", methodName : "testJoin4Success"});
			utest_Assert.same("3",tuple._2,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 243, className : "thx.promise.TestPromise", methodName : "testJoin4Success"});
			utest_Assert.same("4",tuple._3,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 244, className : "thx.promise.TestPromise", methodName : "testJoin4Success"});
			done();
		}),function(err) {
			utest_Assert.fail(null,{ fileName : "TestPromise.hx", lineNumber : 248, className : "thx.promise.TestPromise", methodName : "testJoin4Success"});
		});
	}
	,testJoin4Failure1: function() {
		var done = utest_Assert.createAsync();
		thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise_Promises.join4(thx_promise__$Promise_Promise_$Impl_$.value("1"),thx_promise__$Promise_Promise_$Impl_$.value("2"),thx_promise__$Promise_Promise_$Impl_$.value("3"),thx_promise__$Promise_Promise_$Impl_$.error(new thx_Error("4",null,{ fileName : "TestPromise.hx", lineNumber : 254, className : "thx.promise.TestPromise", methodName : "testJoin4Failure1"}))),function(tuple) {
			utest_Assert.fail(null,{ fileName : "TestPromise.hx", lineNumber : 256, className : "thx.promise.TestPromise", methodName : "testJoin4Failure1"});
			done();
		}),function(err) {
			utest_Assert.same("4",err.message,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 260, className : "thx.promise.TestPromise", methodName : "testJoin4Failure1"});
			done();
		});
	}
	,testJoin4Failure2: function() {
		var done = utest_Assert.createAsync();
		thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise_Promises.join4(this.res(),this.res(),this.res(),this.rej("4")),function(tuple) {
			utest_Assert.fail(null,{ fileName : "TestPromise.hx", lineNumber : 269, className : "thx.promise.TestPromise", methodName : "testJoin4Failure2"});
			done();
		}),function(err) {
			utest_Assert.same("4",err.message,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 273, className : "thx.promise.TestPromise", methodName : "testJoin4Failure2"});
			done();
		});
	}
	,testJoin5Success: function() {
		var done = utest_Assert.createAsync();
		thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise_Promises.join5(this.res("1"),this.res("2"),this.res("3"),this.res("4"),this.res("5")),function(tuple) {
			utest_Assert.same("1",tuple._0,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 282, className : "thx.promise.TestPromise", methodName : "testJoin5Success"});
			utest_Assert.same("2",tuple._1,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 283, className : "thx.promise.TestPromise", methodName : "testJoin5Success"});
			utest_Assert.same("3",tuple._2,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 284, className : "thx.promise.TestPromise", methodName : "testJoin5Success"});
			utest_Assert.same("4",tuple._3,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 285, className : "thx.promise.TestPromise", methodName : "testJoin5Success"});
			utest_Assert.same("5",tuple._4,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 286, className : "thx.promise.TestPromise", methodName : "testJoin5Success"});
			done();
		}),function(err) {
			utest_Assert.fail(null,{ fileName : "TestPromise.hx", lineNumber : 290, className : "thx.promise.TestPromise", methodName : "testJoin5Success"});
		});
	}
	,testJoin5Failure1: function() {
		var done = utest_Assert.createAsync();
		thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise_Promises.join5(thx_promise__$Promise_Promise_$Impl_$.value("1"),thx_promise__$Promise_Promise_$Impl_$.value("2"),thx_promise__$Promise_Promise_$Impl_$.value("3"),thx_promise__$Promise_Promise_$Impl_$.value("4"),thx_promise__$Promise_Promise_$Impl_$.error(new thx_Error("5",null,{ fileName : "TestPromise.hx", lineNumber : 296, className : "thx.promise.TestPromise", methodName : "testJoin5Failure1"}))),function(tuple) {
			utest_Assert.fail(null,{ fileName : "TestPromise.hx", lineNumber : 298, className : "thx.promise.TestPromise", methodName : "testJoin5Failure1"});
			done();
		}),function(err) {
			utest_Assert.same("5",err.message,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 302, className : "thx.promise.TestPromise", methodName : "testJoin5Failure1"});
			done();
		});
	}
	,testJoin5Failure2: function() {
		var done = utest_Assert.createAsync();
		thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise_Promises.join5(this.res(),this.res(),this.res(),this.res(),this.rej("5")),function(tuple) {
			utest_Assert.fail(null,{ fileName : "TestPromise.hx", lineNumber : 311, className : "thx.promise.TestPromise", methodName : "testJoin5Failure2"});
			done();
		}),function(err) {
			utest_Assert.same("5",err.message,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 315, className : "thx.promise.TestPromise", methodName : "testJoin5Failure2"});
			done();
		});
	}
	,testJoin6Success: function() {
		var done = utest_Assert.createAsync();
		thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise_Promises.join6(this.res("1"),this.res("2"),this.res("3"),this.res("4"),this.res("5"),this.res("6")),function(tuple) {
			utest_Assert.same("1",tuple._0,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 324, className : "thx.promise.TestPromise", methodName : "testJoin6Success"});
			utest_Assert.same("2",tuple._1,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 325, className : "thx.promise.TestPromise", methodName : "testJoin6Success"});
			utest_Assert.same("3",tuple._2,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 326, className : "thx.promise.TestPromise", methodName : "testJoin6Success"});
			utest_Assert.same("4",tuple._3,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 327, className : "thx.promise.TestPromise", methodName : "testJoin6Success"});
			utest_Assert.same("5",tuple._4,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 328, className : "thx.promise.TestPromise", methodName : "testJoin6Success"});
			utest_Assert.same("6",tuple._5,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 329, className : "thx.promise.TestPromise", methodName : "testJoin6Success"});
			done();
		}),function(err) {
			utest_Assert.fail(null,{ fileName : "TestPromise.hx", lineNumber : 333, className : "thx.promise.TestPromise", methodName : "testJoin6Success"});
		});
	}
	,testJoin6Failure1: function() {
		var done = utest_Assert.createAsync();
		thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise_Promises.join6(thx_promise__$Promise_Promise_$Impl_$.value("1"),thx_promise__$Promise_Promise_$Impl_$.value("2"),thx_promise__$Promise_Promise_$Impl_$.value("3"),thx_promise__$Promise_Promise_$Impl_$.value("4"),thx_promise__$Promise_Promise_$Impl_$.value("5"),thx_promise__$Promise_Promise_$Impl_$.error(new thx_Error("6",null,{ fileName : "TestPromise.hx", lineNumber : 339, className : "thx.promise.TestPromise", methodName : "testJoin6Failure1"}))),function(tuple) {
			utest_Assert.fail(null,{ fileName : "TestPromise.hx", lineNumber : 341, className : "thx.promise.TestPromise", methodName : "testJoin6Failure1"});
			done();
		}),function(err) {
			utest_Assert.same("6",err.message,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 345, className : "thx.promise.TestPromise", methodName : "testJoin6Failure1"});
			done();
		});
	}
	,testJoin6Failure2: function() {
		var done = utest_Assert.createAsync();
		thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise_Promises.join6(this.res(),this.res(),this.res(),this.res(),this.res(),this.rej("6")),function(tuple) {
			utest_Assert.fail(null,{ fileName : "TestPromise.hx", lineNumber : 354, className : "thx.promise.TestPromise", methodName : "testJoin6Failure2"});
			done();
		}),function(err) {
			utest_Assert.same("6",err.message,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 358, className : "thx.promise.TestPromise", methodName : "testJoin6Failure2"});
			done();
		});
	}
	,testMapTupleSuccess: function() {
		var done = utest_Assert.createAsync();
		thx_promise__$Promise_Promise_$Impl_$.success(thx_promise_PromiseTuple2.mapTuplePromise(thx_promise__$Promise_Promise_$Impl_$.value({ _0 : 1, _1 : 2}),function(a,b) {
			return thx_promise__$Promise_Promise_$Impl_$.value(a / b);
		}),function(v) {
			utest_Assert.equals(0.5,v,null,{ fileName : "TestPromise.hx", lineNumber : 370, className : "thx.promise.TestPromise", methodName : "testMapTupleSuccess"});
			done();
		});
	}
	,testMapTupleFailure: function() {
		var done = utest_Assert.createAsync();
		var err = new thx_Error("error",null,{ fileName : "TestPromise.hx", lineNumber : 377, className : "thx.promise.TestPromise", methodName : "testMapTupleFailure"});
		thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise_PromiseTuple2.mapTuplePromise(thx_promise__$Promise_Promise_$Impl_$.error(err),function(a,b) {
			return thx_promise__$Promise_Promise_$Impl_$.value(a / b);
		}),function(e) {
			utest_Assert.equals(err,e,null,{ fileName : "TestPromise.hx", lineNumber : 383, className : "thx.promise.TestPromise", methodName : "testMapTupleFailure"});
			done();
		});
	}
	,testAllMapToTupleFailure: function() {
		var done = utest_Assert.createAsync();
		var err = new thx_Error("error",null,{ fileName : "TestPromise.hx", lineNumber : 390, className : "thx.promise.TestPromise", methodName : "testAllMapToTupleFailure"});
		thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise_PromiseTuple2.mapTuplePromise(thx_promise__$Promise_Promise_$Impl_$.flatMapEither(thx_promise__$Promise_Promise_$Impl_$.sequence([thx_promise__$Promise_Promise_$Impl_$.error(err),thx_promise__$Promise_Promise_$Impl_$.error(err)]),function(v) {
			utest_Assert.fail("should never happen",{ fileName : "TestPromise.hx", lineNumber : 396, className : "thx.promise.TestPromise", methodName : "testAllMapToTupleFailure"});
			return thx_promise__$Promise_Promise_$Impl_$.value({ _0 : 1, _1 : 2});
		},function(err1) {
			return thx_promise__$Promise_Promise_$Impl_$.error(err1);
		}),function(a,b) {
			utest_Assert.fail("should never happen",{ fileName : "TestPromise.hx", lineNumber : 400, className : "thx.promise.TestPromise", methodName : "testAllMapToTupleFailure"});
			return thx_promise__$Promise_Promise_$Impl_$.value(a / b);
		}),function(e) {
			utest_Assert.equals(err,e,null,{ fileName : "TestPromise.hx", lineNumber : 404, className : "thx.promise.TestPromise", methodName : "testAllMapToTupleFailure"});
			done();
		});
	}
	,testMapSuccessFailure: function() {
		thx_promise__$Promise_Promise_$Impl_$.always(thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise__$Promise_Promise_$Impl_$.map(thx_promise__$Promise_Promise_$Impl_$.nil,function(_) {
			throw new js__$Boot_HaxeError("NOOO!");
		}),function(_1) {
			utest_Assert.fail("should never succeed",{ fileName : "TestPromise.hx", lineNumber : 413, className : "thx.promise.TestPromise", methodName : "testMapSuccessFailure"});
		}),function(e) {
			utest_Assert.stringContains("NOOO!",e.toString(),null,{ fileName : "TestPromise.hx", lineNumber : 414, className : "thx.promise.TestPromise", methodName : "testMapSuccessFailure"});
		}),utest_Assert.createAsync());
	}
	,testTuple3: function() {
		var done = utest_Assert.createAsync();
		new thx_Error("error",null,{ fileName : "TestPromise.hx", lineNumber : 420, className : "thx.promise.TestPromise", methodName : "testTuple3"});
		thx_promise_PromiseTuple3.tuple(thx_promise__$Promise_Promise_$Impl_$.value({ _0 : 1, _1 : "a", _2 : 0.2}),function(a,b,c) {
			utest_Assert.equals(1,a,null,{ fileName : "TestPromise.hx", lineNumber : 424, className : "thx.promise.TestPromise", methodName : "testTuple3"});
			utest_Assert.equals("a",b,null,{ fileName : "TestPromise.hx", lineNumber : 425, className : "thx.promise.TestPromise", methodName : "testTuple3"});
			utest_Assert.equals(0.2,c,null,{ fileName : "TestPromise.hx", lineNumber : 426, className : "thx.promise.TestPromise", methodName : "testTuple3"});
			done();
		});
	}
	,res: function(val) {
		...
		return thx_promise__$Promise_Promise_$Impl_$.value(val);
	}
	,rej: function(msg) {
		if(msg == null) {
			msg = "rejected";
		}
		return thx_promise__$Promise_Promise_$Impl_$.error(new thx_Error(msg,null,{ fileName : "TestPromise.hx", lineNumber : 436, className : "thx.promise.TestPromise", methodName : "rej"}));
	}
	,__class__: thx_promise_TestPromise
};
var thx_promise_TestTryPromise = function() {
};
thx_promise_TestTryPromise.__name__ = ["thx","promise","TestTryPromise"];
thx_promise_TestTryPromise.prototype = {
	testTryCreate: function() {
		thx_promise__$Promise_Promise_$Impl_$.always(thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise__$Promise_Promise_$Impl_$.create(function(resolve,reject) {
			throw new js__$Boot_HaxeError("oh boy");
		}),function(_) {
			utest_Assert.fail("exception triggered resolve",{ fileName : "TestTryPromise.hx", lineNumber : 13, className : "thx.promise.TestTryPromise", methodName : "testTryCreate"});
		}),function(_1) {
			utest_Assert.pass(null,{ fileName : "TestTryPromise.hx", lineNumber : 14, className : "thx.promise.TestTryPromise", methodName : "testTryCreate"});
		}),utest_Assert.createAsync());
	}
	,testTryEitherSuccess: function() {
		var done = utest_Assert.createAsync();
		thx_promise__$Promise_Promise_$Impl_$.either(thx_promise__$Promise_Promise_$Impl_$.nil,function(_) {
			throw new js__$Boot_HaxeError("nops");
		},function(_1) {
			utest_Assert.fail("no reason to get here",{ fileName : "TestTryPromise.hx", lineNumber : 23, className : "thx.promise.TestTryPromise", methodName : "testTryEitherSuccess"});
		}).then(function(r) {
			switch(r[1]) {
			case 0:
				utest_Assert.pass(null,{ fileName : "TestTryPromise.hx", lineNumber : 27, className : "thx.promise.TestTryPromise", methodName : "testTryEitherSuccess"});
				break;
			case 1:
				utest_Assert.fail("not good",{ fileName : "TestTryPromise.hx", lineNumber : 28, className : "thx.promise.TestTryPromise", methodName : "testTryEitherSuccess"});
				break;
			}
			done();
		});
	}
	,testTryEitherFailure: function() {
		var done = utest_Assert.createAsync();
		thx_promise__$Promise_Promise_$Impl_$.either(thx_promise__$Promise_Promise_$Impl_$.fail("no go",{ fileName : "TestTryPromise.hx", lineNumber : 36, className : "thx.promise.TestTryPromise", methodName : "testTryEitherFailure"}),function(_) {
			utest_Assert.fail("no reason to get here",{ fileName : "TestTryPromise.hx", lineNumber : 38, className : "thx.promise.TestTryPromise", methodName : "testTryEitherFailure"});
		},function(_1) {
			throw new js__$Boot_HaxeError("nops");
		}).then(function(r) {
			switch(r[1]) {
			case 0:
				utest_Assert.pass(null,{ fileName : "TestTryPromise.hx", lineNumber : 43, className : "thx.promise.TestTryPromise", methodName : "testTryEitherFailure"});
				break;
			case 1:
				utest_Assert.fail("not good",{ fileName : "TestTryPromise.hx", lineNumber : 44, className : "thx.promise.TestTryPromise", methodName : "testTryEitherFailure"});
				break;
			}
			done();
		});
	}
	,testTrySuccess: function() {
		thx_promise__$Promise_Promise_$Impl_$.always(thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise__$Promise_Promise_$Impl_$.nil,function(_) {
			throw new js__$Boot_HaxeError("nops");
		}),function(_1) {
			utest_Assert.fail("not piped to a failing promise",{ fileName : "TestTryPromise.hx", lineNumber : 53, className : "thx.promise.TestTryPromise", methodName : "testTrySuccess"});
		}),function(_2) {
			utest_Assert.pass(null,{ fileName : "TestTryPromise.hx", lineNumber : 54, className : "thx.promise.TestTryPromise", methodName : "testTrySuccess"});
		}),utest_Assert.createAsync());
	}
	,testTryReject: function() {
		thx_promise__$Promise_Promise_$Impl_$.always(thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.fail("nops",{ fileName : "TestTryPromise.hx", lineNumber : 59, className : "thx.promise.TestTryPromise", methodName : "testTryReject"}),function(_) {
			throw new js__$Boot_HaxeError("niet");
		}),function(_1) {
			utest_Assert.fail("not piped to a failing promise",{ fileName : "TestTryPromise.hx", lineNumber : 61, className : "thx.promise.TestTryPromise", methodName : "testTryReject"});
		}),function(e) {
			utest_Assert.stringContains("niet",e.message,null,{ fileName : "TestTryPromise.hx", lineNumber : 62, className : "thx.promise.TestTryPromise", methodName : "testTryReject"});
		}),utest_Assert.createAsync());
	}
	,testTryAlways: function() {
		thx_promise__$Promise_Promise_$Impl_$.always(thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.always(thx_promise__$Promise_Promise_$Impl_$.nil,function() {
			throw new js__$Boot_HaxeError("bad");
		}),function(e) {
			utest_Assert.stringContains("bad",e.message,null,{ fileName : "TestTryPromise.hx", lineNumber : 69, className : "thx.promise.TestTryPromise", methodName : "testTryAlways"});
		}),utest_Assert.createAsync());
	}
	,testTryThrowFailure: function() {
		var _e = thx_promise__$Promise_Promise_$Impl_$.fail("meh",{ fileName : "TestTryPromise.hx", lineNumber : 74, className : "thx.promise.TestTryPromise", methodName : "testTryThrowFailure"});
		utest_Assert.raises(function() {
			return thx_promise__$Promise_Promise_$Impl_$.throwFailure(_e);
		},thx_Error,null,null,{ fileName : "TestTryPromise.hx", lineNumber : 74, className : "thx.promise.TestTryPromise", methodName : "testTryThrowFailure"});
	}
	,testTryMap: function() {
		thx_promise__$Promise_Promise_$Impl_$.always(thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.map(thx_promise__$Promise_Promise_$Impl_$.nil,function(_) {
			throw new js__$Boot_HaxeError("meh");
		}),function(e) {
			utest_Assert.stringContains("meh",e.message,null,{ fileName : "TestTryPromise.hx", lineNumber : 80, className : "thx.promise.TestTryPromise", methodName : "testTryMap"});
		}),utest_Assert.createAsync());
	}
	,testTryFlatMap: function() {
		thx_promise__$Promise_Promise_$Impl_$.always(thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.flatMapEither(thx_promise__$Promise_Promise_$Impl_$.nil,function(_) {
			throw new js__$Boot_HaxeError("meh");
		},function(err) {
			return thx_promise__$Promise_Promise_$Impl_$.error(err);
		}),function(e) {
			utest_Assert.stringContains("meh",e.message,null,{ fileName : "TestTryPromise.hx", lineNumber : 87, className : "thx.promise.TestTryPromise", methodName : "testTryFlatMap"});
		}),utest_Assert.createAsync());
	}
	,testTryFlatMapEitherSuccess: function() {
		thx_promise__$Promise_Promise_$Impl_$.always(thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.flatMapEither(thx_promise__$Promise_Promise_$Impl_$.nil,function(_) {
			throw new js__$Boot_HaxeError("meh");
		},function(e) {
			throw new js__$Boot_HaxeError("mah");
		}),function(e1) {
			utest_Assert.stringContains("meh",e1.message,null,{ fileName : "TestTryPromise.hx", lineNumber : 97, className : "thx.promise.TestTryPromise", methodName : "testTryFlatMapEitherSuccess"});
		}),utest_Assert.createAsync());
	}
	,testTryFlatMapEitherFailure: function() {
		thx_promise__$Promise_Promise_$Impl_$.always(thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.flatMapEither(thx_promise__$Promise_Promise_$Impl_$.fail("bah",{ fileName : "TestTryPromise.hx", lineNumber : 102, className : "thx.promise.TestTryPromise", methodName : "testTryFlatMapEitherFailure"}),function(_) {
			throw new js__$Boot_HaxeError("meh");
		},function(e) {
			throw new js__$Boot_HaxeError("mah");
		}),function(e1) {
			utest_Assert.stringContains("mah",e1.message,null,{ fileName : "TestTryPromise.hx", lineNumber : 107, className : "thx.promise.TestTryPromise", methodName : "testTryFlatMapEitherFailure"});
		}),utest_Assert.createAsync());
	}
	,testTryRecoverNull: function() {
		thx_promise__$Promise_Promise_$Impl_$.always(thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.recoverNull(thx_promise__$Promise_Promise_$Impl_$.value(null),function() {
			throw new js__$Boot_HaxeError("meh");
		}),function(e) {
			utest_Assert.stringContains("meh",e.message,null,{ fileName : "TestTryPromise.hx", lineNumber : 114, className : "thx.promise.TestTryPromise", methodName : "testTryRecoverNull"});
		}),utest_Assert.createAsync());
	}
	,__class__: thx_promise_TestTryPromise
};
