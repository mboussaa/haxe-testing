...
TS2.addTests = function(runner) {
	...
	runner.addCase(new thx_promise_TestPromise(Std.parseInt(w)));
};
TS2.main = function() {
...
var thx_promise_TestPromise = function(i) {
	this.x = i;
};
...
thx_promise_TestPromise.prototype = {
	...
	,testResolveBefore: function() {
		...
		while(_g1 < _g) {
			++_g1;
			thx_promise__$Promise_Promise_$Impl_$.success(thx_promise__$Promise_Promise_$Impl_$.value(1),(function(done) {
				return function(v) {
					utest_Assert.equals(1,v,null,{ fileName : "TestPromise.hx", lineNumber : 20, className : "thx.promise.TestPromise", methodName : "testResolveBefore"});
					done[0]();
				};
	...
	,testResolveAfter: function() {
		...
		while(_g1 < _g) {
			++_g1;
			thx_promise__$Promise_Promise_$Impl_$.success(thx_promise__$Promise_Promise_$Impl_$.delay(thx_promise__$Promise_Promise_$Impl_$.value(1)),(function(done) {
				return function(v) {
					utest_Assert.equals(1,v,null,{ fileName : "TestPromise.hx", lineNumber : 32, className : "thx.promise.TestPromise", methodName : "testResolveAfter"});
					done[0]();
				};
			})([utest_Assert.createAsync()]));
		}
	...
	,testRejectAfter: function() {
		...
		while(_g1 < _g) {
			...
			var error = [new thx_Error("Nooooo!",null,{ fileName : "TestPromise.hx", lineNumber : 40, className : "thx.promise.TestPromise", methodName : "testRejectAfter"})];
			thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.delay(thx_promise__$Promise_Promise_$Impl_$.error(error[0])),(function(error1,done1) {
				return function(e) {
					utest_Assert.equals(error1[0],e,null,{ fileName : "TestPromise.hx", lineNumber : 45, className : "thx.promise.TestPromise", methodName : "testRejectAfter"});
					done1[0]();
				};
			})(error,done));
		}
	...
	,testDelay: function() {
		...
		while(_g1 < _g) {
			...
			thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise__$Promise_Promise_$Impl_$.delay(thx_promise__$Promise_Promise_$Impl_$.value("a"),50),(function(start1,done1) {
				return function(v) {
					utest_Assert.equals("a",v,null,{ fileName : "TestPromise.hx", lineNumber : 57, className : "thx.promise.TestPromise", methodName : "testDelay"});
					utest_Assert.isTrue(new Date().getTime() - start1[0] >= 40.,null,{ fileName : "TestPromise.hx", lineNumber : 58, className : "thx.promise.TestPromise", methodName : "testDelay"});
					done1[0]();
				};
			})(start,done)),(function() {
				return function(e) {
					utest_Assert.fail(e.toString(),{ fileName : "TestPromise.hx", lineNumber : 62, className : "thx.promise.TestPromise", methodName : "testDelay"});
				};
			})());
		}
	}
	,testRejectBefore: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var done = [utest_Assert.createAsync()];
			var error = [new thx_Error("Nooooo!",null,{ fileName : "TestPromise.hx", lineNumber : 70, className : "thx.promise.TestPromise", methodName : "testRejectBefore"})];
			thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.error(error[0]),(function(error1,done1) {
				return function(e) {
					utest_Assert.equals(error1[0],e,null,{ fileName : "TestPromise.hx", lineNumber : 74, className : "thx.promise.TestPromise", methodName : "testRejectBefore"});
					done1[0]();
				};
			})(error,done));
		}
	...
	,testMapSuccessWithValue: function() {
		...
		while(_g1 < _g) {
			++_g1;
			thx_promise__$Promise_Promise_$Impl_$.success(thx_promise__$Promise_Promise_$Impl_$.flatMapEither(thx_promise__$Promise_Promise_$Impl_$.value(1),(function() {
				return function(v) {
				...
				return function(v1) {
					utest_Assert.equals(2,v1,null,{ fileName : "TestPromise.hx", lineNumber : 85, className : "thx.promise.TestPromise", methodName : "testMapSuccessWithValue"});
					done[0]();
				};
			})([utest_Assert.createAsync()]));
		}
	...
	,testMapSuccessWithFailure: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var done = [utest_Assert.createAsync()];
			var err = [new thx_Error("error",null,{ fileName : "TestPromise.hx", lineNumber : 93, className : "thx.promise.TestPromise", methodName : "testMapSuccessWithFailure"})];
			thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.flatMapEither(thx_promise__$Promise_Promise_$Impl_$.error(err[0]),(function() {
				return function(v) {
					utest_Assert.fail("should never touch this",{ fileName : "TestPromise.hx", lineNumber : 95, className : "thx.promise.TestPromise", methodName : "testMapSuccessWithFailure"});
					return thx_promise__$Promise_Promise_$Impl_$.value(v * 2);
				};
			})(),(function() {
				...
				return function(e) {
					utest_Assert.equals(err2[0],e,null,{ fileName : "TestPromise.hx", lineNumber : 98, className : "thx.promise.TestPromise", methodName : "testMapSuccessWithFailure"});
					done1[0]();
				};
			})(err,done));
		}
	...
	,testAllSuccess: function() {
		...
		while(_g1 < _g) {
			++_g1;
			thx_promise__$Promise_Promise_$Impl_$.success(thx_promise__$Promise_Promise_$Impl_$.sequence([thx_promise__$Promise_Promise_$Impl_$.value(1),thx_promise__$Promise_Promise_$Impl_$.value(2)]),(function(done) {
				return function(arr) {
					utest_Assert.equals(3,thx_Arrays.reduce(arr,(function() {
						return function(acc,v) {
							return acc + v;
						};
					})(),0),null,{ fileName : "TestPromise.hx", lineNumber : 110, className : "thx.promise.TestPromise", methodName : "testAllSuccess"});
					done[0]();
				};
			})([utest_Assert.createAsync()]));
		}
	...
	,testAllFailure1: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var done = [utest_Assert.createAsync()];
			var err = [new thx_Error("error",null,{ fileName : "TestPromise.hx", lineNumber : 118, className : "thx.promise.TestPromise", methodName : "testAllFailure1"})];
			thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise__$Promise_Promise_$Impl_$.sequence([thx_promise__$Promise_Promise_$Impl_$.value(1),thx_promise__$Promise_Promise_$Impl_$.error(err[0])]),(function() {
				return function(arr) {
					utest_Assert.fail("should never happen",{ fileName : "TestPromise.hx", lineNumber : 124, className : "thx.promise.TestPromise", methodName : "testAllFailure1"});
				};
			})()),(function(err1,done1) {
				return function(e) {
					utest_Assert.equals(err1[0],e,null,{ fileName : "TestPromise.hx", lineNumber : 127, className : "thx.promise.TestPromise", methodName : "testAllFailure1"});
					done1[0]();
				};
			})(err,done));
		}
	...
	,testAllFailure2: function() {
		...
		while(_g1 < _g) {
			++_g1;
			thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise__$Promise_Promise_$Impl_$.sequence([this.res(),this.res(),this.rej()]),(function() {
				return function(arr) {
					utest_Assert.fail("should never happen",{ fileName : "TestPromise.hx", lineNumber : 137, className : "thx.promise.TestPromise", methodName : "testAllFailure2"});
				};
			})()),(function(done) {
				return function(e) {
					utest_Assert.pass(null,{ fileName : "TestPromise.hx", lineNumber : 140, className : "thx.promise.TestPromise", methodName : "testAllFailure2"});
					done[0]();
				};
			})([utest_Assert.createAsync()]));
		}
	...
	,testAfterAllSuccess: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var done = [utest_Assert.createAsync()];
			thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise__$Promise_Promise_$Impl_$.afterAll([thx_promise__$Promise_Promise_$Impl_$.value(1),thx_promise__$Promise_Promise_$Impl_$.value(2),thx_promise__$Promise_Promise_$Impl_$.value(3)]),(function(done1) {
				return function(n) {
					utest_Assert.equals(thx_Nil.nil,n,null,{ fileName : "TestPromise.hx", lineNumber : 150, className : "thx.promise.TestPromise", methodName : "testAfterAllSuccess"});
					done1[0]();
				};
			})(done)),(function(done2) {
				return function(err) {
					utest_Assert.fail(null,{ fileName : "TestPromise.hx", lineNumber : 154, className : "thx.promise.TestPromise", methodName : "testAfterAllSuccess"});
					done2[0]();
				};
			})(done));
		}
	...
	,testAfterAllFailure1: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var done = [utest_Assert.createAsync()];
			thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise__$Promise_Promise_$Impl_$.afterAll([thx_promise__$Promise_Promise_$Impl_$.value(1),thx_promise__$Promise_Promise_$Impl_$.value(2),thx_promise__$Promise_Promise_$Impl_$.error(new thx_Error("rejected",null,{ fileName : "TestPromise.hx", lineNumber : 162, className : "thx.promise.TestPromise", methodName : "testAfterAllFailure1"}))]),(function(done1) {
				return function(n) {
					utest_Assert.fail("should never happen",{ fileName : "TestPromise.hx", lineNumber : 164, className : "thx.promise.TestPromise", methodName : "testAfterAllFailure1"});
					done1[0]();
				};
			})(done)),(function(done2) {
				return function(err) {
					utest_Assert.pass(null,{ fileName : "TestPromise.hx", lineNumber : 168, className : "thx.promise.TestPromise", methodName : "testAfterAllFailure1"});
					done2[0]();
				};
			})(done));
		}
	...
	,testAfterAllFailure2: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var done = [utest_Assert.createAsync()];
			thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise__$Promise_Promise_$Impl_$.afterAll([this.res(),this.res(),this.rej()]),(function(done1) {
				return function(n) {
					utest_Assert.fail("should never happen",{ fileName : "TestPromise.hx", lineNumber : 179, className : "thx.promise.TestPromise", methodName : "testAfterAllFailure2"});
					done1[0]();
				};
			})(done)),(function(done2) {
				return function(err) {
					utest_Assert.pass(null,{ fileName : "TestPromise.hx", lineNumber : 183, className : "thx.promise.TestPromise", methodName : "testAfterAllFailure2"});
					done2[0]();
				};
			})(done));
		}
	...
	,testJoinSuccess: function() {
		...
		while(_g1 < _g) {
			++_g1;
			thx_promise__$Promise_Promise_$Impl_$.success(thx_promise_Promises.par(thx__$Tuple_Tuple2_$Impl_$.of,thx_promise__$Promise_Promise_$Impl_$.value(1),thx_promise__$Promise_Promise_$Impl_$.value(2)),(function(done) {
				return function(t) {
					utest_Assert.equals(1,t._0,null,{ fileName : "TestPromise.hx", lineNumber : 194, className : "thx.promise.TestPromise", methodName : "testJoinSuccess"});
					utest_Assert.equals(2,t._1,null,{ fileName : "TestPromise.hx", lineNumber : 195, className : "thx.promise.TestPromise", methodName : "testJoinSuccess"});
					done[0]();
				};
			})([utest_Assert.createAsync()]));
		}
	...
	,testJoinFailure: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var done = [utest_Assert.createAsync()];
			var err = [new thx_Error("error",null,{ fileName : "TestPromise.hx", lineNumber : 203, className : "thx.promise.TestPromise", methodName : "testJoinFailure"})];
			thx_promise__$Promise_Promise_$Impl_$.success(thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise_Promises.par(thx__$Tuple_Tuple2_$Impl_$.of,thx_promise__$Promise_Promise_$Impl_$.value(1),thx_promise__$Promise_Promise_$Impl_$.error(err[0])),(function(err1,done1) {
				return function(e) {
					utest_Assert.equals(err1[0],e,null,{ fileName : "TestPromise.hx", lineNumber : 207, className : "thx.promise.TestPromise", methodName : "testJoinFailure"});
					done1[0]();
				};
			})(err,done)),(function() {
				return function(t) {
					utest_Assert.fail("should never happen",{ fileName : "TestPromise.hx", lineNumber : 211, className : "thx.promise.TestPromise", methodName : "testJoinFailure"});
				};
			})());
		}
	}
	,testJoin3Success: function() {
		...
		while(_g1 < _g) {
			++_g1;
			thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise_Promises.join3(this.res("1"),this.res("2"),this.res("3")),(function(done) {
				return function(tuple) {
					utest_Assert.same("1",tuple._0,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 220, className : "thx.promise.TestPromise", methodName : "testJoin3Success"});
					utest_Assert.same("2",tuple._1,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 221, className : "thx.promise.TestPromise", methodName : "testJoin3Success"});
					utest_Assert.same("3",tuple._2,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 222, className : "thx.promise.TestPromise", methodName : "testJoin3Success"});
					done[0]();
				};
			})([utest_Assert.createAsync()])),(function() {
				return function(err) {
					utest_Assert.fail(null,{ fileName : "TestPromise.hx", lineNumber : 226, className : "thx.promise.TestPromise", methodName : "testJoin3Success"});
				};
			})());
		}
	}
	,testJoin3Failure1: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var done = [utest_Assert.createAsync()];
			thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise_Promises.join3(thx_promise__$Promise_Promise_$Impl_$.value("1"),thx_promise__$Promise_Promise_$Impl_$.value("2"),thx_promise__$Promise_Promise_$Impl_$.error(new thx_Error("3",null,{ fileName : "TestPromise.hx", lineNumber : 233, className : "thx.promise.TestPromise", methodName : "testJoin3Failure1"}))),(function(done1) {
				return function(tuple) {
					utest_Assert.fail(null,{ fileName : "TestPromise.hx", lineNumber : 235, className : "thx.promise.TestPromise", methodName : "testJoin3Failure1"});
					done1[0]();
				};
			})(done)),(function(done2) {
				return function(err) {
					utest_Assert.same("3",err.message,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 239, className : "thx.promise.TestPromise", methodName : "testJoin3Failure1"});
					done2[0]();
				};
			})(done));
		}
	...
	,testJoin3Failure2: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var done = [utest_Assert.createAsync()];
			thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise_Promises.join3(this.res(),this.res(),this.rej("3")),(function(done1) {
				return function(tuple) {
					utest_Assert.fail(null,{ fileName : "TestPromise.hx", lineNumber : 249, className : "thx.promise.TestPromise", methodName : "testJoin3Failure2"});
					done1[0]();
				};
			})(done)),(function(done2) {
				return function(err) {
					utest_Assert.same("3",err.message,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 253, className : "thx.promise.TestPromise", methodName : "testJoin3Failure2"});
					done2[0]();
				};
			})(done));
		}
	...
	,testJoin4Success: function() {
		...
		while(_g1 < _g) {
			++_g1;
			thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise_Promises.join4(this.res("1"),this.res("2"),this.res("3"),this.res("4")),(function(done) {
				return function(tuple) {
					utest_Assert.same("1",tuple._0,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 263, className : "thx.promise.TestPromise", methodName : "testJoin4Success"});
					utest_Assert.same("2",tuple._1,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 264, className : "thx.promise.TestPromise", methodName : "testJoin4Success"});
					utest_Assert.same("3",tuple._2,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 265, className : "thx.promise.TestPromise", methodName : "testJoin4Success"});
					utest_Assert.same("4",tuple._3,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 266, className : "thx.promise.TestPromise", methodName : "testJoin4Success"});
					done[0]();
				};
			})([utest_Assert.createAsync()])),(function() {
				return function(err) {
					utest_Assert.fail(null,{ fileName : "TestPromise.hx", lineNumber : 270, className : "thx.promise.TestPromise", methodName : "testJoin4Success"});
				};
			})());
		}
	}
	,testJoin4Failure1: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var done = [utest_Assert.createAsync()];
			thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise_Promises.join4(thx_promise__$Promise_Promise_$Impl_$.value("1"),thx_promise__$Promise_Promise_$Impl_$.value("2"),thx_promise__$Promise_Promise_$Impl_$.value("3"),thx_promise__$Promise_Promise_$Impl_$.error(new thx_Error("4",null,{ fileName : "TestPromise.hx", lineNumber : 277, className : "thx.promise.TestPromise", methodName : "testJoin4Failure1"}))),(function(done1) {
				return function(tuple) {
					utest_Assert.fail(null,{ fileName : "TestPromise.hx", lineNumber : 279, className : "thx.promise.TestPromise", methodName : "testJoin4Failure1"});
					done1[0]();
				};
			})(done)),(function(done2) {
				return function(err) {
					utest_Assert.same("4",err.message,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 283, className : "thx.promise.TestPromise", methodName : "testJoin4Failure1"});
					done2[0]();
				};
			})(done));
		}
	...
	,testJoin4Failure2: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var done = [utest_Assert.createAsync()];
			thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise_Promises.join4(this.res(),this.res(),this.res(),this.rej("4")),(function(done1) {
				return function(tuple) {
					utest_Assert.fail(null,{ fileName : "TestPromise.hx", lineNumber : 293, className : "thx.promise.TestPromise", methodName : "testJoin4Failure2"});
					done1[0]();
				};
			})(done)),(function(done2) {
				return function(err) {
					utest_Assert.same("4",err.message,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 297, className : "thx.promise.TestPromise", methodName : "testJoin4Failure2"});
					done2[0]();
				};
			})(done));
		}
	...
	,testJoin5Success: function() {
		...
		while(_g1 < _g) {
			++_g1;
			thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise_Promises.join5(this.res("1"),this.res("2"),this.res("3"),this.res("4"),this.res("5")),(function(done) {
				return function(tuple) {
					utest_Assert.same("1",tuple._0,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 307, className : "thx.promise.TestPromise", methodName : "testJoin5Success"});
					utest_Assert.same("2",tuple._1,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 308, className : "thx.promise.TestPromise", methodName : "testJoin5Success"});
					utest_Assert.same("3",tuple._2,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 309, className : "thx.promise.TestPromise", methodName : "testJoin5Success"});
					utest_Assert.same("4",tuple._3,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 310, className : "thx.promise.TestPromise", methodName : "testJoin5Success"});
					utest_Assert.same("5",tuple._4,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 311, className : "thx.promise.TestPromise", methodName : "testJoin5Success"});
					done[0]();
				};
			})([utest_Assert.createAsync()])),(function() {
				return function(err) {
					utest_Assert.fail(null,{ fileName : "TestPromise.hx", lineNumber : 315, className : "thx.promise.TestPromise", methodName : "testJoin5Success"});
				};
			})());
		}
	}
	,testJoin5Failure1: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var done = [utest_Assert.createAsync()];
			thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise_Promises.join5(thx_promise__$Promise_Promise_$Impl_$.value("1"),thx_promise__$Promise_Promise_$Impl_$.value("2"),thx_promise__$Promise_Promise_$Impl_$.value("3"),thx_promise__$Promise_Promise_$Impl_$.value("4"),thx_promise__$Promise_Promise_$Impl_$.error(new thx_Error("5",null,{ fileName : "TestPromise.hx", lineNumber : 322, className : "thx.promise.TestPromise", methodName : "testJoin5Failure1"}))),(function(done1) {
				return function(tuple) {
					utest_Assert.fail(null,{ fileName : "TestPromise.hx", lineNumber : 324, className : "thx.promise.TestPromise", methodName : "testJoin5Failure1"});
					done1[0]();
				};
			})(done)),(function(done2) {
				return function(err) {
					utest_Assert.same("5",err.message,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 328, className : "thx.promise.TestPromise", methodName : "testJoin5Failure1"});
					done2[0]();
				};
			})(done));
		}
	...
	,testJoin5Failure2: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var done = [utest_Assert.createAsync()];
			thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise_Promises.join5(this.res(),this.res(),this.res(),this.res(),this.rej("5")),(function(done1) {
				return function(tuple) {
					utest_Assert.fail(null,{ fileName : "TestPromise.hx", lineNumber : 338, className : "thx.promise.TestPromise", methodName : "testJoin5Failure2"});
					done1[0]();
				};
			})(done)),(function(done2) {
				return function(err) {
					utest_Assert.same("5",err.message,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 342, className : "thx.promise.TestPromise", methodName : "testJoin5Failure2"});
					done2[0]();
				};
			})(done));
		}
	...
	,testJoin6Success: function() {
		...
		while(_g1 < _g) {
			++_g1;
			thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise_Promises.join6(this.res("1"),this.res("2"),this.res("3"),this.res("4"),this.res("5"),this.res("6")),(function(done) {
				return function(tuple) {
					utest_Assert.same("1",tuple._0,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 352, className : "thx.promise.TestPromise", methodName : "testJoin6Success"});
					utest_Assert.same("2",tuple._1,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 353, className : "thx.promise.TestPromise", methodName : "testJoin6Success"});
					utest_Assert.same("3",tuple._2,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 354, className : "thx.promise.TestPromise", methodName : "testJoin6Success"});
					utest_Assert.same("4",tuple._3,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 355, className : "thx.promise.TestPromise", methodName : "testJoin6Success"});
					utest_Assert.same("5",tuple._4,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 356, className : "thx.promise.TestPromise", methodName : "testJoin6Success"});
					utest_Assert.same("6",tuple._5,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 357, className : "thx.promise.TestPromise", methodName : "testJoin6Success"});
					done[0]();
				};
			})([utest_Assert.createAsync()])),(function() {
				return function(err) {
					utest_Assert.fail(null,{ fileName : "TestPromise.hx", lineNumber : 361, className : "thx.promise.TestPromise", methodName : "testJoin6Success"});
				};
			})());
		}
	}
	,testJoin6Failure1: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var done = [utest_Assert.createAsync()];
			thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise_Promises.join6(thx_promise__$Promise_Promise_$Impl_$.value("1"),thx_promise__$Promise_Promise_$Impl_$.value("2"),thx_promise__$Promise_Promise_$Impl_$.value("3"),thx_promise__$Promise_Promise_$Impl_$.value("4"),thx_promise__$Promise_Promise_$Impl_$.value("5"),thx_promise__$Promise_Promise_$Impl_$.error(new thx_Error("6",null,{ fileName : "TestPromise.hx", lineNumber : 368, className : "thx.promise.TestPromise", methodName : "testJoin6Failure1"}))),(function(done1) {
				return function(tuple) {
					utest_Assert.fail(null,{ fileName : "TestPromise.hx", lineNumber : 370, className : "thx.promise.TestPromise", methodName : "testJoin6Failure1"});
					done1[0]();
				};
			})(done)),(function(done2) {
				return function(err) {
					utest_Assert.same("6",err.message,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 374, className : "thx.promise.TestPromise", methodName : "testJoin6Failure1"});
					done2[0]();
				};
			})(done));
		}
	...
	,testJoin6Failure2: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var done = [utest_Assert.createAsync()];
			thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise_Promises.join6(this.res(),this.res(),this.res(),this.res(),this.res(),this.rej("6")),(function(done1) {
				return function(tuple) {
					utest_Assert.fail(null,{ fileName : "TestPromise.hx", lineNumber : 384, className : "thx.promise.TestPromise", methodName : "testJoin6Failure2"});
					done1[0]();
				};
			})(done)),(function(done2) {
				return function(err) {
					utest_Assert.same("6",err.message,null,null,null,{ fileName : "TestPromise.hx", lineNumber : 388, className : "thx.promise.TestPromise", methodName : "testJoin6Failure2"});
					done2[0]();
				};
			})(done));
		}
	...
	,testMapTupleSuccess: function() {
		...
		while(_g1 < _g) {
			++_g1;
			thx_promise__$Promise_Promise_$Impl_$.success(thx_promise_PromiseTuple2.mapTuplePromise(thx_promise__$Promise_Promise_$Impl_$.value({ _0 : 1, _1 : 2}),(function() {
				return function(a,b) {
					return thx_promise__$Promise_Promise_$Impl_$.value(a / b);
				};
			})()),(function(done) {
				return function(v) {
					utest_Assert.equals(0.5,v,null,{ fileName : "TestPromise.hx", lineNumber : 401, className : "thx.promise.TestPromise", methodName : "testMapTupleSuccess"});
					done[0]();
				};
			})([utest_Assert.createAsync()]));
		}
	...
	,testMapTupleFailure: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var done = [utest_Assert.createAsync()];
			var err = [new thx_Error("error",null,{ fileName : "TestPromise.hx", lineNumber : 409, className : "thx.promise.TestPromise", methodName : "testMapTupleFailure"})];
			thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise_PromiseTuple2.mapTuplePromise(thx_promise__$Promise_Promise_$Impl_$.error(err[0]),(function() {
				return function(a,b) {
					return thx_promise__$Promise_Promise_$Impl_$.value(a / b);
				};
			})()),(function(err1,done1) {
				return function(e) {
					utest_Assert.equals(err1[0],e,null,{ fileName : "TestPromise.hx", lineNumber : 415, className : "thx.promise.TestPromise", methodName : "testMapTupleFailure"});
					done1[0]();
				};
			})(err,done));
		}
	...
	,testAllMapToTupleFailure: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var done = [utest_Assert.createAsync()];
			var err = [new thx_Error("error",null,{ fileName : "TestPromise.hx", lineNumber : 423, className : "thx.promise.TestPromise", methodName : "testAllMapToTupleFailure"})];
			thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise_PromiseTuple2.mapTuplePromise(thx_promise__$Promise_Promise_$Impl_$.flatMapEither(thx_promise__$Promise_Promise_$Impl_$.sequence([thx_promise__$Promise_Promise_$Impl_$.error(err[0]),thx_promise__$Promise_Promise_$Impl_$.error(err[0])]),(function() {
				return function(v) {
					utest_Assert.fail("should never happen",{ fileName : "TestPromise.hx", lineNumber : 429, className : "thx.promise.TestPromise", methodName : "testAllMapToTupleFailure"});
				...
				return function(a,b) {
					utest_Assert.fail("should never happen",{ fileName : "TestPromise.hx", lineNumber : 433, className : "thx.promise.TestPromise", methodName : "testAllMapToTupleFailure"});
					return thx_promise__$Promise_Promise_$Impl_$.value(a / b);
				};
			})()),(function(err2,done1) {
				return function(e) {
					utest_Assert.equals(err2[0],e,null,{ fileName : "TestPromise.hx", lineNumber : 437, className : "thx.promise.TestPromise", methodName : "testAllMapToTupleFailure"});
					done1[0]();
				};
			})(err,done));
		}
	...
	,testMapSuccessFailure: function() {
		...
		while(_g1 < _g) {
			...
			thx_promise__$Promise_Promise_$Impl_$.always(thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(thx_promise__$Promise_Promise_$Impl_$.map(thx_promise__$Promise_Promise_$Impl_$.nil,function(_) {
				...
				utest_Assert.fail("should never succeed",{ fileName : "TestPromise.hx", lineNumber : 447, className : "thx.promise.TestPromise", methodName : "testMapSuccessFailure"});
			}),function(e) {
				utest_Assert.stringContains("NOOO!",e.toString(),null,{ fileName : "TestPromise.hx", lineNumber : 448, className : "thx.promise.TestPromise", methodName : "testMapSuccessFailure"});
			}),utest_Assert.createAsync());
		}
	}
	,testTuple3: function() {
		...
		while(_g1 < _g) {
			++_g1;
			var done = [utest_Assert.createAsync()];
			new thx_Error("error",null,{ fileName : "TestPromise.hx", lineNumber : 455, className : "thx.promise.TestPromise", methodName : "testTuple3"});
			thx_promise_PromiseTuple3.tuple(thx_promise__$Promise_Promise_$Impl_$.value({ _0 : 1, _1 : "a", _2 : 0.2}),(function(done1) {
				return function(a,b,c) {
					utest_Assert.equals(1,a,null,{ fileName : "TestPromise.hx", lineNumber : 459, className : "thx.promise.TestPromise", methodName : "testTuple3"});
					utest_Assert.equals("a",b,null,{ fileName : "TestPromise.hx", lineNumber : 460, className : "thx.promise.TestPromise", methodName : "testTuple3"});
					utest_Assert.equals(0.2,c,null,{ fileName : "TestPromise.hx", lineNumber : 461, className : "thx.promise.TestPromise", methodName : "testTuple3"});
					done1[0]();
				};
			})(done));
		}
	...
	,rej: function(msg) {
		...
		return thx_promise__$Promise_Promise_$Impl_$.error(new thx_Error(msg,null,{ fileName : "TestPromise.hx", lineNumber : 471, className : "thx.promise.TestPromise", methodName : "rej"}));
	}
