...
void TestAll_obj::main(){
            	HX_STACK_FRAME("TestAll","main",0x6594a938,"TestAll.main","TestAll.hx",6,0x4f103e4f)
HXLINE(   7)		HX_VARI(  ::utest::Runner,runner) =  ::utest::Runner_obj::__new();
HXLINE(   8)		runner->addCase( ::thx::promise::TestFuture_obj::__new(),null(),null(),null(),null());
HXLINE(   9)		runner->addCase( ::thx::promise::TestPromise_obj::__new(),null(),null(),null(),null());
HXLINE(  10)		runner->addCase( ::thx::promise::TestTryPromise_obj::__new(),null(),null(),null(),null());
HXLINE(  11)		::utest::ui::Report_obj::create(runner,null(),null());
HXLINE(  12)		runner->run();
            	}
