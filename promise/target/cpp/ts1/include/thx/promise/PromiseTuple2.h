...
#define INCLUDED_thx_promise_PromiseTuple2
...
HX_DECLARE_CLASS2(thx,promise,PromiseTuple2)

namespace thx{
namespace promise{


class HXCPP_CLASS_ATTRIBUTES PromiseTuple2_obj : public hx::Object
{
	public:
		typedef hx::Object super;
		typedef PromiseTuple2_obj OBJ_;
		PromiseTuple2_obj();

	public:
		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=false,const char *inName="thx.promise.PromiseTuple2")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,false,"thx.promise.PromiseTuple2"); }
		static hx::ObjectPtr< PromiseTuple2_obj > __new();
		...
		::String __ToString() const { return HX_HCSTRING("PromiseTuple2","\x05","\x23","\x67","\xb0"); }
...
#endif /* INCLUDED_thx_promise_PromiseTuple2 */ 
