...
HXLINE(  16)		::haxe::Log_obj::trace((HX_("The value of loop_wrapper is ",79,76,58,6c) + w),hx::SourceInfo(HX_("TS3.hx",6a,99,15,82),16,HX_("TS3",d4,05,40,00),HX_("addTests",00,a6,f2,86)));
HXLINE(  18)		HX_VARI( Int,x) = ::Std_obj::parseInt(w);
HXLINE(  19)		runner->addCase( ::thx::promise::TestTryPromise_obj::__new(x),null(),null(),null(),null());
            	}
...
void TS3_obj::main(){
            	HX_STACK_FRAME("TS3","main",0x68fb4113,"TS3.main","TS3.hx",22,0x8215996a)
HXLINE(  24)		HX_VARI(  ::utest::Runner,runner) =  ::utest::Runner_obj::__new();
HXLINE(  25)		::TS3_obj::addTests(runner);
